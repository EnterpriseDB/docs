# Installing EDB Postgres Advanced Server 11 on Debian 9 x86_64
...
1. Setup the Repository by replacing 'USERNAME:PASSWORD' below with your username and password for the EDB repositories
