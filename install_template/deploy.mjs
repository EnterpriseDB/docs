...
const moveDoc = async (product, platform, version) => {
  ...
  const destFilename = match(context, 
    ...
    when({product: {name: "EDB*Plus", version: 40}, platform: {name: "Debian 9"}}, 
    (ctx) => `edb_plus/40/03_installing_edb_plus/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_edbplus_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB Postgres Advanced Server"}, platform: {name: "Debian 9"}}, 
      (ctx) => `epas/14/epas_inst_linux/installing_epas_using_edb_repository/${fmtArchPath(ctx)}/epas_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "Failover Manager", version: 4.4}, platform: {name: "Debian 9"}}, 
      (ctx) => `efm/4/03_installing_efm/${fmtArchPath(ctx)}/${prefix[plat]}_efm4_deb9_${fmtArchFilename(ctx)}.mdx`),      
    when({product: {name: "Failover Manager", version: 4.4}, platform: {name: "Debian 10"}}, 
      (ctx) => `efm/4/03_installing_efm/${fmtArchPath(ctx)}/${prefix[plat]}_efm4_deb10_${fmtArchFilename(ctx)}.mdx`),      
    when({product: {name: "Failover Manager", version: 4.4}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `efm/4/03_installing_efm/${fmtArchPath(ctx)}/${prefix[plat]}_efm4_ubuntu18_${fmtArchFilename(ctx)}.mdx`),      
    when({product: {name: "Failover Manager", version: 4.4}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `efm/4/03_installing_efm/${fmtArchPath(ctx)}/${prefix[plat]}_efm4_ubuntu20_${fmtArchFilename(ctx)}.mdx`),      
    ...
    when({product: {name: "Hadoop Foreign Data Wrapper", version: 2}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `hadoop_data_adapter/2/05_installing_the_hadoop_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_hadoop_ubuntu20_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "Hadoop Foreign Data Wrapper", version: 2}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `hadoop_data_adapter/2/05_installing_the_hadoop_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_hadoop_ubuntu18_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "Hadoop Foreign Data Wrapper", version: 2}, platform: {name: "Debian 10"}}, 
      (ctx) => `hadoop_data_adapter/2/05_installing_the_hadoop_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_hadoop_deb10_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "Hadoop Foreign Data Wrapper", version: 2}, platform: {name: "Debian 9"}}, 
      (ctx) => `hadoop_data_adapter/2/05_installing_the_hadoop_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_hadoop_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "MongoDB Foreign Data Wrapper", version: 5}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `mongo_data_adapter/5/04_installing_the_mongo_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_mongo_ubuntu20_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "MongoDB Foreign Data Wrapper", version: 5}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `mongo_data_adapter/5/04_installing_the_mongo_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_mongo_ubuntu18_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "MongoDB Foreign Data Wrapper", version: 5}, platform: {name: "Debian 10"}}, 
      (ctx) => `mongo_data_adapter/5/04_installing_the_mongo_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_mongo_deb10_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "MongoDB Foreign Data Wrapper", version: 5}, platform: {name: "Debian 9"}}, 
      (ctx) => `mongo_data_adapter/5/04_installing_the_mongo_data_adapter/${fmtArchPath(ctx)}/${prefix[plat]}_mongo_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB pgBouncer", version: 1.16}, platform: {name: "Debian 9"}}, 
      (ctx) => `pgbouncer/1.16/01_installation/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_pgbouncer_deb9_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "EDB pgBouncer", version: 1.16}, platform: {name: "Debian 10"}}, 
      (ctx) => `pgbouncer/1.16/01_installation/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_pgbouncer_deb10_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "EDB pgBouncer", version: 1.16}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `pgbouncer/1.16/01_installation/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_pgbouncer_ubuntu18_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "EDB pgBouncer", version: 1.16}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `pgbouncer/1.16/01_installation/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_pgbouncer_ubuntu20_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB Pgpool-II", version: 4.3}, platform: {name: "Debian 9"}}, 
      (ctx) => `pgpool/4.3/01_installing_and_configuring_the_pgpool-II/${fmtArchPath(ctx)}/${prefix[plat]}_pgpool_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB Pgpool-II Extensions", version: 4.3}, platform: {name: "Debian 9"}}, 
      (ctx) => `pgpool/4.3/02_extensions/${fmtArchPath(ctx)}/${prefix[plat]}_pgpoolext_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "Postgres Enterprise Manager server", version: 8}, platform: {name: "Debian 9"}}, 
      (ctx) => `pem/8/installing_pem_server/pem_server_inst_linux/installing_pem_server_using_edb_repository/${fmtArchPath(ctx)}/pem_server_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "Postgres Enterprise Manager agent", version: 8}, platform: {name: "Debian 9"}}, 
      (ctx) => `pem/8/installing_pem_agent/installing_on_linux/${fmtArchPath(ctx)}/pem_agent_deb9_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "PostGIS", version: 3.1}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `postgis/3.1/01a_installing_postgis/installing_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_postgis_ubuntu20_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "PostGIS", version: 3.1}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `postgis/3.1/01a_installing_postgis/installing_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_postgis_ubuntu18_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "PostGIS", version: 3.1}, platform: {name: "Debian 10"}}, 
      (ctx) => `postgis/3.1/01a_installing_postgis/installing_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_postgis_deb10_${fmtArchFilename(ctx)}.mdx`),
    when({product: {name: "PostGIS", version: 3.1}, platform: {name: "Debian 9"}}, 
      (ctx) => `postgis/3.1/01a_installing_postgis/installing_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_postgis_deb9_${fmtArchFilename(ctx)}.mdx`),
