...
const moveDoc = async (product, platform, version) => {
  ...
  const destFilename = integralDeploymentPath || match(context, 
    ...
    when({product: {name: "EDB OCL Connector"}, platform: {name: "SLES 12"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_sles_12.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "SLES 15"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_sles_15.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Debian 10"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_debian_10.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_debian_11.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_ubuntu_18.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_ubuntu_20.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "CentOS 7"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_centos_7.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "AlmaLinux 8 or Rocky Linux 8"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_other_linux_8.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "RHEL 8 or OL 8"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_rhel_8.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "RHEL 7 or OL 7"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_rhel_7.mdx`),
