...
const moveDoc = async (product, platform, version) => {
  ...
  const destFilename = match(context, 
    ...
    (ctx) => `edb_plus/40/03_installing_edb_plus/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_edbplus_deb11_${fmtArchFilename(ctx)}.mdx`),
    ...
    (ctx) => `edb_plus/40/03_installing_edb_plus/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_edbplus_ubuntu22_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "Failover Manager", version: 4.4}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `efm/4/03_installing_efm/${fmtArchPath(ctx)}/${prefix[plat]}_efm4_ubuntu22_${fmtArchFilename(ctx)}.mdx`),      
    ...
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `jdbc_connector/42.3.3.1/04_installing_and_configuring_the_jdbc_connector/01_installing_the_connector_with_an_rpm_package/${fmtArchPath(ctx)}/jdbc42_deb11_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `jdbc_connector/42.3.3.1/04_installing_and_configuring_the_jdbc_connector/01_installing_the_connector_with_an_rpm_package/${fmtArchPath(ctx)}/jdbc42_ubuntu22_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/04_open_client_library/01_installing_and_configuring_the_ocl_connector/install_on_linux_using_edb_repo/${fmtArchPath(ctx)}/${prefix[plat]}_ocl_connector14_deb11_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/04_open_client_library/01_installing_and_configuring_the_ocl_connector/install_on_linux_using_edb_repo/${fmtArchPath(ctx)}/${prefix[plat]}_ocl_connector14_ubuntu22_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `odbc_connector/13/03_installing_edb_odbc/01_installing_linux/${fmtArchPath(ctx)}/${prefix[plat]}_odbc13_deb11_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `odbc_connector/13/03_installing_edb_odbc/01_installing_linux/${fmtArchPath(ctx)}/${prefix[plat]}_odbc13_ubuntu22_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB pgBouncer", version: 1.16}, platform: {name: "Debian 11"}}, 
      (ctx) => `pgbouncer/1.16/01_installation/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_pgbouncer_deb11_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB pgBouncer", version: 1.16}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `pgbouncer/1.16/01_installation/install_on_linux/${fmtArchPath(ctx)}/${prefix[plat]}_pgbouncer_ubuntu22_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB Pgpool-II", version: 4.3}, platform: {name: "Debian 11"}}, 
      (ctx) => `pgpool/4.3/01_installing_and_configuring_the_pgpool-II/${fmtArchPath(ctx)}/${prefix[plat]}_pgpool_deb11_${fmtArchFilename(ctx)}.mdx`),      
    ...
    when({product: {name: "EDB Pgpool-II", version: 4.3}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `pgpool/4.3/01_installing_and_configuring_the_pgpool-II/${fmtArchPath(ctx)}/${prefix[plat]}_pgpool_ubuntu22_${fmtArchFilename(ctx)}.mdx`),          
    ...
    when({product: {name: "EDB Pgpool-II Extensions", version: 4.3}, platform: {name: "Debian 11"}}, 
      (ctx) => `pgpool/4.3/02_extensions/${fmtArchPath(ctx)}/${prefix[plat]}_pgpoolext_deb11_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "EDB Pgpool-II Extensions", version: 4.3}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `pgpool/4.3/02_extensions/${fmtArchPath(ctx)}/${prefix[plat]}_pgpoolext_ubuntu22_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "PostGIS", version: 3.1}, platform: {name: "Ubuntu 22.04"}}, 
      (ctx) => `postgis/3.1/01a_installing_postgis/installing_on_linux/${fmtArchPath(ctx)}/postgis_ubuntu22_${fmtArchFilename(ctx)}.mdx`),
    ...
    when({product: {name: "PostGIS", version: 3.1}, platform: {name: "Debian 11"}}, 
      (ctx) => `postgis/3.1/01a_installing_postgis/installing_on_linux/${fmtArchPath(ctx)}/postgis_deb11_${fmtArchFilename(ctx)}.mdx`),
