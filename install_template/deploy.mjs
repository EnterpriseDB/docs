...
const moveDoc = async (product, platform, version) => {
  ...
  const destFilename = integralDeploymentPath || match(context, 
    ...
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "CentOS 7"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_centos_7.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "AlmaLinux 8 or Rocky Linux 8"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_other_linux_8.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "RHEL 7 or OL 7"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_rhel_7.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "RHEL 8 or OL 8"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_rhel_8.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "RHEL 8"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_rhel_8.mdx`),  
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "SLES 12"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_sles_12.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "SLES 15"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_sles_15.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Debian 10"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_debian_10.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_debian_11.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_ubuntu_18.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_ubuntu_20.mdx`),

    when({product: {name: "EDB OCL Connector"}, platform: {name: "SLES 12"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_sles_12.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "SLES 15"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_sles_15.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Debian 10"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_debian_10.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_debian_11.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_ubuntu_18.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_ubuntu_20.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "CentOS 7"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_centos_7.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "AlmaLinux 8 or Rocky Linux 8"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_other_linux_8.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "RHEL 8 or OL 8"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_rhel_8.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "RHEL 7 or OL 7"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_rhel_7.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "RHEL 8"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_rhel_8.mdx`),     

    when({product: {name: "EDB ODBC Connector"}, platform: {name: "CentOS 7"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_centos_7.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "AlmaLinux 8 or Rocky Linux 8"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_other_linux_8.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "RHEL 8 or OL 8"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_rhel_8.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "RHEL 7 or OL 7"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_rhel_7.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "RHEL 8"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_rhel_8.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "SLES 12"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_sles_12.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "SLES 15"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_sles_15.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "Debian 10"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_debian_10.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_debian_11.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "Ubuntu 18.04"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_ubuntu_18.mdx`),
    when({product: {name: "EDB ODBC Connector"}, platform: {name: "Ubuntu 20.04"}}, 
      (ctx) => `odbc_connector/13/installing/linux_${ctx.platform.arch}/odbc_ubuntu_20.mdx`),
