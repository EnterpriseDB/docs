...
const moveDoc = async (product, platform, version) => {
  ...
  const destFilename = match(context, 
    ...
    when({product: {name: "Hadoop Foreign Data Wrapper", version: 2}, platform: {name: "Debian 11"}}, 
      (ctx) => `hadoop_data_adapter/2/installing/linux_${ctx.platform.arch}/hadoop_deb_11.mdx`),
    when({product: {name: "Hadoop Foreign Data Wrapper", version: 2}, platform: {name: "Debian 10"}}, 
      (ctx) => `hadoop_data_adapter/2/installing/linux_${ctx.platform.arch}/hadoop_deb_10.mdx`),
    ...
    when({product: {name: "MongoDB Foreign Data Wrapper", version: 5}, platform: {name: "Debian 11"}}, 
      (ctx) => `mongo_data_adapter/5/installing/linux_${ctx.platform.arch}/mongo_deb_11.mdx`),
    when({product: {name: "MongoDB Foreign Data Wrapper", version: 5}, platform: {name: "Debian 10"}}, 
      (ctx) => `mongo_data_adapter/5/installing/linux_${ctx.platform.arch}/mongo_deb_10.mdx`),
    ...
    when({product: {name: "MySQL Foreign Data Wrapper", version: 2}, platform: {name: "Debian 10"}}, 
      (ctx) => `mysql_data_adapter/2/installing/linux_${ctx.platform.arch}/mysql_deb_10.mdx`),
    when({product: {name: "MySQL Foreign Data Wrapper", version: 2}, platform: {name: "Debian 11"}}, 
      (ctx) => `mysql_data_adapter/2/installing/linux_${ctx.platform.arch}/mysql_deb_11.mdx`),
