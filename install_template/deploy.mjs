...
const moveDoc = async (product, platform, version) => {
  ...
  const destFilename = integralDeploymentPath || match(context, 
    ...
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Debian 10"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_deb_10.mdx`),
    when({product: {name: "EDB JDBC Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `jdbc_connector/42.5.0.1/installing/linux_${ctx.platform.arch}/jdbc_deb_11.mdx`),
    ...
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Debian 10"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_deb_10.mdx`),
    when({product: {name: "EDB OCL Connector"}, platform: {name: "Debian 11"}}, 
      (ctx) => `ocl_connector/${ctx.product.version}/installing/linux_${ctx.platform.arch}/ocl_connector_deb_11.mdx`),
