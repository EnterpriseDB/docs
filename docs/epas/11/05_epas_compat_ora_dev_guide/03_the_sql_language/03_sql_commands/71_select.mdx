...
> Comment-embedded hints to the optimizer for selection of an execution plan. See [Section 3.4](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/reference/database-compatibility-for-oracle-developers-reference-guide/11/Database_Compatibility_for_Oracle_Developers_Reference_Guide.1.094.html#) for information about optimizer hints.
...
`ROLLUP`, `CUBE`, and `GROUPING` `SETS` are extensions to the `GROUP BY` clause for supporting multidimensional analysis. See Section [2.3.71.3](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/reference/database-compatibility-for-oracle-developers-reference-guide/11/Database_Compatibility_for_Oracle_Developers_Reference_Guide.1.088.html#pID0E0LZB0HA) for information on using these extensions.
