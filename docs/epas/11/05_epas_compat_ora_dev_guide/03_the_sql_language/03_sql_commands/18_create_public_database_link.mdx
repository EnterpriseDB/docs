...
**Note:** For Advanced Server 11, the `CREATE DATABASE LINK` command is tested against and certified for use with Oracle version 10g Release 2 (10.2), Oracle version 11g Release 2 (11.2), and Oracle version 12c Release 1 (12.1).
...
> Specify the connection information for the ~ foreign data wrapper.
...
[DROP DATABASE LINK](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/reference/database-compatibility-for-oracle-developers-reference-guide/11/Database_Compatibility_for_Oracle_Developers_Reference_Guide.1.059.html#)