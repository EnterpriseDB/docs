...
| `cycle_flag`     | `CHARACTER VARYING` | Specifies if the sequence should wrap when it reaches `min_value` or ma~x_value. |
...
| last_nu~mber     | `NUMERIC`           | The value of the last sequence number saved to disk.         |