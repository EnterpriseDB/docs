...
<div id="client_connection_defaults_statement_behavior" class="registered_link"></div>
...
For information on data redaction, see Section [4.4](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/user-guides/user-guide/11/EDB_Postgres_Advanced_Server_Guide.1.055.html#pID0E0CPC0HA).