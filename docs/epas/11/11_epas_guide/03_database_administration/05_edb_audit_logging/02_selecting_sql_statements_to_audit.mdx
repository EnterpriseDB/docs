...
Section [3.5.2.1](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/user-guides/user-guide/11/EDB_Postgres_Advanced_Server_Guide.1.040.html#pID0E02ME0HA) describes additional parameter values for selecting particular DDL or DCL statements for auditing.

Section [3.5.2.2](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/user-guides/user-guide/11/EDB_Postgres_Advanced_Server_Guide.1.040.html#pID0E0MFE0HA) describes additional parameter values for selecting particular DML statements for auditing.
