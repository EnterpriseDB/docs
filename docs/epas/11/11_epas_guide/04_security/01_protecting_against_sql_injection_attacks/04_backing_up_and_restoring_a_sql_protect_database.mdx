...
<div id="backing_up_and_restoring_a_sql_protect_database" class="registered_link"></div>
...
**Step 7:** Run the function `import_sqlprotect('`*`sqlprotect_file`*`')` where *`sqlprotect_file`* is the fully qualified path to the file you created in Step 2 of Section [4.1.4.2](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/user-guides/user-guide/11/EDB_Postgres_Advanced_Server_Guide.1.052.html#pID0E0MWC0HA).
