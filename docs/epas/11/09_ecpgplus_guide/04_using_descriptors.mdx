...
| `DATETIME_INTERVAL_CODE`      | `integer` | If `TYPE` is 9:<br/>`1 - DATE`<br/>`2 - TIME`<br/>`3 - TIMESTAMP`<br/>`4 - TIME WITH TIMEZONE`<br/>`5 - TIMESTAMP WITH TIMEZONE` |
...
| `TYPE`                        | `integer` | A numeric code that represents the data type of the column: <br/>`1 - SQL3_CHARACTER`<br/>`2 - SQL3_NUMERIC3 - SQL`<br/>`3_DECIMAL`<br/>`4 - SQL3_INTEGER`<br/>`5 - SQL3_SMALLINT`<br/>`6 - SQL3_FLOAT`<br/>`7 - SQL3_REA`L<br/>`8 - SQL3_DOUBLE_PRECISION`<br/>`9 - SQL3_DATE_TIME_TIMESTAMP`<br/>`10 - SQL3_INTERVAL`<br/>`12 - SQL3_CHARACTER_VARYING`<br/>`13 - SQL3_ENUMERATED`<br/>`14 - SQL3_BIT`<br/>`15 - SQL3_BIT_VARYING`<br/>`16 - SQL3_BOOLEAN` |
