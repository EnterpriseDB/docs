...
Use the drop-down listbox in the `Startup type` field (shown in Figure 4.2) to specify how the Advanced Server service will behave when the host starts.

![](images/specifying_advanced_servers_startup_behavior.png)

<center><i>Figure 4.2 - Specifying Advanced Server’s startup behavior.</i></center>
