...
> C:\Program Files\edb\as11\pgplus_env.bat

As the `pgplus_env.bat` script executes, it sets the following environment variables:

> `PATH="C:\Program Files\edb\as11\bin";%PATH%`
>
> `EDBHOME=C:\Program Files\edb\as11`
>
> `PGDATA=C:\Program Files\edb\as11\data`
>
> `PGDATABASE=edb`
>
...
> `PGPORT=5432`
>
> `PGLOCALEDIR=C:\Program Files\PostgreSQL\11\share\locale`