...
<div id="drop_program_argument" class="registered_link"></div>

Use the `DROP_PROGRAM_ARGUMENT` procedure to drop a program argument. The DROP_PROGRAM~_ARGUMENT procedure comes in two forms; the first form uses an argument position to specify which argument to drop:
