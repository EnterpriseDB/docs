...
<div id="using_calendar_syntax_to_specify_a_repeating_interval" class="registered_link"></div>
...
| `BYDAY`      | `BYDAY=`*`weekday`*                     | Where *`weekday`* is a three-letter abbreviation or single-digit value representing the day of the week.  <br/> `Monday`        `MON         ` 1 <br/>`Tuesday`     `TUE`   2 <br/>`Wednesday`   `WED`   3 <br/>`Thursday`  `THU`  4 <br/>`Friday`  `FRI`  5 <br/> `Saturday`  `SAT`  6 <br/>`Sunday`  `SUN  `  7 |
| `Monday`     | `MON`                                   | 1                                                            |
| `Tuesday`    | `TUE`                                   | 2                                                            |
| `Wednesday`  | `WED`                                   | 3                                                            |
| `Thursday`   | `THU`                                   | 4                                                            |
