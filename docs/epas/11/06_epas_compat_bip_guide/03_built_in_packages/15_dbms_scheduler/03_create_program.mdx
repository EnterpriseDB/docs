...
<div id="create_program" class="registered_link"></div>
...
>  *`comments`* I`N VARCHAR2 DEFAULT NULL)`
...
>
> If *`program`*_*type* is `PROCEDURE`, *`number_of_arguments`* specifies the number of arguments required by the procedure. The default value is `0`.
