---
title: "Upgrading to Advanced Server 11 – Step-by-Step"
---

<div id="upgrading_to_advanced_server_11_step_by_step" class="registered_link"></div>
...
If a problem occurs during the upgrade process, you can revert to the previous version. See [Section 4.6](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/installation-getting-started/upgrade-guide/11/EDB_Postgres_Advanced_Server_Upgrade_Guide.1.15.html#), *Reverting to the Old Cluster* for detailed information about this process.
...
![](images/configuring_advanced_server_to_use_trust_authentication.png)

<center><i>Figure 4.1 - Configuring Advanced Server to use trust authentication.</i></center>
...
> `-b /usr/edb/as10/bin -B /usr/edb/as11/bin -p 5444 -P 5445 --check`
...
```
`$ pg_upgrade -d /var/lib/edb/as10/data -D /var/lib/edb/as11/data -U enterprisedb -b /usr/edb/as10/bin -B /usr/edb/as11/bin -p 5444 -P 5445`
...
<center><i>Before removing the old cluster, ensure that the cluster has been upgraded as expected, and that you have preserved a backup of the cluster in case you need to revert to a previous version.</i></center>
