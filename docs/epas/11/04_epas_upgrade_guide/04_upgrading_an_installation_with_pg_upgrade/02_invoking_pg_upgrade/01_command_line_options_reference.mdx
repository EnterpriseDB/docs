...
<div id="command_line_options_reference" class="registered_link"></div>
...
> Include the `-k` or `--link` keyword to create a hard link from the new cluster to the old cluster. See [Section 4.1.1](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/installation-getting-started/upgrade-guide/11/EDB_Postgres_Advanced_Server_Upgrade_Guide.1.09.html#), *Linking versus Copying* for more information about using a symbolic link.
