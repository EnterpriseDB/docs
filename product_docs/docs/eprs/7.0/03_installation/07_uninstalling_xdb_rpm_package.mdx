---
title: "Uninstalling the EPRS RPM Package"
---

<div id="uninstalling_xdb_rpm_package" class="registered_link"></div>

If you installed Replication Server from the RPM package, you can uninstall any EPRS component by invoking the yum remove package_name command as the root account where package_name is any Replication Server component RPM package as listed in the table in Section [Installing the EPRS RPM Package](03_installing_rpm_package/#installing_rpm_package).
