---
title: "Installing EPRS on an SLES 12 Host"
---
...
Before installing EPRS, use the following commands to add EnterpriseDB repository configuration files to your SLES host:
