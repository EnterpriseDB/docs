...
If you later decide you wish to remove Replication Server from your system see Section [Uninstalling Replication Server](06_uninstalling_xdb_replication_server/#uninstalling_xdb_replication_server) for directions on uninstalling Replication Server if you initially installed it with the graphical user interface or by invoking the installer program from the command line. See [Uninstalling the EPRS RPM Package](07_uninstalling_xdb_rpm_package/#uninstalling_xdb_rpm_package) for directions on uninstalling Replication Server that was installed from the RPM package.
