...
EPRS supports modulus operator (denoted by %) to define a filter clause. However, the following restrictions apply:
...
EPRS supports the modulus filter in the following formats:
