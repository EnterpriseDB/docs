...
The tables and views in a given publication must all be replicated to the same database. This database is called the subscription database. You must create a subscription database user name with the following characteristics:
