...
!!! Note
    For Windows: If you give a new admin password during an upgrade, it will be ignored, and after the upgrade, Replication Server will pick the old admin and user name and password (which is saved in edb-replconf).