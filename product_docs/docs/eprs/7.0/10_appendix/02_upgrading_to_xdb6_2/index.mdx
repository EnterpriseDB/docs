...
It is assumed that you will be installing Replication Server 7.0 on the same host machine that is currently running Replication Server 6.1.x or 6.0.x, and that you will then manage the existing replication systems using Replication Server 7.0.
