...
**Creating a publication for a Postgres 9.x partitioned table**
...
**Publication containing a Postgres 9.x partitioned table**
...
**MMR system with a Postgres 9.x partitioned table**
