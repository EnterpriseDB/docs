...
1.  If you defined table filters on the newly added table and you want to use these filters on any subscriptions or primary nodes, you must enable the filters on the table in the desired subscriptions or primary nodes.
    ...
    For a single-master replication system, see [Enabling and disabling table filters on a subscription](../../05_smr_operation/05_managing_subscription/04_enable_filters_on_subscription/#enabling-and-disabling-table-filters-on-a-subscription).

    For a multi-master replication system, see [Enabling and disabling table filters on a primary node](../../06_mmr_operation/07_enable_disable_table_filters).
