...
1.  (For MMR only): If you want to modify or see the default conflict resolution options assigned to the newly added table, follow the instructions in [Updating the conflict resolution options](../../06_mmr_operation/06_conflict_resolution/12_update_conflict_resolution_options/).
