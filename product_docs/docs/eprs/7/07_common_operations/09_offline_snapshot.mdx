...
!!! Note
    Migration Toolkit can be used in parallel with Replication Server only to perform *offline* snapshots. We do not recommend using Migration Toolkit in parallel with Replication Server for online snapshots.
