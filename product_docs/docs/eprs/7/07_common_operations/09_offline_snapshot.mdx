...
!!! Note
    You should only use MigrationToolkit in parallel with Replication Server to perform *offline* snapshots. We do not recommended using Migration Toolkit in parallel with Replication Server for online snapshots.
