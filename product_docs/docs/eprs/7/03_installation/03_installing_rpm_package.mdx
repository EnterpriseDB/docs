...
Successful installation of Replication Server results in the creation of directory structures and files in your host environment as described in [Installation details](/eprs/7/03_installation/installation_details).
