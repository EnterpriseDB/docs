...
Successful installation of Replication Server results in the creation of directory structures and files in your host environment as described in [Installation details](03_installing_rpm_package/installation_details/).
...
1. Complete the [Installation steps for Linux](#installation-steps-for-linux-on-x86-64-amd64) or the [Installation steps for RHEL 8](#installation-steps-for-rhel-8-on-ibm-power-ppc64le).
