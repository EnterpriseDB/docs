...
EDB provides an interactive installer for Windows on the Downloads page. You can either invoke the interactive installer directly or use Stack Builder or StackBuilder Plus on PostgreSQL or EDB Postgres Advanced Server, respectively, to download and invoke the installer. 
...
For details on getting started with Stack Builder on PostgreSQL, see [Using Stack Builder](https://www.enterprisedb.com/docs/supported-open-source/postgresql/installer/03_using_stackbuilder/). Follow the prompts until you get to the module selection window, expand the Registration-Required and Trial Products node, expand the EnterpriseDB Tools node, and select Replication Server. Proceed to [Using the interactive installer](#using-the-interactive-installer).

For details on getting started with StackBuilder Plus on EDB Postgres Advanced Server, see [Using StackBuilder Plus](/epas/latest/epas_inst_windows/installing_advanced_server_with_the_interactive_installer/using_stackbuilder_plus/). Follow the prompts until you get to the module selection window, expand the EnterpriseDB Tools node and select Replication Server. Proceed to [Using the interactive installer](#using-the-interactive-installer).
