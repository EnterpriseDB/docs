...
If you installed Replication Server from the RPM package, uninstall it using the Yum package manager. See Section [Uninstalling a RPM package installation](06_uninstalling_xdb_replication_server/#uninstalling-a-rpm-package-installation) for information.
