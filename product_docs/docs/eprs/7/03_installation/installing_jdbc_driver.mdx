...
Which JDBC driver you use depends on the what database you're using. If you're using:
...
- **PostgreSQL**, use the PostgreSQL JDBC driver. To download the latest supported driver, see the [JDBC drivers section](https://jdbc.postgresql.org/download/) on the PostgreSQL Downloads page. 
