...
1. Select the SMR type node under the Publication Server node. Select **Publication > Publication Database > Add Database**. 

1. In the Publication Service – Add Database dialog box, fill in the following fields:
