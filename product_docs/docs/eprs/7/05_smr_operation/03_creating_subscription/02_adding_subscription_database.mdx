...
1. Select the Subscription Server node. Select **Subscription > Subscription Database > Add Database**.

1. In the Subscription Service – Add Database dialog box, fill in the following fields:
