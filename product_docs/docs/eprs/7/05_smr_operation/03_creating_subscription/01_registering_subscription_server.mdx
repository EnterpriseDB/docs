...
-   **Port**. Port number the subscription server is using. You can find the port number in the `xdbReplicationServer-xx.config file`. See [Installation details](/eprs/7/03_installation/installation_details) for the location of the file.
-   **User Name**. Admin user name used to authenticate your use of this subscription server. You can find the user name in the `edb-repl.conf` file. See [Installation details](/eprs/7/03_installation/installation_details) for the location of the file.
