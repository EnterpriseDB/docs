...
-   **Port**. Port number the subscription server is using. ou can find the port number in the `xdbReplicationServer-xx.config file`. See [Installation details](/eprs/7/03_installation/installation_details) for the location of the file.
