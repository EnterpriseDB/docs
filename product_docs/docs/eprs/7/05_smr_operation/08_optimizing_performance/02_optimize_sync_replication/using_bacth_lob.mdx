...
Upgrade your instances to a Replication Server version that includes this feature. See [Release notes](../../../eprs_rel_notes) for an overview of the available release versions and the included enhancements. 
