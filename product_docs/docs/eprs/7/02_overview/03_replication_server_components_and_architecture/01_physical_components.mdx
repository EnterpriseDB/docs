...
See [Installation details](/eprs/latest/03_installation/installation_details) for the file system location of the EPRS Replication Configuration file.
...
See [Installation details](/eprs/latest/03_installation/installation_details) for the file system location of the Replication Server configuration file.
