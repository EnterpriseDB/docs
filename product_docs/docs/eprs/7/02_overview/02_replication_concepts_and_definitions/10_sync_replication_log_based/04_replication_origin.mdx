...
If the replication slots aren't properly deleted when required, see [Dropping replication slots for log-based synchronization replication](../../../10_appendix/02_resolving_problems/04_troubleshooting_areas/#drop_replication_slots_for_log_based) to learn how to delete them manually.
