...
![Logical replication slots with publication database standby before failover](/eprs/latest/images/eprs_logical_rep_600w.svg)

### After failover 

![Logical replication slots with publication database standby after failover](/eprs/latest/images/eprs_logical_rep_failover_600w.svg)
