...
-updatesub subname
  ...
  -port newpubsvr_port
[ -passwordEncryptionMethod { DES-MD5 | AES-SHA256 } ]
```
...
See [Updating a subscription](../../05_smr_operation/05_managing_subscription/#updating-a-subscription) for more information.
...
Specify this option if you want to override the default DES-MD5 encryption method. Set to `-passwordEncryptionMethod=AES-SHA256` to use a stronger encryption algorithm that supports FIPS standards.
