...
You can find conflicts using the **Conflict History** tab in the Replication Server console, described in [Viewing conflict history](../11_view_conflict_history/). 
