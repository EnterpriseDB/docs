...
You can find conflicts on the **Conflict History** tab as described in [Viewing conflict history](../11_view_conflict_history/). In the **Conflict History** tab, select **Refresh** to show all the latest conflicts.
