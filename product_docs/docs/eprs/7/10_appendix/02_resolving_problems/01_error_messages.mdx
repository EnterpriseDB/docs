...
Occurs when adding a Publication Database and Oracle is installed using the JA16SJIS character set encoding. This may happen even if `orai18n.jar` is explicitely added to the `lib/jdbc` folder.
