...
-   Special configuration options for multi-master replication. (See [Optimizing performance](../../../06_mmr_operation/12_optimizing_performance_mmr) for details on these options.)
