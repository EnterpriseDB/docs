...
redirects:
- /eprs/latest/10_appendix/04_miscellaneous_xdb_processing_topics/01_publications_and_subscriptions_server_conf_options
navigation: 
  - 01_controlling_logging_level
  - 03_schema_migration_options
  - 06_snapshot_replication_options
  - snapshot_connection_retry
  - 07_assign_ip_adress_for_rmi
  - 08_using_pgagent_job_scheduling
  - 09_forcing_shadow_table_cleanup
  - 10_setting_event_history_cleanup
  - 11_ddl_change_replication_table_locking
  - 12_persisting_zero_txn_replication_hist
  - 13_skipping_grants_of_table_level_user_privileges_on_mmr
  - 14_applying_grants_of_table_level_user_privileges_on_smr
  - skip_default_column
  - 15_log_based_sync_options
  - 16_setting_apache_dbcp_connection_validation_query
  - 04_replicate_oracle_partitioned_tables
  - 05_specify_custom_url_for_oracle_jdbc
  - 02_replacing_null_characters
  - single_quote_unescape
---
...
-   Special configuration options for multi-master replication. (See [Optimizing performance](../../../06_mmr_operation/10_optimizing_performance_mmr) for details on these options.)
...
1.  Restart the publication or subscription server.
    ...
    Use the following command for RHEL/Rocky Linux/AlmaLinux 8.x or later:
