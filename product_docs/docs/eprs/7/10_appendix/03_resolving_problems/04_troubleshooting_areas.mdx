...
See [Replication Server configuration file](../../02_overview/03_replication_server_components_and_architecture/01_physical_components/#xdb_replication_conf_file) for information on the Replication Server configuration file. See [Installation details](/eprs/latest/03_installation/03_installing_rpm_package/installation_details) for the file system location of the Replication Server configuration file.
