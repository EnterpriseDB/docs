...
| <br /><br /><br />`ppas-xdb`<br /><br />            | All components                                                                |
| <br /><br /><br />`ppas-xdb-console`<br /><br />    | xDB Replication Console and the xDB Replication Server Command Line Interface |
| <br /><br /><br />`ppas-xdb-publisher`<br /><br />  | Publication server                                                            |
| <br /><br /><br />`ppas-xdb-subscriber`<br /><br /> | Subscription server                                                           |
| <br /><br /><br />`ppas-xdb-libs`<br /><br />       | Library files required by all components                                      |
