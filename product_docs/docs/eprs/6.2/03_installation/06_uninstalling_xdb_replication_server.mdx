...
If you installed xDB Replication Server using the xDB Replication Server installer program invoked from Stack Builder or StackBuilder Plus as described in Section [Installing With Stack Builder or StackBuilder Plus](../03_installation/#installing_with_stackbuilder) or you invoked the xDB Replication Server installer program from the command line as described in Section [Installing from the Command Line](../03_installation/#installing_from_cli), uninstall xDB Replication Server by invoking the `uninstall-xdbreplicationserver` script as described in this section.

If you installed xDB Replication Server from the RPM package, uninstall it using the Yum package manager. See Section [Uninstalling the xDB RPM Package](../03_installation/#uninstalling_xdb_rpm_package) for information.
