...
See [Control Schema Objects Created for a Publication](../05_smr_operation/02_creating_publication/#control_schema_objects_created_for_publication) for the control schema objects created in each primary node.
