...
The target node wins the conflict as determined by the setting of the resolution\_code parameter to a value of 2 in the custom conflict handling function.
