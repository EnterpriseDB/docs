...
Conflicts can be found using the `Conflict History` tab as described in Section [Viewing Conflict History](../../../06_mmr_operation/#view_conflict_history). The following is an example of the Conflict History tab. Click the `Refresh` button to reveal all of the latest conflicts.
