...
| `t3`           | Synchronization pushes Node A changes to Node B                                                | id = 2, address = 'ADDR B1'               | **The row with id = 2 is already deleted on target Node B, hence update from Node A fails.**                             |
