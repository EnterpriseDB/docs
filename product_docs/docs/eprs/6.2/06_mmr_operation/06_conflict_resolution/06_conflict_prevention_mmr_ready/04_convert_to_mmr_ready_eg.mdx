...
The multi-master replication system is created using databases `MMRnode_a`, `MMRnode_b`, and `MMRnode_c` in a similar manner as described in Section [MMR-Ready Sequence Example](../../../06_mmr_operation/06_conflict_resolution/06_conflict_prevention_mmr_ready/#mmr_ready_example).
