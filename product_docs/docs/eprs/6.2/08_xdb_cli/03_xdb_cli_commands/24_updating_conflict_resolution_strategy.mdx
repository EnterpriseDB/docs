...
See [Updating the Conflict Resolution Options](../../06_mmr_operation/#update_conflict_resolution_options) for additional information on updating the conflict resolution strategy.
