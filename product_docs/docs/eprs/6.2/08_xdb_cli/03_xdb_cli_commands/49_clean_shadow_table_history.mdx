...
See [Cleaning Up Shadow Table History](../../08_xdb_cli/03_xdb_cli_commands/#clean_shadow_table_history) for additional information on cleaning up shadow table history.
