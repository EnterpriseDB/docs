...
> A cron expression. See appendix Section [Writing a Cron Expression](../../10_appendix/04_miscellaneous_xdb_processing_topics/#writing_cron_exp) for information on writing a cron expression.
