...
See [Cleaning Up Replication History](../../08_xdb_cli/03_xdb_cli_commands/#clean_replication_history) for additional information on cleaning up replication history.
