...
See [Validating a Publication](../../07_common_operations/06_managing_publication/#validating_publication) for additional information on validating publications.
