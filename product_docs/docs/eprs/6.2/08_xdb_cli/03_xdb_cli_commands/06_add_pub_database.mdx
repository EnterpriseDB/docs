...
> Extended usage of JDBC URL parameters such as for support of SSL connectivity. (See Section <span class="title-ref">Preparing Using Secure Sockets Layer (SSL) Connections &lt;using_ssl_connections></span> for information on SSL connectivity to the publication database.)
