...
See [Removing a Subscription Database](../../05_smr_operation/05_managing_subscription/#removing_subscription_database) for additional information on removing a subscription database.
