...
The next, subsequent replication to any target subscriptions or non-MDN nodes on which these filter rules had been enabled reflects the changes to the filter clauses.
