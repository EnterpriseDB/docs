...
See [Performing Synchronization Replication](##perform_sync_replication) for additional information on performing synchronization replication for a single-master replication system. See [Performing Synchronization Replication](##perform_sync_replication) for a multi-master replication system.
