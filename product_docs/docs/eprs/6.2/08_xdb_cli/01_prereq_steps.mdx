...
**Step 2:** Follow the prerequisite steps given in Section [Prerequisite Steps](/eprs/6.2/05_smr_operation/01_prerequisites/) for single-master replication systems or Section [Prerequisite Steps](/eprs/6.2/06_mmr_operation/01_pre_steps/) for multi-master replication systems.
