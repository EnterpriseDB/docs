...
!!! Note
    EDB Postgres Replication Server 6.2 is no longer supported on `CentOS/RHEL/OL 6.x` platforms. It is strongly recommended that EDB products running on these platforms should be migrated to a supported platform.
