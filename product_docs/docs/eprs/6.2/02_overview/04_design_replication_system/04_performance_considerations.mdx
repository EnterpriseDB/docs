...
When your replication system is ready for production, a schedule would typically be used so that replications can occur unattended at regular time intervals. See [Creating a Schedule](../../07_common_operations/#creating_schedule) for directions on creating a schedule.
