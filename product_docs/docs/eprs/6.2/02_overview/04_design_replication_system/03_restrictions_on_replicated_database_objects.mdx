...
!!! Note
    See <span class="title-ref">Replicating the SQL Server SQL_VARIANT Data Type &lt;replicating_sql_server_sql_variant_data_type></span> for a method to replicate tables containing the `SQL_VARIANT` data type under certain conditions.
