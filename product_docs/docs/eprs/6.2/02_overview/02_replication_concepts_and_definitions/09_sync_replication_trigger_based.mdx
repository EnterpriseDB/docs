...
Oracle and SQL Server databases can only be used as a publication database with the trigger-based method. Additionally, Oracle and SQL Server databases can only be used as a subscription database with the WAL-based replication method.
