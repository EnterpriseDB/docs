...
See [Performance Considerations](../../02_overview/04_design_replication_system/#performance_considerations) for a discussion of the advantages of using a snapshot-only publication.
