...
The persistence I/O overhead can be minimized by increasing the heap size value and defining a more frequent synchronization interval such as for every few seconds. See [Creating a Schedule](../../../07_common_operations/#creating_schedule) for information on setting a replication schedule.
