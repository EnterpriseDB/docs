...
In the xDB Replication Console, view the replication history. See [Viewing Replication History](../../07_common_operations/#view_replication_history).
...
See <span class="title-ref">Controlling Logging Level, Log File Sizes, and Rotation Count &lt;controlling\_logging\_level&gt;</span> for more information on setting log file options.
...
The severity level of messages logged in these files can be controlled by a configuration option. See <span class="title-ref">Controlling Logging Level, Log File Sizes, and Rotation Count &lt;controlling\_logging\_level&gt;</span>.
...
See [xDB Replication Configuration File](../../02_overview/03_replication_server_components_and_architecture/#xdb_replication_conf_file)  
