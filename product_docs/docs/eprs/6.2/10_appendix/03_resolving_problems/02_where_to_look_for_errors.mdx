...
See <span class="title-ref">Controlling Logging Level, Log File Sizes, and Rotation Count &lt;controlling_logging_level></span> for more information on setting log file options.
...
!!! Note
    The severity level of messages logged in these files can be controlled by a configuration option. See <span class="title-ref">Controlling Logging Level, Log File Sizes, and Rotation Count &lt;controlling_logging_level></span>.
