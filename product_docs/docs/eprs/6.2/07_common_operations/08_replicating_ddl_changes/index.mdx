...
> The name of the schema containing table\_name. This value is case-sensitive.
...
> Collation assigned to the column. If omitted, the column data type’s default collation is used. Examples of collation are default, C, POSIX, en\_US, en\_GB, or de\_DE.
