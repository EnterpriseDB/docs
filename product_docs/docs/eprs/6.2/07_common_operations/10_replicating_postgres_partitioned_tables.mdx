...
-   For creating a publication in Postgres 10 or later, see Section [Creating a Postgres Version 10 or Later Partitioned Table Publication](#creating-a-postgres-version-10-or-later-partitioned-table-publication).
...
Section [Creating a Postgres Version 10 or Later Partitioned Table Publication](#creating-a-postgres-version-10-or-later-partitioned-table-publication) shows creation of the publication when using partitioning compatible with Oracle databases or declarative partitioning on a Postgres 10 or later database server.
