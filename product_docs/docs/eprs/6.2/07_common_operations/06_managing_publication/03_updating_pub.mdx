...
For a multi-master replication system, see <span class="title-ref">Enabling/Disabling Table Filters on a Primary node &lt;enable_disable_table_filters></span> for directions on enabling table filters on a primary node.
