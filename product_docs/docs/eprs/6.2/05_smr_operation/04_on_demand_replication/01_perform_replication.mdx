...
The publication has now been replicated to the subscription database. A record of the snapshot is maintained in the replication history. See [Viewing Replication History](../../07_common_operations/#view_replication_history) for information on how to view replication history.
