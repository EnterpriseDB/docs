...
When creating a subscription, you may selectively enable these table filters on the corresponding subscription tables. See [Adding a Subscription](../../05_smr_operation/03_creating_subscription/#adding_subscription) for information on creating a subscription.
