...
After you have added a subscription database definition you will find a single table named rrep\_txset\_health has been created as the subscription metadata object.
