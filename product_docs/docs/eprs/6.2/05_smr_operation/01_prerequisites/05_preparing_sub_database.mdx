...
When creating the subscription database definition, the subscription database user name is entered in the Subscription Service – Add Database dialog box (see [Adding a Subscription Database](../../05_smr_operation/03_creating_subscription/#adding_subscription_database)).
...
When creating the subscription database definition, the SQL Server login is entered in the Subscription Service – Add Database dialog box (see [Adding a Subscription Database](../../05_smr_operation/03_creating_subscription/#adding_subscription_database)).
