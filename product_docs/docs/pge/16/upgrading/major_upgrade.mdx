...
!!!note 
   You can perform major upgrades of EDB Postgres Extended Server instances in the same way you would upgrade an EDB Postgres Advanced Server installation. If you need more information about the `pg_upgrade` utility, command line options, troubleshooting, and more, see [Upgrading an installation with pg_upgrade](/epas/latest/upgrading/04_upgrading_an_installation_with_pg_upgrade/).
