...
1. Install the new version of EDB Postgres Extended Server. 
1. Use the EDB Postgres Extended Server's initdb utility to create an empty server. 
1. Use pg_upgrade to migrate all data from your source database server into the new server. 
