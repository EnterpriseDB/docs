...
```shell
sudo apt-get -y install edb-pge<xx>
```

Where `<xx>` is the version of EDB Postgres Extended Server you are installing. For example, if you are installing version 15, the package name would be `edb-pge15`.
