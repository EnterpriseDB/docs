---
navTitle: SLES 15
title: Installing EDB Postgres Extended Server on SLES 15 ppc64le
...
- Enable the required development SUSE modules:
  ```shell
...
```shell
sudo zypper -n install edb-postgresextended17-server edb-postgresextended17-contrib
```
...
sudo SUSEConnect -p sle-module-desktop-applications/15.7/ppc64le
sudo SUSEConnect -p sle-module-development-tools/15.7/ppc64le
sudo zypper install edb-postgresextended17-devel
```
