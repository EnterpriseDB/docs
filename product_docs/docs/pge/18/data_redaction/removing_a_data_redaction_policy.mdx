...
description: "How to use the DROP_REDACTION_POLICY api to remove a data redaction policy from a table"
---

The `DROP_REDACTION_POLICY` API removes a data redaction policy from a table.
