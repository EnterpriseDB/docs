...
laptop or computer using EDB Postgres® AI for CloudNativePG™ Global Cluster (CNPG-GC)
on a single local
...
Some sample files are included in the CNPG-GC repository.
