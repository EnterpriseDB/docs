...
Some sample files are included in the EDB Postgres Distributed for Kubernetes repository.
...
!!! Note Regions and availability zones
    ...
    `-group` services. You can achieve this by deploying a network connectivity
    application like [Submariner](https://submariner.io/)
    on every cluster.
