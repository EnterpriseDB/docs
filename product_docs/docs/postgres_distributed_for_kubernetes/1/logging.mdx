...
EDB Postgres Distributed for Kubernetes outputs logs in JSON format directly to standard output,
...
As EDB Postgres Distributed for Kubernetes leverages the EDB Postgres for Kubernetes clusters
...
!!! Important
    ...
    started will cause the nodes restart.
...
EDB Postgres Distributed for Kubernetes offers seamless and native support for
