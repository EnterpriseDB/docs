...
In a few seconds, you should see the nodes start resuming, and the pods
being re-created.
...
in a pause state. Ideally, the PGD Group should be in Healthy state. Alternatively, if
