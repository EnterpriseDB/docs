...
!!! Important
    ...
    See [Accessing EDB private image registries](identify_images/private_registries.md) for details.
...
-   `@@REPOSITORY@@` is the name of the repository, as explained in [Which repository to
    choose?](identify_images/private_registries.md#which-repository-to-choose).
-   `@@TOKEN@@` is the repository token for your EDB account, as explained in
    [How to retrieve the token](identify_images/private_registries.md#how-to-retrieve-the-token).
