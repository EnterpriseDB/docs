...
-   Logical join
      ...
      It's recommended that the new database contain only the BDR extension, as data synchronization occurs during
      the join.
...
For more information about join methods, see [Creating and joining PGD groups](/pgd/5.9/node_management/creating_and_joining/#creating-and-joining-pgd-groups).
