...
[Terminology](/pgd/5.9/terminology/) in the PGD documentation.

[Data node](/pgd/5.9/terminology/#node)
: A PGD database instance.

[Failover](/pgd/5.9/terminology/#failover)
...
[Switchover](/pgd/5.9/terminology/#switchover)
...
[Write leader](/pgd/5.9/terminology/#write-leader)
