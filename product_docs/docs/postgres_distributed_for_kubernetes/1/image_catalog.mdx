...
spec:
  images:
    - major: 15
      image: docker.enterprisedb.com/k8s_enterprise_pgd/edb-postgres-extended:15.10-5.6.1
    - major: 16
      image:  docker.enterprisedb.com/k8s_enterprise_pgd/edb-postgres-extended:16.6-5.6.1
  proxyImage: docker.enterprisedb.com/k8s_enterprise_pgd/edb-pgd-proxy:5.6.0-1
```
