...
spec:
  images:
    - major: 15
      image: docker.enterprisedb.com/k8s/edb-postgres-extended:15.12-5.7.0-1
    - major: 16
      image:  docker.enterprisedb.com/k8s/edb-postgres-extended:16.8-5.7.0-1
  proxyImage: docker.enterprisedb.com/k8s/edb-pgd-proxy:5.7.0-1
```
...
[PGD Operand images](supported_versions.md#pgd-operand-images) section. These images are the most recent
stored in the k8s_enterprise_pgd repository.
