...
Set the environment variables for the `REPOSITORY_NAME` and `EDB_SUBSCRIPTION_TOKEN`: 
...
!!! Important
    ...
    To identify your access credentials, see [Accessing EDB private image registries](identify_images/private_registries.md).
