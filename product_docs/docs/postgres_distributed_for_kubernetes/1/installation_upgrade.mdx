...
!!! Note
    We are upgrading the repository in cloudsmith. Please use `enterprise` subscription as the first choice.
    If you must use `standard` repository, contact Support before proceeding.
