...
kubectl apply --server-side -f \
  https://get.enterprisedb.io/pg4k-pgd/pg4k-pgd-2.1.0.yaml
```
...
!!! Note
    ...
    and PGD extension versions, please refer to the [Detailed support status](supported_versions.md#detailed-support-status) section document.
...
The [release notes](rel_notes/) contain a detailed list of the
...
!!! Note
    ...
    For more information about the PGD upgrade, please refer to the [manual upgrade guide](/pgd/latest/upgrades/upgrading-pgd/).
