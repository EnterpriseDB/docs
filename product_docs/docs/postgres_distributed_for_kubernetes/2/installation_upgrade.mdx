...
For more details, see [EDB CloudNativePG Global Cluster operator configuration](operator_conf.md#edb-postgres-ai-cloudnativepg-global-cluster-operator-configuration).
