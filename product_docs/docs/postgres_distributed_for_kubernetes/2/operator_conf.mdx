...
The operator for EDB CloudNativePG Global Cluster (PGD4K) is installed from a standard
...
type: Opaque
stringData:
  PGD_IMAGE_NAME: docker.enterprisedb.com/k8s/postgresql-pgd:17.6-pgd612-expanded-ubi
```
