...
1.  Your [EDB account token](/repos/getting_started/get_your_token/)
1.  The name of the repository, which will be `k8s`
1.  The repository server, which will be `docker.enterprisedb.com`
...
obtained from the [EDB portal](/repos/getting_started/get_your_token/).
