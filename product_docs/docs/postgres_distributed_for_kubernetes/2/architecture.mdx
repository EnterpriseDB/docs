...
See [Choosing your architecture](/pgd/latest/planning/architecture/) in the PGD documentation
...
[Choosing your architecture](/pgd/latest/planning/architecture/always-on/) in the PGD documentation on
