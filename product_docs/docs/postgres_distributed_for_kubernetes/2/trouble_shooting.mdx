...
To migrate schemas and data, you can use traditional Postgres migration tools such as [EDB\*Loader](/pgd/latest/data_migration/edbloader/) or [Migration Toolkit](/migration_toolkit/latest/)/[Replication Server](/eprs/latest/).
...
For example, your EDB CloudNativePG Global Cluster instance will be affected by these [known issues and limitations](/pgd/latest/known_issues/).
