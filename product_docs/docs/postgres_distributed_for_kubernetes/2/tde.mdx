...
!!! Important
    ...
    Before you proceed, please take some time to familiarize yourself with the
...
The support for TDE on EDB Postgres® AI for CloudNativePG™ Global Cluster relies on the
implementation from PG4K. See
...
!!! Seealso "EDB Postgres Advanced Server documentation"
    ...
    for details on this encryption key.

TDE on EDB CloudNativePG Global Cluster relies on the PG4K
implementation.
