...
!!!Note
For a large database, where replaying WAL from the base backup can take a long time, see [Joining large PGD nodes with 2 steps](https://knowledge.enterprisedb.com/hc/en-us/articles/29646154697372-Joining-large-PGD-nodes-with-2-steps) for a procedure that takes the base backup separately first and protects the WAL with a permanent replication slot.
!!!
