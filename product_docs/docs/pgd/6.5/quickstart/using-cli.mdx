...
redirects:
  ...
  - /pgd/latest/quickstart/using-cli/
  - /pgd/latest/overview/quickstart/using-cli/
---
...
It's already installed and configured if you are using the [Quickstart Docker Compose kit](first-cluster/).
