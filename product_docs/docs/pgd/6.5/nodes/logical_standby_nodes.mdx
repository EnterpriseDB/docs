...
the node with [`bdr.create_node`](/pgd/latest/reference/tables-views-functions/nodes-management-interfaces#bdrpromote_node).

Later, if you want, use
[`bdr.promote_node`](/pgd/latest/reference/tables-views-functions/nodes-management-interfaces#bdrpromote_node)
...
that act similarly to DDL also aren't replicated. See [DDL replication](../advanced-functionality/ddl/).
