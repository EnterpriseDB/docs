...
PGD 6.5.0 is PGD 6's last feature release and adds PostgreSQL 19 support. After that, PGD 6 gets bug fixes and security patches only through regular patch versions released up until its end-of-life date. See the [EDB Platform Compatibility page](https://www.enterprisedb.com/resources/platform-compatibility#bdr) for the current, authoritative supported-versions table, including OS and CPU architecture compatibility.
