...
-   Community Postgres 18.6 and later minor releases add the `output_plugin_libraries` parameter, which
    ...
    as `library "bdr" may not be used as an output plugin`. See [Postgres
