...
!!! Note "EDB Postgres Extended 18 requires 18.6.0 or later"
EDB Postgres Extended versions 18.1.0 through 18.5.x aren't compatible with PGD 6. Use EDB Postgres Extended 18.6.0 or later instead.
!!!
