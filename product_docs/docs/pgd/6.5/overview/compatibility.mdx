...
!!! Note
If you're running PGD on community Postgres 18 and
upgrading to Postgres 18.6 or later, add `bdr` to the new `output_plugin_libraries` parameter and
reload the configuration, or PGD's replication slots stop working. See [Postgres
