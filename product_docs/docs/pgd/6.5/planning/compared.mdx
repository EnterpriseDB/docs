...
description: A comparison of EDB Postgres Distributed with other replication solutions, including PGD HM-managed and PSR + EFM.
redirects:
...
| Product | Version |
|---|---|
| PGD Standalone | {{version.full}} |
| PGD HM-managed | {{version.full}} |
| PSR + EFM | 5.3 |
...
| PGD HM-managed | ✓ | ✓ | ✓ | ✓ (snowflake (bigint), galloc (int/bigint)) | ✓ |
...
| PGD HM-managed | ✓ | ✓ | ✓ | ✓ | ✓ (rewrite requires permit_unsafe_commands) | ✓ (with restrictions) |
| PSR + EFM | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
| PGD HM-managed | 18 | ✗ | ✓ with EPAS/PGE | ✓ | Many | ✓ (PGD 5.7+) | ✗ | ✗ |
...
| PGD HM-managed | ✓ | ✓ | Hybrid Manager, SQL, CLI, edbctl |
