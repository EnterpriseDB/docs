...
redirects:
  ...
  - /pgd/latest/reference/node_management/automatic_sync/ #generated for DOCS-3034
---

## Auto-triggering the Sync

The BDR manager process does the auto-triggering of sync requests. When there are no updates from a node for an interval of time greater than [`bdr.raft_global_election_timeout`](/pgd/current/reference/tables-views-functions/pgd-settings#bdrraft_global_election_timeout) (default 6s), it is considered to be down. 
