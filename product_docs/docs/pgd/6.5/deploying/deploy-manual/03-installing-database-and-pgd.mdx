...
In this example, we will install EDB Postgres Extended Server 17 with PGD on a CentOS/RHEL system  using the repository configuration we set up in the [previous step's worked example](02-configure-repositories#worked-example).
