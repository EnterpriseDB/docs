...
redirects:
  ...
  - /pgd/latest/transaction-streaming/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/transaction-streaming/ #generated for DOCS-3034
  - /pgd/latest/transaction-streaming/ #generated for DOCS-3995-new
---
...
However, PGD supports Parallel Apply, enabling multiple writer
...
-   At node level, using the GUC [`bdr.default_streaming_mode`](/pgd/latest/reference/tables-views-functions/pgd-settings/#transaction-streaming)
-   At group level, using the function [`bdr.alter_node_group_option()`](/pgd/latest/reference/tables-views-functions/nodes-management-interfaces/#bdralter_node_group_option)
...
You can use the parameter `streaming_mode` in the function [`bdr.alter_node_group_option()`](/pgd/latest/reference/tables-views-functions/nodes-management-interfaces/#bdralter_node_group_option)
...
from the view [`bdr.node_group`](/pgd/latest/reference/tables-views-functions/catalogs-visible/#bdrnode_group). The value returned is
...
-   If Parallel Apply is on but all writers are already busy handling streamed
    ...
    [Monitoring PGD writers](/pgd/current/lifecycle/monitoring/sql#monitoring-pgd-writers) to check PGD
    writer status.
...
You can monitor the use of transaction streaming using the [`bdr.stat_subscription`](/pgd/latest/reference/tables-views-functions/catalogs-visible/#bdrstat_subscription)
