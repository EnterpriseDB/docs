...
navTitle: Locking
redirects:
  - /pgd/latest/ddl/ddl-locking/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/ddl/ddl-locking/ #generated for DOCS-3034
  - /pgd/latest/ddl/ddl-locking/ #generated for DOCS-3995-new
---
...
Specify locking behavior with the [`bdr.ddl_locking`](/pgd/latest/reference/tables-views-functions/pgd-settings#bdrddl_locking) parameter, as
...
-   `ddl_locking = auto` selects `leader` if possible, otherwise `all`.
...
[Monitoring](/pgd/current/lifecycle/monitoring).
