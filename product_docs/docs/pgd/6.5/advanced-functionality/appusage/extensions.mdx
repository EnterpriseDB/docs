...
redirects:
  ...
  - /pgd/latest/reference/appusage/extensions/ #generated for DOCS-3034
  - /pgd/latest/appusage/extensions/ #generated for DOCS-3995-new
---

## PGD and other PostgreSQL extensions

PGD is implemented as a PostgreSQL extension (see [Supported Postgres database servers](/pgd/latest/overview/compatibility/)). It takes advantage of PostgreSQL's expandability and flexibility to modify low-level system behavior to provide multi-master replication.
...
It must include `bdr`.
The order in which you specify other extensions generally doesn't matter.
...
See also [Postgres settings](/pgd/current/postgres-configuration/#postgres-settings).
