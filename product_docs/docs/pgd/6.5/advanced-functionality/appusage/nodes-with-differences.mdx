...
redirects:
  ...
  - /pgd/latest/reference/appusage/nodes-with-differences/ #generated for DOCS-3034
  - /pgd/latest/appusage/nodes-with-differences/ #generated for DOCS-3995-new
---

## Replicating between nodes with differences

By default, DDL is sent to all nodes. You can control this behavior, 
as described in [DDL replication](../../advanced-functionality/ddl), and you can use it to create
...
For details, see [Replication sets](/pgd/current/advanced-functionality/repsets/).
...
to create an index on only a subset of nodes or just locally, see [DDL replication](../../advanced-functionality/ddl) .
...
[Security and roles](/pgd/current/advanced-functionality/security/) for details.
...
replication](/pgd/current/advanced-functionality/ddl/) to specify how to alter a role password on only a subset of
nodes or locally.
