...
if it's currently active. See [DDL replication](../../advanced-functionality/ddl).
...
Functions for working with `KSUUID` v2 data, K-Sortable UUID data. See also [KSUUID in the sequences documentation](/pgd/current/advanced-functionality/sequences/#ksuuids).
...
Functions for working with `KSUUID` v1 data, K-Sortable UUID data(v1). Deprecated - See [KSUUID in the sequences documentation](/pgd/current/advanced-functionality/sequences/#ksuuids) for details.
