...
See also [DDL replication filtering](../../advanced-functionality/repsets#ddl-replication-filtering).
...
[DDL filters](../../advanced-functionality/repsets#ddl-replication-filtering) configuration. 
