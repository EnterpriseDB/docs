...
Requires Postgres superuser privileges to run `ALTER SYSTEM` and reload the configuration. See [User roles](/pgd/current/reference/cli/command_ref/#user-roles).
