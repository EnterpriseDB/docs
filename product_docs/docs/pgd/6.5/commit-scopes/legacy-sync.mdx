...
redirects:
  ...
  - /pgd/latest/reference/commit-scopes/legacy-sync/ #generated for DOCS-3034
---
...
using [Quorum Commit](quorum-commit) or [Synchronous Commit](synchronous_commit)
instead.
...
*(1) Consider using Quorum Commit instead.*
