...
The seed node requires PGD packages that specifically match your Postgres distribution and version (e.g., `edb-pgd6-expanded-epas17` for EPAS 17). Ensure you have configured the appropriate PGD repository before proceeding. See [Installing the database and pgd](/pgd/latest/deploying/deploy-manual/03-installing-database-and-pgd/) for details.
...
Next step: [Join additional nodes](6-join-nodes).
