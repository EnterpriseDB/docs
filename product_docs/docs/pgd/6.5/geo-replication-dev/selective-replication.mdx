...
redirects:
  - /pgd/latest/geo-replication-dev/selective-replication/
---

Use [replication sets](/pgd/current/advanced-functionality/repsets/) to control which tables replicate to which nodes, keeping sensitive or location-specific data within its region.
