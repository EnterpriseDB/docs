...
deepToC: true
redirects:
  - /pgd/latest/access-controls/inter-node-connections/
  - /pgd/latest/node_management/connections_dsns_and_ssl/
  - /pgd/latest/reference/node_management/connections_dsns_and_ssl/
  - /pgd/latest/access-controls/inter-node-connections/ #generated for DOCS-3995-new
---
...
- A [`.pgpass`](https://www.postgresql.org/docs/current/libpq-pgpass.html) file in the home directory of the Postgres process user, containing the correct password for each node. The file must have permissions `0600` or stricter. If permissions are too open, the file is silently ignored.
