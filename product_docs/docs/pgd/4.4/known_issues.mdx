...
-   Group Commit cannot be combined with [CAMO](/pgd/4.4/bdr/camo/) or [Eager All Node replication](/pgd/4.4/bdr/eager/). Eager Replication currently only works by using the "global" BDR commit scope.
