...
!!! Note
Installation of HARP proxies is not covered in this guide. For information on how to install HARP proxies, see the [HARP Proxy Installation Guide](/pgd/4.4/harp/03_installation).
!!!
