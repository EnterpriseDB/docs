...
-   Manual installation is also available where TPA is not an option. Details of how to deploy PGD manually are in the [manual installation](/pgd/4.4/deployments/manually/) section of the documentation.
