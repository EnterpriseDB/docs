...
[throughput up to 5X faster than native logical replication](https://www.enterprisedb.com/blog/performance-improvements-edb-postgres-distributed), and enables
...
or two groups in two separate locations. Each group provides HA and IS.  When two
...
standard Postgres extension. See the [Compatibility matrix](/pgd/4.4/#compatibility-matrix)
...
[Choosing a Postgres distribution](/pgd/4.4/choosing_server/).
