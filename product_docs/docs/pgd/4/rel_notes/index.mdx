...
| ------------ | ---------------------------- | ----- | ----- | ----- | -------------------------------------------------------------------------------- |
| 2023 May 17  | [4.3.1 (2023 July 12 Update)](pgd_4.3.1_rel_notes#updated-2023-july-12)| 4.3.1 | 2.3.0[^**] | 1.1.1 | [23.17](https://techsupport.enterprisedb.com/customer_portal/sw/tpa/trunk/239/)   |
