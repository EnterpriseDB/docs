...
- EDB Postgres® AI Cloud Services (formerly BigAnimal) are a fully managed database-as-a-service offering with built-in Oracle compatibility, running in your cloud account and operated by the Postgres experts. EDB Postgres® AI Cloud Services make it easy to set up, manage, and scale your databases. The addition of distributed high availability support through EDB Postres Distributed allows single-region or multi-region clusters with one or two data groups. See the [Distributed high availability](/biganimal/latest/overview/02_high_availability/distributed_highavailability/) topic in the [EDB Postgres® AI Cloud Services documentation](/biganimal/latest) for more information.
