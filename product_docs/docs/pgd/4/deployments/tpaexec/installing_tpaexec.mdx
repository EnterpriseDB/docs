...
1. Install the EnterpriseDB repository for TPAexec. 
   ...
   - **To access the RPM repository:** Replace `token` with your company token and replace `pgVersion` with the version of Postgres you are installing.
    ...
    - **To access the Debian repository:** Replace `token` with your company token.
