...
[CAMO](/pgd/latest/overview/bdr/camo), [Group Commit ](/pgd/latest/overview/bdr/group-commit), or
[eager all node replication](/pgd/latest/overview/bdr/eager) features.
