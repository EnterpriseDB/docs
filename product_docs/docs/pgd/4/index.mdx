...
| EDB Postgres | BDR       | pgLogical3 |      | Commmunity | EDB Postgres    | EDB Postgres    | PGD |
| -------------| --------- | ---------- | ---- | ---------- | --------------- | --------------- | --- |
| Distributed  | Extension | Extension  | HARP | PosgreSQL  | Extended Server | Advanced Server | CLI |
| -------------| --------- | ---------- | ---- | ---------- | --------------- | --------------- | --- |
