...
* [Group Commit](/bdr/latest/group-commit)
...
The following sections cover the various forms of synchronous or eager
replication and its timing aspects.

## Terms and Definitions

This content refers to BDR nodes taking different
