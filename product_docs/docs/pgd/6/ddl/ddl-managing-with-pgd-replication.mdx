...
redirects:
  - /pgd/latest/ddl/ddl-managing-with-pgd-replication/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/ddl/ddl-managing-with-pgd-replication/ #generated for DOCS-3034
---
...
We recommend using the [`bdr.run_on_all_nodes()`](/pgd/6/reference/tables-views-functions/functions#bdrrun_on_all_nodes) technique with `CREATE
...
timeout settings. [`bdr.global_lock_timeout`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrglobal_lock_timeout) limits how long the wait for
acquiring the global lock can take before it's canceled.
[`bdr.global_lock_statement_timeout`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrglobal_lock_statement_timeout) limits the runtime length of any statement
in transaction that holds global locks, and [`bdr.global_lock_idle_timeout`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrglobal_lock_idle_timeout) sets
...
the bdr_superuser to update the [`bdr.ddl_locking`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrddl_locking) value.
...
by turning [`bdr.ddl_replication`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrddl_replication) off.
