...
redirects:
  ...
  - /pgd/latest/reference/ddl/ddl-replication-options/ #generated for DOCS-3034
---

The [`bdr.ddl_replication`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrddl_replication) parameter specifies replication behavior.
...
function [`bdr.replicate_ddl_command()`](/pgd/6/reference/tables-views-functions/functions#bdrreplicate_ddl_command). This function can be helpful if you
...
execute it manually on each node using the [`bdr.ddl_replication`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrddl_replication) configuration
parameter.
