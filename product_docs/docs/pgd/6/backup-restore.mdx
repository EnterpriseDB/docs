...
After a multi-node restore, compare row counts and a digest of each table's contents across nodes. For PGAA specifically, see [PGAA documentation](/pgaa/latest/).
