...
These can be configured using the [`bdr.alter_node_group_option`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdralter_node_group_option) command, or using the [`pgd group set-option`](/pgd/6/reference/cli/command_ref/group/set-option/) command.
