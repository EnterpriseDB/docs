...
* Establishing the IP address of any Connection Manager you want to connect to
...
By listing all the addresses of connection managers as the host, you can ensure that the client will always failover and connect to the first available connection manager in the event of a node failing. 
