...
redirects:
  ...
  - /pgd/latest/reference/stream-triggers/ #generated for DOCS-3034
---
...
[`bdr.create_conflict_trigger()`](/pgd/6/reference/tables-views-functions/streamtriggers/interfaces/#bdrcreate_conflict_trigger) and [`bdr.create_transform_trigger()`](/pgd/6/reference/tables-views-functions/streamtriggers/interfaces/#bdrcreate_transform_trigger).
