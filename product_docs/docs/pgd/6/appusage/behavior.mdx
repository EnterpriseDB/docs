...
replication sets are defined. See [Replication sets](/pgd/6/reference/repsets) for
...
[Conflicts](/pgd/6/reference/conflict-management/conflicts).

### Sequences

Sequences need special handling, described in [Sequences](/pgd/6/reference/sequences). This is
