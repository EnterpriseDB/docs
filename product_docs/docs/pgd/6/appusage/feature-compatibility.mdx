...
Although you can't mix commit scopes, you can [combine rules](/pgd/6/reference/commit-scopes/commit-scope-rules/#combining-rules) with an `AND` operator. This table shows where commit scopes can be combined.		
