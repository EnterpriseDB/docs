...
PGD AutoPartition uses the [`bdr.autopartition()`](/pgd/6/reference/tables-views-functions/autopartition#bdrautopartition)
...
example, the built-in [`bdr.conflict_history`](/pgd/6/reference/tables-views-functions/catalogs-visible#bdrconflict_history)
...
Use
[`bdr.drop_autopartition()`](/pgd/6/reference/tables-views-functions/autopartition#bdrdrop_autopartition)
...
Use
[`bdr.autopartition_wait_for_partitions()`](/pgd/6/reference/tables-views-functions/autopartition#bdrautopartition_wait_for_partitions)
...
[`bdr.autopartition_wait_for_partitions_on_all_nodes()`](/pgd/6/reference/tables-views-functions/autopartition#bdrautopartition_wait_for_partitions_on_all_nodes)
...
Use the
[`bdr.autopartition_find_partition()`](/pgd/6/reference/tables-views-functions/autopartition#bdrautopartition_find_partition)
...
Use
[`bdr.autopartition_enable()`](/pgd/6/reference/tables-views-functions/autopartition#bdrautopartition_enable)
to enable autopartitioning on the given table. If autopartitioning is already
enabled, then no action occurs. Similarly, use
[`bdr.autopartition_disable()`](/pgd/6/reference/tables-views-functions/autopartition#bdrautopartition_disable)
