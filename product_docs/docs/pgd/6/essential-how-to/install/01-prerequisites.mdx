...
If you want to install a learning/test environment, we recommend using the [PGD First Cluster](/pgd/6/get-started/first-cluster).

!!! Note
If you want to install EDB Postgres Distributed (PGD) Expanded, consult the [Expanded installation guide](/pgd/6/expanded-how-to/install/01-prerequisites).
!!!
