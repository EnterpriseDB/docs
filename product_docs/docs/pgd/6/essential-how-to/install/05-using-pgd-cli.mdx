...
- Ensure PGD CLI is installed.
  ...
  - For any system, repeat the [configure repositories](02-installing-database-and-pgd#configuring_repositories) step on that system.
