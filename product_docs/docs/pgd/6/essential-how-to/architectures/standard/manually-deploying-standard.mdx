...
* [Configure repositories](/pgd/6/essential-how-to/install/02-configure-repositories/) to enable installation of the PGD packages.
* [Install PGD and Postgres](/pgd/6/essential-how-to/install/03-installing-database-and-pgd/) to install the PGD packages.
* [Configure the PGD cluster](/pgd/6/essential-how-to/install/04-configuring-cluster/) to configure the PGD cluster.
