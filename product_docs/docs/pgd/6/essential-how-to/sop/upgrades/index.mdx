...
* **[Compatibility changes](compatibility)** &mdash; If you're upgrading from PGD 4.x to PGD 6.x or later, you need to understand the compatibility changes between versions.


## Upgrading Postgres or Postgres and PGD major versions

* **[In-place Postgres major version upgrades](inplace_upgrade)** &mdash; How to use `pgd node upgrade` to manually upgrade the Postgres version or Postgres and PGD major version on one or more nodes.
