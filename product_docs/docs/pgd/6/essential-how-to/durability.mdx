...
For more information on commit scopes, see the [Commit Scopes](/pgd/6/reference/commit-scopes/) reference section and the [Predefined Commit Scopes](/pgd/6/reference/commit-scopes/predefined-commit-scopes/) reference page.
