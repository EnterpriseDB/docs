...
redirects:
  - /pgd/latest/nodes/logical_standby_nodes/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/nodes/logical_standby_nodes/ #generated for DOCS-3034
---
...
the node with [`bdr.create_node`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrpromote_node).

Later, if you want, use
[`bdr.promote_node`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrpromote_node)
