...
redirects:
  ...
  - /pgd/latest/reference/nodes/subscriber_only/optimizing-so/ #generated for DOCS-3034
---
...
You can then set the GUC [`bdr.force_full_mesh`](/pgd/6/reference/tables-views-functions/pgd-settings#bdrforce_full_mesh) to `off` to allow the optimization to be activated.
