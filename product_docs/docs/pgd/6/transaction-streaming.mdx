...
-   At node level, using the GUC [`bdr.default_streaming_mode`](/pgd/6/reference/tables-views-functions/pgd-settings/#transaction-streaming)
-   At group level, using the function [`bdr.alter_node_group_option()`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces/#bdralter_node_group_option)
...
You can use the parameter `streaming_mode` in the function [`bdr.alter_node_group_option()`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces/#bdralter_node_group_option)
...
from the view [`bdr.node_group`](/pgd/6/reference/tables-views-functions/catalogs-visible/#bdrnode_group). The value returned is
...
You can monitor the use of transaction streaming using the [`bdr.stat_subscription`](/pgd/6/reference/tables-views-functions/catalogs-visible/#bdrstat_subscription)
