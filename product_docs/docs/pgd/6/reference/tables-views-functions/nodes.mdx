...
!!! warning Deprecated
This command is deprecated in favor of the using the pgd CLI command [`pgd node setup`](/pgd/6/reference/cli/command_ref/node/setup) which offers a more flexible and powerful ways to create and manage nodes in a PGD group. 
