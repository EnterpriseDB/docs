...
Commit scopes are rules that determine how transaction commits and conflicts are handled within a PGD system. You can read more about them in [Commit Scopes](/pgd/6/reference/commit-scopes/).

You can manipulate commit scopes using the following functions:

-   [`bdr.create_commit_scope`](/pgd/6/reference/tables-views-functions/functions#bdrcreate_commit_scope)
-   [`bdr.alter_commit_scope`](/pgd/6/reference/tables-views-functions/functions#bdralter_commit_scope)
-   [`bdr.drop_commit_scope`](/pgd/6/reference/tables-views-functions/functions#bdrdrop_commit_scope)
