...
EDB Postgres Distributed has tools that help with testing and tuning your PGD clusters. For background, see [Testing and tuning](/pgd/6/reference/testing-tuning).
...
See [pgd_bench in Testing and tuning](/pgd/6/reference/testing-tuning#pgd_bench) for examples
