...
See [Role manipulation statements](/pgd/6/reference/ddl/ddl-role-manipulation.mdx)
for details.
...
Sets the output format of [CRDT data types](/pgd/6/reference/conflict-management/crdt).
...
Sets the current (or default) [commit scope](/pgd/6/reference/commit-scopes/commit-scopes) (default
is an empty string).
...
Tracks apply statistics for each subscription with [`bdr.stat_subscription`](/pgd/6/reference/tables-views-functions/catalogs-visible#bdrstat_subscription) (default is `on`).

### `bdr.track_relation_apply`

Tracks apply statistics for each relation with [`bdr.stat_relation`](/pgd/6/reference/tables-views-functions/catalogs-visible#bdrstat_relation) (default is `off`).

### `bdr.track_apply_lock_timing`

Tracks lock timing when tracking statistics for relations with [`bdr.stat_relation`](/pgd/6/reference/tables-views-functions/catalogs-visible#bdrstat_relation) (default is `off`).
