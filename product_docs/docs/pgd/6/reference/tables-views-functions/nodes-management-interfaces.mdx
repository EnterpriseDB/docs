...
| `enable_routing`    | `boolean`  | Where [`Connection Manager`](../routing/) through the group write leader is enabled for given group. Valid values are `on` or `off`. Default is `on` for subgroups and off for the cluster group.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
