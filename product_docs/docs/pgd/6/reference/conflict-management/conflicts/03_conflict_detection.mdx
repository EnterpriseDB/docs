...
To change the current conflict detection strategy, use [bdr.alter_table_conflict_detection](/pgd/latest/reference/conflict_functions/#bdralter_table_conflict_detection).
