...
PGD lets you override the default behavior of conflict resolution by using [bdr.alter_node_set_conflict_resolver](/pgd/latest/reference/conflict_functions/#bdralter_node_set_conflict_resolver).