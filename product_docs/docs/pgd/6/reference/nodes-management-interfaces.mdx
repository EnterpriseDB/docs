...
| `enable_routing`    | `boolean`  | Where [`Connection Manager`](../routing/) through the group write leader is enabled for given group. Valid values are `on` or `off`. Default is `off`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `enable_raft`             | `boolean`  | Whether group has its own Raft consensus. This option is necessary for setting `enable_routing` to `on`. Valid values are `on` or `off`. Default is `on` for datagroups.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
