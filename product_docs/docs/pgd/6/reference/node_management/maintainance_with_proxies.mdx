...
For example, in EDB Cloud Service, PGD clusters are locked down such that the only access to the database is through an instance of PGD Proxy. 
...
!!! Tip
For more details, see  the [`bdr.node`](/pgd/latest/reference/tables-views-functions/catalogs-visible#bdrnode) table.
!!!
...
!!! Tip
For more details, see the [`bdr.node_summary`](/pgd/latest/reference/tables-views-functions/catalogs-visible#bdrnode_summary) table.
!!!
