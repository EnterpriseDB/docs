...
deepToC: true
redirects:
  - /pgd/latest/cli/command_ref/commit-scope/update/ #generated for DOCS-1247-PGD-6.0-Docs
---
...
No command specific options. See [Global Options](/pgd/6/reference/cli/command_ref/#global-options).
