...
- You need the name or IP address of any data host. By default all PGD 6 data hosts have a connection manager you can connect to. Usually the connection manager listens on port 6432.
