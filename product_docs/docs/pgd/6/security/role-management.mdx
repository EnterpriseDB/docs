...
redirects:
  ...
  - /pgd/latest/reference/security/role-management/ #generated for DOCS-3034
---
...
argument of [`bdr.create_node`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrcreate_node) and the `join_target_dsn` of [`bdr.join_node_group`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrjoin_node_group)
