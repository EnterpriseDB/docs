...
You can effectively eliminate this type of conflict by using [global sequences](/pgd/6/reference/sequences#pgd-global-sequences).
...
You can also define a different behavior using a [conflict trigger](/pgd/6/reference/stream-triggers/#conflict-triggers).
