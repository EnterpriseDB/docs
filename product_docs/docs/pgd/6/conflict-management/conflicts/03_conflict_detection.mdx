...
To change the current conflict detection strategy, use [bdr.alter_table_conflict_detection](/pgd/6/reference/tables-views-functions/conflict_functions/#bdralter_table_conflict_detection).
