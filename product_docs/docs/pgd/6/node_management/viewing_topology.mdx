...
### Using [pgd-cli](/pgd/6/reference/cli/)

Use the [pgd-cli](/pgd/6/reference/cli/) `groups list` command to list all groups in the PGD cluster:
...
from the [`bdr.node_summary`](/pgd/6/reference/tables-views-functions/catalogs-visible#bdrnode_summary)` view. For example:
