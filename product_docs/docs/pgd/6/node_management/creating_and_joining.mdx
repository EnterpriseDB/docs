...
redirects:
  ...
  - /pgd/latest/reference/node_management/creating_and_joining/ #generated for DOCS-3034
---
...
The SQL function
[`bdr.create_node_group()`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrcreate_node_group)
...
After this, all tables will have the `bdr.default_replica_identity` value configured as the `REPLICA IDENTITY` for the table.

Once the node group is created, further nodes can join the PGD group using the [`bdr.join_node_group()`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrjoin_node_group) function.

Alternatively, use the command line utility
[bdr_init_physical](/pgd/6/reference/tables-views-functions/nodes/#bdr_init_physical) to create a
...
[`bdr.join_node_group`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrjoin_node_group)
...
because of cache-lookup failures. Since [`bdr.join_node_group`](/pgd/6/reference/tables-views-functions/nodes-management-interfaces#bdrjoin_node_group) uses pg_dump
