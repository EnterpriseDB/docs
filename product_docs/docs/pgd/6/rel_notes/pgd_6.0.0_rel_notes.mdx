...
<tr><td><details><summary>Fixed issue where manually disabled subscriptions were automatically re-enabled</summary><hr/><p>Fixed an issue where manually disabled subscriptions to a subscriber-only node were re-enabled by the manager.</p>
