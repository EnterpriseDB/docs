...
ones from the join source node.</p>
<p>System roles (i.e. the ones created by initdb) are not synchronized.</p>
</details></td><td></td></tr>
...
The commands that display more than one resource, the output will be sorted by each resource column in order.</p>
</details></td><td></td></tr>
