...
You can effectively eliminate this type of conflict by using [global sequences](/pgd/current/reference/sequences#pgd-global-sequences).
...
You can also define a different behavior using a [conflict trigger](/pgd/current/reference/stream-triggers/#conflict-triggers).
