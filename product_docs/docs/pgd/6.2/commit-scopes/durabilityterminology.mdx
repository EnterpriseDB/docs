...
redirects:
  - /pgd/latest/commit-scopes/durabilityterminology/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/commit-scopes/durabilityterminology/ #generated for DOCS-3034
---

## Durability terminology

This page covers terms and definitions directly related to PGD's durability options.
For other terms, see [Terminology](/pgd/current/overview/terminology/).
