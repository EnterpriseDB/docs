...
A internal catalog table used to track the replication progress between all nodes in a cluster. WAL position against the reported positions of remote peers. 
