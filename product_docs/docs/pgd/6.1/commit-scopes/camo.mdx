...
See the CAMO section of [Limitations](/pgd/current/known_issues/#camo).
...
CAMO limitations are covered in [Known Issues and Limitations](/pgd/current/known_issues/#camo).
