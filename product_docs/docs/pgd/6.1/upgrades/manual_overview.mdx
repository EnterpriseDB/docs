...
!!!Note
   A PGD 5.9 node can't join a mixed version cluster that has PGD 5.9 and PGD 6.1 nodes.
!!!

A PGD 5.9 cluster first needs to start using the connection manager, since 6.1 does not support PGD proxy.  Use the following steps to move it to connection manager:
