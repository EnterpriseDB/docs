...
SELECT wait_slot_confirm_lsn(NULL, NULL);
 ```
  ...
  !!!
    ...
    9. If you're also performing a major version upgrade from PGD 5 to PGD 6.1, proceed with the [rolling upgrade steps](./upgrading_major_rolling/#worked-example).
