...
A PGD 4 cluster must be running PGD 4.4 before upgrading to PGD 6.1.

Upgrading from PGD 4.4 to PGD 6.1 requires additional steps to move from Harp proxy to Connection Manager. For more information, 
see the worked example: [Upgrade PGD 4 to PGD 6.1](./upgrading_major_rolling/#worked-example-upgrade-pgd-4-to-pgd-61). 

A PGD 5 cluster must be running PGD 5.9 before upgrading to PGD 6.1.

Upgrading from PGD 5.9 to PGD 6.1 requires additional steps to move from PGD proxy to Connection Manager.  
For more information, see the worked example: [Upgrade PGD 5 to PGD 6.1](./upgrading_major_rolling/#worked-example-upgrade-pgd-5-to-pgd-61).  
!!!
...
-   !!!Note
    ...
    9.  If you're also performing a major version upgrade from PGD 5 to PGD 6.1, proceed with the [rolling upgrade steps](./upgrading_major_rolling/#worked-example-upgrade-pgd-5-to-pgd-61).
