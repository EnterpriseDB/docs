...
You must install your selected Postgres distribution on each node you are configuring. You can find installation instructions for each distribution in the [EDB Postgres Advanced Server documentation](/epas/latest/installing/), [EDB Postgres Extended Server documentation](/pge/latest/installing/), and the [Postgres installation documentation](/supported-open-source/postgresql/installing/). You can also refer to the [PGD manual installation guide](/pgd/current/essential-how-to/install/03-installing-database-and-pgd/) which covers the installation of Postgres.
