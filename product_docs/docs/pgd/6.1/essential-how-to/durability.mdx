...
For more information on commit scopes, see the [Commit Scopes](/pgd/current/commit-scopes/) reference section and the [Predefined Commit Scopes](/pgd/current/commit-scopes/predefined-commit-scopes/) reference page.
