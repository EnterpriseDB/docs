...
-   [Configure repositories](/pgd/current/essential-how-to/install/02-configure-repositories/) to enable installation of the PGD packages.
-   [Install PGD and Postgres](/pgd/current/essential-how-to/install/03-installing-database-and-pgd/) to install the PGD packages.
-   [Configure the PGD cluster](/pgd/current/essential-how-to/install/04-configuring-cluster/) to configure the PGD cluster.
