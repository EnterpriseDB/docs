...
See [Role manipulation statements](/pgd/latest/reference/ddl/ddl-role-manipulation.mdx)
for details.
...
Sets the output format of [CRDT data types](/pgd/latest/reference/conflict-management/crdt).
...
Sets the current (or default) [commit scope](/pgd/latest/reference/commit-scopes/commit-scopes) (default
is an empty string).
