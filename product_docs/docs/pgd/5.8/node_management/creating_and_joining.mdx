...
The SQL function
[`bdr.create_node_group()`](/pgd/5.8/reference/nodes-management-interfaces#bdrcreate_node_group)
...
[bdr_init_physical](/pgd/5.8/reference/nodes/#bdr_init_physical) to create a
...
because of cache-lookup failures. Since [`bdr.join_node_group`](/pgd/5.8/reference/nodes-management-interfaces#bdrjoin_node_group) uses pg_dump
