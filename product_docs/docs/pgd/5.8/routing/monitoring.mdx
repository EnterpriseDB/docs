...
The current configuration of every group is visible in the [`bdr.node_group_routing_config_summary`](/pgd/5.8/reference/catalogs-internal#bdrnode_group_routing_config_summary) view. 

The [`bdr.node_routing_config_summary`](/pgd/5.8/reference/catalogs-internal#bdrnode_routing_config_summary) view shows current per-node routing configuration. 

[`bdr.proxy_config_summary`](/pgd/5.8/reference/catalogs-internal#bdrproxy_config_summary) shows per-proxy configuration.
