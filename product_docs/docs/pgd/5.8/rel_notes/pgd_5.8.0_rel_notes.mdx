...
<table class="table w-100"><thead><tr><th>Component</th><th>Version</th><th>Description</th><th width="10%">Addresses</th></tr></thead><tbody>
<tr><td>BDR</td><td>5.8.0</td><td><details><summary>Addressed CVE-2025-2506, which could enable a user with CONNECT access to obtain read access to replicated tables.</summary><hr/><p>An issue, <a href="/security/advisories/cve20252506/">CVE-2025-2506</a>, was discovered in pglogical which is present in later versions of BDR and PGD. The issue could enable a user with CONNECT access to obtain read access to replicated tables.</p>
...
<tr><td>BDR</td><td>5.8.0</td><td><details><summary>Prevent segfault in bdr.taskmgr_set_leader.</summary><hr/><p>The node_name argument to bdr.taskmgr_set_leader is required. The function now throws an appropriate error in case node_name := NULL is passed in.</p>
</details></td><td></td></tr>
