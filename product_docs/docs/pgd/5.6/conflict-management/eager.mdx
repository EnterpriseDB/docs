...
You configure it using [commit scopes](../commit-scopes/commit-scopes) as one of the conflict resolution options for [Group Commit](../commit-scopes/group-commit).
