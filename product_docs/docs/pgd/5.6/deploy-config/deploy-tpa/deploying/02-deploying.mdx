...
navTitle: Deploying
redirects:
  - /pgd/5.6/install-admin/admin-tpa/installing/02-deploying/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5.6/admin-tpa/installing/02-deploying/ #generated for pgd deploy-config-planning reorg 
---
