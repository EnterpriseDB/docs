...
redirects:
  - /pgd/5.6/install-admin/admin-kubernetes/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5.6/admin-kubernetes/ #generated for pgd deploy-config-planning reorg 
---
