...
deepToC: true
redirects:
  - /pgd/5.6/install-admin/admin-manual/installing/02-install-postgres/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5.6/admin-manual/installing/02-install-postgres/ #generated for pgd deploy-config-planning reorg 
---
