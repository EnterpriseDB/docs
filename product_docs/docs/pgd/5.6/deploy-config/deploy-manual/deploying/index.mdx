...
navigation:
  ...
  - 08-using-pgd-cli
redirects:
  - /pgd/5.6/install-admin/admin-manual/installing/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5.6/admin-manual/installing/ #generated for pgd deploy-config-planning reorg 
---
