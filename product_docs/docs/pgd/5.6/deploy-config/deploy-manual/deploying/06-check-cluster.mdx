...
deepToC: true
redirects:
  - /pgd/5.6/install-admin/admin-manual/installing/06-check-cluster/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5.6/admin-manual/installing/06-check-cluster/ #generated for pgd deploy-config-planning reorg 
---
