...
For a full description of configuration parameters, see the [GROUP_COMMIT](https://www.enterprisedb.com/docs/pgd/latest/reference/commit-scopes/#group-commit) commit scope reference.
