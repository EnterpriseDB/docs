...
See the [`SYNCHRONOUS_COMMIT`](https://www.enterprisedb.com/docs/pgd/5.6/reference/commit-scopes/#synchronous_commit) commit scope reference for configuration parameters.
