...
Read about [Conflicts](/pgd/5.6/conflict-management/conflicts/) to understand the implications of the asynchronous operation mode in terms of data consistency.
