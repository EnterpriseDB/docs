...
You have to configure transaction streaming in two places within PGD:
...
[Group configuration using bdr.alter_node_group_option()](#group-configuration-using-bdralter_node_group_option) for details.
