...
EDB Postgres Distributed 5 is compatible with PostgreSQL, EDB Postgres Extended, and ED Postgres Advanced versions 12-17. See the [compatibility](compatibility) section for more details, including compatibility with different operating systems and architectures.
