...
<tr><td>BDR</td><td>5.6.0</td><td><details><summary>bdr&nbsp;config: add PG_FLAVOR output</summary><hr/><p>This shows the PostgreSQL "flavor" which BDR was built against, one of:</p>
<ul>
<li>COMMUNITY</li>
<li>EPAS</li>
<li>EXTENDED</li>
