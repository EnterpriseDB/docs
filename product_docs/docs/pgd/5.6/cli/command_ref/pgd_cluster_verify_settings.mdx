---
title: cluster verify settings
description: Verifies the EDB Postgres Distributed cluster settings.
navTitle: verify settings
deepToC: true
---
...
```sh
pgd cluster verify settings [flags]
```
