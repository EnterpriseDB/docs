...
### Configuring per-node authentication for client users
...
We recommend SCRAM-SHA-256 authentication method for these backend connections. Certificate authentication is not practical for connections mediated by Connection Manager.
