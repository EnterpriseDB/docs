...
redirects:
  - /pgd/latest/bdr/crdt/
  - /pgd/latest/conflict-management/crdt/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/conflict-management/crdt/ #generated for DOCS-3034
---
...
- [Overview](00_crdt_overview) provides an introduction to CRDTs, including how to use CRDTs in tables, configuration options, and examples of CRDTs. 
