...
| /connection/is-ready   | Is the connection manager is ready to accept connections, returns true(200)/false(503)                                                              |
| /connection/is-ready-ro   | Is the connection manager is ready to accept read-only connections, returns true(200)/false(503)                                                              |
| /connection/is-ready-rw   | Is the connection manager is ready to accept read-write connections, returns true(200)/false(503)                                                              |
