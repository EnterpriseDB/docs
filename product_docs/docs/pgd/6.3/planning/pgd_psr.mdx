...
To transition your current environment, follow the step-by-step guide [Migrating from Postgres Physical Streaming Replication (PSR) to PGD](/pgd/latest/lifecycle/migrating/migration-psr/).
