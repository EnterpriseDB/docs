...
A PGD 4 cluster must be running PGD 4.4.2 before upgrading to PGD {{version.full}}.

Upgrading from PGD 4.4.2 to PGD {{version.full}} requires additional steps to move from Harp proxy to Connection Manager. For more information, 
