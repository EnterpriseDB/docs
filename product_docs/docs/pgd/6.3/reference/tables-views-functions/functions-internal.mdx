...
Internal function used to retrieve reconciliation statistics for commit scopes. For standard monitoring and troubleshooting, use the [bdr.stat_commit_scope](catalogs-visible#bdrstat_commit_scope) view, which provides a more accessible and user-friendly representation of this data.
