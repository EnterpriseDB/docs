...
2.  Use the `pgaa.convert_to_tiered_table()` function to [convert a heap table to a tiered table](#converting-a-heap-table-to-a-tiered-table).
3.  [Verify and monitor](#monitoring-tiered-tables) the automated offloading.
4.  [Modify or disable](#modifying-and-disabling-tiered-tables) settings as your storage needs evolve.
