...
[bdr_init_physical](/pgd/5.7/reference/nodes/#bdr_init_physical) to create a
...
because of cache-lookup failures. Since [`bdr.join_node_group`](/pgd/5.7/reference/nodes-management-interfaces#bdrjoin_node_group) uses pg_dump
