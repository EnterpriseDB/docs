...
deepToC: true
redirects:
  - /pgd/5.7/install-admin/admin-manual/installing/01-provisioning-hosts/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5.7/admin-manual/installing/01-provisioning-hosts/ #generated for pgd deploy-config-planning reorg 
---
