...
## Upgrading Postgres and PGD major versions

* **[In-place Postgres major version upgrades](bdr_pg_upgrade)** &mdash; How to use `pgd node upgrade` to manually upgrade the Postgres version or Postgres and PGD major version on a node, or nodes.

* **[Rolling major version upgrades](upgrading_major_rolling)** &mdash; How to perform a major version upgrade of Postgres or Postgres and PGD on a cluster deployed using TPA.
