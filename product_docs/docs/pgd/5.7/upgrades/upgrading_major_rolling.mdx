...
deepToC: true
redirects:
  - /pgd/5.7/install-admin/admin-tpa/upgrading_major_rolling/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5.7/admin-tpa/upgrading_major_rolling/ #generated for pgd deploy-config-planning reorg 
---
...
This worked example starts with a TPA-managed PGD cluster deployed using the [AWS quick start](/pgd/5.7/quickstart/quick_start_aws/), which create Debian OS nodes. The cluster has three nodes: kaboom, kaolin, and kaftan, all running Postgres 16.
