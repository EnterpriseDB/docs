...
!!!Note
The following overview and worked example assume you are upgrading to or from 5.7.0+. For upgrading to older versions of PGD, you need to use the command 'bdr_pg_upgrade`, which has the same behavior and requiremnts as `pg node upgrade.
!!!
