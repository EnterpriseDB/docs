...
conflict resolution with last/first update wins (see [pglogical writer](subscriptions/pglogical-writer)),
...
The view [`pglogical.worker_tasks`](troubleshooting/#pglogicalworker_tasks)
