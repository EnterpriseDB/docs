...
[`pglogical.min_worker_backoff_delay`](configuration/#pglogicalmin_worker_backoff_delay-and-pglogicalmax_worker_backoff_delay) for
...
most likely the [HeapWriter](/pgd/3.7/pglogical/subscriptions/pglogical-writer/#restrictions).
