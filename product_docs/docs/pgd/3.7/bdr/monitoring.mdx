...
Also, the table [`bdr.node_catchup_info`](reference/catalogs-visible/#bdrnode_catchup_info) will give information
...
-   [`bdr.node_slots`](reference/catalogs-visible/#bdrnode_slots) for monitoring outgoing replication
-   [`bdr.subscription_summary`](reference/catalogs-visible/#bdrsubscription_summary) for monitoring incoming replication
...
-   [`bdr.node_replication_rates`](reference/catalogs-visible/#bdrnode_replication_rates) for monitoring outgoing replication
...
via the function [bdr.wal_sender_stats](/pgd/3.7/bdr/functions/#bdrwal_sender_stats),
e.g.:
...
[bdr.get_decoding_worker_stat](/pgd/3.7/bdr/functions/#bdrget_decoding_worker_stat), e.g.:
...
-----------+------------------+-------------------+-------------
 node1     | 13.3             | 3.7.10            | 3.7.10
 node2     | 13.3             | 3.7.10            | 3.7.10
```
