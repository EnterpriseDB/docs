...
via the function [bdr.wal_sender_stats](../../latest/bdr/functions/#bdrwal_sender_stats),
e.g.:
...
[bdr.get_decoding_worker_stat](../../latest/bdr/functions/#bdrget_decoding_worker_stat), e.g.:
