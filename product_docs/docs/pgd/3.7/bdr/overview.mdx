...
addition and node removal. Data may arrive from outside the EDB Postgres Distributed cluster or
...
The minimum recommended number of nodes in EDB Postgres Distributed cluster is 3, because with
