...
navigation:
  ...
  - optimizing-so
redirects:
  - /pgd/latest/nodes/subscriber_only/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/nodes/subscriber_only/ #generated for DOCS-3034
---
...
* [Optimizing subscriber-only groups](optimizing-so) provides details on how to configure the PGD subscriber-only optimized topology feature which uses a group leader for more efficient replication.
