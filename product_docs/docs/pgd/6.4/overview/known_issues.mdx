...
PGD was developed to [enable rolling upgrades of PGD](/pgd/current/lifecycle/upgrades/) by allowing mixed versions of PGD to operate during the upgrade process. 
