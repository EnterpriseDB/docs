...
redirects:
  - /pgd/latest/node_management/viewing_topology/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/node_management/viewing_topology/ #generated for DOCS-3034
---


## Listing PGD groups

### Using [pgd-cli](/pgd/latest/reference/cli/)

Use the [pgd-cli](/pgd/latest/reference/cli/) `groups list` command to list all groups in the PGD cluster:
...
from the [`bdr.node_summary`](/pgd/latest/reference/tables-views-functions/catalogs-visible#bdrnode_summary)` view. For example:
