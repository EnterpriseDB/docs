...
deepToC: true
redirects:
  - /pgd/latest/geo-replication-dba/commit-scopes/
---
...
If your locations have asymmetric durability requirements, you can create a separate rule per location instead. See [Using Quorum Commit](/pgd/current/commit-scopes/quorum-commit/using-quorum-commit/) for full details.
