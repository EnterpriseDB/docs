...
| /connection/is-ready   | Is the connection manager ready to accept connections, returns true(200)/false(503).                                                              |
| /connection/is-ready-ro   | Is the connection manager ready to accept read-only connections, returns true(200)/false(503).                                                              |
| /connection/is-ready-rw   | Is the connection manager ready to accept read-write connections, returns true(200)/false(503).                                                              |
...
| /node/is-read-only     | Is this PGD node, not the connection manager but the PGD node itself, a read-only node (not the write leader), returns true(200)/false(503).                                                                                                                                          |
