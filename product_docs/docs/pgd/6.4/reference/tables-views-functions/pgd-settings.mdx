...
See [Role manipulation statements](/pgd/current/ddl/ddl-role-manipulation/)
for details.
...
The default is `off`. For more details, see [Replicated large objects](/pgd/current/large-objects/).
