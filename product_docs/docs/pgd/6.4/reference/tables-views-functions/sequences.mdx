...
Functions for working with `KSUUID` v2 data, K-Sortable UUID data. See also [KSUUID in the sequences documentation](/pgd/current/sequences/#ksuuids).
...
Functions for working with `KSUUID` v1 data, K-Sortable UUID data(v1). Deprecated - See [KSUUID in the sequences documentation](/pgd/current/sequences/#ksuuids) for details.
