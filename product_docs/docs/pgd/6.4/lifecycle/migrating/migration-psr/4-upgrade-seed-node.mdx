---
title: Upgrading the seed node and installing PGD
navTitle: Upgrading the seed node and installing PGD
...
1. Verify that the table list in the subscription matches the configuration you obtained on [Enabling logical replication to the seed node](3-convert-to-logical-replication/#enabling-logical-replication-to-the-seed-node):
...
Next step: [Initialize PGD](5-initialize-pgd).