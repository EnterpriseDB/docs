...
redirects:
  ...
  - /pgd/latest/reference/conflict-management/column-level-conflicts/02_enabling_disabling/ #generated for DOCS-3034
---

!!! Note Permissions required
Column-level conflict detection uses the `column_timestamps` type. This type requires any user needing to detect column-level conflicts to have at least the [bdr_application](../../advanced-functionality/security/pgd-predefined-roles/#bdr_application) role assigned.
!!!
