...
You can effectively eliminate this type of conflict by using [global sequences](/pgd/current/sequences/#pgd-global-sequences).
...
You can also define a different behavior using a [conflict trigger](/pgd/current/stream-triggers/#conflict-triggers).
