...
redirects:
  ...
  - /pgd/latest/reference/conflict-management/crdt/01_crdt_usage/ #generated for DOCS-3034
---

## Using CRDTs in tables

!!! Note Permissions required
PGD CRDTs requires usage access to CRDT types. Therefore, any user needing to access CRDT types must have at least the [bdr_application](../../advanced-functionality/security/pgd-predefined-roles/#bdr_application) role assigned to them.
!!!
