...
deepToC: true
redirects:
  - /pgd/latest/commit-scopes/synchronous_commit/ #generated for DOCS-1247-PGD-6.0-Docs
  - /pgd/latest/reference/commit-scopes/synchronous_commit/ #generated for DOCS-3034
---
...
`SYNCHRONOUS COMMIT` supports the optional `DEGRADE ON` clause. See the [`SYNCHRONOUS COMMIT`](/pgd/latest/reference/tables-views-functions/commit-scopes/#synchronous-commit) commit scope reference for specific configuration parameters or see [this section](degrading) regarding Degrade on options.
