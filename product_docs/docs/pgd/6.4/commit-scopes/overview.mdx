...
Commit scopes allow five kinds of controlling durability of the transaction:
...
-   [Quorum Commit](quorum-commit): This kind of commit scope coordinates across all participating nodes before any node commits. All participating nodes commit together or roll back together, and eager conflict resolution is always active.
