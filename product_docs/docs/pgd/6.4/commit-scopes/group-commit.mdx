...
!!! Warning Deprecated
Group Commit has been superseded by [Quorum Commit](quorum-commit) and will be removed in a future major version. For new deployments requiring distributed transaction consistency, use Quorum Commit instead.
!!!
