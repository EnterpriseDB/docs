...
1. When a node hasn't been heard from for `bdr.raft_global_election_timeout` (default 6s), the PGD manager process creates a reconciliation request and holds WAL senders for that origin.
