...
| ALTER MATERIALIZED VIEW          | Y                                             | N                                          | [N](#matview_commands)                           |
...
| CREATE MATERIALIZED VIEW         | Y                                             | N                                          | [N](#matview_commands)                           |
...
| DROP MATERIALIZED VIEW           | Y                                             | N                                          | [N](#matview_commands)                           |
...
| REFRESH MATERIALIZED VIEW        | Y                                             | N                                          | [N](#matview_commands)                           |
| REINDEX                          | Y                                             | Y                                          | DDL                                                |
| RELEASE                          | Y                                             | N                                          | N                                                |
| RESET                            | Y                                             | N                                          | N                                                |
...
Materialized views are accepted but not replicated. Each node refreshes and creates them locally.
