...
database, with [`bdr.role_replication`](/pgd/current/reference/pgd-settings/#bdrrole_replication) set to `on`.
...
[`bdr.role_replication`](/pgd/current/reference/pgd-settings/#bdrrole_replication)
