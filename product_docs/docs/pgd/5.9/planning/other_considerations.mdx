...
Read about [Conflicts](/pgd/5.8/conflict-management/conflicts/) to understand the implications of the asynchronous operation mode in terms of data consistency.
