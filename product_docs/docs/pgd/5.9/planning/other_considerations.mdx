...
Read about [Conflicts](/pgd/5.9/conflict-management/conflicts/) to understand the implications of the asynchronous operation mode in terms of data consistency.
