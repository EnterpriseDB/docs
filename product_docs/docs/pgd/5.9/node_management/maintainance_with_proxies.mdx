...
!!! Tip
For more details, see  the [`bdr.node`](/pgd/5.9/reference/catalogs-visible#bdrnode) table.
!!!
...
!!! Tip
For more details, see the [`bdr.node_summary`](/pgd/5.9/reference/catalogs-visible#bdrnode_summary) table.
!!!
