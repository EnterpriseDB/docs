...
-   At node level, using the GUC [`bdr.default_streaming_mode`](/pgd/5.9/reference/pgd-settings/#transaction-streaming)
-   At group level, using the function [`bdr.alter_node_group_option()`](/pgd/5.9/reference/nodes-management-interfaces/#bdralter_node_group_option)
...
You can use the parameter `streaming_mode` in the function [`bdr.alter_node_group_option()`](/pgd/5.9/reference/nodes-management-interfaces/#bdralter_node_group_option)
...
from the view [`bdr.node_group`](/pgd/5.9/reference/catalogs-visible/#bdrnode_group). The value returned is
...
You can monitor the use of transaction streaming using the [`bdr.stat_subscription`](/pgd/5.9/reference/catalogs-visible/#bdrstat_subscription)
