...
PGD AutoPartition uses the [`bdr.autopartition()`](/pgd/5.9/reference/autopartition#bdrautopartition)
...
Use
[`bdr.drop_autopartition()`](/pgd/5.9/reference/autopartition#bdrdrop_autopartition)
...
Use
[`bdr.autopartition_wait_for_partitions()`](/pgd/5.9/reference/autopartition#bdrautopartition_wait_for_partitions)
...
[`bdr.autopartition_wait_for_partitions_on_all_nodes()`](/pgd/5.9/reference/autopartition#bdrautopartition_wait_for_partitions_on_all_nodes)
...
Use the
[`bdr.autopartition_find_partition()`](/pgd/5.9/reference/autopartition#bdrautopartition_find_partition)
...
Use
[`bdr.autopartition_enable()`](/pgd/5.9/reference/autopartition#bdrautopartition_enable)
to enable autopartitioning on the given table. If autopartitioning is already
enabled, then no action occurs. Similarly, use
[`bdr.autopartition_disable()`](/pgd/5.9/reference/autopartition#bdrautopartition_disable)
