...
Use the [`bdr.routing_leadership_transfer()`](/pgd/5.9/reference/routing#bdrrouting_leadership_transfer) function.
...
You can use the [`group set-leader`](/pgd/5.9/cli/command_ref/group/set-leader/) command to perform a switchover operation.
