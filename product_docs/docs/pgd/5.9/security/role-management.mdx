...
You can disable this automatic replication behavior by turning off the [`bdr.role_replication`](/pgd/5.9/reference/pgd-settings/#bdrrole_replication) setting, but we don't recommend that.
...
argument of [`bdr.create_node`](/pgd/5.9/reference/nodes-management-interfaces#bdrcreate_node) and the `join_target_dsn` of [`bdr.join_node_group`](/pgd/5.9/reference/nodes-management-interfaces#bdrjoin_node_group)
