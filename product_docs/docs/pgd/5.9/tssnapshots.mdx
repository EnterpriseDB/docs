...
description: Learn how to use timestamp-based snapshots in EDB Postgres Distributed.
redirects: 
  - ../bdr/tssnapshots
...
a user-specified timestamp rather than the usual MVCC snapshot. You can use this feature
to access data on different PGD nodes at a common point in time. For
example, you can compare data on multiple nodes for data-quality checking.
