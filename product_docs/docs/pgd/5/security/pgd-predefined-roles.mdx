...
This role provides read access to most of the tables, views and functions that may be needed by users or applications which wish to observe the statistics and state of the PGD cluster. 
