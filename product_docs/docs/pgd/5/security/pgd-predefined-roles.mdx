...
This role provides read access to most of the tables, views, and functions that users or applications need to observe the statistics and state of the PGD cluster. 
