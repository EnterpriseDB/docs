---
title: Configuring repositories for Postgres and PGD
---

## Overview

To install and run Postgres and PGD requires that you install repositories from which the system can download the relevant packages.
