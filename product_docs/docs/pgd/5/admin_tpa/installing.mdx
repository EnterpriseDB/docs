---
title: Installing EDB Postgres Distributed using Trusted Postgres Architect
navTitle: Installing with TPA
description: >
...
The standard way of deploying EDB Postgres Distributed in a self-managed setting is to use EDB's deployment tool: [Trusted Postgres
