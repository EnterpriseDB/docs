...
|-----------|---------|-------------|-----------|
| PGD | 5.4.0 | Group Commit and Parallel Apply can work together with a dedicated writer for Group Commit. | |

## Enhancements

| Component | Version  |Description | Addresses |
|-----------|---------|-------------|-----------|
| BDR     | 5.4.0   | Reduced WAL file retention when decoding worker enabled by using more compact LCR files. | |
...
| BDR       | 5.4.0   | Resolved an issue of high CPU usage for concensus processes | RT97649 |
...
| BDR       | 5.4.0   | bdr_config now displays PG_FLAVOR reflecting which PostgreSQL "flavor" BDR was built agains. ||
