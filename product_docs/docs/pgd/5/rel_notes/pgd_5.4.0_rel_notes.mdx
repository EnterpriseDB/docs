...
| BDR       | 5.4.0   | EAGER transaction not aborting when raft is disabled (not working) then re-enabled.                                                                                                                                                                                                                             | RT101055         |
| BDR       | 5.4.0   | Increase default bdr.raft_keep_min_entries to 1000 for 100.                                                                                                                                                                                                                                                     |                  |
| BDR       | 5.4.0   | Allow the origin of group commit transactions to wait for responses from all the required nodes before taking an abort decision                                                                                                                                                                                 |                  |
