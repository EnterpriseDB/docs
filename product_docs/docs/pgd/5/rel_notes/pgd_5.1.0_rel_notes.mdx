...
| BDR       | 5.1.0   | Bug fix         | Fixed memory leak in consensus process.  |
...
| BDR       | 5.1.0   | Bug fix         | Fixed join and replication when SDW and standby_slot_names are set. |
| BDR       | 5.1.0   | Bug fix         | Fixed spurious warnings when processing sequence options. |
