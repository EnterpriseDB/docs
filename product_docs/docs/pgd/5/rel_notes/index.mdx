...
| Release Date | EDB Postgres Distributed     | BDR   | PGD CLI | PGD Proxy | TPAexec                                                                          |
| ------------ | ---------------------------- | ----- | ------- | --------- | -------------------------------------------------------------------------------- |
| 2023 Feb 14 | [5.0.0](pgd_5.0.0_rel_notes)  | 5.0.0 | 5.0.0   | 5.0.0     | [23.11](https://techsupport.enterprisedb.com/customer_portal/sw/tpa/trunk/2311/)   |
