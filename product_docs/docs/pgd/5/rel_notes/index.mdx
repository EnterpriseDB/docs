...
| Release Date  |   EDB Postgres Distributed   | BDR extension | PGD CLI | PGD Proxy |  TPA  |
| ------------- | ---------------------------- | ------------- | ------- | --------- | ----- |
| 2023 Mar 21   | [5.0.1](pgd_5.0.1_rel_notes) | 5.0.0         | 5.0.1   | 5.0.1     | 23.15 |
| 2023 Feb 21   | [5.0.0](pgd_5.0.0_rel_notes) | 5.0.0         | 5.0.0   | 5.0.0     | 23.12 |
