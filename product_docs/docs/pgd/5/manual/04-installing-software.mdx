...
<details><summary><h3 style="display:inline"> Installing PGD for EDB Postgres Extended Server</h3></summary>

```
sudo dnf -y install install edb-bdr5-pgextended16 edb-pgd5-proxy edb-pgd5-cli
sudo PGSETUP_INITDB_OPTIONS="-E UTF-8" /usr/edb/as16/bin/edb-pge-16-setup initdb
...
<details><summary><h3 style="display:inline"> Installing PGD for Postgresql</h3></summary>
