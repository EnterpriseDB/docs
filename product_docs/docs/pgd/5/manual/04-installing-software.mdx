...
If it wasn't initialized and started by the database's package initialisatio (or you are repeating the process), you will need to initialize and start the server.
