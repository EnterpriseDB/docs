...
The following operations should be carried out on each host you wish to be a data node, witness node or subscribe-only node.

For our example, that means configuring the repositories on all three hosts.
