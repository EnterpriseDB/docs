...
Generally, we recommend you upgrade to the latest version 4.0 release, before
upgrading to the latest version 5 release. Upgrades from PGD 4 to PGD 5 are
 supported from version 4.3.0 or later. See [Upgrading within
4](/pgd/4/upgrades/upgrade_paths/#upgrading-within-version-4) for more
information. After upgrading t the following upgrade paths are
possible.

| From version | To version |
| ---- | -- |
| 4.3.0 | 5.0.0 or later |
| 4.3.0-1 | 5.0.1 or later |
| 4.3.1 | 5.1.0 or later |
| 4.3.1-1 | 5.2.0 or later |
