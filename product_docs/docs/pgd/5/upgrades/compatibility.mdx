...
CAMO configuration is now done through [Commit Scopes](/pgd/latest/durability/commit-scopes). The
...
behavior using [Group Commit](/pgd/latest/durability/group-commit).
...
[Commit Scopes](/pgd/latest/durability/commit-scopes) for more flexible durability configuration.
...
- many catalogs were added and some have new columns, as documented in the
  [Catalogs](/pgd/latest/catalogs) section of the documentation, these
