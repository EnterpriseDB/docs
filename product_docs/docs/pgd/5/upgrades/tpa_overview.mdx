...
When upgrading to PGD 5 from previous PGD major versions, you can use [`tpaexec reconfigure`](/tpa/latest/reference/tpaexec-reconfigure/). This command will help you make appropriate modifications to your deployment configuration. 
...
TPA will first test the cluster and then the nodes. 

Each node will then be isolated from the cluster, upgraded, and returned to operation within the cluster.
