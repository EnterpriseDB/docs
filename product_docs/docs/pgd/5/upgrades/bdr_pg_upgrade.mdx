...
You can upgrade a PGD node to a newer major version of Postgres using the command-line utility [pgd node upgrade](/product_docs/docs/pgd/5/cli/command_ref/node/upgrade.mdx).
