...
This final step should apply the configuration changes to the cluster managed by TPA. Upon successful deployment, the reconciliation of the new version of Postgres with TPA and the upgrade procedure as a whole is complete.
