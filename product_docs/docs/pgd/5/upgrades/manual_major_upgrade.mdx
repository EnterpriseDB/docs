...
With your PGD cluster set up, you can now perform the rolling upgrade of the Postgres major version on your PGD cluster. Carry out the following steps on each node in the cluster:
