...
```bash
sudo cp /opt/postgres/data/postgresql.conf /opt/postgres/datanew/
sudo cp /opt/postgres/data/postgresql.auto.conf /opt/postgres/datanew/
sudo cp /opt/postgres/data/pg_hba.conf /opt/postgres/datanew/
sudo cp -r /opt/postgres/data/conf.d/ /opt/postgres/datanew/
```
