---
title: "Working with Raft subgroups and the PGD CLI"
---

## Working with Raft subgroups

You can view the status of your nodes and subgroups with the [pgd](../cli/index) cli command. The examples here assume a cluster as configured by in [Creating Raft subgroups with TPA](raft_and_tpa).
