...
- `consensus_grace_period` &mdash; Duration for which proxy will continue to route even upon loss
of a Raft leader. If set to `0s` proxy will stop routing immediately.
