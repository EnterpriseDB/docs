...
You can view the status of your nodes and subgroups with the [pgd](../cli/index) cli command. The examples here assume a cluster as configured by in [Creating Raft subgroups with TPA](01_raft_subgroups_and_tpa).
