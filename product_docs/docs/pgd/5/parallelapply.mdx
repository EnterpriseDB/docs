...
!!! Note Improved in PGD 5.4
This feature was enhanced in PGD 5.4 and is recommended for all replication scenarios. 
!!!
...
In PGD 5.4, an on-demand writer mechanism was added to Parallel Apply. This handles the commit phase of prepared GROUP COMMIT transactions by dedicating a writer to participate in the commit confirmation of the GROUP COMMIT. Doing so enables the continued free flow of non GROUP COMMIT transactions through remaining Parallel Apply writers while ensuring consistency for the GROUP COMMIT.
...
From PGD 5.4, Parallel Apply works with CAMO, Group Commit and Eager Replication.
...
are metrics that indicate how well Parallel Apply is managing what previously would have been deadlocks. They don't reflect overall system performance.
