...
A quorum is the minimum number of voting processes needed to take place within a distributed vote. It ensures that the decision made has validity. For example,
