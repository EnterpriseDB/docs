...
For example, in EDB Postgres® AI Cloud Services (formerly BigAnimal), PGD clusters are locked down such that the only access to the database is through an instance of PGD Proxy. 
