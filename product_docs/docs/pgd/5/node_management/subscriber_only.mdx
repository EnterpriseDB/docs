...
[`bdr.standby_slot_names`](/pgd/5/reference/pgd-settings#bdrstandby_slot_names)
and
[`bdr.standby_slots_min_confirmed`](/pgd/5/reference/pgd-settings#bdrstandby_slots_min_confirmed)
