...
- EDB Postgres® AI Cloud Services (formerly BigAnimal) are a fully managed database-as-a-service offering with built-in Oracle compatibility that runs in your cloud account or the cloud account of EDB Postgres AI Cloud Services where it's operated by our Postgres experts. EDB Postgres AI Cloud Services make it easy to set up, manage, and scale your databases. The addition of distributed high-availability support powered by EDB Postgres Distributed (PGD) enables single- and and multi-region Always-on clusters. See [Distributed high availability](/biganimal/latest/overview/02_high_availability/distributed_highavailability/) in the [EDB Postgres AI Cloud Services documentation](/biganimal/latest) for more information.
...
|                                            |         <center>TPA</center>         | <center>EDB Postgres AI Cloud Services</center> |     <center>Kubernetes</center>      |
|--------------------------------------------|:------------------------------------:|:-----------------------------------------------:|:------------------------------------:|
| Single region                              | <span style="color: green;">✓</span> |      <span style="color: green;">✓</span>       | <span style="color: green;">✓</span> |
