...
Perform Proxy update operations in an EDB Postgres Distributed cluster

### Synopsis

Perform Proxy update operations such as setting proxy options in an EDB Postgres
Distributed cluster.
