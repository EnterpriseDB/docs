---
title: replication show subscriptions
navTitle: show subscriptions
description: Shows BDR subscription (incoming replication) details
---
...
A 3 node cluster, bdr-b1 was down and it has just been restarted.
...
A 3 node cluster, all nodes are up and in 'streaming' state.
...
A cluster with witness, logical standby and subscriber-only nodes; upstream for logical-standby-a1 is bdr-a1 and for logical-standby-b1 is bdr-b1.
