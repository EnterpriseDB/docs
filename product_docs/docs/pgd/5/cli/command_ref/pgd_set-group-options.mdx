...
Following group options can be set through this command -
...
Please note that enable_raft and enable_proxy_routing both should be true if
proxy is attached to the group.
