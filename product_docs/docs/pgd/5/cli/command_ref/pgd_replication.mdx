...
Monitor BDR subscriptions and replication slots for an EDB Postgres Distributed cluster

### Synopsis

Monitor BDR subscriptions and replication slots for an EDB Postgres Distributed
cluster.
