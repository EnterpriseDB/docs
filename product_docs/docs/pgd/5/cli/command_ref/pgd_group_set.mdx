...
Perform group management operations in an EDB Postgres Distributed cluster

### Synopsis

Perform group management operations like setting group write leader, group
options in an EDB Postgres Distributed cluster.
