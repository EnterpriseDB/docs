...
---
 ...
 PGD CLI is available for most Linux distributions. You can install it from the EDB repositories, which you can access with your EDB account. PGD users and EDB Postgres® AI Cloud Services (formerly BigAnimal) users, including those on a free trial, have an EDB account and access to PGD CLI.
