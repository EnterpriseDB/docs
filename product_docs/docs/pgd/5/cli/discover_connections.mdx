...
### For a distributed high-availability cluster manages in EDB Postgres® AI Cloud Services (formerly BigAnimal)

1. Log in to the [EDB Postgres® AI Cloud Services clusters](https://portal.biganimal.com/clusters) view.
