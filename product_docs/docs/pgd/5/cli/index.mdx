...
There is also a guide to [discovering connection strings](discover_connections) which shows how to obtain the correct connection strings for your PGD-powered deployment.
