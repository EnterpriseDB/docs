...
You can install PGD CLI on any system which is able to connect to, or is part of, the PGD cluster. You will require a user with Postgres superuser privileges (or equivalent, e.g., edb_admin on Big Animal PGD) to use PGD CLI.
