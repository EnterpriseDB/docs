...
Then obtain your repository access token from [EDB Repos 2.0](https://www.enterprisedb.com/repos-downloads) by clicking the Repo Access link.
...
First, set the `EDB_SUBSCRIPTION_TOKEN` environmental variable to your EDB repository access token.
