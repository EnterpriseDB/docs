...
PGD lets you override the default behavior of conflict resolution by using the `bdr.alter_node_set_conflict_resolver()` function.
...
|----------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `error`                    | Throws an error and stops replication. Can be used for any conflict type.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| `insert_or_error`          | Tries to build a new row from available information sent by origin and insert it. If there isn't enough information available to build a full row, throws an error and stops the replication. Can be used for `update_missing` and `update_recently_deleted` conflict types.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
