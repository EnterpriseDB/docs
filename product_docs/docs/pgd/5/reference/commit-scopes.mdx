...
Commit scopes are rules which determine how transaction commits and conflicts are handled within a PGD system. You can read more about them in the [Durability](/pgd/latest/durability) section.
