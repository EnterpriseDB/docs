...
| nprovisional_waits   |                          | Number of update/delete operations on same tuples by concurrent apply transactions. These are provisional waits. See [Parallel apply](../parallelapply) |
| ntuple_waits         |                          | Number of update/delete operations that waited to be safely applied. See [Parallel apply](../parallelapply) |
| ncommit_waits        |                          | Number of fully applied transactions that had to wait before being committed. See [Parallel apply](../parallelapply) |
