...
| ntuple_waits         | bigint                   | Number of tuple operations that had to wait to be avoid a deadlock. See [Parallel apply](../parallelapply)           |
| ncommit_waits        | bigint                   | Number of fully applied transactions that had to wait to maintain consistency with their origin. See [Parallel apply](../parallelapply)                     |
