...
| npre_commit_confirmations | bigint              | Number of pre_commit confirmations by CAMO partners                                                                 |
...
| nprovisional_waits   | bigint                   | Number of identical tuples applied by concurrent apply transactions                                                 |
| ntuple_waits         | bigint                   | Number of tuple operations that had to wait to avoid a deadlock                                                     |
| ncommit_waits        | bigint                   | Number of commits that had to wait to maintain consistency with origin                                              |
