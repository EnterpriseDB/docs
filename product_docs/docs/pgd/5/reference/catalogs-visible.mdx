...
| node_group_name     | name        | Name of the PGD group                                                                                                                   |
| node_group_id       | oid         | The OID of the PGD group                                                                                                                |
...
| node_group_id          | oid  | The OID of the PGD node group                                               |
...
| npre_commit          | bigint                   | Number of pre_commits                                                                                               |
...
| nprovisional_waits   | bigint                   | Number of identical tuples applied by concurrent apply transactions. See [Parallel apply](../parallelapply) |
| ntuple_waits         | bigint                   | Number of tuple operations that had to wait to be safely applied to avoid a deadlock  . See [Parallel apply](../parallelapply) |
| ncommit_waits        | bigint                   | Number of fully applied transactions that had to wait before being committed to maintain consistency with origin. See [Parallel apply](../parallelapply) |
...
| node_group_id              | oid         | The OID of the PGD group the node is part of                                             |
