...
This table tracks the status of logical replication slots that are being used with failover support. For more information on failover replication slots, see [Logical Slot Failover Support](/pgd/latest/logical-slot-failover).
...
| active_pid    | int     | PID of the active node                |
