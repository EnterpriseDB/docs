...
CAMO (Commit At Most Once)[durability/camo] is a feature that aims to prevent applications committing more than once. If this feature is used, there are a range of limitations on it that should be taken into account when planning. 
