...
In this quick start, you first install TPA. (If TPA is already installed, you can skip those steps.) You can use and reuse TPA to deploy various configurations of Postgres clusters.
