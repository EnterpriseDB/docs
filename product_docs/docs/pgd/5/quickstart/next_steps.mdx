...
* Discover the [architectural options](architecture/) available with PGD
* Find out how [applications work](applications/) with PGD and how common Postgres features like [sequences](sequences/) are globally distributed
