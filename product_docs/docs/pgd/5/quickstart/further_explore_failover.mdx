...
If we bring back the Postgres service on kaolin, by switching back to the top right pane with Control-b cursor-up Control-b cursor-right (or Control-b q 1) and running:
