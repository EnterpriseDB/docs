...
* [CAMO](camo) focuses on the Commit At Most Once option, which allows
applications to take on the responsibility of verifying that a commit has been
successful before retying. This ensures that their commits only happen at most
once.
