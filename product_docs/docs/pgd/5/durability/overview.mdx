...
-   [CAMO](camo): This kind of commit scope is a variant of Group Commit in which the client is part of the
    consensus.
...
-   [Synchronous Commit](synchronous-commit): This kind of commit scope allows 
