...
The origin_node_group is a PGD group  

A commit scope also has a rule which defines what commit scope kind, or combination of commit scope kinds should be applied
