...
!!! Note
This process will involve you running commands as the Postgres owner. We will refer to this user as `postgres` throughout. If you are running EDB Postgres Advanced Server, you will need to substitute that user withu postgres` in all commands.
!!!
