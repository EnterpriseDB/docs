...
Nodes can run different release levels, negotiating the required protocols to communicate. As a result, EDB Postgres Distributed clusters can use rolling upgrades, even for [major versions](https://www.enterprisedb.com/docs/pgd/latest/upgrades/upgrading_major_rolling/) of database software.
