...
-   At group level, using the function [`bdr.alter_node_group_config()`](/pgd/latest/reference/nodes-management-interfaces/#bdralter_node_group_config)
...
You can use the parameter `streaming_mode` in the function [`bdr.alter_node_group_config()`](/pgd/latest/reference/nodes-management-interfaces/#bdralter_node_group_config)
