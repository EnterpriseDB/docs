...
redirects:
  - /pgd/5/install-admin/admin-biganimal/ #generated for pgd deploy-config-planning reorg 
  - /pgd/5/admin-biganimal/ #generated for pgd deploy-config-planning reorg 
---
