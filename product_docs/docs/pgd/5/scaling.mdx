...
AutoPartition allows you to split tables into several partitions. It lets 
tables grow easily to large sizes using automatic
...
[`bdr.autopartition()`](/pgd/latest/reference/autopartition#bdrautopartition) creates or alters the definition of automatic range
