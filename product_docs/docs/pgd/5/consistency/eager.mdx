...
step The added synchronization step due to the use of a commit scope using eager
...
## Effects of ALL-Node Replication in general
...
confirmations can be large, causing high latencies. All-Node Replication adds
