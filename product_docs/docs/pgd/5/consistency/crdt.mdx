...
PGD CRDT requires usage access to CRDT types. Therefore a user must have at least the [bdr_application](../security/pgd-predefined-roles/#bdr_application) role assigned to them.
!!!
