...
PGD offers a range of [commit scopes](../durability/commit-scopes) with synchronous transaction options that allow you to balance durability, consistency, and performance for your particular queries. 
