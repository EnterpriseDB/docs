...
protocol - leader, follower or candidate to leader) - see [Monitoring Raft Consensus](/pgd/latest/monitoring/sql#monitoring-raft-consensus)
* Whenever a worker has errored out (see [bdr.workers](/pgd/latest/bdr/catalogs#bdr.workers)
and [Monitoring BDR Replication Workers](/pgd/latest/monitoring/sql#monitoring-bdr-replication-workers))
