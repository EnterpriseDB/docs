...
![Always On 1 Location, 3 Nodes Diagram](images/always-on-1x3-updated.png)
...
![Always On 2 Locations, 3 Nodes Per Location, Active/Active Diagram](images/always-on-2x3-aa-updated.png)
