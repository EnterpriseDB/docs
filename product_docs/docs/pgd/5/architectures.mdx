...
![Always On 1 Location, 3 Nodes Diagram](images/alwayson_one_loc.png)
...
![Always On 2 Locations, 3 Nodes Per Location, Active/Active Diagram](images/alwayson_two_loc_active_active.png)
