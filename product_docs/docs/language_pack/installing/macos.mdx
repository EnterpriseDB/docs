...
- Use Stack Builder (with PostgreSQL) to download the EDB installer package and invoke the graphical installer.  See [Using Stack Builder](#using-stack-builder-or-stackbuilder-plus).
