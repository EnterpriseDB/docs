...
The Postgres procedural languages (PL/Perl, PL/Python, and PL/Java) are installed by the Language Pack installer. You can also use an RPM package to add procedural language functionality to your EDB Postgres Advanced Server installation. For more information about using an RPM package, please see the EDB Postgres Advanced Server Installation Guide, available at the [EDB website](https://www.enterprisedb.com/edb-docs).
