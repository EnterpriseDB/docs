...
## Uninstalling PgBouncer on a RHEL/CentOS Host
...
For example, to uninstall PgBouncer 1.15, invoke the following command:

``` text
zypper remove edb-pgbouncer115
```
...
<figure><img src="images/uninstall1.png" class="align-center" alt="The PgBouncer Uninstaller" /><figcaption aria-hidden="true"><em>The PgBouncer Uninstaller</em></figcaption></figure>

2.  The uninstallation process begins. Click `OK` when the uninstallation completes:

<figure><img src="images/uninstall2.png" class="align-center" alt="Uninstallation completes" /><figcaption aria-hidden="true"><em>Uninstallation completes</em></figcaption></figure>
