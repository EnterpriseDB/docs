...
2.  Expand the `Add-ons, tools and utilities` node, and check the box next to the `PgBouncer v1.14.0.1-1`. Click `Next` to continue.
...
Fig. 2: The Selected Packages window
...
Fig. 6: The Installation Directory window
...
Fig. 8: The PgBouncer Configuration window
