...
pdf: true
redirects:
  - /warehousepg/6/admin_guide/external/pxf-overview
  - /warehousepg/7.3/admin_guide/external/pxf-overview
  - /warehousepg/7.4/admin_guide/external/pxf-overview
  - /warehousepg/7.5/admin_guide/external/pxf-overview
directoryDefaults:
  iconName: logos/Whpg
  version: "6"
  displayBanner: >
