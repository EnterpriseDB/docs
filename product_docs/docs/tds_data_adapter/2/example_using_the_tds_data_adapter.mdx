...
- A foreign server and user mapping are defined. See [Create server](configuring/#creating-the-foreign-server) and [Create user mapping](configuring/#create-a-user-mapping).
