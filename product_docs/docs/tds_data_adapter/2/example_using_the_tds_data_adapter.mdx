...
- A foreign server and user mapping are defined. See [Create server](configuring/#create-the-foreign-server) and [Create user mapping](configuring/#create-a-user-mapping).
