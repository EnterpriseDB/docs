---
title: "Using TDS foreign data wrapper"
---
...
- `tds_fdw` is installed and the extension is created on your Postgres database. See [Create extension](configuring/#creating-the-extension).
- A foreign server and user mapping are defined. See [Create server](configuring/#creating-the-foreign-server) and [Create user mapping](configuring/#creating-a-user-mapping).
...
TDS foreign data wrapper allows you to identify the currently installed version of the extension by querying a system catalog. 
