---
title: "Example: Using TDS foreign data wrapper"
---
...
Then run your queries and review the full output. You can report issues on the [GitHub's tds_fdw issues page](https://github.com/tds-fdw/tds_fdw/issues).
