...
| ------------------------ | ----------------------------------------------------------------------- |
| RHEL 8/9 and derivatives | `sudo dnf upgrade edb-as<xx>-tds-fdw`                                   |
| SLES                     | `sudo zypper upgrade edb-as<xx>-tds-fdw`                                |
| Debian and Ubuntu        | `sudo apt-get --only-upgrade install edb-as<xx>-tds-fdw`                |
