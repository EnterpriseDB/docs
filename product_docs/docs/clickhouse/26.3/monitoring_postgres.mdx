...
Run the following steps on your Postgres instance. EDB distributes pg_stat_ch as RPM packages for Rocky Linux 9 on x86-64 and arm64, covering community PostgreSQL, EDB Postgres Extended Server, and EDB Postgres Advanced Server (EPAS), for Postgres versions 16 through 18.
