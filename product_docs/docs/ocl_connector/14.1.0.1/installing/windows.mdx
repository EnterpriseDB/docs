...
navTitle: "On Windows"
redirects:
  - /ocl_connector/14.1.0.1/04_open_client_library/01_installing_and_configuring_the_ocl_connector/install_on_windows
---


You can use the EDB Connectors Installation wizard to add the EDB OCL connector to your Windows system; the wizard is available at the [EDB website](https://www.enterprisedb.com/software-downloads-postgres/).
