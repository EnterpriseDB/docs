...
To install a DEB package on a Debian or Ubuntu host, you must have credentials that allow access to the EnterpriseDB repository. To request credentials for the repository, visit [the EDB website](https://www.enterprisedb.com/repository-access-request).
...
You can use the EnterpriseDB Connectors Installation wizard to add the OCL connector to your system; the wizard is available from [the EnterpriseDB Advanced Downloads page](https://www.enterprisedb.com/advanced-downloads).
