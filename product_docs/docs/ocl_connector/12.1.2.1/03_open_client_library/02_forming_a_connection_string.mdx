...
The OCL connector accepts both Oracle-style and Postgres-style connection URI's. A connection string may take the following Oracle-style form:
...
For more information about using Postgres-style connection strings, please see the PostgreSQL core documentation, available [here](https://www.enterprisedb.com/resources/product-documentation).
