...
title: Installing EDB OCL Connector on Ubuntu 24.04 x86_64
...
redirects:
  - /ocl_connector/16/04_open_client_library/01_installing_and_configuring_the_ocl_connector/install_on_linux_using_edb_repo/x86_amd64/ocl_ubuntu24_x86
---
