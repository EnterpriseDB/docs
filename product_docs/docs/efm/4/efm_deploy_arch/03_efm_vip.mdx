...
For information about using a virtual IP address, see [Using Failover Manager with virtual IP addresses](/efm/latest/efm_user/04_configuring_efm/05_using_vip_addresses/#using_vip_addresses).