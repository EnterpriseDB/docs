...
-----------------|-----------------------------------|-------------------------|---------------------------------
 ...
 go - lib/pq     | No                                |                         | 
 go - jackc/pgx  | Yes                               | 5 and above             | `libpq` syntax is supported. More information: https://pkg.go.dev/github.com/jackc/pgx#ConnConfig
 psycopyg3       | Yes                               | All supported versions  | `libpq` syntax is supported. More information: https://www.psycopg.org/psycopg3/docs/api/connections.html
