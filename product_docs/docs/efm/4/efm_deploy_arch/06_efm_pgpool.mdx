...
<div style=ini-align: center">Figure 5: Failover Manager's traffic routing using EDB Pgpool-II on-premises</div>
...
<div style=ini-align: center">Figure 6: Failover Manager's traffic routing using EDB Pgpool-II in cloud</div>
