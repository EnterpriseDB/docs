...
| Bug Fix | Added validation in the agent startup to check if the parent directory of pg_wal/pg_xlog is writable. This is necessary so EFM can later create a backup of that directory. [Support Ticket #RT77626] |
