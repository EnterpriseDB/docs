...
```shell
apt-get -y install edb-efm<4x>
```

Where `<4x>` is the version of Failover Manager you are installing. For example, if you are installing version 4.2, the package name would be `edb-efm42`.
