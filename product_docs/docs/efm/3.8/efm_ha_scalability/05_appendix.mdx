...
| Standby agent exits or standby node fails   | Failover Manager will notify the administrator and invoke the load_balancer_detach.sh script (when properly configured in efm.properties). For more information, see [load_balancer_detach.sh](#load_balancer_detach_sh) in Appendix B.                                                                                                                                                       |
