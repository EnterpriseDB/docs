...
4.  Start the Failover Manager agent on each node of the cluster. For more information about controlling the Failover Manager service, see [Section 5](08_controlling_efm_service/#controlling-the-failover-manager-service).
...
| Component                         | Location                    |
| --------------------------------- | --------------------------- |
| Executables                       | /usr/edb/efm-3.8/bin        |
| Libraries                         | /usr/edb/efm-3.8/lib        |
| Cluster configuration files       | /etc/edb/efm-3.8            |
| Logs                              | /var/log/efm-3.8            |
| Lock files                        | /var/lock/efm-3.8           |
| Log rotation file                 | /etc/logrotate.d/efm-3.8    |
| sudo configuration file           | /etc/sudoers.d/efm-38       |
| Binary to access VIP without sudo | /usr/edb/efm-3.8/bin/secure |
