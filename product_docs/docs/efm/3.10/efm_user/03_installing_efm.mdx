...
| Component                         | Location                    |
| --------------------------------- | --------------------------- |
| Executables                       | /usr/edb/efm-3.10/bin        |
| Libraries                         | /usr/edb/efm-3.10/lib        |
| Cluster configuration files       | /etc/edb/efm-3.10            |
| Logs                              | /var/log/efm- 3.10           |
| Lock files                        | /var/lock/efm-3.10           |
| Log rotation file                 | /etc/logrotate.d/efm-3.10    |
| sudo configuration file           | /etc/sudoers.d/efm-310       |
| Binary to access VIP without sudo | /usr/edb/efm-3.10/bin/secure |
