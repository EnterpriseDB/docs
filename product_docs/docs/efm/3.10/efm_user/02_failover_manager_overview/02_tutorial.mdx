...
The following properties are the minimal properties required to configure a cluster. If you are configuring a production system, please see [The Cluster Properties File](../04_configuring_efm/01_cluster_properties/#cluster_properties) for a complete list of properties.
