...
>
> \[<witness@localhost> \~\]\# service efm-3.6 status efm-3.6 (pid 50836) is running...
...
>
> Process: 58125 ExecStart=/bin/bash -c /usr/edb/efm-3.6/bin/runefm.sh start ${CLUSTER} (code=exited, status=0/SUCCESS) Main PID: 58180 (java) CGroup: /system.slice/efm-3.6.service └─58180 /usr/lib/jvm/java-1.8.0-openjdk-1.8.0.161-0.b14.el7\_4.x86\_64/jre/bin/java -cp /usr/edb/efm-3.6/lib/EFM-3.6.0.jar -Xmx128m -agentlib:jdwp=transport...
