...
>
> \[[witness@localhost](mailto:witness@localhost) ~]# service efm-3.7 status efm-3.7 (pid 50836) is running...
...
>
> \[[root@ONE](mailto:root@ONE) ~]}> systemctl status efm-3.7  
...
>
> Process: 58125 ExecStart=/bin/bash -c /usr/edb/efm-3.7/bin/runefm.sh start ${CLUSTER} (code=exited, status=0/SUCCESS) Main PID: 58180 (java) CGroup: /system.slice/efm-3.7.service └─58180 /usr/lib/jvm/java-1.8.0-openjdk-1.8.0.161-0.b14.el7_4.x86_64/jre/bin/java -cp /usr/edb/efm-3.7/lib/EFM-3.7.0.jar -Xmx128m -agentlib:jdwp=transport...
