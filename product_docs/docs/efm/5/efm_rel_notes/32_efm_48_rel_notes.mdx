...
| Enhancement | New CLI command 'efm reset-members' added to remove cached node addreses after a node is removed from a cluster.                                                                                                                     | 1047118      |
| Enhancement | Encryption/decryption of database password will now work in a FIPS environment.                                                                                                                                                      | 90803, 90805 |
...
| Bug Fix     | To prevent edge cases of other nodes logging warnings about cluster communication problems, during a cluster shutdown, the coordinator waits a couple of seconds before exiting .                                                    | 96840        |
| Bug Fix     | Fixed a rare timing case that could result in a primary database failure being ignored because of a simultaneous cluster status check.                                                                                               | 98428        |
