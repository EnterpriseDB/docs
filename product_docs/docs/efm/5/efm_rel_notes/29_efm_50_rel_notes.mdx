...
| Enhancement | Removed unnecessary check of database operating system user in sudoers conf file.                                                                                        | 42594, 99957           |
| Enhancement | Removed unnecessary network status check that was added for older operating systems.                                                                                     |                        |
| Enhancement | Table information in 'efm cluster-status' output will now resize to handle long host names.                                                                              | 101878                 |
