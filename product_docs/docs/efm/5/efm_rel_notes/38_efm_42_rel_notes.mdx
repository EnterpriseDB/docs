...
| Enhancement | Promotion priority for standbys can now be defined per primary.                                                                                                                                                                                                                                                                       | 1092697          |
...
| Bug Fix     | Standbys configured with archiving are now properly reconfigured to follow the new primary.                                                                                                                                                                                                                                           | 1127627, 1182654 |
| Bug Fix     | A new option can disable the LoadBalancer detach script when the primary EFM agent fails but Postgres is still running.                                                                                                                                                                                                               | 1096007          |
...
See [The Cluster Properties File](/efm/5/04_configuring_efm/01_cluster_properties/) for more information on the new properties.
