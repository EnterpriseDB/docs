...
| Enhancement | The amount of memory allocated when running the `efm` command has been increased to prevent the [Notification; Unexpected error message](/efm/latest/13_troubleshooting/#notification-unexpected-error-message) issue.                                                                                                   | 58146                  |
