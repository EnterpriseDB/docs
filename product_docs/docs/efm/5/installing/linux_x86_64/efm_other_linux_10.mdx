---
navTitle: AlmaLinux 10 or Rocky Linux 10
title: Installing Failover Manager on AlmaLinux 10 or Rocky Linux 10 x86_64
...
redirects:
  - /efm/5/03_installing_efm/x86_amd64/efm_other_linux10_x86
---
...
Where `<5x>` is the version of Failover Manager that you're installing. For example, if you're installing version 5.4, the package name is `edb-efm54`.
