...
1.  [Failover Manager using VIP (virtual IP)](#_5cok6y4dmox5): Failover Manager has a key
...
2.  [Failover Manager using client connect failover](#failover-manager-using-client-connect-failover):
...
3.  [Failover Manager with PgBouncer](#failover-manager-with-pgbouncer): PgBouncer
...
4.  [Failover Manager with Pgpool](#failover-manager-with-pgpool): Pgpool-II is
...
**Client Connect Failover**
  ...
  -------------------------- ---------------------------- ------------------------------------------------ --------------------------------- ------------------------------
  Features                   Failover Manager using VIP   Failover Manager using client connect failover   Failover Manager with PgBouncer   Failover Manager with Pgpool
  Connection pooling                                                                                       Yes                               Yes
  Runs on cloud (no VIP)                                  Yes                                              Yes                               Yes
  Halt traffic option                                                                                      Yes                               
  Read-only scalability                                   Yes[^1]                                                                            Yes
  Clustered proxy                                                                                                                            Yes
