...
| [enable.stop.cluster](#enable_stop_cluster)                   |       |       | true                                  | This value must be same for all the agents                                                                                                                     |
...
| [detach.on.agent.failure](#detach_on_agent_failure)           |       |       | true                                  | Set to false if you want to keep a running primary database attached.                                                                                     |
...
!!! Note
    ...
    If you are using the `reconfigure.num.sync` property, ensure that the `wal_sender_timeout` in the primary database is set to at least ten seconds lesser than the `efm.node.timeout` value.
...
!!! Note
    ...
    If you are using the `reconfigure.sync.primary` property, ensure that the `wal_sender_timeout` in the primary database is set to at least ten seconds lesser than the `efm.node.timeout` value.
