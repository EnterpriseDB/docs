...
4.  If you are using Eager Failover, you must disable it before stopping the EFM cluster. For more information, see [Disabling the Eager Failover](06_configuring_for_eager_failover/disabling_the_eager_failover).
