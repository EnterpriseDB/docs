...
Replace the value of eth0 with the network interface on your system. See [Chapter 5](#appendix_b) for tuning the number of connections, and pooling configuration.
