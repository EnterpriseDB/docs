...
![Architecture diagram for EFM and Pgpool integration using Azure Load Balancer](images/EFM_PgPool_Azure.png)
 <p align = "center"> <i> Architecture diagram for EFM and Pgpool integration using Azure Load Balancer </i> </p>
...
Configure Pgpool as per the steps given in chapter 3 (except for delegate\_ip, which should be left empty in this architecture).
...
<p align = "center"> <i> Backend pool in Azure console </i> </p>
...
<p align = "center"> <i> Health probes in Azure console </i> </p>
...
<p align = "center"> <i> Load balancing rules in Azure console </i> </p>

1.  Rule created for port 9898 (i.e. PCP port)

![Load balancing rule for port 9898](images/rule_port_9898.png)
<p align = "center"> <i> Load balancing rule for port 9898 </i> </p>

2.  Rule created for port 9999 (i.e. Pgpool port)

![Load balancing rule for port 9999](images/rule_port_9999.png)
<p align = "center"> <i> Load balancing rule for port 9999 </i> </p>

After configuration of the above-mentioned setup, you can connect to Postgres on the IP address of the Network Load Balancer on port 9999. If a failure occurs on the Primary database server, EFM will promote a new Primary and then reconfigure Pgpool to redistribute traffic. If any one of the Pgpool processes is not available to accept traffic anymore, the Network Load Balancer will redistribute all the traffic to the remaining two Pgpool processes. Make sure that listen\_backlog\_multiplier is tuned to compensate for the higher number of connections in case of failover.
