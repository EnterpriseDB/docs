...
legacyRedirects:
  - "/edb-docs/d/edb-postgres-failover-manager/user-guides/user-guide/4.1/installing_debian_ubuntu.html"
  - "/edb-docs/d/edb-postgres-failover-manager/user-guides/user-guide/4.1/installing_sles.html"
  - "/edb-docs/d/edb-postgres-failover-manager/user-guides/user-guide/4.1/post_install_tasks.html"
  - "/edb-docs/d/edb-postgres-failover-manager/user-guides/user-guide/4.1/installing_rhel_centos_oel.html"
...
| Component                         | Location                    |
| --------------------------------- | --------------------------- |
| Executables                       | /usr/edb/efm-4.1/bin        |
| Libraries                         | /usr/edb/efm-4.1/lib        |
| Cluster configuration files       | /etc/edb/efm-4.1            |
| Logs                              | /var/log/efm- 4.1           |
| Lock files                        | /var/lock/efm-4.1           |
| Log rotation file                 | /etc/logrotate.d/efm-4.1    |
| sudo configuration file           | /etc/sudoers.d/efm-41       |
| Binary to access VIP without sudo | /usr/edb/efm-4.1/bin/secure |
