...
EDB SQL Assess provides the ability to parse Oracle SQL statements and assess their compatibility with EDB Postgres Advanced Server, and calling them via Java/JDBC API.
