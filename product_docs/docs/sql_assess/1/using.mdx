...
usage: assessSQL <options>
 ...
 -sourcedb <version>         Specify source database e.g. Oracle 19c
 -targetdb <version>         Specify target database e.g. EPAS 14
 -version                    Print the version information and exit

java -jar assessSQL.jar -version
AssessSQL ver 1.0

java -jar assessSQL.jar -appname TeleApp -inputfilepath /home/abbas/Projects/trc4/ -inputfiletype trace -reportpath /home/abbas/Projects/rep4/ -loglevel FINE
AssessSQL ver 1.0
Input file type: TRACE
Inputfile path: /home/abbas/Projects/trc4/
Report path: /home/abbas/Projects/rep4/
