...
For detailed information about the commands that offer granular control of the objects imported, please see <span class="title-ref">Schema Object Selection Options &lt;schema\_select&gt;</span>.
...
For more information about the `-offlineMigration` option, see <span class="title-ref">Offline Migration Options &lt;offline\_migration&gt;</span>.
