...
Migration Toolkit supports the migration of packages from an Oracle database into Advanced Server. See the [Functionality Overview Section](04_functionality_overview/#functionality_overview) for information about the migration support offered by Advanced Server.
