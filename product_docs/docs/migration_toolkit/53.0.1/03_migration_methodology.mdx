...
2.  Identify potential migration problems. If it is an Oracle-to-Advanced Server migration, consult the [EnterpriseDB documentation](https://www.enterprisedb.com/edb-docs/p/edb-postgres-advanced-server) for complete details about the compatibility features supported in Advanced Server. Consider using EnterpriseDB's migration assessment service to assist in this review.
