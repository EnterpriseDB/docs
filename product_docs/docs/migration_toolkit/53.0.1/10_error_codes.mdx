...
| MTK-10013  | Provided default date time must be in following format 'yyyy-MM-dd*HH:mm:ss'. Time portion is optional, to specify time, the underscore symbol '*' is necessary.               |
