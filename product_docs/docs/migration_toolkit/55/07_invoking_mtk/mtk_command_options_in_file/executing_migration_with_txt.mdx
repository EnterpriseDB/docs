...
```shell
-allTables -excludeTables comp_schema.emp,finance_schema.jobhist -funcs finance_schema.add_two_numbers -safeMode -connRetryCount 7  schema_name
```
...
```shell
-offlineMigration file_dest -allTables -schemaOnly -allSchemas
```
