...
```
./runMTK.sh -allSchemas -tables comp_schema.emp,comp_schema.dept,finance_schema.acctg
```
...
```
-allSchemas -allTables -excludeTables comp_schema.emp,finance_schema.jobhist -funcs finance_schema.add_two_numbers -safeMode -connRetryCount 7
```
