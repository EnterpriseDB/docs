...
| MTK-10067  | The connRetryCount value should be between 0 and 50.                                                                                                                            |
| MTK-10068  | Invalid value for connRetryCount, use a number between 0 and 50.                                                                                                                |
| MTK-10069  | The connRetryInterval value should be between 0 and 900.                                                                                                                        |
| MTK-10070  | Invalid value for connRetryInterval, use a number between 0 and 900.                                                                                                            |
| MTK-10071  | The -pgIdleTxSessionTimeOut value should be greater than 0.                                                                                                                     |
