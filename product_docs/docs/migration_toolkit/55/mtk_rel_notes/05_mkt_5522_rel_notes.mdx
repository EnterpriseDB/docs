...
| Type | Description |
| ---- |------------ |
| Chnage | The EnterpriseDB JDBC Driver in Migration Toolkit is upgraded to the latest version. This upgrade fixes the CVE-2022-21724 vulnerability reported in older versions of EnterpriseDB JDBC Driver. |
