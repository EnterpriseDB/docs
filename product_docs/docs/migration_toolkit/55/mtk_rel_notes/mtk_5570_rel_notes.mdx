...
| Type         | Description                                                                                                                                                                                                                  |
|--------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Enhancement  | The Migration Toolkit is now certified to work with all the supported cluster types in EDB Postgres® AI Cloud Services (formerly BigAnimal) including the distributed high availability clusters.                            |
