...
If you are using PostgreSQL, you can invoke the graphical installer with Stack Builder. See [Using Stack Builder](/supported-open-source/postgresql/installing/using_stackbuilder/). 
...
1. When the installation has completed, select **Finish**.
   ...
   !!! Note
       The EDB JDBC driver is not available for macOS. 
