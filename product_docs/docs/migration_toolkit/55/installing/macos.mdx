...
You must also set the `JAVA_HOME` environment variable based on the location where you installed Java. For MacOS version 10.15 and later, you can use the following command to set the variable:
...
1. After downloading the graphical installer, use the terminal to navigate to the following directory:
