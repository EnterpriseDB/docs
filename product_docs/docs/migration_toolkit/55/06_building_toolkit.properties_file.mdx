...
!!! Note 
    ...
    - When you migrate from MYSQL using the MySQL driver `8.0.26`, the migration of foreign key constraints fails randomly. In such cases, use the MySQL driver version `8.0.25`. 
