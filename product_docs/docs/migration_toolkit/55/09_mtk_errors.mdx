...
Alter the `TARGET_DB_URL` URL in the `toolkit.properties` file to include the new setting for the connection to the database, for example:

```
TARGET_DB_URL=jdbc:edb://1.2.3.4:5432/tcpKeepAlive=true
```
