...
*When I trye to perform a migration with Migration Toolkit, the migration fails and I get the error message:*
...
### Error with timezone region or unsupported character set 
...
1.  Set the classpath environment variable to the JAR file containing the fix: 
