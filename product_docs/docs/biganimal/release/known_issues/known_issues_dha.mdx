...
In some cases, although a regional quota check may have passed initially, when the PGD cluster is created, it may fail due a SKU critical for the Witness Nodes. 
