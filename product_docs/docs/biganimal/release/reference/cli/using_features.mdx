...
To update, delete, and restore faraway replicas, use the `cluster update`, `cluster delete`, and `cluster restore` commands. See [Managing clusters with the CLI](/biganimal/latest/reference/cli/managing_clusters/) for more information.
