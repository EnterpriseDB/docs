...
To update, restore, and delete faraway replicas, use the update-cluster, delete-cluster, and restore-cluster commands. See [Managing clusters with the CLI](/biganimal/latest/reference/cli/managing_clusters/) for more information.
