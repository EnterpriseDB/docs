...
```
clusterName: biganimal-aws-cluster                                      # <string:  cluster name>
password: password@12345                                              # <string:  cluster password (must be at least 12 characters)>
...
```
clusterName: biganimal-gcp-cluster                                    # <string:  cluster name>
password: password@12334                                                # <string:  cluster password (must be at least 12 characters)>
