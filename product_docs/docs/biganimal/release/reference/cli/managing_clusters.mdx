...
-- Add example to pause a cluster using flag mode and interactive mode
...
-- Add example to resume a cluster using flag mode and interactive mode
...
-- Add example to pause a pgd cluster
...
-- Add example of resume pgd cluster