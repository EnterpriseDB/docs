...
## Sample use cases
The examples in this section show Azure as the cloud provider. The functionality is the same when using AWS.
...
Here is a sample for configuration file in YAML format with Azure specified as the provider:
