...
If a credential you created before has expired, you can reset the credential using the following command. Confirm that the user code in your browser matches the one in your terminal and re-authenticate yourself to BigAnimal.
