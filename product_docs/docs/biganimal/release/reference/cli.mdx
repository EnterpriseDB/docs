...
```yaml
  ...
  volumePropertySize: "4Gi"                                                       # <string:  Applicable to AWS gp3 onlyand Azure Ultradisk, volume size in Byte, you may append unit suffix 'Gi' or 'G'.>
