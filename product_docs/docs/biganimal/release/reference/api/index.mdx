...
API v2 is supported starting from June 1, 2022. As part of EDB's change management policy, EDB will support v1 only until Dec 31, 2022. To see the change log for v1 to v2, see [Change log](change_log).
