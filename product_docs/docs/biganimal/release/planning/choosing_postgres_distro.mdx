...
|------------------------------|----------|------------------------------------------------|
| PostgreSQL                   | 12–16    | Single-node, primary/standby high-availability |
| EDB Postgres Advanced Server | 12–16    | Single-node, primary/standby high-availability |
| EDB Postgres Extended Server | 14–16    | Distributed high-availability                  |
| EDB Postgres Advanced Server | 14–16    | Distributed high-availability                  |
...
|------------------------------|----------|------------------------------------------------|
| PostgreSQL                   | 12–16    | Single-node, primary/standby high-availability |
| EDB Postgres Advanced Server | 14–16    | Single node, primary/standby high availability |
| EDB Postgres Extended Server | 14–16    | Distributed high-availability                  |
| EDB Postgres Advanced Server | 14–16    | Distributed high-availability                  |
