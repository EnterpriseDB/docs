...
Different types of events are sent as notifications. Users with different roles can configure these notifications. 
...
- Role unassigned from you
- Access key is about to expire
- New role assigned to you
...
- Organization owners/admins can view the organization notifications. 
