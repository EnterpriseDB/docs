...
To view events, navigate to the [Activity Log](https://portal.biganimal.com/activityLog) page on the [BigAnimal](https://portal.biganimal.com) portal. The organization-level activity log is available from the dropdown menu next to your organization name in the top right of the portal. The project-level activity log is available from the Project menu on the left of the portal. 
