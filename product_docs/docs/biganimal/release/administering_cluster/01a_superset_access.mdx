...
| Alpha | All Superset Gamma privileges, plus the ability to add or alter data  sources | Contributor |
| Admin | All Superset Alpha privileges, plus the ability to grant or revoke access to data to other users  | Owner |
