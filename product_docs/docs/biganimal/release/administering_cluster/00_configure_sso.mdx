---
title: "Registering your indentity provider"

---

After completing the free trial, you can register your application's identity provider (IdP) using SAML or OAuth protocols to authenticate your organization's users in BigAnimal.

### Registering your IdP in BigAnimal

First, the user selects which IdP they’d like to set up: SAML or OIDC.  

For SAML, they’ll need to provide the following information to BigAnimal in a form:
Issuer URI
Single Sign-On URL
Identity Provider Signature Certificate
Pasted or uploaded as a file (.cer or .cert accepted) 
Request Binding 
The SAML Authentication Request Protocol binding used to send the AuthNRequest i.e. HTTP or HTTP POST
Response Signature Algorithm
The signature algorithm used to sign the SAML AuthNRequest i.e. SHA or SHA-256
