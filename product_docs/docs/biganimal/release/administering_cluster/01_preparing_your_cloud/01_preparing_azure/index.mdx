...
2.  From the Azure Cloud Shell, run the following command:  
    ...
    | `-e` or `--endpoint` | Type of network endpoint for the BigAnimal cluster, either **public** or **private**. See [Cluster networking architecture](../../../getting-started/creating_a_cluster/01_cluster_networking) for more information. |
