...
BigAnimal uses Azure Active Directory (AD) and Okta (SAML/OIDC integration) to authenticate users and role-based access controls to grant users access to different parts of the application.
