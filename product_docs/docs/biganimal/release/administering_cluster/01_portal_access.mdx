...
!!! Note
    If you're using EDB Okta as your identity provider, you can invite users to your organization by copying a link from the Users page in the BigAnimal portal and sending it to their email.
