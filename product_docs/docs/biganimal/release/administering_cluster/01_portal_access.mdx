...
Projects in an organization facilitates separate workflows to use BigAnimal across multiple teams with secure and isolated environments. Users can be added to multiple Projects with varying permissions. Users cannot move their clusters between Projects in the MVP. 
