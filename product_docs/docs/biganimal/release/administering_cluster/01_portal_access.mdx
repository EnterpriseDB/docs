...
!!! Note
    You can invite users whom have an EDB account to your organization by copying a link from the Users page in the BigAnimal portal and sending it to their email.
