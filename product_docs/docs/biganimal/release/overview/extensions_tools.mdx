...
- [EDB Postgres Tuner](/pg_extensions/pg_tuner/) &mdash;  provides safe recommendations that maximize the use of available resources. Unlike other extensions that you enable using the CREATE EXTENSION command, you enable edb_pg_tuner on the DB Configuration tab of the Create or Edit Cluster page of the BigAnimal portal. Enabling the cluster disables the effective_cache_size and maintenance_work_mem parameters.
