...
BigAnimal supports [EDB PgBouncer](/pgbouncer/latest/) and [EDB Pgpool-II](/pgpool/latest/) to manage your connections to your Postgres database. PgBouncer can be BigAnimal-hosted or self-hosted, while EDB Pgpool-II can only be self-hosted.
...
If you want to self-host your PgBouncer deployment, see the [How to configure PgBouncer with BigAnimal Cluster](https://support.biganimal.com/hc/en-us/articles/4848726654745-How-to-configure-PgBouncer-with-BigAnimal-Cluster) knowledgebase article.
