...
If you want to control when the updates are pushed to your clusters, you can specify a weekly maintenance window. BigAnimal displays a *scheduled maintenance* message on your cluster list four hours prior to the scheduled maintenance time to remind you to prepare for the upcoming maintenance window. This allows you to make any necessary preparations, such as saving your work and closing any open connections. For more information on specifying maintenance windows, see [Maintenance](/biganimal/latest/getting_started/creating_a_cluster/#maintenance). 
