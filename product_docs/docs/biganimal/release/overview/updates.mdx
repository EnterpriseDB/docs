...
You can ensure the stability and security of your databases by setting maintenance windows for your clusters. For more information, see [Maintenance](/biganimal/latest/getting_started/creating_a_cluster/#maintenance).
