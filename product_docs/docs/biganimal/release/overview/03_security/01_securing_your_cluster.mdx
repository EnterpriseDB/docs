...
For each subscription belonging to your organization, Azure automatically assigns a default set of policies to ensure baseline security. You can customize these default policies to match BigAnimal's specific requirement and further harden security of your resources. 

## Customize the default ASC policy

To be able to customize the default ASC policy, you must have Perform the following steps for each of your Azure subscriptions:
...
Once you have modified the default ASC policy definition associated with each subscription, ensure that your resources are compliant with BigAnimal's security requirements from Remediation tab of the assignment wizard. Perform the following steps: 
