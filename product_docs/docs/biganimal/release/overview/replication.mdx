...
- **Replication lag** &mdash; Promoting a faraway replica to a BigAnimal cluster can result in loss of data. See [Log shipping](/biganimal/latest/using_cluster/04_backup_and_restore/#faraway-replicas).
