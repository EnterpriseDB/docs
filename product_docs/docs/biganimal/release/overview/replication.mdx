...
- **Replication lag** &mdash; Promoting a faraway replica to a BigAnimal cluster can result in loss of data. See [Replication lag](/biganimal/latest/using_cluster/04_backup_and_restore/#faraway-replicas).
