...
| Fast restoration of local HA after data node failure | Yes - if 3 PGD data nodes <br />  No - if 2 PGD data nodes | Yes - if 3 PGD data nodes <br />  No - if 2 PGD data nodes |
