...
If you're looking for a true active-active solution that protects against regional failures, select a three-region configuration. The following is a possible configurations for three regions:

region(2 data + 1 witness) + region(2 data + 1 witness) + region(1 witness)
