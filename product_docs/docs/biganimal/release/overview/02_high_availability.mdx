...
| EDB Postgres Advanced Server     | 11–15            | Single node, high availability |
| EDB Postgres Advanced Server     | 14–15            | Extreme high availability      |
| EDB Postgres Extended Server | 14-15            | Extreme high availability      | 
