...
While other configurations are available, if you're looking for a true active-active solution that protects against regional failures, select a three-region configuration. 
