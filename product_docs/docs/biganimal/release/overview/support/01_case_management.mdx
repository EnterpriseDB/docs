...
You can't reopen support cases that have been in the resolved state for more than seven calendar days. However, you can create a follow-up from the original case. To create a follow-up, select the link at the bottom of the case. The follow-up creates a new case linked to the original case.
