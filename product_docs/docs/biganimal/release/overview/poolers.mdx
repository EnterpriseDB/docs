...
!!!note
   Currently you can't enable EDB PgBouncer when using BigAnimal's cloud account or when creating an extreme-high-availability cluster using your cloud account.
