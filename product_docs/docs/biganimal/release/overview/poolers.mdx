...
!!!note
   Currently you can't enable EDB PgBouncer using the BigAnimal portal when using BigAnimal's cloud account or when creating a distributed high-availability cluster using your cloud account.
