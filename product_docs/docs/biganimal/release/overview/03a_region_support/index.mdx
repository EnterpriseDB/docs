...
| Asia Pacific (Hong Kong)    | ap-east-1 | Enable the region through the [AWS console](https://docs.aws.amazon.com/general/latest/gr/rande-manage.html#rande-manage-enable) <br /> before activating it for BigAnimal. |
