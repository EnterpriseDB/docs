...
| You can't create a new instance with Postgres version X in the BigAnimal interfaces after this date.                                                                                                                                                                                                                        | May 20, 2023        | June 9, 2024        |
| If you manually restore a cluster, you can't restore it with Postgres version X after this date. You need to restore that Postgres cluster into a newer version of Postgres.                                                                                                                                                | May 20, 2023        | June 9, 2024        |
