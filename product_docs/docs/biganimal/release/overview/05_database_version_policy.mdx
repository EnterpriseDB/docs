...
| ---------------------------- | --------------------------------------------------- |
| PostgreSQL                   | 11–15                                               |
| EDB Postgres Advanced Server | 11–15<FeatureFlag flagName="prod-in-preview"> , 14-15 for extreme high availability clusters</FeatureFlag> |
...
| You should start upgrading your BigAnimal instances to a later major version starting on this date. You can use pg_dump to restore your cluster into a later version.                                                                                    | now to May 20, 2023 |
