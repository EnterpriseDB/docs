...
-   BigAnimal provides two methods of backups:
    -   Base backups are the backups of the data directory of your Postgres clusters taken using Barman. These backups are stored on object storage or respective cloud service providers.
    -   Snapshot backups are the volume snapshots stored on disk in the same region as your cluster.
