...
-   You are responsible for managing your Azure resource limits to ensure the underlying infrastructure can be provisioned.

## Backups and restores

-   EDB is responsible for taking backups and archiving transaction logs and storing them in cross-regionally-durable Azure Blob Storage instances. 
...
-   EDB is responsible for securely managing your edb_admin credential. The edb_admin credential will never be stored in plaintext.
