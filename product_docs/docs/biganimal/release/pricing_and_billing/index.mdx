...
This section covers the pricing breakdown for BigAnimal as well as how to view invoices and infrastructure usage. It also covers management costs. 
...
EDB doesn't bill you for cloud infrastructure such as compute, storage, data transfer, monitoring, and logging. 

### Azure Marketplace infrastructure costs
...
To give you full control over your data, BigAnimal deploys infrastructure in each region to manage the clusters in that region. BigAnimal doesn’t charge you for this infrastructure. Azure and AWS bills directly for the infrastructure according to the terms of your account agreement.
...
If you are using Azure Marketplace, all billing is handled directly by Microsoft Azure. This includes infrastructure costs as well as database costs. You can view invoices and usage on the Azure Portal billing page. [Learn more](https://docs.microsoft.com/en-us/azure/cost-management-billing/).
