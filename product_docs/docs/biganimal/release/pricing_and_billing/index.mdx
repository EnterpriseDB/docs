...
If you're connecting directly to BigAnimal through BigAnimal's cloud, EDB bills you for cloud infrastructure, such as compute, storage, data transfer, monitoring, and logging. Monthly estimates for BigAnimal's cloud infrastructure costs can be viewed while creating a cluster. 
...
You can pay for BigAnimal month-to-month with a credit card by making an [EDB account](https://www.enterprisedb.com/accounts/register). BigAnimal sends you monthly invoices to your email. This invoice includes database costs, and if you're using BigAnimal's cloud, infrastructure costs. 
...
On the [Billing](https://portal.biganimal.com/billing) page, you can manage your payment methods and view your invoice total. To cancel your monthly subscription immediately, you can select **Cancel purchase**. Or, to cancel your subscription at the next renewal date, select **Cancel auto-renewal**.
