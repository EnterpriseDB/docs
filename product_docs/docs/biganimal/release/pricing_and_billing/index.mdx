...
When creating a BigAnimal cluster, the estimated monthly price is calculated at the bottom of the page. This price includes the database and infrastructure costs, depending on the cloud service provider you choose. 
...
If you're connecting directly to BigAnimal through BigAnimal-hosted, EDB bills you for cloud infrastructure, such as compute, storage, data transfer, monitoring, and logging. Monthly estimates for your BigAnimal-hosted cloud infrastructure costs can be viewed while creating a cluster. 
...
To give you full control over your data, BigAnimal deploys infrastructure in each region to manage the clusters in that region. BigAnimal charges you for this infrastructure only if you're using BigAnimal-hosted. Microsoft Azure and AWS bill directly for the infrastructure according to the terms of your account agreement.
...
If you're using EDB Digital Self-Service, BigAnimal sends you an invoice via email each month. This invoice includes database costs, and if you're using BigAnimal-hosted, infrastructure costs. 
