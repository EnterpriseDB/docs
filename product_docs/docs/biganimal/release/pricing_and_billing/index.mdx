...
BigAnimal calculates the estimated monthly price for your cluster at the bottom of the page while you are [creating a cluster](/biganimal/release/getting_started/creating_a_cluster). This estimate includes database costs and, if you're using BigAnimal's cloud account, infrastructure costs.
...
If you're connecting directly to BigAnimal through BigAnimal's cloud account, EDB bills you for cloud infrastructure, such as compute, storage, data transfer, monitoring, and logging. Monthly estimates for BigAnimal's cloud infrastructure costs can be viewed while creating a cluster. 
...
BigAnimal charges the credit card on your EDB account monthly and sends invoices to your email. This invoice includes database costs, and if you're using BigAnimal's cloud account, infrastructure costs. 

On the [Billing](https://portal.biganimal.com/billing) page, you can manage your payment methods and view your invoice total.

!!! Note 
    If you want to pay for a longer term of BigAnimal, like for a year or two, then please contact [Sales](https://info.enterprisedb.com/EDB-Contact-Us.html). 

### Direct purchase
If you are using BigAnimal's cloud account, you are invoiced on a monthly basis or you can arrange for a longer term.

If you're using your own Microsoft Azure or AWS account, usage details are included in your invoice. Account owners can download a usage report in CSV format from the BigAnimal Usage page and can set the time frame, database type, and cloud provider prior to downloading the report. The information on the page is refreshed hourly.
