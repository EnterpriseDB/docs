...
If you want to remove management resources provisioned from your cloud provider, reach out to [Support](../overview/06_support).
...
At list price, estimated overall management costs are $400&ndash;$700 for a single cluster. Check with your Microsoft Azure account manager for specifics that apply to your account. 
...
At list price, estimated overall monthly management costs are $4007&ndash;$600 for a single cluster. Check with your AWS account manager for specifics that apply to your account.
