...
- GCP provides invoice information on your Cloud Billing account. [Learn more](https://cloud.google.com/billing/docs).
...
### GCP management costs

The table shows a breakdown of management costs for GCP: 
