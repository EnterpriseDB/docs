...
If you're using EDB Digital Self-Service, BigAnimal sends you an invoice via email each month. This invoice includes database costs, and if you're using BigAnimal's cloud, infrastructure costs. 
