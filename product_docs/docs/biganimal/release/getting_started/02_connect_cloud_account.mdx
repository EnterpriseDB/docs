...
To grant admin consent, a user with the Azure AD Global Administrator or Privileged Role Administrator role goes to [App registrations](https://portal.azure.com/#blade/Microsoft_AAD_RegisteredApps/ApplicationsListBlade) in the Azure portal and selects **API permissions**.
