...
The Azure AD Global Administrator or Privileged Role Administrator role can grant admin consent from Azure **App registrations** at [Azure portal](https://portal.azure.com/), then select **API permissions** to grant admin consent.
