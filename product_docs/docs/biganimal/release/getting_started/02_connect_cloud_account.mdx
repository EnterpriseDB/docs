...
!!! Note
    ...
    Your Azure role must be the below either of the below roles in the Azure AD
      - Global Administrator
      - Privileged Role Administrator
    or you need the cooperation of an user with the above roles in your organization.
...
!!! Note
    After step 1, you are prompted for approval by an Azure AD administrator. Your Azure AD's `Global Administrator` or `Privileged Role Administrator` can approve it.
