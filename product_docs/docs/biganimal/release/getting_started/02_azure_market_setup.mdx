...
description: "Applies when you purchased BigAnimal from Azure Marketplace"
redirects:
- /biganimal/latest/getting_started/02_connecting_to_your_cloud/02_azure_market_setup/
---

!!!note
   We have deprecated the manual, script-based process for setting up your Azure Marketplace account. For information on the deprecated process, contact [Support](/biganimal/release/overview/support).
