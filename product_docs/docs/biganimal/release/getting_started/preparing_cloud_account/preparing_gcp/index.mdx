...
-   Whether your Google Cloud account restricts vCPUs, elastic IP addresses, VPCs, or NLBs in your region (and availability zone, if HA is enabled). 
    ...
    Make sure the GCP Project ID 1234-5678-9012 is the one that you want to use for BigAnimal
    Make sure the GCP account used <YOUR_GCP_ACCOUNT> has rights to create custom roles, service accounts, keys and assign project grants
...
If needed, you can enable required APIs following this [GCP documentation page](https://cloud.google.com/service-usage/docs/enable-disable). You can also increase your quotas following this [Request a higher quota limit](https://cloud.google.com/docs/quota_detail/view_manage#requesting_higher_quota).