...
-   Private — In a private cluster, the IP address or DNS name is private to the VNet or VPC hosting your BigAnimal services. By default, it isn't routable from other networks. See [Cloud infrastructure for your private network cluster](../creating_a_cluster/cloud_infra) for details and instructions on how to properly configure routing for private clusters.
