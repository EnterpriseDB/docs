...
-   Private — In a private cluster, the IP address or DNS name is private to the VNet or VPC hosting your BigAnimal services. By default, it is not routable from other networks. See [Setting up cloud infrastructure to connect to a private network cluster](../../using_cluster/02_connecting_your_cluster/#setting-up-cloud-infrastructure-to-connect-to-a-private-network-cluster) for details and instructions on how to properly configure routing for private clusters.
