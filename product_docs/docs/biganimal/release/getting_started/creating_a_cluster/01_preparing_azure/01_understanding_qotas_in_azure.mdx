---
title: "Understanding resource requirements"
...
The number of vCPUs depends on the *Instance Type* and *High Availability* options of the clusters you provision. You can calculate the number of Esv3 cores required for your cluster as follows:
...
!!! Note
     Ensure that all regions and zones designated for the deployment of your clusters have no SKU restrictions for the vCPU families used by BigAnimal. `Standard_DS2_v2` and `Standard_E2s_v3` in zone 1, 2, and 3 of every region designated for cluster deployment.
