...
- Activate a region prior to cluster creation. See [Activating regions](/biganimal/latest/getting_started/activating_regions).
!!!
...
!!! Note
    Typically maintenance updates only take a few minutes to complete.
