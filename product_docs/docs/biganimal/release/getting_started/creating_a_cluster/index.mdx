...
1. Select which type of cluster to deploy. Note that you cannot switch from single node/HA to BDR or vice versa 
    ...
    -  *Extreme High Availability Cluster* 
...
<!--Need to mention or link to types of BDR architectures --> 
