...
1.  ##### **Networking** section
    ...
    Private networking allows only IP addresses in your private network to connect to your cluster.  If you are using BigAnimal's cloud account, you can enter your cloud service provider's account information, which allows BigAnimal to provide you with a service name, which you can use to connect to your cluster privately. See [Cluster networking architecture](01_cluster_networking) for more information.
