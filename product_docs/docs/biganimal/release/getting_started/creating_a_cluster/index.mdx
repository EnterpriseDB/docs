...
1.  In the top right of the Overview or Clusters page, select **Create New Cluster**.
...
1. Select the type of cloud account for your cluster. You can choose a BigAnimal-hosted account or set up your own. For more information, see [Deployment options](../../overview/deployment_options).

!!! Note
     If you use a BigAnimal-hosted account, your estimated cloud infrastructure costs are calculated into your cluster's estimated monthly price at the bottom of the page. 
