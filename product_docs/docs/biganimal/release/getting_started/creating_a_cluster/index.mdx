...
1.  In the **Database Type** section:
    ...
    1.  Select the type of Postgres you want to use in the **Postgres Type** field:
        ...
        -   [*EDB Postgres Advanced Server*](/epas/latest/) is EDB’s secure, Oracle-compatible PostgreSQL. View [a quick demonstration of Oracle compatibility on Big Animal(../../using_cluster/06_demonstration_oracle_compatibility).
