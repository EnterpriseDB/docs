...
- Distributed High Availability cluster type
...
1. Select the type of cluster to deploy. 
    ...
    !!! Note
       You can't switch from a single-node or primary/standby-high-availability cluster to an distributed high-availability cluster or vice versa. 
