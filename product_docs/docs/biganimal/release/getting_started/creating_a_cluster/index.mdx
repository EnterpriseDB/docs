...
- Before creating the first cluster in a cloud region, you must provision the required resources by activating that region. See [Activating regions](../activating_regions).
!!!
...
1.  In the **Region** section, select the region where you want to deploy your cluster.
 ...
 You can select a region for deploying your cluster even if it is not yet *Active*. Your cluster creation request is added to a queue, and the cluster will be created after you activate the region. See [Activating regions](../activating_regions) for more information.
