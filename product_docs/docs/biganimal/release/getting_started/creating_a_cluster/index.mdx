...
1. Select the type of cloud account for your cluster. You can choose BigAnimal's cloud or set up your own. For more information, see [Deployment options](../../overview/deployment_options).

!!! Note
     If you use BigAnimal's cloud, your estimated cloud infrastructure costs are calculated into your cluster's estimated monthly price at the bottom of the page. 
