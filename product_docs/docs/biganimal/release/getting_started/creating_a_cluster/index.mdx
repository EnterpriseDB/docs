...
- If the TDE enabled cluster creation is in progress and the process is paused providing **Encryption Key Error** next to the cluster name on the clusters page:
