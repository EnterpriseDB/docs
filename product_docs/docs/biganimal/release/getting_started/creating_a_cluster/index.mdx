...
Enable **Transparent Data Encryption (TDE)** to use your own encryption key. This option is available for EDB Postgres Advanced Server and on AWS. Select an encryption key from your project and region to encrypt the cluster with TDE.
