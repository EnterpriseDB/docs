...
As a Project Owner or Project Editor, you have the ability to set/edit maintenance windows for your clusters in order to ensure the stability and security of your databases. By setting a maintenance window, you can specify a 60-minute time frame in which maintenance upgrades occur for each cluster. If you do not set a window, BigAnimal assigns a random maintenance window for you, which might not be ideal for your needs. 

Perform the following steps to set your maintenance window:

1.  Enable the **Custom Maintenance Window** option. This option gives you the ability to set your own maintenance window, rather than relying on a randomly assigned window.
    
1.  Use the dropdown menus to select a day and time during which your weekly maintenance window can occur to best suit your needs.

    !!! Note
    The 60-minute maintenance window specifies the start time, not necessarily the end time, of maintenance events.
    !!!

BigAnimal displays a **Scheduled maintenance** message on the Cluster List 4 hours prior to the scheduled maintenance time. This notification reminds you to prepare for the upcoming maintenance window, and to make any necessary preparations, such as saving your work and closing any open connections.
