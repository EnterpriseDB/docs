...
For information on replication lag while using read-only workloads, see Standby Replicas (/biganimal/latest/overview/02_high_availability/#synchronous-replication). 
