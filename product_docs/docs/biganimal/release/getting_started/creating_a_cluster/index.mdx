...
1.  In the **Database Type** section:
    ...
    1.  In the **Postgres Type** field, select the type of Postgres you want to use:
        ...
        -   **PostgreSQL Compatible** is powered by [EDB Postgres Extended Server](/pge/latest/), which uses advanced logical replication of data and schema. It's available only if you select extreme high availability as your cluster type.
