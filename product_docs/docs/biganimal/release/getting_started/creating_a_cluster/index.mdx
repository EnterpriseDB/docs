...
Enable **PgBouncer** to have it manage your connections to Postgres databases and help your workloads run more efficiently. To learn more about PgBouncer, see the [Supported extensions and tools](/biganimal/latest/overview/extensions_tools/#edb-pgbouncer) topic.

Use the **PgBouncer Configuration Settings** dropdown menu to set PgBouncer-specific settings. Select the Read-Write and Read-Only tabs according to the type of connection you wish to configure. 
