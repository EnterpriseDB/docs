...
Enable **PgBouncer** to have it manage your connections to Postgres databases and help your workloads run more efficiently &mdash; all entirely managed by BigAnimal. To learn more about PgBouncer, see [Connection poolers](/biganimal/latest/overview/poolers/#edb-pgbouncer).
