...
1.  Follow the on-screen guide to grant encrypt and decrypt access rights to your key. Here is additional information in case you require further guidance:
