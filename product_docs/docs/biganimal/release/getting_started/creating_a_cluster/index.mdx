...
Enable **PgBouncer** to have it manage your connections to Postgres databases and help your workloads run more efficiently. To learn more about PgBouncer, see [Supported extensions and tools](/biganimal/latest/overview/extensions_tools/#edb-pgbouncer).
