...
2.  ##### **Networking** section
    ...
    If you're using BigAnimal's cloud account, enter your cloud service provider's account information. BigAnimal uses it for logging and telemetry and for customers using private networking. If you're using private networking, this information also allows BigAnimal to provide you with a service name, which you can use to connect to your cluster privately. 
