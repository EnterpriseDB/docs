...
- Before creating the first cluster in a cloud region, you must provision the required resources by activating that region. See [Activating regions](/biganimal/latest/getting_started/activating_regions).
!!!
