...
---
<figure style="margin: 0 0 20px 20px; float: right;">
  <iframe src="https://drive.google.com/file/d/1niRThmobt5iPV3wgzTrEYxMhUEMEr0SO/preview" width="360" height="202" allow="autoplay fullscreen"></iframe>
  <figcaption style="font-style: italic; font-size: smaller; text-align: center">Video recording of this demonstration</figcaption>
</figure>
...
## Demo #2: average track size with `AVG` and `LISTAGG`

As we saw above, this database has "album" and "track" tables containing metadata on digital recordings. We can use some window functions, including `LISTAGG`, to put together a report on average track storage requirements for albums with "baby" in the title.
