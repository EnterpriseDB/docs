---
title: Preparing your Azure account for BigAnimal
Redirects:
 - 01_check_resource_limits/
---

BigAnimal is deployed inside your Azure account and so requires you to perform some Azure configurationThe following sections help you plan for quotas (service limits) and Azure Service Provider registrations required by your cluster.
...
To launch BigAnimal in a region, BA requires six Esv3 [...]
