...
2.  From the Azure Cloud Shell, run the following command:  
    ...
    | `-i` or `--instance-type` | Azure VM instance type for the BigAnimal cluster. The command help provides a list of possible VM instance types. See [Sizes for virtual machines in Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/sizes) for information to help you choose the appropriate instance type. |
