 ...
 * Is there a restriction on SKUs for the Standard Esv3 VM size family?
...
1. From the Azure Cloud Shell, run the following command to download the script:  
 ...
 ```
 curl -s https://raw.githubusercontent.com/EnterpriseDB/cloud-utilities/main/azure/azure-preflight.sh | bash -s --location <azure_region> --pgtype ENsv3 --endpoint private --ha --with-infra
 ```
...
1. Run the `azure-preflight.sh` script with the following options: 
   ...
   - *--with-infra* indicates that no clusters are created in the region.
  
 ```
  curl -s https://raw.githubusercontent.com/EnterpriseDB/cloud-utilities/main/azure/azure-preflight.sh | bash -s --location <azure_region> --pgtype <pg_type> --endpoint <end_point> [--ha] [--with-infra]
   ```
 ...
 ```
 curl -s https://raw.githubusercontent.com/EnterpriseDB/cloud-utilities/main/azure/azure-preflight.sh | bash -s --location eastus2 --pgtype e2s_v3 --endpoint public --with-infra
 ```
