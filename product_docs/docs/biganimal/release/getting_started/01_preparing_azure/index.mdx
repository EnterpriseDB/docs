 ...
 * A list of required Azure Service Providers and their registeration status. Ensure that you register the service providers that are displayed as `NotRegistered` in the `RegistrationState` column. See [Register Azure service providers](#register-azure-service-providers).
  ```
  #######################
  # Provider            #
  #######################
