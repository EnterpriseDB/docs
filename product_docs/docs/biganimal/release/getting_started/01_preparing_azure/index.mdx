...
You can check vCPU limits for the VM size family using the Azure Cloud Shell. For example, to check the Standard_D2_v4 VM SKU restriction in *westus2* location for all zones, run the following command:
...
Alternatively. to check for SKU restrictions using the Azure Portal, see [here](https://docs.microsoft.com/en-us/azure/azure-resource-manager/templates/error-sku-not-available#solution-3---azure-portal).
