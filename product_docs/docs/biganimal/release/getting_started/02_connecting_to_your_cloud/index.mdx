...
- **If connecting to an Azure subscription, ensure that:** 
   ...
   - You are assigned either the Global Administrator role or have BOTH the Privileged Role Administrator and Cloud Application Administrator role assignments in Azure AD.
