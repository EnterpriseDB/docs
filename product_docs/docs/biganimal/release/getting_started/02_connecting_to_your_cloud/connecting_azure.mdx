...
## Prerequisites
Before connecting to your cloud, ensure that you are assigned either the Global Administrator role or the Privileged Role Administrator role in Azure AD, and you have the Owner role on Azure subscription.
