...
description: How to activate (applies when using your own cloud account), suspend, or delete regions 
---

!!!note
   If you are using BigAnimal's cloud account you don't need to activate regions. You can suspend and delete regions.
