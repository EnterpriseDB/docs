...
To access BigAnimal for the first time, you have to set up your identity provider (IDP). After setting up your identity provider, your identity provider can add users, and you can set up your cloud service provider (CSP) in the BigAnimal portal. 
