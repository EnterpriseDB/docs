...
Alternatively, you can use [BigAnimal's Terraform provider](terraform_provider) to incorporate BigAnimal into your existing cloud infrastructure workflows. *I'm not sure where in the process the Terraform provider comes in. Does mentioning it here make sense?*
