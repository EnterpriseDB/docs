...
To connect BigAnimal to Google's identity provider, you must have:
- A [Super Administrator](https://support.google.com/a/answer/2405986#super_admin) role is assigned to you in Google.
