...
- A [Super Administrator](https://support.google.com/a/answer/2405986#super_admin) role is assigned to you in Google Workspace.
...
1. From the Name ID format menu, select **EMAIL**. From the Name ID menu, select **Primary email**. 
