...
1. Create and name the applcication in the Application catalog. 
   1. Select **Add a custom SAML 2.0 application**.
   1. Name the application, BigAnimal or otherwise, under **Display Name**.
1. At the bottom of the page under **Application metada**, click the link "If you don't have a metadata file...".
   ...
   2. Copy the following information from BigAnimal and Paste it into the Applciation metadad section. 
