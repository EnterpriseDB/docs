...
1. In the browser tab you opened in step 1 using the link in the email sent from cloudcare@enterprisedb.com, you are on the **Setup Config** tab on the Set Up Identity Provider page in BigAnimal. On this tab: 
...
## Next steps  
You and other users can log in to [BigAnimal](https://portal.biganimal.com/overview) using your identity provider credentials by selecting **Sign in to your BigAnimal account** (instead of **Sign in for Azure Marketplace users**).
