...
You can optionally use the quick sign-in URL provided on the **Settings > Identity Provider** page of the BigAnimal portal to create a tile for your users to access for the BigAnimal application. See the [Add linked single sign-on to an application](https://learn.microsoft.com/en-us/azure/active-directory/manage-apps/configure-linked-sign-on) topic in the Microsoft Azure documentation for details.
