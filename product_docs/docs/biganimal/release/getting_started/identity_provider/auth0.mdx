...
!!!Note
   Auth0 doesn't provide a SSO dashboard where you could use the quick sign-in URL we provide to make access to your BigAnimal application easier for end users.
