...
However you purchased BigAnimal, you must set up either EDB Okta as your identity provider (IDP) or you can use your own. If you're using your own IDP, you can add users to BigAnimal by adding them to the designated group in your identity provider. Once you've logged into BigAnimal using your identity provider, you can set up your cloud service provider (CSP) in the BigAnimal portal to complete onboarding. 
