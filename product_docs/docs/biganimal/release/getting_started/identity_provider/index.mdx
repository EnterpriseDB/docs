...
Once you have established the identity provider, you can create a BigAnimal tile for users to access the BigAnimal instance hosting your organization's application. To do so, simply copy the quick sign-in URL from the **Admin > Identity Provider** page of the BigAnimal portal to create the tile. For details on how to add a tile, refer to your identify provider documentation for instructions on setting up SSO access to your application. 
