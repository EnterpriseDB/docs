...
Optionally, once you have set up your identity provider, if your identity provider supports it, you can create a  tile to provide easy access to the BigAnimal instance hosting your organization's application. You can copy the quick sign-in URL from the **Admin > Identity Provider** page of the BigAnimal portal to set up the tile.

Refer to your identify provider documentation for instructions on setting up SSO access to your application. 
