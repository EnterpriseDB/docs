...
Project and organization owners can also invite users that have an EDB account by selecting **Invite New User** on the Users page. After providing their EDB account email and their role, you can send them an invitation link. See 
...
Your domain and its status appears on the **Domains** tab, where you can delete or verify it. Domains can take up to 48 hours to be verified. To add another domain, select **Add Domain**. 
