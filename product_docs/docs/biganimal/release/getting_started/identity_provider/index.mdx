...
If you purchased BigAnimal through EDB, you can use EDB Okta as your identity provider. After signing in for the first time, you can then set up your own identity provider if you wish. 
...
When using EDB Okta, you can invite users by selecting **Invite New User** on the Users page. After providing their EDB account email and their role, you can send them an invitation link. 
...
If using your own cloud account, you can [set up your cloud service provider](/biganimal/latest/getting_started/02_connecting_to_your_cloud/) so that you or other users with the correct permissions can create clusters.

- You can assign roles to your default project. See [Managing portal access](/biganimal/release/administering_cluster/01_portal_access). (If using your own cloud account, you need to set it up first.) 
