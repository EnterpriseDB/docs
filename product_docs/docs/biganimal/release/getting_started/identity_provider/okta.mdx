...
1. Go to the Configure SAML step. 
   ...
   1. On the **Assignments** tab on the Applications page, to assign people or groups to the newly created application, select **Assign**. If you need to sign into BigAnimal, be sure to assign yourself.
   1. On the **Sign On** tab, to open a tab with instructions for your applicationm select **View SAML setup instructions**. 
      1. Copy the Identity Provider Single Sign-on URL from step 1 of the SAML setup instructions.
