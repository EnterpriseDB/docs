...
## Connecting to a private BigAnimal cluster using AWS VPC peering

See the following article for step-by-step instructions for setting up the connection to a private BigAnimal cluster using AWS VPC peering:
