...
You need to register with EDB to access BigAnimal and your $300 in free credits, as well as EDB's training and software downloads. EDB provides a free Postgres training, found here (https://www.enterprisedb.com/training).
