...
You can link to an existing Oracle database to your cluster. This set up enables you to use your cluster in the front-end without risking your production environment. For step-by-step instructions on setting up the infrastructure, see [Linking to your Oracle database](../../../getting_started/creating_a_cluster/cloud_infra/oracle_dblink/).