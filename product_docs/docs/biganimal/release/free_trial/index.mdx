...
BigAnimal offers both standard PostgreSQL and EnterpriseDB Postgres Advanced Server clusters. You can try out either using the latest PostgreSQL version (14) or one of the previous supported versions (11&ndash;13). Other configuration options are limited for the free trail.
