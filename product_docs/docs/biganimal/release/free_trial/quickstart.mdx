...
Follow this quick walk-through to configure a Postgres cluster on BigAnimal. 
...
After you select **Create Cluster**, you'll be brought back to the Clusters page with your newly configured cluster now populating the list. From the Clusters page you can view the details and create a replica of your cluster and edit and delete your cluster.
