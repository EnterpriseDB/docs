...
2.  Select the options for your cluster. See [Creating a cluster](/edb-postgres-ai/cloud-service/getting_started/creating_cluster/creating_a_cluster/) for more information.
...
3.  Connect to the `math` database. You're prompted for the edb_admin password you provided in Step 2.
