...
!!!note
If you prefer a graphical client tool to execute Oracle compatible queries or run Oracle PL/SQL compatible code, we recommend [pgAdmin](https://www.pgadmin.org/docs/).
!!!
