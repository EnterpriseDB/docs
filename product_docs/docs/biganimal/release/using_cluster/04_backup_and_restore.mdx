...
BigAnimal retains backups for 30 days by default. You can change the retention period on the [Backups tab](../getting_started/creating_a_cluster/#backups-tab) when you create or edit your cluster. 
