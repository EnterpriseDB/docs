...
By default, BigAnimal retains backups for 30 days for both types of backups. 

You can restore base backups into a new cluster in any region supported by BigAnimal. However, you can restore the volume snapshots into a new cluster only in the same region.
