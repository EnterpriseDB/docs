...
#### Single-node or primary/standby-high-availability clusters restore
...
#### Distributed-high-availability cluster restore
...
1. In the **Nodes** section, select **Two Data Nodes** or **Three Data Nodes**. For more information on node architecture, see [EDistributed high availability](/biganimal/latest/overview/02_high_availability/#distributed-high-availability-preview).
