...
You can also get the metrics and logs URLs using the `show-cluster-monitoring-urls` CLI command. See [Logging and metrics CLI command](/biganimal/latest/reference/cli/using_features/#logging-and-metrics-cli-command) for more information.
