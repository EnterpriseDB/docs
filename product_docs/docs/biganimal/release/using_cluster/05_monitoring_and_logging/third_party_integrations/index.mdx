...
All the metrics collected from all the clusters in the project are sent to the integrated tool and displayed in the BigAnimal  [**Monitoring and logging** tab using BigAnimal's Observability](../monitoring_using_pemx). The collected logs are exported to the object storage by default.
