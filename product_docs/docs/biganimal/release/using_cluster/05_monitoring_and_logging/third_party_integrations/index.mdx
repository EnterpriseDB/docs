...
You can enable in-app inbox or email notifications to get notified incase third-party monitoring integration fails. For more information, see [managing notifications](../../../administering_cluster/notifications/#managing-notifications).
