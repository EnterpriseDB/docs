...
TBC - will need input from UI team
...
Some platform providers have limitations regarding the ingestion of logs. Please make sure you read the vendor documentation carefully.
