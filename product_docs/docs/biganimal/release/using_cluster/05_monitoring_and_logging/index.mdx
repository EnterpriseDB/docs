...
- BigAnimal provides PEMx as another metric endpoint. PEMx consolidates and exposes metrics in each data plane. PEMx is an integrated monitoring and alerting solution in BigAnimal. It's designed to monitor performance of the Postgres clusters. See [PEMx monitoring](monitoring_using_pemx) for more information.
