...
- BigAnimal provides a Prometheus-compatible endpoint you can use to connect to your own metrics infrastructure such as your AWS Managed Grafana, as well as the option to view logs from your cloud provider's blob storage solution. For more information, see [Other Monitoring and Logging Solutions](custom_monitoring). 
