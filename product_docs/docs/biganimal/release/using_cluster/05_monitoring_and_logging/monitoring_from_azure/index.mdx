...
BigAnimal sends all metrics and logs from PostgreSQL clusters to Azure. You can view metrics and logs directly from Azure. The following describes the metrics and logs that are sent and how to view them.
...
See [Metrics details](06_metrics) for more information.