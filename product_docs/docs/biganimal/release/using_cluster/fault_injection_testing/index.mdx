...
+ You've connected your BigAnimal cloud account with your Azure subscription. See [Connecting your Azure cloud](/biganimal/latest/getting_started/02_connecting_to_your_cloud/connecting_aws/) for more information.
