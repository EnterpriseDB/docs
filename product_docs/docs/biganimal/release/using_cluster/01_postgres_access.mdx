...
- [Managing portal access](../administering_cluster/01_portal_access/) to control the roles and privileges for your organization
...
- You can grant the edb_admin role superuser privileges for a cluster. If you grant superuser privileges, you must take care to limit the number of connections used by superusers to avoid degraded service or compromising availability.
