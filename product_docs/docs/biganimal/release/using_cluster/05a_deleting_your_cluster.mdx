...
1. Contact [Support](../overview/06_support/) to stop the associated management costs. For more information on management costs see [Pricing and billing](../pricing_and_billing).
