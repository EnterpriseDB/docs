...
- Depending on your appetite for testing, you can optionally switch your traffic over to the blue site to enable testing of the green. Moreover, you could use the switchover feature to promote B2 to write leader (as depicted) to test through the application stack:

<center>

![](images/blue-green_pgd-node_switchover.svg)    
