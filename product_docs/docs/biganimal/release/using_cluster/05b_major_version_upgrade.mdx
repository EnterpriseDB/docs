...
Using pg_dump to migrate between major versions requires creating a new BigAnimal instance with the new version of Postgres. This procedure does not work for upgrading a distributed high-availability BigAnimal instance.
