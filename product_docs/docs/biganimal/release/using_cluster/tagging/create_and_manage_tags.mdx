...
1. From the drop down menu under your name in the top right of the panel, select **Tags**.

1. From the Create Tag page, select **Create Tag**.

1. Provide the **Tag Name**.
...
**To assign a tag to a cluster:**

1. Go to clusters home page.

1. In the clusters list, select the edit icon next to the cluster.

1. On the **Edit Cluster** page, go to **Cluster Settings** tab.

1. Select **+** button under **Tags**.

1. Provide the name of the tag in search bar, and select the tag.

1. Select **Save** button to assign the tag.

**To assign a tag to a project:**

1. Go to projects home page.

1. In the projects list, select the edit icon next to the project.

1. On the **Edit Project** page, select **+** button under **Tags**.
...
1. Select **Save** button to apply the changes.
...
1. On the **Tags** page, select the delete button next to the tag name.

1. On the **Delete tag** page, it asks to type **delete tag** into the field.

1. Select **Yes, Delete tag** to delete the tag.
