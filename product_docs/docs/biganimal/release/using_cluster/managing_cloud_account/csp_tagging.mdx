...
Tags are key-value pairs you can apply to cloud provider resources created on your own cloud account, also known as [Your Cloud Account](/edb-postgres-ai/cloud-service/using_cluster/your_cloud_account). Resource tagging allows you to have fine-grained audit policy and cost control over your resources. When you add a tag, the following resources are labeled: 
