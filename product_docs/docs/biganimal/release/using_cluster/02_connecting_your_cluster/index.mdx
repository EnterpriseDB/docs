...
redirects:
  ...
  #when I originally created the folder I didn't add an ordering prefix but need to add one 
...
You can connect to the private cluster from an application in Azure, see [Connecting from Azure](01_connecting_from_azure). This section also contains walkthrough examples to guide you through the different methods to connect to your cluster.