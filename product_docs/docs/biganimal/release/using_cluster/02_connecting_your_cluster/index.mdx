...
### Setting up AWS infrastructure to connect to a private network cluster

You can connect to the private cluster from an application in Azure. See [Connecting from Azure](01_connecting_from_azure),