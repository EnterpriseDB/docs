---
title: "Linking to an Oracle database in Azure"

---

This topic describes how you can set up the infrastructure for linking an existing Oracle database in the front end and Postgres for reporting in the back end. This allows you to evaluate Postgres without risking your production environment.
