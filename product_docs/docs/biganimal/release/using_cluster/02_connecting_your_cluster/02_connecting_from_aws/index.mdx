...
1. You can see a list of load balancers, and each load balancer is tagged with the ID of the cluster to which it is deployed (`<cluster-id>-rw-internal-lb`). For example, `p-96fh28m3cb-rw-internal-lb`.
