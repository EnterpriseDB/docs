...
When using BigAnimal's cloud account, you provide BigAnimal with your AWS account ID when creating a cluster (see [Networking](/biganimal/latest/getting_started/creating_a_cluster/network-logs--telemetry-section)). BigAnimal, in turn, provides you with a AWS service name, which you can use to connect to your cluster privately.
