...
While we recommend using Private Service Connect when using your own Google Cloud account, another option is VPC peering. See [VPC peering](vpc_peering) for more information.
