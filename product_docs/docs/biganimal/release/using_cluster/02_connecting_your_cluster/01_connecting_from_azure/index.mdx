...
5. Enter the details for the private endpoint in the **Basics** tab:
   ...
   - Resource group &mdash; Select the Resource Group where your vm-client resides.  In this case, it is `rg-client`.
...
you created by entering the following details:
   ...
   - Resource group &mdash; Select *Microsoft.Network/privateLinkServices*.  This is the type of resource you would like to connect to using this private endpoint.
