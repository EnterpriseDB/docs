...
Redirects:
 - connecting_your_cluster/01_connecting_from_azure/01_private_endpoint/
---
...
1. Create a private DNS zone using your organization's domain name as an apex domain. The organization's domain name must be unique to your BigAnimal organization. For example, `biganimal.io`.
