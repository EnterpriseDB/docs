...
[EDB PgBouncer](/pgbouncer/latest/) is a lightweight connection pooling utility that you can use to more quickly connect to your BigAnimal cluster. It saves you time by pooling previously established connections to your server. Instead of waiting for your server to negotiate every connection, EDB PgBouncer can negotiate the connection for you. 
