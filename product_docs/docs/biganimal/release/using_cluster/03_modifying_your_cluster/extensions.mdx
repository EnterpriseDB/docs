...
You need superuser privileges to install most extensions on BigAnimal. Those that don't require superuser privileges to install on BigAnimal are denoted as such in the table at [Supported Postgres extensions](/pg_extensions/latest/).
