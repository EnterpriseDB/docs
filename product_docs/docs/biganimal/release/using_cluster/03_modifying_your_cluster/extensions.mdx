...
BigAnimal supports many Postgres extensions. See [Postgres extensions available by offering](/pg_extensions/) for the complete list.
...
You need superuser privileges to install most extensions on BigAnimal. The table in [Postgres extensions available by offering](/pg_extensions/) indicates whether an extension requires superuser privileges or not.
