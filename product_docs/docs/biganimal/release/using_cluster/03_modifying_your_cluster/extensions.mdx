...
You need superuser privileges to install most extensions on BigAnimal. If an extension is trusted, it does not require superuser privileges to install. The Postgres documentation for an extension indicates if it is trusted or not. 
