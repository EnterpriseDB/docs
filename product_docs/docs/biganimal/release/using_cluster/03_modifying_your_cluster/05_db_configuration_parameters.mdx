...
## Using equations for parameter values

In addition to entering specific values for parameters, for some parameters you can specify equations to automatically calculate a value relative to the machine specifications you selected for the cluster. 
...
This example uses an equation for the `shared_buffers` parameter value.
