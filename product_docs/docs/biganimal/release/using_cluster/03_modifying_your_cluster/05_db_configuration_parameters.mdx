...
In addition to entering specific values for parameters, for some parameters you can specify formulas to automatically calculate a value. 
...
Formulas can calculate a value relative to the specifications you selected for the cluster or relative to two non-pseudo GUCs.

You can use equations for parameters of type integer and real. GUCs used in formulas must also be of type integer or real.
