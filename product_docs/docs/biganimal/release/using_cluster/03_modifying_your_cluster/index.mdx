...
4.  You can modify the following settings on the corresponding tab of the Edit Cluster page:
    ...
    | Volume type                          | [Cluster Settings](../../getting_started/03_create_cluster/#cluster-settings-tab)  |
...
- You cannot switch between the io2 and io2 Block Express volume types in an AWS cluster.
