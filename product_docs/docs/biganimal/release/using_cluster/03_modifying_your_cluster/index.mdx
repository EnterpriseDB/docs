...
4. You can modify the following settings on the corresponding tab of the Edit Cluster page.
   ...
   | Networking type (public or private)                  | **Cluster Settings**    | If you're using Azure and previously set p a private link and want to  change to a public network, you must remove the private link resources before making the change.                                                                                                                                                                                            |
