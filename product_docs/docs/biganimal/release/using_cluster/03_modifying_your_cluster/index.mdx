...
4. You can modify the following settings on the corresponding tab of the Edit Cluster page:
   ...
   | Custom Maintenance Window                            | Additional Settings | The 60-minute maintenance window specifies the start time, not necessarily the end time, of maintenance events. 
