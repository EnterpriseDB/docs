...
4. You can modify the following settings on the corresponding tab of the Edit Cluster page:
   ...
   | Database configuration parameters                    | DB Configuration | If you are using faraway replicas, only a small subset of parameters are editable. These parameters need to modified in the replica when increased in the replica's parent cluster. See [Modify a faraway replica](/biganimal/latest/using_cluster/managing_replicas/#modify-a-faraway-replica/) for details.                                                                                                                                                                                                                                                                                |
