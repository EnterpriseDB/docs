...
You can also modify your cluster by installing Postgres extensions. See [Installing Postgres extensions](/biganimal/release/using_cluster/03_modifying_your_cluster/extensions) for more information.
