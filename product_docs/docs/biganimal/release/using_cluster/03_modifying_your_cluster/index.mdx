...
4. You can modify the following settings on the corresponding tab of the Edit Cluster page:
   ...
   | Write-Ahead Logs (WALs)                              | Cluster Settings    | Once Write-Ahead Log (WAL) separation is enabled in your cluster, you will not be able to disable it later, but you can still adjust the size and input/output operations per second (IOPS) of the WAL volume as needed.                                                                                                                                                                                                                                                                             |
