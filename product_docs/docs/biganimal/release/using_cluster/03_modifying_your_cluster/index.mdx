...
4. You can modify the following settings on the corresponding tab of the Edit Cluster page:
   ...
   | Custom maintenance window                            | Additional Settings | Create or modify a maintenance window in which maintenance upgrades occur for the cluster. See [Maintenance](/biganimal/latest/getting_started/creating_a_cluster/#maintenance). |
