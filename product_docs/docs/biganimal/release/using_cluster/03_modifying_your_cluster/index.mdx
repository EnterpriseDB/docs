...
4.  You can modify the following settings on the corresponding tab of the Edit Cluster page:
   ...
   \** It can take upto a few hours to tune and resize the disks in your cluster. The volume properties are disabled and cannot be modified while this is in progress.
