...
See the table for a list of supported databases from which you can migrate to BigAnimal using the Migration Toolkit command-line tool. For more information, see [Migration Toolkit](https://www.enterprisedb.com/docs/migration_toolkit/latest/) documentation.

| Source database                                      | To PostgreSQL | To EDB Postgres Advanced Server |
|------------------------------------------------------|------------|------------------------------|
| Microsoft SQL Server                                 | No        | Yes                          |
| PostgreSQL                                           | Yes        | Yes                          |
| EDB Postgres Advanced Server                         | No         | Yes                          |
