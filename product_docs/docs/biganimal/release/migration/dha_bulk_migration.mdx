...
The target-password for the target-user will be available from the BigAnimal dashboard for the cluster. 
...
LiveCompare will compare the source and target databases and generate a report of the differences. 
