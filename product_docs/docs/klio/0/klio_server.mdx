...
originalFilePath: >-
  https://github.com/EnterpriseDB/klio/blob/main/documentation/web/versioned_docs/version-0.0.16/user/klio_server.md
sidebar_position: 5
...
[Managing Storage](managing_storage.mdx).
...
spec:
  ...
  image: docker.enterprisedb.com/k8s/klio:v0.0.16
