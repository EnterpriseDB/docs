...
originalFilePath: >-
  https://github.com/EnterpriseDB/klio/blob/main/documentation/web/versioned_docs/version-0.0.16/user/plugin_configuration.md
sidebar_position: 6
...
-   A client TLS certificate stored in a Kubernetes Secret (see
    [Klio server authentication](klio_server.mdx#authentication))
