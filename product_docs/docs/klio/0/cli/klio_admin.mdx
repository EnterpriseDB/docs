...
title: klio admin
originalFilePath: >-
  https://github.com/EnterpriseDB/klio/blob/main/documentation/web/versioned_docs/version-0.0.15/user/cli/klio_admin.md
...
-   [klio admin delete-backup](klio_admin_delete-backup.mdx)	 - Delete a backup from the Klio server
