...
title: klio server
originalFilePath: >-
  https://github.com/EnterpriseDB/klio/blob/main/documentation/web/versioned_docs/version-0.0.12/user/cli/klio_server.md
...
-   [klio server start](klio_server_start.mdx)	 - Starts a Klio server
