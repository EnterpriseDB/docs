...
originalFilePath: >-
  https://github.com/EnterpriseDB/klio/blob/main/documentation/web/versioned_docs/version-0.0.12/user/cli/klio_retention.md
...
-   [klio retention get](klio_retention_get.mdx)	 - Gets the currently applied retention policy
-   [klio retention set](klio_retention_set.mdx)	 - Sets the currently applied retention policy
