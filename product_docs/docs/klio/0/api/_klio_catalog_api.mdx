...
| `status` *[KlioBackupStatus](#kliobackupstatus)*                                                                   |                                                                 |          |         |            |
...
| `metadata` *[ListMeta](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#listmeta-v1-meta)* | Refer to Kubernetes API documentation for fields of `metadata`. | True     |         |            |
...
| `startedAt` *[Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#time-v1-meta)* | StartedAt is the current time when the backup started.                            | True     |         |            |
| `stoppedAt` *[Time](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#time-v1-meta)* | StoppedAt is the current time when the backup ended.                              | True     |         |            |
