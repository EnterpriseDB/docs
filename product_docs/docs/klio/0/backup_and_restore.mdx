...
originalFilePath: >-
  https://github.com/EnterpriseDB/klio/blob/main/docs/documentation/web//versioned_docs/version-0.0.10/backup_and_restore.md
sidebar_position: 7
...
[retention policy](plugin_configuration.mdx#retention-policies) defined in the
