...
originalFilePath: >-
  https://github.com/EnterpriseDB/klio/blob/main/documentation/web/versioned_docs/version-0.0.16/user/backup_and_restore.md
sidebar_position: 7
...
2.  **Restores WAL files**: Klio is configured to retrieve the WAL files
