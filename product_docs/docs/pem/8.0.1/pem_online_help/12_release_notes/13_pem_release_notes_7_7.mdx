...
[Bug \#3877](https://redmine.postgresql.org/issues/3877) - Make the browser more robust in the face of multibyte characters in SQL\_ASCII databases.  
...
[Bug \#3961](https://redmine.postgresql.org/issues/3961) - Exclude HTTPExceptions from the all\_exception\_handler as they should be returned as-is.  
...
[Bug \#3973](https://redmine.postgresql.org/issues/3973) - Use 'set\_config(...)' function to update the 'bytea\_output' settings instead of 'UPDATE' statement, which is not allowed in the the read-only instances.  
