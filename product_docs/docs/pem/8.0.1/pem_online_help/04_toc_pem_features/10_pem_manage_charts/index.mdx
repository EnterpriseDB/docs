...
> -   [Create a New Chart](../04_toc_pem_features/10_pem_manage_charts/#pem_create_new_chart) for use on a custom dashboard.
> -   [Import a Capacity Manager template](../04_toc_pem_features/10_pem_manage_charts/#pem_manage_charts_template) to use as a template for creating a custom chart.
...
pem\_create\_new\_chart pem\_manage\_charts\_template
