...
| table, index, sequence or function name | '${object\_name}'   |
...
After defining a template, you can use the [Manage Alerts](../../04_toc_pem_features/09_pem_alerting/#pem_alerting_dialog) tab to create and enable an alert based on the template.
