...
Click the `Generate` button to display the report onscreen (accepting the default configuration options), or continue to the [Options](../../04_toc_pem_features/08_capacity_manager/#capacity_manager_options) tab to specify sampling boundaries, report type and report destination.
