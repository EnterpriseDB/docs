...
When PEM executes [scheduled tasks](../../04_toc_pem_features/18_pem_task_view/../../04_toc_pem_features/18_pem_task_view/#pem_task_view), log records are created to record the status of each step of the task for diagnostic purposes. Log records can be viewed on the *Log Viewer* dialogue, opened from the [Scheduled Task dialogue](../../04_toc_pem_features/18_pem_task_view/../../04_toc_pem_features/18_pem_task_view/#pem_task_view).
