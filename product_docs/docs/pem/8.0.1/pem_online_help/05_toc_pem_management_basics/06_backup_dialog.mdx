...
When you’ve specified the details that will be incorporated into the pg\_dump command:
...
You can click on the ![sm\_icon](../images/sm_icon.png) icon in the process watcher window to open the file location in the Storage Manager. You can use the [Storage Manager](../05_toc_pem_management_basics/#storage_manager) to download the backup file on the client machine .
