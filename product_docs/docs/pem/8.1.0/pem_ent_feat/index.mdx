...
This document uses `Postgres` to mean either the PostgreSQL or EDB Postgres Advanced Server database or EDB Postgres Extended (formerly known as 2nQPostgres).
