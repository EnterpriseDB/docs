...
To include monitoring information on the BDR dashboards, you must enable the relative probes for each BDR Group. You can see the complete list of BDR Probes [here](05_performance_monitoring_and_management/#bdr_probes).
