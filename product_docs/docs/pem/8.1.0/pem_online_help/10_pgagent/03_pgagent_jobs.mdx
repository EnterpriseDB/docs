...
<figure><img src="../images/pgagent_general.png" class="align-center" alt="Create pgAgent Job dialog - General tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - General tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_steps.png" class="align-center" alt="Create pgAgent Job dialog - Steps tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - Steps tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_step_definition.png" class="align-center" alt="Create pgAgent Job dialog - Steps tab - General tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - Steps tab - General tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_step_definition_code.png" class="align-center" alt="Create pgAgent Job dialog - Steps tab - Code tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - Steps tab - Code tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_schedules.png" class="align-center" alt="Create pgAgent Job dialog - Schedules tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - Schedules tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_schedule_definition.png" class="align-center" alt="Create pgAgent Job dialog - Schedules tab - General tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - Schedules tab - General tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_schedule_repeat.png" class="align-center" alt="Create pgAgent Job dialog - Schedules tab - Repeat tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - Schedules tab - Repeat tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_schedule_exceptions.png" class="align-center" alt="Create pgAgent Job dialog - Schedules tab - Exceptions tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - Schedules tab - Exceptions tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_sql.png" class="align-center" alt="Create pgAgent Job dialog - SQL tab" /><figcaption aria-hidden="true"><em>Create pgAgent Job dialog - SQL tab</em></figcaption></figure>
...
<figure><img src="../images/pgagent_properties.png" class="align-center" alt="pgAgent Object Properties tab" /><figcaption aria-hidden="true"><em>pgAgent Object Properties tab</em></figcaption></figure>
