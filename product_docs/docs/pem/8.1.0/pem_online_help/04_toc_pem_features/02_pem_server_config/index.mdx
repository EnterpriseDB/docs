...
<figure><img src="../../images/pem_server_config.png" class="align-center" alt="Server Configuration dialogue" /><figcaption aria-hidden="true"><em>Server Configuration dialogue</em></figcaption></figure>
