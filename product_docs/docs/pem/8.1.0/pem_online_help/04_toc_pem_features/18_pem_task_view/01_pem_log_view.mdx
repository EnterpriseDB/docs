...
<figure><img src="../../images/pem_log_view.png" class="align-center" alt="Scheduled Task Log viewer" /><figcaption aria-hidden="true"><em>Scheduled Task Log viewer</em></figcaption></figure>
