...
<figure><img src="../../images/capacity_manager_metrics.png" class="align-center" alt="Capacity manager metrics selection list" /><figcaption aria-hidden="true"><em>Capacity manager metrics selection list</em></figcaption></figure>
...
<figure><img src="../../images/capacity_manager_add_metric.png" class="align-center" alt="Capacity manager metrics selection" /><figcaption aria-hidden="true"><em>Capacity manager metrics selection</em></figcaption></figure>
