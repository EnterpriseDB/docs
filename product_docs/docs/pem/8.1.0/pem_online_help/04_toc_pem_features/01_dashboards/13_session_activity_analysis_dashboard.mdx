...
<figure><img src="../../images/session_activity_analysis_dashboard.png" class="align-center" alt="Session Activity Analysis dashboard" /><figcaption aria-hidden="true"><em>Session Activity Analysis dashboard</em></figcaption></figure>
