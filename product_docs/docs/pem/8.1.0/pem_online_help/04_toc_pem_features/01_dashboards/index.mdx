...
<figure><img src="../../images/dashboard_configuration.png" class="align-center" alt="Dashboard configuration" /><figcaption aria-hidden="true"><em>Dashboard configuration</em></figcaption></figure>
