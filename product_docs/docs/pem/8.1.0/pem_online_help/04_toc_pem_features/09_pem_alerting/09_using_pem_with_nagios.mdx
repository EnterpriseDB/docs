...
<figure><img src="../../images/nagios_alert_notification.png" class="align-center" alt="Nagios Alert - Notification tab" /><figcaption aria-hidden="true"><em>Nagios Alert - Notification tab</em></figcaption></figure>
...
<figure><img src="../../images/nagios_server_configuration.png" class="align-center" alt="Nagios Server Configuration options" /><figcaption aria-hidden="true"><em>Nagios Server Configuration options</em></figcaption></figure>
