...
<figure><img src="../images/bart_backup_dashboard.png" class="align-center" alt="BART Dashboard" /><figcaption aria-hidden="true"><em>BART Dashboard</em></figcaption></figure>
