...
<div id="erd_tool" class="registered_link"></div>
...
<figure><img src="../images/erd_tool.png" class="align-center" alt="ERD Tool" /><figcaption aria-hidden="true"><em>ERD Tool</em></figcaption></figure>
...
<figure><img src="../images/erd_tool_toolbar.png" class="align-center" alt="ERD Tool - Toolbar" /><figcaption aria-hidden="true"><em>ERD Tool - Toolbar</em></figcaption></figure>
...
<figure><img src="../images/erd_table_dialog.png" class="align-center" alt="ERD Tool - Table Dialog" /><figcaption aria-hidden="true"><em>ERD Tool - Table Dialog</em></figcaption></figure>

The table dialog allows you to:

-   Change the table structure details.
-   It can be used edit an existing table or add a new one.
-   Refer [table dialog](#table-dialog) for information on different fields.

## Table Node

<figure><img src="../images/erd_table_node.png" class="align-center" alt="ERD Tool - Table Node" /><figcaption aria-hidden="true"><em>ERD Tool - Table Node</em></figcaption></figure>
...
-   Upon double click on the table node or by clicking the edit button from the toolbar, the table dialog opens where you can change the table details. Refer [table dialog](#table-dialog) for information on different fields.

## The One to Many Link Dialog

<figure><img src="../images/erd_1m_dialog.png" class="align-center" alt="ERD Tool - One to Many Dialog" /><figcaption aria-hidden="true"><em>ERD Tool - One to Many Dialog</em></figcaption></figure>
...
<figure><img src="../images/erd_mm_dialog.png" class="align-center" alt="ERD Tool - Many to Many Dialog" /><figcaption aria-hidden="true"><em>ERD Tool - Many to Many Dialog</em></figcaption></figure>
...
<figure><img src="../images/erd_table_link.png" class="align-center" alt="ERD Tool - Table Link" /><figcaption aria-hidden="true"><em>ERD Tool - Table Link</em></figcaption></figure>
...
<figure><img src="../images/erd_table_note.png" class="align-center" alt="ERD Tool - Table Notes" /><figcaption aria-hidden="true"><em>ERD Tool - Table Notes</em></figcaption></figure>
