---
title: "Import/Export data Dialog"
---
...
<figure><img src="../images/import_export_options.png" class="align-center" alt="Import/Export data dialog - Options tab" /><figcaption aria-hidden="true"><em>Import/Export data dialog - Options tab</em></figcaption></figure>
...
<figure><img src="../images/import_export_miscellaneous.png" class="align-center" alt="Import/Export data dialog - Miscellaneous tab" /><figcaption aria-hidden="true"><em>Import/Export data dialog - Miscellaneous tab</em></figcaption></figure>
...
<figure><img src="../images/import_export_columns.png" class="align-center" alt="Import/Export data dialog - Columns tab" /><figcaption aria-hidden="true"><em>Import/Export data dialog - Columns tab</em></figcaption></figure>
...
<figure><img src="../images/import_export_complete.png" class="align-center" alt="Import/Export data dialog - Completion Notification" /><figcaption aria-hidden="true"><em>Import/Export data dialog - Completion Notification</em></figcaption></figure>
...
<figure><img src="../images/import_export_pw.png" class="align-center" alt="Import/Export data dialog - Process Watcher" /><figcaption aria-hidden="true"><em>Import/Export data dialog - Process Watcher</em></figcaption></figure>
