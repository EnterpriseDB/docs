...
<figure><img src="../images/restore_general.png" class="align-center" alt="Restore dialog - General tab" /><figcaption aria-hidden="true"><em>Restore dialog - General tab</em></figcaption></figure>
...
<figure><img src="../images/restore_sections.png" class="align-center" alt="Restore dialog - Restore Options tab - Sections" /><figcaption aria-hidden="true"><em>Restore dialog - Restore Options tab - Sections</em></figcaption></figure>
...
<figure><img src="../images/restore_objects.png" class="align-center" alt="Restore dialog - Restore Options tab - Type of objects section" /><figcaption aria-hidden="true"><em>Restore dialog - Restore Options tab - Type of objects section</em></figcaption></figure>
...
<figure><img src="../images/restore_do_not_save.png" class="align-center" alt="Restore dialog - Restore Options tab - Do not save section" /><figcaption aria-hidden="true"><em>Restore dialog - Restore Options tab - Do not save section</em></figcaption></figure>
...
<figure><img src="../images/restore_queries.png" class="align-center" alt="Restore dialog - Restore Options tab - Queries section" /><figcaption aria-hidden="true"><em>Restore dialog - Restore Options tab - Queries section</em></figcaption></figure>
...
<figure><img src="../images/restore_disable.png" class="align-center" alt="Restore dialog - Restore Options tab - Disable section" /><figcaption aria-hidden="true"><em>Restore dialog - Restore Options tab - Disable section</em></figcaption></figure>
...
<figure><img src="../images/restore_miscellaneous.png" class="align-center" alt="Restore dialog - Restore Options tab - Miscellaneous section" /><figcaption aria-hidden="true"><em>Restore dialog - Restore Options tab - Miscellaneous section</em></figcaption></figure>
...
<figure><img src="../images/restore_messages.png" class="align-center" alt="Restore dialog - Successful Notifications popup" /><figcaption aria-hidden="true"><em>Restore dialog - Successful Notifications popup</em></figcaption></figure>
...
<figure><img src="../images/restore_process_watcher.png" class="align-center" alt="Restore dialog - Process Watcher" /><figcaption aria-hidden="true"><em>Restore dialog - Process Watcher</em></figcaption></figure>
