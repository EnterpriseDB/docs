...
Throughout this guide, the term `Postgres` refers to either a PostgreSQL or an EDB Postgres Advanced Server or EDB Postgres Extended (formerly known as 2nQPostgres) installation, where either is appropriate.
