...
You can only set up the Failover Manager for Postgres Enterprise Manager (PEM) server with the fresh installation. You can't set it for the existing PEM installation.
