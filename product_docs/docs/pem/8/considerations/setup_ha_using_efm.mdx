...
You can only set up Failover Manager for the Postgres Enterprise Manager (PEM) server with a fresh installation. You can't set it for an existing PEM installation.
