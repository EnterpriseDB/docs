...
-  Install the PEM server on a separate Linux machine. For more information, see [Installing the PEM server](/pem/latest/installing_pem_server/installing_on_linux).
