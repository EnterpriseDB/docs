...
To include monitoring information on the BDR dashboards, you must enable the relative probes for each BDR Group. You can see the complete list of BDR Probes [here](monitoring_performance/probes/#bdr-probes).
