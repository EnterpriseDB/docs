...
<figure><img src="../images/lm_welcome.png" class="align-center" alt="Log Manager Wizard - Welcome page" /><figcaption aria-hidden="true"><em>Log Manager Wizard - Welcome page</em></figcaption></figure>

Click `Next` to continue to the `Server selection` dialog:

<figure><img src="../images/lm_server_select.png" class="align-center" alt="Log Manager wizard - Server Selection page" /><figcaption aria-hidden="true"><em>Log Manager wizard - Server Selection page</em></figcaption></figure>
...
<figure><img src="../images/lm_import_rotation.png" class="align-center" alt="Log Manager Wizard - Log Configuration page" /><figcaption aria-hidden="true"><em>Log Manager Wizard - Log Configuration page</em></figcaption></figure>
...
<figure><img src="../images/lm_where_to_log.png" class="align-center" alt="Log Manager Wizard - Where to Log page" /><figcaption aria-hidden="true"><em>Log Manager Wizard - Where to Log page</em></figcaption></figure>
...
<figure><img src="../images/lm_when_to_log.png" class="align-center" alt="Log Manager Wizard - When to Log page" /><figcaption aria-hidden="true"><em>Log Manager Wizard - When to Log page</em></figcaption></figure>
...
<figure><img src="../images/lm_what_to_log.png" class="align-center" alt="Log Manager Wizard - What to Log page" /><figcaption aria-hidden="true"><em>Log Manager Wizard - What to Log page</em></figcaption></figure>
...
<figure><img src="../images/lm_scheduling.png" class="align-center" alt="Log Manager Wizard - Scheduling page" /><figcaption aria-hidden="true"><em>Log Manager Wizard - Scheduling page</em></figcaption></figure>
