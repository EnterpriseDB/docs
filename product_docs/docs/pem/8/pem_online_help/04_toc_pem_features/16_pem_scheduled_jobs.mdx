...
<figure><img src="../images/create_pem_jobs_general.png" class="align-center" alt="Create Agent Job dialog - General tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - General tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_steps.png" class="align-center" alt="Create Agent Job dialog - Steps tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - Steps tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_steps_definition.png" class="align-center" alt="Create Agent Job dialog - Definition tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - Definition tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_steps_definition_code.png" class="align-center" alt="Create Agent Job dialog - Definition Code tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - Definition Code tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_schedules.png" class="align-center" alt="Create Agent Job dialog - Schedules General tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - Schedules General tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_schedules_repeat.png" class="align-center" alt="Create Agent Job dialog - Schedules Repeat tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - Schedules Repeat tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_schedules_exceptions.png" class="align-center" alt="Create Agent Job dialog - Schedule Exceptions tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - Schedule Exceptions tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_notifications.png" class="align-center" alt="Create Agent Job dialog - Notifications tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - Notifications tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_sql.png" class="align-center" alt="Create Agent Job dialog - SQL tab" /><figcaption aria-hidden="true"><em>Create Agent Job dialog - SQL tab</em></figcaption></figure>
