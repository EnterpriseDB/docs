...
<figure><img src="../../images/memory_analysis_dashboard.png" class="align-center" alt="Memory Analysis dashboard" /><figcaption aria-hidden="true"><em>Memory Analysis dashboard</em></figcaption></figure>
