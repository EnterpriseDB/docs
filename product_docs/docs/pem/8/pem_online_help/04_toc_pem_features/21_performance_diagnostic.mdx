...
<figure><img src="../images/performance_diagnostic_error.png" class="align-center" alt="Performance Diagnostic Error dialog" /><figcaption aria-hidden="true"><em>Performance Diagnostic Error dialog</em></figcaption></figure>
...
<figure><img src="../images/performance_diagnostic_intro.png" class="align-center" alt="Performance Diagnostic dashboard" /><figcaption aria-hidden="true"><em>Performance Diagnostic dashboard</em></figcaption></figure>
...
<figure><img src="../images/performance_diagnostic_datetime_selection.png" class="align-center" alt="Performance Diagnostic dashboard - Time Changes option" /><figcaption aria-hidden="true"><em>Performance Diagnostic dashboard - Time Changes option</em></figcaption></figure>
...
<figure><img src="../images/performance_diagnostic_timeseries_selection.png" class="align-center" alt="Performance Diagnostic dashboard - Time range selection in the first Wait event types graph" /><figcaption aria-hidden="true"><em>Performance Diagnostic dashboard - Time range selection in the first Wait event types graph</em></figcaption></figure>
...
<figure><img src="../images/performance_diagnostic_chart_legends.png" class="align-center" alt="Performance Diagnostic dashboard - Show and hide a particular wait event type by click the respective graph legend" /><figcaption aria-hidden="true"><em>Performance Diagnostic dashboard - Show and hide a particular wait event type by click the respective graph legend</em></figcaption></figure>
...
<figure><img src="../images/performance_diagnostic_table_filter.png" class="align-center" alt="Performance Diagnostic - SQL tab with filter applied" /><figcaption aria-hidden="true"><em>Performance Diagnostic - SQL tab with filter applied</em></figcaption></figure>

Users tab

<figure><img src="../images/performance_diagnostic_users_table.png" class="align-center" alt="Performance Diagnostic - Users tab" /><figcaption aria-hidden="true"><em>Performance Diagnostic - Users tab</em></figcaption></figure>

Waits tab

<figure><img src="../images/performance_diagnostic_wait_events.png" class="align-center" alt="Performance Diagnostic - Waits tab" /><figcaption aria-hidden="true"><em>Performance Diagnostic - Waits tab</em></figcaption></figure>
...
<figure><img src="../images/performance_diagnostic_query_dashboard.png" class="align-center" alt="Performance Diagnostic - Query dashboard" /><figcaption aria-hidden="true"><em>Performance Diagnostic - Query dashboard</em></figcaption></figure>
