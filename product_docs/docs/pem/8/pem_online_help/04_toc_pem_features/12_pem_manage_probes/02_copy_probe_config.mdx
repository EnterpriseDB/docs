...
<figure><img src="../../images/copy_probe_config.png" class="align-center" alt="Copy Probe Configuration" /><figcaption aria-hidden="true"><em>Copy Probe Configuration</em></figcaption></figure>
