...
<figure><img src="../../images/capacity_manager_options.png" class="align-center" alt="Capacity manager options" /><figcaption aria-hidden="true"><em>Capacity manager options</em></figcaption></figure>
