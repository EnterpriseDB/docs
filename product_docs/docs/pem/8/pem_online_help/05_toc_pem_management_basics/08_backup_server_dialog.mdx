...
<figure><img src="../images/backup_server_general.png" class="align-center" alt="Backup Server dialog - General tab" /><figcaption aria-hidden="true"><em>Backup Server dialog - General tab</em></figcaption></figure>
...
<figure><img src="../images/backup_server_objects.png" class="align-center" alt="Backup Server dialog - Dump Options tab - Types of Objects" /><figcaption aria-hidden="true"><em>Backup Server dialog - Dump Options tab - Types of Objects</em></figcaption></figure>
...
<figure><img src="../images/backup_server_do_not_save.png" class="align-center" alt="Backup Server dialog - Dump Options tab - Do not save options" /><figcaption aria-hidden="true"><em>Backup Server dialog - Dump Options tab - Do not save options</em></figcaption></figure>
...
<figure><img src="../images/backup_server_queries.png" class="align-center" alt="Backup Server dialog - Dump Options - Queries options" /><figcaption aria-hidden="true"><em>Backup Server dialog - Dump Options - Queries options</em></figcaption></figure>
...
<figure><img src="../images/backup_server_disable.png" class="align-center" alt="Backup Server dialog - Dump Options tab - Disable options" /><figcaption aria-hidden="true"><em>Backup Server dialog - Dump Options tab - Disable options</em></figcaption></figure>
...
<figure><img src="../images/backup_server_miscellaneous.png" class="align-center" alt="Backup Server dialog - Dump Options tab - Miscellaneous options" /><figcaption aria-hidden="true"><em>Backup Server dialog - Dump Options tab - Miscellaneous options</em></figcaption></figure>
...
<figure><img src="../images/backup_server_messages.png" class="align-center" alt="Backup Server dialog - Success Notification popup" /><figcaption aria-hidden="true"><em>Backup Server dialog - Success Notification popup</em></figcaption></figure>
...
<figure><img src="../images/backup_server_process_watcher.png" class="align-center" alt="Backup Server dialog - Process Watcher" /><figcaption aria-hidden="true"><em>Backup Server dialog - Process Watcher</em></figcaption></figure>
