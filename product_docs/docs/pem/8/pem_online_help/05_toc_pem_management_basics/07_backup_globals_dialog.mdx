...
<figure><img src="../images/backup_globals_general.png" class="align-center" alt="Backup Globals dialog - General tab" /><figcaption aria-hidden="true"><em>Backup Globals dialog - General tab</em></figcaption></figure>
...
<figure><img src="../images/backup_globals_messages.png" class="align-center" alt="Backup Globals tab - Success Notification popup" /><figcaption aria-hidden="true"><em>Backup Globals tab - Success Notification popup</em></figcaption></figure>
...
<figure><img src="../images/backup_globals_process_watcher.png" class="align-center" alt="Backup Globals - Process Watcher" /><figcaption aria-hidden="true"><em>Backup Globals - Process Watcher</em></figcaption></figure>
