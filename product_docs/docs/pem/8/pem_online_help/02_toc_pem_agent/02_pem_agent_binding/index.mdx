...
<figure><img src="../../images/connect_pem_agent.png" class="align-center" alt="PEM server agent binding options" /><figcaption aria-hidden="true"><em>PEM server agent binding options</em></figcaption></figure>
