...
<figure><img src="../images/sp_create_new_trace.png" class="align-center" alt="Create trace dialog - Trace options tab" /><figcaption aria-hidden="true"><em>Create trace dialog - Trace options tab</em></figcaption></figure>
...
<figure><img src="../images/sp_create_new_trace_schedule.png" class="align-center" alt="Create trace dialog - Schedule tab" /><figcaption aria-hidden="true"><em>Create trace dialog - Schedule tab</em></figcaption></figure>
...
<figure><img src="../images/sp_create_new_trace_periodic_job.png" class="align-center" alt="Create trace - Schedule repeat tab" /><figcaption aria-hidden="true"><em>Create trace - Schedule repeat tab</em></figcaption></figure>
...
<figure><img src="../images/sp_create_new_trace_executed.png" class="align-center" alt="New trace executed" /><figcaption aria-hidden="true"><em>New trace executed</em></figcaption></figure>
...
<figure><img src="../images/sp_open_existing_trace.png" class="align-center" alt="Open existing trace dialog" /><figcaption aria-hidden="true"><em>Open existing trace dialog</em></figcaption></figure>
...
<figure><img src="../images/sp_trace_filter.png" class="align-center" alt="Trace filter - General tab" /><figcaption aria-hidden="true"><em>Trace filter - General tab</em></figcaption></figure>
...
<figure><img src="../images/sp_delete_trace.png" class="align-center" alt="Delete existing trace dialog" /><figcaption aria-hidden="true"><em>Delete existing trace dialog</em></figcaption></figure>

Click the icon to the left of a trace name to mark one or more traces for deletion and click `Delete`.

<figure><img src="../images/sp_delete_trace.png" class="align-center" alt="Delete existing trace notification" /><figcaption aria-hidden="true"><em>Delete existing trace notification</em></figcaption></figure>
...
<figure><img src="../images/sp_scheduled_traces.png" class="align-center" alt="Scheduled traces dialog" /><figcaption aria-hidden="true"><em>Scheduled traces dialog</em></figcaption></figure>
...
<figure><img src="../images/sp_trace_details.png" class="align-center" alt="Scheduled traces details dialog" /><figcaption aria-hidden="true"><em>Scheduled traces details dialog</em></figcaption></figure>
