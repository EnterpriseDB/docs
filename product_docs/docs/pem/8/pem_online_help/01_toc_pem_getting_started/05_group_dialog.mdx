...
<figure><img src="../images/create_group.png" class="align-center" alt="Create Group dialog" /><figcaption aria-hidden="true"><em>Create Group dialog</em></figcaption></figure>
