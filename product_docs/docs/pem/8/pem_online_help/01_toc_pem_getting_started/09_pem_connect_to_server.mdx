...
<figure><img src="../images/connect_to_server.png" class="align-center" alt="PEM Connect to Server dialog" /><figcaption aria-hidden="true"><em>PEM Connect to Server dialog</em></figcaption></figure>
...
<figure><img src="../images/disconnect_server.png" class="align-center" alt="PEM Disconnect Server dialog" /><figcaption aria-hidden="true"><em>PEM Disconnect Server dialog</em></figcaption></figure>
