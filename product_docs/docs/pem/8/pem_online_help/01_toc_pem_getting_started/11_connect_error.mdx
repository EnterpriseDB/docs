...
<figure><img src="../images/ce_timeout.png" class="align-center" alt="Connection to the server has been lost" /><figcaption aria-hidden="true"><em>Connection to the server has been lost</em></figcaption></figure>
...
<figure><img src="../images/ce_not_running.png" class="align-center" alt="Could not connect to server" /><figcaption aria-hidden="true"><em>Could not connect to server</em></figcaption></figure>

If PEM displays this message, there are two possible reasons for this:  
...
<figure><img src="../images/ce_error_hba.png" class="align-center" alt="No pg_hba.conf entry" /><figcaption aria-hidden="true"><em>No pg_hba.conf entry</em></figcaption></figure>

If PEM displays this message when connecting, your server can be contacted correctly over the network, but is not configured to accept your connection. Your client has not been detected as a legal user for the database.
...
<figure><img src="../images/ce_password_failed.png" class="align-center" alt="Password authentication failed" /><figcaption aria-hidden="true"><em>Password authentication failed</em></figcaption></figure>
