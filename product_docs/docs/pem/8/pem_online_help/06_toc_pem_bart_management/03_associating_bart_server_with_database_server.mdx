...
<figure><img src="../images/create_server_bart_general.png" class="align-center" alt="Create Server dialog (BART - General tab)" /><figcaption aria-hidden="true"><em>Create Server dialog (BART - General tab)</em></figcaption></figure>
...
<figure><img src="../images/create_server_bart_misc.png" class="align-center" alt="Create Server dialog (BART - Misc tab)" /><figcaption aria-hidden="true"><em>Create Server dialog (BART - Misc tab)</em></figcaption></figure>
