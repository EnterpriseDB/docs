...
<figure><img src="../images/pem_browser_window.png" class="align-center" alt="PEM browser window" /><figcaption aria-hidden="true"><em>PEM browser window</em></figcaption></figure>
...
<figure><img src="../images/pem_browser_dashboard_welcome.png" class="align-center" alt="PEM browser - Welcome dashboard tab" /><figcaption aria-hidden="true"><em>PEM browser - Welcome dashboard tab</em></figcaption></figure>
...
<figure><img src="../images/pem_browser_dashboard_statistics.png" class="align-center" alt="PEM browser - Dashboard tab" /><figcaption aria-hidden="true"><em>PEM browser - Dashboard tab</em></figcaption></figure>
...
<figure><img src="../images/pem_browser_properties.png" class="align-center" alt="PEM browser - Properties tab" /><figcaption aria-hidden="true"><em>PEM browser - Properties tab</em></figcaption></figure>

Navigate to the `Properties` tab to review the properties of the item currently highlighted in the tree control.

<figure><img src="../images/pem_browser_sql.png" class="align-center" alt="PEM browser - SQL tab" /><figcaption aria-hidden="true"><em>PEM browser - SQL tab</em></figcaption></figure>

The `SQL` tab displays the SQL code used to generate the object currently selected in the Browser tree control.

<figure><img src="../images/pem_browser_statistics.png" class="align-center" alt="PEM browser - Statistics tab" /><figcaption aria-hidden="true"><em>PEM browser - Statistics tab</em></figcaption></figure>
...
<figure><img src="../images/pem_browser_dependencies.png" class="align-center" alt="PEM browser - Dependencies tab" /><figcaption aria-hidden="true"><em>PEM browser - Dependencies tab</em></figcaption></figure>
...
<figure><img src="../images/pem_browser_dependents.png" class="align-center" alt="PEM browser - Dependents tab" /><figcaption aria-hidden="true"><em>PEM browser - Dependents tab</em></figcaption></figure>
...
<figure><img src="../images/global_overview.png" class="align-center" alt="PEM browser - Global Overview tab" /><figcaption aria-hidden="true"><em>PEM browser - Global Overview tab</em></figcaption></figure>
...
<figure><img src="../images/chart_icons.png" class="align-center" alt="PEM Agent and Server Status" /><figcaption aria-hidden="true"><em>PEM Agent and Server Status</em></figcaption></figure>
...
<figure><img src="../images/personalize_chart.png" class="align-center" alt="PEM personalize chart options" /><figcaption aria-hidden="true"><em>PEM personalize chart options</em></figcaption></figure>
