...
The PGD Admin dashboard displays the overview information about PGD node, PGD group, and PGD worker.

### PGD Group Monitoring dashboard

The PGD Group Monitoring dashboard displays the information about PGD group subscription and PGD group replication slots.

### PGD Node Monitoring dashboard

The PGD Node Monitoring dashboard displays the information about PGD node slots, PGD node replication rates, and PGD conflict history summary for the selected node. 
