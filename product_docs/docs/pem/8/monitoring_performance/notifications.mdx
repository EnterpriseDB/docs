...
To define a new email group, select the plus sign (+) in the upper-right corner of the **Email Groups** table. 

![Adding an email group](../images/email_group_add.png)

Use the Email Group dialog box to define an email group and its members.
...
To define a new webhook, select the plus sign (+) in the upper-right corner of the table.
