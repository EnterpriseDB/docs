...
redirects:
- https://www.enterprisedb.com/docs/pem/latest/pem_inst_guide_linux/04_installing_postgres_enterprise_manager/07_configuring_the_pem_server_to_use_windows_kerberos_server/
---
...
-   Install the PEM Server on the separate Linux machine, for more information see [Installing the PEM Server](../installing_on_linux).
