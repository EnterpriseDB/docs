...
-   Refer to [Table dialog](pem_online_help/05_toc_pem_management_basics/12_modifying_tables/10_table_dialog) for information on different fields.<!-- This is also said in the Table node section. Seems like this one is unnecessary and should be deleted. -->
