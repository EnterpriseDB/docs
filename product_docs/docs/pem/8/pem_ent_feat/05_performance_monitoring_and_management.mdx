...
Please note that you must configure the PEM Server to use an SNMP server to send the notifications to an SNMP trap/notification receiver before notifications can be sent. Set the SNMP ver to v1, v2 or v3 to identify the SNMP version.
