...
The new webhook has a unique URL similar to <div style="display: inline">https://hooks.slack.com/services/x/y/z</div>. You can now configure PEM to send notifications to this URL.
