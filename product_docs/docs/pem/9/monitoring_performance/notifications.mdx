...
- Add new webhooks to the Slack workspace. You must add the channel and authorize the application for the incoming webhooks so the pemAgent can notify the alert using Slack.
