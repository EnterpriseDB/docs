...
| Type        | Description                                                                                      |
| ----------- | -------------------------------------------------------------------------------------------------|
| Enhancement | The default sample end time for performance diagnostics is now **Now** rather than the time the window was first opened. The data now updates when you click **Run**. |
