...
| Bug&nbsp;fix | Resolved a cross-site scripting vulnerability in Manage Charts and Manage Dashboards.                                           |
| Bug&nbsp;fix | Fixed an issue whereby TRACK/TRACE HTTP methods were not blocked in the Apache HTTPD configuration provided with PEM (CVE-XXX). |
