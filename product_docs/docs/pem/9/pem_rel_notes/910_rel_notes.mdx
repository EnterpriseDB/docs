...
| Bug Fix     | Fixed an issue whereby alert notifications were sent for Low or Medium alerts when the user disabled the option to send them.                                                     |
| Bug Fix     | Fixed an issue whereby webhooks weren't called if there was an inactive endpoint in the spool.                                                                                |
