...
1. Stop all the PEM agents if running:
   ...
   On Windows, use the Services applet to stop the PEM agent. The PEM agent service is named Postgres Enterprise Manager Agent. Select the service name in the Services dialog box and select **Stop the service**.
...
1. Take the backup of the old agent certificate and key files:
...
1. Start the PEM agent service.
   ...
   - On Linux:
    ...
    - On Windows:
      Use the Services applet to start the PEM agent. The PEM agent service is named Postgres Enterprise Manager Agent. Select the service name in the Services dialog box and select **Start the service**.
