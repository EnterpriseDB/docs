...
If you are using [Failover Manager for high availability](considerations/setup_ha_using_efm/) on your PEM server, you can perform an upgrade of the PEM installation by updating the PEM packages.
