...
For detailed information about using the PEM server graphical installer, see [Installing the PEM Server on Windows](../../7.15/pem_inst_guide_windows/03_installing_postgres_enterprise_manager/#installing_pem_server_on_windows).
...
For detailed information about using the PEM agent graphical installer, see [Installing a PEM Agent on Windows](../../7.15/pem_inst_guide_windows/03_installing_postgres_enterprise_manager/#installing_pem_agent_on_windows).
