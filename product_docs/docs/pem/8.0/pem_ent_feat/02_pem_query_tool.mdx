...
| `Save`              | Click the `Save` icon to perform a quick-save of a previously saved query, or to access the Save menu:                                                                                                          | Accesskey + S |
...
| `Find`              | Use the `Find` menu to search, replace, or navigate the code displayed in the SQL Editor:                                                                                                                       | Cmd+F         |
|                     | - Select `Find` to provide a search target, and search the SQL Editor contents.                                                                                                                                 | Cmd+G         |
|                     | - Select `Find next` to locate the next occurrence of the search target.                                                                                                                                        | Cmd+Shift+G   |
|                     | - Select `Find previous` to move to the last occurrence of the search target.                                                                                                                                   | Cmd+Shift+F   |
|                     | - Select `Pesistent find` to identify all occurrences of the search target within the editor.                                                                                                                   | Alt+G         |
...
| `Edit`              | Use options on the `Edit` menu to access text editing tools; the options operate on the text displayed in the SQL Editor panel when in Query Tool mode:                                                         | Tab           |
|                     | - Select `Indent Selection` to indent the currently selected text.                                                                                                                                              | Shift+Tab     |
|                     | - Select `Unindent Selection` to remove indentation from the currently selected text.                                                                                                                           | Cmd+/         |
|                     | - Select `Inline Comment Selection` to enclose any lines that contain the selection in SQL style comment notation.                                                                                              | Cmd+.         |
|                     | - Select `Inline Uncomment Selection` to remove SQL style comment notation from the selected line.                                                                                                              | Shift+Cmd+/   |
...
| `Execute/Refresh`   | Click the `Execute/Refresh` icon to either execute or refresh the query highlighted in the SQL editor panel. Click the down arrow to access other execution options:                                            | F5            |
...
|                     | - Select `Verbose` to display additional information regarding the query plan.                                                                                                                                  | Shift+F7      |
