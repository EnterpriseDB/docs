...
<figure><img src="../images/pem_custom_dashboard_configure_dashboard.png" class="align-center" alt="The Create Dashboard editor" /><figcaption aria-hidden="true"><em>The Create Dashboard editor</em></figcaption></figure>
...
<figure><img src="../images/pem_custom_dashboard_add_section_name.png" class="align-center" alt="Modifying a Section Header" /><figcaption aria-hidden="true"><em>Modifying a Section Header</em></figcaption></figure>

Click the edit icon in a section header to specify a section name; then, click the add icon (+) to add a chart to the section.

<figure><img src="../images/pem_custom_dashboard_add_chart.png" class="align-center" alt="Adding a Chart" /><figcaption aria-hidden="true"><em>Adding a Chart</em></figcaption></figure>

Use the arrows to the right of each chart category to display the charts available and select a chart.

<figure><img src="../images/pem_custom_dashboard_chart_details.png" class="align-center" alt="Specifying placement details for a chart" /><figcaption aria-hidden="true"><em>Specifying placement details for a chart</em></figcaption></figure>
...
<figure><img src="../images/define_ops_dashboard.png" class="align-center" alt="Ops dashboard options" /><figcaption aria-hidden="true"><em>Ops dashboard options</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_charts.png" class="align-center" alt="The Manage Charts tab" /><figcaption aria-hidden="true"><em>The Manage Charts tab</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_charts_custom_chart.png" class="align-center" alt="The Custom Charts table" /><figcaption aria-hidden="true"><em>The Custom Charts table</em></figcaption></figure>
...
<figure><img src="../images/pem_create_new_chart_conf_chart.png" class="align-center" alt="Specifying general information about the chart" /><figcaption aria-hidden="true"><em>Specifying general information about the chart</em></figcaption></figure>
...
<figure><img src="../images/pem_create_new_chart_select_metrics.png" class="align-center" alt="Specifying the metrics that will be displayed" /><figcaption aria-hidden="true"><em>Specifying the metrics that will be displayed</em></figcaption></figure>
...
<figure><img src="../images/pem_create_new_chart_set_options.png" class="align-center" alt="Specifying chart options" /><figcaption aria-hidden="true"><em>Specifying chart options</em></figcaption></figure>
...
<figure><img src="../images/pem_create_new_chart_set_options.png" class="align-center" alt="Specifying access permissions" /><figcaption aria-hidden="true"><em>Specifying access permissions</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_charts_completed.png" class="align-center" alt="The chart definition is displayed on the Manage Charts tab" /><figcaption aria-hidden="true"><em>The chart definition is displayed on the Manage Charts tab</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_charts_imported_template.png" class="align-center" alt="Importing a Capacity Manager template" /><figcaption aria-hidden="true"><em>Importing a Capacity Manager template</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_charts_imported_metrics.png" class="align-center" alt="The template metrics" /><figcaption aria-hidden="true"><em>The template metrics</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_charts_imported_options.png" class="align-center" alt="Selecting chart options" /><figcaption aria-hidden="true"><em>Selecting chart options</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_charts_imported_permissions.png" class="align-center" alt="Selecting permissions for the chart" /><figcaption aria-hidden="true"><em>Selecting permissions for the chart</em></figcaption></figure>
...
<figure><img src="../images/pem_manage_probes_tab.png" class="align-center" alt="The Manage Probes tab" /><figcaption aria-hidden="true"><em>The Manage Probes tab</em></figcaption></figure>
...
<figure><img src="../images/custom_probes.png" class="align-center" alt="The Custom Probes dialog" /><figcaption aria-hidden="true"><em>The Custom Probes dialog</em></figcaption></figure>
...
<figure><img src="../images/custom_probes_general.png" class="align-center" alt="Defining a custom probe – the General tab" /><figcaption aria-hidden="true"><em>Defining a custom probe – the General tab</em></figcaption></figure>
...
<figure><img src="../images/custom_probes_columns.png" class="align-center" alt="The Columns tab of the Custom Probes dialog" /><figcaption aria-hidden="true"><em>The Columns tab of the Custom Probes dialog</em></figcaption></figure>
...
<figure><img src="../images/custom_probes_code.png" class="align-center" alt="The Code tab of the Custom Probes dialog" /><figcaption aria-hidden="true"><em>The Code tab of the Custom Probes dialog</em></figcaption></figure>
...
<figure><img src="../images/custom_probes_alt_code.png" class="align-center" alt="The Alternate Code tab of the Custom Probes dialog" /><figcaption aria-hidden="true"><em>The Alternate Code tab of the Custom Probes dialog</em></figcaption></figure>
...
<figure><img src="../images/copy_probe_config.png" class="align-center" alt="The Copy Probe Configuration tree control" /><figcaption aria-hidden="true"><em>The Copy Probe Configuration tree control</em></figcaption></figure>
...
<figure><img src="../images/alerts_status_table.png" class="align-center" alt="The Alert Status table" /><figcaption aria-hidden="true"><em>The Alert Status table</em></figcaption></figure>
...
<figure><img src="../images/personalize_chart.png" class="align-center" alt="Customizing a chart" /><figcaption aria-hidden="true"><em>Customizing a chart</em></figcaption></figure>
...
<figure><img src="../images/alerting_manage_alerts.png" class="align-center" alt="The Manage Alerts tab" /><figcaption aria-hidden="true"><em>The Manage Alerts tab</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_templates_tab.png" class="align-center" alt="The Alert Templates tab" /><figcaption aria-hidden="true"><em>The Alert Templates tab</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_templates_general.png" class="align-center" alt="The General tab" /><figcaption aria-hidden="true"><em>The General tab</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_templates_pdtab.png" class="align-center" alt="The Probe Dependency tab of the Alert Templates dialog" /><figcaption aria-hidden="true"><em>The Probe Dependency tab of the Alert Templates dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_templates_paramtab.png" class="align-center" alt="The Parameters tab of the Alert Templates dialog" /><figcaption aria-hidden="true"><em>The Parameters tab of the Alert Templates dialog</em></figcaption></figure>
...
> <figure><img src="../images/pem_alert_templates_sqltab.png" class="align-center" alt="The SQL tab of the Alert Templates dialog" /><figcaption aria-hidden="true"><em>The SQL tab of the Alert Templates dialog</em></figcaption></figure>
>
...
<figure><img src="../images/alerting_define_new_alert.png" class="align-center" alt="The General tab of the alert editor" /><figcaption aria-hidden="true"><em>The General tab of the alert editor</em></figcaption></figure>
...
<figure><img src="../images/alerting_define_notification.png" class="align-center" alt="The alert editor Notification tab" /><figcaption aria-hidden="true"><em>The alert editor Notification tab</em></figcaption></figure>
...
<figure><img src="../images/alerting_manage_alerts_table.png" class="align-center" alt="The Alerts table" /><figcaption aria-hidden="true"><em>The Alerts table</em></figcaption></figure>
...
<figure><img src="../images/alerting_manage_alerts_delete.png" class="align-center" alt="Deleting an alert" /><figcaption aria-hidden="true"><em>Deleting an alert</em></figcaption></figure>
...
<figure><img src="../images/alert_copy.png" class="align-center" alt="The Copy Alert Configuration dialog" /><figcaption aria-hidden="true"><em>The Copy Alert Configuration dialog</em></figcaption></figure>
...
<figure><img src="../images/email_group_add.png" class="align-center" alt="Adding an email group" /><figcaption aria-hidden="true"><em>Adding an email group</em></figcaption></figure>
...
<figure><img src="../images/email_group_delete.png" class="align-center" alt="Deleting an email group" /><figcaption aria-hidden="true"><em>Deleting an email group</em></figcaption></figure>
...
<figure><img src="../images/webhooks_tab.png" class="align-center" alt="Webhooks tab" /><figcaption aria-hidden="true"><em>Webhooks tab</em></figcaption></figure>
...
<figure><img src="../images/webhook_add.png" class="align-center" alt="Webhooks - Add New Webhook - General Tab" /><figcaption aria-hidden="true"><em>Webhooks - Add New Webhook - General Tab</em></figcaption></figure>
...
You can define the Webhook SSL parameters in the respective agent configuration file or registry in windows. You can find the list of Webhook SSL parameters [PEM Agent Configuration Parameters](https://www.enterprisedb.com/edb-docs/d/edb-postgres-enterprise-manager/user-guides/agent-user-guide/latest/managing_pem_agent.html#agent-configuration) section. If you add or remove any of the agent configuration parameters, you must restart the agent to apply them.
...
<figure><img src="../images/webhook_ssl_config.png" class="align-center" alt="Example - Webhook SSL Parameters in agent.cfg file" /><figcaption aria-hidden="true"><em>Example - Webhook SSL Parameters in agent.cfg file</em></figcaption></figure>

<figure><img src="../images/webhook_ssl_config_windows.png" class="align-center" alt="Example - Webhook SSL Parameters in windows registry" /><figcaption aria-hidden="true"><em>Example - Webhook SSL Parameters in windows registry</em></figcaption></figure>

<figure><img src="../images/webhook_add_headers.png" class="align-center" alt="Webhooks - Add New Webhook - HTTP Headers Tab" /><figcaption aria-hidden="true"><em>Webhooks - Add New Webhook - HTTP Headers Tab</em></figcaption></figure>
...
<figure><img src="../images/webhook_add_payload.png" class="align-center" alt="Webhooks - Add New Webhook - Payload Tab" /><figcaption aria-hidden="true"><em>Webhooks - Add New Webhook - Payload Tab</em></figcaption></figure>
...
<figure><img src="../images/webhook_add_notification.png" class="align-center" alt="Webhooks - Add New Webhook - Notifications Tab" /><figcaption aria-hidden="true"><em>Webhooks - Add New Webhook - Notifications Tab</em></figcaption></figure>
...
<figure><img src="../images/webhook_delete.png" class="align-center" alt="Webhooks - Delete an existing webhook" /><figcaption aria-hidden="true"><em>Webhooks - Delete an existing webhook</em></figcaption></figure>
...
<figure><img src="../images/pem_management_menu.png" class="align-center" alt="PEM Management Menu" /><figcaption aria-hidden="true"><em>PEM Management Menu</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_blackout_server_tab.png" class="align-center" alt="Schedule Alert Blackout - Server tab" /><figcaption aria-hidden="true"><em>Schedule Alert Blackout - Server tab</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_blackout_agent_tab.png" class="align-center" alt="Schedule Alert Blackout - Agent tab" /><figcaption aria-hidden="true"><em>Schedule Alert Blackout - Agent tab</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_blackout_select_servers.png" class="align-center" alt="Schedule Alert Blackout - Select servers" /><figcaption aria-hidden="true"><em>Schedule Alert Blackout - Select servers</em></figcaption></figure>
...
<figure><img src="../images/pem_alert_blackout_delete_confirm.png" class="align-center" alt="Schedule Alert Blackout - Delete confirmation" /><figcaption aria-hidden="true"><em>Schedule Alert Blackout - Delete confirmation</em></figcaption></figure>
...
<figure><img src="../images/nagios_alert_notification.png" class="align-center" alt="The Notification tab" /><figcaption aria-hidden="true"><em>The Notification tab</em></figcaption></figure>
