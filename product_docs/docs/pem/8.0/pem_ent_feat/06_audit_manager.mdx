...
<figure><img src="../images/audit_manager_intro.png" class="align-center" alt="The Audit Manager Welcome dialog" /><figcaption aria-hidden="true"><em>The Audit Manager Welcome dialog</em></figcaption></figure>

Click `Next` to continue.

<figure><img src="../images/audit_manager_servers.png" class="align-center" alt="Select the servers you wish to configure for auditing" /><figcaption aria-hidden="true"><em>Select the servers you wish to configure for auditing</em></figcaption></figure>
...
<figure><img src="../images/audit_manager_config1.png" class="align-center" alt="The Auditing Parameters Configuration dialog" /><figcaption aria-hidden="true"><em>The Auditing Parameters Configuration dialog</em></figcaption></figure>
...
<figure><img src="../images/audit_manager_config2.png" class="align-center" alt="The Audit Log Configuration dialog" /><figcaption aria-hidden="true"><em>The Audit Log Configuration dialog</em></figcaption></figure>
...
<figure><img src="../images/audit_manager_finish.png" class="align-center" alt="The Schedule Auditing Changes dialog" /><figcaption aria-hidden="true"><em>The Schedule Auditing Changes dialog</em></figcaption></figure>
...
<figure><img src="../images/audit_log_analysis_dashboard.png" class="align-center" alt="The Audit Log dashboard" /><figcaption aria-hidden="true"><em>The Audit Log dashboard</em></figcaption></figure>
...
<figure><img src="../images/audit_log_analysis_filter.png" class="align-center" alt="The Audit Log dashboard filters panel" /><figcaption aria-hidden="true"><em>The Audit Log dashboard filters panel</em></figcaption></figure>
