...
PEM-2573 - Fixed for shared\_buffers dashboard's historical span issue. \[Support Ticket \#894867\]  
...
[Issue \#5025](https://redmine.postgresql.org/issues/5025) - Fix an issue where setting STORAGE\_DIR to empty should show all the volumes on Windows in server mode.  
