...
PEM-812/ <span class="title-ref">Issue \#5830 &lt;https://redmine.postgresql.org/issues/5830&gt;</span> - Display parenthesis around AND/OR conditions in the same order within PEM and dba\_views. Fixed reverse engineering SQL where parenthesis is not properly arranged for View/MView definition. \[Support Ticket \#315838\]  
...
[Issue \#4216](https://redmine.postgresql.org/issues/4216) - Ensure that schema names starting with 'pg' should be visible in browser tree when standard\_conforming\_strings is set to off.  
...
[Issue \#5746](https://redmine.postgresql.org/issues/5746) - Fixed an issue where --load-server does not allow loading connections that use pg\_services.  
