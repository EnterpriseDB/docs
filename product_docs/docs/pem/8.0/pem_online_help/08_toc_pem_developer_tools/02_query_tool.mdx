...
![New connection option](../images/new_connection_options.png)

-   Now select server, database, user, and role to connect and click OK.

![New Connection Dialog](../images/new_connection_dialog.png)
...
![Query Tool Manage Macros Clear](../images/query_tool_macros_clear_row.png)
