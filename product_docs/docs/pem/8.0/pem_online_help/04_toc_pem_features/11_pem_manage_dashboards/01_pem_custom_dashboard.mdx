...
-   Set the `Ops Dashboard?` field to `Yes` to instruct the server to create a dashboard that is formatted for display on an [Ops monitor](../../04_toc_pem_features/11_pem_manage_dashboards/#pem_ops_dashboard).
