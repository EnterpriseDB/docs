...
You can click on the ![sm_icon](../images/sm_icon.png) icon in the process watcher window to open the file location in the Storage Manager. You can use the [Storage Manager](../05_toc_pem_management_basics/#storage_manager) to download the backup file on the client machine .
