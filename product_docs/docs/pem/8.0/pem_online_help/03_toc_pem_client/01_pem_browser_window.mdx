...
| Option                  | Action                                                                                                                                                                        |
| ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Import/Export...`      | Click open the [Import/Export...](../05_toc_pem_management_basics/03_import_export_data/#import_export_data) dialog to import data to or export data from the selected table. |
