...
For detailed information on the `Create - Server` dialog and configuration details for each tab, see [Define a Server](../01_toc_pem_getting_started/#pem_define_connection).
