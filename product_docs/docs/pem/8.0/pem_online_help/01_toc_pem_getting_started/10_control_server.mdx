...
If you provided a `Service ID` on the `Advanced` tab of the [Server](../01_toc_pem_getting_started/#pem_define_connection) property dialogue, the PEM server can control the database service process.
