...
<div id="using_sql_profiler" class="registered_link"></div>
...
<figure><img src="../images/sp_create_new_trace.png" class="align-center" alt="The Trace options tab" /><figcaption aria-hidden="true"><em>The Trace options tab</em></figcaption></figure>
...
<figure><img src="../images/sp_create_new_trace_schedule.png" class="align-center" alt="The Create trace Schedule tab" /><figcaption aria-hidden="true"><em>The Create trace Schedule tab</em></figcaption></figure>
...
<figure><img src="../images/sp_create_new_trace_periodic_job.png" class="align-center" alt="The Create trace Periodic job options tab" /><figcaption aria-hidden="true"><em>The Create trace Periodic job options tab</em></figcaption></figure>
...
<figure><img src="../images/sp_create_new_trace_executed.png" class="align-center" alt="The SQL Profiler tab, displaying the trace results" /><figcaption aria-hidden="true"><em>The SQL Profiler tab, displaying the trace results</em></figcaption></figure>
...
<figure><img src="../images/sp_open_existing_trace.png" class="align-center" alt="Opening an existing trace" /><figcaption aria-hidden="true"><em>Opening an existing trace</em></figcaption></figure>
...
<figure><img src="../images/sp_delete_trace.png" class="align-center" alt="The Delete traces… dialog" /><figcaption aria-hidden="true"><em>The Delete traces… dialog</em></figcaption></figure>
...
<figure><img src="../images/sp_scheduled_traces.png" class="align-center" alt="Reviewing scheduled traces" /><figcaption aria-hidden="true"><em>Reviewing scheduled traces</em></figcaption></figure>
