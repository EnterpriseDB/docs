...
For detailed information about configuring a PEM Server, see [Configuring the PEM Server on Linux Platforms](../04_installing_postgres_enterprise_manager/#configuring_the_pem_server_on_linux).
