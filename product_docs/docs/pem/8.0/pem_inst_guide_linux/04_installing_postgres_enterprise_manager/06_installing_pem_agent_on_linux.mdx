...
<figure><img src="../../images/pem_rpm_installation_agent.png" class="align-center" /></figure>
...
After installing PEM Agent using `yum` or `dnf`, you need to register the PEM Agent. For detailed information see [Registering a PEM Agent](../04_installing_postgres_enterprise_manager/#registering_a_pem_agent).
...
After installing PEM Agent using `apt-get`, you need to register the PEM Agent. For more detailed information see [Registering a PEM Agent](../04_installing_postgres_enterprise_manager/#registering_a_pem_agent).
...
After installing the PEM Agent, you must register the agent. For more detailed information see [Registering a PEM Agent](../04_installing_postgres_enterprise_manager/#registering_a_pem_agent).
