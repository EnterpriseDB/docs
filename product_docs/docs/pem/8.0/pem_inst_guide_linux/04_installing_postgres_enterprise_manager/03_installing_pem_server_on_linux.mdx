...
Before installing PEM, you must install prerequisite packages. Invoke the following commands, replacing _sp_no_ with the service pack that you are using (i.e. SP4):
