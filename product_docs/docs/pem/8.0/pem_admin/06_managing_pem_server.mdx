...
Please note that any user (or client application) connected to the Postgres server will be abruptly disconnected if you stop the service. For more information about controlling a service, please consult the *EDB Postgres Advanced Server Installation Guide*, available from the EDB website at:
...
<figure><img src="../images/pem_server_tools_menu_queue_server.png" class="align-center" alt="The Tools menu of a managed server" /><figcaption aria-hidden="true"><em>The Tools menu of a managed server</em></figcaption></figure>
...
<figure><img src="../images/table_general.png" class="align-center" alt="Create Table - General Tab" /><figcaption aria-hidden="true"><em>Create Table - General Tab</em></figcaption></figure>
...
The password file is usually named `~root/.pgpass` on Linux systems, or `%APPDATA%\postgresql\pgpass.conf` (on Windows). For more information about configuring a password file, visit the PostgreSQL website at:

> <http://www.postgresql.org/docs/current/libpq-pgpass.html>

For more information about the authentication methods supported by Postgres, see the PostgreSQL core documentation at:

> <http://www.postgresql.org/docs/current/client-authentication.html>
...
<figure><img src="../images/pem_server_config.png" class="align-center" alt="The Server Configuration dialog" /><figcaption aria-hidden="true"><em>The Server Configuration dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_access_create_login.png" class="align-center" alt="The context menu of the Login Roles node" /><figcaption aria-hidden="true"><em>The context menu of the Login Roles node</em></figcaption></figure>
...
<figure><img src="../images/role_general.png" class="align-center" alt="Create Login Role - General tab" /><figcaption aria-hidden="true"><em>Create Login Role - General tab</em></figcaption></figure>
...
> <http://www.postgresql.org/docs/current/sql-createrole.html>
...
<figure><img src="../images/role_membership.png" class="align-center" alt="Create Login Role - Membership tab" /><figcaption aria-hidden="true"><em>Create Login Role - Membership tab</em></figcaption></figure>
...
<figure><img src="../images/role_sql.png" class="align-center" alt="Create Login Role - SQL tab" /><figcaption aria-hidden="true"><em>Create Login Role - SQL tab</em></figcaption></figure>
...
<figure><img src="../images/job_notifications_job_level.png" class="align-center" alt="Configure Job Notification - Job level" /><figcaption aria-hidden="true"><em>Configure Job Notification - Job level</em></figcaption></figure>
...
<figure><img src="../images/job_notifications_agent_level.png" class="align-center" alt="Configure Job Notification - Agent level" /><figcaption aria-hidden="true"><em>Configure Job Notification - Agent level</em></figcaption></figure>
...
<figure><img src="../images/job_notifications_server_level.png" class="align-center" alt="Configure Job Notification - Server level" /><figcaption aria-hidden="true"><em>Configure Job Notification - Server level</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_general.png" class="align-center" alt="Create Agent Job - General tab" /><figcaption aria-hidden="true"><em>Create Agent Job - General tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_steps.png" class="align-center" alt="Create Agent Job - Steps tab" /><figcaption aria-hidden="true"><em>Create Agent Job - Steps tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_steps_definition.png" class="align-center" alt="Create Agent Job - Steps tab - General tab" /><figcaption aria-hidden="true"><em>Create Agent Job - Steps tab - General tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_steps_definition_code.png" class="align-center" alt="Create Agent Job - Steps tab - Code tab" /><figcaption aria-hidden="true"><em>Create Agent Job - Steps tab - Code tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_schedules.png" class="align-center" alt="Create Agent Job - Schedules tab - General tab" /><figcaption aria-hidden="true"><em>Create Agent Job - Schedules tab - General tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_schedules_repeat.png" class="align-center" alt="Create Agent Job - Schedules tab - Repeat tab" /><figcaption aria-hidden="true"><em>Create Agent Job - Schedules tab - Repeat tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_schedules_exceptions.png" class="align-center" alt="Create Agent Job - Schedules tab - Exceptions tab" /><figcaption aria-hidden="true"><em>Create Agent Job - Schedules tab - Exceptions tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_notifications.png" class="align-center" alt="Create Agent Job - Notifications tab" /><figcaption aria-hidden="true"><em>Create Agent Job - Notifications tab</em></figcaption></figure>
...
<figure><img src="../images/create_pem_jobs_sql.png" class="align-center" alt="Create Agent Job - SQL tab" /><figcaption aria-hidden="true"><em>Create Agent Job - SQL tab</em></figcaption></figure>
