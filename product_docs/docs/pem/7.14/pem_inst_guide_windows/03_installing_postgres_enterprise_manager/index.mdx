...
For detailed information about using the PEM server graphical installer, see [Installing the PEM Server on Windows](03_installing_postgres_enterprise_manager/#installing_pem_server_on_windows).
...
For detailed information about using the PEM agent graphical installer, see [Installing a PEM Agent on Windows](03_installing_postgres_enterprise_manager/#installing_pem_agent_on_windows).

<div class="toctree" maxdepth="5">

installing\_pem\_server\_on\_windows installing\_pem\_agent\_on\_windows
