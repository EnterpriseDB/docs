...
> **Note:** The selected database server must include an installation of the `sslutils` contrib module, and have a startup script (on Linux) or a registered service (on Windows).
...
> **Note:** For information about preparing a service script, please see [this section](../03_installing_postgres_enterprise_manager/#creating_a_service_script_or_registering_the_service)
