...
title: "Release Notes"
---
The Postgres Enterprise Manager (PEM) documentation version 7 describes the latest version of PEM 7.x including minor releases. The release notes in this section provide information on what was new in each 7.x release. For major new functionality that was introduced in a minor release, there are also indicators within the content about what release introduced the feature.
