...
<figure><img src="../images/audit_manager_intro.png" class="align-center" alt="Audit Manager Wizard - Welcome page" /><figcaption aria-hidden="true"><em>Audit Manager Wizard - Welcome page</em></figcaption></figure>

Click `Next` to continue:

<figure><img src="../images/audit_manager_servers.png" class="align-center" alt="Audit Manager Wizard - Select Servers page" /><figcaption aria-hidden="true"><em>Audit Manager Wizard - Select Servers page</em></figcaption></figure>
...
<figure><img src="../images/audit_manager_config1.png" class="align-center" alt="Audit Manager Wizard - Configuration page" /><figcaption aria-hidden="true"><em>Audit Manager Wizard - Configuration page</em></figcaption></figure>
...
<figure><img src="../images/audit_manager_config2.png" class="align-center" alt="Audit Manager Wizard - Log Parameters page" /><figcaption aria-hidden="true"><em>Audit Manager Wizard - Log Parameters page</em></figcaption></figure>
...
<figure><img src="../images/audit_manager_finish.png" class="align-center" alt="Audit Manager Wizard - Finish page" /><figcaption aria-hidden="true"><em>Audit Manager Wizard - Finish page</em></figcaption></figure>
