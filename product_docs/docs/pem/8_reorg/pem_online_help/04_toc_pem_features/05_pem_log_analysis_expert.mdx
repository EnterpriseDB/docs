...
<figure><img src="../images/pem_log_analysis_expert_welcome.png" class="align-center" alt="Postgres Log Analysis Expert Wizard- Welcome page" /><figcaption aria-hidden="true"><em>Postgres Log Analysis Expert Wizard- Welcome page</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_select_analyzers.png" class="align-center" alt="Postgres Log Analysis Expert Wizard - Select Analyzers page" /><figcaption aria-hidden="true"><em>Postgres Log Analysis Expert Wizard - Select Analyzers page</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_select_servers.png" class="align-center" alt="Postgres Log Analysis Expert Wizard - Select Servers page" /><figcaption aria-hidden="true"><em>Postgres Log Analysis Expert Wizard - Select Servers page</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_report_options.png" class="align-center" alt="Postgres Log Analysis Expert Wizard - Report Options page" /><figcaption aria-hidden="true"><em>Postgres Log Analysis Expert Wizard - Report Options page</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_report_finish.png" class="align-center" alt="Postgres Log Analysis Expert Wizard - Report Destination page" /><figcaption aria-hidden="true"><em>Postgres Log Analysis Expert Wizard - Report Destination page</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_report.png" class="align-center" alt="Postgres Log Analysis Expert Report" /><figcaption aria-hidden="true"><em>Postgres Log Analysis Expert Report</em></figcaption></figure>
