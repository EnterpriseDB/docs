...
<figure><img src="../../images/alerting_manage_alerts.png" class="align-center" alt="Manage Alerts" /><figcaption aria-hidden="true"><em>Manage Alerts</em></figcaption></figure>
...
<figure><img src="../../images/alerting_define_new_alert.png" class="align-center" alt="Create New Alert - General tab" /><figcaption aria-hidden="true"><em>Create New Alert - General tab</em></figcaption></figure>
...
<figure><img src="../../images/alerting_define_notification.png" class="align-center" alt="Create New Alert - Notification - Email tab" /><figcaption aria-hidden="true"><em>Create New Alert - Notification - Email tab</em></figcaption></figure>
...
<figure><img src="../../images/alerting_define_notification_webhook.png" class="align-center" alt="Create New Alert - Notification - Webhook tab" /><figcaption aria-hidden="true"><em>Create New Alert - Notification - Webhook tab</em></figcaption></figure>
...
<figure><img src="../../images/alerting_define_notification_snmp.png" class="align-center" alt="Create New Alert - Notification - SNMP tab" /><figcaption aria-hidden="true"><em>Create New Alert - Notification - SNMP tab</em></figcaption></figure>
...
<figure><img src="../../images/alerting_define_notification_nagios.png" class="align-center" alt="Create New Alert - Notification - Nagios tab" /><figcaption aria-hidden="true"><em>Create New Alert - Notification - Nagios tab</em></figcaption></figure>
...
<figure><img src="../../images/alerting_define_script_execution.png" class="align-center" alt="Create New Alert - Script Execution tab" /><figcaption aria-hidden="true"><em>Create New Alert - Script Execution tab</em></figcaption></figure>
...
<figure><img src="../../images/alerting_manage_alerts_table.png" class="align-center" alt="Manage Alerts table" /><figcaption aria-hidden="true"><em>Manage Alerts table</em></figcaption></figure>
...
<figure><img src="../../images/alerting_manage_alerts_delete.png" class="align-center" alt="Delete existing alerts" /><figcaption aria-hidden="true"><em>Delete existing alerts</em></figcaption></figure>
...
<figure><img src="../../images/alerting_example_general.png" class="align-center" alt="Create New Alert - General Tab - Example" /><figcaption aria-hidden="true"><em>Create New Alert - General Tab - Example</em></figcaption></figure>
...
<figure><img src="../../images/alerting_example_notification.png" class="align-center" alt="Create New Alert - Notification Tab - Example" /><figcaption aria-hidden="true"><em>Create New Alert - Notification Tab - Example</em></figcaption></figure>

<figure><img src="../../images/alerting_example_script_execution.png" class="align-center" alt="Create New Alert - Script Execution Tab - Example" /><figcaption aria-hidden="true"><em>Create New Alert - Script Execution Tab - Example</em></figcaption></figure>
