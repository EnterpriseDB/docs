...
<figure><img src="../images/backup_general.png" class="align-center" alt="Backup dialog - General tab" /><figcaption aria-hidden="true"><em>Backup dialog - General tab</em></figcaption></figure>
...
<figure><img src="../images/backup_sections.png" class="align-center" alt="Backup dialog - Dump Options tab - Sections options" /><figcaption aria-hidden="true"><em>Backup dialog - Dump Options tab - Sections options</em></figcaption></figure>
...
<figure><img src="../images/backup_objects.png" class="align-center" alt="Backup dialog - Dump Options tab - Type of Objects" /><figcaption aria-hidden="true"><em>Backup dialog - Dump Options tab - Type of Objects</em></figcaption></figure>
...
<figure><img src="../images/backup_do_not_save.png" class="align-center" alt="Backup dialog - Dump Options tab - Do not save options" /><figcaption aria-hidden="true"><em>Backup dialog - Dump Options tab - Do not save options</em></figcaption></figure>
...
<figure><img src="../images/backup_queries.png" class="align-center" alt="Backup dialog - Dump Options tab - Queries options" /><figcaption aria-hidden="true"><em>Backup dialog - Dump Options tab - Queries options</em></figcaption></figure>
...
<figure><img src="../images/backup_disable.png" class="align-center" alt="Backup dialog - Dump Options tab - Disable options" /><figcaption aria-hidden="true"><em>Backup dialog - Dump Options tab - Disable options</em></figcaption></figure>
...
<figure><img src="../images/backup_miscellaneous.png" class="align-center" alt="Backup dialog - Dump Options tab - Miscellaneous options" /><figcaption aria-hidden="true"><em>Backup dialog - Dump Options tab - Miscellaneous options</em></figcaption></figure>
...
<figure><img src="../images/backup_messages.png" class="align-center" alt="Backup Success Notification popup" /><figcaption aria-hidden="true"><em>Backup Success Notification popup</em></figcaption></figure>
...
<figure><img src="../images/backup_process_watcher.png" class="align-center" alt="Backup Process Watcher" /><figcaption aria-hidden="true"><em>Backup Process Watcher</em></figcaption></figure>
