...
<figure><img src="../images/add_restore_point.png" class="align-center" alt="Restore point dialog" /><figcaption aria-hidden="true"><em>Restore point dialog</em></figcaption></figure>
