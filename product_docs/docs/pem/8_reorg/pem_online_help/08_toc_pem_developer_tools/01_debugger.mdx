...
<figure><img src="../images/debug_main.png" class="align-center" alt="Debugger page - Parameters tab" /><figcaption aria-hidden="true"><em>Debugger page - Parameters tab</em></figcaption></figure>
...
<figure><img src="../images/debug_set_breakpoint.png" class="align-center" alt="Debugger tab" /><figcaption aria-hidden="true"><em>Debugger tab</em></figcaption></figure>
...
<figure><img src="../images/debug_ic_step_in.png" class="align-center" alt="Debugger page - Stack tab" /><figcaption aria-hidden="true"><em>Debugger page - Stack tab</em></figcaption></figure>

**Direct Debugging**

To use the debugger for direct debugging, right click on the name of the object that you wish to debug in the browser tree control and select `Debug` from the `Debugging` sub-menu. The debugger window will open, prompting you for any values required by the program:

<figure><img src="../images/debug_params.png" class="align-center" alt="Debugger parameter dialog" /><figcaption aria-hidden="true"><em>Debugger parameter dialog</em></figcaption></figure>
...
<figure><img src="../images/debug_step_in.png" class="align-center" alt="Debugger page - Stack tab" /><figcaption aria-hidden="true"><em>Debugger page - Stack tab</em></figcaption></figure>
...
<figure><img src="../images/debug_toolbar.png" class="align-center" alt="Debugger navigation toolbar" /><figcaption aria-hidden="true"><em>Debugger navigation toolbar</em></figcaption></figure>
...
<figure><img src="../images/debug_main.png" class="align-center" alt="Debugger main page" /><figcaption aria-hidden="true"><em>Debugger main page</em></figcaption></figure>
...
<figure><img src="../images/debug_variables.png" class="align-center" alt="Debugger page - Local variables tab" /><figcaption aria-hidden="true"><em>Debugger page - Local variables tab</em></figcaption></figure>
...
<figure><img src="../images/debug_stack.png" class="align-center" alt="Debugger page - Stack tab" /><figcaption aria-hidden="true"><em>Debugger page - Stack tab</em></figcaption></figure>
...
<figure><img src="../images/debug_error_message.png" class="align-center" alt="Debugger page - Message tab" /><figcaption aria-hidden="true"><em>Debugger page - Message tab</em></figcaption></figure>
