...
Postgres Enterprise Manager (PEM) offers several robust authentication options to secure access to the PEM web interface and backend database. These methods range from standard database authentication enhanced by two-factor verification to enterprise-grade Single Sign-On (SSO) using Kerberos.
...
- **Documentation:** [Configuring Two-Factor authentication](../configuring_2fa_authentication.mdx)
...
- **Documentation:** [Configuring Kerberos authentication on Linux](../configuring_the_pem_server_to_use_kerberos_authentication.mdx)
...
- **Documentation:** [Configuring Kerberos authentication on Windows](../configuring_the_pem_server_to_use_windows_kerberos_server.mdx)