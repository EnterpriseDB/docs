...
entitles you to use PEM, adding it to your stack to monitor those
...
additional cores are consumed by monitoring those servers with PEM.
...
6-core servers running PostgreSQL covered by EDB support,
consuming their 36 cores, as in the previous example.

The customer also has 10 x 2-core PostgreSQL servers that aren't
covered by any EDB subscription. These servers won't be monitored by
