...
Instructions for upgrading HA PEM are provided [here](/pem/10/upgrading/upgrading_pem_installation/high_availability_upgrade.mdx). You should validate these in your specific environment.
