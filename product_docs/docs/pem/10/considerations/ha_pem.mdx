...
You can find detailed installation instructions for some typical configurations in [Installing Postgres Enterprise Manager in HA Patterns](/pem/10/installing/ha/index.mdx).
