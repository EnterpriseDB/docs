...
| ---------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Is a standalone server enough or do you need a high-availability architecture? | [Installing the server](../installing/) or [Deploying high availability](setup_ha_using_efm/) |
