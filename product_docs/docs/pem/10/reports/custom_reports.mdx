...
- **PEM reports** query PEM's own management database. Use these to report on PEM monitoring data, agent status, alert history, and configuration. PEM reports require the `pem_admin` or `pem_super_admin` role.
...
1. For non-PEM reports, select the target database.
...
- View system-defined and custom non-PEM templates.
- View your own non-PEM report results.

Can't generate reports, create, edit, or delete report templates, or view report execution history for PEM reports.

**`pem_manage_report_templates`** — Includes all `pem_view_reports` permissions, plus:
- Create, edit, and delete own custom non-PEM report templates.
...
- Create, edit, and delete own custom PEM report templates.
...
|--------|:-----------------:|:---------------------------:|:-----------:|:-----------------:|
| View templates (non-PEM) | ✓ | ✓ | ✓ | ✓ |
| View templates (PEM) | | | ✓ | ✓ |
| Create/edit own templates (non-PEM) | | ✓ | ✓ | ✓ |
| Create/edit own templates (PEM) | | | ✓ | ✓ |
| Delete own templates (non-PEM) | | ✓ | ✓ | ✓ |
| Delete own templates (PEM) | | | ✓ | ✓ |
| Delete any template | | | | ✓ |
| Generate reports (non-PEM) | | ✓ | ✓ | ✓ |
| Generate reports (PEM) | | | ✓ | ✓ |
| View own report results (non-PEM) | ✓ | ✓ | ✓ | ✓ |
| View own report results (PEM) | | | ✓ | ✓ |
| View all users' report results (PEM) | | | | ✓ |
| Delete own report results (non-PEM) | | ✓ | ✓ | ✓ |
| Delete own report results (PEM) | | | ✓ | ✓ |
