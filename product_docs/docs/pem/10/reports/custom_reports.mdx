...
The execution history provides a centralized audit trail of all custom report activities. To effectively manage and locate specific records within a high-volume environment, users can apply the following filters:
...
!!! Note
     Increasing this limit significantly may impact report generation speed and the overall responsiveness of the Report Results view when handling large volumes of data.