...
|--------|:-----------------:|:---------------------------:|:-----------:|:-----------------:|
| View template | non-PEM | non-PEM | all | all |
| Create/edit template | | non-PEM | all | all |
| Delete own template | | non-PEM | all | all |
| Delete any template | | | | ✓ |
| View reports | non-PEM | non-PEM | all | all |
| Generate reports | | non-PEM | all | all |
| Delete own reports | | non-PEM | all | all |
| Delete any reports | | | | ✓ |
