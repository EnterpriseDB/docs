---
navTitle: RHEL 9
title: Installing Postgres Enterprise Manager server on RHEL 9 ppc64le
...
redirects:
  - /pem/10/installing_pem_server/pem_server_inst_linux/installing_pem_server_using_edb_repository/ibm_power_ppc64le/pem_server_rhel9_ppcle
  - /pem/10/installing_pem_server/installing_on_linux/using_edb_repository/ibm_power_ppc64le/pem_server_rhel9_ppcle/
  - /pem/10/installing_pem_server/installing_on_linux/using_edb_repository/ppc64le/pem_server_rhel9_ppcle/
  - /pem/10/installing_pem_server/installing_on_linux/using_edb_repository/x86_amd64/pem_server_rhel9_ppcle/
  - /pem/10/installing_pem_server/installing_on_linux/using_edb_repository/x86/pem_server_rhel9_ppcle/
---
...
!!! Note "Upgrading to PEM 10.3"
If you come across libcurl errors while upgrading to 10.3 on RHEL 9 then use `--allowerasing` option with your package manager.
