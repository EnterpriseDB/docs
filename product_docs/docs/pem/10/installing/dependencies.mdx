...
| Platform  | Architecture | package-version      |
|-----------|--------------|----------------------|
| RHEL 8    | x86_64       | `edb-snmp++-3.6.3`   |
|           | ppc64le      | `edb-snmp++-3.6.3`   |
|           | s390x        | `edb-snmp++-3.6.3`   |
| RHEL 9    | x86_64       | `edb-snmp++-3.6.6`   |
|           | ppc64le      | `edb-snmp++-3.6.6`   |
|           | s390x        | `edb-snmp++-3.6.6`   |
|           | arm64        | `edb-snmp++-3.6.6`   |
| RHEL 10   | x86_64       | `edb-snmp++-3.6.6`   |
| SLES 15   | x86_64       | `edb-snmp++-3.6.6`   |
|           | ppc64le      | `edb-snmp++-3.6.6`   |
|           | s390x        | `edb-snmp++-3.6.6`   |
| Ubuntu 22 | amd64        | `edb-snmp++-3.6.6`   |
| Ubuntu 24 | amd64        | `edb-snmp++-3.6.6`   |
| Debian 11 | amd64        | `edb-snmp++-3.6.3`   |
| Debian 12 | amd64/arm64  | `edb-snmp++-3.6.6`   |
