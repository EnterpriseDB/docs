...
|-----------|--------------|----------------------------------------|----------------|------------------------------------------|
|           | ppc64le      | `edb-python310/edb-python310-mod-wsgi` | 3.12           | `/usr/libexec/edb-python310/bin/python3` |
|           | s390x        | `edb-python310/edb-python310-mod-wsgi` | 3.12           | `/usr/libexec/edb-python310/bin/python3` |
| RHEL 8    | x86_64       | `edb-python310/edb-python310-mod-wsgi` | 3.12           | `/usr/libexec/edb-python310/bin/python3` |
| RHEL 9    | x86_64       | `python39/python39-mod_wsgi`           | 3.12           | `/usr/bin/python3`                       |
|           | ppc64le      | `python39/python39-mod_wsgi`           | 3.12           | `/usr/bin/python3`                       |
|           | s390x        | `python39/python39-mod_wsgi`           | 3.12           | `/usr/bin/python3`                       |
|           | arm64        | `python39/python39-mod_wsgi`           | 3.12           | `/usr/bin/python3`                       |
| SLES 15   | x86_64       | `edb-python310/edb-python310-mod-wsgi` | 3.12           | `/usr/libexec/edb-python310/bin/python3` |
|           | ppc64le      | `edb-python310/edb-python310-mod-wsgi` | 3.12           | `/usr/libexec/edb-python310/bin/python3` |
|           | s390x        | `edb-python310/edb-python310-mod-wsgi` | 3.12           | `/usr/libexec/edb-python310/bin/python3` |
| Ubuntu 22 | amd64        | `python310/libapache2-mod-wsgi-py3`    | 3.12           | `/usr/bin/python3`                       |
| Ubuntu 24 | amd64        | `python312/libapache2-mod-wsgi-py3`    | 3.12           | `/usr/bin/python3`                       |
| Debian 11 | amd64        | `edb-python310/edb-python310-mod-wsgi` | 3.12           | `/usr/libexec/edb-python310/bin/python3` |
