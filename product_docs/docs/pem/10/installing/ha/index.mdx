...
For PEM 10.4 and above, the recommended process for deploying HA PEM is as follows:
...
However, the changes to configure-pem-server.sh are backward-compatible so previous processes will still without adjustment.
