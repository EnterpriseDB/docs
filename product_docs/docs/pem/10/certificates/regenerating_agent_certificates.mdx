...
!!! Important
By default, these steps are performed automatically when the certificates near expiry.
These instructions are provided for completeness should you need to manually regenerate the PEM certificates and keys. 
!!!
