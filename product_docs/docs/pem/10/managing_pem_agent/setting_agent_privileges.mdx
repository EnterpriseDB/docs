...
| Manage Dashboards            | Some dashboards might not be able to show complete data. See the [affected functionality](#functionality-affected-by-limiting-operating-system-privileges). details.                                                                                                                                                                            | Some dashboards might not be able to show complete data. For example, the operating system information of the database server doesn't appear as not available.                               |
