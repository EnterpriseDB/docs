...
-   The **Heartbeat Tolerance** fields display the length of time that how late a heartbeat can be before it is considered missed. Use the selectors next to the **Minutes** or **Seconds** fields to modify the value.
