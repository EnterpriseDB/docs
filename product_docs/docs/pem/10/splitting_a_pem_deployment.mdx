...
This document provides a procedure for splitting an existing PEM installation into two installations.
...
In this guide, we show example commands for PostgreSQL 16. Modify the service name and file paths as appropriate to your environment.
