...
Unless you have orchestration tooling capable of doing this or are using a [common agent user](certificates/#generate-a-common-agent-certificate-and-key-pair), this can be a significant effort.
!!!
...
4.  [Regenerate agent certificates](certificates/regenerating_agent_certificates/) for each agent user and copy the new certificates and keys into place. 
    You must also regenerate the certificate and key and for the agent on the PEM server.

5.  Restart the affected PEM agents.
