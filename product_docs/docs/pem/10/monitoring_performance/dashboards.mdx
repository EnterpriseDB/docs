...
PEM displays performance statistics on a number of system-defined dashboards. Each dashboard contains a series of summary views that contain charts, graphs, and tables that display statistics related to the selected object. 
You can also create custom dashboards with your choice of charts and layout.

To create a custom dashboard, first open an existing dashboard at the same level as the one you wiush to create.
For example if you wish to create a new server-level dashboard, open any of the existing server-level dashboards.
...
Click **Save** when you are done and the dashboard will appear in the list of dashboards shown in the breadcrumb bar at the top opf the screen.
...
To choose who can see this dashboard, click the cog icon next