...
| EFM cluster failover detected                                               | Failover is triggered when a failover event is recorded for an EFM cluster within the specified time.                                           |
...
| Patroni cluster failover detected                                           | Patroni: Failover is triggered when a failover event is recorded for a Patroni cluster within the specified time.                               |
