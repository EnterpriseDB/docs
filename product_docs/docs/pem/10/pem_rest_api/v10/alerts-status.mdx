...
pdfExclude: true
title: 'EDB Postgres Enterprise Manager REST APIs v10.0: Alerts Status'
...
curl -X GET https://PEM-SERVER-IP/pem/api/v10/alert/status/ \
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v10/alert/status/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v10/alert/status/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v10/alert/status/{since} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v10/alert/status/{since}', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v10/alert/status/{since}',
{
  method: 'GET',
