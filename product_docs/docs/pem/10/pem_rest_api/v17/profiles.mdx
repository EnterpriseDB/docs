---
navTitle: Profiles
title: 'EDB Postgres Enterprise Manager REST APIs v17.0: Profiles'
description: >-
...
curl -X GET https://PEM-SERVER-IP/pem/api/v17/profiles/ \
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v17/profiles/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X POST https://PEM-SERVER-IP/pem/api/v17/profiles/ \
...
r = requests.post('https://PEM-SERVER-IP/pem/api/v17/profiles/', headers = headers)
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X PUT https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id} \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.put('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}', headers = headers)
...
```shell
# You can also use wget
curl -X DELETE https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id} \
  -H 'X-Auth-Token: string'
...
r = requests.delete('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}', headers = headers)
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/assigned \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/assigned', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/assigned',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/draft \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/draft', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/draft',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X DELETE https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/rollback \
  -H 'X-Auth-Token: string'
...
r = requests.delete('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/rollback', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/rollback',
{
  method: 'DELETE',
...
```shell
# You can also use wget
curl -X POST https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/publish \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.post('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/publish', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/publish',
{
  method: 'POST',
...
```shell
# You can also use wget
curl -X POST https://PEM-SERVER-IP/pem/api/v17/profiles/{source_id}/clone \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.post('https://PEM-SERVER-IP/pem/api/v17/profiles/{source_id}/clone', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/{source_id}/clone',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
Creates a new published profile by copying every probe and alert configuration from the source. The source must be a published profile; cloning a draft is rejected with 400. The clone is independent of the source (parent_id is NULL, status is 'published', no active assignments). All notification-channel IDs (email groups, webhook IDs, SNMP trap fields) are copied verbatim because clone happens inside one PEM instance. Auto-created alerts are copied and remain non-deletable on the clone. When 'name' is omitted, the server generates 'Copy of <source />' and appends ' (2)', ' (3)', ... until the name is unique among published profiles.
...
<span id="post__profiles_{source_id}_clone-parameters"></span>
...
| X-Auth-Token  | header | string  | true     | Token for authorization                                                                                                                                                          |
| body          | body   | object  | false    | none                                                                                                                                                                             |
| » name        | body   | string  | false    | Optional. Name for the clone. Must be unique among published profiles or the request returns 409. If omitted, the server generates 'Copy of <source />' with conflict-avoidance. |
...
<Details summary="Profile cloned successfully.">
...
```json
{
  ...
  "data": {
    "id": 42,
    "name": "Copy of Production Servers",
    "target_kind": "s",
    "description": "Monitoring production database servers"
  }
}
...
<span id="post__profiles_{source_id}_clone-responses"></span>
...
| Status | Meaning                                                                    | Description                                                                                                                                                             | Schema |
| ------ | -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ |
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)                    | Profile cloned successfully.                                                                                                                                            | Inline |
| 400    | [Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1)           | Bad request. The source is a draft (cannot be cloned), the supplied name is empty, the auto-generated name has been exhausted, or 'name'/'description' is not a string. | Inline |
| 404    | [Not Found](https://tools.ietf.org/html/rfc7231#section-6.5.4)             | Source profile not found.                                                                                                                                               | Inline |
| 409    | [Conflict](https://tools.ietf.org/html/rfc7231#section-6.5.8)              | The user-supplied 'name' conflicts with an existing published profile.                                                                                                  | Inline |
| 500    | [Internal Server Error](https://tools.ietf.org/html/rfc7231#section-6.6.1) | Internal server error.                                                                                                                                                  | None   |

<span id="post__profiles_{source_id}_clone-responseschema"></span>
...
```shell
# You can also use wget
curl -X DELETE https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/{new_profile_id} \
  -H 'X-Auth-Token: string'
...
r = requests.delete('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/{new_profile_id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profiles/{profile_id}/{new_profile_id}',
{
  method: 'DELETE',
...
```shell
# You can also use wget
curl -X POST https://PEM-SERVER-IP/pem/api/v17/profile/export/ \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.post('https://PEM-SERVER-IP/pem/api/v17/profile/export/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profile/export/',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
<span id="post__profile_export_-parameters"></span>
...
<span id="post__profile_export_-responses"></span>
...
| Status | Meaning                                                          | Description                                                                                      | Schema |
| ------ | ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ------ |
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)          | Export bundle (application/json).                                                                | Inline |
| 400    | [Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1) | No profiles to export, profile id not found, orphan draft, or resolved profile is not published. | None   |
| 401    | [Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)  | User lacks `pem_manage_profile` role.                                                            | None   |

<span id="post__profile_export_-responseschema"></span>
...
```shell
# You can also use wget
curl -X POST https://PEM-SERVER-IP/pem/api/v17/profile/import/ \
  -H 'Content-Type: application/json' \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.post('https://PEM-SERVER-IP/pem/api/v17/profile/import/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v17/profile/import/',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
<span id="post__profile_import_-parameters"></span>
...
<span id="post__profile_import_-responses"></span>
...
| Status | Meaning                                                          | Description                                                        | Schema |
| ------ | ---------------------------------------------------------------- | ------------------------------------------------------------------ | ------ |
| 200    | [OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)          | Per-profile import results.                                        | Inline |
| 400    | [Bad Request](https://tools.ietf.org/html/rfc7231#section-6.5.1) | Malformed payload, missing skip_overwrite, or unsupported version. | None   |
| 401    | [Unauthorized](https://tools.ietf.org/html/rfc7235#section-3.1)  | User lacks `pem_manage_profile` role.                              | None   |

<span id="post__profile_import_-responseschema"></span>
...
<span id="edb-postgres-enterprise-manager-rest-apis-blackout"></span>
