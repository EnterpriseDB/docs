---
navTitle: Schemas
title: 'EDB Postgres Enterprise Manager REST APIs v17.0: Schemas'

---

<span id="tocs_profile"></span>
...
Full profile details with probe and alert configurations (returned by GET /profiles/{profile_id}).
...
| published            | boolean                             | false    | none         | True when the profile is published, false if it's a draft.                |
| parent_id            | integer                             | false    | none         | Parent profile ID (null for published profiles, set for drafts).          |
| draft_id             | integer                             | false    | none         | Draft profile ID (only present for published profiles that have a draft). |
| target_probe_configs | \[[ProbeConfig](#tocs_probeconfig)] | false    | none         | Probe configurations associated with the profile.                         |
| target_alert_configs | \[[Alert](#tocs_alert)]             | false    | none         | Alert configurations associated with the profile.                         |
...
<span id="tocs_profiledraft"></span>

## ProfileDraft


<a id="schemaprofiledraft"></a>
<a id="schema_ProfileDraft"></a>
<a id="tocSprofiledraft"></a>
<a id="tocsprofiledraft"></a>
...
Draft profile details (returned by GET /profiles/{profile_id}/draft). Does not include parent_id or draft_id.
...
| description          | string                              | false    | none         | none                                                        |
| target_kind          | string                              | false    | none         | Target type for the profile: 's' for server, 'a' for agent. |
| published            | boolean                             | false    | none         | Always false for drafts.                                    |
| target_probe_configs | \[[ProbeConfig](#tocs_probeconfig)] | false    | none         | Probe configurations associated with the draft.             |
| target_alert_configs | \[[Alert](#tocs_alert)]             | false    | none         | Alert configurations associated with the draft.             |
...
<span id="tocs_profilesummary"></span>
...
A trimmed profile representation for list operations (no probe/alert config arrays).
...
<span id="tocs_probeconfig"></span>

## ProbeConfig


<a id="schemaprobeconfig"></a>
<a id="schema_ProbeConfig"></a>
<a id="tocSprobeconfig"></a>
<a id="tocsprobeconfig"></a>
...
| Name             | Type    | Required | Restrictions | Description                                                     |
| ---------------- | ------- | -------- | ------------ | --------------------------------------------------------------- |
| probe_id         | integer | false    | none         | none                                                            |
| probe_name       | string  | false    | none         | none                                                            |
| enabled          | boolean | false    | none         | none                                                            |
| interval         | integer | false    | none         | Execution frequency (minutes).                                  |
| lifetime         | integer | false    | none         | History retention (days).                                       |
| default_enabled  | boolean | false    | none         | none                                                            |
| default_interval | integer | false    | none         | none                                                            |
| default_lifetime | integer | false    | none         | none                                                            |
| target_type      | integer | false    | none         | Target type identifier for probe (e.g., 200=server, 100=agent). |
| force_enabled    | boolean | false    | none         | none                                                            |

<span id="tocs_probeconfigupsert"></span>

## ProbeConfigUpsert


<a id="schemaprobeconfigupsert"></a>
<a id="schema_ProbeConfigUpsert"></a>
<a id="tocSprobeconfigupsert"></a>
<a id="tocsprobeconfigupsert"></a>
...
Probe configuration fields to add or update for a profile.

#### Properties

| Name                | Type    | Required | Restrictions | Description                                                                          |
| ------------------- | ------- | -------- | ------------ | ------------------------------------------------------------------------------------ |
| probe_id            | integer | true     | none         | Probe identifier to add/update.                                                      |
| enabled             | boolean | false    | none         | Enable/disable this probe in the profile.                                            |
| enabled_by_default  | boolean | false    | none         | Whether the probe follows default enablement. Alias: 'use_default_enabled' accepted. |
| execution_frequency | integer | false    | none         | Probe execution frequency in minutes. Alias: 'interval' accepted.                    |
| lifetime            | integer | false    | none         | History retention (days).                                                            |

<span id="tocs_probeconfigsupdateonly"></span>

## ProbeConfigsUpdateOnly


<a id="schemaprobeconfigsupdateonly"></a>
<a id="schema_ProbeConfigsUpdateOnly"></a>
<a id="tocSprobeconfigsupdateonly"></a>
<a id="tocsprobeconfigsupdateonly"></a>
...
Delta for probe configs when updating by profile id: only modify existing probes using 'changed'. Adding probes is not supported via this endpoint.

#### Properties

| Name    | Type                                            | Required | Restrictions | Description                                                |
| ------- | ----------------------------------------------- | -------- | ------------ | ---------------------------------------------------------- |
| changed | \[[ProbeConfigUpsert](#tocs_probeconfigupsert)] | false    | none         | Existing probe configs to modify (identified by probe_id). |

<span id="tocs_alertchange"></span>

## AlertChange


<a id="schemaalertchange"></a>
<a id="schema_AlertChange"></a>
<a id="tocSalertchange"></a>
<a id="tocsalertchange"></a>
...
Change an existing alert config in a profile.

#### Properties

| Name                   | Type    | Required | Restrictions | Description         |
| ---------------------- | ------- | -------- | ------------ | ------------------- |
| id                     | integer | false    | none         | Alert ID to modify. |
| name                   | string  | false    | none         | Alert name.         |
| enabled                | boolean | false    | none         | none                |
| history_retention      | integer | false    | none         | none                |
| frequency_min          | integer | false    | none         | none                |
| operator               | string  | false    | none         | none                |
| low_threshold_value    | number  | false    | none         | none                |
| medium_threshold_value | number  | false    | none         | none                |
| high_threshold_value   | number  | false    | none         | none                |
| all_alert_enable       | boolean | false    | none         | none                |
| email_group_id         | integer | false    | none         | none                |
| low_alert_enable       | boolean | false    | none         | none                |
| low_email_group_id     | integer | false    | none         | none                |
| med_alert_enable       | boolean | false    | none         | none                |
| med_email_group_id     | integer | false    | none         | none                |
| high_alert_enable      | boolean | false    | none         | none                |
| high_email_group_id    | integer | false    | none         | none                |
...
<span id="tocs_alertdeleteref"></span>

## AlertDeleteRef


<a id="schemaalertdeleteref"></a>
<a id="schema_AlertDeleteRef"></a>
<a id="tocSalertdeleteref"></a>
<a id="tocsalertdeleteref"></a>
...
Reference to an existing alert to delete (id only).

#### Properties

| Name | Type    | Required | Restrictions | Description                |
| ---- | ------- | -------- | ------------ | -------------------------- |
| id   | integer | true     | none         | Alert config id to delete. |

<span id="tocs_alertconfigsdelta"></span>

## AlertConfigsDelta


<a id="schemaalertconfigsdelta"></a>
<a id="schema_AlertConfigsDelta"></a>
<a id="tocSalertconfigsdelta"></a>
<a id="tocsalertconfigsdelta"></a>
...
Delta for alert configs within a profile.

#### Properties

| Name    | Type                                      | Required | Restrictions | Description                                           |
| ------- | ----------------------------------------- | -------- | ------------ | ----------------------------------------------------- |
| changed | \[[AlertChange](#tocs_alertchange)]       | false    | none         | Modify existing alerts.                               |
| added   | \[[AlertPayload](#tocs_alertpayload)]     | false    | none         | Add new alerts. See AlertPayload for required fields. |
| deleted | \[[AlertDeleteRef](#tocs_alertdeleteref)] | false    | none         | Delete existing alerts by id.                         |

<span id="tocs_deleteandreassignpayload"></span>

## DeleteAndReassignPayload


<a id="schemadeleteandreassignpayload"></a>
<a id="schema_DeleteAndReassignPayload"></a>
<a id="tocSdeleteandreassignpayload"></a>
<a id="tocsdeleteandreassignpayload"></a>
...
| Name           | Type    | Required | Restrictions | Description                                                      |
| -------------- | ------- | -------- | ------------ | ---------------------------------------------------------------- |
| old_profile_id | integer | true     | none         | Existing profile ID to remove.                                   |
| new_profile_id | integer | false    | none         | New profile ID to reassign associated servers/agents (optional). |

<span id="tocs_profileassignmentdetails"></span>

## ProfileAssignmentDetails


<a id="schemaprofileassignmentdetails"></a>
<a id="schema_ProfileAssignmentDetails"></a>
<a id="tocSprofileassignmentdetails"></a>
<a id="tocsprofileassignmentdetails"></a>
...
| Name         | Type    | Required | Restrictions | Description |
| ------------ | ------- | -------- | ------------ | ----------- |
| has_profile  | boolean | false    | none         | none        |
| profile_id   | integer | false    | none         | none        |
| profile_name | string  | false    | none         | none        |
...
| profile_id          | integer  | false    | none         | Determine whether this agent has to be managed by the specified profile id.                                                                     |
...
| profile_id                | integer  | false    | none         | Profile ID                                                                                                                                              |
...
| tunnel_keep_alive         | integer  | false    | none         | Interval in seconds to send keep alive packets for ssh tunnel.                                                                                          |
...
| » jstkind      | any                    | false    | none         | Determines the kind of the step. Accepts boolean (true=SQL, false=Batch) or string ('s'=SQL, 'b'=Batch, 'r'=Report). |
...
| » report_template_id | integer¦null      | false    | none         | ID of the report template. Required when jstkind is 'r' (report step).                                                                                                                  |
...
| » jscweekdays        | [boolean]         | false    | none         | 7-element boolean array for days of the week. Index 0=Sunday, 1=Monday, 2=Tuesday, 3=Wednesday, 4=Thursday, 5=Friday, 6=Saturday. true at an index means the schedule runs on that day. |
| » jscmonthdays       | [boolean]         | false    | none         | 32-element boolean array for days of the month. Index 0=1st, index 30=31st, index 31=last day of month. true at an index means the schedule runs on that day.                           |
| » jscmonths          | [boolean]         | false    | none         | 12-element boolean array for months. Index 0=January, 1=February, ..., 11=December. true at an index means the schedule runs in that month.                                             |
| » jschours           | [boolean]         | false    | none         | 24-element boolean array for hours of the day (0-23). Index 0=midnight, index 12=noon, index 23=11PM. true at an index means the schedule runs at that hour.                            |
| » jscminutes         | [boolean]         | false    | none         | 60-element boolean array for minutes of the hour (0-59). true at an index means the schedule runs at that minute.                                                                       |
...
| »» database_name      | string   | false    | none         | Name of the database associated with the step.                                                                       |
| »» jstonerror         | string   | false    | none         | Specifies the behavior of agent if it encounters an error while executing the step('Fail', 'Success', 'Ignore').     |
| »» report_template_id | integer  | false    | none         | ID of the report template. Required when jstkind is 'r' (report step).                                               |
...
| »» jscweekdays        | [string]     | false    | none         | Array of weekday names when the schedule should run. Pass only the days you want.                                      |
| »» jscmonthdays       | [integer]    | false    | none         | Array of day numbers (1-31) when the schedule should run. Use 32 for 'last day of month'. Pass only the days you want. |
| »» jscmonths          | [string]     | false    | none         | Array of month names when the schedule should run. Pass only the months you want.                                      |
| »» jschours           | [integer]    | false    | none         | Array of hours (0-23) when the schedule should run. 0=midnight, 12=noon, 23=11PM. Pass only the hours you want.        |
| »» jscminutes         | [integer]    | false    | none         | Array of minutes (0-59) when the schedule should run. Pass only the minutes you want.                                  |
...
| »» jsctimezone        | string       | false    | none         | Timezone of the schedule. Use standard IANA timezone names.                                                            |
...
<span id="tocs_blackout"></span>

## Blackout


<a id="schemablackout"></a>
<a id="schema_Blackout"></a>
<a id="tocSblackout"></a>
<a id="tocsblackout"></a>
...
<span id="tocs_blackouthistory"></span>

## BlackoutHistory


<a id="schemablackouthistory"></a>
<a id="schema_BlackoutHistory"></a>
<a id="tocSblackouthistory"></a>
<a id="tocsblackouthistory"></a>
...
```json
{
  ...
  "actual_end_time": "2019-08-24T14:15:22Z",
  "object_type": 0,
  "object_id": 0,
  "source": "manual",
  "batch_id": "4da22c97-b7d5-4e31-8c3a-03870ebc7b20",
...
Archived blackout record. Returned by GET /blackout/?include_history=true (mixed with live rows) and by GET /blackout/{id} when the id is found only in pem.blackout_history.
...
<span id="tocs_blackoutwarning"></span>

## BlackoutWarning


<a id="schemablackoutwarning"></a>
<a id="schema_BlackoutWarning"></a>
<a id="tocSblackoutwarning"></a>
<a id="tocsblackoutwarning"></a>
...
Structured non-fatal warning attached to a successful response. `code` is a stable identifier callers can dispatch on; `message` is human-readable; remaining keys are per-warning context (e.g. ObjectId, BlackoutId, ArchivedCount).
...
<span id="tocs_objectblackoutstatus"></span>

## ObjectBlackoutStatus


<a id="schemaobjectblackoutstatus"></a>
<a id="schema_ObjectBlackoutStatus"></a>
<a id="tocSobjectblackoutstatus"></a>
<a id="tocsobjectblackoutstatus"></a>
...
Synthesized blackout state for a single server or agent: the synced alert_blackout flag plus the full record set broken down by source.
...
| object_type | integer                                     | false    | none         | 100 = agent, 200 = server                                                                                                                                                      |
| object_id   | integer                                     | false    | none         | none                                                                                                                                                                           |
| in_blackout | boolean                                     | false    | none         | Value of pem.{server,agent}.alert_blackout — true when at least one source has an active record on this object.                                                                |
| manual      | [Blackout](#tocs_blackout)¦null             | false    | none         | Active manual record (always indefinite, end_time=NULL) or null.                                                                                                               |
| scheduled   | \[[Blackout](#tocs_blackout)]               | false    | none         | Active scheduled records.                                                                                                                                                      |
| auto        | [Blackout](#tocs_blackout)¦null             | false    | none         | Active auto record (system-initiated for unreachable objects) or null.                                                                                                         |
| warnings    | \[[BlackoutWarning](#tocs_blackoutwarning)] | false    | none         | Optional non-fatal warnings (e.g. flag_select_failed when alert_blackout flag SELECT failed and in_blackout was derived from the records list). Field absent when no warnings. |
...
<span id="tocs_objectblackouttoggleresult"></span>

## ObjectBlackoutToggleResult


<a id="schemaobjectblackouttoggleresult"></a>
<a id="schema_ObjectBlackoutToggleResult"></a>
<a id="tocSobjectblackouttoggleresult"></a>
<a id="tocsobjectblackouttoggleresult"></a>
...
Result of an object-centric PUT (enable manual) or DELETE (end all). Idempotent — second identical call returns changed=false with the same post-state.

#### Properties

| Name            | Type                                        | Required | Restrictions | Description                                                                                                                                                                                                                                                                                      |
| --------------- | ------------------------------------------- | -------- | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| changed         | boolean                                     | false    | none         | true when the call actually changed state (a record was inserted on PUT or one or more records were ended on DELETE); false on no-op idempotent calls.                                                                                                                                           |
| in_blackout     | boolean                                     | false    | none         | Post-state of alert_blackout. After a successful PUT this is always true; after DELETE always false.                                                                                                                                                                                             |
| manual          | [Blackout](#tocs_blackout)¦null             | false    | none         | Current manual record (or null).                                                                                                                                                                                                                                                                 |
| ended_records   | [object]                                    | false    | none         | Records that were ended (only populated on DELETE; always \[] on PUT). Each carries the record id, source, scheduled_end (string ISO timestamp or null for indefinite manual records), and ended_early (true if the record had a non-NULL end_time still in the future at the moment of DELETE). |
| » id            | integer                                     | false    | none         | none                                                                                                                                                                                                                                                                                             |
| » source        | string                                      | false    | none         | none                                                                                                                                                                                                                                                                                             |
| » scheduled_end | string(date-time)¦null                      | false    | none         | none                                                                                                                                                                                                                                                                                             |
| » ended_early   | boolean                                     | false    | none         | none                                                                                                                                                                                                                                                                                             |
| warnings        | \[[BlackoutWarning](#tocs_blackoutwarning)] | false    | none         | Optional non-fatal warnings (e.g. manual_post_state_unavailable / in_blackout_post_state_unavailable when post-COMMIT response-shape SELECTs fail). Field absent when no warnings.                                                                                                               |
