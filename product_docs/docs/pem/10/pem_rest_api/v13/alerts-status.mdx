...
curl -X GET https://PEM-SERVER-IP/api/v13/alert/status/ \
...
r = requests.get('https://PEM-SERVER-IP/api/v13/alert/status/', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v13/alert/status/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/api/v13/alert/status/{since} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/api/v13/alert/status/{since}', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v13/alert/status/{since}',
{
  method: 'GET',
