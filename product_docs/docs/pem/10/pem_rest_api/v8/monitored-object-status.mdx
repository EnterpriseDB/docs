...
curl -X GET https://PEM-SERVER-IP/api/v8/agent/status/ \
...
r = requests.get('https://PEM-SERVER-IP/api/v8/agent/status/', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v8/agent/status/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/api/v8/agent/status/{agent_id} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/api/v8/agent/status/{agent_id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v8/agent/status/{agent_id}',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/api/v8/server/status/ \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/api/v8/server/status/', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v8/server/status/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/api/v8/server/status/{server_id} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/api/v8/server/status/{server_id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v8/server/status/{server_id}',
{
  method: 'GET',
