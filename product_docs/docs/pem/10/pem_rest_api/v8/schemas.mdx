...
navTitle: Schemas
pdfExclude: true
title: 'EDB Postgres Enterprise Manager REST APIs v8.0: Schemas'
...
| type                    | string  | false    | none         | Value must be "agent"                                           |
| agent_id                | integer | false    | none         | none                                                            |
| ignore_duplicate_alerts | boolean | false    | none         | Determines whether to ignore the duplicate alerts to be copied. |
...
| ignore_duplicate_alerts | boolean | false    | none         | Determines whether whether to ignore the duplicate alerts to be copied. |
