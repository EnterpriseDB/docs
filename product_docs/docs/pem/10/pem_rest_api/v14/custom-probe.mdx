...
pdfExclude: true
title: 'EDB Postgres Enterprise Manager REST APIs v14.0: Custom Probe'
...
curl -X GET https://PEM-SERVER-IP/pem/api/v14/probe/ \
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v14/probe/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v14/probe/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X POST https://PEM-SERVER-IP/pem/api/v14/probe/ \
...
r = requests.post('https://PEM-SERVER-IP/pem/api/v14/probe/', headers = headers)
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v14/probe/{probe_id} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v14/probe/{probe_id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v14/probe/{probe_id}',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X PUT https://PEM-SERVER-IP/pem/api/v14/probe/{probe_id} \
  -H 'Content-Type: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.put('https://PEM-SERVER-IP/pem/api/v14/probe/{probe_id}', headers = headers)
...
```shell
# You can also use wget
curl -X DELETE https://PEM-SERVER-IP/pem/api/v14/probe/{probe_id} \
  -H 'X-Auth-Token: string'
...
r = requests.delete('https://PEM-SERVER-IP/pem/api/v14/probe/{probe_id}', headers = headers)
