...
curl -X GET https://PEM-SERVER-IP/api/v9/alert/template/ \
...
r = requests.get('https://PEM-SERVER-IP/api/v9/alert/template/', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v9/alert/template/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X POST https://PEM-SERVER-IP/api/v9/alert/template/ \
...
r = requests.post('https://PEM-SERVER-IP/api/v9/alert/template/', headers = headers)
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/api/v9/alert/template/{id} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/api/v9/alert/template/{id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v9/alert/template/{id}',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X PUT https://PEM-SERVER-IP/api/v9/alert/template/{id} \
  -H 'Content-Type: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.put('https://PEM-SERVER-IP/api/v9/alert/template/{id}', headers = headers)
...
```shell
# You can also use wget
curl -X DELETE https://PEM-SERVER-IP/api/v9/alert/template/{id} \
  -H 'X-Auth-Token: string'
...
r = requests.delete('https://PEM-SERVER-IP/api/v9/alert/template/{id}', headers = headers)
