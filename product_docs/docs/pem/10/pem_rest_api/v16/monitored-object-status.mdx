...
pdfExclude: true
title: 'EDB Postgres Enterprise Manager REST APIs v16.0: Monitored Object Status'
...
curl -X GET https://PEM-SERVER-IP/pem/api/v16/agent/status/ \
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v16/agent/status/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v16/agent/status/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v16/agent/status/{agent_id} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v16/agent/status/{agent_id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v16/agent/status/{agent_id}',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v16/server/status/ \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v16/server/status/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v16/server/status/',
{
  method: 'GET',
...
```shell
# You can also use wget
curl -X GET https://PEM-SERVER-IP/pem/api/v16/server/status/{server_id} \
  -H 'Accept: application/json' \
  -H 'X-Auth-Token: string'
...
r = requests.get('https://PEM-SERVER-IP/pem/api/v16/server/status/{server_id}', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v16/server/status/{server_id}',
{
  method: 'GET',
