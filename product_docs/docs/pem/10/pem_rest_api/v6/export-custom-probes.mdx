...
curl -X POST https://PEM-SERVER-IP/api/v6/probe/custom/export/ \
...
r = requests.post('https://PEM-SERVER-IP/api/v6/probe/custom/export/', headers = headers)
...
fetch('https://PEM-SERVER-IP/api/v6/probe/custom/export/',
{
  method: 'POST',
  body: inputBody,
  headers: headers
