---
navTitle: Export Custom Probes
pdfExclude: true
title: 'EDB Postgres Enterprise Manager REST APIs v6.0: Export Custom Probes'
...
curl -X POST https://PEM-SERVER-IP/pem/api/v6/probe/custom/export/ \
...
r = requests.post('https://PEM-SERVER-IP/pem/api/v6/probe/custom/export/', headers = headers)
...
fetch('https://PEM-SERVER-IP/pem/api/v6/probe/custom/export/',
{
  method: 'POST',
  body: inputBody,
  headers: headers
...
<span id="post__probe_custom_export_-parameters"></span>
...
| body         | body   | [CustomProbeExportData](schemas.mdx#tocs_customprobeexportdata) | true     | none                   |
...
<span id="post__probe_custom_export_-responses"></span>
...
<span id="post__probe_custom_export_-responseschema"></span>
...
<span id="edb-postgres-enterprise-manager-rest-apis-import-custom-probes"></span>
