...
title: Installing Postgres Enterprise Manager agent on RHEL 10 or OL 10 arm64
...
redirects:
  - /pem/10/installing_pem_agent/installing_on_linux/arm64/pem_agent_rhel10_arm
---
