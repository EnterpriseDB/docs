---
navTitle: RHEL 10
title: Installing Postgres Enterprise Manager agent on RHEL 10 ppc64le
...
redirects:
  - /pem/10/installing_pem_agent/installing_on_linux/ibm_power_ppc64le/pem_agent_rhel10_ppcle
---
