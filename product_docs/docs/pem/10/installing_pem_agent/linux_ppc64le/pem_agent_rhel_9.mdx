---
navTitle: RHEL 9
title: Installing Postgres Enterprise Manager agent on RHEL 9 ppc64le
...
redirects:
  - /pem/10/installing_pem_agent/installing_on_linux/ibm_power_ppc64le/pem_agent_rhel9_ppcle
---
