...
However, it will restart your primary database instance once. You should ensure that automatic failover is disabled to allow the primary to back up and avoid one of the replicas being promoted.
!!!
