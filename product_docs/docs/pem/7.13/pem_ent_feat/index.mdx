...
what's_new pem_query_tool pem_schema_diff_tool package_deployment performance_monitoring_and_management capacity_manager audit_manager log_manager sql_profiler tuning_wizard postgres_expert streaming_replication reports monitoring_failover_manager monitoring_xdb_replication_cluster performance_diagnostic reference conclusion
