...
<table><thead><tr class="header"><th>Component</th><th>PEM agent</th><th>Uninstaller name</th></tr></thead><tbody><tr class="odd"><td>uninstall-pemagent</td><td><blockquote><p>Default location</p></blockquote></td><td><blockquote><p>/usr/edb/pem/agent</p></blockquote></td></tr></tbody></table>
