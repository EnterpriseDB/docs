...
For information about the platforms and versions supported by PEM, visit the [EnterpriseDB website](https://www.enterprisedb.com/product-compatibility#pem).

**Please note**: PEM 7.16 is no longer supported on CentOS/RHEL/OEL 6.x platforms. It is strongly recommended that EDB products running on these platforms be migrated to a supported platform.
