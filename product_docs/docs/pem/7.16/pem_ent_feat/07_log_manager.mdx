...
<figure><img src="../images/lm_welcome.png" class="align-center" alt="The Log Manager welcome dialog" /><figcaption aria-hidden="true"><em>The Log Manager welcome dialog</em></figcaption></figure>

Click `Next` to continue to the `Server selection` dialog.

<figure><img src="../images/lm_server_select.png" class="align-center" alt="The Log Manager Server selection dialog" /><figcaption aria-hidden="true"><em>The Log Manager Server selection dialog</em></figcaption></figure>
...
<figure><img src="../images/lm_import_rotation.png" class="align-center" alt="The Log Manager Log configuration dialog" /><figcaption aria-hidden="true"><em>The Log Manager Log configuration dialog</em></figcaption></figure>
...
<figure><img src="../images/lm_where_to_log.png" class="align-center" alt="The Where to Log dialog" /><figcaption aria-hidden="true"><em>The Where to Log dialog</em></figcaption></figure>
...
<figure><img src="../images/lm_when_to_log.png" class="align-center" alt="The Log Manager When to Log dialog" /><figcaption aria-hidden="true"><em>The Log Manager When to Log dialog</em></figcaption></figure>
...
<figure><img src="../images/lm_what_to_log.png" class="align-center" alt="The Log Manager What to Log dialog" /><figcaption aria-hidden="true"><em>The Log Manager What to Log dialog</em></figcaption></figure>
...
<figure><img src="../images/lm_scheduling.png" class="align-center" alt="The Schedule Logging Changes dialog" /><figcaption aria-hidden="true"><em>The Schedule Logging Changes dialog</em></figcaption></figure>
...
<figure><img src="../images/server_log_analysis_filter.png" class="align-center" alt="Defining a Server Log filter" /><figcaption aria-hidden="true"><em>Defining a Server Log filter</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_welcome.png" class="align-center" alt="The Log Analysis Expert Welcome dialog" /><figcaption aria-hidden="true"><em>The Log Analysis Expert Welcome dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_select_analyzers.png" class="align-center" alt="The Analyzer selection dialog" /><figcaption aria-hidden="true"><em>The Analyzer selection dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_select_servers.png" class="align-center" alt="The Server selection dialog" /><figcaption aria-hidden="true"><em>The Server selection dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_report_options.png" class="align-center" alt="The Report options dialog" /><figcaption aria-hidden="true"><em>The Report options dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_report_finish.png" class="align-center" alt="The Report destination dialog" /><figcaption aria-hidden="true"><em>The Report destination dialog</em></figcaption></figure>
...
<figure><img src="../images/pem_log_analysis_expert_report.png" class="align-center" alt="The Postgres Log Analysis Expert Report" /><figcaption aria-hidden="true"><em>The Postgres Log Analysis Expert Report</em></figcaption></figure>
