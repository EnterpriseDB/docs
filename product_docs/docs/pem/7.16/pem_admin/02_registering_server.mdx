...
<figure><img src="../images/create_server_general_tab.png" class="align-center" alt="The General tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The General tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="../images/create_server_connection_tab.png" class="align-center" alt="The Connection tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The Connection tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="../images/create_server_ssl_tab.png" class="align-center" alt="The SSL tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The SSL tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="../images/create_server_ssh_tunnel_tab.png" class="align-center" alt="The SSH Tunnel tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The SSH Tunnel tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="../images/create_server_advanced_tab.png" class="align-center" alt="The Advanced tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The Advanced tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="../images/create_server_pem_agent_tab.png" class="align-center" alt="The PEM Agent tab of the Create – Server dialog" /><figcaption aria-hidden="true"><em>The PEM Agent tab of the Create – Server dialog</em></figcaption></figure>
...
<figure><img src="../images/auto_discovery.png" class="align-center" alt="The PEM Auto Discovery dialog" /><figcaption aria-hidden="true"><em>The PEM Auto Discovery dialog</em></figcaption></figure>
...
<figure><img src="../images/global_overview.png" class="align-center" alt="The registered server" /><figcaption aria-hidden="true"><em>The registered server</em></figcaption></figure>
