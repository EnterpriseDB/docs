...
SQL Profiler is officially supported only on the EnterpriseDB distributions of PostgreSQL version 9.4 or above and Advanced Server version 9.4 or above. The plugin is distributed via StackBuilder, or as operating system dependent packages in EnterpriseDB's yum repositories. The plugin is also distributed and installed with the Advanced Server installations.
...
installing\_the\_sql\_profiler\_plugin using\_sql\_profiler uninstalling\_sql\_profiler conclusion
