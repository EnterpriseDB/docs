...
If you're using PostgreSQL, you can invoke the graphical installer with Stack Builder. See [Using Stack Builder](/supported-open-source/postgresql/installing/using_stackbuilder/). 
...
1. Browse to a directory where you want ODBC to be installed, or leave the directory set to the default location. Select **Next**.
