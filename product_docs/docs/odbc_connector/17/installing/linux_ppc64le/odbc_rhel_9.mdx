---
navTitle: RHEL 9
title: Installing EDB ODBC Connector on RHEL 9 ppc64le
...
redirects:
  - /odbc_connector/17/03_installing_edb_odbc/01_installing_linux/ibm_power_ppc64le/odbc13_rhel9_ppcle
---
