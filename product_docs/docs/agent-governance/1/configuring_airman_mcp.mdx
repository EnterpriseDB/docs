...
1. Deploy a new Airman MCP instance with `AIRMAN_MCP_PURPOSE` set to the new purpose label and the database connection pointing at the new login user. Deployment examples are available in the [Governance-Project repository](https://github.com/EnterpriseDB/Governance-Project).
