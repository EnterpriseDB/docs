...
- Routes each request to the correct Hybrid Manager (HM) or Loki endpoint based on the instance type.
...
The viewer backend issues different Loki queries depending on what you're viewing.
