...
description: Transparent data encryption (TDE) is a feature for encrypting user data in EDB Postgres Advanced Server and EDB Postgres Extended Server databases.
hideVersion: true
navigation:
- "#Overview"
- about
...
- limitations
navRootedTo: /edb-postgres-ai/platforms-and-tools/security/
pdf: true
---
