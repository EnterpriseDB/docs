...
If you don't specify a command, TDE falls back on the environment variable `PGDATAKEYWRAPCMD`.
...
If you don't specify a command, TDE falls back on the environment variable `PGDATAKEYUNWRAPCMD`.
