...
These options to [pg_upgrade](https://www.postgresql.org/docs/15/pgupgrade.html) help with upgrading encrypted clusters.
...
See [Enabling TDE with pg_upgrade](/tde/latest/enabling_tde_pg_upgrade/) for an example of how to use `pg_upgrade` for TDE enablement.
