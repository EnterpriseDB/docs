...
See the [Using](/partner_docs/ThalesCipherTrustManager/05-UsingThalesCipherTrustManager/) section of the [Implementing Thales CipherTrust Manager](/partner_docs/ThalesCipherTrustManager/) documentation for instructions how to wrap the data encryption key with a key from the Thales key store.
