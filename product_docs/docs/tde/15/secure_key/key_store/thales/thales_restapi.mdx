...
1.  Set the wrapping and unwrapping commands that will perform encryption and decryption. To set them correctly, you need: 
    ...
    - The key `id`, which you can find in the output of the key creation command or look up in the Thales CipherTrust Manager portal.
    ...
    export PGDATAKEYUNWRAPCMD='python3 /usr/edb/tde/rest/client/edb_tde_crypto.py decrypt %p  24360eab449640bebdc0b16ec1d65ef61beb363481f34638b82918064ab27ce2 | jq -r '.plaintext' | base64 -d'
    ```
