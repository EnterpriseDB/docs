...
title: CREATE RULE
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_RULE.md
...
`CREATE RULE` is a WarehousePG extension, as is the entire query rewrite system.
