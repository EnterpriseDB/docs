...
title: gplogfilter
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/utility_guide/reference/gplogfilter.md
...
/usr/edb/whpg7/greenplum_path.sh ; gplogfilter -f 
