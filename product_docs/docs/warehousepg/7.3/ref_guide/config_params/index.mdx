...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/config_params/index.md
redirects:
  - guc_config
...
There are many WarehousePG server configuration parameters that affect the behavior of the WarehousePG cluster. Many of these configuration parameters have the same names, settings, and behaviors as in a regular PostgreSQL database system.
...
-   [Parameter Categories](guc_category-list.mdx) organizes parameters by functionality.
-   [Configuration Parameters](guc-list.mdx) lists the parameter descriptions in alphabetic order.

<a id="topic_vsn_22l_z4"></a>
...
<a id="topic_cyz_p2l_z4"></a>

## Setting Parameters

> **Note** WarehousePG does not support using the `ALTER SYSTEM` command to set server configuration parameters.
...
| restart or reload    | When changing parameter values in the postgresql.conf file(s), some require a *restart* of WarehousePG for the change to take effect. Other parameter values can be refreshed by just reloading the server configuration file (using `gpstop -u`), and do not require stopping the system.                                                                                                                                                                                                                                                                                                                                                                                           |
