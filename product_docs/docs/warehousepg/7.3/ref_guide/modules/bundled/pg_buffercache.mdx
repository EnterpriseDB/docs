...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/ref_guide/modules/bundled/pg_buffercache.md
redirects:
  - ../pg_buffercache
description: >-
  The pgbuffercache module provides five views for obtaining cluster-wide shared
  buffer metrics:.
