...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/ref_guide/modules/bundled/tsm_system_time.md
redirects:
  - ../tsm_system_time
description: >-
  The tsmsystemtime module implements the SYSTEMTIME table sampling method. This
