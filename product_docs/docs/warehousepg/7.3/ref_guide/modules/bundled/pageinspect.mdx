...
title: pageinspect
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/ref_guide/modules/bundled/pageinspect.md
redirects:
  - ../pageinspect
description: >-
  The pageinspect module provides functions for low level inspection of the
  contents of database pages. pageinspect is available only to WarehousePG
  superusers.
