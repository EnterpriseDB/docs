...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/ref_guide/modules/bundled/pg_stat_statements.md
redirects:
  - ../pg_stat_statements
description: >-
  pgstatstatements is a core PostgreSQL module that provides a means to track
  planning and execution statistics of all SQL statements executed by the
  server.
