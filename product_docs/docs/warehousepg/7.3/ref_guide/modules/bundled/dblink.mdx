...
title: dblink
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/ref_guide/modules/bundled/dblink.md
redirects:
  - ../dblink
description: >-
...
Refer to [SSL Client Authentication](../../../security_guide/authentication.mdx#ssl_postgresql) for information about configuring WarehousePG to use SSL.
