...
The `whpg-utl-raw` extension extends [orafce](../orafce_ref.mdx) with additional Oracle compatibility features for WarehousePG (WHPG). It implements the `UTL_RAW` package and the `RAW` data type.
