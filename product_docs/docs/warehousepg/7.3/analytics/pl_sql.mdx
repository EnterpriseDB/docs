...
A PL/pgSQL procedure is similar to a PL/pgSQL function. Refer to [User-Defined Procedures](../admin_guide/query/functions-operators.mdx#userproc) for more information on procedures in WarehousePG and how they differ from functions.
