...
A PL/Python procedure is similar to a PL/Python function. Refer to [User-Defined Procedures](../admin_guide/query/functions-operators.mdx#topic28a) for more information on procedures in WarehousePG and how they differ from functions.
