...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/install_guide/env_var.md
...
-   **[Required Environment Variables](env_var.mdx)**  

-   **[Optional Environment Variables](env_var.mdx)**  
...
**Parent topic:** [WarehousePG Environment Variables](env_var.mdx)
