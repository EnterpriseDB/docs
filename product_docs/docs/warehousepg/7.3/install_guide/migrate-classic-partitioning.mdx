...
-   [pg_partition_tree()](../admin_guide/ddl/ddl-partition.mdx#topic76)
-   [pg_partition_ancestors()](../admin_guide/ddl/ddl-partition.mdx#topic76)
-   [pg_partition_root()](../admin_guide/ddl/ddl-partition.mdx#topic76)
