...
title: >-
  Migrating Partition Maintenance Scripts to the New WarehousePG 7 Partitioning
  Catalogs
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/install_guide/migrate-classic-partitioning.md
...
-   [gp_partition_template](../ref_guide/system_catalogs/system_catalogs_definitions/gp_partition_template.mdx)
-   [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx)
-   [pg_partition_tree()](../admin_guide/ddl/ddl-partition#topic76)
-   [pg_partition_ancestors()](../admin_guide/ddl/ddl-partition#topic76)
-   [pg_partition_root()](../admin_guide/ddl/ddl-partition#topic76)
...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| schemaname               | The name of the schema in which the root partitioned table resides.                                                | Use `pg_partition_root()` to obtain the root object identifier, and then query [pg_namespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_namespace.mdx).                                                                                                                                                        |
| tablename                | The name of the root partitioned table.                                                                            | Use `pg_partition_root()` to obtain the root object identifier, and then query [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.mdx).                                                                                                                                                                |
| partitionschemaname      | The namespace of the leaf partition.                                                                               | [pg_namespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_namespace.mdx)                                                                                                                                                                                                                                        |
| partitiontablename       | The table name of the leaf partition (the table name you use to access the partition directly).                    | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.mdx)                                                                                                                                                                                                                                                |
...
| parentpartitiontablename | The table name of the parent table of this partition.                                                              | Get the parent object identifier via [pg_inherits](../ref_guide/system_catalogs/system_catalogs_definitions/pg_inherits.mdx) and then query [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.mdx).                                                                                                   |
| parentpartitionname      | The partition name of the parent table of this partition.                                                          | N/A                                                                                                                                                                                                                                                                                                                              |
| partitiontype            | The type of partition (range or list).                                                                             | Get the parent object identifier via [pg_inherits](../ref_guide/system_catalogs/system_catalogs_definitions/pg_inherits.mdx) and then query [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx).                                                                           |
| partitionlevel           | The level of this partition in the partition hierarchy.                                                            | Get the level from `pg_partition_tree()` using the root object identifier.<br />Note that the level differs in WarehousePG 6 and 7. In WarehousePG 6, the level of the immediate child of a partitioned table is 0. In WarehousePG 7, the level of the partitioned table itself is 0, and the level of its immediate child is 1. |
...
| parenttablespace         | The tablespace of the parent table of this partition.                                                              | Get the parent object identifier via [pg_inherits](../ref_guide/system_catalogs/system_catalogs_definitions/pg_inherits.mdx) and then query [pg_tablespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_tablespace.mdx).                                                                                         |
| partitiontablespace      | The tablespace of this partition.                                                                                  | [pg_tablespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_tablespace.mdx)                                                                                                                                                                                                                                      |

<a id="pgparts_retrieve"></a>
...
| Column Name               | WarehousePG 6 Description                                                                                                                   | WarehousePG 7 Equivalent                                                                                                                                                             |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| schemaname                | The name of the schema in which the partitioned table resides.                                                                              | Get the root partitioned table object identifier via `pg_partition_root()` and then query [pg_namespace](../ref_guide/system_catalogs/system_catalogs_definitions/pg_namespace.mdx). |
| tablename                 | The table name of the partitioned table.                                                                                                    | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.mdx)                                                                                                    |
| columnname                | The name of the partition key column.                                                                                                       | [pg_attribute](../ref_guide/system_catalogs/system_catalogs_definitions/pg_attribute.mdx)                                                                                            |
...
| parchildrelid     | The table identifier of the partition.                                                                                                                                                                                                                                                                                            | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.mdx)                                 |
| parparentrule     | The row identifier of the rule associated with the parent table of this partition.                                                                                                                                                                                                                                                | N/A (removed object)                                                                                              |
| parname           | The given name of this partition.                                                                                                                                                                                                                                                                                                 | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.mdx)                                 |
...
| parreloptions     | An array describing the storage characteristics of the particular partition.                                                                                                                                                                                                                                                      | [pg_class](../ref_guide/system_catalogs/system_catalogs_definitions/pg_class.mdx).reloptions                      |
...
The majority of this information resides in [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx) in WarehousePG 7.

| Column Name   | WarehousePG 6 Description                                                                                                                           | WarehousePG 7 Equivalent                                                                                                                                                                                                                          |
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| parrelid      | The object identifier of the table.                                                                                                                 | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx).partrelid                                                                                                                               |
| parkind       | The partition type - R for range or L for list.                                                                                                     | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx).partstrat                                                                                                                               |
| parlevel      | The partition level of this row: 0 for the top-level parent table, 1 for the first level under the parent table, 2 for the second level, and so on. | Cross-check [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx) and `pg_partition_root()/pg_partition_tree()`, similar to how you retrieve [pg_partitions](#pg_partitions).partitionlevel.  |
| paristemplate | Whether or not this row represents a subpartition template definition (`true`) or an actual partitioning level (`false`).                           | Cross-check [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx).partrelid with [gp_partition_template](../ref_guide/system_catalogs/system_catalogs_definitions/gp_partition_template.mdx). |
| parnatts      | The number of attributes that define this level.                                                                                                    | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx).partnatts                                                                                                                               |
| paratts       | An array of the attribute numbers (as in `pg_attribute.attnum`) of the attributes that participate in defining this level.                          | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx).partattrs                                                                                                                               |
| parclass      | The operator class identifier(s) of the partition columns.                                                                                          | [pg_partitioned_table](../ref_guide/system_catalogs/system_catalogs_definitions/pg_partitioned_table.mdx).partclass                                                                                                                               |

<a id="pg_partition_templates"></a>
...
<a id="pg_partition_encoding"></a>

## pg_partition_encoding

The WarehousePG 6 `pg_partition_encoding` table describes the available column compression options for a subpartition template. This information is stored in [gp_partition_template](../ref_guide/system_catalogs/system_catalogs_definitions/gp_partition_template.mdx) in WarehousePG 7.
...
<a id="pg_stat_partition_operations"></a>
