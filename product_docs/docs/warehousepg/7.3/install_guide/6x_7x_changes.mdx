...
-   Changes the partitioning system catalogs. See [Changes in Partitioning](../admin_guide/ddl/about-part-changes.mdx) and [Migrating Partition Maintenance Scripts to the New WarehousePG 7 Partitioning Catalogs](migrate-classic-partitioning.mdx).

-   Makes changes to external tables. See [Changes to External Tables](../admin_guide/external/about_exttab_7.mdx).

-   Makes changes to resource groups. See [Changes to Resource Groups](../admin_guide/about-resgroups-changes.mdx).
