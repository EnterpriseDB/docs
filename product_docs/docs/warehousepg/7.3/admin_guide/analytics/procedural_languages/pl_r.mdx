...
WarehousePG provides a collection of data science-related R packages that can be used with the WarehousePG PL/R language. For information about the packages, see [Data Science Package for R](../../../install_guide/data_sci_pkgs/install_r_dslib.mdx).
