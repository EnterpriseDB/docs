...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/analytics/procedural_languages/pl_sql.md
...
A PL/pgSQL function’s volatility classification has implications on how WarehousePG caches plans that reference the function. Refer to [Function Volatility and Plan Caching](../../query/functions-operators.mdx#userfunc1) in the *WarehousePG Administrator Guide* for information on plan caching considerations for WarehousePG function volatility categories.
...
A PL/pgSQL procedure is similar to a PL/pgSQL function. Refer to [User-Defined Procedures](../../query/functions-operators.mdx#userproc) for more information on procedures in WarehousePG and how they differ from functions.
...
For a summary of built-in WarehousePG functions, see [Summary of Built-in Functions](../../../ref_guide/function-summary.mdx) in the *WarehousePG Reference Guide*. For information about using WarehousePG functions see "SQL: Querying Data" in the *WarehousePG Administrator Guide*
