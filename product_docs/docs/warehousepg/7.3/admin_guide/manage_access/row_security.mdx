...
You create policies using the [CREATE POLICY](../../ref_guide/sql_commands/CREATE_POLICY.mdx) command, alter policies using the [ALTER POLICY](../../ref_guide/sql_commands/ALTER_POLICY.mdx) command, and drop policies using the [DROP POLICY](../../ref_guide/sql_commands/DROP_POLICY.mdx) command. To enable and disable row security for a given table, use the [ALTER TABLE](../../ref_guide/sql_commands/ALTER_TABLE.mdx) command.
...
For additional details see [CREATE POLICY](../../ref_guide/sql_commands/CREATE_POLICY.mdx) and [ALTER TABLE](../../ref_guide/sql_commands/ALTER_TABLE.mdx).

<a id="views"></a>

## About Row-Level Security for Views
