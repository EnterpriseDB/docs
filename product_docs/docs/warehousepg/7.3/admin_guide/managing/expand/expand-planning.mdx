...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/expand/expand-planning.md
...
For information about WarehousePG interconnect proxies, see [Configuring Proxies for the WarehousePG Interconnect](../../managing/proxy-ic.mdx).

**Parent topic:** [Expanding a WarehousePG cluster](../expand)
