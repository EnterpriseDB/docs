...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/ha/detecting-a-failed-segment.md
...
**Parent topic:** [Enabling High Availability and Data Consistency Features](../ha)
