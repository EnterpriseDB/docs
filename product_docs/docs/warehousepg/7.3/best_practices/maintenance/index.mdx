...
navigation:
  ...
  - logfiles
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/best_practices/maintenance/index.md
...
-   **[Updating Statistics with ANALYZE](analyze.mdx)**  

-   **[Managing Bloat in a Database](bloat.mdx)**  

-   **[Monitoring WarehousePG Log Files](logfiles.mdx)**  

**Parent topic:** [WarehousePG Best Practices](./)

<a id="topic_izw_bwb_s4"></a>
