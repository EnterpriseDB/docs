...
title: pg_restore
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/ref_guide/utility_guide/reference/pg_restore.md
...
See also the [pg_dump](pg_dump.mdx) documentation for details on limitations of `pg_dump`.
...
[pg_dump](pg_dump.mdx), [pg_dumpall](pg_dumpall.mdx), [psql](psql.mdx)
