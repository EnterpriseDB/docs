...
title: pg_dumpall
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/ref_guide/utility_guide/reference/pg_dumpall.md
...
Check [pg_dump](pg_dump.mdx) for details on possible error conditions.
