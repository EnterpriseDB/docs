...
title: pgvector
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/modules/pgvector/index.md
redirects:
  - pgvector
...
Use [partitioning](../../../admin_guide/ddl/ddl-partition) for approximate search on many different values of the `WHERE` columns:
...
You can use `pgvector` together with [full-text search](../../../admin_guide/query/textsearch) for a hybrid search:
...
Use [EXPLAIN ANALYZE](../../sql_commands/EXPLAIN.mdx) to debug performance:
