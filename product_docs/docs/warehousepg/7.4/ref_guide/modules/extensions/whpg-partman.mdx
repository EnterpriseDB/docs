...
The WarehousePG `whpg-partman` module is equivalent to version 4.7.4 of the [`pg_partman`](https://github.com/pgpartman/pg_partman) extension used with PostgreSQL. See [Limitations](#limitations) before you use `whpg-partman` on WarehousePG.
