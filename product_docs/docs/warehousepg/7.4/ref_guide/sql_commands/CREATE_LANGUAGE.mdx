...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_LANGUAGE.md
...
Use [DROP LANGUAGE](DROP_LANGUAGE.mdx) to drop procedural languages.

The system catalog [pg_language](../system_catalogs/system_catalogs_definitions/pg_language.mdx) records information about the currently installed languages. Also, the [psql](../utility_guide/reference/psql.mdx) command `\dL` lists the installed languages.
...
[ALTER LANGUAGE](ALTER_LANGUAGE.mdx), [CREATE EXTENSION](CREATE_EXTENSION.mdx), [CREATE FUNCTION](CREATE_FUNCTION.mdx), [DROP LANGUAGE](DROP_LANGUAGE.mdx), [GRANT](GRANT.mdx), [DO](DO.mdx)
