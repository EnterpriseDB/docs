...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_STATISTICS.md
...
table_name
The name (optionally schema-qualified) of the table containing the column(s) on which the statistics are computed; see [ANALYZE](ANALYZE.mdx) for an explanation of inheritance and partition handling.
...
[ALTER STATISTICS](ALTER_STATISTICS.mdx), [DROP STATISTICS](DROP_STATISTICS.mdx)
