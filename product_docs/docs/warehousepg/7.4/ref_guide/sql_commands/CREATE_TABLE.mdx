...
> **Note** WarehousePG supports both *classic* and *modern* partitioning syntaxes. Refer to [Choosing the Partitioning Syntax](../../admin_guide/ddl/ddl-partition.mdx#choose) for more information, including guidance on selecting the appropriate syntax for a partitioned table.
...
data_type
The data type of the column. This may include array specifiers. For more information on the data types supported by WarehousePG, refer to the [Data Types](../data_types.mdx) documentation.
...
Refer to [Partitioning Large Tables](../../admin_guide/ddl/ddl-partition.mdx) for further discussion on table partitioning.
