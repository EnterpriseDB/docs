...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/install_guide/platform-requirements.md
...
> **Note** If you use endpoint security software on your WarehousePG hosts, it may affect your database performance and stability. See [About Endpoint Security Sofware](../security_guide#endpoint_security) for more information.
...
<tr class="row">
<td class="entry nocellnorowborder" style="vertical-align:top;" headers="d78288e683"><a class="xref" href="data_sci_pkgs/install_python_dsmod.mdx">Python 3.11 Data Science Module Package</a></td>
