...
WarehousePG provides a collection of data science-related R packages that can be used with the WarehousePG PL/R language. For information about the packages, see [Data Science Package for R](/warehousepg/current/install_guide/additional_modules/external_components/install_r_dslib).
