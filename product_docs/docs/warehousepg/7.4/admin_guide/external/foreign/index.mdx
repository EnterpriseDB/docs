...
The WarehousePG distribution includes the [postgres_fdw](../../../ref_guide/modules/postgres_fdw.mdx) foreign data wrapper. 
You can also download and install the EDB-provided module [whpg_fdw](../../../ref_guide/modules/edb_modules/whpg_fdw.mdx).
