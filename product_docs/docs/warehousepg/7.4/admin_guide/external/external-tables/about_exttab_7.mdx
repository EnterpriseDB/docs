...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/external/about_exttab_7.md
...
**Parent topic:** [Accessing External Data with External Tables](../external-tables.mdx)
