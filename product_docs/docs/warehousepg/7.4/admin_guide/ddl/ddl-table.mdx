...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/ddl/ddl-table.md
...
See also [CREATE TABLE ... CONSTRAINT ... EXCLUDE](../../ref_guide/sql_commands/CREATE_TABLE.mdx) for details.
