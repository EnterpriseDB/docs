...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/ddl/ddl-partition.md
...
Partitioning information is stored in the [pg_partitioned_table](../../../ref_guide/system_catalogs/pg_partitioned_table.mdx) system catalog, and in additional fields in the [pg_class](../../../ref_guide/system_catalogs/pg_class.mdx) (`relispartition` and `relpartbound`) catalog.
...
For a partitioned table that you create using the classic syntax, the [gp_partition_template](../../../ref_guide/system_catalogs/gp_partition_template.mdx) system catalog table describes the relationship between the partitioned table and the sub-partition template defined at each level in the partition hierarchy.
