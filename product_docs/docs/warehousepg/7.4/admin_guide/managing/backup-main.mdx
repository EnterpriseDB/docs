...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/admin_guide/managing/backup-main.md
...
`gpbackup` and `gprestore` are the recommended WarehousePG backup and restore utilities, provided as a separate download. For documentation, see [WarehousePG Backup and Restore](../../../../whpg-backup/).
...
![Non-parallel Restore Using Parallel Backup Files](../../images/nonparallel_backup_restore.png "Non-parallel Restore Using Parallel Backup Files")
