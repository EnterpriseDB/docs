...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/security-guide/Authenticate.md
editTarget: originalFilePath

---

<a id="topic_n5w_gtd_jr"></a>
...
<a id="ul_kpg_sgq_kr"></a>

-   [Allowing Connections to WarehousePG](#topic_ln1_ptd_jr)
-   [Editing the pg_hba.conf File](#topic_xwr_rvd_jr)
...
<a id="topic_ln1_ptd_jr">

</a>

## Allowing Connections to WarehousePG

Client access and authentication is controlled by a configuration file named `pg_hba.conf` (the standard PostgreSQL host-based authentication file). For detailed information about this file, see [The pg_hba.conf File](https://www.postgresql.org/docs/9.4/auth-pg-hba-conf.html) in the PostgreSQL documentation.
...
<a id="ol_krz_zvd_jr"></a><a id="ul_zsk_kwd_jr"></a>
...
-   password
    ...
    When using the WarehousePG `SHA-256` password hashing algorithm, the `password` authentication method must be specifed, and SSL-secured client connections are recommended.

<a id="basic_auth_example">
...
<a id="ul_bzs_b22_jr"></a><a id="ul_gzs_b22_jr"></a>
...
The default location for the following SSL server files is the WarehousePG coordinator data directory (`$MASTER_DATA_DIRECTORY`):
...
2.  On the coordinator host, edit `$MASTER_DATA_DIRECTORY/postgresql.conf` and change the following two parameters:
    <a id="ul_e5k_vk2_jr"></a><a id="ul_iwf_1l2_jr"></a>
