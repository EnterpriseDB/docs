...
title: Auditing
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/security-guide/Auditing.md
editTarget: originalFilePath

---

<a id="topic_ufw_zn2_jr"></a>
...
Every database instance in WarehousePG (coordinator and segments) is a running PostgreSQL database server with its own server log file. Daily log files are created in the `pg_log` directory of the coordinator and each segment data directory.
