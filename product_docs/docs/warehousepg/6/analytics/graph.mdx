...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/analytics/graph.html.md
...
To use the MADlib graph modules, install the version of MADlib corresponding to your WarehousePG version. To download the software, access the VMware Tanzu Network. For WarehousePG 6.x, see [Installing MADlib](madlib.mdx#topic3).
