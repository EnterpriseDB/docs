...
title: createuser
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/utility_guide/ref/createuser.html.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pb141029"></a>
...
-   \--replication
    ...
    The new user will have the `REPLICATION` privilege, which is described more fully in the documentation for [CREATE ROLE](../../ref_guide/sql_commands/CREATE_ROLE.mdx).

-   \--no-replication

    The new user will not have the `REPLICATION` privilege, which is described more fully in the documentation for [CREATE ROLE](../../ref_guide/sql_commands/CREATE_ROLE.mdx).
...
[CREATE ROLE](../../ref_guide/sql_commands/CREATE_ROLE.mdx), [dropuser](dropuser.mdx)
