...
title: pg_dump
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/utility_guide/ref/pg_dump.html.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="os137116"></a>

<a id="client_util_desc"></a>
...
-   \-j njobs | --jobs=njobs
    ...
    `pg_dump` will open njobs + 1 connections to the database, so make sure your [max_connections](../../ref_guide/config_params/guc-list.mdx) setting is high enough to accommodate all connections.
