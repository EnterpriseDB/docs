...
title: gprecoverseg
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/utility_guide/ref/gprecoverseg.html.md
...
-   \-i recover_config_file
    ...
    For recovery to a new location, enter two groups of fields separated by a space in the line. The required space is indicated by \\<space></space>. Do not add additional spaces.
