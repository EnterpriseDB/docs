...
title: createdb
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/utility_guide/ref/createdb.html.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="oz137116"></a>
...
`createdb` is a wrapper around the SQL command [CREATE DATABASE](../../ref_guide/sql_commands/CREATE_DATABASE.mdx) .
...
The options `-D`, `-l`, `-E`, `-O`, and `-T` correspond to options of the underlying SQL command `CREATE DATABASE`; see [CREATE DATABASE](../../ref_guide/sql_commands/CREATE_DATABASE.mdx) in the *WarehousePG Reference Guide* for more information about them.
...
[CREATE DATABASE](../../ref_guide/sql_commands/CREATE_DATABASE.mdx), [dropdb](dropdb.mdx)
