...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/access_db/topics/g-database-application-interfaces.html.md
...
| --------------- | ---------------------------------- | --------------------------------------------------- |
| ODBC            | WarehousePG DataDirect ODBC Driver | <https://network.pivotal.io/products/pivotal-gpdb>. |
| ODBC            | psqlODBC                           | <https://odbc.postgresql.org/>                      |
| JDBC            | WarehousePG DataDirect JDBC Driver | <https://network.pivotal.io/products/pivotal-gpdb>  |
