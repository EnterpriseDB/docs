...
Refer to the [pgbouncer.ini](../../utility_guide/ref/pgbouncer-ini.mdx) reference page for the PgBouncer configuration file format and the list of configuration properties it supports.
...
1.  Create a PgBouncer configuration file. For example, add the following text to a file named `pgbouncer.ini`:
    ...
    The file lists databases and their connection details. The file also configures the PgBouncer instance. Refer to the [pgbouncer.ini](../../utility_guide/ref/pgbouncer-ini.mdx) reference page for information about the format and content of a PgBouncer configuration file.
...
3.  Launch `pgbouncer`:
    ...
    The `-d` option runs PgBouncer as a background (daemon) process. Refer to the [pgbouncer](../../utility_guide/ref/pgbouncer.mdx) reference page for the `pgbouncer` command syntax and options.
...
For complete documentation of PgBouncer Administration Console commands, refer to the [pgbouncer-admin](../../utility_guide/ref/pgbouncer-admin.mdx) command reference.
