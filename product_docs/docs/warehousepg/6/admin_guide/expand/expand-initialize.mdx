...
After segment initialization is complete, [redistribute the tables](expand-redistribute.mdx#expand-redistribute) to balance existing data over the new segments.
