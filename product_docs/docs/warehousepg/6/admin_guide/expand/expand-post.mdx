...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/expand/expand-post.html.md
...
-   Log into the WarehousePG Master and run the following commands:
