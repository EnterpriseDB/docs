...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/query/query-piv-uniform-part-tbl.md
...
**Parent topic:** [About GPORCA](query-piv-optimizer)

<a id="topic_zn1_m3m_ss"></a>
