...
Refer to [gpmapreduce](../../utility_guide/ref/gpmapreduce.mdx) for details about running the WarehousePG MapReduce program.
...
Refer to [gpmapreduce.yaml](../../utility_guide/ref/gpmapreduce-yaml.mdx) for detailed information about the WarehousePG MapReduce configuration file format and the keys and values supported.
