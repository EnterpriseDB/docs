...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/query/textsearch/testing.md
...
The word `The` was recognized by the `english_ispell` dictionary as a stop word ([Stop Words](dictionaries.mdx#stop-words)) and will not be indexed. The spaces are discarded too, since the configuration provides no dictionaries at all for them.
