...
<a id="topic_e5t_whm_kbb"></a>

## About WarehousePG Performance Monitoring

WarehousePG WarehousePG Command Center is an optional web-based performance monitoring and management tool for WarehousePG. Administrators can install Command Center separately from WarehousePG.
