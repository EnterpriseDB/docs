...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/intro/about_ha.md
...
This diagram shows how table data is distributed across segments when spread mirroring is configured.
