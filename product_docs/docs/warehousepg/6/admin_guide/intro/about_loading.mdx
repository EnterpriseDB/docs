...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/intro/about_loading.md
...
![External Tables Using WarehousePG Parallel File Server (gpfdist)](../../images/external_tables.png "External Tables Using WarehousePG Parallel File Server (gpfdist)")
