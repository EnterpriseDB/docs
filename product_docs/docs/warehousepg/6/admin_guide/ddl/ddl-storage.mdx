...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/ddl/ddl-storage.md
...
See [Splitting a Partition](ddl-partition) to learn how to change the storage model of a partitioned table.
