...
navigation:
  - devel-fdw
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/admin_guide/external/foreign/index.md
...
The WarehousePG distribution includes the [postgres_fdw](/supported-open-source/warehousepg/extensions/bundled/postgres_fdw.mdx) foreign data wrapper.
