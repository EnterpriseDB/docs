...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/external/g-external-tables.html.md
...
To create an external table definition, you specify the format of your input files and the location of your external data sources. For information about input file formats, see [Formatting Data Files](../load/formatting-data-files.mdx).
...
-   **[Examples for Creating External Tables](creating-external-tables---examples.mdx)**  
