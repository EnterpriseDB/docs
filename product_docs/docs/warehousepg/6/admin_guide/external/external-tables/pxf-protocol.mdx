...
title: pxf:// Protocol
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/external/external-tables/pxf-protocol.md
...
For detailed information about configuring and using PXF and the `pxf` protocol, refer to [Accessing External Data with PXF](../pxf-overview.mdx).
