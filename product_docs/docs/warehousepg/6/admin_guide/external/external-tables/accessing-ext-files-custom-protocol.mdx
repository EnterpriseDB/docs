...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/external/g-accessing-ext-files-custom-protocol.html.md
...
See [Example Custom Data Access Protocol](../load/example-custom-data-access-protocol.mdx) for an example.
