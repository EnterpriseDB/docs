...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/load/topics/g-disabling-execute-for-web-or-writable-external-tables.html.md
...
**Parent topic:** [Defining a Command-Based Writable External Web Table](defining-a-command-based-writable-external-web-table.mdx)
