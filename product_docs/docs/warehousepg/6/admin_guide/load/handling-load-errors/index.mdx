...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/load/handling-load-errors/index.md
...
-   **[Define an External Table with Single Row Error Isolation](define-an-external-table-with-single-row-error-isolation.mdx)**  

-   **[Capture Row Formatting Errors and Declare a Reject Limit](create-an-error-table-and-declare-a-reject-limit.mdx)**  

-   **[Viewing Bad Rows in the Error Log](viewing-bad-rows-in-the-error-table-or-error-log.mdx)**  

-   **[Moving Data between Tables](moving-data-between-tables.mdx)**  
