...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/load/topics/g-using-a-custom-protocol.html.md
...
1.  Author the send, receive, and (optionally) validator functions in C, with a predefined API. These functions are compiled and registered with the WarehousePG. For an example custom protocol, see [Example Custom Data Access Protocol](example-custom-data-access-protocol.mdx).
...
**Parent topic:** [Loading and Writing Non-HDFS Custom Data](loading-and-writing-non-hdfs-custom-data.mdx)
