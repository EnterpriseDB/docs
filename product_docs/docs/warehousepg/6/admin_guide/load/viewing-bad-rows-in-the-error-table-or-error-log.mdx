...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/load/topics/g-viewing-bad-rows-in-the-error-table-or-error-log.html.md
...
**Parent topic:** [Handling Load Errors](handling-load-errors.mdx)
