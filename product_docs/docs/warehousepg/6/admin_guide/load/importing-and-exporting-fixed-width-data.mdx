...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/admin_guide/load/topics/g-importing-and-exporting-fixed-width-data.html.md
...
**Parent topic:** [Using a Custom Format](using-a-custom-format.mdx)
