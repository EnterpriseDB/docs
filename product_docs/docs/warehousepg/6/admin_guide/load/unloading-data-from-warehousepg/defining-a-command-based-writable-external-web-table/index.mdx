...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/load/unloading-data-from-warehousepg/defining-a-command-based-writable-external-web-table/index.md
...
| $GP_MASTER_HOST   | The host name of the WarehousePG coordinator host from which the external table statement was dispatched.                   |
| $GP_MASTER_PORT   | The port number of the WarehousePG coordinator instance from which the external table statement was dispatched.             |
