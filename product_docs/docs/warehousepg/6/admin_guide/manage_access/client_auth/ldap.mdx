...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/manage_access/client_auth/ldap.md
...
4.  As the gpadmin user, edit `/usr/edb/whpg6/greenplum_path.sh` and add the following line.
