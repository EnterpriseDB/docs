...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/manage_access/client_auth/index.md
...
<table class="table" id="ip141709"><caption><span class="table--title-label">Table 1. </span><span class="title">pg_hba.conf Fields</span></caption><colgroup><col style="width:25%" /><col style="width:75%" /></colgroup><thead class="thead">
            <tr class="row">
              <th class="entry" id="ip141709__entry__1">Field</th>
              <th class="entry" id="ip141709__entry__2">Description</th>
            </tr>
            ...
            <tr class="row">
              ...
              <td class="entry" headers="topic2__ip141709__entry__2">Specifies the authentication method to use when connecting.
                WarehousePG supports the <a class="xref" href="https://www.postgresql.org/docs/9.4/auth-methods.html" target="_blank" rel="external noopener">authentication methods</a> supported by PostgreSQL 9.4.</td>
            </tr>
          </tbody></table>
