...
-   The catalog view [gp_stat_replication](../../ref_guide/system_catalogs/gp_stat_replication.mdx) contains replication statistics of the `walsender` processes that are used for WarehousePG coordinator and segment mirroring.
