...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/managing/ha/enabling-mirroring-in-warehousepg/enabling-segment-mirroring.md
...
2.  Use [gpssh-exkeys](../../../../ref_guide/utility_guide/reference/gpssh-exkeys.mdx) to ensure that the segment hosts can SSH and SCP to each other without a password prompt.
