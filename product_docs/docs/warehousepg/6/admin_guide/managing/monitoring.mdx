...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/managing/monitoring.md
redirects:
  - monitoring
...
<td class="entry" headers="topic_idx_smh_rp__table_td5_5mh_rp__entry__1">Install WarehousePG minor releases<span class="ph">, for example
                                            6.21.<em class="ph i">x</em></span>.<p class="p">Recommended frequency:
