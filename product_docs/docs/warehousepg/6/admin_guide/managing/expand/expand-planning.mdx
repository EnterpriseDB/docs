...
title: Planning WarehousePG System Expansion
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/admin_guide/managing/expand/expand-planning.md
...
<table class="table frame-all" id="table_pvq_yzl_2r"><caption><span class="table--title-label">Table 1. </span><span class="title">WarehousePG cluster Expansion Checklist</span></caption><colgroup><col style="width:11.173184357541901%" /><col style="width:88.82681564245812%" /></colgroup><tbody class="tbody">
              <tr class="row">
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_gr2_s1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_ryl_s1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_e2s_s1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
                <td class="entry">Perform a complete schema dump.</td>
              </tr>
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_yq5_s1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
                <td class="entry">Install WarehousePG binaries on new hosts. </td>
              </tr>
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_vxw_s1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
                <td class="entry">Copy SSH keys to the new hosts (<code class="ph codeph">gpssh-exkeys</code>).</td>
              </tr>
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_qkb_t1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_ojd_t1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_wch_t1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_q3q_t1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_ct3_t1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
                <td class="entry">Prepare an expansion input file (<code class="ph codeph">gpexpand</code>). </td>
              </tr>
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_rcs_t1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_jzy_t1m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_aq1_51m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_xjc_51m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
                <td class="entry">Remove expansion schema (<code class="ph codeph">gpexpand -c</code>).</td>
              </tr>
              <tr class="row">
                <td class="entry">
                  <img class="image" id="image_sk2_51m_2r" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" />
                </td>
              ...
              <tr class="row">
                <td class="entry"><img class="image" id="image_ogk_mj4_lhb" src="../../../images/blue_checkbox.png" alt="Checkbox" width="29" height="28" /></td>
