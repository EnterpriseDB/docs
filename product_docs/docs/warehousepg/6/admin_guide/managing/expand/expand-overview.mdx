...
-   The last step of the software phase is redistributing table data. Using the expansion control tables in the *gpexpand* schema as a guide, tables are redistributed. For each table:
    ...
    -   The [gpexand](../../../utility_guide/ref/gpexpand.mdx) utility redistributes the table data, across all of the servers, old and new, according to the distribution policy.
...
For information about the [gpexpand](../../../utility_guide/ref/gpexpand.mdx) utility and the other utilities that are used for system expansion, see the *WarehousePG Utility Guide*.
