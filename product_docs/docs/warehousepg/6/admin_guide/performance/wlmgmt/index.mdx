...
navigation:
  ...
  - workload_mgmt
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/admin_guide/performance/wlmgmt/index.md
...
| External Components | None                                                                              | Manage external component CPU and memory resources                                                                                                |
