...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/analytics/overview.html.md
...
[Text Analytics and Search](text.mdx) enables processing of mass quantities of raw text data (such as social media feeds or e-mail databases) into mission-critical information that guides project and business decisions. WarehousePG Text joins the WarehousePG massively parallel-processing database server with Apache SolrCloud enterprise search. WarehousePG Text includes powerful text search as well as support for text analysis.
...
-   Use a multitude of data extensions. Review the capabilities of the WarehousePG [Platform Extension Framework (PXF)](../admin_guide/external/pxf-overview.mdx), which provides *connectors* that enable you to access data stored in sources external to your WarehousePG deployment.
