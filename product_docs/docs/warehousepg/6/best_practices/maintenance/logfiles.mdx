...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/best_practices/maintenance/logfiles.md
...
-   `$MASTER_DATA_DIRECTORY` refers to the coordinator data directory on the WarehousePG coordinator host.
