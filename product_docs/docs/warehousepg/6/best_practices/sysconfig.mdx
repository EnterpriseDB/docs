...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/best_practices/sysconfig.md
...
See [Setting the WarehousePG Recommended OS Parameters](../install_guide/config_os.mdx#shared-memory-pages) for more details.
