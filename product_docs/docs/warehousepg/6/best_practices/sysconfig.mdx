...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/best_practices/sysconfig.html.md
...
See [Setting the WarehousePG Recommended OS Parameters](../install_guide/config_os.mdx#shared_memory_pages) for more details.
