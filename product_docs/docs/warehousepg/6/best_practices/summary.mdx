...
See [System Monitoring and Maintenance](maintenance.mdx), [Query Profiling](../admin_guide/query/query-profiling.mdx) and [Monitoring WarehousePG Log Files](logfiles.mdx).
