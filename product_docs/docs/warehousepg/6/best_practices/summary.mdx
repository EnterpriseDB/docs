...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/best_practices/summary.md
...
See [Heap Storage or Append-Optimized Storage](schema.mdx#heap_vs_ao).
...
See [Row or Column Orientation](schema.mdx#row_vs_column).
...
See [Setting the WarehousePG Recommended OS Parameters](../install_guide/config_os.mdx#sysctl_file) and [Memory and Resource Management with Resource Queues](workloads.mdx).
...
See [Configuring Resource Queues](workloads.mdx#configuring_rq).
...
See [System Monitoring and Maintenance](maintenance), [Query Profiling](../admin_guide/query/query-profiling.mdx) and [Monitoring WarehousePG Log Files](maintenance/logfiles.mdx).
...
See [Updating Statistics with ANALYZE](maintenance/analyze.mdx).
...
See [Managing Bloat in a Database](maintenance/bloat.mdx).
...
See [Loading Data](data_loading.mdx).
...
See [Encrypting Data and Database Connections](encryption.mdx)
...
-   Backup WarehousePGs regularly unless the data is easily restored from sources.
