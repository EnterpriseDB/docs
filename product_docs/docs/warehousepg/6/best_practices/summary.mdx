...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/best_practices/summary.html.md
...
See [System Monitoring and Maintenance](maintenance.mdx), [Query Profiling](../admin_guide/query/query-profiling.mdx#in198649) and [Monitoring WarehousePG Log Files](logfiles.mdx).
...
See [Updating Statistics with ANALYZE](analyze.mdx).
...
See [Managing Bloat in a Database](bloat.mdx).
...
-   Consider using WarehousePG integration to stream backups to the Dell EMC Data Domain enterprise backup platform.
