...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/best_practices/workloads.html.md
...
> **Note** Resource groups are a newer resource management scheme that enforces memory, CPU, and concurrent transaction limits in WarehousePG. The [Managing Resources](../admin_guide/wlmgmt.mdx) topic provides a comparison of the resource queue and the resource group management schemes. Refer to [Using Resource Groups](../admin_guide/workload_mgmt_resgroups.mdx) for configuration and usage information for this resource management scheme.
...
-   **vm.overcommit_ratio**
    ...
    See [WarehousePG Memory Overview](../admin_guide/wlmgmt_intro.mdx) for instructions to calculate a value for `vm.overcommit_ratio`.
