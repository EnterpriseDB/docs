...
Refer to the `gp_parallel_retrieve_cursor` [README](https://github.com/greenplum-db/gpdb/tree/master/src/backend/cdb/endpoint/README) in the WarehousePG `github` repository for additional information about this module. You can also find parallel retrieve cursor [programming examples](https://github.com/greenplum-db/gpdb/tree/master/src/test/examples/) in the repository.
