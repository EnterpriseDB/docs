...
title: greenplum_fdw
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/modules/greenplum_fdw.md
...
Refer to [Installing Extensions](../../install_guide/install_modules.mdx) for more information about installing and registering modules in WarehousePG.
