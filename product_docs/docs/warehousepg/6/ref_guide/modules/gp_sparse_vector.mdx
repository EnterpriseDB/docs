...
Refer to the `gp_sparse_vector` READMEs in the [WarehousePG github repository](https://github.com/greenplum-db/gpdb/tree/master/gpcontrib/gp_sparse_vector/README) for additional information about this module.
