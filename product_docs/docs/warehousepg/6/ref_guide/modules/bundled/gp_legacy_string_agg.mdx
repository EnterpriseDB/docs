...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/ref_guide/modules/bundled/gp_legacy_string_agg.md
description: >-
  The gplegacystringagg module re-introduces the single-argument stringagg()
  function that was present in WarehousePG 5.
...
The `gp_legacy_string_agg` module is installed when you install WarehousePG. Before you can use the function defined in the module, you must register the `gp_legacy_string_agg` extension in each database where you want to use the function. Refer to [Installing Extensions](../../../install_guide/additional_modules) for more information about registering the module.
