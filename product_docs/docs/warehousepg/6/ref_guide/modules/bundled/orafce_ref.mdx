...
title: orafce
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/ref_guide/modules/bundled/orafce_ref.md
description: >-
  The orafce module provides Oracle Compatibility SQL functions in WarehousePG.
  These functions target PostgreSQL but can also be used in WarehousePG.
editTarget: originalFilePath

---

<a id="topic1"></a><a id="me143671"></a>
...
The `orafce` module is installed when you install WarehousePG. Before you can use any of the functions defined in the module, you must register the `orafce` extension in each database in which you want to use the functions. Refer to [Installing Extensions](../../../install_guide/additional_modules) for more information.
