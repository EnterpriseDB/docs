...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/ref_guide/modules/bundled/gp_parallel_retrieve_cursor.md
description: >-
  The gpparallelretrievecursor module is an enhanced cursor implementation that
  you can use to create a special kind of cursor on the WarehousePG coordinator
  node, and retrieve query results, on demand and in parallel, dir.
