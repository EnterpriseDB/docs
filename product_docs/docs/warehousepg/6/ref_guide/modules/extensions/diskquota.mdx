...
title: diskquota
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/ref_guide/modules/extensions/diskquota.md
redirects:
  - ../diskquota
description: >-
  The diskquota module allows WarehousePG administrators to limit the amount of
  disk space used by schemas, roles, or tablespaces in a database.
