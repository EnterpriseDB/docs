...
title: pg_opclass
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/system_catalogs/system_catalogs_definitions/pg_opclass.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="gw141670"></a>
