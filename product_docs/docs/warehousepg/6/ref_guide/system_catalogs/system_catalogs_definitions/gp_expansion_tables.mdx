...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/system_catalogs/system_catalogs_definitions/gp_expansion_tables.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="fb138336"></a>
