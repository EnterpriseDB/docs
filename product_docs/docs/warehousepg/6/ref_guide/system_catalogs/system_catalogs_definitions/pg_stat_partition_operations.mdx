...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/system_catalogs/system_catalogs_definitions/pg_stat_partition_operations.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="hu141670"></a>
