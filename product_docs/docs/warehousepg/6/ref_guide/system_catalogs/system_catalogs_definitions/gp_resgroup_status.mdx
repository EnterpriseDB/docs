...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/system_catalogs/system_catalogs_definitions/gp_resgroup_status.md
...
| `memory_usage`         | json     |                     | The real-time memory usage of the resource group on each WarehousePG segment's host.                                                                                                                                                                                                        |
