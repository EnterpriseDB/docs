...
title: vacuumdb
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/vacuumdb.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="ph137116"></a><a id="client_util_desc"></a>
...
[VACUUM](../../sql_commands/VACUUM.mdx), [ANALYZE](../../sql_commands/ANALYZE.mdx)
