...
title: gpstate
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/gpstate.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="md20941"></a>
...
-   \-d coordinator_data_directory
    ...
    Optional. The coordinator data directory. If not specified, the value set for `$MASTER_DATA_DIRECTORY` will be used.
...
[gpstart](gpstart.mdx), [gpexpand](gpexpand.mdx)[gplogfilter](gplogfilter.mdx)
