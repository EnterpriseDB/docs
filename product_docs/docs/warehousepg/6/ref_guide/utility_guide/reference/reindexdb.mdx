...
title: reindexdb
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/reindexdb.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pg137116"></a><a id="client_util_desc"></a>
