...
title: gprecoverseg
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/gprecoverseg.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="mb20941"></a>
...
-   \-p new_recover_host\[,...]
    ...
    Specifies a new host outside of the currently configured WarehousePG array on which to recover invalid segments.
...
[gpstart](gpstart.mdx), [gpstop](gpstop.mdx)
