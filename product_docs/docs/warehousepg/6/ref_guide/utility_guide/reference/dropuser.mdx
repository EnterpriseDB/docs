...
title: dropuser
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/dropuser.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pe137116"></a><a id="client_util_desc"></a>
...
[createuser](createuser.mdx), [DROP ROLE](../../sql_commands/DROP_ROLE.mdx)
