...
title: dropuser
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/utility_guide/ref/dropuser.html.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pe137116"></a>
...
[createuser](createuser.mdx), [DROP ROLE](../../ref_guide/sql_commands/DROP_ROLE.mdx)
