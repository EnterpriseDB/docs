...
title: pgbouncer
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/pgbouncer.md
...
[pgbouncer.ini](pgbouncer-ini.mdx), [pgbouncer-admin](pgbouncer-admin.mdx)
