...
title: pg_config
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/pg_config.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pf137116"></a><a id="client_util_desc"></a>
