...
title: clusterdb
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/clusterdb.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="oy139586"></a><a id="client_util_desc"></a>
...
`clusterdb` is a wrapper around the SQL command `CLUSTER`. Although clustering a table in this way is supported in WarehousePG, it is not recommended because the `CLUSTER` operation itself is extremely slow.
