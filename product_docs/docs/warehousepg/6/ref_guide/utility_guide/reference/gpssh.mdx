...
title: gpssh
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/gpssh.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="jx138388"></a>
...
[gpssh-exkeys](gpssh-exkeys.mdx), [gpscp](gpscp.mdx)
