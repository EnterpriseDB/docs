...
title: createuser
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/createuser.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pb141029"></a><a id="client_util_desc"></a>
...
-   \--replication
    ...
    The new user will have the `REPLICATION` privilege, which is described more fully in the documentation for [CREATE ROLE](../../sql_commands/CREATE_ROLE.mdx).

-   \--no-replication

    The new user will not have the `REPLICATION` privilege, which is described more fully in the documentation for [CREATE ROLE](../../sql_commands/CREATE_ROLE.mdx).
...
[CREATE ROLE](../../sql_commands/CREATE_ROLE.mdx), [dropuser](dropuser.mdx)
