...
title: createdb
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/createdb.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="oz137116"></a><a id="client_util_desc"></a>
...
`createdb` is a wrapper around the SQL command [CREATE DATABASE](../../sql_commands/CREATE_DATABASE.mdx) .
...
The options `-D`, `-l`, `-E`, `-O`, and `-T` correspond to options of the underlying SQL command `CREATE DATABASE`; see [CREATE DATABASE](../../sql_commands/CREATE_DATABASE.mdx) in the *WarehousePG Reference Guide* for more information about them.
...
[CREATE DATABASE](../../sql_commands/CREATE_DATABASE.mdx), [dropdb](dropdb.mdx)
