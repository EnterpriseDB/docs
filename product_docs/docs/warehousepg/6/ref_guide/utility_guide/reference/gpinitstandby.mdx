...
title: gpinitstandby
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/gpinitstandby.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="js140845"></a>
...
[gpinitsystem](gpinitsystem.mdx), [gpaddmirrors](gpaddmirrors.mdx), [gpactivatestandby](gpactivatestandby.mdx)
