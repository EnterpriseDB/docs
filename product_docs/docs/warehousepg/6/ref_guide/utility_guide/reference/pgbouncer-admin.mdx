...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/pgbouncer-admin.md
...
-   [POOLS](#pools)
-   [SERVERS](#servers)
-   [SOCKETS, ACTIVE_SOCKETS](#sockets),
-   [STATS](#stats)
-   [STATS_TOTALS](#stats_totals)
-   [STATS_AVERAGES](#stats_averages)
-   [TOTALS](#totals)
-   [USERS](#users)
-   [VERSION](#version)
...
| total_xact_time   | Total number of microseconds spent by PgBouncer when connected to WarehousePG in a transaction, either idle in transaction or executing queries. |
...
[pgbouncer](pgbouncer.mdx), [pgbouncer.ini](pgbouncer-ini.mdx)
