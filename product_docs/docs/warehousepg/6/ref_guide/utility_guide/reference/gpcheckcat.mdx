...
title: gpcheckcat
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/gpcheckcat.md
...
<a id="ul_jry_gmh_mp"></a><a id="ul_smw_hmh_mp"></a>
...
-   \-S {none | only}
    ...
    Specify this option to control the testing of catalog tables that are shared across all databases in the WarehousePG installation, such as *pg_database*.
