...
title: dropdb
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/utility_guide/ref/dropdb.html.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pc137116"></a>
...
[createdb](createdb.mdx), [DROP DATABASE](../../ref_guide/sql_commands/DROP_DATABASE.mdx)
