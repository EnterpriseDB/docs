...
title: dropdb
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/dropdb.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="pc137116"></a><a id="client_util_desc"></a>
...
[createdb](createdb.mdx), [DROP DATABASE](../../sql_commands/DROP_DATABASE.mdx)
