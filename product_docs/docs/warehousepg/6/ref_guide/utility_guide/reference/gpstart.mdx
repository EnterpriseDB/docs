...
title: gpstart
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/utility_guide/reference/gpstart.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="jy143030"></a>
...
[gpstop](gpstop.mdx), [gpinitsystem](gpinitsystem.mdx)
