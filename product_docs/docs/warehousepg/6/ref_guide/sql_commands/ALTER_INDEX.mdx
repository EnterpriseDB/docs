...
title: ALTER INDEX
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ALTER_INDEX.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="ap20941"></a><a id="sql_command_desc"></a>
...
`ALTER INDEX` is a WarehousePG extension.
