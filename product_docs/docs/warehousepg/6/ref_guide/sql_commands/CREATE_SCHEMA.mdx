...
title: CREATE SCHEMA
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/CREATE_SCHEMA.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="cb20941"></a><a id="sql_command_desc"></a>
