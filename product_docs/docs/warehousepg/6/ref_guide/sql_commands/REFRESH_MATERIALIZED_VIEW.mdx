...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/REFRESH_MATERIALIZED_VIEW.md
...
[ALTER MATERIALIZED VIEW](ALTER_MATERIALIZED_VIEW.mdx), [CREATE MATERIALIZED VIEW](CREATE_MATERIALIZED_VIEW.mdx), [DROP MATERIALIZED VIEW](DROP_MATERIALIZED_VIEW.mdx)
