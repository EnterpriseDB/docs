...
title: ALTER VIEW
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ALTER_VIEW.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="am137232"></a><a id="sql_command_desc"></a>
...
[CREATE VIEW](CREATE_VIEW.mdx#cj20941), [DROP VIEW](DROP_VIEW.mdx#dn20941) in the *WarehousePG Utility Guide*
