...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ALTER_RESOURCE_QUEUE.md
...
[CREATE RESOURCE QUEUE](CREATE_RESOURCE_QUEUE.mdx), [DROP RESOURCE QUEUE](DROP_RESOURCE_QUEUE.mdx), [CREATE ROLE](CREATE_ROLE.mdx), [ALTER ROLE](ALTER_ROLE.mdx)
