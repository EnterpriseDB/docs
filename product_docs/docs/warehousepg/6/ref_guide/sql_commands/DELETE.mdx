...
title: DELETE
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/ref_guide/sql_commands/DELETE.html.md
...
-   with_query
    ...
    See [WITH Queries (Common Table Expressions)](../../admin_guide/query/CTE-query.mdx#topic_zhs_r1s_w1b) and [SELECT](SELECT.mdx) for details.
