...
title: ALTER TABLE
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/ref_guide/sql_commands/ALTER_TABLE.html.md
...
-   EXCHANGE \[DEFAULT] PARTITION
    ...
    For information about the parameter, see [Server Configuration Parameters](../config_params/guc_config.mdx).
...
-   partition_name
    ...
    The given name of a partition. The given partition name is the `partitionname` column value in the *[pg_partitions](../system_catalogs/pg_partitions.mdx)* system view.
...
To see the structure of a partitioned table, you can use the view [pg_partitions](../system_catalogs/pg_partitions.mdx). This view can help identify the particular partitions you may want to alter.
