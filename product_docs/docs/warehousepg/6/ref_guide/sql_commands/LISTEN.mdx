...
title: LISTEN
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/ref_guide/sql_commands/LISTEN.html.md
...
`LISTEN` registers the current session as a listener on the notification channel named \\<channel></channel>. If the current session is already registered as a listener for this notification channel, nothing is done.
