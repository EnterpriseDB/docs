...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/CREATE_SEQUENCE.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="cc20941"></a><a id="sql_command_desc"></a>
