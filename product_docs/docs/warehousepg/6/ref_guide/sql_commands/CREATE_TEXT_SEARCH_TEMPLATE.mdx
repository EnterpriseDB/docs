...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/CREATE_TEXT_SEARCH_TEMPLATE.md
...
[DROP TEXT SEARCH TEMPLATE](DROP_TEXT_SEARCH_TEMPLATE.mdx), [ALTER TEXT SEARCH TEMPLATE](ALTER_TEXT_SEARCH_TEMPLATE.mdx)
