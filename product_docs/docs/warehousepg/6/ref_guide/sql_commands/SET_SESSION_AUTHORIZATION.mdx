...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/SET_SESSION_AUTHORIZATION.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="ek156485"></a><a id="sql_command_desc"></a>
