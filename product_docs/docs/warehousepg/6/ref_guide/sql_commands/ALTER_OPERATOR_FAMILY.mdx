...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ALTER_OPERATOR_FAMILY.md
...
[CREATE OPERATOR FAMILY](CREATE_OPERATOR_FAMILY.mdx), [DROP OPERATOR FAMILY](DROP_OPERATOR_FAMILY.mdx), [ALTER OPERATOR CLASS](ALTER_OPERATOR_CLASS.mdx), [CREATE OPERATOR CLASS](CREATE_OPERATOR_CLASS.mdx), [DROP OPERATOR CLASS](DROP_OPERATOR_CLASS.mdx)
