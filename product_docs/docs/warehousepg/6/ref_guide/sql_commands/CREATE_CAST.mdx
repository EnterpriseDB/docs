...
title: CREATE CAST
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/CREATE_CAST.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="bn20941"></a><a id="sql_command_desc"></a>
...
[CREATE FUNCTION](CREATE_FUNCTION.mdx), [CREATE TYPE](CREATE_TYPE.mdx), [DROP CAST](DROP_CAST.mdx)
