...
title: RETRIEVE
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/RETRIEVE.md
...
> **Note** WarehousePG does not support scrollable cursors; you can only move a cursor forward in position using the `RETRIEVE` command.
...
[DECLARE](DECLARE.mdx), [CLOSE](CLOSE.mdx)
