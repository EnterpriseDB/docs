...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ALTER_EXTENSION.md
...
[CREATE EXTENSION](CREATE_EXTENSION.mdx), [DROP EXTENSION](DROP_EXTENSION.mdx)
