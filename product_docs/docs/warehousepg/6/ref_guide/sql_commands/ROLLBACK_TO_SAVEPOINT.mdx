...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ROLLBACK_TO_SAVEPOINT.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="ee20941"></a><a id="sql_command_desc"></a>
...
[BEGIN](BEGIN.mdx), [COMMIT](COMMIT.mdx), [SAVEPOINT](SAVEPOINT.mdx), [RELEASE SAVEPOINT](RELEASE_SAVEPOINT.mdx), [ROLLBACK](ROLLBACK.mdx)
