...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ALTER_EXTERNAL_TABLE.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="ak20941"></a><a id="sql_command_desc"></a>
...
Use the [ALTER TABLE](ALTER_TABLE.mdx) command to perform these actions on an external table.
...
[CREATE EXTERNAL TABLE](CREATE_EXTERNAL_TABLE.mdx), [DROP EXTERNAL TABLE](DROP_EXTERNAL_TABLE.mdx), [ALTER TABLE](ALTER_TABLE.mdx)
