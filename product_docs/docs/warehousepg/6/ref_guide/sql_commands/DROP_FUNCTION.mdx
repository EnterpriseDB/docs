...
title: DROP FUNCTION
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/DROP_FUNCTION.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="cv20941"></a><a id="sql_command_desc"></a>
...
[CREATE FUNCTION](CREATE_FUNCTION.mdx), [ALTER FUNCTION](ALTER_FUNCTION.mdx)
