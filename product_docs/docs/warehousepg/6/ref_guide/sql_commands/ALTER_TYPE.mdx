...
title: ALTER TYPE
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/ALTER_TYPE.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="bb137420"></a><a id="sql_command_desc"></a>
