...
title: DROP TABLE
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/DROP_TABLE.md
...
[CREATE TABLE](CREATE_TABLE.mdx), [ALTER TABLE](ALTER_TABLE.mdx), [TRUNCATE](TRUNCATE.mdx)
