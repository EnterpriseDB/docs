...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/DROP_RESOURCE_QUEUE.md
...
Use [ALTER ROLE](ALTER_ROLE.mdx) to remove a user from a resource queue.
...
[ALTER RESOURCE QUEUE](ALTER_RESOURCE_QUEUE.mdx), [CREATE RESOURCE QUEUE](CREATE_RESOURCE_QUEUE.mdx), [ALTER ROLE](ALTER_ROLE.mdx)
