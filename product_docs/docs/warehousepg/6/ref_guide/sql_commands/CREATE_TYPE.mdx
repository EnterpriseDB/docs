...
-   category
    ...
    The category code (a single ASCII character) for this type. The default is '`U`', signifying a user-defined type. You can find the other standard category codes in [`pg_type` Category Codes](../system_catalogs/pg_type.mdx#category-codes). You may also assign unused ASCII characters to custom categories that you create.
