...
title: SET
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/SET.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="ei20941"></a><a id="sql_command_desc"></a>
...
See [Server Configuration Parameters](../config_params) for information about server parameters.
...
-   configuration_parameter
    ...
    The name of a WarehousePG configuration parameter. Only parameters classified as *session* can be changed with `SET`. See [Server Configuration Parameters](../config_params) for details.
...
-   DEFAULT
    ...
    Set the time zone to your local time zone (that is, server's default value of timezone). See the [Time zone section of the PostgreSQL documentation](https://www.postgresql.org/docs/9.4/datatype-datetime.html#DATATYPE-TIMEZONES) for more information about time zones in WarehousePG.
