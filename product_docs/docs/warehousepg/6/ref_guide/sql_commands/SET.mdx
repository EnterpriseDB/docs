...
title: SET
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/ref_guide/sql_commands/SET.html.md
...
See [Server Configuration Parameters](../config_params/guc_config.mdx) for information about server parameters.
...
-   configuration_parameter
    ...
    The name of a WarehousePG configuration parameter. Only parameters classified as *session* can be changed with `SET`. See [Server Configuration Parameters](../config_params/guc_config.mdx) for details.
