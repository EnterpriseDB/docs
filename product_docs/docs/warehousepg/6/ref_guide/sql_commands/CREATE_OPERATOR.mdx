...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/ref_guide/sql_commands/CREATE_OPERATOR.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="bw20941"></a><a id="sql_command_desc"></a>
...
`CREATE OPERATOR` is a WarehousePG language extension. The SQL standard does not provide for user-defined operators.
...
[CREATE FUNCTION](CREATE_FUNCTION.mdx), [CREATE TYPE](CREATE_TYPE.mdx), [ALTER OPERATOR](ALTER_OPERATOR.mdx), [DROP OPERATOR](DROP_OPERATOR.mdx)
