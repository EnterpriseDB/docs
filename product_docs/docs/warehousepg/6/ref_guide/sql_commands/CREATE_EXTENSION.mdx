...
The extensions currently available for loading can be identified from the *[pg_available_extensions](../system_catalogs/pg_available_extensions.mdx)* or *[pg_available_extension_versions](../system_catalogs/pg_available_extension_versions.mdx)* system views.
