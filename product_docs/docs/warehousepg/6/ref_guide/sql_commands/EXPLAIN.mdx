...
title: EXPLAIN
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/EXPLAIN.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="dq20941"></a><a id="topic1"></a><a id="dq20941"></a><a id="sql_command_desc"></a>
...
`EXPLAIN` displays the query plan that the WarehousePG or Postgres Planner generates for the supplied statement. Query plans are a tree plan of nodes. Each node in the plan represents a single operation, such as table scan, join, aggregation or a sort.
...
<a id="dq155498"></a><a id="dq155498"></a>
- The total elapsed time (in milliseconds) that it took to run the query.<a id="dq155499"></a>
