...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/sql_commands/CREATE_OPERATOR_CLASS.md
...
[ALTER OPERATOR CLASS](ALTER_OPERATOR_CLASS.mdx), [DROP OPERATOR CLASS](DROP_OPERATOR_CLASS.mdx), [CREATE FUNCTION](CREATE_FUNCTION.mdx)
