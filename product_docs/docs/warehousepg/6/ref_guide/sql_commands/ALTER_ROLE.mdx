...
title: ALTER ROLE
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/ref_guide/sql_commands/ALTER_ROLE.html.md
...
-   config_parameter=value
    ...
    See [Server Configuration Parameters](../config_params/guc_config.mdx) for information about user-settable configuration parameters.
