...
> **Note** The WarehousePG Partner Connector is supported for WarehousePG versions 4.3.5.0 and later.
...
<a id="topic_limits"></a><a id="py217167"></a>
...
The [gppc test](https://github.com/greenplum-db/gpdb/tree/master/src/interfaces/gppc/test) directory in the WarehousePG github repository includes sample GPPC code:
