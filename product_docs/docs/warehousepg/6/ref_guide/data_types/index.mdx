...
navigation:
  ...
  - datatype-range
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/6x/ref_guide/data_types/index.md
...
Additional modules that you register may also install new data types. The `hstore` module, for example, introduces a new data type and associated functions for working with key-value pairs. See [hstore](/supported-open-source/warehousepg/extensions/bundled/hstore.mdx). The `citext` module adds a case-insensitive text data type. See [citext](/supported-open-source/warehousepg/extensions/bundled/citext.mdx).
