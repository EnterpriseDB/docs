...
navigation:
  ...
  - datatype-range
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/data_types/index.md
editTarget: originalFilePath

---

<a id="topic1"></a><a id="if135496"></a>
...
Additional modules that you register may also install new data types. The `hstore` module, for example, introduces a new data type and associated functions for working with key-value pairs. See [hstore](../modules/hstore.mdx). The `citext` module adds a case-insensitive text data type. See [citext](../modules/citext.mdx).
