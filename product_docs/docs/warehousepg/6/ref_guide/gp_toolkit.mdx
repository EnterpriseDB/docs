...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/ref_guide/gp_toolkit.md
...
-   **[Checking for Tables that Need Routine Maintenance](gp_toolkit.mdx)**

-   **[Checking for Locks](gp_toolkit.mdx)**

-   **[Checking Append-Optimized Tables](gp_toolkit.mdx)**

-   **[Viewing WarehousePG Server Log Files](gp_toolkit.mdx)**

-   **[Checking Server Configuration Files](gp_toolkit.mdx)**

-   **[Checking for Failed Segments](gp_toolkit.mdx)**

-   **[Checking Resource Group Activity and Status](gp_toolkit.mdx)**

-   **[Checking Resource Queue Activity and Status](gp_toolkit.mdx)**

-   **[Checking Query Disk Spill Space Usage](gp_toolkit.mdx)**

-   **[Viewing Users and Groups (Roles)](gp_toolkit.mdx)**

-   **[Checking Database Object Sizes and Disk Space](gp_toolkit.mdx)**

-   **[Checking for Uneven Data Distribution](gp_toolkit.mdx)**
