...
originalFilePath: >-
  https://github.com/warehouse-pg/warehouse-pg/gpdb-doc/markdown/install_guide/install_guide.html.md
redirects:
  - install_guide
...
-   **[Upgrading to WarehousePG 6](upgrade_intro.mdx)**  
...
-   **[Migrating Open Source WarehousePG to WarehousePG](migrate-oss-to-vmware.html)**
    This topic describes how to migrate an Open Source WarehousePG installation to commercial WarehousePG.
