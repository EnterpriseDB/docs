...
title: WarehousePG Environment Variables
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/6x/install_guide/env_var_ref.md
...
-   **[Required Environment Variables](env_var_ref.mdx)**  

-   **[Optional Environment Variables](env_var_ref.mdx)**  
...
**Parent topic:** [WarehousePG Environment Variables](env_var_ref.mdx)
