...
-   [gpbackup & gprestore user guide](./)
-   [gpbackup syntax reference](../../ref_guide/utility_guide/reference/gpbackup.mdx)
-   [gprestore syntax reference](../../ref_guide/utility_guide/reference/gprestore.mdx) 
!!!

The [gpbackup](../../ref_guide/utility_guide/reference/gpbackup.mdx) and [gprestore](../../ref_guide/utility_guide/reference/gprestore.mdx) utilities support creating
...
set must be archived. You must archive all the files created on the coordinator and all
segments. 
