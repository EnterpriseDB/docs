...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/backup_restore/index.md
...
[gpbackup](../../ref_guide/utility_guide/reference/gpbackup.mdx) and [gprestore](../../ref_guide/utility_guide/reference/gprestore.mdx) 
...
For additional documenation, visit the [gpbackup](../../ref_guide/utility_guide/reference/gpbackup.mdx)  and [gprestore](../../ref_guide/utility_guide/reference/gprestore.mdx)  cluster utilities reference page.
