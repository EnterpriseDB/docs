...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/query/parallel-proc.md
...
![Dispatching the Parallel Query Plan](../../images/parallel_dispatch.png "Dispatching the Parallel Query Plan")
...
![Dispatching a Targeted Query Plan](../../images/targeted_dispatch.png "Dispatching a Targeted Query Plan")
...
![Query Slice Plan](../../images/slice_plan.png "Query Slice Plan")
...
![Query Worker Processes](../../images/gangs.png "Query Worker Processes")
