...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/query/textsearch/features.md
...
<a id="manipulating-documents"></a>

## Manipulating Documents

[Parsing Documents](controlling.mdx#parsing-documents) showed how raw textual documents can be converted into `tsvector` values. WarehousePG also provides functions and operators that can be used to manipulate documents that are already in `tsvector` form.
...
<a id="manipulate_queries"></a>

## Manipulating Queries

[Parsing Queries](controlling.mdx#parsing-queries) showed how raw textual queries can be converted into `tsquery` values. WarehousePG also provides functions and operators that can be used to manipulate queries that are already in `tsquery` form.
