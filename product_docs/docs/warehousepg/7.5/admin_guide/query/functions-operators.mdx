...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/query/functions-operators.md
...
-   You define a procedure with the [CREATE PROCEDURE](../../ref_guide/sql_commands/CREATE_PROCEDURE.mdx) command, not `CREATE FUNCTION`.
...
-   While a function is called as part of a query or DML command, you call a procedure in isolation using the [CALL](../../ref_guide/sql_commands/CALL.mdx) command.
...
GROUP BY department_id; </code></pre>
                            ...
                            <td class="entry" headers="agg__in2073121__entry__4">Can take a two-dimensional array as input. Treats
