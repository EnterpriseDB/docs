...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/query/json-data.md
        ...
        <table class="table" summary="jsonpath Variables" border="1">
          ...
          <tbody>
            ...
            <tr class="row">
              ...
              <td class="entry nocellnorowborder">A named variable. Its value can be set by the parameter <em class="parameter"><code>vars</code></em> of several JSON processing functions. See <a href="../../ref_guide/function-summary.mdx#json-processing-functions">JSON Processing Functions</a> and its notes for details.</td>
            </tr>
            <tr>
              <td class="entry nocellnorowborder"><code class="literal">@</code></td>
