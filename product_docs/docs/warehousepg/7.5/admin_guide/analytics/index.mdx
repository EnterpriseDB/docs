...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/analytics/index.md
redirects:
  - pl
...
[Text Analytics and Search](../query/textsearch) enables processing of mass quantities of raw text data (such as social media feeds or e-mail databases) into mission-critical information that guides project and business decisions. 
...
-   [PL/Java](procedural_languages/pl_java.mdx)
...
-   [PL/R](procedural_languages/pl_r.mdx)

<a id="why_gp_analytics"></a>

## Advanced Analytics and WarehousePG
