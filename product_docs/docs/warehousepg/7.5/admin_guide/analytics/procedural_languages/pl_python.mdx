...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/analytics/procedural_languages/pl_python.md
...
A PL/Python procedure is similar to a PL/Python function. Refer to [User-Defined Procedures](../../query/functions-operators.mdx#user-defined-procedures) for more information on procedures in WarehousePG and how they differ from functions.
