...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/analytics/postGIS.md
...
For information about the supported WarehousePG extension packages and software versions, see [Extensions](../../install_guide/platform-requirements.mdx#topic_eyc_l2h_zz).
