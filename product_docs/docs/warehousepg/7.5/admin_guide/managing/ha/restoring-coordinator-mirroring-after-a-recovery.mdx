...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/managing/ha/restoring-coordinator-mirroring-after-a-recovery.md
...
4.  After the initialization completes, check the status of standby coordinator, cdw. Run [gpstate](../../../ref_guide/utility_guide/reference/gpstate.mdx) with the `-f` option to check the standby coordinator status:
