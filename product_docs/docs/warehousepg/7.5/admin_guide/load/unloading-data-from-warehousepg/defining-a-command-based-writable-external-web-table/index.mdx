...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/whpg/7x/admin_guide/load/unloading-data-from-warehousepg/defining-a-command-based-writable-external-web-table/index.md
