...
navigation:
  ...
  - example-2-hadoop-file-server
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/load/unloading-data-from-warehousepg/defining-a-file-based-writable-external-table/index.md
...
-   **[Example 1—WarehousePG file server (gpfdist)](example-1-warehousepg-file-server-gpfdist.mdx)**  

-   **[Example 2—Hadoop file server (pxf)](example-2-hadoop-file-server.mdx)**  
