...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/external/external-tables/index.md
...
[Examples for Creating External Tables](creating-external-tables---examples) provides examples for different data types and different built-in protocols.
...
By default, if external table data contains an error, the command fails and no data loads into the target database table. See [Handling Errors in External Table Data](handling-errors-ext-table-data.mdx) for more information.
