...
navigation:
  - devel-fdw
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/admin_guide/external/foreign/index.md
...
The WarehousePG distribution includes the [postgres_fdw](../../../ref_guide/modules/bundled/postgres_fdw.mdx) foreign data wrapper.
