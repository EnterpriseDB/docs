...
title: gpbackup
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/utility_guide/reference/gpbackup.md
...
[**See Filtering the Contents of a Backup or Restore for more information.**](../../../admin_guide/backup_restore#filter)
