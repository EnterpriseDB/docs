...
title: DROP INDEX
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/DROP_INDEX.md
...
[ALTER INDEX](ALTER_INDEX.mdx), [CREATE INDEX](CREATE_INDEX.mdx)
