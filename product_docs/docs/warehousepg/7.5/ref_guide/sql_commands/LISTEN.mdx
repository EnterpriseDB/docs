...
title: LISTEN
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/LISTEN.md
...
[NOTIFY](NOTIFY.mdx) contains a more extensive discussion of the use of `LISTEN` and `NOTIFY`.
...
[NOTIFY](NOTIFY.mdx), [UNLISTEN](UNLISTEN.mdx)
