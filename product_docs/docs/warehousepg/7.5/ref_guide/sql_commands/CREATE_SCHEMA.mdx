...
title: CREATE SCHEMA
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_SCHEMA.md
...
schema*name
The name of a schema to be created. If this is omitted, the user_name is used as the schema name. The name cannot begin with \`pg*\`, as such names are reserved for system catalog schemas.
...
[ALTER SCHEMA](ALTER_SCHEMA.mdx), [DROP SCHEMA](DROP_SCHEMA.mdx)
