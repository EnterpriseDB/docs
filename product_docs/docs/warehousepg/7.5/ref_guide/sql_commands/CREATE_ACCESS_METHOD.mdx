...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_ACCESS_METHOD.md
...
[DROP ACCESS METHOD](DROP_ACCESS_METHOD.mdx), [CREATE OPERATOR CLASS](CREATE_OPERATOR_CLASS.mdx), [CREATE OPERATOR FAMILY](CREATE_OPERATOR_FAMILY.mdx)
