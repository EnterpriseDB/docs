...
title: REVOKE
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/REVOKE.md
...
See the description of the [GRANT](GRANT.mdx) command for the meaning of the privilege types.
...
The compatibility notes of the [GRANT](GRANT.mdx) command also apply to `REVOKE`.
...
[ALTER DEFAULT PRIVILEGES](ALTER_DEFAULT_PRIVILEGES.mdx), [GRANT](GRANT.mdx)
