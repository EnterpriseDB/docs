...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/ALTER_USER_MAPPING.md
...
[CREATE USER MAPPING](CREATE_USER_MAPPING.mdx), [DROP USER MAPPING](DROP_USER_MAPPING.mdx)
