...
title: REINDEX
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/REINDEX.md
...
[CREATE INDEX](CREATE_INDEX.mdx), [DROP INDEX](DROP_INDEX.mdx), [VACUUM](VACUUM.mdx), [reindexdb](../utility_guide/reference/reindexdb.mdx)
