...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/ALTER_PROCEDURE.md
...
Change whether the procedure is a security definer or not. The key word `EXTERNAL` is ignored for SQL conformance. See [CREATE PROCEDURE](CREATE_PROCEDURE.mdx) for more information about this capability.
...
[CREATE PROCEDURE](CREATE_PROCEDURE.mdx), [DROP PROCEDURE](DROP_PROCEDURE.mdx)
