...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/IMPORT_FOREIGN_SCHEMA.md
...
[CREATE FOREIGN TABLE](CREATE_FOREIGN_TABLE.mdx), [CREATE SERVER](CREATE_SERVER.mdx)
