...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_FOREIGN_DATA_WRAPPER.md
...
[ALTER FOREIGN DATA WRAPPER](ALTER_FOREIGN_DATA_WRAPPER.mdx), [DROP FOREIGN DATA WRAPPER](DROP_FOREIGN_DATA_WRAPPER.mdx), [CREATE FOREIGN TABLE](CREATE_FOREIGN_TABLE.mdx), [CREATE SERVER](CREATE_SERVER.mdx), [CREATE USER MAPPING](CREATE_USER_MAPPING.mdx)
