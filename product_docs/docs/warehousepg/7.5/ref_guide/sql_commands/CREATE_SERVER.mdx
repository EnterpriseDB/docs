...
title: CREATE SERVER
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_SERVER.md
...
[ALTER SERVER](ALTER_SERVER.mdx), [DROP SERVER](DROP_SERVER.mdx), [CREATE FOREIGN DATA WRAPPER](CREATE_FOREIGN_DATA_WRAPPER.mdx), [CREATE FOREIGN TABLE](CREATE_FOREIGN_TABLE.mdx), [CREATE USER MAPPING](CREATE_USER_MAPPING.mdx)
