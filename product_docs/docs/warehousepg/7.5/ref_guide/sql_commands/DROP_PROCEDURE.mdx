...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/DROP_PROCEDURE.md
...
[CREATE PROCEDURE](CREATE_PROCEDURE.mdx), [ALTER PROCEDURE](ALTER_PROCEDURE.mdx)
