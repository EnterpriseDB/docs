...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/ROLLBACK_TO_SAVEPOINT.md
...
Use [RELEASE SAVEPOINT](RELEASE_SAVEPOINT.mdx) to destroy a savepoint without discarding the effects of commands run after it was established.
...
[BEGIN](BEGIN.mdx), [COMMIT](COMMIT.mdx), [RELEASE SAVEPOINT](RELEASE_SAVEPOINT.mdx), [ROLLBACK](ROLLBACK.mdx), [SAVEPOINT](SAVEPOINT.mdx)
