...
title: ALTER VIEW
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/ALTER_VIEW.md
...
[CREATE VIEW](CREATE_VIEW.mdx), [DROP VIEW](DROP_VIEW.mdx)
