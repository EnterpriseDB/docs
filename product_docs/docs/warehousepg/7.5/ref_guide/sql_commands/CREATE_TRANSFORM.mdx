...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_TRANSFORM.md
...
Use [DROP TRANSFORM](DROP_TRANSFORM.mdx) to remove transforms.
...
[CREATE FUNCTION](CREATE_FUNCTION.mdx), [CREATE LANGUAGE](CREATE_LANGUAGE.mdx), [CREATE TYPE](CREATE_TYPE.mdx), [DROP TRANSFORM](DROP_TRANSFORM.mdx)
