...
title: CREATE TYPE
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_TYPE.md
...
category
The category code (a single ASCII character) for this type. The default is '`U`', signifying a user-defined type. You can find the other standard category codes in [`pg_type` Category Codes](../system_catalogs/system_catalogs_definitions/pg_type.mdx#typcategory). You may also assign unused ASCII characters to custom categories that you create.
