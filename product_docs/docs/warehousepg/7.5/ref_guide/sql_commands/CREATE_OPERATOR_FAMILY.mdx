...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/sql_commands/CREATE_OPERATOR_FAMILY.md
...
[ALTER OPERATOR FAMILY](ALTER_OPERATOR_FAMILY.mdx), [DROP OPERATOR FAMILY](DROP_OPERATOR_FAMILY.mdx), [ALTER OPERATOR CLASS](ALTER_OPERATOR_CLASS.mdx), [CREATE OPERATOR CLASS](CREATE_OPERATOR_CLASS.mdx), [DROP OPERATOR CLASS](DROP_OPERATOR_CLASS.mdx)
