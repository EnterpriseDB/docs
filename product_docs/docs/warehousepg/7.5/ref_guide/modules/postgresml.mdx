...
title: postgresml
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/modules/postgresml.md
...
-   `project_name` is the project name used to train models in [pgml.train()](#pgmltrain).
