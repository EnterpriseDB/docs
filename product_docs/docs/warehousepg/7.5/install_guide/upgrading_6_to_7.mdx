...
3.  Initalize a WarehousePG 7 cluster on the destination hardware, by issuing the [`gpinitsystem` command](../ref_guide/utility_guide/reference/gpinitsystem.mdx).
