...
For information about the Oracle Compatibility Functions, see [Oracle Compatibility Functions](/supported-open-source/warehousepg/extensions/bundled/orafce_ref/).
