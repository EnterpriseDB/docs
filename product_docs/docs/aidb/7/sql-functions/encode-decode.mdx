...
For the full parameter reference, see [Models reference](../reference/models.mdx#aidbencode_text).
...
For the full parameter reference, see [Models reference](../reference/models.mdx#aidbencode_text_batch).
...
For the full parameter reference, see [Models reference](../reference/models.mdx#aidbdecode_text_batch).
