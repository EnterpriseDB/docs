...
!!! Tip
This operation transforms the shape of the data, automatically unnesting collections by introducing a `part_id` column. See [Data processing](../data-pipelines/data-processing) for more details on how pipelines handle multi-part output.
!!!
