...
| `count(record errors)`     | bigint | Number of record-level errors logged for this pipeline.                                       |
| `count(blocking errors)`   | bigint | Number of pipeline-level errors that prevent the pipeline from running.                       |
