...
| `last run completed`       | timestamptz | When the pipeline's last run finished. Introduced in 7.6.0.                                       |
...
----------------------+-----------------+-------------------------+-------------------------+-----------------------+----------------------------+----------+----------------------+------------------------+----------------------------
 pipeline__7471a      | Background      |                       0 |                         |                     5 |                          5 | UpToDate |                    0 |                      0 | 2026-07-21 10:15:03.221+00
 pipeline__7471b      | Background      |                       0 |                         |                     5 |                          5 | UpToDate |                    0 |                      0 | 2026-07-21 10:15:03.402+00
 animal_facts_kb      | Disabled        |                       0 |                         |                    99 |                        372 | UpToDate |                    0 |                      0 | 2026-07-20 09:02:11.010+00
 animal_facts_kb_bert | Disabled        |                       0 |                         |                    99 |                        372 | UpToDate |                    0 |                      0 | 2026-07-20 09:02:11.010+00
 mpkb_pipe_int        | Disabled        |                       0 |                         |                     2 |                          4 | UpToDate |                    0 |                      0 | 2026-07-19 16:40:55.884+00
 mpkb_pipe_text       | Disabled        |                       0 |                         |                     2 |                          4 | UpToDate |                    0 |                      0 | 2026-07-19 16:40:55.884+00
(6 rows)
```
...
| -------------------------- | ------------------------------------------------------------------ | ---------- | --------------------------------------------------------------------------------- |
| `name`                     | TEXT                                                               | Required   | Name of the pipeline. Max 46 characters.                                          |
...
| `last_run_completed`    | timestamptz | When the pipeline's last run finished. Introduced in 7.6.0.                                        |
...
Functions for inspecting, clearing, and requeuing failed pipeline records (`aidb.get_error_logs`, `aidb.clear_error_logs`, `aidb.get_error_log_summary`, `aidb.get_all_error_summaries`, `aidb.requeue_pipeline_errors`) are documented in the [Operations reference](../reference/operations). See [Error log](./orchestration/error-log/) for the end-to-end guide-style workflow.
