...
Use the view [`aidb.knowledge_base_stats`](../../reference/knowledge-bases#aidbknowledge_base_stats), or use its short alias `aidb.kbstat`. The view shows all configured knowledge base pipelines,
