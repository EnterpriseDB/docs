...
description: Learn how to configure each pipeline step — ChunkText, ParseHtml, ParsePdf, PerformOcr, SummarizeText, and KnowledgeBase — and how to persist intermediate step output, when building AI pipelines in EDB Postgres AI.
---
