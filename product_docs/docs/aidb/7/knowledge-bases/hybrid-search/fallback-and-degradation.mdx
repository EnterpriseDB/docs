---
title: Handle embedding service outages
...
This page shows how to implement a three-tier fallback so your application keeps returning results in those situations.
