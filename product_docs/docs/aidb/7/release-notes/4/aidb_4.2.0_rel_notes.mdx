...
| Bugfix      | **Fixed local file processing in volume knowledge bases:** An issue existed where a number of local files in a volume knowledge base were not processed due to an issue with the ordering of file results. This has been fixed.                                                                         |
...
| Bugfix      | **Fixed easy model syncing in hybrid manager deployments:** The `sync_hcp_models()` function used to automatically create AIDB models in hybrid manager deployments resulted in non-working model configurations. This is now fixed.                                                                    |
