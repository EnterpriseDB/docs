...
| Enhancement       | **`aidb.summarize_text_aggregate` aggregate function:** Added a new `aidb.summarize_text_aggregate` aggregate SQL function that summarizes a set of text rows using a specified AI model.  |
