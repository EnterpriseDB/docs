...
See [Creating agents](creating-agents). Letting an agent create or reconfigure *other* agents (including itself) is a powerful, self-modifying capability — grant these tools deliberately.
