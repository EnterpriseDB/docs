...
!!!note
If you're using Agent Factory, AIDB is already included as part of that platform, but Agent Factory is not required to use AIDB. This documentation covers standalone AIDB.
!!!
