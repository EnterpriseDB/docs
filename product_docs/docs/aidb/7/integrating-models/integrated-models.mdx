...
|--------------|---------------|--------------------------------------------|
| `bert_local` | `bert_local`  | Text embeddings                            |
| `clip_local` | `clip_local`  | Multimodal embeddings (text and image)     |
| `t5_local`   | `t5_local`    | Text-to-text generation                    |
...
| `context_size` | INTEGER          | NULL     | Maximum context window size in tokens.                   |
