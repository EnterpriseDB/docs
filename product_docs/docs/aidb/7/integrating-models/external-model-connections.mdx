...
|-----------------------|-----------------------------------------------|------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------|
| `openai_completions`  | Chat Completions (`/v1/chat/completions`)    | Simple, one-off text generation — `aidb.decode_text()`, summarization, pipeline steps. | Rejects `tools`/`tool_choice`/`response_format` in `aidb.decode_text()`'s `inference_config`.                  |
