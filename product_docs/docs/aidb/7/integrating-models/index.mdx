...
| Page                                                     | What it covers                                                                             |
|----------------------------------------------------------|--------------------------------------------------------------------------------------------|
| [Local models](integrated-models)                         | Default local models (BERT, CLIP, T5, Llama), model providers, registering custom local models, and llama.cpp GGUF models |
| [External model connections](external-model-connections) | OpenAI-compatible APIs, the native OpenAI Responses and Anthropic Messages APIs, NVIDIA NIM, Google Gemini, and OpenRouter |
