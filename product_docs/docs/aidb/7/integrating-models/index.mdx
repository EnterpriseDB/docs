...
description: How to configure and connect AI models with AIDB, including built-in local models, external API-based models, and supported model variants.
navigation:
 - integrated-models
 - support-matrix
 - external-model-connections
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/integrating-models
  - /edb-postgres-ai/innovation-release/ai-factory/integrating-models/*
---
