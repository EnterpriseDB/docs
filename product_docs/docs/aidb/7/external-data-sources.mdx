...
SELECT pgfs.create_storage_location(
    ...
    -- or omit access_key_id/secret_access_key to use the cloud provider's native credential chain (IAM role, managed identity, etc.) instead
);
...
SELECT pgfs.create_storage_location(
    ...
    's3://my-docs-bucket',
    options => '{"region": "us-east-1", "access_key_id": "<key>", "secret_access_key": "<secret>"}'
    -- or omit access_key_id/secret_access_key to use the cloud provider's native credential chain instead
);
