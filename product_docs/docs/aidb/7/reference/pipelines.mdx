...
| Vector index config helpers  | `aidb.vector_index_hnsw_config`, `aidb.vector_index_ivfflat_config`, `aidb.vector_index_hsphere_optimized_config`, `aidb.vector_index_disabled_config` |
