...
Creates an AIDB volume from a PGFS storage location for use as a knowledge base data source. See [External data sources](../external-data-sources) for setting up the PGFS storage location first.
