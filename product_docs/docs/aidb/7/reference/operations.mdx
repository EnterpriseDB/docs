...
| `p_error_category` | [aidb.ErrorBlocking](../data-pipelines/reference#aidberrorblocking) | NULL     | Filter by category: `RecordTemporary`, `RecordPermanent`, `PipelineTemporary`, or `PipelinePermanent`. |
...
| `step_operation` | [aidb.PipelineStepOperation](../data-pipelines/reference#aidbpipelinestepoperation) | Operation name (for example, `ParsePdf`, `ChunkText`) |
...
| `last_seen_at`   | timestamptz        | Timestamp of the most recent occurrence of this error. Updates on every repeat; `failed_at` stays fixed at the first occurrence. |
...
| `step_operation`   | [aidb.PipelineStepOperation](../data-pipelines/reference#aidbpipelinestepoperation) | Operation name                 |
| `error_category`   | [aidb.ErrorBlocking](../data-pipelines/reference#aidberrorblocking) | Error category                 |
