...
| [Semantic aliases](semantic-aliases) | Named, parameterized SQL queries with vectorized descriptions, enabling reusable, governed text-to-SQL |
...
- [Agents](../agents), which covers building the in-database agents that call semantic KB search functions as tools.
- [Semantic knowledge base tools](../tools/native-tools#semantic-knowledge-bases), which lists the native tool catalog entries for the KB functions.
- [Knowledge bases](../knowledge-bases), which covers vector knowledge bases for semantic and hybrid search over your data.
