...
See [Threading limits](threading-limits) for what these two parameters control, how they interact, and when to lower them.
...
| Parameter                   | Type    | Default | Range | Description                                                                                                                                                                    |
|------------------------------|---------|---------|-------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `aidb.enable_llamacpp_logs` | boolean | `false` | —     | Controls whether llama.cpp's own diagnostic output (GGUF metadata, tensor shapes, backend/model initialization) is written to the server log. `Suset`. Read once at extension initialization — see below. |
