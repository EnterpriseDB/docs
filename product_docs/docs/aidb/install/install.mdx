...
AIDB (AI Database) is a specialized PostgreSQL extension developed by EnterpriseDB (EDB). It is the core engine of the EDB Postgres AI platform, designed to transform a standard database into a powerful platform for Artificial Intelligence and Machine Learning.
