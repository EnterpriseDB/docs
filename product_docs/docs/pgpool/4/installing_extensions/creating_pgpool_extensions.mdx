...
`Pgpool_adm` is a set of extensions that allows SQL access to PCP commands. For information about PCP commands, see <https://www.pgpool.net/docs/latest/en/html/pcp-commands.html>.
...
For more information about `Pgpool_adm`, see <https://www.pgpool.net/docs/latest/en/html/pgpool-adm.html>.
