...
title: Installing EDB Pgpool-II on AlmaLinux 9 or Rocky Linux 9 x86_64
...
redirects:
  - /pgpool/4/01_installing_and_configuring_the_pgpool-II/x86_amd64/pgpool_other_linux9_x86
---
...
- Set up the EDB repository.
 ...
 If no output is generated, the EDB repository is not installed. To install it, set up the EDB repository.
