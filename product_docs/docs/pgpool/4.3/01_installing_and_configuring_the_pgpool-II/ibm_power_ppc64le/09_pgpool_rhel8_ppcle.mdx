---
title: "Installing EDB PgPool-II on RHEL 8 IBM Power (ppc64le)"
navTitle: "RHEL 8"
---
...
1. Enable the `codeready-builder-for-rhel-8-\*-rpms` repository because EPEL packages may depend on packages from it:
