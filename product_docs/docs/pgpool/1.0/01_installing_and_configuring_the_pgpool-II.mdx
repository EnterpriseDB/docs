...
|--------------------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------|
| Pgpool 4.2         | Advanced Server 13          | RHEL 7 - x86_64, RHEL 8 - x86_64 <br/>RHEL 7 - ppc64le <br/>Debian 9x Stretch and 10x Buster <br/>Ubuntu 18.04 LTS Bionic Beaver and Ubuntu 20.04 LTS Focal Fossa |
| Pgpool 4.2         | Advanced Server 12          | RHEL 7 - x86_64, and RHEL 8 - x86_64 <br/>RHEL 7 - ppc64le <br/>Debian 9x Stretch and 10x Buster <br/>Ubuntu 18.04 LTS Bionic Beaver <br/>SLES 12                      |
| Pgpool 4.2         | Advanced Server 11          | RHEL 7 - x86_64 <br/>RHEL 7 - ppc64le <br/>Debian 9x Stretch <br/>Ubuntu 18.04 LTS Bionic Beaver <br/>SLES 12                                                          |
| Pgpool 4.2         | Advanced Server 9.6 and 10  | RHEL 7 - x86_64 and RHEL 7 - ppc64le                                                                                                               |
