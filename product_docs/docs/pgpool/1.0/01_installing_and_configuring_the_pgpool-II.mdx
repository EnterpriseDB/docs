...
| Pgpool 4.2         | EDB Postgres Advanced Server and PostgreSQL 11          | RHEL 7 - x86_64 <br/>RHEL 7 - ppc64le <br/>Debian 9x Stretch <br/>Ubuntu 18.04 LTS Bionic Beaver <br/>SLES 12                                                     |
...
Graphical installers for Pgpool-II are available via StackBuilder Plus (for EDB Postgres Advanced Server hosts) or Stack Builder (on PostgreSQL hosts). You can access StackBuilder Plus through your Linux start menu. It is not supported on Windows systems.
