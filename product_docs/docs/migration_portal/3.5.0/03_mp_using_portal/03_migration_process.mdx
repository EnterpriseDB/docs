---
title: Migration Portal overview
---
To migrate Oracle schemas using Migration Portal:

1. Generate a .sql file with metadata information of your schemas using Oracle Data Pump’s command line clients `expdp` and `impdp`. For more information, see [Performing a schema extraction](../04_mp_migrating_database/01_mp_schema_extraction).
