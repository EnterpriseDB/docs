...
| Enhancement | Migration Portal now uses the metadata information in a SQL dump file to assess the extracted schemas. You no longer should download the DDL extractor script to extract DDLs for your schemas. |
