---
title: Quick start to migration

redirects:
  - /migration_portal/latest/03_mp_using_portal/03_mp_quick_start/
---

![The assessment and migration process](/images/mp_using_portal_old.png)
...
1. Refer to the Knowledge Base for checking the possible workarounds for the objects that aren't compatible in EDB Postgres Advanced Server.
