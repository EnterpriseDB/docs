...
- The DDL generated by Oracle’s Data Pump utility might contain ALTER STATEMENTS such as ALTER FUNCTION, ALTER PACKAGE, and ALTER TYPE. Migration Portal does not process these statements.  
