...
It uses Microsoft Azure's OpenAI services and is trained on both EDB's product documentation and support knowledge base to deliver use-case specific solutions. 
...
You can also provide more detailed feedback or report an issue by noting down the conversation ID and sharing it with the support team.

![Feedback via conversation ID and icon](../../images/mp_ai_copilot_feedback.png)
