...
It uses third party OpenAI-based services and is trained on both EDB's product documentation and support knowledge base to deliver use-case specific solutions. 
