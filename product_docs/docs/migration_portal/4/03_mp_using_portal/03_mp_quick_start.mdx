...
1. Verify the DDL objects, for example, TABLES that don't show a 100% success ratio.

1. Select the objects that aren't compatible with EDB Postgres Advanced Server.

1.  To look up and understand possible workarounds for the objects that aren't compatible in EDB Postgres Advanced Server, refer to the Knowledge Base or interact with the [AI Copilot](/migration_portal/latest/03_mp_using_portal/mp_ai_copilot/).
   
   !!! Important
   Ensure you test all suggested solutions to confirm the converted schemas behave as expected.
   !!!
