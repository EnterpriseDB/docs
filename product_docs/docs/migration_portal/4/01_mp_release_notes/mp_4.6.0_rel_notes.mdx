...
EDB Postgres Advanced Server version 11 standard support is ending by November 20, 2023. The support for EDB Postgres Advanced Sever version 11 is removed from Migration Portal on May 20, 2023 to ensure that no new EDB Postgres Advanced Server version 11 projects are created post this date.
