...
The AI Copilot is a tool designed to assist you with issues that come up during the migration of DDLs. 
While this tool can greatly aid in problem-solving, it's important to understand that generative AI technology will sometimes generate inaccurate or irrelvant responses. 
The accuracy and quality of recommended solutions is heavily influenced by the user's [prompt and query strategies](/03_mp_using_portal/ai_good_prompts/).
