...
The uppercase naming convention is preserved for all object names, except for object references within procedural objects, including triggers, procedures, functions, package specs and package bodies. For these database objects, the uppercase naming convention is applied to:
