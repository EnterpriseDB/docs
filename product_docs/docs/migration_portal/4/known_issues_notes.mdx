...
The AI Copilot is a tool designed to assist you with issues that come up while migrating DDLs. 
...
The accuracy and quality of recommended solutions is heavily influenced by your [prompt and query strategies](/03_mp_using_portal/ai_good_prompts/).
