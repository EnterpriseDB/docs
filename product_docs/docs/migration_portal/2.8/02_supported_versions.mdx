...
The Migration Portal supports assessment and migration from Oracle 11g and 12c to EDB Advanced Server 10, 11, or 12. Migration Portal is supported on the following browsers and operating systems:
