...
> **Note:** In case your schemas are not 100% compatible, a banner will be displayed as shown, and you can fill the Contact Us form for any assistance required.
...
To migrate schemas on EDB Postgres Advanced Server on Cloud, complete the following steps:
