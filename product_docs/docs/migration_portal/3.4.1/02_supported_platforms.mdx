...
The Migration Portal supports assessment and migration from Oracle 11g, 12c, 18c, and 19c to EDB Postgres Advanced Server 10, 11, 12, 13, or 14. Migration Portal is supported on the following browsers and operating systems.
