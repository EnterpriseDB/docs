...
| Type           | Description                                                                                                                                                                            | ID |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -- |
| Feature        | New section in setting called `Comparison Key` allows users to define a custom comparison key (list of columns) per table. This can be useful for tables without primary keys or unique indexes. | LIV-5 |
