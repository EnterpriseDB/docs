...
If running LiveCompare against an Oracle database, Oracle Instant Client must be installed.
Refer to [Oracle Support Requirements](oracle_support/#requirements) for additional information.
