...
|-------------------------------------|--------------------------------------------|---------------------------|
| PostgreSQL                          | 10¹, 11¹, 12¹, 13¹, 14, 15, 16, 17, and 18 | Data and output           |
| EDB Postgres Extended (PGE)         | 10¹, 11¹, 12¹, 13¹, 14, 15, 16, 17, and 18 | Data and output           |
| EDB Postgres Advanced Server (EPAS) | 11¹, 12¹, 13¹, 14, 15, 16, 17, and 18      | Data and output           |
