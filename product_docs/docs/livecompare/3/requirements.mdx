...
* an x86 platform with Debian 11, 12, or 13; Ubuntu 20.04/22.04; SLES 12 SP5 and 15 SP3; RHEL 8, 9, or 10; or CentOS/RockyLinux/AlmaLinux 8 or 9
* an IBM Power ppc64le platform with RHEL 8, 9, or 10, or SLES 12 SP5/15 SP3+
* an ARM64 platform with Debian 12 or 13.

If your system has internet access, then installing the LiveCompare package using your package manager installs EDB Python (package name `edb-python312`) as a dependency.
