...
> pg_upgrade --old-datadir *path_to_9.4_data_directory* --new-datadir *path_to_9.5_data_directory* --user *superuser_name* --old-bindir *path_to_9.4_bin_directory* --new-bindir *path_to_9.5_bin_directory* --old-port *9.4_port* --new-port *9.5_port*
...
> pg_upgrade -d /opt/PostgresPlus/9.4AS/data -D /opt/PostgresPlus/9.5AS/data -U enterprisedb -b /opt/PostgresPlus/9.4AS/bin -B /opt/PostgresPlus/9.5AS/bin -p 5444 -P 5445 --check
...
> pg_upgrade -d /opt/PostgresPlus/9.4AS/data -D /opt/PostgresPlus/9.5AS/data -U enterprisedb -b /opt/PostgresPlus/9.4AS/bin -B /opt/PostgresPlus/9.5AS/bin -p 5444 -P 5445
...
1.  Restart the Advanced Server service.
    ...
    Use StackBuilder Plus to download and install the missing module as described in [Using Stackbuilder Plus](004_installing_advanced_server_with_the_interactive_installer/#using-stackbuilder-plus).
