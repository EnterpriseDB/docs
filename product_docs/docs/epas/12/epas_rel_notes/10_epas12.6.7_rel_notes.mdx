...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------- |
| Upstream Merge | Merged with community PostgreSQL 12.6. See the community [Release Notes](https://www.postgresql.org/docs/12/release-12-6.html) for details.                                        |         |                |
