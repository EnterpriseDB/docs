---
title: "Version 12.12.16"
---

EDB Postgres Advanced Server 12.12.16 includes the following bug fixes:

| Type           | Description                                                                                                                          | ID      | Category         |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------| ------- | ---------------- |
| Upstream merge | Merged with community PostgreSQL 12.12. See the community [Release Notes](https://www.postgresql.org/docs/release/12.12/) for details.                                              |         |                  |
