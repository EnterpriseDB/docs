...
redirects:
  - /epas/12/epas_inst_linux/installing_epas_using_edb_repository/ibm_power_ppc64le/epas_rhel9_ppcle
  - /epas/12/epas_inst_linux/installing_epas_using_edb_repository/ppcle/epas_rhel9_ppcle
---
...
Where `<xx>` is the version of the EDB Postgres Advanced Server you're installing. For example, if you're installing version 12, the package name is `edb-as12-server`.
