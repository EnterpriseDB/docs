...
redirects:
  - /epas/12/epas_inst_linux/
  - /epas/12/epas_inst_linux/installing_epas_using_edb_repository/
  - /epas/12/epas_inst_linux/03_using_a_package_manager_to_install_advanced_server/
