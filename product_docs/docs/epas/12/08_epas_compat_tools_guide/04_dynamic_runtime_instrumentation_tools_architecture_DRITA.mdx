...
<table><tbody><tr class="odd"><td>Column Name</td><td><blockquote><p>Description</p></blockquote></td></tr><tr class="even"><td><code>SCHEMA</code></td><td><blockquote><p>The name of the schema in which the table resides.</p></blockquote></td></tr><tr class="odd"><td><code>RELATION</code></td><td><blockquote><p>The name of the table.</p></blockquote></td></tr><tr class="even"><td><code>HEAP READ</code></td><td><blockquote><p>The number of heap blocks read.</p></blockquote></td></tr><tr class="odd"><td><code>HEAP HIT</code></td><td><blockquote><p>The number of heap blocks hit.</p></blockquote></td></tr><tr class="even"><td><code>IDX READ</code></td><td><blockquote><p>The number of index blocks read.</p></blockquote></td></tr><tr class="odd"><td><code>IDX HIT</code></td><td><blockquote><p>The number of index blocks hit.</p></blockquote></td></tr><tr class="even"><td><code>TOAST READ</code></td><td><blockquote><p>The number of toast blocks read.</p></blockquote></td></tr><tr class="odd"><td><code>TOAST HIT</code></td><td><blockquote><p>The number of toast blocks hit.</p></blockquote></td></tr><tr class="even"><td><code>TIDX READ</code></td><td><blockquote><p>The number of toast index blocks read.</p></blockquote></td></tr><tr class="odd"><td><code>TIDX HIT</code></td><td><blockquote><p>The number of toast index blocks hit.</p></blockquote></td></tr></tbody></table>
...
<table><tbody><tr class="odd"><td>Column Name</td><td><blockquote><p>Description</p></blockquote></td></tr><tr class="even"><td><code>SCHEMA</code></td><td><blockquote><p>The name of the schema in which the index resides.</p></blockquote></td></tr><tr class="odd"><td><code>RELATION</code></td><td><blockquote><p>The name of the table on which the index is defined.</p></blockquote></td></tr><tr class="even"><td><code>INDEX</code></td><td><blockquote><p>The name of the index.</p></blockquote></td></tr><tr class="odd"><td><code>IDX SCAN</code></td><td><blockquote><p>The number of indexes scans initiated on this index.</p></blockquote></td></tr><tr class="even"><td><code>IDX TUP READ</code></td><td><blockquote><p>Number of index entries returned by scans on this index</p></blockquote></td></tr><tr class="odd"><td><code>IDX TUP FETCH</code></td><td><blockquote><p>Number of live table rows fetched by simple index scans using this index.</p></blockquote></td></tr></tbody></table>
