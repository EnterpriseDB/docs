...
> A `DBMS_UTILITY LNAME_ARRAY` (as described in the <span class="title-ref">LNAME\_ARRAY &lt;lname\_array&gt;</span> section).

`UNCL_ARRAY`

> A `DBMS_UTILITY UNCL_ARRAY` (as described in the <span class="title-ref">UNCL\_ARRAY &lt;uncl\_array&gt;</span> section).
...
> A `DBMS_UTILITY UNCL_ARRAY` (as described the <span class="title-ref">UNCL\_ARRAY &lt;uncl\_array&gt;</span> section).
