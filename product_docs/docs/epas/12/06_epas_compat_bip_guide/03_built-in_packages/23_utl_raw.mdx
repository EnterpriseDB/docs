...
| CONVERT(r IN RAW, to\_charset IN VARCHAR2, from\_charset IN VARCHAR2 | Function              | RAW         | Converts encoded data from one encoding to another, and returns the result as a RAW value. |
