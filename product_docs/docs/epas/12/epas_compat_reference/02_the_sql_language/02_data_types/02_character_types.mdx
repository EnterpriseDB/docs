 ...
 **Note**: The `CLOB` data type is actually a `DOMAIN` based on the PostgreSQL `TEXT` data type. For information on a `DOMAIN`, see the PostgreSQL core documentation at <https://www.postgresql.org/docs/12/static/sql-createdomain.html>
