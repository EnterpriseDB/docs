...
> **Note:** To install Slony Replication for Advanced Server version 9.5, you need to execute the `yum install ppas95-replication` command.
...
> **Note:** To install Slony Replication for Advanced Server version 9.5, you need to execute the `yum install ppas95-replication` command. The `ppas95-replication.service` path is `/usr/lib/systemd/system/ppas95-replication.service` and the installation path is `/usr/ppas-9.5`.
