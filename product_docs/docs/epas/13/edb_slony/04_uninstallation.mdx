...
<figure><img src="images/slony_uninstall.png" class="align-center" alt="The Slony Replication Uninstaller" /><figcaption aria-hidden="true"><em>The Slony Replication Uninstaller</em></figcaption></figure>

1.  The uninstallation process begins. Click `OK` once the process completes.

<figure><img src="images/slony_uninstall2.png" class="align-center" alt="Uninstallation completes" /><figcaption aria-hidden="true"><em>Uninstallation completes</em></figcaption></figure>
