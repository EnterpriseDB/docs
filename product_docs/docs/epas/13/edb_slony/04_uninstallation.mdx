...
> **Note:** To uninstall Slony Replication for Advanced Server 9.5 version, you need to execute the `yum remove ppas95-replication` command.
...
> **Note:** To uninstall Slony Replication for Advanced Server 9.5 version, you need to execute the `apt-get remove ppas95-replication` command.
