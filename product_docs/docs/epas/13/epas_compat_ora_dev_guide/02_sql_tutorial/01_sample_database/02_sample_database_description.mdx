...
<figure><img src="../../images/sample_database_tables.png" class="align-center" alt="Sample Database Tables" /><figcaption aria-hidden="true"><em>Sample Database Tables</em></figcaption></figure>
