...
The statistics for a role that has been removed are not deleted until you use the <span class="title-ref">drop\_stats function &lt;drop\_stats&gt;</span>.

The offending queries for a role that has been removed are not deleted until you use the <span class="title-ref">drop\_queries function &lt;drop\_queries&gt;</span>.
