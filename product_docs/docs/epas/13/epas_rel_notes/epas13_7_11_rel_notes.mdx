...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------| ------- | ---------------- |
| Upstream merge | Merged with community PostgreSQL 13.7.11. See the community [Release Notes](https://www.postgresql.org/docs/release/13.7/) for details.                                              |         |                  |
