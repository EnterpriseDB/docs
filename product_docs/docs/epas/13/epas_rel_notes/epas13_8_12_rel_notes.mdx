---
title: "Version 13.8.12"
---

EDB Postgres Advanced Server 13.8.12 includes the following bug fixes:

| Type           | Description                                                                                                                          | ID      | Category         |
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------| ------- | ---------------- |
| Upstream merge | Merged with community PostgreSQL 13.8.12. See the community [Release Notes](https://www.postgresql.org/docs/release/13.8/) for details.                                              |         |                  |
...
| Bug fix        | Fix the server crash that fast pruning can cause in partition-wise join. [Support Ticket: #79071]            | DB-1751 |        |
