...
| Type            | Description                                                                                                                                                                                                                                                                                                                                                      | 
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | 
| Upstream Merges | Merged with community PostgreSQL 13 and 13.1. See the community Release Notes of [13](https://www.postgresql.org/docs/13/release-13.html) and [13.1](https://www.postgresql.org/docs/release/13.1/) for details.                                                                                                                                                 |
