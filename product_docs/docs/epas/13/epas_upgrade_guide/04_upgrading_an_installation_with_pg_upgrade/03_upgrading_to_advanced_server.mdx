...
<figure><img src="../images/configuring_advanced_server_to_use_trust_authentication.png" class="align-center" alt="Configuring Advanced Server to use trust authentication." /><figcaption aria-hidden="true"><em>Configuring Advanced Server to use trust authentication.</em></figcaption></figure>
