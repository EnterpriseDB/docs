...
example\_partition\_by\_list example\_automatic\_list\_partition example\_partition\_by\_range example\_interval\_range\_partition example\_partition\_by\_hash example\_partitions\_number example\_partition\_by\_range\_subpartition\_by\_list
