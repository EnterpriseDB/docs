...
<figure><img src="../images/connecting_to_server.png" class="align-center" alt="Connecting to the server" /><figcaption aria-hidden="true"><em>Connecting to the server</em></figcaption></figure>
