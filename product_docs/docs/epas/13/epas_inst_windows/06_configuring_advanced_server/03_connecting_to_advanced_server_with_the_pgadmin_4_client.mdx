...
<figure><img src="../images/pgadmin4_client_dashboard.png" class="align-center" alt="The pgAdmin 4 client Dashboard" /><figcaption aria-hidden="true"><em>The pgAdmin 4 client Dashboard</em></figcaption></figure>
...
<figure><img src="../images/connecting_server.png" class="align-center" alt="The Connect to Server dialog" /><figcaption aria-hidden="true"><em>The Connect to Server dialog</em></figcaption></figure>

Provide the password associated with the database superuser in the `Password` field, and click `OK` to connect.

<figure><img src="../images/connecting_to_advanced_server_database.png" class="align-center" alt="Connecting to an Advanced Server database" /><figcaption aria-hidden="true"><em>Connecting to an Advanced Server database</em></figcaption></figure>
