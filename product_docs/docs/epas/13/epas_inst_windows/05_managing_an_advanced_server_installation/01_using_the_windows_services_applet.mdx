...
<figure><img src="../images/advanced_server_services.png" class="align-center" alt="The Advanced Server service in the Windows Services window" /><figcaption aria-hidden="true"><em>The Advanced Server service in the Windows Services window</em></figcaption></figure>
