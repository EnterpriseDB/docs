...
<figure><img src="images/stack_builder_welcome.png" class="align-center" alt="The Stack Builder welcome window" /><figcaption aria-hidden="true"><em>The Stack Builder welcome window</em></figcaption></figure>
...
<figure><img src="images/module_selection.png" class="align-center" alt="The Stack Builder module selection window" /><figcaption aria-hidden="true"><em>The Stack Builder module selection window</em></figcaption></figure>
...
<figure><img src="images/checkbox_module.png" class="align-center" alt="Check the box to add new module" /><figcaption aria-hidden="true"><em>Check the box to add new module</em></figcaption></figure>

The `Selected packages` window confirms the packages selected.

<figure><img src="images/summary_of_selected_packages.png" class="align-center" alt="A summary window displays a list of selected packages" /><figcaption aria-hidden="true"><em>A summary window displays a list of selected packages</em></figcaption></figure>
...
<figure><img src="images/download_completes.png" class="align-center" alt="Confirmation that the download process is complete" /><figcaption aria-hidden="true"><em>Confirmation that the download process is complete</em></figcaption></figure>
