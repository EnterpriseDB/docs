...
| varaccess<br /><br />varsrc | "char"<br /><br />text | not null  | `+` if the variable is visible outside of the package.<br /><br />`-` if the variable is only visible within the package.<br /><br />Note: Public variables are declared within the package header, private variables are declared within the package body. Contains the source of the variable declaration, including any default value expressions for the variable. |
