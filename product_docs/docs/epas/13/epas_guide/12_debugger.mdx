...
<figure><img src="images/starting_the_debugger_from_object_menu.png" class="align-center" alt="Starting the Debugger from the Object menu" /><figcaption aria-hidden="true"><em>Starting the Debugger from the Object menu</em></figcaption></figure>
...
<figure><img src="images/starting_the_debugger_from_context_menu.png" class="align-center" alt="Starting the Debugger from the object’s context menu" /><figcaption aria-hidden="true"><em>Starting the Debugger from the object’s context menu</em></figcaption></figure>
...
<figure><img src="images/debugger_window.png" class="align-center" alt="The Debugger window" /><figcaption aria-hidden="true"><em>The Debugger window</em></figcaption></figure>
...
<figure><img src="images/main_debugger_window.png" class="align-center" alt="The Main Debugger window" /><figcaption aria-hidden="true"><em>The Main Debugger window</em></figcaption></figure>
...
<figure><img src="images/program_body.png" class="align-center" alt="The Program Body" /><figcaption aria-hidden="true"><em>The Program Body</em></figcaption></figure>
...
<figure><img src="images/parameters_tab.png" class="align-center" alt="The Parameters tab" /><figcaption aria-hidden="true"><em>The Parameters tab</em></figcaption></figure>

<figure><img src="images/local_variables_tab.png" class="align-center" alt="The Local variables tab" /><figcaption aria-hidden="true"><em>The Local variables tab</em></figcaption></figure>

<figure><img src="images/messages_tab.png" class="align-center" alt="The Messages tab" /><figcaption aria-hidden="true"><em>The Messages tab</em></figcaption></figure>

<figure><img src="images/results_tab.png" class="align-center" alt="The Results tab" /><figcaption aria-hidden="true"><em>The Results tab</em></figcaption></figure>
...
<figure><img src="images/stack_tab.png" class="align-center" alt="A debugged program calling a subprogram" /><figcaption aria-hidden="true"><em>A debugged program calling a subprogram</em></figcaption></figure>
...
<figure><img src="images/stack_tab.png" class="align-center" alt="Debugging the called subprogram" /><figcaption aria-hidden="true"><em>Debugging the called subprogram</em></figcaption></figure>
...
<figure><img src="images/stack_tab.png" class="align-center" alt="Control returns from debugged subprogram" /><figcaption aria-hidden="true"><em>Control returns from debugged subprogram</em></figcaption></figure>
...
<figure><img src="images/toolbar_icons.png" class="align-center" alt="The Tool bar icons" /><figcaption aria-hidden="true"><em>The Tool bar icons</em></figcaption></figure>
...
<figure><img src="images/setting_global_breakpoint_from_left-hand_margin.png" class="align-center" alt="Set a breakpoint by clicking in left-hand margin" /><figcaption aria-hidden="true"><em>Set a breakpoint by clicking in left-hand margin</em></figcaption></figure>
...
<figure><img src="images/clear_breakpoints.png" class="align-center" alt="Clear all breakpoints icon" /><figcaption aria-hidden="true"><em>Clear all breakpoints icon</em></figcaption></figure>
...
<figure><img src="images/setting_global_breakpoint_from_object_menu.png" class="align-center" alt="Setting a global breakpoint from the Object menu" /><figcaption aria-hidden="true"><em>Setting a global breakpoint from the Object menu</em></figcaption></figure>
...
<figure><img src="images/setting_global_breakpoint_from_left-hand_margin.png" class="align-center" alt="Setting a global breakpoint from the object&#39;s context menu" /><figcaption aria-hidden="true"><em>Setting a global breakpoint from the object's context menu</em></figcaption></figure>
...
<figure><img src="images/waiting_invocation_program_debugged.png" class="align-center" alt="Waiting for invocation of program to be debugged" /><figcaption aria-hidden="true"><em>Waiting for invocation of program to be debugged</em></figcaption></figure>
...
<figure><img src="images/parameters_tab.png" class="align-center" alt="Program on which a global breakpoint has been set" /><figcaption aria-hidden="true"><em>Program on which a global breakpoint has been set</em></figcaption></figure>
...
<figure><img src="images/exiting_from_debugger.png" class="align-center" alt="Exiting from the Debugger" /><figcaption aria-hidden="true"><em>Exiting from the Debugger</em></figcaption></figure>
