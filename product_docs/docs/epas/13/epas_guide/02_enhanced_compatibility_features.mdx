...
| DBMS\_RANDOM    | The DBMS\_RANDOM package provides a number of methods to generate random values.                                                                                                                                    |
| DBMS\_REDACT    | The DBMS\_REDACT package enables the redacting or masking of data that is returned by a query.                                                                                                                      |
...
| DBMS\_SQL       | The DBMS\_SQL package provides an application interface to the EDB dynamic SQL functionality.                                                                                                                       |
...
<figure><img src="images/open_client_library.png" class="align-center" alt="The Open Client Library" /><figcaption aria-hidden="true"><em>The Open Client Library</em></figcaption></figure>
