...
<figure><img src="../images/postgresql_conf_file.png" class="align-center" alt="The postgresql.conf file" /><figcaption aria-hidden="true"><em>The postgresql.conf file</em></figcaption></figure>
