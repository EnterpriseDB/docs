...
<figure><img src="../images/advanced_server_startup.png" class="align-center" alt="Specifying Advanced Server&#39;s startup behavior" /><figcaption aria-hidden="true"><em>Specifying Advanced Server's startup behavior</em></figcaption></figure>
