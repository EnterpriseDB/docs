...
<figure><img src="images/pgadmin4_from_applications_menu.png" class="align-center" alt="Accessing EDB pgAdmin 4 from Applications Menu." /><figcaption aria-hidden="true"><em>Accessing EDB pgAdmin 4 from Applications Menu.</em></figcaption></figure>
