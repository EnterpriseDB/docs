...
<figure><img src="images/hadoop_distributed_file_system_with_postgres.png" class="align-center" alt="Using a Hadoop distributed file system with Postgres" /><figcaption aria-hidden="true"><em>Using a Hadoop distributed file system with Postgres</em></figcaption></figure>
