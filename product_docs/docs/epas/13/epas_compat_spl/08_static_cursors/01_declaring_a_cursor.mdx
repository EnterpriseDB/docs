...
> **Note:** An extension of this syntax allows the use of parameters. This is discussed in more detail in [Parameterized Cursors](../08_static_cursors/#parameterized_cursors).
