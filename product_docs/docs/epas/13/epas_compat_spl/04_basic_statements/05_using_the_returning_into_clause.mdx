...
The following example is a modification of the `emp_comp_update` procedure introduced in [UPDATE](../04_basic_statements/#update), with the addition of the `RETURNING INTO` clause.
