...
For additional information on the `SQLCODE` and `SQLERRM` variables, see [Errors and Messages](../12_working_with_collections/05_errors_and_messages/#errors_and_messages), *Errors and Messages*.
