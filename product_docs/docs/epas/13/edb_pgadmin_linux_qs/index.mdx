...
1.  **Install EPEL Repository**
    ...
    > **Note:** To install EPEL repository on CentOS/RHEL6.x, RHEL 7.x and CentOS/RHEL 8.x see the platform specific steps at [EDB Website](https://repos.enterprisedb.com/).
