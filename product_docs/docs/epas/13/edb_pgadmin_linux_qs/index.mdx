...
1.  **Install EPEL Repository**
    ...
    To install EPEL repository on CentOS/RHEL6.x, RHEL 7.x and CentOS/RHEL 8.x see the platform specific steps at [EDB Website](https://repos.enterprisedb.com/).
...
<figure><img src="images/pgadmin4_from_applications_menu.png" class="align-center" alt="Accessing pgAdmin 4 from Applications Menu." /><figcaption aria-hidden="true"><em>Accessing pgAdmin 4 from Applications Menu.</em></figcaption></figure>
...
<figure><img src="images/server_general.png" class="align-center" alt="Create Server dialog" /><figcaption aria-hidden="true"><em>Create Server dialog</em></figcaption></figure>
...
<figure><img src="images/connect_to_epas_server.png" class="align-center" alt="Connecting to EPAS Server through EDB pgAdmin 4." /><figcaption aria-hidden="true"><em>Connecting to EPAS Server through EDB pgAdmin 4.</em></figcaption></figure>

Once you are connected to the server, you can see the `Dashboard` tab as shown below:

<figure><img src="images/edb_pgadmin4_first_look.png" class="align-center" alt="EPAS Server - Dashboard" /><figcaption aria-hidden="true"><em>EPAS Server - Dashboard</em></figcaption></figure>
