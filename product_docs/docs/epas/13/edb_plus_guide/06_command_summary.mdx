...
>
>
> `connectstring` is the database connection string. See <span class="title-ref">Using EDB\*Plus &lt;using\_edb\_plus&gt;</span> for further information on the database connection string.
>
