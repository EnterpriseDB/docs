...
> ``` text
> sed -i "s@<username>:<password>@USERNAME:PASSWORD@" /etc/yum.repos.d/
> edb.repo
> ```
...
>
> ``` text
> rpm --import https://public.dhe.ibm.com/software/server/POWER/Linux/
> toolchain/at/redhat/RHEL7/gpg-pubkey-6976a827-5164221b
> ```
>
...
> $(lsb_release -cs)-edb/ $(lsb_release -cs) main" > /etc/apt/sources.
> list.d/edb-$(lsb_release -cs).list'
> ```
>
> On Debian 10:
>
...
>
> > ``` text
> > sh -c 'echo "deb [arch=amd64] https://apt.enterprisedb.com/
...
> ``` text
> wget -q -O - https://apt.enterprisedb.com/edb-deb.gpg.key  | sudo
> apt-key add -
> ```
...
<figure><img src="images/edb_plus_welcome.png" class="align-center" alt="The EDBPlus Welcome window*" /><figcaption aria-hidden="true"><em>The EDB</em>Plus Welcome window*</figcaption></figure>
...
<figure><img src="images/advanced_server_installation_details.png" class="align-center" alt="The Advanced Server Installation Details window" /><figcaption aria-hidden="true"><em>The Advanced Server Installation Details window</em></figcaption></figure>
...
<figure><img src="images/installation_complete.png" class="align-center" alt="The installation is complete" /><figcaption aria-hidden="true"><em>The installation is complete</em></figcaption></figure>
