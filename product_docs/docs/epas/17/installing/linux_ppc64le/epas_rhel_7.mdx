...
redirects:
  - /epas/16/epas_inst_linux/installing_epas_using_edb_repository/ibm_power_ppc64le/epas_rhel7_ppcle
  - /epas/16/epas_inst_linux/installing_epas_using_edb_repository/ppcle/epas_rhel7_ppcle
---
