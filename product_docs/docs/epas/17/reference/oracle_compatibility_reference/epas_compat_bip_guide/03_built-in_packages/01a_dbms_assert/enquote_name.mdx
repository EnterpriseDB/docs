...
The `ENQUOTE_NAME` function wraps quotation marks around a string, unless the input is already enclosed in quotation marks. The string can include a quotation mark but output for the string puts quotation marks around the input quotation mark. 
