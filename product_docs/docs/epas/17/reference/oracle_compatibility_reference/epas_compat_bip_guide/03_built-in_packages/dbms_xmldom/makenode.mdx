...
This example creates a new XML DOMDocument, and turns it into a node so it can be root. Then, it creates a DOMElement named “Departments”, turns it into a node and appends it to the DOMDocument. It then creates a text node named “Dept list” and appends it to the “Departments” node.
