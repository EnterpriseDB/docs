---
title: Version 10.9.17
---

EDB Postgres Advanced Server 10.9.17 includes the following bug fixes:

| Type           | Description                                                                                                                                                                            | ID     | Category      | 
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------- |
| Upstream Merge | Merged with community PostgreSQL 10.9. See the community [Release Notes](https://www.postgresql.org/docs/10/release-10-9.html) for details.                                          |        |               |
