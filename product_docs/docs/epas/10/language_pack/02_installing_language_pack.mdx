...
`set PYTHONHOME=C:\edb\languagepack-10\x64\Python-3.6`

Use the following commands to add Python, Perl and Tcl to your search path:

```text
set PATH=C:\edb\languagepack-10\x64\Python-3.6;
C:\edb\languagepack-10\x64\Perl-5.26\bin;
...
```text
PERLHOME=/Library/edb/languagepack-10/Perl-5.26
PYTHONHOME=/Library/edb/languagepack-10/Python-3.6
