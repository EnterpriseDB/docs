...
To open pgAdmin, use the `Start` menu to access the `EDB Postgres` menu; navigate through the `Advanced Server 10` menu to select `pgAdmin`. The client opens in your default browser.
