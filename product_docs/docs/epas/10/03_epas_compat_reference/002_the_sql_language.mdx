...
[CREATE SEQUENCE](#create-sequence), [DROP SEQUENCE](#drop-sequence)
...
[CREATE ROLE](#create-role), [SET ROLE](#set-role), [GRANT](#grant), [REVOKE](#revoke)
...
[ALTER SEQUENCE](#alter-sequence), [CREATE SEQUENCE](#create-sequence)
