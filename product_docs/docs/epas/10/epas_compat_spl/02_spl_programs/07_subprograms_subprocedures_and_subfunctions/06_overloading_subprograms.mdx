...
For detailed information about the data types supported by Advanced Server, see the [Data types](/epas/10/epas_compat_reference/02_the_sql_language/02_data_types/).
