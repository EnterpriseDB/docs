...
redirects:
  ...
  - /epas/11/epas_inst_linux/installing_epas_using_edb_repository/ppcle/epas_rhel7_ppcle
---
...
Where `<xx>` is the version of the EDB Postgres Advanced Server you're installing. For example, if you're installing version 11, the package name is `edb-as11-server`.
