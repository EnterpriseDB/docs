...
redirects:
  - /epas/11/epas_inst_linux/
  - /epas/11/epas_inst_linux/installing_epas_using_edb_repository/
  - /epas/11/epas_inst_linux/03_using_a_package_manager_to_install_advanced_server/
