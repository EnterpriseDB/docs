...
| -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------- |
| Upstream Merge | Merged with community PostgreSQL 11.10. See the community [Release Notes](https://www.postgresql.org/docs/10/release-11-10.html) for details.                                          |        |               |
