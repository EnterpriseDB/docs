...
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | -------------- |
| Upstream Merge | Merged with communuity PostgreSQL PostgreSQL 11.12. See the community [Release Notes](https://www.postgresql.org/docs/11/release-11-12.html) for details.                          |         |                |
