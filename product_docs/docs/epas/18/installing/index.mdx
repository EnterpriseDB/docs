...
redirects:
  - /epas/18/epas_inst_linux/
  - /epas/18/epas_inst_linux/installing_epas_using_edb_repository/
  - /epas/18/epas_inst_linux/03_using_a_package_manager_to_install_advanced_server/
...
- [Debian 12](linux_x86_64/epas_debian_12)
