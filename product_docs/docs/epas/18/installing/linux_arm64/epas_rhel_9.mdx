...
redirects:
  - /epas/18/epas_inst_linux/installing_epas_using_edb_repository/arm64/epas_rhel9_arm
  - /epas/18/epas_inst_linux/installing_epas_using_edb_repository/arm/epas_rhel9_arm
---
