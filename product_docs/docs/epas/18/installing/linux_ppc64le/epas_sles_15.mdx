...
redirects:
  - /epas/18/epas_inst_linux/installing_epas_using_edb_repository/ibm_power_ppc64le/epas_sles15_ppcle
  - /epas/18/epas_inst_linux/installing_epas_using_edb_repository/ppcle/epas_sles15_ppcle
---
...
Where `<xx>` is the version of the EDB Postgres Advanced server you are installing. For example, if you are installing version 18, the package name would be `edb-as18-server`.
