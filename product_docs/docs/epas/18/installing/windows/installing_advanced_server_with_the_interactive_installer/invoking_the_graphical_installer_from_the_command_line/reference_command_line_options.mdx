...
`--prefix installation_dir/as18`

Specifies an installation directory for EDB Postgres Advanced Server. The installer appends a version-specific subdirectory (that is, `as18`) to the specified directory. The default installation directory is:
...
Specifies the name of the EDB Postgres Advanced Server service. The default is `edb-as-18`.
