...
- edb_dynatune focuses its automatic tuning efforts on these parameters: 
   ...
   Keep in mind that the tuning logic is limited, and any parameter that has been manually set will be excluded from the automatic tuning process.
