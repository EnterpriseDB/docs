---
title: EDB Postgres Advanced Server 18.6.0 release notes
...
|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| Upstream&nbsp;merge | Merged with community PostgreSQL 18.6. See the [PostgreSQL 18.6 release notes](https://www.postgresql.org/docs/release/18.6/) for more information.                                                                        |                 |
