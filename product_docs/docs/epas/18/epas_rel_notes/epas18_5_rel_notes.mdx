---
title: EDB Postgres Advanced Server 18.5.0 release notes
...
- On Windows, EPAS 18.5.0 is bundled with OpenSSL 3.5.7.
!!!

EDB Postgres Advanced Server 18.5.0 includes the following enhancements and bug fixes:

| Type              | Description                                                                                                                                                                                                                   | Addresses&nbsp; |
|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| Upstream&nbsp;merge | Merged with community PostgreSQL 18.5. See the [PostgreSQL 18.5 release notes](https://www.postgresql.org/docs/release/18.5/) for more information.                                                                        |                 |
