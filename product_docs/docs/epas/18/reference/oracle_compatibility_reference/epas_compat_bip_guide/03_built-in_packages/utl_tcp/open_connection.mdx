...
`wallet_path`
 ...
 The `wallet_path` is added for redwood compatibility and should be set to NULL.

`wallet_password`
 
 The `wallet_password` is added for redwood compatibility and should set to NULL.
