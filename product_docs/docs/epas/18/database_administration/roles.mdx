...
For the complete list of the PostgreSQL predefined roles, see [Predefined roles](https://www.postgresql.org/docs/18/predefined-roles.html) in the PostgreSQL documentation. 
