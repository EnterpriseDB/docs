...
title: "EDB Postgres Advanced Server 14 Release Notes"
---
...
EDB Postgres Advanced Server 14 adds a number of new features that will delight developers and DBAs alike, including:
...
-   *Database Compatibility for Oracle Developer SQL Guide*
-   *Database Compatibility for Oracle Developer Reference Guide*
-   *Database Compatibility for Oracle Developer Built-in Package Guide*
-   *Database Compatibility for Oracle Developer Tools and Utilities Guide*
