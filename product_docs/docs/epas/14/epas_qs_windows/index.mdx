...
By default, Advanced Server is configured to start the service when the system boots. Click `Next` to continue.
...
For more detailed product usage information, see the [Advanced Server documentation](/epas/latest/) available at the EDB website.
