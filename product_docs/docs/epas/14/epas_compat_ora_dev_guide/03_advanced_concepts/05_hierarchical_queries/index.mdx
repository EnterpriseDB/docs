...
-  If the `CONNECT BY condition` is compound, only one condition requires the `PRIOR` operator, although there can be multiple `PRIOR` conditions.

-  `PRIOR` keyword can be used to evaluate the parent row in a parent-child relationship in a hierarchical query. `PRIOR` takes the same precedence as `+` and `-` operators.
...
-  The `NOCYCLE` keyword can be used with or without the `CONNECT_BY_ISCYCLE` pseudo-column which, shows if the current row contains a cycle. The possible values for `CONNECT_BY_ISCYCLE` pseudo-column is either 0 or 1; returns 1 when a loop is detected in the `CONNECT BY` query, otherwise returns 0.
...
The following example uses the `NOCYCLE` keyword with `CONNECT BY` clause to return rows that contain the cycle. The `CONNECT_BY_ISCYCLE` shows which rows have the cycle.

```text
SELECT LPAD(ename,length(ename)+2 *(LEVEL - 1),' ') AS employee, empno, mgr, LEVEL, CONNECT_BY_ISCYCLE
FROM emp
...
```text
employee     | empno | mgr  | level | connect_by_iscycle 
-------------+-------+------+-------+--------------------
 SMITH       |  7369 | 7902 |     1 |                  0
 ALLEN       |  7499 | 7698 |     1 |                  0
 WARD        |  7521 | 7698 |     1 |                  0
 JONES       |  7566 | 7839 |     1 |                  0
 MARTIN      |  7654 | 7698 |     1 |                  0
 BLAKE       |  7698 | 7839 |     1 |                  0
 CLARK       |  7782 | 7839 |     1 |                  0
 SCOTT       |  7788 | 7566 |     1 |                  0
 KING        |  7839 |      |     1 |                  0
 TURNER      |  7844 | 7698 |     1 |                  0
 ADAMS       |  7876 | 7788 |     1 |                  0
 JAMES       |  7900 | 7698 |     1 |                  0
 FORD        |  7902 | 7566 |     1 |                  0
 MILLER      |  7934 | 7782 |     1 |                  0
   SMITH     |  7369 | 7902 |     2 |                  0
   ALLEN     |  7499 | 7698 |     2 |                  0
   WARD      |  7521 | 7698 |     2 |                  0
   JONES     |  7566 | 7839 |     2 |                  0
   MARTIN    |  7654 | 7698 |     2 |                  0
   BLAKE     |  7698 | 7839 |     2 |                  0
   CLARK     |  7782 | 7839 |     2 |                  0
   SCOTT     |  7788 | 7566 |     2 |                  0
   TURNER    |  7844 | 7698 |     2 |                  0
   ADAMS     |  7876 | 7788 |     2 |                  0
   JAMES     |  7900 | 7698 |     2 |                  0
   FORD      |  7902 | 7566 |     2 |                  0
   MILLER    |  7934 | 7782 |     2 |                  0
     SMITH   |  7369 | 7902 |     3 |                  0
     ALLEN   |  7499 | 7698 |     3 |                  0
     WARD    |  7521 | 7698 |     3 |                  0
