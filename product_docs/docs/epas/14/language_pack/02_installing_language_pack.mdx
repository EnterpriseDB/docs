...
After installing Language Pack, set the following variables with these steps:

1. Go to **This PC > Properties > Advanced System Settings > Environment Variables**.

1. Edit the system-wide PATH variables. Add the following commands: 

   ```text 
   C:\edb\as\languagepack\v1\Python-3.7\
   ```

   and

   ```text
   C:\edb\as\languagepack\v1\Python-3.7\Scripts
   ```

1. Close the dialog box. 

1. Restart the EDB Postgres Advanced Server. 
