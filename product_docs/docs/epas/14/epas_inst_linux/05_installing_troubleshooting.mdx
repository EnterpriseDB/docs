...
If you encounter difficulty when installing the `EPEL` release package, you can use the following command to install the `epel-release` package on RHEL or CentOS 7.x and RHEL or Rocky Linux 8.x:
