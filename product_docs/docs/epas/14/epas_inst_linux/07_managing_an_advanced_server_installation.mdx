...
| ------------------------------ | ------------------------ | --------------------------------------- |
| Advanced Server                | edb-as-14                | edb-as@14-main                          |
...
### Controlling a Service on RHEL or CentOS 7.x | RHEL or Rocky Linux 8.x
...
If your installation of Advanced Server resides on version 9.x of Debian or 18.04 | 20.04 of Ubuntu, assume superuser privileges and invoke the following commands (using bundled scripts) to manage the service. Use the following commands to:
