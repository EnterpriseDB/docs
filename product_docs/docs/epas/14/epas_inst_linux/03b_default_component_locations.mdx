---
title: Default Component Install Locations
---

## Default Location of components for CentOS and RHEL
The RPM installers for CentOS and RHEL place Advanced Server components in the directories listed in the table below:
...
## Default Location of components for Debian
