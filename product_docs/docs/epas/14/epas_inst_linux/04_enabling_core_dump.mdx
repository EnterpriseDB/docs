...
## Enabling Core Dumps on a RHEL or CentOS or Rocky Linux Host

On a RHEL or CentOS 7.x | RHEL or Rocky Linux 8.x, core file creation is disabled by default. To enable the core file generation, follow the following commands:
