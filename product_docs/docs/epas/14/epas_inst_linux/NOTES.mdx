...
START COMMENT??: Moved to Default Location of Components
...
START COMMENT-WIP: See notes about proposed structure
...
END COMMENT
START COMMENT-WIP: put in Installation Details folder and link to from Installing the Package section
...
END COMMENT
START COMMENT-WIP Move to Upgrading section
