...
You can install EDB pgAdmin 4 for your Advanced Server database using the `yum` package manager for RHEL/CentOS 7.x platforms and using `dnf` package manager for RHEL/Rocky Linux/AlmaLinux 8.x platforms.
