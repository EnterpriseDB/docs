...
This section steps you through getting started with your cluster including logging in, ensuring the installation and initial configuration was successful, connecting to your cluster, and creating the user password. See [Managing an installation](/epas/latest/deployment_options/epas_inst_linux/managing_an_advanced_server_installation), for more information including how to use pgAdmin4 to connect to your cluster using its graphical interface instead of the command line option given below.
