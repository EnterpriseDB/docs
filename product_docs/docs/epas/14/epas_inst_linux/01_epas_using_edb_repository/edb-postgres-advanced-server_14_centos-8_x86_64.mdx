---
navTitle: Installing on CentOS 8 x86_64
title: Installing EDB Postgres Advanced Server 14 on CentOS 8 x86_64
---
...
1. Replace `'USERNAME:PASSWORD'` below with your username and password available from your
   ...
   ```sh
   sed -i "s@&lt;username&rt;:&lt;password&rt;@USERNAME:PASSWORD@" /etc/yum.repos.d/edb.repo
   ```
