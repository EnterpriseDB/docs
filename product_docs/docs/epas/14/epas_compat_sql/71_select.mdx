...
`optimizer_hint`
 ...
 Comment-embedded hints to the optimizer for selection of an execution plan. See Functions and Operators of *Database Compatibility for Oracle Developer Reference Guide* for information about optimizer hints.
