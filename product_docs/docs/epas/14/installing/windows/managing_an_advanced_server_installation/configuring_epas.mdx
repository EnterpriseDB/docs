...
For more information about Modifying the postgresql.conf file and Modifying the pg_hba.conf file, see [Setting parameters](/epas/14/epas_guide/03_database_administration/01_configuration_parameters/01_setting_new_parameters/).
