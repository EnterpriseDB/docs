...
| `created`       | `TIMESTAMP WITH TIME ZONE` | Timestamp for the creation of an object.                                                                                                                     |
| `last_ddl_time` | `TIMESTAMP WITH TIME ZONE` | Timestamp for the last modification of an object resulting from a DDL statement.                                                                             |
