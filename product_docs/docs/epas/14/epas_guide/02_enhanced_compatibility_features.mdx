...
[https://www.enterprisedb.com/docs](/epas/latest/epas_inst_linux)
...
For information about using the Stored Procedural Language, see the *Database Compatibility Stored Procedural Language Guide,* available at:
...
[https://www.enterprisedb.com/docs](/epas/latest/edb_plus/)
