...
-   Advanced Server now supports the `AS` clause to alias a table, view, materialized view, or a subquery to be referenced in the `INSERT` statement. For information, see the *Database Compatibility for Oracle Developer's SQL Guide*.
