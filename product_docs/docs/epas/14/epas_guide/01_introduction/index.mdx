...
-   Advanced Server has added improvements to the `CONNECT BY` clause, which specifies the relationship between a parent record and its child records of the hierarchy. For information, see the *Database Compatibility for Oracle Developers Guide*.
