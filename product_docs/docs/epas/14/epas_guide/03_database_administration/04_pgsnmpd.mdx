...
!!! Note
    Beginning with EDB Postgres Advanced Server v14, 'pgsnnmpd' is deprecated and it will not be included in future releases of EDB Postgres Advanced Server startiing with v15.
