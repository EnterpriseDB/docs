...
```text
2021-06-23 06:08:59.027 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,1,"authentication",2021-06-23 06:08:59 EDT,4/19,0,AUDIT,00000,"connection authorized: 
user=adminuser database=auditdb",,,,,,,,,"","client backend",,"","","connect"
2021-06-23 06:09:27.613 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,2,"idle",2021-06-23 06:08:59 EDT,4/21,0,AUDIT,00000,"statement: CREATE TABLE dept
       (deptno NUMBER(2),
        dname VARCHAR2(14),
        loc VARCHAR2(13) );",,,,,,,,,"psql","client backend",,"CREATE TABLE","","create"
2021-06-23 06:09:39.238 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,3,"idle",2021-06-23 06:08:59 EDT,4/22,0,AUDIT,00000,"statement: INSERT INTO 
dept VALUES (10, 'ACCOUNTING', 'NEW YORK');",,,,,,,,,"psql","client backend",,"INSERT","","insert"
2021-06-23 06:09:39.242 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,4,"idle",2021-06-23 06:08:59 EDT,4/23,0,AUDIT,00000,"statement: INSERT INTO 
dept VALUES (20, 'RESEARCH', 'DALLAS');",,,,,,,,,"psql","client backend",,"INSERT","","insert"
2021-06-23 06:09:39.247 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,5,"idle",2021-06-23 06:08:59 EDT,4/24,0,AUDIT,00000,"statement: INSERT INTO 
dept VALUES (30, 'SALES', 'CHICAGO');",,,,,,,,,"psql","client backend",,"INSERT","","insert"
2021-06-23 06:09:39.251 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,6,"idle",2021-06-23 06:08:59 EDT,4/25,0,AUDIT,00000,"statement: INSERT INTO 
dept VALUES (40, 'OPERATIONS', 'BOSTON');",,,,,,,,,"psql","client backend",,"INSERT","","insert"
2021-06-23 06:10:04.849 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,7,"idle",2021-06-23 06:08:59 EDT,4/26,0,AUDIT,00000,"statement: UPDATE dept SET loc = 'BEDFORD' 
WHERE deptno = 40;",,,,,,,,,"psql","client backend",,"UPDATE","","update"
2021-06-23 06:10:16.045 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,8,"idle",2021-06-23 06:08:59 EDT,4/27,0,AUDIT,00000,"statement: SELECT * FROM dept;",,,,,,,,,
"psql","client backend",,"SELECT","","select"
2021-06-23 06:10:40.593 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,9,"idle",2021-06-23 06:08:59 EDT,4/28,0,AUDIT,00000,"statement: DELETE FROM emp WHERE deptno = 40;
",,,,,,,,,"psql","client backend",,"DELETE","","delete"
2021-06-23 06:10:40.594 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,10,"DELETE",2021-06-23 06:08:59 EDT,4/28,0,ERROR,42P01,"relation ""emp"" does not exist",,,,,,
"DELETE FROM emp WHERE deptno = 40;",13,,"psql","client backend",,"DELETE","","error"
2021-06-23 06:11:02.563 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,11,"idle",2021-06-23 06:08:59 EDT,4/29,0,AUDIT,00000,"statement: DELETE FROM dept WHERE deptno = 40;
",,,,,,,,,"psql","client backend",,"DELETE","","delete"
2021-06-23 06:11:14.585 EDT,"adminuser","auditdb",60218,"[local]",60d3083b.
eb3a,12,"idle",2021-06-23 06:08:59 EDT,4/30,0,AUDIT,00000,"statement: SELECT * FROM dept;",,,,,,,,,
"psql","client backend",,"SELECT","","select"
```
...
!!! Note
    The database administrator can allow a certain user to audit any SQL statements by specifying the `ALTER USER` command and setting the `edb_audit_statement` parameter to any desired value.
...
Setting the `edb_audit_statement` parameter to `none` does not allow auditing any of the SQL statements for `carol` and thereby no audit logs are generated.
