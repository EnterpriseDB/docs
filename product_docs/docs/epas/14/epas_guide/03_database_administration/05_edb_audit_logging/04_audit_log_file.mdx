...
| `leader_pid`             | See note at bottom of the page | `integer`                  | Process ID of leader for active parallel workers.                                                                          |
| `query_id`               | See note at bottom of the page | `long`                     | Identifier of this backend's most recent query.                                                                            |
