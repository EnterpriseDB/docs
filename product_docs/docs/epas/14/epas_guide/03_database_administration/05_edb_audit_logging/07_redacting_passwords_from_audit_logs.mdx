...
You can use the GUC parameter `edb_filter_log.redact_password_commands = true` under the postgresql.conf file to instruct the server to redact stored passwords in the log file. 
