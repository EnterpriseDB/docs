...
Connected to EnterpriseDB 14.0.1 (localhost:5444/edb) AS enterprisedb

EDB*Plus: Release 14 (Build 39.0.0)
...
```text
C:\Program Files\edb\as14\edbplus>edbplus enterprisedb/
password@localhost:5445/edb
Connected to EnterpriseDB 14.0.1 (localhost:5445/edb) AS enterprisedb
...
Connected to EnterpriseDB 14.0.1 (localhost:5445/hr) AS enterprisedb
