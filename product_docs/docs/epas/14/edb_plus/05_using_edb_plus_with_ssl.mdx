...
**Step 5:** Move or copy the certificate and private key files to the Advanced Server data directory (for example, `/opt/edb/as14/data`).
...
Connected to EnterpriseDB 14.0.1 (192.168.2.22:5444/edb) AS enterprisedb
