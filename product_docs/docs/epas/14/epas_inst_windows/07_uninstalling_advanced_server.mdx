...
If you have elected to remove components that are dependent on EDB Postgres Advanced Server, those components will be removed first; click `Yes` to acknowledge that you wish to continue.
