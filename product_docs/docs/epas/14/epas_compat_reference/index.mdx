...
title: "Database Compatibility for Oracle Developer Reference Guide"
---
...
-   Compatible SQL Language syntax is provided in the *Database Compatibility for Oracle Developer SQL Guide*.
-   Compatible Catalog Views is provided in the *Database Compatibility for Oracle Developer Catalog Views Guide*.
