...
Use the `TABLESPACE` keyword to specify the name of a tablespace on which a partition or subpartition reside; if you do not specify a tablespace, the partition or subpartition resides in the default tablespace.
