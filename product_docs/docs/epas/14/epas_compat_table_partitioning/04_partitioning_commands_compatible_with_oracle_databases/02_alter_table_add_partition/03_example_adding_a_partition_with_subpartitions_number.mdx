...
The following command adds a new partition `americas` to the `sales` table and creates a number of subpartitions as specified in the partition description.
