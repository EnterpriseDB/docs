...
!!! Note
    If the original EDB Postgres Advanced Server installation is using port number `5444` when you invoke the EDB Postgres Advanced Server 14 installer, the installer will recommend using listener port `5445` for the new installation of EDB Postgres Advanced Server.
