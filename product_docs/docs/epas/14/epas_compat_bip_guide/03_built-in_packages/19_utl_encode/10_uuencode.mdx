...
`filename`
 ...
 `filename` is a `VARCHAR2` value that specifies the file name that you want to embed in the encoded form; if you do not specify a file name, `UUENCODE` includes a file name of `uuencode.txt` in the encoded form.
