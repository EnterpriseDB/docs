...
For information about using the `GRANT` command to provide access to a package, see the *Database Compatibility for Oracle Developer SQL Guide* available at:
