...
Advanced Server also provides extended (non-compatible) functionality for the `DBMS_AQ` package with SQL commands, see the *Database Compatibility for Oracle Developer SQL Guide* for detailed information about the following SQL commands:
