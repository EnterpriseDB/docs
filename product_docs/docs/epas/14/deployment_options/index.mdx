...
- [EDB Postgres® AI Cloud Services](/biganimal/latest) (formerly BigAnimal) are a fully managed database-as-a-service with built-in Oracle compatibility, running in your cloud account and operated by the Postgres experts. EDB Postgres® AI Cloud Services make it easy to set up, manage, and scale your databases. Provision PostgreSQL or EDB Postgres Advanced Server with Oracle compatibility.
