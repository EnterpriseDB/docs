...
SQL commands that return a result set consisting of a large number of rows might not operate efficiently. This is due to the constant context switching that occurs between the database server and the client to transfer the entire result set. 
