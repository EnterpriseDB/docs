...
When you have a default value for an argument and the argument isn't a trailing argument, you must use named notation to call the procedure or function. The following case demonstrates a procedure with two leading, default arguments.
