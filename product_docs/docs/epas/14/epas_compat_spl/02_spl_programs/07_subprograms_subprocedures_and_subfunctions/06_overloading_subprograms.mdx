...
For detailed information about the data types supported by Advanced Server, see the *Database Compatibility for Oracle Developer Reference Guide* available from EDB at:
