...
For detailed information about the data types supported by EDB Postgres Advanced Server, see the [Data types](/epas/latest/epas_compat_reference/02_the_sql_language/02_data_types/).
