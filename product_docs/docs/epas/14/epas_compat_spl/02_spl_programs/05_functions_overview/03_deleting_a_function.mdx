...
!!! Note
    ...
    -   Usage of `IF EXISTS, CASCADE`, or `RESTRICT` is not compatible with Oracle databases. See the `DROP FUNCTION` command in the *Database Compatibility for Oracle Developer Reference Guide* for information on these options.
