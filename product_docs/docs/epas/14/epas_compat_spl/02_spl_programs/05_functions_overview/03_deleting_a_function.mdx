...
!!! Note
    ...
    -   Use of `IF EXISTS`, `CASCADE`, or `RESTRICT` isn't compatible with Oracle databases. See the [Database Compatibility: SQL](../../../epas_compat_sql/47_drop_function) for information on these options.
