...
-   *Static Methods* – procedures or functions that operate independently of any particular object instance. Static methods don't have access to, and cannot change the attributes of an object instance.
