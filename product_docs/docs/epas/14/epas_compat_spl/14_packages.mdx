...
For more information about the package support provided by Advanced Server, see the *Database Compatibility for Oracle Developer Built-in Package Guide* available at:

[https://www.enterprisedb.com/docs](/epas/latest/epas_compat_bip_guide/)

For a list of built-in packages, see the Table of Contents, of "Built-In Packages" of the *Database Compatibility for Oracle Developer Built-in Package Guide*.
