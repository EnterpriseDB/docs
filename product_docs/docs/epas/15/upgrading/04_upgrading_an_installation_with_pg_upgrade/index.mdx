...
!!! Note
    Review the [upgrade considerations](/epas/latest/upgrading/03_limitations/) prior to performing an upgrade with the `pg_upgrade` utility.
...
The following topics walk you through the process of upgrading with `pg_upgrade`.
