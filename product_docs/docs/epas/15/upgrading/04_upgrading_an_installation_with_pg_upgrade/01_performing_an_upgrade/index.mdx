...
To upgrade an earlier version of EDB Postgres Advanced Server (EPAS) to the current version:

1.   Install the current version of EPAS. The new installation must contain the same supporting server components as the old installation.
...
1.   Shut down the old and new EPAS services.
