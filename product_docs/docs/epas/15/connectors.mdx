...
You can use the PostgreSQL community connectors with EDB Postgres Advanced Server. However, if your applications require EDB Postgres Advanced Server features, then you should use the EDB components.
