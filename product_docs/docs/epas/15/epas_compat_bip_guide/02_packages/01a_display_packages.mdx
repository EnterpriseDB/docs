...
From version 15 onwards, you can view the package specification and package body definition using the psql meta-commands `\sps` and `\spb` respectively.
...
Create the following function and procedure:
