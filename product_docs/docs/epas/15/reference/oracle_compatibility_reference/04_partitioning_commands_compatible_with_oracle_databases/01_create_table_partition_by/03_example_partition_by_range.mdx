...
redirects:
  - ../../../../../epas_compat_table_partitioning/04_partitioning_commands_compatible_with_oracle_databases/01_create_table_partition_by/03_example_partition_by_range #generated for docs/epas/reorg-role-use-case-mode
---
