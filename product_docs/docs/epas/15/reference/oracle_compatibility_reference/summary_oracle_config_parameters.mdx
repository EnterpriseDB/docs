...
escription: "Descriptions of the configuration parameters used to control system behaviors to act more like PostgreSQL or more like Oracle"
---
...
See [Configuration parameters compatible with Oracle databases](/epas/latest/reference/database_administrator_reference/01_introduction/) for access to more detailed information.
