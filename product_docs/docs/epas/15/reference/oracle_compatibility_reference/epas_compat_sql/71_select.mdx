...
title: "SELECT"
redirects:
  - ../../../../epas_compat_sql/71_select #generated for docs/epas/reorg-role-use-case-mode
---
...
`optimizer_hint`
 ...
 Comment-embedded hints to the optimizer for selecting an execution plan. See [Database Compatibility for Oracle Developers](../../../application_programming/optimizing_code/05_optimizer_hints/) for information about optimizer hints.
