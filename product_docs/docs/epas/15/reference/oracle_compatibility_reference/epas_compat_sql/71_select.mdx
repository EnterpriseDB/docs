...
`optimizer_hint`
 ...
 Comment-embedded hints to the optimizer for selecting an execution plan. See [Database Compatibility for Oracle Developers](/epas/latest/application_programming/optimizing_code/05_optimizer_hints/) for information about optimizer hints.
