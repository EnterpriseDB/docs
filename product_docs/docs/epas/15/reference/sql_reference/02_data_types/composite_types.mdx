...
Creating a table also creates a composite type to represent the table's row type. The composite typehas the same name as the table. For example, suppose you entered:
