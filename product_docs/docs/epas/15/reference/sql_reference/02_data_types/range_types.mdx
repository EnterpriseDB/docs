...
Defining your own range type also allows you to specify a different subtype B-tree operator class or collation to use to change the sort ordering that determines which values fall into a given range.
