...
You can cast a money to `NUMERIC` without loss of precision. Conversion to other types can potentially lose precision and must also be done in two stages:
