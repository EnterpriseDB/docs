...
The PostgreSQL type system contains a number of special-purpose entries that are collectively called pseudo-types. A pseudo-type cannot be used as a column data type, but it can be used to declare a function's argument or result type. Each of the available pseudo-types is useful in situations where a function's behavior does not correspond to simply taking or returning a value of a specific SQL data type. The following are the existing pseudo-types:

| Name | Description |
| ---- | ----------- | 
| `any` | 	Indicates that a function accepts any input data type. |
| `anyelement` | Indicates that a function accepts any data type. For more information, see [Polymorphic types](https://www.postgresql.org/docs/9.3/extend-type-system.html#EXTEND-TYPES-POLYMORPHIC) PostgreSQL documentation. |
| `anyarray` | Indicates that a function accepts any array data type. For more information, see [Polymorphic types](https://www.postgresql.org/docs/9.3/extend-type-system.html#EXTEND-TYPES-POLYMORPHIC) PostgreSQL documentation. |
| `anynonarray` | Indicates that a function accepts any non-array data type. For more information, see [Polymorphic types](https://www.postgresql.org/docs/9.3/extend-type-system.html#EXTEND-TYPES-POLYMORPHIC) PostgreSQL documentation. |
