...
2.  Create the `index_advisor` extension. It will create the database objects. Login as superuser and use the command:
...
!!! Note
    If you are using index advisor in earlier version of EPAS and upgrading to version 15 then use this command to create index_advisor extension.
