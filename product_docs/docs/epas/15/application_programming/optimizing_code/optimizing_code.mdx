...
description: "Benefits of using the SQL Profiler utility to optimize code"
---
...
See [SQL Profiler](/epas/latest/managing_performance/03_sql_profiler/) to see how the utility can help you locate and optimize poorly running SQL code.