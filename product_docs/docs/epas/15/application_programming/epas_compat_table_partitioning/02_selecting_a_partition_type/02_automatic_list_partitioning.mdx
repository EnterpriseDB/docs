...
For information about automatic list partitioning syntax, see [CREATE TABLE...PARTITION BY](/epas/latest/reference/oracle_compatibility_reference/04_partitioning_commands_compatible_with_oracle_databases/01_create_table_partition_by/#create_table_partition_by).
