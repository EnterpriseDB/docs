...
title: "Nested tables"
redirects:
  - ../../../../epas_compat_spl/10_collections/02_nested_tables #generated for docs/epas/reorg-role-use-case-mode
---
...
!!! Note
    You can use the `CREATE TYPE` command to define a nested table type that's available to all SPL programs in the database. See [Database Compatibility for Oracle Developers: SQL](/../../../reference/oracle_compatibility_reference/epas_compat_sql/39_create_type/) for more information about the `CREATE TYPE` command.
