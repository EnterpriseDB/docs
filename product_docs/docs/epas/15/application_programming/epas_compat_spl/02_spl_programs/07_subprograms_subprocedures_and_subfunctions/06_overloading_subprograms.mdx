...
For detailed information about the data types supported by EDB Postgres Advanced Server, see [Data types](/epas/latest/reference/sql_reference/02_the_sql_language/02_data_types/).
