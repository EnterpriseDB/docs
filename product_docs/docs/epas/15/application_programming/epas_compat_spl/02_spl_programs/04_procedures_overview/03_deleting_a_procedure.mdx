...
!!! Note
    ...
    -   Using `IF EXISTS`, `CASCADE`, or `RESTRICT` isn't compatible with Oracle databases. See [Database Compatibility: SQL](/epas/latest/reference/oracle_compatibility_reference/epas_compat_sql/50_drop_procedure) for information on these options.
