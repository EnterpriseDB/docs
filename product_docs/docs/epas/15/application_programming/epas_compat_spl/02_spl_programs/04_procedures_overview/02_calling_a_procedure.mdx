...
redirects:
  - ../../../../../epas_compat_spl/02_spl_programs/04_procedures_overview/02_calling_a_procedure #generated for docs/epas/reorg-role-use-case-mode
---
...
!!! Note
    ...
    -   The syntax for calling a procedure is the same as in the preceding syntax diagram when executing it with the `EXEC` command in PSQL or EDB\*Plus. See [Database Compatibility: SQL](/../../../../reference/oracle_compatibility_reference/epas_compat_sql/63_exec) for information about the `EXEC` command.
