...
redirects:
  - ../../../../../epas_compat_spl/02_spl_programs/05_functions_overview/03_deleting_a_function #generated for docs/epas/reorg-role-use-case-mode
---
...
!!! Note
    ...
    -   Use of `IF EXISTS`, `CASCADE`, or `RESTRICT` isn't compatible with Oracle databases. See the [Database Compatibility: SQL](../../../../reference/oracle_compatibility_reference/epas_compat_sql/47_drop_function) for information on these options.
