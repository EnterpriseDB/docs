...
redirects:
  - ../../../epas_compat_bip_guide/02_packages/01a_display_packages #generated for docs/epas/reorg-role-use-case-mode
---
...
## Create and viewing a package and a package body
