...
redirects:
  - ../../../epas_guide/03_database_administration/05_edb_audit_logging/03_enabling_audit_logging #generated for docs/epas/reorg-role-use-case-mode
---
...
-  Set the `edb_audit_directory` parameter to specify the desired location of audit files.
