...
redirects:
  - ../../../epas_guide/03_database_administration/05_edb_audit_logging/01_audit_logging_configuration_parameters #generated for docs/epas/reorg-role-use-case-mode
---

Use the following configuration parameters to control database auditing. See [Summary of configuration parameters](/../../database_administration/01_configuration_parameters/02_summary_of_configuration_parameters/#summary_of_configuration_parameters) to determine if a change to the configuration parameter:
