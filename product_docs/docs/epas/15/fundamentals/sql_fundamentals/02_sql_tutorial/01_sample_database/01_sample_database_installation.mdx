...
redirects:
  - ../../../../../epas_compat_ora_dev_guide/02_sql_tutorial/01_sample_database/01_sample_database_installation #generated for docs/epas/reorg-role-use-case-mode
---
...
You can alter the search path using commands in PSQL (a terminal-based front-end to PostgreSQL).
