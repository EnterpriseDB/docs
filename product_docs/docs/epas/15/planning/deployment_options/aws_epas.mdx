...
To view all the instances, select **Instances** in the navigation pane on the EC2 home page. Click on the **Instance Id** next to your instance name to view the complete details of your instance. 
...
If you need to upgrade EDB Postgres Advanced Server or install any EDB products you need to set up the EDB repository. Setting up the repository is a one-time task. 
