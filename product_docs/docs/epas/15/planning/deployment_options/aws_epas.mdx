...
- Create and use an EDB Postgres Advanced Server cluster

## Creating an instance

To create an EDB Postgres Advanced Server (EPAS) image on AWS: 
...
To view all the instances, select **Instances** in the navigation pane on the EC2 home page.
