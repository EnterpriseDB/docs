...
1. On the **Launch an instance** page, specify the following:
   ...
   - **Application and OS Images (Amazon Machine Image)** &mdash; On the **My AMIs** tab, select **Owned by me** and choose the EDB Postgres Advanced Server image. The image name is in the format `EDB-AS<x>-AWS-<y>`, where: 
