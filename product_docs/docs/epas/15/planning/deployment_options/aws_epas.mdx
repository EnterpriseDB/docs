---
title: "Deploying from an Amazon machine mmage on AWS "
navTitle: Deploying from an AMI
---


EDB Postgres Advanced Server Amazon machine image (AMI) is a pre-configured template with EDB Postgres Advanced Server installed on RHEL 8. You can purchase the EDB Postgres Advanced Server AMI from Amazon Marketplace. 
...
To create an EDB Postgres Advanced Server instance on AWS: 
