...
1. On the **Launch an instance** page, specify the following:
   ...
   - **Network settings** &mdash; For **Firewall**, select either *Create security group* or *Select existing security group*. For more information, see [Network settings](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-networking.html).
