...
You can deploy and install EDB Postgres Advanced Server using the following methods:
...
- [EDB Postgres Advanced Server AMI](aws_epas) is an Amazon machine image containing EDB Postgres Advanced Server available from Amazon Marketplace.
