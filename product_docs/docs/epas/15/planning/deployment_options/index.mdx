...
-   [EDB Postgres AI Cloud Service](/edb-postgres-ai/cloud-service/), a fully managed database-as-a-service with built-in Oracle compatibility. It runs in your cloud account and is operated by the Postgres experts. Cloud Service makes it easy to set up, manage, and scale your databases. Provision PostgreSQL or EDB Postgres Advanced Server with Oracle compatibility.
