...
If you have difficulty installing the EPEL release package, you can use the following command to install the `epel-release` package on RHEL/Rocky Linux/AlmaLinux 8.x:
