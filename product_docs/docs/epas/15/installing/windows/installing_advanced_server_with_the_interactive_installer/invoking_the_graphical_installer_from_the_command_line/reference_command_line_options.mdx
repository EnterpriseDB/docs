...
You can optionally include the following parameters for an EDB Postgres Advanced Server (EPAS) installation on the command line or in a configuration file when invoking the EPASinstaller.
