...
You can use the EDB Postgres Advanced Server (EPAS) interactive installer to install EPAS on Windows. The interactive installer is available from [Downloads page](https://www.enterprisedb.com/advanced-downloads) on the EDB website.

You can invoke the graphical installer in different installation modes to perform an EPAS installation.
