...
If your installation of EDB Postgres Advanced Server resides on version 8.x of RHEL and CentOS, you must use the `systemctl` command to control the EDB Postgres Advanced Server service and supporting components.
