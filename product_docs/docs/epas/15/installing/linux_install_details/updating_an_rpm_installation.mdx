...
If you have an existing EDB Postgres Advanced Server RPM installation, you can use dnf to upgrade your repository configuration file and update to a more recent product version. 
