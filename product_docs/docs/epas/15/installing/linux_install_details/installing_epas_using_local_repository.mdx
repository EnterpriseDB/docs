...
After specifying the location and connection information for your local repository, you can use the dnf command to install EDB Postgres Advanced Server and its supporting components on the isolated servers. For example:
