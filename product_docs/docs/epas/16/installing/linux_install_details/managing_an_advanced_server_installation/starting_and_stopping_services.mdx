...
If your installation of EDB Postgres Advanced Server resides on version 8.x | 9.x of RHEL and CentOS, you must use the `systemctl` command to control the EDB Postgres Advanced Server service and supporting components.
...
## Controlling a service on 11.x or Ubuntu 20.04 | 22.04
