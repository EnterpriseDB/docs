...
On RHEL/CentOS 7.x or RHEL/Rocky Linux/AlmaLinux 8.x | 9.x, core file creation is disabled by default. To enable the core file generation:
...
On Debian 10 or 11 or Ubuntu 20 and 22, core file creation is disabled by default. To enable the core file generation:
