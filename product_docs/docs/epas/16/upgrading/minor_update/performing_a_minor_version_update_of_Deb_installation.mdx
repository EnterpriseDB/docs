---
title: "Performing a minor version update of a Debian installation"
...
!!! Note
    This procedure only performs an update between minor EPAS releases. To upgrade to a later major release, use the [`pg_upgrade` procedure](../major_upgrade/).
...
1.  Restart your server to complete the update. 
