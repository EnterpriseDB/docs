...
-   Use the DNF software package manager, apt-get, or StackBuilder Plus to perform upgrades between minor versions of EDB Postgres Advanced Server. The method you use depends on the underlying operating system. 
