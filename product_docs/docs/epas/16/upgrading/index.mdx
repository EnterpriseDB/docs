...
-   Use `dnf`, `apt-get` or `StackBuilder Plus` to perform updates between minor versions of EDB Postgres Advanced Server. The method you use depends on the underlying operating system. 
