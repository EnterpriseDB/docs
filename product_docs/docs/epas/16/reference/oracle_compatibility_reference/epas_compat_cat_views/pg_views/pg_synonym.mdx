...
The `PG_SYNONYM` view defines system "synonym" relations (pg_synonym) along with the relation's initial contents, if any. PostgreSQL does not provide a system catalog for `PG_SYNONYM`.
