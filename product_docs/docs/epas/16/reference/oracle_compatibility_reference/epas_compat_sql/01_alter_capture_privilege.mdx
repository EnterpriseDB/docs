...
ALTER CAPTURE PRIVILEGES POLICY db1898_p1 ENABLE db1898_db_run1;
ALTER CAPTURE PRIVILEGES POLICY db1898_p1 DISABLE;

## Enable and disable policy on the role
ALTER CAPTURE PRIVILEGES POLICY db1898_p2 ENABLE db1898_role_run1;
ALTER CAPTURE PRIVILEGES POLICY db1898_p2 DISABLE db1898_role_run1;
```
