...
The `RETURN_RESULT` procedure returns the result of an executed statement to the client application. The procedure allows you to pass the Ref-Cursors or the DBMS_SQL cursor numbers implicitly rather than defining them explicitly as OUT parameters.
