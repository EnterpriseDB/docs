...
redirects:
  - ../../../../epas_compat_table_partitioning/04_partitioning_commands_compatible_with_oracle_databases/01_create_table_partition_by #generated for docs/epas/reorg-role-use-case-mode
---
