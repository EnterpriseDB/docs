...
Please note: If your installation resides on a Linux system, you must install the redhat-lsb package before invoking StackBuilder Plus. For more information, see [Using Stackbuilder Plus](#using-stackbuilder-plus).
