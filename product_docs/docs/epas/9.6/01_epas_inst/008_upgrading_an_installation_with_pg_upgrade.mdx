...
> Include the -k or --link keyword to create a hard link from the new cluster to the old cluster. See [Section 8.1.1](#linking-versus-copying), *Linking versus Copying* for more information about using a symbolic link.
...
For more information about using StackBuilder Plus, please see [Using Stackbuilder Plus](004_installing_advanced_server_with_the_interactive_installer/#using-stackbuilder-plus).
