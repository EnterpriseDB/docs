---
navTitle: RHEL 9
title: Installing MongoDB Foreign Data Wrapper on RHEL 9 ppc64le
...
redirects:
  - /mongo_data_adapter/5/04_installing_the_mongo_data_adapter/ibm_power_ppc64le/mongo_rhel9_ppcle
---
