...
title: Installing MongoDB Foreign Data Wrapper on AlmaLinux 9 or Rocky Linux 9 x86_64
...
redirects:
  - /mongo_data_adapter/5/04_installing_the_mongo_data_adapter/x86_amd64/mongo_other_linux9_x86
---
...
sudo dnf -y install edb-postgresextended<X>-mongo-fdw
```

Where `<X>` is the version of your EDB Postgres Extended Server.

```shell
# For PostgreSQL:
sudo dnf -y install postgresql-<X>-mongo-fdw
```

Where `<X>` is the version of your PostgreSQL.
