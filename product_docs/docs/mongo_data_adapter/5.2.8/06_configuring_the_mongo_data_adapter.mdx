...
| **Option**               | **Description**                                                                                                                                                                                                                 |
|--------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| address                  | The address or hostname of the Mongo server. The default value is <span class="title-ref">127.0.0.1</span>.                                                                                                                     |
| port                     | The port number of the Mongo Server. Valid range is 0 to 65535. The default value is <span class="title-ref">27017</span>.                                                                                                      |
...
| replica\_set             | The replica set the server is member of. If it is set, the driver will auto-connect to correct primary in the replica set when writing.                                                                                         |
| read\_preference         | The order of read preference. Options available are: primary \[default\], secondary, primaryPreferred, secondaryPreferred, and nearest.                                                                                         |
