...
Mongo Foreign Data Wrapper supports pushdown for inner joins, left joins, right joins, and cross joins. The following example shows join pushdown between two foreign tables 'warehouse' and 'sales_records':
