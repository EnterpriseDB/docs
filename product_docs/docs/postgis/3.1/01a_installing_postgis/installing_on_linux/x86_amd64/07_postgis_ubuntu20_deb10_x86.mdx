---
title: "Installing PostGIS on Ubuntu 20.04/Debian 10 x86"
...
2.  Configure the EnterpriseDB repository.
    ...
    On Ubuntu 20, invoke the following command and substitute your EnterpriseDB credentials for the `username` and `password` placeholders.
