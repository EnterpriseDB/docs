...
| Type            | Description                                                                                                                                      |
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| Upstream merges | Merged with community PostGIS 3.1.5. See the community [Release Notes](https://postgis.net/docs/manual-3.1/release_notes.html#idm41899) for details. |
