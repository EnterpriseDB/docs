...
- [RHEL 8](linux_x86_64/postgis_rhel_8), [RHEL 7](linux_x86_64/postgis_rhel_7)

- [Oracle Linux (OL) 8](linux_x86_64/postgis_rhel_8), [Oracle Linux (OL) 7](linux_x86_64/postgis_rhel_7)

- [Rocky Linux 8](linux_x86_64/postgis_other_linux_8)

- [AlmaLinux 8](linux_x86_64/postgis_other_linux_8)

- [CentOS 7](linux_x86_64/postgis_centos_7)
...
- [Ubuntu 22.04](linux_x86_64/postgis_ubuntu_22), [Ubuntu 20.04](linux_x86_64/postgis_ubuntu_20), [Ubuntu 20.04](linux_x86_64/postgis_ubuntu_20), [Ubuntu 18.04](linux_x86_64/postgis_ubuntu_18)

- [Debian 11](linux_x86_64/postgis_debian_11), [Debian 10](linux_x86_64/postgis_debian_10)

## Linux [IBM Power (ppc64le)](linux_ppc64le)

### Red Hat Enterprise Linux (RHEL) and derivatives

- [RHEL 8](linux_ppc64le/postgis_rhel_8)
