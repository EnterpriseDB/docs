...
6.  Invoke the platform-specific command to install `PostGIS`:
    ...
    On RHEL 7, to install the latest version of PostGIS for EDB Advanced Server version 14.0:
    ...
    On RHEL 7, to install the latest version of PostGIS for EDB Advanced Server version older than 14.0:
