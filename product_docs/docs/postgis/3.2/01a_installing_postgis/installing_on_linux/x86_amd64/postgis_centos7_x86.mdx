...
# To install PostGIS 3.1 using EDB Postgres 10-12:
yum install edb-as<xx>-postgis
```

Where `<xx>` is the version of EDB Postgres Advanced Server. Replace `xx` is the version of EDB Postgres Advanced Server you are using. For example, `db-as14-postgis32`.
