...
| PostGIS | EPAS 14 | EPAS 13 | EPAS 12 | EPAS 11 | EPAS 10 | EPAS 9.6 |
| ------- | ------- | ------- | ------- | ------- | ------- | -------- |
| 3.1     | Y       | Y       | Y       | Y       | Y       | Y        | 
| 3.0     | Y       | Y       | Y       | Y       | N       | N        |
| 2.5     | N       | N       | Y       | Y       | N       | Y        |
...
## Installing PostGIS on a CentOS/Rocky Linux x86-64 Host
...
4.  The following  steps are applicable only for Rocky Linux 8 platform:
...
5.  Invoke the platform-specific command to install `PostGIS`:
    ...
    On Rocky Linux 8, to install the latest version of PostGIS version for EDB Advanced Server version 13.0:
...
## Installing PostGIS on an RHEL 7 ppcl64le Host
