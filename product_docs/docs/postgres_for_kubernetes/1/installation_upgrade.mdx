...
You can install the [latest operator manifest](https://get.enterprisedb.io/pg4k/pg4k-enterprise-1.23.5.yaml)
for this minor release as follows:

```sh
kubectl apply --server-side -f \
  https://get.enterprisedb.io/pg4k/pg4k-enterprise-1.23.5.yaml
```
