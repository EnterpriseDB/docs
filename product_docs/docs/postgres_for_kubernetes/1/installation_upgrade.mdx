...
You can install the [latest operator manifest](https://get.enterprisedb.io/pg4k/pg4k-1.30.0-rc1.yaml)
...
{{name.ln}} SCRAM-SHA-256 encodes role passwords **operator-side**
...
{{name.ln}} pins the `search_path` to a fixed `pg_catalog, public,
