...
The following supplements the [Installation and upgrades](https://cloudnative-pg.io/documentation/1.15.0/installation_upgrade/) topic in the upstream CloudNativePG project.
