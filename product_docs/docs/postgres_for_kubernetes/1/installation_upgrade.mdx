...
You can install the [latest operator manifest](https://get.enterprisedb.io/cnp/postgresql-operator-1.18.10.yaml)
for this minor release as follows:

```sh
kubectl apply -f \
  https://get.enterprisedb.io/cnp/postgresql-operator-1.18.10.yaml
```
...
!!! Important
    ...
    earliest possible convenience to 1.18.8, the latest stable version for this
    minor release.
