...
You can obtain the token by visiting the [EDB Repos website](https://www.enterprisedb.com/repos) and signing into your account.
...
* Standard - Includes the operator and operands for EDB Postgres Extended.
* Enterprise - Includes the operator and operands for EDB Postgres Advanced and EDB Postgres Extended.

Export the appropriate value as an environmental variable EDB_SUBSCRIPTION_PLAN.
...
kubectl apply --server-side -f \
  https://get.enterprisedb.io/pg4k/pg4k-enterprise-1.24.1.yaml
