...
* Enterprise - Includes the operator and the EDB Postgres Advanced and EDB Postgres Extended images.

Set the relevant value, determined by your subscription, as an environmental variable `EDB_SUBSCRIPTION_PLAN`.
