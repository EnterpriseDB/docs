...
You can install the [latest operator manifest](https://get.enterprisedb.io/cnp/postgresql-operator-1.18.12.yaml)
for this minor release as follows:

```sh
kubectl apply --server-side -f \
  https://get.enterprisedb.io/cnp/postgresql-operator-1.18.12.yaml
```
...
### Upgrading to 1.18.11

!!! Important
    We encourage all existing users of EDB Postgres for Kubernetes 1.18.x to upgrade at your
    earliest possible convenience to 1.18.11, the latest stable version for this
    minor release.
