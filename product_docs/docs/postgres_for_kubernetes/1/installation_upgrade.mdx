...
You can install the [latest operator manifest](https://get.enterprisedb.io/cnp/postgresql-operator-1.19.4.yaml)
for this minor release as follows:

```sh
kubectl apply -f \
  https://get.enterprisedb.io/cnp/postgresql-operator-1.19.4.yaml
```
