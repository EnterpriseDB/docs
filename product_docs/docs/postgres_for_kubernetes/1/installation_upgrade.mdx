...
This page contains only the changes from the "Installation page" in the upstream CloudNativePG project.
Please refer to that page for additional content.
...
Differently from CloudNativePG, the operator is by default installed in the `postgresql-operator-system` namespace as a Kubernetes
