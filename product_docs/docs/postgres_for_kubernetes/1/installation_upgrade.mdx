...
-   Standard: The [latest standard operator manifest](https://get.enterprisedb.io/pg4k/pg4k-standard-1.23.6.yaml).
-   Enterprise: The [latest enterprise operator manifest](https://get.enterprisedb.io/pg4k/pg4k-enterprise-1.23.6.yaml).

You can install the manifest for the latest version of the operator by running:

```sh
kubectl apply --server-side -f \
  https://get.enterprisedb.io/pg4k/pg4k-$EDB_SUBSCRIPTION_PLAN-1.23.5.yaml
```
