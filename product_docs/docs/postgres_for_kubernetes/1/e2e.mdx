...
EDB Postgres for Kubernetes operator is automatically tested after each
...
The E2E tests suite is also run for OpenShift versions 4.6, 4.7, 4.8, 4.9, and 4.10.
