...
<td>
   <p>Configuration parameters passed to the plugin managing this backup
Only available in 1.25 or later</p>
</td>
</tr>
...
<td>
   <p>Sets the default collation order and character classification in the new database.
Only available in 1.25 or later</p>
</td>
</tr>
...
<td>
   <p>Defines the major PostgreSQL version we want to use within an ImageCatalog
Only available in 1.25 or later</p>
</td>
</tr>
...
<div id='postgresql-k8s-enterprisedb-io-v1-ExternalClusterList'></div>

## ExternalClusterList

(Alias of `[]github.com/EnterpriseDB/cloud-native-postgres/api/v1.ExternalCluster`)
...
<td>
   <p>Services roles managed by the <code>Cluster</code>
Only available in 1.25 or later</p>
</td>
</tr>
</tbody>
...
<td>
   <p>The name of the resource. Only supported for certain types
Only available in 1.25 or later</p>
</td>
</tr>
<tr><td><code>labels</code><br/>
...
<td>
   <p>Template for the Service to be created
Only available in 1.25 or later</p>
</td>
</tr>
</tbody>
...
<td>
   <p>Configuration of the PostgreSQL synchronous replication feature
Only available in 1.25 or later</p>
</td>
</tr>
<tr><td><code>pg_hba</code><br/>
...
or a replica cluster, comparing it with <code>primary</code>
Only available in 1.25 or later</p>
</td>
</tr>
...
<td>
   <p>Configures the synchronization of the user defined physical replication slots
Only available in 1.25 or later</p>
</td>
</tr>
</tbody>
