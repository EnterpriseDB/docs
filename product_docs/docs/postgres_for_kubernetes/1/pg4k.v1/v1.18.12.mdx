...
<td>
   <p>VolumeSnapshot provides the configuration for the execution of volume snapshot backups.
Only available in 1.22 or later</p>
</td>
</tr>
...
and <code>volumeSnapshot</code>. Defaults to: <code>barmanObjectStore</code>.
Only available in 1.22 or later</p>
</td>
</tr>
...
<td>
   <p>Backup label file content as returned by Postgres in case of online (hot) backups
Only available in 1.22 or later</p>
</td>
</tr>
...
<td>
   <p>Tablespace map file content as returned by Postgres in case of online (hot) backups
Only available in 1.22 or later</p>
</td>
</tr>
...
<td>
   <p>Status of the volumeSnapshot backup
Only available in 1.22 or later</p>
</td>
</tr>
<tr><td><code>method</code><br/>
...
<td>
   <p>The backup method being used
Only available in 1.22 or later</p>
</td>
</tr>
...
<td>
   <p>Whether the backup was online/hot (<code>true</code>) or offline/cold (<code>false</code>)
Only available in 1.22 or later</p>
</td>
</tr>
</tbody>
...
will be implemented).
Mutually exclusive with <code>backup</code> and <code>source</code>.
Only available in 1.22 or later</p>
</td>
</tr>
...
user by setting it to <code>NULL</code>. Enabled by default before 1.22. Disabled by default in 1.22 or later.</p>
</td>
</tr>
...
(that is: <code>stopDelay</code> - <code>smartShutdownTimeout</code>).
Only available in 1.22 or later</p>
</td>
</tr>
...
update procedure, after all replicas have been successfully updated:
it can be with a switchover (<code>switchover</code> - default before 1.22)
or in-place (<code>restart</code> - default in 1.22 or later)</p>
</td>
</tr>
<tr><td><code>backup</code><br/>
...
<td>
   <p>The configuration that is used by the portions of PostgreSQL that are managed by the instance manager
Only available in 1.22 or later</p>
</td>
</tr>
...
Only available in 1.23 or later</p>
</td>
</tr>
...
<td>
   <p>The tablespaces configuration
Only available in 1.22 or later</p>
</td>
</tr>
</tbody>
...
<td>
   <p>ManagedRolesStatus reports the state of the managed roles in the cluster
Only available in 1.22 or later</p>
</td>
</tr>
...
<td>
   <p>TablespacesStatus reports the state of the declarative tablespaces in the cluster
Only available in 1.22 or later</p>
</td>
</tr>
...
<td>
   <p>The first recoverability point, stored as a date in RFC3339 format, per backup method type
Only available in 1.22 or later</p>
</td>
</tr>
...
This field is reported when <code>.spec.failoverDelay</code> is populated or during online upgrades
Only available in 1.22 or later</p>
</td>
</tr>
...
<td>
   <p>AvailableArchitectures reports the available architectures of a cluster
Only available in 1.22 or later</p>
</td>
</tr>
...
<tr><td><code>additionalCommandArgs</code><br/>
<i>[]string</i>
</td>
<td>
...
<td>
   <p>Configuration of the storage for PostgreSQL tablespaces
Only available in 1.22 or later</p>
</td>
</tr>
</tbody>
...
Default to true before 1.22. Defaults to false in 1.22 or later.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
   <p>If enabled (default in 1.22 or later), the operator will automatically manage replication slots
...
cluster. If disabled (default before 1.22), the operator will not take advantage
...
<td>
   <p>The resource versions of the managed roles secrets
Only available in 1.22 or later</p>
</td>
</tr>
