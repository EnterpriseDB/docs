...
cnp_collector_postgres_version{cluster="cluster-example",full="17.5"} 17.5
...
## Monitoring the EDB Postgres for Kubernetes operator
...
A Grafana dashboard for EDB Postgres for Kubernetes clusters and operator, is kept in the
