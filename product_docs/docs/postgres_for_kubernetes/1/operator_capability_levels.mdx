...
EDB Postgres for Kubernetes supports [hibernation of a running PostgreSQL cluster](cnp-plugin.md#cluster-hibernation)
...
how to integrate EDB Postgres for Kubernetes with Prometheus and Grafana, by providing
