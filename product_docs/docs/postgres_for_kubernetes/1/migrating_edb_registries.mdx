...
spec:
  images:
    - major: 15
      image: quay.io/enterprisedb/postgresql:15.14
    - major: 16
      image: quay.io/enterprisedb/postgresql:16.10
    - major: 17
      image: quay.io/enterprisedb/postgresql:17.6
    - major: 18
      image: quay.io/enterprisedb/postgresql:18.0
```
...
spec:
  images:
    ...
    - major: 18
      image: docker.enterprisedb.com/k8s/postgresql:18.0-standard-ubi9
```
