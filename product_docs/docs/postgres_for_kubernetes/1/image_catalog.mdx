...
spec:
  images:
    - major: 15
      image: docker.enterprisedb.com/k8s_enterprise/postgresql:15.14-standard-ubi9
    - major: 16
      image: docker.enterprisedb.com/k8s_enterprise/postgresql:16.10-standard-ubi9
    - major: 17
      image: docker.enterprisedb.com/k8s_enterprise/postgresql:17.6-standard-ubi9
    - major: 18
      image: docker.enterprisedb.com/k8s_enterprise/postgresql:17.6-standard-ubi9
```
...
```shell
kubectl apply -f \
  https://raw.githubusercontent.com/cloudnative-pg/artifacts/refs/heads/main/image-catalogs/catalog-minimal-ubi9.yaml
```
