...
EDB Postgres for Kubernetes is very flexible when it comes to TLS certificates. It
...
2. [**User provided**](#user-provided-certificates-mode) – Certificates are
   ...
   secrets. EDB Postgres for Kubernetes integrates itself with [cert-manager](https://cert-manager.io/)
