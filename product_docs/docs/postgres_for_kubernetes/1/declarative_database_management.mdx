...
!!! Info
    ...
    require superuser privileges to create or modify. EDB Postgres for Kubernetes provides a
...
EDB Postgres for Kubernetes enables seamless and automated management of PostgreSQL foreign
...
!!! Info
     EDB Postgres for Kubernetes manages FDWs using PostgreSQL's native SQL commands:
...
EDB Postgres for Kubernetes provides seamless, automated management of PostgreSQL foreign
...
!!! Important
    EDB Postgres for Kubernetes does not currently support declarative configuration of user mappings.
...
!!!Info
EDB Postgres for Kubernetes manages foreign servers using PostgreSQL’s native SQL commands:
