...
options are empty string, which will default to <code>primary</code> policy, <code>primary</code>
to have backups run always on primary instances, <code>prefer-standby</code> to have
backups run preferably on the most updated standby, if available.</p>
</td>
</tr>
</tbody>
</table>
...
Available options are empty string, which will default to <code>primary</code>
policy, <code>primary</code> to have backups run always on primary instances,
...
Mutually exclusive with <code>backup</code> and <code>volumeSnapshots</code>.</p>
</td>
</tr>
...
will be implemented).
Mutually exclusive with <code>backup</code> and <code>source</code>.</p>
</td>
</tr>
...
(that is: <code>stopDelay</code> - <code>smartStopDelay</code>).</p>
</td>
</tr>
...
update procedure, after all replicas have been successfully updated:
it can be with a switchover (<code>switchover</code> - default) or in-place (<code>restart</code>)</p>
</td>
</tr>
<tr><td><code>backup</code><br/>
