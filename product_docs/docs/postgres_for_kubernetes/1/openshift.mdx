...
the `stable-v1.16` channel. `stable` will be removed once version 1.16 goes *End of Life*.

If you were using `stable` before 1.16 was released, you have two options:

-   stick with `stable` and therefore remain in the 1.16 minor release, consuming
