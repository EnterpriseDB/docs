...
If you are in `stable` and your operator version is 1.15, please move to
...
!!! Warning Both 1.15.x and 1.16.x are now End of Life
    The last supported version of 1.15.x was released on October 22, 2022.
    The last supported version of 1.16.x was released on December 21, 2022.
