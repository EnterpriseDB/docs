...
EDB Postgres for Kubernetes is distributed through the following
...
**EDB Postgres for Kubernetes** follow *trunk-based development* and
...
for Kubernetes - currently `stable-v1.25`.
...
| ----------------------------------- | ------------------ | ------------------------- |
| 1.25.x                              | 4.12-4.18          | restricted, restricted-v2 |
