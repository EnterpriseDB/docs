...
```shell
kubectl apply -f https://get.enterprisedb.io/cnp/postgresql-operator-1.16.0.yaml
__OUTPUT__
...
metadata:
  ...
  creationTimestamp: "2022-07-28T21:57:47Z"
  generation: 1
  name: cluster-example
  namespace: default
  resourceVersion: "1945"
  uid: 8725e025-e304-4bff-abb8-aac617d32fd6
spec:
  affinity:
...
status:
  certificates:
    ...
    expirations:
      cluster-example-ca: 2022-10-26 21:52:48 +0000 UTC
      cluster-example-replication: 2022-10-26 21:52:48 +0000 UTC
      cluster-example-server: 2022-10-26 21:52:48 +0000 UTC
  ...
  cloudNativePostgresqlCommitHash: acccf408
  cloudNativePostgresqlOperatorHash: 68df07920f226d668c98d3dc6d58d433da7242f84aae762d71f47c32d89eaee3
  configMapResourceVersion:
    metrics:
      postgresql-operator-default-monitoring: "863"
  currentPrimary: cluster-example-1
  currentPrimaryTimestamp: "2022-07-28T21:58:20Z"
  healthyPVC:
  - cluster-example-1
  - cluster-example-2
  - cluster-example-3
  ...
  licenseStatus:
    isImplicit: true
    isTrial: true
    licenseExpiration: "2022-08-27T21:57:47Z"
  ...
  secretsResourceVersion:
    applicationSecretVersion: "829"
    clientCaSecretVersion: "825"
    replicationSecretVersion: "827"
    serverCaSecretVersion: "825"
    serverSecretVersion: "826"
    superuserSecretVersion: "828"
  targetPrimary: cluster-example-1
  targetPrimaryTimestamp: "2022-07-28T21:57:48Z"
  topology:
    instances:
      cluster-example-1: {}
      cluster-example-2: {}
...
EnterpriseDB/kubectl-cnp info found version: 1.16.0 for v1.16.0/linux/x86_64
...
Name:               cluster-example
Namespace:          default
System ID:          7125546140512505874
PostgreSQL Image:   quay.io/enterprisedb/postgresql:14.4
...
----------------             ---------------                --------------------------
cluster-example-ca           2022-10-26 21:52:48 +0000 UTC  89.99
cluster-example-replication  2022-10-26 21:52:48 +0000 UTC  89.99
cluster-example-server       2022-10-26 21:52:48 +0000 UTC  89.99
...
----               -------------  -----------  ----------------  ------  ---         ---------------  ----
cluster-example-1  33 MB          0/5000060    Primary           OK      BestEffort  1.16.0           k3d-k3s-default-server-0
cluster-example-2  33 MB          0/5000060    Standby (async)   OK      BestEffort  1.16.0           k3d-k3s-default-server-0
cluster-example-3  33 MB          0/5000060    Standby (async)   OK      BestEffort  1.16.0           k3d-k3s-default-server-0
```
...
Name               Database Size  Current LSN  Replication role  Status             QoS         Manager Version  Node
----               -------------  -----------  ----------------  ------             ---         ---------------  ----
cluster-example-2  33 MB          0/6000F58    Primary           OK                 BestEffort  1.16.0           k3d-k3s-default-server-0
cluster-example-3  -              -            -                 pod not available  BestEffort  -                k3d-k3s-default-server-0
...
Instances:          3
Ready instances:    3
Current Write LSN:  0/7000110 (Timeline: 2 - WAL File: 000000020000000000000007)

Certificates Status
Certificate Name             Expiration Date                Days Left Until Expiration
----------------             ---------------                --------------------------
cluster-example-ca           2022-10-26 21:52:48 +0000 UTC  89.98
cluster-example-replication  2022-10-26 21:52:48 +0000 UTC  89.98
cluster-example-server       2022-10-26 21:52:48 +0000 UTC  89.98
...
Name               Sent LSN   Write LSN  Flush LSN  Replay LSN  Write Lag  Flush Lag  Replay Lag  State      Sync State  Sync Priority
----               --------   ---------  ---------  ----------  ---------  ---------  ----------  -----      ----------  -------------
cluster-example-1  0/7000110  0/7000110  0/7000110  0/7000110   00:00:00   00:00:00   00:00:00    streaming  async       0
cluster-example-3  0/7000110  0/7000110  0/7000110  0/7000110   00:00:00   00:00:00   00:00:00    streaming  async       0

Instances status
Name               Database Size  Current LSN  Replication role  Status  QoS         Manager Version  Node
----               -------------  -----------  ----------------  ------  ---         ---------------  ----
cluster-example-2  33 MB          0/7000110    Primary           OK      BestEffort  1.16.0           k3d-k3s-default-server-0
cluster-example-1  33 MB          0/7000110    Standby (async)   OK      BestEffort  1.16.0           k3d-k3s-default-server-0
cluster-example-3  33 MB          0/7000110    Standby (async)   OK      BestEffort  1.16.0           k3d-k3s-default-server-0
```
