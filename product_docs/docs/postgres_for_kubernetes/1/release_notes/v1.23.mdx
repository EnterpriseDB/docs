---
title: 'Release notes for EDB Postgres for Kubernetes 1.23'
originalFilePath: 'src/release_notes/v1.23.md'
---

History of user-visible changes in the 1.23 minor release of EDB Postgres for Kubernetes.

For a complete list of changes, please refer to the
[commits](https://github.com/EnterpriseDB/cloud-native-postgres/commits/release-1.23)
