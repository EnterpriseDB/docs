---
title: 'Release notes for EDB Postgres for Kubernetes 1.24'
originalFilePath: 'src/release_notes/v1.24.md'
---

History of user-visible changes in the 1.24 minor release of EDB Postgres for Kubernetes.

For a complete list of changes, please refer to the
[commits](https://github.com/EnterpriseDB/cloud-native-postgres/commits/release-1.24)
...
-   Deprecate the `role` label in the selectors of `Service` and
    `PodDisruptionBudget` resources in favor of `k8s.enterprisedb.io/instanceRole` (#4897).
