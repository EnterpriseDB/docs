---
title: 'Release notes for EDB Postgres for Kubernetes 1.21'
originalFilePath: 'src/release_notes/old/v1.21.md'
---
...
-   The `backup` command of the `cnp` plugin for `kubectl` improves the volume
