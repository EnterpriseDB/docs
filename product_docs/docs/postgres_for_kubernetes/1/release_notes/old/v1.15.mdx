---
title: 'Release notes for EDB Postgres for Kubernetes 1.15'
originalFilePath: 'src/release_notes/old/v1.15.md'
---

History of user-visible changes in the 1.15 minor release of EDB Postgres for Kubernetes.

For a complete list of changes, please refer to the
[commits](https://github.com/EnterpriseDB/cloud-native-postgres/commits/release-1.15)
...
Version 1.15.0 is the first release of EDB Postgres for Kubernetes. Previously, this software
...
[EDB documentation](/postgres_for_kubernetes/latest/).
