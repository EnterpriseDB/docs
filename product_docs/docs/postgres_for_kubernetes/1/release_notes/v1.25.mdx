---
title: 'Release notes for EDB Postgres for Kubernetes 1.25'
originalFilePath: 'src/release_notes/v1.25.md'
---

History of user-visible changes in the 1.25 minor release of EDB Postgres for Kubernetes.

For a complete list of changes, please refer to the
[commits](https://github.com/EnterpriseDB/cloud-native-postgres/commits/release-1.25)
...
-   **Logical Replication Management**: Add `Publication` and `Subscription` CRDs
    ...
    replication setup and facilitate online migrations to EDB Postgres for Kubernetes. (#5329)
...
-   Add support for `maxConcurrentReconciles` in the EDB Postgres for Kubernetes controller and
    set the default to 10, improving the operator's ability to efficiently manage
    larger deployments out of the box. (#5678)
-   Add the `k8s.enterprisedb.io/userType` label to secrets generated for predefined users,
