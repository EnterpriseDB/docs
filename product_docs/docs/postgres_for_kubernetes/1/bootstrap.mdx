...
!!!note API reference
Please refer to the ["API reference for the `bootstrap` section](pg4k.v1.md#bootstrapconfiguration)
...
!!!note API reference
Please refer to the ["API reference for the `externalClusters` section](pg4k.v1.md#externalcluster)
for more information.
!!!
