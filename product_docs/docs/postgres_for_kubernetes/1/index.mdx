...
You can [evaluate EDB Postgres for Kubernetes for free](evaluation.md) as part of a trial subscription.
You need a valid EDB subscription to use EDB Postgres for Kubernetes in production.
...
EDB Postgres for Kubernetes works with both PostgreSQL, EDB Postgres Extended and EDB Postgres
...
-   PostgreSQL: 12 - 17
-   EDB Postgres Advanced: 12 - 17
-   EDB Postgres Extended: 12 - 17
