...
## Features unique to EDB Postgres for Kubernetes
...
All of the above versions are available on the following platforms: `linux/amd64`, `linux/ppc64le`, `linux/s390x`.
