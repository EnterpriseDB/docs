...
-   Oracle compatibility through EDB Postgres Advanced Server
...
The following distrubutions of Postgres are currently supported:

-   PostgreSQL 11-15
-   EDB Postgres Advanced Server 11-15
