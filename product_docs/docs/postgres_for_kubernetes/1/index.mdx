...
EDB is committed to declaring a Long Term Support (LTS) version of {{name.ln}} annually. 1.27.1 is the current LTS version. 1.18 was the
first. Each LTS version will receive maintenance releases and be supported for an additional 12 months beyond
