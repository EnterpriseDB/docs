...
directoryDefaults:
  ...
  displayBanner: |
    ...
    For more information, see <a href="/postgres_for_kubernetes/preview/preview_version/">the v1.30.0-rc1 documentation</a>
#redirects:
...
The following versions of Postgres are currently supported by version 1.28:

-   PostgreSQL: 14 - 18
-   EDB Postgres Advanced: 14 - 18
-   EDB Postgres Extended: 14 - 18
