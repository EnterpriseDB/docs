...
directoryDefaults:
  version: "1.26.1"
  displayBanner: |
    We're preparing the next release of {{name.ln}}, and a release candidate is available. For more information, see <a href="/postgres_for_kubernetes/preview/preview_version/">the v1.27.0-rc1 documentation</a>
navigation:
  - rel_notes
