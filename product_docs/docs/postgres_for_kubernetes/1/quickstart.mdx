...
helm upgrade --install \
  -f https://raw.githubusercontent.com/EnterpriseDB/cloudnative-pg/main/docs/src/samples/monitoring/kube-stack-config.yaml \
...
```sh
kubectl apply -f \
  https://raw.githubusercontent.com/EnterpriseDB/cloudnative-pg/main/docs/src/samples/monitoring/postgresql-operator-prometheusrule.yaml
```
...
```sh
kubectl apply -f \
  https://raw.githubusercontent.com/EnterpriseDB/cloudnative-pg/main/docs/src/samples/monitoring/grafana-configmap.yaml
```
