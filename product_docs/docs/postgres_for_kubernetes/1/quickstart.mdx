...
EDB Postgres for Kubernetes provides a default dashboard for Grafana as part of the official
...
and monitor any EDB Postgres for Kubernetes clusters deployed with the Monitoring feature enabled.
