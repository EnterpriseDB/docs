...
<td>
   ...
   <div class="admonition admonition-note alert alert--secondary"><div class="admonition-heading"><h5>Introduced in v1.21</h5></div></div>
</td>
</tr>
...
to have backups run preferably on the most updated standby, if available.</p>
   <div class="admonition admonition-note alert alert--secondary"><div class="admonition-heading"><h5>Introduced in v1.19</h5></div></div>
</td>
</tr>
</tbody>
</table>
...
(that is: <code>stopDelay</code> - <code>smartShutdownTimeout</code>).</p>
   <div class="admonition admonition-note alert alert--secondary"><div class="admonition-heading"><h5>Note: this property was named <code>smartStopDelay</code> prior to version 1.21</h5></div></div>   
</td>
</tr>
...
<td>
   ...
   <div class="admonition admonition-note alert alert--secondary"><div class="admonition-heading"><h5>Introduced in v1.20</h5></div></div>
</td>
</tr>
...
<i>map[github.com/EnterpriseDB/cloud-native-postgres/pkg/utils.PodStatus][]string</i>
</td>
<td>
...
<a href="#postgresql-k8s-enterprisedb-io-v1-InstanceReportedState"><i>map[github.com/EnterpriseDB/cloud-native-postgres/api/v1.PodName]github.com/EnterpriseDB/cloud-native-postgres/api/v1.InstanceReportedState</i></a>
</td>
<td>
...
<i>map[github.com/EnterpriseDB/cloud-native-postgres/api/v1.RoleStatus][]string</i>
</td>
<td>
...
<a href="#postgresql-k8s-enterprisedb-io-v1-PasswordState"><i>map[string]github.com/EnterpriseDB/cloud-native-postgres/api/v1.PasswordState</i></a>
</td>
<td>
...
<tbody>
<tr><td><code>instances</code><br/>
<a href="#postgresql-k8s-enterprisedb-io-v1-PodTopologyLabels"><i>map[github.com/EnterpriseDB/cloud-native-postgres/api/v1.PodName]github.com/EnterpriseDB/cloud-native-postgres/api/v1.PodTopologyLabels</i></a>
</td>
<td>
