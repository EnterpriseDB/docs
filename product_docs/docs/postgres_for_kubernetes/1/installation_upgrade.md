...
You can install the [latest operator manifest](https://get.enterprisedb.io/cnp/postgresql-operator-1.20.4.yaml)
for this minor release as follows:

```sh
kubectl apply -f \
  https://get.enterprisedb.io/cnp/postgresql-operator-1.20.4.yaml
```
...
!!! Important
    We encourage all existing users of EDB Postgres for Kubernetes 1.20.x to upgrade at your
