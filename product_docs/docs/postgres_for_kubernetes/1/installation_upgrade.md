...
You can install the [latest operator manifest](https://get.enterprisedb.io/cnp/postgresql-operator-1.18.8.yaml)
for this minor release as follows:

```sh
kubectl apply -f \
  https://get.enterprisedb.io/cnp/postgresql-operator-1.18.8.yaml
```
...
!!! Important
    We encourage all existing users of EDB Postgres for Kubernetes 1.18.x to upgrade at your
    earliest possible convenience to 1.18.7, the latest stable version for this
    minor release.
...
definitions **before upgrading** to version 1.18.7:
