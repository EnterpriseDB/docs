...
{{name.ln}} release candidates are **not intended for use in production** systems.
...
-   **Upgrade Paths:** Testing the process of upgrading an existing {{name.ln}}
...
-   **New Deployment Test:** Deploy a new {{name.ln}} cluster using the RC version.
