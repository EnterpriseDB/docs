...
```sh
wget https://github.com/EnterpriseDB/kubectl-cnp/releases/download/v1.26.0-rc2/kubectl-cnp_1.26.0-rc2_linux_x86_64.deb \
...
```sh
curl -L https://github.com/EnterpriseDB/kubectl-cnp/releases/download/v1.26.0-rc2/kubectl-cnp_1.26.0-rc2_linux_x86_64.rpm \
