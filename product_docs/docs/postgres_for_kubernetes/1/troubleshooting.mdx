...
PostgreSQL Image:   docker.enterprisedb.com/k8s_enterprise/postgresql:17.6-standard-ubi9
...
```shell
  Image Name:    docker.enterprisedb.com/k8s_enterprise/postgresql:17.6-standard-ubi9
```
...
{{name.ln}} integrates with [pprof](https://github.com/google/pprof) to
