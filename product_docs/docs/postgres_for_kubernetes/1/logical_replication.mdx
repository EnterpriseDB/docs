...
spec:
  ...
  imageName: docker.enterprisedb.com/k8s_enterprise/postgresql:16-standard-trixie
...
spec:
  ...
  imageName: docker.enterprisedb.com/k8s_enterprise/postgresql:18-standard-trixie
