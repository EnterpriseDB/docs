...
!!!info
Please refer to the [API reference](pg4k.v1.md#publication)
...
Additionally, refer to the [{{name.ln}} API reference](pg4k.v1.md#publicationtarget)
...
!!!info
Please refer to the [API reference](pg4k.v1.md#subscription)
