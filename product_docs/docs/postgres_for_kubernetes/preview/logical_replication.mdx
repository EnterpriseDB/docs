...
!!! Important
    ...
    publisher cluster in EDB Postgres for Kubernetes, ensure that replication slot
...
a failover of the publisher, configure EDB Postgres for Kubernetes to synchronize logical
