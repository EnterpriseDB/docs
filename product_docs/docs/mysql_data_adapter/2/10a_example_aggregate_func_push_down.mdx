...
- AVG &mdash; Calculates the average of a set of values.
- COUNT &mdash; Counts rows in a specified table or view.
- MIN &mdash; Gets the minimum value in a set of values.
- MAX &mdash; Gets the maximum value in a set of values.
- SUM &mdash; Calculates the sum of values.
