...
title: "Upgrading"
redirects:
- /mysql_data_adapter/5/05_updating_the_mysql_data_adapter/
...
To perform the process, open a terminal window, assume superuser privileges, and enter the commands that apply to the operating system and package manager used for the installation:
...
To upgrade to the latest product version, enter one of the following commands:
  ...
  | -------------------------------- | ---------------------------------------------------------------------------------- |
  | RHEL 8/9 and derivatives         | `sudo <package-manager> -y upgrade edb-as<xx>-mysql<y>_fdw* mysql-community-devel` |
  | RHEL 7 and derivatives, CentOS 7 | `sudo <package-manager> -y upgrade edb-as<xx>-mysql<y>_fdw* mysql-community-devel` |
  | SLES                             | `sudo <package-manager> -y upgrade edb-as<xx>-mysql<y>_fdw* mysql-community-devel` |
  | Debian and Ubuntu                | `sudo <package-manager> upgrade edb-as<xx>-mysql<y>-fdw`                           |
