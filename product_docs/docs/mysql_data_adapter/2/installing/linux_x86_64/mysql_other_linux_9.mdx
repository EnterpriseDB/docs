...
title: Installing MySQL Foreign Data Wrapper on AlmaLinux 9 or Rocky Linux 9 x86_64
...
redirects:
  - /mysql_data_adapter/2/04_installing_the_mysql_data_adapter/x86_amd64/mysql_other_linux9_x86
---
...
sudo dnf -y install edb-postgresextended<X>-mysql8_fdw
```
...
```shell
# For PostgreSQL:
sudo dnf -y install mysql_fdw_<X>
```
