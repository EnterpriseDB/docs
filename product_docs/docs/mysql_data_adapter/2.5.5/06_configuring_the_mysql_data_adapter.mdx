...
| secure_auth         | Use to enable or disable secure authentication. The default value is <span class="title-ref">true</span>.                                                                       |
...
> > | **Option**      | **Description**                                                                                                                                                                                                   |
> > | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
> > | import_default  | Controls whether column <span class="title-ref">DEFAULT</span> expressions are included in the definitions of foreign tables imported from a foreign server. The default is <span class="title-ref">false</span>. |
> > | import_not_null | Controls whether column <span class="title-ref">NOT NULL</span> constraints are included in the definitions of foreign tables imported from a foreign server. The default is <span class="title-ref">true</span>. |
