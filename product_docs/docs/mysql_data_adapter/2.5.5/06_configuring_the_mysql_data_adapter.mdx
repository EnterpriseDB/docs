...
| Option                | Description                                                                                                                                                                         |
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| host                  | The address or hostname of the MySQL server. The default value is <span class="title-ref">127.0.0.1</span>.                                                                         |
| port                  | The port number of the MySQL Server. The default is <span class="title-ref">3306</span>.                                                                                            |
| secure\_auth          | Use to enable or disable secure authentication. The default value is <span class="title-ref">true</span>.                                                                           |
...
> > | **Option**        | **Description**                                                                                                                                                                                                   |
> > |-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
> > | import\_default   | Controls whether column <span class="title-ref">DEFAULT</span> expressions are included in the definitions of foreign tables imported from a foreign server. The default is <span class="title-ref">false</span>. |
> > | import\_not\_null | Controls whether column <span class="title-ref">NOT NULL</span> constraints are included in the definitions of foreign tables imported from a foreign server. The default is <span class="title-ref">true</span>. |
