...
where <span class="title-ref">xx</span> is the server version number, and <span class="title-ref">x</span> is the supported release version number of MySQL. For example, to install MySQL 5.0 on RHEL 7:
...
where <span class="title-ref">xx</span> is the server version number, and <span class="title-ref">x</span> is the supported release version number of MySQL. For example, to install MySQL 5.0 on CentOS 7:
