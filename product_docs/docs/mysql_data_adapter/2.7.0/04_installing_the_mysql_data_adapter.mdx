...
# 1. For MySQL8, enable the MySQL8 repository and disable the MySQL5 repository
zypper modifyrepo -d mysql57-community
zypper modifyrepo -e mysql80-community

# 2. For MySQL5, enable the MySQL5 repository and disable the MySQL8 repository
