...
| Option                  | Description                       |         |                                                                                                                                                                                                                    |
| ----------------------- | --------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| \`-s { &lt;server_name> | all`}`--server { &lt;server_name> | all\` } | `<server_name>` is the name of the database server to which the `SHOW-SERVERS` actions are to be applied. If `all` is specified or if the `-s` option is omitted, the actions are applied to all database servers. |
