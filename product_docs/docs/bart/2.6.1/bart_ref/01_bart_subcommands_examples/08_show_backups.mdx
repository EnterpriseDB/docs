...
<table><thead><tr class="header"><th>Options</th><th>Description</th></tr></thead><tbody><tr class="odd"><td><p><code>-s &#123; &lt;server_name&gt; | all</code> &#125;</p><p><code>--server &#123; &lt;server_name&gt; | all</code> &#125;</p></td><td><p><code>&lt;server_name&gt;</code> is the name of the database server whose backup information is to be displayed.<br />
If <code>all</code> is specified or if the option is omitted, the backup information for all database servers is displayed.</p></td></tr><tr class="even"><td><p><code>-i &#123; &lt;backup_id&gt; | &lt;backup_name&gt; | all &#125;</code><br />
<br />
...
<code>--toggle</code></p></td><td>Displays detailed backup information in list format. If the option is omitted, the default is a tabular format.</td></tr></tbody></table>
