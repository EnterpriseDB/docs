...
See the *EDB Backup and Recovery Reference Guide* available at the [EDB website](https://www.enterprisedb.com/edb-docs/) to review examples of how to evaluate, mark, and delete backups using a redundancy retention policy and recovery window retention policy, as well as examples of `MANAGE` subcommand.
