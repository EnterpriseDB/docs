...
See the *EDB Backup and Recovery Reference Guide* available at the [EDB website](https://www.enterprisedb.com/edb-docs/) for examples demonstrating use of the `MANAGE` and `DELETE` subcommands when a redundancy retention policy is in effect.
...
See the *EDB Backup and Recovery Reference Guide* available at the [EDB website](https://www.enterprisedb.com/edb-docs/) for examples demonstrating use of the `MANAGE` and `DELETE` subcommands when a recovery window retention policy is in effect.
