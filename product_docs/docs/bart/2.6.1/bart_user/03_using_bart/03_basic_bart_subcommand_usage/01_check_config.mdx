...
<code>--server &lt;server_name&gt;</code></p></td><td><p><code>server_name</code> is the name of the database server to be checked for proper configuration. If the option is omitted, the settings of the global section of the BART configuration file are checked.</p></td></tr></tbody></table>
