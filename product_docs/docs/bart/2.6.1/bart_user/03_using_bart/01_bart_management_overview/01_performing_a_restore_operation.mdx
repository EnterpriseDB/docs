...
legacyRedirectsGenerated:
  ...
  - "/edb-docs/d/edb-backup-and-recovery-tool/user-guides/backup-recovery-guide/latest/performing_a_restore_operation.html"
---
...
!!! Note
    If you set the [backup](../03_basic_bart_subcommand_usage/03_backup/#backup) `--checksum-algorithm=NONE` option, then you must specify the `--disable checksum` option while restoring a backup.
