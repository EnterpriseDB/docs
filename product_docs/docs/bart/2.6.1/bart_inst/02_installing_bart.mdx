...
7.  Use the following command to install BART:
    ...
    - The remote user account on the remote host to which incremental backups are to be restored. For details, see the _EDB Backup and Recovery User Guide_ available at the [EDB website](https://www.enterprisedb.com/edb-docs/).
