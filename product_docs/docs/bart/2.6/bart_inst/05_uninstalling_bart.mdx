...
For information about the BART `DELETE` subcommand, see the *EDB Postgres Backup and Recovery User Guide* available at the [EDB website](https://www.enterprisedb.com/edb-docs/).
