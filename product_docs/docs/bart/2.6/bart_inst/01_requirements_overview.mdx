...
-   BART supports the following database versions:
    ...
    > -   Advanced Server versions 9.6, 10, 11, 12, 13
...
-   BART Host Components - Use EDB packages to add BART host components; see [Installing BART](02_installing_bart/#installing_bart_using_an_rpm_package) for information about how to install these components.
