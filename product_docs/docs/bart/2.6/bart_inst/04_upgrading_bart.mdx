...
**Step 1:** Install the latest version of BART. For information about how to install, see [installing BART](02_installing_bart/#installing_bart_using_an_rpm_package).
