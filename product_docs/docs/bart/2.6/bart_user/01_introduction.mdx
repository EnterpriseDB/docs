...
For information about installing BART, see the *EDB Backup and Recovery Installation and Upgrade Guide* available at the [EDB website](/bart/2.6/bart_inst/). To view examples of BART operations and subcommand usage, see the *EDB Backup and Recovery Reference Guide* available at the [EDB website](/bart/2.6/bart_ref/).
...
In the global section of the BART configuration file, the `pg_basebackup_path` parameter specifies the complete directory path to the `pg_basebackup` program. For information about the `pg_basebackup_path` parameter and the `thread_count`, see the *EDB Backup and Recovery Installation and Upgrade Guide* available at the [EDB website](/bart/2.6/bart_inst/).
