...
See the *EDB Backup and Recovery Reference Guide* available at the [EDB website](/bart/2.6/bart_ref/) for examples demonstrating use of the `MANAGE` and `DELETE` subcommands when a redundancy retention policy is in effect.
...
See the *EDB Backup and Recovery Reference Guide* available at the [EDB website](/bart/2.6/bart_ref/) for examples demonstrating use of the `MANAGE` and `DELETE` subcommands when a recovery window retention policy is in effect.
