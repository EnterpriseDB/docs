...
<table><colgroup><col style="width: 10%" /><col style="width: 15%" /><col style="width: 17%" /><col style="width: 14%" /><col style="width: 13%" /><col style="width: 15%" /><col style="width: 13%" /></colgroup><tbody><tr class="odd"><td><code>Operation</code></td><td>Redundancy Retention Policy</td><td></td><td></td><td>Recovery Window Retention Po</td><td>licy</td><td></td></tr><tr class="even"><td></td><td>Active</td><td>Obsolete</td><td>Keep</td><td>Active</td><td>Obsolete</td><td>Keep</td></tr><tr class="odd"><td><code>MANAGE –d</code></td><td>No</td><td>Yes</td><td>No</td><td>No</td><td>Yes</td><td>No</td></tr><tr class="even"><td><code>DELETE –i *backup*</code></td><td><p>Yes</p><p>(see <a href="#note1">Note 1</a>_)</p></td><td><blockquote><p>Yes</p></blockquote><p>(see <a href="#note1">Note 1</a>_)</p></td><td><p>Yes</p><p>(see <a href="#note1">Note 1</a>_)</p></td><td><p>Yes</p><blockquote><p>(see <a href="#note2">Note 2</a></p></blockquote></td><td><blockquote><p>Yes</p></blockquote>__)| (see <a href="#note2">Note 2</a>_</td><td><blockquote><p>Yes</p></blockquote>) | (see <a href="#note2">Note 2</a>_)</td></tr><tr class="odd"><td><code>DELETE –i all</code></td><td>Yes</td><td>Yes</td><td>Yes</td><td>Yes</td><td>Yes</td><td>Yes</td></tr></tbody></table>
...
See the *EDB Postgres Backup and Recovery Reference Guide* available at the [EDB website](https://www.enterprisedb.com/edb-docs/) to review examples of how to evaluate, mark, and delete backups using a redundancy retention policy and recovery window retention policy, as well as examples of `MANAGE` subcommand.
