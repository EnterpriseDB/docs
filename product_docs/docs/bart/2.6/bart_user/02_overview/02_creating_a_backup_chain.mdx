...
See the *EDB Backup and Recovery Reference Guide*, available at the [EDB website](/bart/2.6/bart_ref/) for examples of creating a backup chain and restoring an incremental backup.
