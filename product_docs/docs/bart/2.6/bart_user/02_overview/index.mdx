...
For information on how all of these components are configured and used with BART, see the EDB Postgres Backup and Recovery Installation and Upgrade Guide available at the [EDB website](https://www.enterprisedb.com/edb-docs/).
