...
EDB has selected Barman to replace BART as the new strategic backup tool with the following enhancements on the roadmap:
...
tools on a generic level:
 ...
 | Backup compression                         | Roadmap                                                                          |        Yes |
 | Partial restore (only selected databases)  | -                                                                                |   Yes |
 | PEM integration                            | Roadmap                                                                          |       - |
