...
<table><thead><tr class="header"><th>Option</th><th>Description</th></tr></thead><tbody><tr class="odd"><td><p><code>-s &lt;server_name&gt;</code><br />
<code>--server &lt;server_name&gt;</code></p></td><td><code>&lt;server_name&gt;</code> is the name of the database server whose configuration parameter settings are to be checked.</td></tr></tbody></table>
