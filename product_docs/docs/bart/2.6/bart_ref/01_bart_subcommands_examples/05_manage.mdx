...
To view detailed information about the `MANAGE` subcommand and retention policy management, see *the EDB Backup and Recovery User Guide* available at the [EDB website](/bart/2.6/bart_user/). For information about setting the `wal_compression` parameter, see the *EDB Backup and Recovery Installation and Upgrade Guide* available at the [EDB website](/bart/2.6/bart_inst/).
