...
-   [Installing BART on a Debian or Ubuntu Host](#installing-bart-on-a-debian-or-ubuntu-host) section describes how to install BART on a Debian or Ubuntu host.
