...
3.  To verify the BART installation, navigate to the `/usr/bart/bin` directory and execute the following command:
    ...
    -   The BART user account on the BART host. See [Configuring BART](03_configuration/#path) for details.
...
After BART is installed successfully, you need to [configure the installation](03_configuration/#configuration).
