...
**Step 1:** Install the latest version of BART. For information about how to install, see [Using an RPM Package to Install BART](02_installing_bart_using_an_rpm_package/#installing_bart_using_an_rpm_package).
