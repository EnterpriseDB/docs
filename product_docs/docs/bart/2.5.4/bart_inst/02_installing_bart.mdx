...
If you encounter any error while installing epel, see [Troubleshooting](04_troubleshooting/#troubleshooting) for a workaround.
...
1.  Use either yum, dnf, or rpm to create the repository configuration file:
