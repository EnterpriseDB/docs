...
Generally, all BART features (such as retention policy management) apply to incremental backups and full backups. See [Managing Incremental Backups](../03_using_bart/02_managing_backups_using_a_retention_policy/#managing_incremental_backups) for information.
