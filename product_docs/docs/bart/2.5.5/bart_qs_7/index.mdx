...
2.  You must [authorize SSH/SCP access](../bart_qs_8/#passwordless) between the server and the BART host without a password prompt.

3.  Create a [replication database user](../bart_qs_8/#replication) for each database server that BART manages.
