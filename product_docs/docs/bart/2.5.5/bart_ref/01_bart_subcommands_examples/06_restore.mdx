...
For information about the <code>remote_host</code> parameter, see the <em>EDB Postgres Backup and Recovery Installation and Upgrade Guide</em> available at the <a href="https://www.enterprisedb.com/edb-docs/">EDB website</a>.</p></td></tr><tr class="odd"><td><code>-w</code> or <code>--workers &lt;number_of_workers&gt;</code></td><td><p><code>&lt;number_of_workers&gt;</code> is the number of worker processes to run in parallel to stream the modified blocks of an incremental backup to the restore location. If the <code>-w</code> option is omitted, the default is <code>1</code> worker process.<br />
...
For information about the <code>copy_wals_during_restore</code> parameter, see the EDB Postgres Backup and Recovery Installation and Upgrade Guide available at the <a href="https://www.enterprisedb.com/edb-docs/">EDB website</a>.</p></td></tr></tbody></table>
