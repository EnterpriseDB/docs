...
-   Minimal recovery settings will be saved in the `postgresql.auto.conf` file and archive recovery will proceed only until consistency is reached, with no restoration of files from the archive. See [Restore](../../04_using_bart/03_basic_bart_subcommand_usage/#restore) for detailed information about `Restore` subcommand.
...
See [Restore](../../04_using_bart/03_basic_bart_subcommand_usage/#restore) for more information about using the BART `Restore` subcommand.
