...
See the EDB Postgres Backup and Recovery Reference Guide available at the [EDB website](https://www.enterprisedb.com/edb-docs/) for examples of creating a backup chain and restoring an incremental backup.
