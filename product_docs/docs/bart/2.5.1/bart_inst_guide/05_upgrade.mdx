...
-   [Upgrading from BART 2.1, 2.2, 2.3 or 2.4 to BART 2.5.1](#upgrading-from-bart-21-22-23-or-24-to-bart-251) describes the upgrade process from previous BART versions (except 2.0) to 2.5.1.
