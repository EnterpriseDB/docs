...
!!! Note
    All the examples shows the basic steps to connect to an EDB Postgres Advanced Server without a data source. All these examples can also be executed using a data source.
