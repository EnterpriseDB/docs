...
To use the above defined procedure from .NET code, you must specify the data type of the ref cursor being passed as an `OUT` parameter, as shown in the above script.
