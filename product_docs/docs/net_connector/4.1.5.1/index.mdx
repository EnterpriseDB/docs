...
productStub: true
directoryDefaults:
  description: "EDB .NET Connector Version 4.1.5.1 Documentation and release notes."

legacyRedirects:
  - "/edb-docs/p/edb-postgres-net-connector/4.1.5.1"
  - "/edb-docs/d/edb-postgres-net-connector/user-guides/net-guide/4.1.5.1/whats_new.html"
