...
Note that `ExecuteNonQuery()` method returns the number of rows affected by the command. It is usually a good practice to check the number of affected rows matches your expectations (0 or 1 in this example).
...
!!!note
   ...
   - .NET Framework sample : [DeletingRecords](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/DeletingRecords)
   - .NET sample : [DeletingRecords](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/DeletingRecords)
!!!
*/}
