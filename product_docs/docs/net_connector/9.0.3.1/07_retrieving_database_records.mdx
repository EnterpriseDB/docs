...
!!!note
   ...
   - .NET Framework sample : [RetrievingDatabaseRecords](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/RetrievingDatabaseRecords)
   - .NET sample : [RetrievingDatabaseRecords](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/RetrievingDatabaseRecords)
!!!
*/}
...
The sample includes an explicit conversion of the value returned by the ExecuteScalar() method. The ExecuteScalar() method returns an object (it’s a decimal value boxed into an object). You can access the native value by using an explicit cast to an nullable decimal value.

{/*
!!!note
   A full sample project for this section is available in the [EDB .NET documentation samples](https://github.com/EnterpriseDB/edb-dotnet-docs-samples) repository:
   - .NET Framework sample : [RetrievingSingleDatabaseRecord](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/RetrievingSingleDatabaseRecord)
   - .NET sample : [RetrievingSingleDatabaseRecord](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/RetrievingSingleDatabaseRecord)
!!!
*/}