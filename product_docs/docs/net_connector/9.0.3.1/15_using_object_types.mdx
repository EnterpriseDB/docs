...
!!!note
   ...
   - .NET Framework sample : [UsingObjectTypes](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingObjectTypes)
   - .NET sample : [UsingObjectTypes](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingObjectTypes)
!!!