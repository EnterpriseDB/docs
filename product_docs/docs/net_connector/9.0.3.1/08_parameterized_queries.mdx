...
!!!note
   ...
   - .NET Framework sample : [ParameterizedQueries](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/ParameterizedQueries)
   - .NET sample : [ParameterizedQueries](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/ParameterizedQueries)
!!!
*/}