...
!!!note
   ...
   - .NET Framework sample : [UsingNestedTableTypes](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingNestedTableTypes)
   - .NET sample : [UsingNestedTableTypes](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingNestedTableTypes)
!!!