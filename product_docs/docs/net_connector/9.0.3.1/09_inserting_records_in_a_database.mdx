...
!!!note
   ...
   - .NET Framework sample : [InsertingRecords](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/InsertingRecords)
   - .NET sample : [InsertingRecords](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/InsertingRecords)
!!!
*/}
