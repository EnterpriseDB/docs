...
!!!note
   Sample projects for this article is available in the [EDB .NET documentation samples](https://github.com/EnterpriseDB/edb-dotnet-docs-samples) repository:
   - .NET Framework samples : [UsingPlugins](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingPlugins)
   - .NET samples : [UsingPlugins](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingPlugins)
!!!