...
!!!note
    ...
    Note: Ref cursors live only within the current scope of the caller/callee. The sample below creates an ambient transaction in order to leave the cursor variable alive and ready to fetch.
...
!!!note
   ...
   - .NET Framework sample : [UsingRefCursor](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingRefCursor)
   - .NET sample : [UsingRefCursor](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingRefCursor)
!!!