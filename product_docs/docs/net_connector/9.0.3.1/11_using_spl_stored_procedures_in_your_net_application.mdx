...
{/*
!!!note
   A full sample project for this section is available in the [EDB .NET documentation samples](https://github.com/EnterpriseDB/edb-dotnet-docs-samples) repository:
   - .NET Framework sample : [UsingSPLStoredProcedures_Basics](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingSPLStoredProcedures_Basics)
   - .NET sample : [UsingSPLStoredProcedures_Basics](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingSPLStoredProcedures_Basics)
!!!
*/}
...
After the stored procedure executes, a test record is inserted into the `emp` table, and the values inserted are displayed on the Console :
...
!!!note
   A full sample project for this section is available in the [EDB .NET documentation samples](https://github.com/EnterpriseDB/edb-dotnet-docs-samples) repository:
   - .NET Framework sample : [UsingSPLStoredProcedures_INParameters](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingSPLStoredProcedures_INParameters)
   - .NET sample : [UsingSPLStoredProcedures_INParameters](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingSPLStoredProcedures_INParameters)
!!!
*/}
...
Call the `ExecuteReader` method of the `EDBCommand` and explicitly loop through the returned `EDBDataReader`. The reader will contain one row where columns reflects `INOUT` or `OUT` parameters returned. Please note that this behavior is legacy and should not be longer used.
...
!!!note
   A full sample project for this section is available in the [EDB .NET documentation samples](https://github.com/EnterpriseDB/edb-dotnet-docs-samples) repository:
   - .NET Framework sample : [UsingSPLStoredProcedures_INOUTParameters](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingSPLStoredProcedures_INOUTParameters)
   - .NET sample : [UsingSPLStoredProcedures_INOUTParameters](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingSPLStoredProcedures_INOUTParameters)
!!!
*/}

!!!note

	The preferred method (less error-prone) to retrieve `OUT` parameter values is via using `EDBCommand.ExecuteNonQuery()`, in that case, `EDBParameter.Value` will hold the output value and can be accessed directly without going through a data row. This is the preferred method, less error-prone, as the value is held by the parameter itself.
