...
!!!note
   ...
   - .NET Framework sample : [UsingAdvancedQueuing](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/netframework/UsingAdvancedQueuing)
   - .NET sample : [UsingAdvancedQueuing](https://github.com/EnterpriseDB/edb-dotnet-docs-samples/tree/main/net/UsingAdvancedQueuing)
!!!
*/}
