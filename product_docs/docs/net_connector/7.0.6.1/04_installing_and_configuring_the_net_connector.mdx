...
For .NET Framework 4.7.2, the data provider installation path is C:\Program Files\edb\dotnet\net472\.
...
For .NET Framework 4.8, the data provider installation path is C:\Program Files\edb\dotnet\net48\.
...
For .NET Framework 4.8.1, the data provider installation path is C:\Program Files\edb\dotnet\net481\.
