...
If you're using the GeoJSON plugin on .NET Standard 2.0, the data provider installation path are: 
...
If you're using the Json.NET plugin on .NET Standard 2.0, the data provider installation path are:
...
If you're using the NetTopologySuite plugin on .Net Standard 2.0, the data provider installation path are:
...
If you're using the NodaTime plugin on .Net Standard 2.0, the data provider installation path are: 
