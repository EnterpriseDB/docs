...
You can use the EnterpriseDB .NET Connector Installer (available [from the EnterpriseDB website](https://www.enterprisedb.com/advanced-downloads)) to add the .NET Connector to your system. After downloading the installer, right-click on the installer icon, and select `Run As Administrator` from the context menu. When prompted, select an installation language and click `OK` to continue to the `Setup` window.
...
-   **Referencing the Library Files.** [General configuration information](../4.1.3.1/#referencing_the_library_files) applicable to all components.
-   **.NET Framework 4.0.** Instructions for configuring for use with [.NET Framework 4.0](../4.1.3.1/#framework_setup_4).
-   **.NET Framework 4.5.** Instructions for configuring for use with [.NET Framework 4.5](../4.1.3.1/#framework_setup_4_5).
-   **.NET Framework 4.5.1.** Instructions for configuring for use with [.NET Framework 4.5.1](../4.1.3.1/#framework_setup_4_5_1).
-   **.NET Framework 4.6.1** Instructions for configuring for use with [.NET Framework 4.6.1](../4.1.3.1/#framework_setup_4_6_1).
-   **.NET Standard 2.0.** Instructions for configuring for use with [.NET Standard 2.0](../4.1.3.1/#standard_setup_2).
-   **.NET Standard 2.1.** Instructions for configuring for use with [.NET Standard 2.1](../4.1.3.1/#standard_setup_2_1).
-   **.NET Core 3.0** Instructions for configuring for use with [.NET Core 3.0](../4.1.3.1/#framework_setup_core3_0).
-   **Entity Framework 5/6.** Instructions for configuring for use with [Entity Framework](../4.1.3.1/#entity_setup_5_6).
-   **EnterpriseDB VSIX.** Instructions for configuring for use with [EnterpriseDB VSIX](../4.1.3.1/#vsix_setup).
...
<div id="framework_setup_4" class="registered_link"></div>
...
Depending upon the type of application you use, you may be required to import the namespace into the source code. See [Referencing the Library Files](../4.1.3.1/#referencing_the_library_files) for this and other information about referencing library files.
...
<div id="framework_setup_4_5_1" class="registered_link"></div>
...
Entity Framework can be used with the `EnterpriseDB.EDBClient.dll` library available in the `net45`, `net451` and `net461` subdirectories.

</div>

See [Referencing the Library Files](../4.1.3.1/#referencing_the_library_files) for information about referencing library files.
...
Depending upon the type of application you are using, you may be required to import the namespace into the source code (see [Referencing the Library Files](../4.1.3.1/#referencing_the_library_files)).
...
The EDB Data Designer Extensibility Provider (EnterpriseDB VSIX) is a component that integrates Advanced Server database access into Visual Studio, thus providing Visual Studio integrated features.

EnterpriseDB VSIX allows you to connect to Advanced Server from within Visual Studio's Server Explorer and create a model from an existing database. Therefore, if Visual Studio features are desired, then EnterpriseDB VSIX must be utilized.
...
**Step 1:** Install EnterpriseDB VSIX to the desired version of Visual Studio with the `EnterpriseDB.vsix` installer.
...
**Step 2:** Relaunch Visual Studio and verify from the `Tools > Extensions and Updates…` menu that the EnterpriseDB extension is installed.
...
**Step 4:** Add the `EnterpriseDB.EDBClient.dll` and `EntityFramework6.EnterpriseDB.EDBClient.dll` files to project references. see [Referencing the Library Files](../4.1.3.1/#referencing_the_library_files) for information about referencing library files.
