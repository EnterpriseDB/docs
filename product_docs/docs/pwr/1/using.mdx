...
!!! Note
To avoid overwriting previous reports, the `pwr execute` command appends the database name and a timestamp in the format `%Y%m%d%H%M%S` to the report name provided, for example, `March_report-mydatabase-20240321-133727.html`. 
