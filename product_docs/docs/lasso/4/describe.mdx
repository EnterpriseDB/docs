...
xDB output from several CLI commands, from the running xDB publication and/or
subscription server.
...
All partitioned tables view (from `all_part_tables`, EDB Postgres Advanced Servier specific).
