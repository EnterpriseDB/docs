...
Collects OpenSSL version, enabled engines, ciphers/configurations.
...
### EPAS resource group active use information (`postgresql_epas_edb_all_resource_groups`)
...
### EPAS user profile policies (`postgresql_epas_edb_profile`)
...
### EPAS resource group information (`postgresql_epas_edb_resource_group`)

EPAS resource group names and limits.
...
### EPAS directories (`postgresql_epas_edb_dir`)
...
### EPAS security policies (`postgresql_epas_edb_policy`)
...
### EPAS redaction policies per column (`postgresql_epas_edb_redaction_column`)
...
### EPAS redaction policies (`postgresql_epas_edb_redaction_policy`)
...
### EPAS-extended pg_namespace view (`postgresql_epas_pg_namespace`)

EPAS has extended pg_namespace which provides additional information.
