...
|------------------------|-------------|-----------|
| Feature                | Add support for Ubuntu 24.04 | DC-1034 |
| Improvement            | Locks held by prepared transactions are now included in `running_locks.out` | DC-1059 |
| Bug Fixes              | Fix concurrency issue where the Lasso Patroni collector tries to scan all PIDs, resulting in error `process no longer exists` | DC-1056 |
