...
Unless your company requested a version of Lasso for
an isolated network system, without external access to EnterpriseDB's
infrastructure, you can upload the produced tarball
directly through Lasso using the `--upload` option. For more information, see [Servers accepting upload of reports](96-appendix-a).
