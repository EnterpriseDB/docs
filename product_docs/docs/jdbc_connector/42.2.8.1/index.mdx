...
The JDBC connector is written in Java and conforms to Sun's JDK architecture. For more information, see [JDBC Driver Types](03_advanced_server_jdbc_connector_overview/#jdbc-driver-types)
