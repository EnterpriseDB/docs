...
| Type           | Description                                                                                                                                                                  |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Upstream merge | Merged with the upstream community driver version 42.2.19. See the [community JDBC documentation](https://jdbc.postgresql.org/changelogs/2021-02-18-42.2.19-release/) for details.      |
