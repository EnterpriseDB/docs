...
| Fix                 | Fixed issue where EDBJmsMessageConsumer.receive() [without time parameter] is supposed to block until a message is available.                                                                                                                                                      |
| Fix                 | Fixed issue where EDBJmsMessageConsumer.receive(timeout) doesn't honor the timeout specified.                                                                                                                                                                                      |