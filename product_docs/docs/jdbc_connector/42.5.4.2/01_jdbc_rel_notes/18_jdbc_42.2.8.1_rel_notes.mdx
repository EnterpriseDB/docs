---
title: "EDB JDBC Connector 42.2.8.1 release notes"
navTitle: Version 42.2.8.1
---
...
| Type           | Description                                                                     |
| -------------- | ------------------------------------------------------------------------------- |
| Upstream merge | Merged with the upstream community driver version 42.2.8. See the community [JDBC documentation](https://jdbc.postgresql.org/changelogs/2019-09-13-42.2.8-release/) for details. |
