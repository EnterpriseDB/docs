...
You can use the EDB Connectors Installation wizard to add the JDBC connector to your system; the wizard is available from [the EDB Advanced Downloads page](https://www.enterprisedb.com/advanced-downloads).
