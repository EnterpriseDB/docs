...
In the EDB Postgres AI Console, [create a database cluster ](./installing/create_database.mdx).
...
Configure the source reader according to your source and target databases and run the EDB Transporter source reader. For details, see [Configuring EDB Transporter software](config_reader).
