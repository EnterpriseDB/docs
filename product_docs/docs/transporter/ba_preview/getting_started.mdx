...
## Create in EDB Portal a new database cluster

Create a new database cluster in the EDB Portal. Also create a new database in the cluster.
...
- Snapshot: EDB takes a snapshot of the source database
- CDC: EDB starts capturing changes from the source database
