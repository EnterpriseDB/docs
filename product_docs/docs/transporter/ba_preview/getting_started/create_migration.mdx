...
After you use the EDB Data Migration Reader to read the source database, create a new migration in the EDB Postgres® AI Console. 
...
1.  Select the **Source** of the migration. The ID for the `cdcreader` is listed in the drop-down menu. 
