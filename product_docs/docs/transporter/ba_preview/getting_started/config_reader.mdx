...
# Pick a different compression type (valid values are none,gzip,zstd,lz4,snappy - default zstd)
#export MP_MESSAGING_OUTGOING_DATA_COMPRESSION_TYPE=
# Pick a different compression type (valid values are none,gzip,lz4 - default gzip)
#export MP_MESSAGING_OUTGOING_DATA_LARGE_MESSAGE_COMPRESSION_TYPE=
