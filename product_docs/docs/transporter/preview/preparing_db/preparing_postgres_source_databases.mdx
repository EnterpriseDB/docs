...
CDCReader installation comes with a helper script that will validate the Postgres configuration and help you identify any issues. Once you have configured the database, it is recommended to run the script and ensure all checks are passed.
