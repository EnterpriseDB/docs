...
```
edbctl setup list-install-secrets --version "2026.2" # will list secrets for all scenarios
edbctl setup list-install-secrets --version "2026.2" --scenario core --scenario ai # will list secrets for core and ai scenarios
```