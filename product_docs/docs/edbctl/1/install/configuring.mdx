...
description: Configure the edbctl command line tool to manage resources and perform database cluster operations for Hybrid Manager.
---

After installing the package, configure an [access key](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/using_the_api/access_key/) using the `credential` command. 
