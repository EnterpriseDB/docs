...
These commands require Hybrid Manager 2026.9 or later. Earlier releases don't provide the federation pairing resources they act on. For the deployment context, see [Multi-datacenter deployments](/edb-postgres-ai/current/hybrid-manager/install/configuration/multi_dc/).
!!!
