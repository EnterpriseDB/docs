...
- [edbctl operand annotate-extensions](#edbctl-operand-annotate-extensions) &mdash; Annotate an operand image with its available PostgreSQL extensions.
...
- [edbctl operand show-extensions](#edbctl-operand-show-extensions) &mdash; Show the available PostgreSQL extensions recorded on an image.
...
Extracts the list of available PostgreSQL extensions from an operand image and injects them as OCI annotations into the image manifest in its remote registry.
