...
- [Custom operand images](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/image-management/custom-operand-images/) — a complete walkthrough of building, annotating, and registering a custom operand image using these commands.
