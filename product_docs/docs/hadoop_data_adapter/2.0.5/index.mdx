...
requirements_overview architecture_overview supported_authentication_methods installing_the_hadoop_data_adapter configuring_the_hadoop_data_adapter using_the_hadoop_data_adapter identifying_data_adapter_version conclusion
