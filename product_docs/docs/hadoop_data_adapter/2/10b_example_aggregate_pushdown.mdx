...
!!! Note
    You can also enable/disable aggregate pushdown at the server/table level using a GUC. For more information, see [create server](/hadoop_data_adapter/latest/configuring/#create-server) and [create foreign table](/hadoop_data_adapter/latest/configuring/#create-foreign-table).
