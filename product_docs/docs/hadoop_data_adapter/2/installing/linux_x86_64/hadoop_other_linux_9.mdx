...
title: Installing Hadoop Foreign Data Wrapper on AlmaLinux 9 or Rocky Linux 9 x86_64
...
redirects:
  - /hadoop_data_adapter/2/05_installing_the_hadoop_data_adapter/x86_amd64/hadoop_other_linux9_x86
---
...
sudo dnf -y install edb-postgresextended<X>-hdfs-fdw
```
...
```shell
# For PostgreSQL:
sudo dnf -y install postgresql-<X>-hdfs-fdw
```
