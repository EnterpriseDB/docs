...
!!! Note
    You can also enable/disable join pushdown at the server level using a GUC. For more information, see [Create Server](https://www.enterprisedb.com/docs/hadoop_data_adapter/latest/configuring/#create-server).
