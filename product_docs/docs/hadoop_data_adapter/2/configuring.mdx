...
| ssl                       | This boolean option must be set to true when SSL is enabled on the hive server. The default value is `false`.                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| sslTrustStore             | Use this option to specify the path to a custom certificate trust store file. It is useful when you have a specific vertificate you need to trust.                                                                                                                                                                                                                                                                                                                                                                           |
| trustStorePassword        | This option is used to provide the password for the custom trust store file specified by `sslTrustStore`. It is a required parameter when a password-protected trust store is used.                                                                                                                                                                                                                                                                                                                                          |
