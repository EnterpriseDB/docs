...
When creating the user mapping, you must provide the name of a registered LDAP user and the corresponding password as options. For details, see [Create User Mapping](06_configuring_the_hadoop_data_adapter/#create-user-mapping).
