...
Before creating the extension and the database objects that use the extension, you must modify the Postgres host, providing the location of the supporting libraries; for details, see [Prerequisites](05_installing_the_hadoop_data_adapter/#prerequisites). Then, before using the data adapter, you must:
