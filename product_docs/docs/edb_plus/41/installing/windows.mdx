...
Before installing EDB\*Plus, you must first install Java 11 or later. EDB\*Plus supports OpenJDK 21. For Windows, Java installers and instructions are available at the [Java download page](http://www.java.com/en/download/manual.jsp).
