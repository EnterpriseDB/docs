...
**Step 5:** Move or copy the certificate and private key files to the Advanced Server data directory (for example, `/opt/edb/as12/data`).

```text
$ mv root.crt /opt/edb/as12/data
$ mv server.crt /opt/edb/as12/data
$ mv server.key /opt/edb/as12/data
```
