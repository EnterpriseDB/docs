...
6.  Use the following platform-specific command to install Slony:
    ...
    To install Slony 2.2.10 on CentOS 8 for EDB Advanced Server version 13, the command is:
...
6.  Use the following platform-specific command to install Slony:
    ...
    ```
       ...
       To install Slony 2.2.10 on RHEL 8 for EDB Advanced Server version 13, use the following command:
