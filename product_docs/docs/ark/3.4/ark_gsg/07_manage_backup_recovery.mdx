...
|                                                                                             |                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="images/recover_backup_icon.png" style="width:0.25in;height:0.25in" alt="icon1" /> | Highlight a backup in the list, and click the Recover Backup icon to open a dialog that allows you to restore a cluster from the selected backup.                                                                                |
| <img src="images/delete_backup_icon.png" style="width:0.25in;height:0.25in" alt="icon2" />  | Highlight one or more backups in the list and click the Delete Backup icon to delete the selected backups. A popup will ask you to confirm that you wish to delete the selected backups before the backups are actually deleted. |
