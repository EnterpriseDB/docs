...
## Getting Tokens Using Shell Script

To simplify process of getting tokens, EDB provides a [shell script](https://github.com/EnterpriseDB/cloud-utilities/tree/main/api).

### Prerequisites for using the shell script

Install [command-line JSON processor jq](https://stedolan.github.io/jq/) specific to your OS.

### Usage

You can use script `get-token.sh` to get tokens for EDB Cloud API
...
Example of getting tokens with user activation code
...
```
 ...
 Example of getting tokens using refresh token
