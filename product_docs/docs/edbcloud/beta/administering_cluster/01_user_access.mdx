...
Role based access controls are achieved through a combination of organizations, roles, and users.
...
!!! Note
    For a user's role assignment to take effect, the user should sign out from EDB Cloud and sign in again.
