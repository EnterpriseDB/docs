...
Each EDB Cloud organization is associated with an Azure Active Directory (AD) tenant. Azure AD establishes the identity of users that belong to an organization. After you link your EDB Cloud account with your Azure AD application during subscription, users that belong to that AD can login. 
