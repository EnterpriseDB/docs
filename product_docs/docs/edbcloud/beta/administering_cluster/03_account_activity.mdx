...
---
The activity log collects EDB Cloud events based on user activity within the portal. It can be used to audit activities performed by users from your organizations. 

## Events

Events describe actions performed by users on EDB cloud resources. The available actions are:
* create
* read
* update
* delete
