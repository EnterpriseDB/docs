...
The Private Networking option offers a higher level of isolation and security to your EDB Cloud clusters by completely removing your clusters from the Internet. However, clusters with Private Networking enabled are by default not accessible from outside of your EDB Cloud resource virtual network. You need to perform additional configuration steps to connect your applications in other parts of your Azure infrastructure to your EDB Cloud clusters via private network links.
