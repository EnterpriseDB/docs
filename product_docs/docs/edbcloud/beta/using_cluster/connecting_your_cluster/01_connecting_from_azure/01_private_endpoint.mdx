...
#### Step 1: Create an Azure Private Link service in each cluster
...
#### Step 2: Create an Azure Private Endpoint in each client virtual network
  ...
  1. Enter the details for the private endpoint as as shown in the following screenshot. Use a unique name for the private endpoint. 
...
11. You have now successfully built a tunnel between your client VM's virtual network and the cluster. You can access the private PG service by using the private endpoint:
