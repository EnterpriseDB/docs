...
1. On the **Create virtual network gateway** page, create the VPN gateway for the cluster's resource virtual network `vnet-japaneast`. Name the VPN gateway `vpng-edbcloud`.
