...
1. From the Azure portal, type "virtual network gateways" in the search box. Locate Virtual network gateways in the search results and select it.
...
Use the Azure CLI (or [PowerShell](https://docs.microsoft.com/en-us/azure/vpn-gateway/vpn-gateway-vnet-vnet-rm-ps)) to add a VPN gateway connection from `vpng-edbcloud`, as follows:
...
2. Verify the connectivity to the cluster:
 ...
 $ psql -h p-c4j0jfcmp3af2ieok5eg.brcxzr08qr7rbei1.edbcloud.io -U edb_admin      
