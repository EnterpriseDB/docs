...
1. In the Azure portal, search for "Virtual networks". When "Virtual networks" appear in the search results, select it. Don't select "Virtual networks (classic)", as you can't create a peering from a virtual network deployed through the classic deployment model.
