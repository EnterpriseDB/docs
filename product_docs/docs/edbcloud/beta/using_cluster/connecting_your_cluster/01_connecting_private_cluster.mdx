...
Let us use an example to guide you through the procedures of implementing the different 
solutions. In this example, assume that your EDB Cloud cluster is on a subscription called `development` 
