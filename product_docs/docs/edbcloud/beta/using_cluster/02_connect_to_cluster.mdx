...
Once connected to the cluster using psql, the `conninfo` meta-command will show the encryption protocol being used for communication, in the case of EDB Cloud,  TLS (v1.2+) is supported:
