...
!!!note
Not all database configuration parameters are supported by EDB Cloud. Some parameters are reserved for EDB to provide the managed database features of EDB Cloud such as `wal_level` and `restore_command`. 
!!!
