...
The following are useful examples of KQL queries:

`PostgresLogs_CL | project record_log_time_s, record_error_severity_s, record_detail_s | sort by record_log_time_s desc`
...
To view logs from your PostgreSQL clusters using Shared Dashboard, do the following:
