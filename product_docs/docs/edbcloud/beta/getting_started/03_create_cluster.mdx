...
---
!!! Note
Prior to creating your cluster, make sure you have adequate Azure resources. See [Checking Your Azure Resource Limits](../getting_started/01a_check_resource_limits/).
!!!
...
* [Administering your account](../administering_cluster/ )
