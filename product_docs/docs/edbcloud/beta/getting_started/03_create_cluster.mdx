...
---
!!! Note
Prior to creating your cluster, make sure you have adequate Azure resources or your request to create a cluster will fail. See [Checking Your Azure Resource Limits](../getting_started/01a_check_resource_limits/).
!!!
