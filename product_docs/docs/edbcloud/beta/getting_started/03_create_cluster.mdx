...
11. In the **Storage** field, select the type and amount of storage needed for your cluster. 
   !!! Note
       The supported storage types for the Preview include all Azure Premium SSD types. See [Premium SSD](https://docs.microsoft.com/en-us/azure/virtual-machines/disks-types#premium-ssd) for more information.
