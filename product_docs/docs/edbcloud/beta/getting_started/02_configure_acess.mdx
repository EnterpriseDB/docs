...
!!! Note
    This feature may not be available in the preview release. The preview release may have only one predefined role _Owner_.
...
!!! Note
    Azure AD email domain will likely be different from the domain regurly used by your organization.
...
![Assign Roles to Users](images/assign-roles.png "list users")
