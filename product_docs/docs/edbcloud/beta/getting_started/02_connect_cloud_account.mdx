...
The specific output includes the client ID and client secret you use when you configure your account. See [Step 4. Configure your account](#4-configure-your-account) in the following procedure.
