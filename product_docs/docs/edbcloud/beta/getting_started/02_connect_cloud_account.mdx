...
!!! Note
    Some steps of the subscription process require approval of Azure AD _Global Administrator_.
    You must be in a role _Global Administrator_ or ensure cooperation of a _Global Administrator_ of Azure AD of your organization.
...
!!! Note
    After step 1  you will be prompted for approval of Azure AD _Global Administrator_.
