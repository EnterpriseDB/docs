...
#### Create Your Azure AD Application Using `create-spn`

To use the `create-spn` script to create your Azure AD Application, use the script as the example:
