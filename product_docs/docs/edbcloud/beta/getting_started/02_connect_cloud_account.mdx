...
You can create Azure Active Directory Application using Azure Portal. Users of Azure CLI can crete Azure Active Directory Application using `create-spn` script.
...
### Create Azure Active Directory Application Using `create-spn` Script

To simplify the process of creating Azure AD Application, EDB provides the `create-spn` script. You can download it [here](https://github.com/EnterpriseDB/cloud-utilities/tree/main/azure).
...
Required tools:
  jq
Usage:
  ./azure/create-spn.sh -d NAME -s SUBSCRIPTION_ID [options]

Options:
  -d, --display-name: The name of Azure AD App.
  -s, --subscription: The Azure Subscription ID used by EDB Cloud.
  -h, --help:         Show this help.
```

#### Example of creating Azure AD Application Using `create-spn` Script

To crete Azure AD Application with subscription ID  `c808xxxx-xxxx-xxxx-xxxx-xxxxxxxxb712` and display name `hello-s`
 use the script as follows:

```
./create-spn.sh -d "hello-s" -s c808xxxx-xxxx-xxxx-xxxx-xxxxxxxxb712
...
2. Fill in the following parameters in the form:
   ...
   | **Azure AD: Application Client Secret Value** | Application client secret value you noted when [creating your Azure AD Application](#create-azure-ad-application).|
