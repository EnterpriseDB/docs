...
services; by defaul it is not routable from other networks, even in
your Azure account. Please see [Connecting to Your
Cluster](../../connecting_your_cluster/) for details and instructions
