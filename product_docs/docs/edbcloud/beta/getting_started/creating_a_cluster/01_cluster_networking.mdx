...
subscription per EDB Cloud region; subsequent public clusters add
...
Azure subscription per EDB Cloud region; subsequent private clusters add additional IP addresses to the existing load balancer.
