...
12. (Optional) Expand the **Advanced Customization** section, to specify:
    ...
    1.  Whether to use private or public networking using the **Networking** buttons. Networking is set to Private by default. Private networking allows only IP addresses within your private network to connect to your cluster. Public means that any client can connect to your cluster’s public IP address over the internet. See [Creating a Private Networking Cluster](01_private_networking) for more information.
