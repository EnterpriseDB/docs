...
- [Request a standard quota increase from subscriptions](https://docs.microsoft.com/en-us/azure/azure-portal/supportability/regional-quota-requests#request-a-standard-quota-increase-from-subscriptions)
...
- [Request networking quota increase at subscription level using usages + quotas](https://docs.microsoft.com/en-us/azure/azure-portal/supportability/request-networking-quota-increase-at-subscription-level-using-usages-quotas)
