...
**Embedded video option 1:** Showing the thumbnail

[![Raising Azure Resource Limits](images/raising-limits-video.png)](https://www.youtube.com/watch?v=cfl11ajrPhE "Raising Azure Resource Limits")

**Embedded video option 2:** Just showing the link

This topic describes the process. Watch [![Raising Azure Resource Limits](https://www.youtube.com/watch?v=cfl11ajrPhE)](https://www.youtube.com/watch?v=cfl11ajrPhE "Raising Azure Resource Limits") for a demo.
