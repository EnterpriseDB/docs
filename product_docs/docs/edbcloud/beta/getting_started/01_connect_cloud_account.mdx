...
5. Fill in the following parameters in the form: form using the values of parameters you noted when [creating your Azure AD Application](#create-azure-ad-application) and your EDB Cloud Origanization Name found on the overview page of a subscription.
   ...
   | **Azure Subscription ID**             | Azure subscription ID available from the Subscriptions page of your Azure account.  |
