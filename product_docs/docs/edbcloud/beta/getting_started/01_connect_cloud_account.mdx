...
If your role is Owner, Contributor or Support Request Contributor for your Azure account, you can send requests to increase those limits. Please ensure that the Default subscription filter is updated for the expected subscription id.
...
| **Your EDB Cloud Organization Name**  | Name you assigned to your EDB Cloud Organization Name                          |
