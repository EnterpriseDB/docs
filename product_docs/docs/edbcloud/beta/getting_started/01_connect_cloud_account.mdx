...
<table>
    ...
    <tr>
        <td><strong>Your EDB Cloud Organization Name</strong>
        </td>
        <td> NA
        </td>
        <td>
...
4. Finally, you must configure EDB Cloud to use your Azure subscription, your Azure Service Principal and your Resource Group.
