...
EDB Cloud enables deploying a cluster with or without High Availability. The option is presented as a High Availablity on/off toggle button on the Create Cluster page in the EDB Cloud Portal.   
