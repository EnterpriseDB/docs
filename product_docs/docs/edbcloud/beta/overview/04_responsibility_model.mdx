...
- Customers are responsible for choosing if they want to enable high availability. 


## Database Performance
- EDB is responsible for managing and monitoring the underlying infrastructure resources. 
- Customers are responsible for data modeling, query performance, and scaling the cluster to meet their performance needs. 

## Scaling 
- EDB is responsible for managing and monitoring the underlying infrastructure.
- Customers are responsible for choosing the appropriate resources for their workload, including instance type, storage, and connections. Customers are also responsible for managing their Azure resource limits to ensure the underlying infrastructure can be scaled.

## Backups and Restores
- EDB is responsible for taking automatic backups and storing them in cross-regional Azure Blob Storage. 
- Customers are responsible for periodically restoring and verifying the restores to ensure that archives are completing frequently and successfully to meet their needs. 

## Encryption
- EDB is responsible for data encryption at rest and in transit. EDB is also responsible for encrypting backups.
- Customers are responsible for column level encryption to protect sensitive database attributes from unauthorized access by authorized users and applications of the database.

## Credential Management 
- EDB is responsible for making credentials available to customers.
- Customers are responsible for managing and securing their passwords, both for EDB Cloud and their database passwords.
