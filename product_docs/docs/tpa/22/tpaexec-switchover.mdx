...
originalFilePath: tpaexec-switchover.md
...
replication](reference/architecture-M1). After you run this command, the
...
This command is applicable only to [M1 clusters](reference/architecture-M1)
