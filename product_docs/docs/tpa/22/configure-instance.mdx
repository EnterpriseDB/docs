...
-   [Distribution support](distributions)
-   [Python environment](python) (`preferred_python_version`)
-   [Environment variables](target_environment) (e.g., `https_proxy`)
...
-   [Configure YUM repositories](yum_repositories)
    (for RHEL, Rocky and AlmaLinux)

-   [Configure APT repositories](apt_repositories)
    (for Debian and Ubuntu)

-   [Configure 2ndQuadrant repositories](tpa_2q_repositories)
    (on any system)

-   [Configure EDB repositories](edb_repositories)
    (on any system)

-   [Configure a local package repository](local-repo)
...
-   [Install non-Postgres packages](packages)
...
-   [Create and mount filesystems](volumes) (including RAID,
    LUKS setup)
-   [Upload artifacts](artifacts) (files, directories,
    tar archives)
-   [Set sysctl values](sysctl_values)
-   [Configure /etc/hosts](hosts)
-   [Manage ssh_known_hosts entries](manage_ssh_hostkeys)
...
-   [Install Postgres and Postgres-related packages](postgres_installation_method_pkg)
    (e.g., pglogical, BDR, etc.)

-   [Build and install Postgres and extensions from source](postgres_installation_method_src)
...
-   [Configure the postgres Unix user](postgres_user)

-   [Run initdb to create the PGDATA directory](initdb)

-   [Configure pg_hba.conf](pg_hba.conf)

-   [Configure pg_ident.conf](pg_ident.conf)
...
-   [Configure Barman](barman)
-   [Configure pgbouncer](pgbouncer)
-   [Configure haproxy](haproxy)
-   [Configure HARP](harp)
-   [Configure EFM](efm)
...
-   [Create Postgres users](postgres_users)

-   [Create Postgres tablespaces](postgres_tablespaces)

-   [Create Postgres databases](postgres_databases)

-   [Configure pglogical replication](pglogical)

-   [Configure .pgpass](pgpass)
