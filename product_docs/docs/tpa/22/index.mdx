...
Here's a [list of capabilities and supported software](tpaexec-support).
...
-   [Custom commands](tpaexec-commands), which make it simple to write
...
-   [Custom tests](tpaexec-tests), which augment the builtin tests with
