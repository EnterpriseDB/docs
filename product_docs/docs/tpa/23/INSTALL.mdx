...
First, set up the repository. Setting up the repository is a one-time task. If you have already set up your repository, you don't need to perform this step.
...
!!! Important EDB repository access 
    Before installing the tpaexec package, first subscribe to the EDB repository. Go to [EDB repositories](https://www.enterprisedb.com/repos-downloads) and follow the instructions provided there.
