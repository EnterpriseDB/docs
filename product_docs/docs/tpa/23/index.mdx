...
Follow the [installation instructions](INSTALL/) for your platform.
...
For more information, see [TPA capabilities and supported software](reference/tpaexec-support/).
