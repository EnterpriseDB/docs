---
navTitle: Task selection
description: Selecting which tasks TPA should run during deployment.
title: Selective task execution
originalFilePath: task-selection.md
...
-   artifacts
      ...
      Tasks related to [artifacts](reference/artifacts/).
...
-   fs
      ...
      Tasks related to setting up additional [volumes](reference/volumes/) on
      instances.

-   hostkeys

      Tasks which set up [ssh host keys](reference/manage_ssh_hostkeys/).
...
-   hosts
      ...
      Tasks which [add entries to /etc/hosts](reference/hosts/)
...
-   local-repo
      ...
      Tasks which set up [local package repositories](reference/local-repo/).

-   locale

      Tasks which install [locale support](reference/locale/).
...
-   pgpass
      ...
      Tasks which create the [.pgpass](reference/pgpass/) file.
...
-   sysctl_net
      ...
      [Setting sysctl values](reference/sysctl_values/).
