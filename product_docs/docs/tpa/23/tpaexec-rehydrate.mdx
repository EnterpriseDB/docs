---
navTitle: Rehydration
title: tpaexec rehydrate
originalFilePath: tpaexec-rehydrate.md
...
a [streaming replication cluster](reference/architecture-M1), you can rehydrate
...
replication](reference/architecture-M1) with a primary instance, two replicas,
