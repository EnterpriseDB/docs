---
navTitle: PGD-S (PGD 6)
description: Configuring a PGD-S cluster with TPA.
title: PGD-S
originalFilePath: architecture-PGD-S.md
...
!!! Note
    ...
    or [Lightweight](architecture-PGD-Lightweight/).
    ...
    All software is be sourced from [EDB Repos 2.0](reference/edb_repositories/).
