...
| `--enable-efm`            | Configure Failover Manager as the cluster failover manager. | TPA selects EFM as the failover manager for EPAS and repmgr for all other flavors. |
