...
| `--enable-efm`            | Configure EDB Enterprise Failover Manager as the cluster failover manager. | TPA will select EFMas the failover managerfor EPAS, and repmgrfor all other flavours. |
