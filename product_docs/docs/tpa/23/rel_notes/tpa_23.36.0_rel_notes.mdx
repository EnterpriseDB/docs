...
<tr><td><details><summary>Add support for Ubuntu Noble 24.04</summary><hr/><p>TPA runs on Ubuntu 24.04 and supports this OS as a target host. <strong>EDB packages for Ubuntu 24.04 will be generally available at the end of March 2025. Before that, deployments needing EDB  packages will likely fail.</strong></p></details></td><td></td></tr>
</tbody></table>
...
<tr><td><details><summary>Support EFM 'backup.wal' property.</summary><hr/><p>Starting with EFM 5.0, a new property 'backup.wal' has been added. This change adds the new property if the version of EFM is 5 or higher.</p></details></td><td></td></tr>
