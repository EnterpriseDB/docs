...
description: >-
  Deploying and managing TPA clusters using Ansible Tower/Ansible Automation
  Platform.
...
in [Configuration](tpaexec-configure/), are still valid.
...
configuration](configure-cluster/) for more details.
