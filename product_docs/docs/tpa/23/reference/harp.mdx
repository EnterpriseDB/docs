---
title: Configuring HARP
originalFilePath: harp.md
...
| Variable            | Default value                                                                                                                                                             | Description                                                                          |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| `harp_http_options` | `enable: false``secure: false``host: <inventory_hostname>``port: 8080``probes:`  `timeout: 10s``endpoint: "host=<proxy_name> port=<6432> dbname=<bdrdb> user=<username>"` | Configure the http section of harp config.yml that defines the http(s) api settings. |
