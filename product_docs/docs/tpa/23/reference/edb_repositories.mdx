---
title: Configuring EDB repositories
...
you must `export EDB_SUBSCRIPTION_TOKEN=<token>` before you run
`tpaexec`. You can get your subscription token from the [EDB repositories page](https://www.enterprisedb.com/repos-downloads).
