...
other tools such as pg_upgrade or [pgd node upgrade](/pgd/latest/reference/cli/command_ref/node/upgrade/).
...
When you have used `pg_upgrade`, [`pgd node upgrade`](/pgd/latest/reference/cli/command_ref/node/upgrade/),
