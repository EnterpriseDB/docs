...
other tools such as pg_upgrade or [pgd node upgrade](/pgd/latest/upgrades/inplace_upgrade/#pgd-node-upgrade-command-line).
...
When you have used `pg_upgrade`, [`pgd node upgrade`](/pgd/latest/upgrades/inplace_upgrade/#pgd-node-upgrade-command-line),
