---
title: Configuring 2ndQuadrant repositories
originalFilePath: tpa_2q_repositories.md
...
On Debian and Ubuntu systems, it uses the APT repository. On
...
Either of the above conditions results in no 2ndQuadrant repositories being installed.
