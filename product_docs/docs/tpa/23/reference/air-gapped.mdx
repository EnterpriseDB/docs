...
[Creating and using a local repository](local-repo/). If you use this approach, 
...
the [`download-packages`](tpaexec-download-packages/) command. 
...
!!! Note
    ...
    follow [these instructions](../INSTALL/#installing-tpa-without-internet-or-network-access-air-gapped)
    to install it.
...
See [Creating and using a local repository](local-repo/) for more information.

## Downloading packages

On the internet-connected machine with
[docker installed](../platform-docker/), run:
