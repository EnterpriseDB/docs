...
[EDB Postgres Distributed](/bdr/latest) clusters. The core design of 
...
EDB Postgres Distributed nodes in the cluster. On failure or unavailability of 
the lead master, HARP elects a new lead master and redirects application traffic.
...
HARP requires EDB Postgres Distributed versions 3.6 and later.
