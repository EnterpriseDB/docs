...
[Node directives](04_configuration#node_directives) are valid here.
...
Sets proxy-related attributes for the named proxy. Any options mentioned in the [Proxy directives](04_configuration#proxy_directives) 
are valid here.  
