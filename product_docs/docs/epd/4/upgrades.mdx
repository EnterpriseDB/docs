...
Always check the [monitoring](monitoring.md) after upgrade
...
controlled manually, as described in [DDL Replication](ddl.md), which
...
[Replicating between nodes with differences](appusage.md).
