...
- [EDB Postgres Extended Server] - PostgreSQL compatibility and additional features
- [EDB Postgres Advanced Server] - Oracle compatibility and additional features
