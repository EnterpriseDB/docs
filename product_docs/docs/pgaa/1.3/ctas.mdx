...
To write to object storage, you must [create a PGFS storage location](/edb-postgres-ai/1.3/ai-factory/pipeline/pgfs/functions/#creating-a-storage-location). This defines the target bucket and provides the necessary credentials. For example:
