...
You can access data in object storage either through a storage location or via an integrated [Iceberg catalog](catalog). A storage location establishes a bridge between your Postgres instance and your data lake. 
...
For a comprehensive list of configuration parameters and supported storage providers, see [Creating a PGFS storage location](/edb-postgres-ai/1.3/ai-factory/pipeline/pgfs/functions/#creating-a-storage-location). 
