...
-   [Analytics Terminology](/pgaa/current/terminology) — learn the key terms used
-   [Generic Concepts](/pgaa/current/generic-concepts) — understand common architectures and patterns
...
-   [Columnar storage formats](/pgaa/current/generic-concepts#columnar-storage-formats)
-   [Vectorized query engines](/pgaa/current/generic-concepts#vectorized-query-engines)
-   [Separation of storage and compute](/pgaa/current/generic-concepts#separation-of-storage-and-compute)
-   [Open table formats](/pgaa/current/generic-concepts#open-table-formats)
...
Related concept: [Vectorized query engines](/pgaa/current/generic-concepts#vectorized-query-engines)
...
-   [Data tiering](/pgaa/current/generic-concepts#data-tiering)
-   [ETL / ELT](/pgaa/current/generic-concepts#etl--elt)
...
Related concept: [OLAP / OLTP](/pgaa/current/generic-concepts#olap--oltp)
...
-   [Semantic search](/pgaa/current/generic-concepts#semantic-search)
-   [Vector embeddings](/pgaa/current/generic-concepts#vector-embeddings)
-   [Retrieval augmented generation (RAG)](/pgaa/current/generic-concepts#retrieval-augmented-generation-rag)
...
-   [Analytics Accelerator Generic Concepts](/pgaa/current/generic-concepts)
