...
**Start here:** [Analytics Accelerator generic concepts](/pgaa/current/generic-concepts)
...
**Continue your journey:** [Analytics Accelerator concepts](/pgaa/current/analytics-concepts) + [How-To Guides](/pgaa/current/#how-tos-runbook-aligned)
...
**Advance your expertise:** See [Architecture](/pgaa/current/architecture) and [Reference](/pgaa/current/reference/index.mdx)
...
-   **Role-based guidance:** See [Analytics Accelerator for your role](/pgaa/current/personas.mdx) for resources tailored to your job function.
-   **Solution-oriented examples:** Visit [Analytics in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/) for real-world examples.

* * *

## Next steps

-   Build your foundation with [Analytics Accelerator generic concepts](/pgaa/current/generic-concepts)
-   Learn EDB’s approach in [Analytics Accelerator concepts](/pgaa/current/analytics-concepts)
-   Apply your knowledge with [How-To Guides](/pgaa/current/#how-tos-runbook-aligned)
-   Explore industry applications via [Analytics in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/)
