...
-   [Configure PGD data tiering](tiered_tables_howto) ► Learn how to configure your PGD cluster to manage your date lifecycle by moving Postgres data to object storage. 