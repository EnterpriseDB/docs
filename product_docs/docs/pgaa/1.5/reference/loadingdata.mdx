...
See [Delta Lake Table tools](/pgaa/current/reference/delta_tables.mdx) for more information on how to get and use that utility.

For more details, see [querying Delta Lake tables](/pgaa/current/how-to-lakehouse-read-with-without-catalog).
