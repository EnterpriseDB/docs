...
- Restoring into an existing database that already contains PGAA tables results in those tables restoring empty. Use `--redirect-db` to restore into a new, empty database.
