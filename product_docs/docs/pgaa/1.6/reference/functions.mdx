...
To run this function, you must set configuration parameter `pgaa.executor_engine` to `spark_connect` and point `pgaa.spark_connect_url` to an available Spark Connect service.
