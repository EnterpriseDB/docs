...
PGAA supports reading from and writing (using [CTAS](ctas)) to Iceberg and Delta tables using the following catalog implementations: 
...
Where:
- `pgaa.format`: Sets the table format. Supporte values are 'iceberg' and 'delta'.
