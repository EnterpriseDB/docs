...
For architectural background, see [Lakehouse clusters in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/lakehouse.mdx).
...
- [Configure an Iceberg REST catalog connection](/pgaa/current/how-to-iceberg-reads-writes-with-catalog)
...
- [Configure a PGFS storage location](/edb-postgres-ai/latest/ai-factory/pipeline/pgfs/) — if querying Delta Lake or filesystem-based Iceberg.
- [Configure an Iceberg REST catalog connection](/pgaa/current/how-to-iceberg-reads-writes-with-catalog) — if querying catalog-managed Iceberg tables or using PGD Tiered Tables.

- **Define and query Lakehouse tables:**
- [Read Iceberg and Delta Lake tables](/pgaa/current/how-to-lakehouse-read-with-without-catalog)

- **Query Tiered Tables offloaded from PGD:**
- Learn concepts for [Tiered Tables](/pgaa/current/tiered_tables)

## Related topics

- [Lakehouse clusters in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/lakehouse.mdx)
