...
- **No-catalog offload**: Store metadata alongside data files using [storage locations](../read_no_catalog#creating-a-storage-location) to connect directly to object storage.
