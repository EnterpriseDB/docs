...
- On manual restores, set `max_worker_processes` before starting Postgres. `barman recover` handles this adjustment automatically. See [Backup and recovery](/pgd/latest/backup-restore/) in the PGD documentation for details.
