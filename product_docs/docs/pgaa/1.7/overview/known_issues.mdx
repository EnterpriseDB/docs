...
description: Learn about known issues in Analytics Accelerator version 1.7.
---
...
- The function [pgaa.execute_compaction()](../reference/functions#pgaaexecute_compaction) does not support the parameter `settings`. Use [pgaa.spark_sql()](../reference/functions#pgaaspark_sql) or [pgaa.launch_task()](../reference/functions#pgaalaunch_task) to run Spark procedures directly in your cluster or to execute compaction for Iceberg tables. 
