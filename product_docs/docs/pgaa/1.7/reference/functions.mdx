...
!!! Note
    ...
    The parameter `settings` is currently not supported. Instead, use [pgaa.spark_sql()](#pgaaspark_sql) to run Spark queries directly on your cluster.
...
Runs a synthetic, pgbench-like replication benchmark to measure the performance of data ingestion into a specified storage location. It calculates the initial data load speed and the sustained transaction throughput.
...
| Parameter          | Type      | Description                                                                                                                  |
| ------------------ | --------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `storage_location` | `TEXT`    | The name of the PGFS destination storage location where the benchmark data will be written.                                  |
