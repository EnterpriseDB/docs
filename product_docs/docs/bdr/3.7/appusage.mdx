...
The synchronous replication features of PGLogical are available to BDR
as well.  More advanced variants of synchronous replication features
are available with the Enterprise Edition.
