...
is smart enough to reconstruct the new row, filling the
...
will, by default, log every conflict into the `bdr.conflict_history` table.
This behaviour can be changed with more granularity with the following functions.
