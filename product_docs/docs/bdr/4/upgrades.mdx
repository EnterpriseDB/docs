...
While this chapter primarily discus upgrades of BDR itself, it's also
possible to do major version upgrade of Postgres this way. This
can be done using `bdr_pg_upgrade` tool which is described further
