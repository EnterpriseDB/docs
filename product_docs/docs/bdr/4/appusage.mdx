...
replication. See
[Choosing durability](/pgd/4/choosing_durability) in the EDB Postgres Distributed documentation for an overview and comparison of all variants available and
its different modes.
