...
-   [Deploying NVIDIA NIM Microservices in Hybrid Manager](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-serving/deploy-nim-container/)
-   [Verify deployed models](/edb-postgres-ai/1.2/hybrid-manager/ai-factory/learn/how-to/verify-models/)
-   [Model Serving Concepts Hub](/edb-postgres-ai/1.2/ai-factory/learn/explained/model-serving-concepts/)
-   [Model Serving FAQ](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-serving/faq/)
-   [AI Factory Concepts](/edb-postgres-ai/1.2/ai-factory/learn/explained/ai-factory-concepts/)
-   [How to set up GPU resources](/edb-postgres-ai/1.2/hybrid-manager/ai-factory/learn/how-to/setup-gpu/)
