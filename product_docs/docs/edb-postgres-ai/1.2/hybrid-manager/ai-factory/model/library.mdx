...
-   [How to deploy AI models in Hybrid Manager](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-library/how-to-deploy-ai-models/)
-   [Manage repository metadata](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-library/manage-repository-metadata/)
-   Full reference on the underlying concepts: [Model Library Hub](/edb-postgres-ai/1.2/ai-factory/model/library/)
