...
-   [AI Factory concepts](/edb-postgres-ai/current/ai-factory/learn/explained/ai-factory-concepts/) — how AI Factory fits within the EDB Postgres AI ecosystem.
-   [Model Image Library](explained/model-image-library-explained/) — how prebuilt and custom model containers are managed.
-   [Container Registry Integration](explained/container-registry-explained/) — how models are delivered and stored.
...
-   [Enable and configure GPU support](how-to/setup-gpu/) — provision GPU resources and prep your cluster.
-   [Verify deployed models](how-to/verify-models/) — check model status and GPU usage after deployment.
...
-   [AI Factory Learning Path](paths/) — start with enabling the platform and progress to model deployment and advanced usage.
