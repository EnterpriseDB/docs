...
For an architectural deep dive and full feature reference, start with the [Gen AI Hub](/edb-postgres-ai/current/ai-factory/gen-ai/).
...
See: [Agent Studio in Hybrid Manager](./agent-studio).
...
See: [Gen AI Builder in Hybrid Manager](./builder).
