...
For architectural background, see [Lakehouse clusters in Hybrid Manager](../../lakehouse.mdx).
...
-   [Configure a PGFS storage location](./configure-delta-pgfs) — if querying Delta Lake or filesystem-based Iceberg.

-   [Configure an Iceberg REST catalog connection](./configure-iceberg-catalog) — if querying catalog-managed Iceberg tables or using PGD Tiered Tables.
...
-   [Analytics in Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/analytics/learn/)
