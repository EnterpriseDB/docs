...
- Use the HM console, API, or CLI to deploy PGD clusters and Lakehouse Clusters.
...
For an overview of core analytics concepts, see [Analytics Concepts in Hybrid Manager](analytics_concepts.mdx).
