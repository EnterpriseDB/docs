...
-   **[A secret for Griptape and configures DeltaLake object storage](/edb-postgres-ai/1.2/hybrid-manager/install/customization/genai_secret/) (optional for GenAI Builder)**

-   **[A secret for Catalog](/edb-postgres-ai/1.2/hybrid-manager/install/customization/data_catalog_secret/) (optional for using Catalog)**

-   See also **[custom secrets for Migration Portal](/edb-postgres-ai/1.2/hybrid-manager/install/customization/migration_portal_secrets/) (optional to secure internal communications with Migration Portal)**
