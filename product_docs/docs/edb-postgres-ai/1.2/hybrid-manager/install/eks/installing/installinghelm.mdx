...
-   **[A secret for Griptape and DeltaLake object storage configuration](/edb-postgres-ai/1.2/hybrid-manager/install/customization/genai_secret/) (optional for GenAI Builder)**
