...
See the [following documentation](gcpcluster) for setting up the Griptape secret.

#### Catalog secret

See the [following documentation](gcpcluster) for setting up the Catalog secret.
