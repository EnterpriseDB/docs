...
-   **[Create a secret for Griptape and configure DeltaLake object storage](/edb-postgres-ai/1.2/hybrid-manager/install/customization/genai_secret/) (optional for GenAI Builder)**

-   **[Create a secret for Catalog](/edb-postgres-ai/1.2/hybrid-manager/install/customization/data_catalog_secret/) (optional for using Catalog)**

-   **[Create custom secrets for Migration Portal](/edb-postgres-ai/1.2/hybrid-manager/install/customization/migration_portal_secrets/) (optional to secure internal communications with Migration Portal)**
