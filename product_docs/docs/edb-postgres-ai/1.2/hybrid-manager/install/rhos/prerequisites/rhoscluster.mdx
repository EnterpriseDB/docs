...
-   **[Create a secret for Griptape and configure DeltaLake object storage](/edb-postgres-ai/current/hybrid-manager/install/customization/genai_secret/) (optional for GenAI Builder)**

-   **[Create a secret for Catalog](/edb-postgres-ai/current/hybrid-manager/install/customization/data_catalog_secret/) (optional for using Catalog)**

-   **[Create custom secrets for Migration Portal](/edb-postgres-ai/current/hybrid-manager/install/customization/migration_portal_secrets/) (optional to secure internal communications with Migration Portal)**
...
stringData:
    ...
    # Optional: when_required or when_supported
    #
    # Configures the computation and validation of checksums when interating with the object storage
    # Some object stores require setting these parameters to when_required
    aws_request_checksum_calculation: xxx
    aws_response_checksum_validation: xxx
```
