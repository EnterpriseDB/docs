...
-   **Identity Provider (IDP):** Optional, for [integrating with existing authentication systems](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/managing_users/byo_idp/).
