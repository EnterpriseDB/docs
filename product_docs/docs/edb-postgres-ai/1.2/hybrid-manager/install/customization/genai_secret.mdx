...
After you've configured the secret and created a dedicated bucket, continue with [Hybrid Manager installation](/edb-postgres-ai/1.2/hybrid-manager/install/).
