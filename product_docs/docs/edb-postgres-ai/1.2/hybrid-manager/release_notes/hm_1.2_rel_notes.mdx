...
-   [AI Factory Overview](/edb-postgres-ai/1.2/hybrid-manager/ai-factory/)
-   [Analytics Lakehouse Architecture](../analytics)
-   [Power & ESG Reporting](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/monitoring/monitoring_grafana/grafana_dashboards/other_dashboards/#power-consumption-power-usage--carbon-footprint)
