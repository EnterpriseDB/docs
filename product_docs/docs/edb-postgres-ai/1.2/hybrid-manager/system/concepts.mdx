...
Sovereign Data and AI Factory combines physical infrastructure, orchestration software, and lifecycle automation into a single system, preassembled and installed in your data center.
...
The administration node provides additional software packages, licensing, and support tooling for your Sovereign Data and AI Factory. You need one administration node per installation.
