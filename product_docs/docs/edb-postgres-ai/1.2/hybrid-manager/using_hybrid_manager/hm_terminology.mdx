...
You can connect self-managed clusters to Hybrid Manager for observability with the [Agent](monitoring/mon_ext_dbs/mon_with_agent) and perform migrations with the [Data Migration Service](migration/).
...
You can [connect CSP-managed clusters to Hybrid Manager for observability](monitoring/mon_ext_dbs/mon_ext_csp) and perform migrations with the [Data Migration Service](migration/).
