...
-   Adjust WAL and data volume allocation by [editing](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/cluster_management/manage-clusters/edit-clusters/#editing-a-cluster) your cluster's **Storage**. 
...
-   Adjust memory allocation by [editing](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/cluster_management/manage-clusters/edit-clusters/#editing-a-cluster) your cluster's **Cluster Settings** > **Instance size**.
...
For HM-managed database clusters, adjust CPU allocation by [editing](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/cluster_management/manage-clusters/edit-clusters/#editing-a-cluster) your cluster's **Instance size**.
...
Adjust WAL configurations by [editing](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/cluster_management/manage-clusters/edit-clusters/#editing-a-cluster) your cluster's **DB Configuration**. Search for the `max_wal_size` parameter, provide the new size in MB and save to apply the configuration. 
