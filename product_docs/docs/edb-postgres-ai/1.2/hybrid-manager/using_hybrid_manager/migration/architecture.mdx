...
![Migrations from Oracle databases](/edb-postgres-ai/1.2/hybrid-manager/images/hm_migrations_oracle.svg/)
...
![Migrations from Postgres databases](/edb-postgres-ai/1.2/hybrid-manager/images/hm_migrations_pg.svg/)
