...
2.  [Install the EDB DMS Writer](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/migration/installing2/).
...
1.  Set the variables according to your environment and uncomment the edited lines. See [parameters](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/migration/writer_reference/) for further guidance. The script is reproduced below.
