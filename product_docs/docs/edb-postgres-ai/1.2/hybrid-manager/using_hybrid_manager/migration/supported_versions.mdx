...
Postgres sources require a database role or user that can manage replications. For details, see [Preparing Postgres source databases](migration_guides/self_managed_pg_to_hm_managed/preparing_source_pg_db/).
...
Postgres destinations require a database role or user that can manage replications. For details, see [Preparing Postgres destination databases](migration_guides/self_managed_pg_to_self_managed_pg/preparing_destination_selfpg_db/).
