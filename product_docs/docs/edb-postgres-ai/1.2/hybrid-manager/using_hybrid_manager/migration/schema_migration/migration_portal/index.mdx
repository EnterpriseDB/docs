...
-   The Migration Portal built into the Hybrid Manager is accessed directly within the product. 
    -   Use [project-scoped access](hm_schema_migration/) to migrate schemas loaded by the Agent.
    -   Use the [user's workspace access](external_schema_migration/) to migrate externally provided schemas. 
