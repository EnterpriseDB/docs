...
-   The *project-scoped workspace* in the Migration Portal is where you manage Migration Portal (MP) projects created with the Hybrid Manager Console for schemas loaded by the [Agent](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/migration/migration_guides/oracle_to_hm_managed/).
