...
!!!info
   ...
   You can also use the Agent to [assess your Oracle database for migration](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/migration/migration_guides/oracle_to_hm_managed/).
