...
description: Learn how to configure the EDB Postgres AI agent for monitoring with Hybrid Manager.
---

Configure the EDB Postgres AI agent (deployed as `beacon-agent`) to allow it to connect to your Hybrid Manager and fetch monitoring data from the source database.
