...
-   [**Projects**](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/projects/), where you create and manage projects, create and manage clusters, and perform a variety of tasks to manage your cluster and each project.
...
-   [**Asset Library**](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/image-management/asset-library/), where you can view container images and knowledge bases and manage repositories.
