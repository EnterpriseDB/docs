...
For details on how Tiered Tables are implemented and managed within Hybrid Manager (HM), see [Implementing Tiered Tables in Hybrid Manager](/edb-postgres-ai/1.2/hybrid-manager/analytics/tiered_tables/).
...
[Implementing Tiered Tables in Hybrid Manager](/edb-postgres-ai/1.2/hybrid-manager/analytics/tiered_tables/)

How-To guides
[Configure PGFS storage for Tiered Tables](/edb-postgres-ai/1.2/hybrid-manager/analytics/learn/how-to/configure-tiered-pgfs/)
[Configure PGD node group for analytics offload](/edb-postgres-ai/1.2/hybrid-manager/analytics/learn/how-to/configure-tiered-offload/)
[Configure BDR AutoPartition with analytics offload](/edb-postgres-ai/1.2/hybrid-manager/analytics/learn/how-to/configure-tiered-autopartition/)
[Query Tiered Tables from PGD and Lakehouse](/edb-postgres-ai/1.2/hybrid-manager/analytics/learn/how-to/query-tiered-tables/)
