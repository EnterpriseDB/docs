...
→ For a full setup guide, see: [Setup GPU Resources for Model Serving](/edb-postgres-ai/current/hybrid-manager/ai-factory/learn/how-to/setup-gpu/)
...
-   [Model Library Explained](/edb-postgres-ai/current/ai-factory/learn/explained/model-library-explained/)
-   [Image and Model Library Explained](/edb-postgres-ai/current/hybrid-manager/ai-factory/learn/explained/model-image-library-explained/)
-   [Setup GPU Resources for Model Serving](/edb-postgres-ai/current/hybrid-manager/ai-factory/learn/how-to/setup-gpu/)
-   [Deploy NVIDIA NIM Microservices - Advanced Guide](/edb-postgres-ai/current/ai-factory/learn/how-to/model-serving/deploy-nim-container/)
