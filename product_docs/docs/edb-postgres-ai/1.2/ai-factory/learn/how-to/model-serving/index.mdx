...
-   [Model Serving Quickstart](/edb-postgres-ai/current/ai-factory/pipeline/models/getting-started/)
...
-   [Model Serving Explained](/edb-postgres-ai/current/ai-factory/learn/explained/model-serving-explained/)

* * *

For broader architecture context, see [AI Factory Concepts](/edb-postgres-ai/current/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference).
