...
AI Factory Model Serving (version 1.2) supports deploying models packaged as **NVIDIA NIM Microservices ** using KServe.
...
-   [AI Factory Concepts](/edb-postgres-ai/current/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference)
