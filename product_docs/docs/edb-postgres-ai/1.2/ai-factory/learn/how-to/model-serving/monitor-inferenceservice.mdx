...
For AI Factory users, Hybrid Manager will provide additional value-add monitoring and observability features — see [Model Serving in Hybrid Manager](/edb-postgres-ai/current/ai-factory/model/serving/).
...
-   [Model Serving in Hybrid Manager](/edb-postgres-ai/current/ai-factory/model/serving/) *(Coming soon)*
