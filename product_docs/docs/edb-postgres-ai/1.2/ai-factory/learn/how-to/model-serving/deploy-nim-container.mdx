...
While the steps here apply to general Kubernetes environments, in Hybrid Manager AI Factory, we provide additional value such as lifecycle management, observability, and simplified integration. Learn more in the [Model Serving in Hybrid Manager](/edb-postgres-ai/1.2/ai-factory/model/serving/) section.
...
-   [Model Serving Explained](/edb-postgres-ai/1.2/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference)
-   [AI Factory Terminology](/edb-postgres-ai/1.2/ai-factory/learn/explained/terminology/#model-serving)
