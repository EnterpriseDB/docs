...
See [Hybrid Manager Model Serving Observability](/edb-postgres-ai/current/hybrid-manager/ai-factory/learn/how-to/verify-models/) for additional guidance on using HCP observability tools with Model Serving.
...
-   [KServe in AI Factory Concepts](/edb-postgres-ai/current/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference)
-   [Hybrid Manager Model Serving Observability](/edb-postgres-ai/current/hybrid-manager/ai-factory/learn/how-to/verify-models/)
