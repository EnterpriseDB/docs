...
1.  [Assistants Explained](/edb-postgres-ai/1.2/ai-factory/learn/explained/assistants-explained/)
2.  [Tools Explained](/edb-postgres-ai/1.2/ai-factory/learn/explained/tools-explained/)
3.  [Create a Tool](/edb-postgres-ai/1.2/ai-factory/learn/how-to/gen-ai/create-tool/)
4.  [Structures Explained](/edb-postgres-ai/1.2/ai-factory/learn/explained/structures-explained/) — for multi-step pipelines and agent behaviors
...
1.  [Model Serving Concepts](/edb-postgres-ai/1.2/ai-factory/learn/explained/model-serving-concepts/)
2.  [Configure ServingRuntime](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-serving/configure-servingruntime/)
3.  [Advanced ServingRuntime Configuration](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-serving/faq/) *(placeholder — expand with custom Transformers/Explainers patterns)*
...
1.  [Observability for Model Serving](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-serving/observability/)
2.  [Monitor InferenceService](/edb-postgres-ai/1.2/ai-factory/learn/how-to/model-serving/monitor-inferenceservice/)
3.  [Hybrid Manager Observability](/edb-postgres-ai/1.2/hybrid-manager/ai-factory/model/serving/)
...
1.  [Hybrid Manager API Overview](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/using_the_api/)
2.  [Using the Hybrid Manager API](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/using_the_api/using_the_hm_api/)
