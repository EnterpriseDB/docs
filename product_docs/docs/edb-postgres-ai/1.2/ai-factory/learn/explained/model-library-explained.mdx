...
It is powered by the core **Image and Model Library** of Hybrid Manager (HCP). The Model Library presents a curated, AI-focused view of model images validated for production use.
...
-   [Image and Model Library Explained](../../../hybrid-manager/ai-factory/learn/explained/model-image-library-explained.mdx)
-   [Deploy AI Models](/edb-postgres-ai/current/ai-factory/learn/how-to/model-library/how-to-deploy-ai-models/)
-   [Integrate Private Registry](/edb-postgres-ai/current/ai-factory/learn/how-to/model-library/integrate-private-registry/)
-   [Define Repository Rules](/edb-postgres-ai/current/ai-factory/learn/how-to/model-library/define-repository-rules/)
-   [Model Serving Concepts](model-serving-concepts)
-   [Hybrid Manager: Using Model Serving](/edb-postgres-ai/current/hybrid-manager/ai-factory/model/serving/)
