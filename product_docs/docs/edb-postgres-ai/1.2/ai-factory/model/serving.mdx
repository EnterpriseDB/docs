...
-   EDB PG AI components (such as [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/), [Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/builder/), and Knowledge Bases) connect to these InferenceServices at runtime
