...
-   EDB PG AI components (such as [Pipelines](/edb-postgres-ai/1.2/ai-factory/pipeline/), [Gen AI Builder](/edb-postgres-ai/1.2/ai-factory/gen-ai/builder/), and Knowledge Bases) connect to these InferenceServices at runtime
