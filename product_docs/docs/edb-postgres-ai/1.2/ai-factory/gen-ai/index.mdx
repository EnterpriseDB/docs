...
[Gen AI Workloads in Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/)
...
See our [Use Cases](/edb-postgres-ai/current/ai-factory/learn/use-cases/) and [Solutions](/edb-postgres-ai/current/ai-factory/learn/solutions/) for detailed patterns.
...
-   Follow the [AI Factory 101 Learning Path](/edb-postgres-ai/current/ai-factory/learn/paths/101/)
-   Explore the [Explained Concepts](/edb-postgres-ai/current/ai-factory/learn/explained/) — Knowledge Bases, retrievers, Pipelines, and more
-   Build your first Assistant in [Agent Studio](agent-studio/)
-   Deploy Knowledge Bases using [Gen AI Builder](builder/)
