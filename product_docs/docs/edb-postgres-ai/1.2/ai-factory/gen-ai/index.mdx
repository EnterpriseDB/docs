...
[Gen AI Workloads in Hybrid Manager](/edb-postgres-ai/1.2/hybrid-manager/ai-factory/gen-ai/)
...
See our [Use Cases](/edb-postgres-ai/1.2/ai-factory/learn/use-cases/) and [Solutions](/edb-postgres-ai/1.2/ai-factory/learn/solutions/) for detailed patterns.
...
-   Follow the [AI Factory 101 Learning Path](/edb-postgres-ai/1.2/ai-factory/learn/paths/101/)
-   Explore the [Explained Concepts](/edb-postgres-ai/1.2/ai-factory/learn/explained/) — Knowledge Bases, retrievers, Pipelines, and more
