...
For a deep dive, see: [Data Lake explained](/edb-postgres-ai/current/ai-factory/learn/explained/data-lake-explained/).
...
-   Configure CORS to enable console interaction.
-   Obtain and provide required credentials to your deployment.

See [Configure the Data Lake](/edb-postgres-ai/current/ai-factory/learn/how-to/gen-ai/configure-datalake/) for the full step-by-step guide.

## Related topics

-   [Data Lake explained](/edb-postgres-ai/current/ai-factory/learn/explained/data-lake-explained/)
-   [Configure the Data Lake](/edb-postgres-ai/current/ai-factory/learn/how-to/gen-ai/configure-datalake/)
-   [Configure Data Sources](/edb-postgres-ai/current/ai-factory/gen-ai/builder/libraries/data-sources/)
-   [Configure Knowledge Bases](/edb-postgres-ai/current/ai-factory/learn/explained/knowledge-bases-explained/)
