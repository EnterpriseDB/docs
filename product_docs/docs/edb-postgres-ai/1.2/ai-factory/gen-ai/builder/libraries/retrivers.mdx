...
For a deep dive, see [Retrievers explained](/edb-postgres-ai/current/ai-factory/learn/explained/retrievers-explained/).
For step-by-step configuration, see [Create a Retriever](/edb-postgres-ai/current/ai-factory/learn/how-to/gen-ai/create-retriever/).
...
See [Griptape concepts](/edb-postgres-ai/current/ai-factory/learn/explained/ai-factory-concepts/) for more on Structures.
...
See [Create a Retriever](/edb-postgres-ai/current/ai-factory/learn/how-to/gen-ai/create-retriever/) for the full step-by-step guide.
