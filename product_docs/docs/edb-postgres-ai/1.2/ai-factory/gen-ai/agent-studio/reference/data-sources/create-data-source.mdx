...
You can specify a [Structure](../structures/create-structure.mdx) to run as a Data Source as long as your Structure returns a [`TextArtifact` or `ListArtifact` from the Gen AI Builder SDK](../../../builder/sdk/data/artifacts.mdx). You can use this as a way to build custom Data Sources.
