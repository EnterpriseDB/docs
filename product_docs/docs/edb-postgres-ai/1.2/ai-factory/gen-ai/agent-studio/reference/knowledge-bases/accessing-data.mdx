...
You can use the [GriptapeCloudVectorStoreDriver](../../../builder/sdk/drivers/vector-store-drivers.mdx#gen-ai-builder-knowledge-base) to query your Knowledge Base with Gen AI Builder.
