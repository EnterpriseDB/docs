...
Gen AI Builder Structures are Python applications that use the [Gen AI Builder SDK](../../../builder/sdk) to bring LLMs into your software environment. You can create Structures in the form of agents, sequential task pipelines, and parallelized workflows.
