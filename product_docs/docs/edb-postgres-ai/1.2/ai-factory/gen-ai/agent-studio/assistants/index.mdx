...
For a deep dive, see: [Assistants explained](/edb-postgres-ai/1.2/ai-factory/learn/explained/assistants-explained/).
...
See [Create an Assistant](/edb-postgres-ai/1.2/ai-factory/learn/how-to/gen-ai/create-assistant/) for a full step-by-step guide.
