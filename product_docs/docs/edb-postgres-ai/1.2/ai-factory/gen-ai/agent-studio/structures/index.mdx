...
-   [Deploy a Griptape-powered Structure from Data Lake](/edb-postgres-ai/current/ai-factory/learn/how-to/gen-ai/create-structure/) *(step-by-step deployment guide)*
-   [Create a Tool](/edb-postgres-ai/current/ai-factory/learn/how-to/gen-ai/create-tool/) *(Structures can implement Tools callable by Assistants)*
...
See [Create a Structure](/edb-postgres-ai/current/ai-factory/learn/how-to/gen-ai/create-structure/) for a full step-by-step guide.
...
-   [Gen AI Builder Hub](/edb-postgres-ai/current/ai-factory/gen-ai/builder/)
