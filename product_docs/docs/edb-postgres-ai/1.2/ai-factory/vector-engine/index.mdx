...
-   [Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/builder/) and Knowledge Bases use PGvector-backed retrievals.
...
-   Retrieval in Knowledge Bases (via [Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/builder/))
