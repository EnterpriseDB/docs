...
-   [Pipelines](/edb-postgres-ai/1.2/ai-factory/pipeline/) can automatically populate vector columns using embedding models.
-   [Gen AI Builder](/edb-postgres-ai/1.2/ai-factory/gen-ai/builder/) and Knowledge Bases use PGvector-backed retrievals.
...
-   Retrieval in Knowledge Bases (via [Gen AI Builder](/edb-postgres-ai/1.2/ai-factory/gen-ai/builder/))
...
Use [Pipelines](/edb-postgres-ai/1.2/ai-factory/pipeline/) to generate embeddings
...
AI Accelerator  [Pipelines](/edb-postgres-ai/1.2/ai-factory/pipeline/) makes it easy to:

AI Factory [Pipelines](/edb-postgres-ai/1.2/ai-factory/pipeline/) makes it easy to:
...
-   [Pipelines](/edb-postgres-ai/1.2/ai-factory/pipeline/) uses PGvector-based retrieval when building Knowledge Bases:
