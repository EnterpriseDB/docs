...
-   Chat Completion Runtime: [llm-runtime.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/llm-runtime.yaml/)
-   Chat Completion Service: [llm-service.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/llm-service.yaml/)
-   Text Embedding Runtime: [embed-runtime.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/embedding-runtime.yaml/)
-   Text Embedding Service: [embed-service.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/embedding-service.yaml/)
-   Text Reranker Runtime: [rerank-runtime.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/rerank-runtime.yaml/)
-   Text Reranker Service: [rerank-service.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/rerank-service.yaml/)
-   Image Embedding Runtime: [image-embed-runtime.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/image-embed-runtime.yaml/)
-   Image Embedding Service: [image-embed-service.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/image-embed-service.yaml/)
-   Image OCR Runtime: [ocr-runtime.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/ocr-runtime.yaml/)
-   Image OCR Service: [ocr-service.yaml](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/ocr-service.yaml/)
...
-   EDB AI Factory deployment examples: [https://www.enterprisedb.com/docs/edb-postgres-ai/ai-factory/learn/how-to/model-serving/deploy-nim-container/](/edb-postgres-ai/current/ai-factory/learn/how-to/model-serving/deploy-nim-container/)
