...
navTitle: Glossary
description: Definitions of common terms and roles used in Sovereign Data and Agent Factory.
---


These key terms and architectural components are used throughout the Sovereign Data and Agent Factory documentation.
