...
Here's what to expect when receiving, setting up, and operating your Sovereign Data and Agent Factory system during the first 90 days—from delivery through active use and support.
...
Once the system is live, you can immediately begin launching workloads. All operations take place through the Hybrid Manager portal.

### What you can do

- Deploy a high-availability 3-node Postgres cluster.
- Launch embedding jobs and vector pipelines using Postgres and pgvector.
- Use GPU nodes to serve models locally via NVIDIA NIM Microservices .
- Create RAG-style applications and internal chatbots.

You don’t need to access Kubernetes directly. You manage everything through the HM portal.
