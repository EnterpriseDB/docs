---
title: Use Cases and Personas for Agent Factory on Hybrid Manager
navTitle: Use Cases & Personas
description: Real-world Agent Factory implementations on Hybrid Manager addressing specific organizational needs and user roles.
---
...
See [Pipeline Designer](pipeline-designer/getting-started) for implementation guidance.
...
See [Agent Studio quickstart](langflow/quickstart) for a working example.
...
See [Knowledge bases](/aidb/7/knowledge-bases/) for detailed architecture.
...
1.  Configure model registries per [Model Library Documentation](/edb-postgres-ai/1.3/ai-factory/model/library/)
1.  Monitor inference performance using [Observability Tools](/edb-postgres-ai/1.3/ai-factory/model/observability/)
...
1.  Configure retrieval in an Agent Studio flow: [EDB Knowledge Base component](langflow/components/knowledge-base)
...
1.  Call models from Python: [Python Client Guide](/edb-postgres-ai/1.3/ai-factory/model/quickstart-python-using-inference-endpoint/)
1.  Invoke deployed Agent Studio flows over HTTP or MCP: [Accessing deployed flows](langflow/flow-deployment/accessing-deployed-flows)

### Business Analysts

Business analysts use Agent Studio's visual flow builder to create AI applications without coding expertise.
...
1.  Build flows using the Agent Studio visual editor: [Agent Studio quickstart](langflow/quickstart)
1.  Use pre-built templates as starting points: [Templates](langflow/templates/)
1.  Publish and deploy flows for others to use: [Flow deployment](langflow/flow-deployment/)
...
1.  Build a RAG flow end-to-end: [Agent Studio quickstart](langflow/quickstart)

### For Customer Service

1.  Build a conversational flow: [Agent Studio quickstart](langflow/quickstart)
...
1.  Access endpoints: [Python Client Guide](/edb-postgres-ai/1.3/ai-factory/model/quickstart-python-using-inference-endpoint/)
...
-   [Agent Factory architecture](architecture)
-   [Agent Studio](langflow/)
