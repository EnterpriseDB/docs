...
description: How to manage remote model endpoints (OpenAI, Google Gemini, Anthropic Claude, NVIDIA NIM, or any OpenAI-compatible API) in Hybrid Manager so that Langflow flows, Pipeline Designer pipelines, and AIDB can proxy calls to them.
deepToC: true
---
