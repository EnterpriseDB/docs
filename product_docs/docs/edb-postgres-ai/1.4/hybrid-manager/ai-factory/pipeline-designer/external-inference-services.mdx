...
The **Sovereign AI > Model Serving** interface described in this section isn't available in the current Portal release. To register external models, use [AIDB-native model registration](#registering-aidb-native-models) (described below on this page), which works on any cluster with the AIDB extension.
!!!
