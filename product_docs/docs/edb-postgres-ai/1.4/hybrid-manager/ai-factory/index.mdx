---
title: Agent Factory in Hybrid Manager
navTitle: Agent Factory in Hybrid Manager
description: Deploy and serve AI models, build AI flows with Agent Studio, create knowledge base pipelines with Pipeline Designer, and expose model endpoints to your applications — all within Hybrid Manager's sovereign Kubernetes environment.
directoryDefaults:
  displayBanner: |
    The previous Griptape-based Gen AI Builder has been removed from EDB Agent Factory releases 1.3.6 and beyond, and Innovation Release 2026.3 and beyond. 
    New functionality built around Agent Studio (built on open source Langflow) is now available as a replacement. <a href="https://www.enterprisedb.com/docs/edb-postgres-ai/latest/ai-factory/langflow/">More details&hellip;</a>
redirects:
- /purl/hm/ai-factory
...
-   Build AI flows and agents with Agent Studio for internal or external-facing use.
...
-   [Agent Studio](langflow/) — Build and deploy AI pipelines and flows using EDB components connected to HM-managed models, knowledge bases, and Postgres clusters
...
-   A Hybrid Manager project with Agent Factory enabled and required entitlements for Agent Studio, Pipeline Designer, and Model Serving.
...
-   New to Agent Factory on HM? Start here: [Getting started](getting-started)
