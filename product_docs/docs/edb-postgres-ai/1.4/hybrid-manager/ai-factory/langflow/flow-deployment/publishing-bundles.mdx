...
Parameters are the values in your flow that use an Agent Studio [global variable](https://docs.langflow.org/configuration-global-variables). HM extracts them from each flow's definition at publish time and presents them in step 2 of the dialog.
