...
-   An HM model server cluster with an embedding model deployed. See [Models](/edb-postgres-ai/innovation-release/hybrid-manager/ai-factory/models) for how to create one. A [GPU node](/edb-postgres-ai/current/hybrid-manager/ai-factory/gpu-recommended/) is typically required.
