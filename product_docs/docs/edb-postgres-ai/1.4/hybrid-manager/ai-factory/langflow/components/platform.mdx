...
description: Agent Studio component that exposes Hybrid Manager platform operations (projects, clusters, knowledge bases, and more) as MCP tools to an agent.
deepToC: true
---
