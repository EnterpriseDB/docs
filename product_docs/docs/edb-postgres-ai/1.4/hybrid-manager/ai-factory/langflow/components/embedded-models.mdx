...
description: Agent Studio component that runs CPU-based inference (text and image embeddings, text generation) directly on a Postgres cluster using the aidb extension.
deepToC: true
---
