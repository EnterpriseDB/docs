...
| --- | --- | --- | --- |
| Replication | None | Physical streaming | Logical (PGD) |
...
2.  **Single region or multi-region?** — If all data must stay in one region, choose high availability. If you need multi-region or active-active writes, choose distributed high availability.
