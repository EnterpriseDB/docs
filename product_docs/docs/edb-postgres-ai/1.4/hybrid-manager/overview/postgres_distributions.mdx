...
Distribution | Postgres 16 | Postgres 17 | Postgres 18
--- | --- | --- | ---
PostgreSQL | Supported | Supported | Supported
EDB Postgres Extended Server | Supported | Supported | Supported
EDB Postgres Advanced Server | Supported | Supported | Supported
