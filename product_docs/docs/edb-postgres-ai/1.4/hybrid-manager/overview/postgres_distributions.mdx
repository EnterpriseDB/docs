...
The following table shows the Postgres major versions available for each distribution in HM. Specific minor versions depend on the HM release — check the release notes for version-specific details.
...
HM makes AI-relevant extensions available across distributions to support the AI Factory workload:
