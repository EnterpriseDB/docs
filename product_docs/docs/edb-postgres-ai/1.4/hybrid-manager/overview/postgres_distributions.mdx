...
!!!note
EDB Postgres Extended Server is also called Enterprise Postgres, and EDB Postgres Advanced Server is also called Enterprise Postgres (Oracle Compatible). You might see either name in the HM console or in documentation.
!!!
