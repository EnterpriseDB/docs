...
[DOCS-3788, confirm with eng/SRE whether a dedicated rotation section is needed beyond what's covered below]: #
...
1.  The HM administrator must retrieve the Fernet key and store it safely:
    ...
    [DOCS-3788, confirm exact rotation procedure with eng/SRE before finalizing this warning]: #
    !!!
