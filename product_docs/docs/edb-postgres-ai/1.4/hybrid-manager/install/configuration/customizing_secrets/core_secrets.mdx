...
1.  You can create the bootstrap Fernet key and admin credentials using the [`edbctl`](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/edbctl/) CLI.
