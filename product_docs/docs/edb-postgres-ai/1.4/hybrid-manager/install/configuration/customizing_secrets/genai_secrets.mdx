...
1.  If you plan to pull models from HuggingFace, create a `hf-secret` containing your HuggingFace access token:
    ...
    <!-- TODO(DOCS-3788): Cross-check "2026.4 IR / 1.4 LTS" against the actual release
         notes (or with eng) before this page goes live — it's pulled from the edbctl
         source code, not confirmed as the official GA version. -->
