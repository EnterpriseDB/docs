...
1.  You can create a confounding key secret with the [`edbctl`](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/edbctl/) CLI for environments with the `analytics` scenario enabled. 
