...
edbctl hm list-install-secrets --version "$HM_VERSION"   # lists what this version requires
kubectl get secret -A -l app.kubernetes.io/managed-by=edbctl   # lists what was created
```
