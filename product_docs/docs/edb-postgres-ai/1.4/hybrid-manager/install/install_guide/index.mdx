...
-   **Documentation:** [Installing Hybrid Manager](install_hm) (standard Kubernetes) or [Installing Hybrid Manager on Red Hat OpenShift](install_rhos) (Red Hat OpenShift/OperatorHub)
