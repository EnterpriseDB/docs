...
2.  [Configuring image discovery](../configuration/image_discovery)
3.  [Customizing secrets](../configuration/customizing_secrets)
4.  [Implementing TLS](../configuration/cert-man)
5.  [Deploying HM across multiple data centers](../configuration/multi_dc)
6.  [Configuring IdPs](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/config_idp_hm/)
7.  [Enabling KMS for TDE](../configuration/kms_for_tde)
8.  [Optimizing service mesh memory](../configuration/optimize_mesh_memory)
9.  [Migrating from the Bootstrap to Operator method](../migrate_bootstrap_to_operator)
