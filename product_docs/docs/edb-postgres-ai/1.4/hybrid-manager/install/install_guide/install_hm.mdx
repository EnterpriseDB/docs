...
If you have an existing bootstrap installation, follow the [Migrating from Bootstrap to Operator](../migrate_bootstrap_to_operator) guide — `edbctl hm prepare-bootstrap-operator-conversion` exports the live CR and transfers Helm ownership in one step.
!!!
