...
- Phases 1–4 of the step-by-step guide are complete, including [Preparing your environment](environment_prep). That page covers creating the image pull secret, component secrets, and the object storage secret with `edbctl`.
