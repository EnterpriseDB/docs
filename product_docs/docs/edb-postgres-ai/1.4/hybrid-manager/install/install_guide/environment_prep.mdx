...
```
### Configure Beacon Agent OperandSet

The following operandSetVersions parameter should be added to your HM configuration under `spec.beaconAgent`:
...
replacing `operand-set-regex` with the values depending of the HM installation:

| HM Version      | Operand Set Reg Ex |
|-----------------|--------------------|
| **HM 1.3 LTS ** | "1\\.0\\.[0-9]+"   |
| **HM 1.4 LTS ** | "1\\.1\\.[0-9]+"   |
| **HM IR **      | "1\\.2\\.[0-9]+"   |

as example, for HM 1.4 LTS:
