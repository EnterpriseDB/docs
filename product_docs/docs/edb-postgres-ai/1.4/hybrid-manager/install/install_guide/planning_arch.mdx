...
**Default behavior:** In HM 1.4.2, if the `scenarios` parameter is omitted from your configuration, the system installs all scenarios. Don't rely on this default — list your scenarios explicitly.
...
spec:
  ...
  version: <Version>
  scenarios: # list scenarios explicitly rather than relying on the default
    - core
