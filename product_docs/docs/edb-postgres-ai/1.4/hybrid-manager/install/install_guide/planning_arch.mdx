...
A cluster dedicated to HM is recommended and is the supported production configuration. Running HM on a cluster shared with other workloads is permitted on an evaluation basis.
