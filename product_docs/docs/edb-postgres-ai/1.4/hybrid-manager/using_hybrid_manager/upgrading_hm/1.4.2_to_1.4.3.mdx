...
If you haven't customized the backup schedule, no action is needed. For details, see [Changing the default backup schedule](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/hadr/backup_considerations/#changing-the-default-backup-schedule).
