...
LTS releases follow standard semantic versioning (`major.minor.patch`, e.g., **1.3.x**). These versions focus on stability and are intended for production environments requiring a long support lifecycle. Each LTS release is supported for 15 months from its release date, receiving monthly patch releases with bug and security fixes.
