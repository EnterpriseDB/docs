...
- **Version pinning**: The agent installs each extension at exactly the version found on the source. If that exact version isn't available on the destination, schema migration fails.
