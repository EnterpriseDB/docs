...
1.  Select the schemas you want to migrate, but clear **Constraints** from the list of objects underneath the database. Select **Next**.
    ...
    !!!note
        ...
        See [Schema integrity and performance considerations](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/self_managed_pg_to_self_managed_pg/migrating_schema/) to learn more about why constraints must be disabled and other considerations.
