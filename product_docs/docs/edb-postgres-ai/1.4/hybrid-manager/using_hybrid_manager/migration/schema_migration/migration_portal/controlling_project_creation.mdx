...
description: Reference material on automatic Migration Portal project creation and how to disable or customize this capability, supporting the step-by-step migration guides.

---

If you registered a database with Hybrid Manager (HM) via the EDB Postgres AI agent, a Migration Portal project is created automatically for all the database schemas and dependencies. This behavior applies to Oracle and Postgres sources alike — for Postgres sources, the project passes the schema through without requiring compatibility assessment or conversion.
...
-   [Migrating self-managed Postgres databases with HM](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/self_managed_pg_to_hm_managed/).

-   [Controlling schema ingestion with the EDB Postgres AI agent](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/monitoring/mon_ext_dbs/mon_with_agent/configure_agent/schema_ingestion/).
