---
title: Interacting programmatically with HM
navTitle: Interacting programmatically with HM
description: Learn how to use the API and MCP tools to perform management tasks with Hybrid Manager.
navigation:
  - access_key
  - using_access_key
  - using_the_hm_api
...
redirects:
  - /edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/using_the_api/
---
