...
See [Transparent Data Encryption across data centers](/edb-postgres-ai/current/hybrid-manager/install/configuration/multi_dc/tde/#distributed-high-availability-pgd-clusters-across-data-centers) for the full requirement, including a known rough edge in how the same-material case is resolved on Azure.
