...
These intervals are configurable for self-managed clusters. To customize the frequency of data collection, define the intervals in the [EDB Postgres AI agent configuration YAML](../mon_ext_dbs/mon_with_agent/configure_agent.mdx#prepare-a-configuration-file). For CSP-managed clusters, backend refresh intervals aren't customer-configurable at this release.
