---
title: Cluster view
navTitle: Viewing clusters
description: View detailed information about a selected cluster, including configuration, health, monitoring, diagnostics, backups, and tags.
navigation:
 - cluster-overview-tab
 - cluster-connect-tab
 - cluster-monitoring-tab
 - cluster-query-diagnostics-tab
 - cluster-recommendations-tab
 - cluster-backups-tab
 - cluster-logs-tab
 - cluster-properties-tab
 - health_reports
---
...
-   [Health assessment reports](health_reports) — Generate, view, download, and compare health assessment reports for your database clusters.
