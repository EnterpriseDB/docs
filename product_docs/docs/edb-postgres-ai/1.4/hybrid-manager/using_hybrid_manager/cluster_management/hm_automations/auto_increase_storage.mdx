...
Database storage auto-scaling monitors the storage utilization of your HM-managed cluster's data volumes. When usage exceeds a configured threshold, HM automatically expands the underlying `PersistentVolumeClaim` (PVC) — keeping your databases online and preventing outages caused by disk full events.
