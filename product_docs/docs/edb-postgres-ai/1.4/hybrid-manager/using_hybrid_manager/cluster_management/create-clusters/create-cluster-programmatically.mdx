...
5.  Fill in the field **Expires in**.
6.  In the pop-up window, select **Add user**.
7.  Copy the access key from the pop-up window.
8.  Select **Key stored safely**.
...
Check the [API documentation](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/interacting_programmatically/using_the_hm_api/) for more details on the required fields, the naming convention, and JSON structure for cluster creation.
!!!
