...
Before you begin, configure a machine user and `env.sh` file. See [Creating a cluster programmatically](../create-clusters/create-cluster-programmatically.mdx) for the initial setup steps.
