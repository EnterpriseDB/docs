...
-   [API Access](./interacting_programmatically) — automate platform functions with the HM API.
-   [Postgres database upgrades](./upgrading) - upgrade your HM-managed Postgres databases to the next minor or major version.
...
-   [Chat Agent](./chat_agent) — operate Hybrid Manager in plain language: browse your estate, provision clusters, troubleshoot performance, and consult the docs.
-   [Governance](./governance) — audit and govern how AI agents interact with your Postgres data, reconstructing agent sessions and inspecting every SQL statement they run.
...
-   [IdP management](./idp_management) — configure identity providers and rotate IdP connector encryption keys.
-   [Monitoring](./monitoring) — set up agents, explore built-in dashboards, and extend observability with Prometheus and Grafana.
-   [Multi-DC](/edb-postgres-ai/current/hybrid-manager/install/configuration/multi_dc/) - set up multiple data centers, a primary and secondary locations.
-   [Hybrid Manager upgrades](./upgrading_hm) - upgrade the HM platform to the next minor/major/innovation release version.
