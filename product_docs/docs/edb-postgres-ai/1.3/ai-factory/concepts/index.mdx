...
navigation:
  ...
  - sovereign-ai
redirects:
  - /edb-postgres-ai/latest/ai-factory/concepts/:splat
---
...
-   The [Vector Engine](/edb-postgres-ai/current/ai-factory/vector-engine/), providing pgvector-based capabilities
-   AI Factory [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) to generate embeddings
-   [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/) for integrated vector search across structured and unstructured data
...
-   Domain-specific embeddings from [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/)
-   Configurable search behavior with [Retrievers](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/retrievers/)
-   Scalable model inference through [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/)
-   Application orchestration via [Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/)
...
-   Vector similarity search using the [Vector Engine](/edb-postgres-ai/current/ai-factory/vector-engine/)
-   Embedding pipelines integrated via [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/)
-   Search and retrieval across [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/)
...
-   Flexible deployment options through the [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/) framework
-   Lifecycle management and discoverability with the [Model Library Explained](/edb-postgres-ai/current/ai-factory/model/model-library-explained/)
...
-   Orchestrate LLMs with [Assistants](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/assistants/)
-   Retrieve content using [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/) and [Retrievers](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/retrievers/)
-   Enforce behavior via [Rulesets](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/rulesets/)
-   Execute actions via [Tools](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/tools/)
-   Maintain conversational context through memory settings in [Assistants](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/assistants/)

Explore [Gen AI Builder](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/getting-started/) to start building AI-driven apps.

* * *

### Pipelines and data preparation

AI Factory [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) automate:

-   Embedding generation
-   Chunking, parsing, summarizing content
-   Keeping embeddings fresh with [Auto-Processing](/edb-postgres-ai/current/ai-factory/pipeline/capabilities/auto-processing/)

Explore [Preparers](/edb-postgres-ai/current/ai-factory/pipeline/preparers/) for reusable data preparation components.
...
-   [AI Factory Learning Center](/edb-postgres-ai/current/ai-factory/learn/)
