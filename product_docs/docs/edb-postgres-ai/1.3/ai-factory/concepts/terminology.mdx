...
Natural language processing (NLP) enables computers to understand and generate human language. It underpins semantic search and conversational AI in AI Factory via [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/knowledge-bases), [Retrievers](/edb-postgres-ai/1.3/ai-factory/gen-ai/retrievers), and [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants).

[Learn more](https://en.wikipedia.org/wiki/Natural_language_processing)

### Large language models (LLMs)

LLMs are large deep learning models trained on massive text corpora. In AI Factory, they drive [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants), Retrieval-Augmented Generation (RAG), and various model pipelines, deployed using [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/).

[Learn more](https://huggingface.co/blog/llm)

### Embeddings

Embeddings are vector representations of data that capture semantic meaning. AI Factory Pipelines create embeddings used in [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/knowledge-bases) and served through the [Vector Engine](/edb-postgres-ai/1.3/ai-factory/vector-engine/) to enable semantic search and RAG.
...
RAG combines vector search with LLM generation to ground model responses in relevant documents. In AI Factory, it is implemented through [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/knowledge-bases), [Retrievers](/edb-postgres-ai/1.3/ai-factory/gen-ai/retrievers), and [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/).
...
AIDB (AI-in-Database) brings vector search, embedding pipelines, and future capabilities to HM-managed Postgres clusters. It is the foundation for AI Factory [Pipelines](/edb-postgres-ai/1.3/ai-factory/pipeline/) and Knowledge Bases.
========
...
Natural language interfaces enable users to query Postgres using natural language rather than SQL. AI Factory Assistants leverage this pattern through [Gen AI](/edb-postgres-ai/1.3/ai-factory/gen-ai), combining LLMs with structured and unstructured retrieval.
...
KServe is the open-source Kubernetes-native framework AI Factory uses to deploy and manage  models. It provides InferenceServices, autoscaling, and observability for AI Factory [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/).
...
-   [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants) for conversational AI
-   [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/knowledge-bases) for RAG and semantic search
-   [Retrievers](/edb-postgres-ai/1.3/ai-factory/gen-ai/retrievers) for advanced search patterns
-   [Tools](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/) to perform external actions
-   [Rulesets](/edb-postgres-ai/1.3/ai-factory/gen-ai/rulesets) to control Assistant behavior
-   [Threads](/edb-postgres-ai/1.3/ai-factory/gen-ai/threads) to persist conversation history
-   [Structures](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures) to define AI workflows and pipelines
...
See: [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/knowledge-bases)
...
See: [Model Library](/edb-postgres-ai/1.3/ai-factory/model/library)
