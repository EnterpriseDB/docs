...
-   Helpful: experience with **AI Factory Concepts** and [AI Factory 101 Path](/edb-postgres-ai/1.3/ai-factory/learn/101)
...
-   [Vectorized query engines](/edb-postgres-ai/1.3/analytics/learn/explained/generic-concepts/#vectorized-query-engines)
-   [Data lakehouse architectures](/edb-postgres-ai/1.3/analytics/learn/explained/generic-concepts/#data-lakehouse)
-   [Separation of storage and compute](/edb-postgres-ai/1.3/analytics/learn/explained/generic-concepts/#separation-of-storage-and-compute)
-   [AI Factory Concepts](/edb-postgres-ai/1.3/ai-factory/concepts)
