...
-   [Vector Engine](/edb-postgres-ai/1.3/ai-factory/vector-engine/) — Vector search in your Postgres clusters.
-   [Pipelines](/edb-postgres-ai/1.3/ai-factory/pipeline/) — Controlled creation of Knowledge Bases and embeddings.
-   [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/) — Kubernetes-native, GPU-accelerated model inference.
-   [Agent Studio](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/agent-studio/) — Governed Assistant and Tool development.
...
[See: Hybrid Manager Gen AI Workloads](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/)
...
-   [AI Factory Overview](/edb-postgres-ai/1.3/ai-factory/)
...
-   [Agent Studio](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/agent-studio/)
