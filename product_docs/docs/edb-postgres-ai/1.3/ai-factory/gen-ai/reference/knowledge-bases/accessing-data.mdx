...
You can use the [GriptapeCloudVectorStoreDriver](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/sdk/drivers/vector-store-drivers#gen-ai-builder-knowledge-base) to query your Knowledge Base with Gen AI Builder.
