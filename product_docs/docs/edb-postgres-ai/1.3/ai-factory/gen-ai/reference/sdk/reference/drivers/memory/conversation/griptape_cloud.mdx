...
-   `__all__ = ['GriptapeCloudConversationMemoryDriver']` <small>module-attribute</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.__all__"></span> 

<span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver"></span>
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <a href="griptape_cloud.mdx#griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.thread_id" title="thread_id = field(default=None, metadata={'serializable': True})           class-attribute       instance-attribute    (griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.thread_id)"><code class="language-python">thread_id</code></a>                                    | `Optional[str]` | The ID of the Thread to store the conversation memory in. If not provided, the driver will attempt to retrieve the ID from the environment variable `GT_CLOUD_THREAD_ID`.<br/>             |
| <a href="griptape_cloud.mdx#griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.alias" title="alias = field(default=None, metadata={'serializable': True})           class-attribute       instance-attribute    (griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.alias)"><code class="language-python">alias</code></a>                                                    | `Optional[str]` | The alias of the Thread to store the conversation memory in.<br/>                                                                                                                          |
| <a href="griptape_cloud.mdx#griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.base_url" title="base_url = field(default=Factory(lambda: os.getenv('GT_CLOUD_BASE_URL', 'https://cloud.griptape.ai')))           class-attribute       instance-attribute    (griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.base_url)"><code class="language-python">base_url</code></a> | `str`           | The base URL of the Gen AI Builder API. Defaults to the value of the environment variable `GT_CLOUD_BASE_URL` or `https://cloud.griptape.ai`.<br/>                                         |
| <a href="griptape_cloud.mdx#griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.api_key" title="api_key = field(default=Factory(lambda: os.environ['GT_CLOUD_API_KEY']))           class-attribute       instance-attribute    (griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.api_key)"><code class="language-python">api_key</code></a>                                  | `str`           | The API key to use for authenticating with the Gen AI Builder API. If not provided, the driver will attempt to retrieve the API key from the environment variable `GT_CLOUD_API_KEY`.<br/> |
...
-   `_thread = field(default=None, init=False)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver._thread"></span> 

-   `alias = field(default=None, metadata={'serializable': True})` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.alias"></span> 

-   `api_key = field(default=Factory(lambda: os.environ['GT_CLOUD_API_KEY']))` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.api_key"></span> 

-   `base_url = field(default=Factory(lambda: os.getenv('GT_CLOUD_BASE_URL', 'https://cloud.griptape.ai')))` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.base_url"></span> 

-   `headers = field(default=Factory(lambda self: {'Authorization': f'Bearer {self.api_key}'}, takes_self=True), init=False)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.headers"></span> 

-   `thread` <small>property</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.thread"></span> 

-   `thread_id = field(default=None, metadata={'serializable': True})` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.thread_id"></span> 

<span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver._call_api"></span>
...
<span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver._get_url"></span>
...
<span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.load"></span>
...
<span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.store"></span>
...
<span id="griptape.drivers.memory.conversation.griptape_cloud.GriptapeCloudConversationMemoryDriver.validate_api_key"></span>
