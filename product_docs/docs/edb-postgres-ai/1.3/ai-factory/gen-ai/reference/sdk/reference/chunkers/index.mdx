...
-   `__all__ = ['BaseChunker', 'ChunkSeparator', 'MarkdownChunker', 'PdfChunker', 'TextChunker']` <small>module-attribute</small>  <span id="griptape.chunkers.__all__"></span> 

<span id="griptape.chunkers.BaseChunker"></span>
...
-   `DEFAULT_SEPARATORS = [ChunkSeparator(' ')]` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.BaseChunker.DEFAULT_SEPARATORS"></span> 

-   `max_tokens = field(default=Factory(lambda self: self.tokenizer.max_input_tokens, takes_self=True), kw_only=True)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.BaseChunker.max_tokens"></span> 

-   `separators = field(default=Factory(lambda self: self.DEFAULT_SEPARATORS, takes_self=True), kw_only=True)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.BaseChunker.separators"></span> 

-   `tokenizer = field(default=Factory(lambda: OpenAiTokenizer(model=OpenAiTokenizer.DEFAULT_OPENAI_GPT_3_CHAT_MODEL)), kw_only=True)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.BaseChunker.tokenizer"></span> 

<span id="griptape.chunkers.BaseChunker.__find_midpoint_index"></span>
...
<span id="griptape.chunkers.BaseChunker.__get_subchunks"></span>
...
<span id="griptape.chunkers.BaseChunker._chunk_recursively"></span>
...
<span id="griptape.chunkers.BaseChunker.chunk"></span>
...
<span id="griptape.chunkers.BaseChunker.validate_max_tokens"></span>
...
<span id="griptape.chunkers.ChunkSeparator"></span>

## ChunkSeparatordataclass
...
-   `is_prefix = False` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.ChunkSeparator.is_prefix"></span> 

-   `value` <small>instance-attribute</small>  <span id="griptape.chunkers.ChunkSeparator.value"></span> 

<span id="griptape.chunkers.ChunkSeparator.__init__"></span>

### **init**(value, is_prefix=False)

<span id="griptape.chunkers.MarkdownChunker"></span>
...
-   `DEFAULT_SEPARATORS = [ChunkSeparator('##', is_prefix=True), ChunkSeparator('###', is_prefix=True), ChunkSeparator('####', is_prefix=True), ChunkSeparator('#####', is_prefix=True), ChunkSeparator('######', is_prefix=True), ChunkSeparator('\n\n'), ChunkSeparator('. '), ChunkSeparator('! '), ChunkSeparator('? '), ChunkSeparator(' ')]` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.MarkdownChunker.DEFAULT_SEPARATORS"></span> 

<span id="griptape.chunkers.PdfChunker"></span>
...
-   `DEFAULT_SEPARATORS = [ChunkSeparator('\n\n'), ChunkSeparator('. '), ChunkSeparator('! '), ChunkSeparator('? '), ChunkSeparator(' ')]` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.PdfChunker.DEFAULT_SEPARATORS"></span> 

<span id="griptape.chunkers.TextChunker"></span>
...
-   `DEFAULT_SEPARATORS = [ChunkSeparator('\n\n'), ChunkSeparator('\n'), ChunkSeparator('. '), ChunkSeparator('! '), ChunkSeparator('? '), ChunkSeparator(' ')]` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.chunkers.TextChunker.DEFAULT_SEPARATORS"></span> 
