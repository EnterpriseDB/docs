...
-   `__all__ = ['PgVectorVectorStoreDriver']` <small>module-attribute</small>  <span id="griptape.drivers.vector.pgvector.__all__"></span> 

<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver"></span>
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ---------------------------------------------------------------------------------- |
| <a href="pgvector.mdx#griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.connection_string" title="connection_string = field(default=None, kw_only=True, metadata={'serializable': True})           class-attribute       instance-attribute    (griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.connection_string)"><code class="language-python">connection_string</code></a>             | `Optional[str]` | An optional string describing the target Postgres database instance.<br/>          |
| <a href="pgvector.mdx#griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.create_engine_params" title="create_engine_params = field(factory=dict, kw_only=True, metadata={'serializable': True})           class-attribute       instance-attribute    (griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.create_engine_params)"><code class="language-python">create_engine_params</code></a> | `dict`          | Additional configuration params passed when creating the database connection.<br/> |
| <a href="pgvector.mdx#griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.engine" title="engine() (griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.engine)"><code class="language-python">engine</code></a>                                                                                                                                                                                  | `Engine`        | An optional sqlalchemy Postgres engine to use.<br/>                                |
| <a href="pgvector.mdx#griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.table_name" title="table_name = field(kw_only=True, metadata={'serializable': True})           class-attribute       instance-attribute    (griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.table_name)"><code class="language-python">table_name</code></a>                                                       | `str`           | Optionally specify the name of the table to used to store vectors.<br/>            |
...
-   `_engine = field(default=None, kw_only=True, alias='engine', metadata={'serializable': False})` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver._engine"></span> 

-   `_model = field(default=Factory(lambda self: self.default_vector_model(), takes_self=True))` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver._model"></span> 

-   `connection_string = field(default=None, kw_only=True, metadata={'serializable': True})` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.connection_string"></span> 

-   `create_engine_params = field(factory=dict, kw_only=True, metadata={'serializable': True})` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.create_engine_params"></span> 

-   `table_name = field(kw_only=True, metadata={'serializable': True})` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.table_name"></span> 

<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.default_vector_model"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.delete_vector"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.engine"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.load_entries"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.load_entry"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.query_vector"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.setup"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.upsert_vector"></span>
...
<span id="griptape.drivers.vector.pgvector.PgVectorVectorStoreDriver.validate_connection_string"></span>
