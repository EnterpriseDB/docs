...
-   [Embeddings explained](/edb-postgres-ai/latest/ai-factory/learn/explained/generic-concepts/#embeddings-and-vector-representations)
-   [Retrieval Augmented Generation (RAG)](/edb-postgres-ai/latest/ai-factory/learn/explained/terminology/#retrieval-augmented-generation-rag)

For guidance on using this content in AI applications:

-   [Knowledge Bases overview](../../../pipeline/knowledge_base)
-   [Building Knowledge Bases with Gen AI Builder](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/create-knowledge-base/) <!-- Placeholder link -->
...
-   [Configure a Web Page data source](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/data-source-webpage/)
-   [Configure a Data Lake data source](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/data-source-data-lake/)
-   [Configure an Amazon S3 data source](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/data-source-s3/)
-   [Configure a Google Drive data source](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/data-source-google-drive/)
-   [Configure an Atlassian Confluence data source](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/data-source-confluence/)
-   [Configure a Custom data source](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/data-source-custom/)
...
-   [Building AI Workflows with Gen AI Builder](/edb-postgres-ai/1.3/ai-factory/gen-ai/libraries/create-knowledge-base/) <!-- Placeholder link -->
