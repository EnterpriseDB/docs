...
[Gen AI Workloads in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/ai-factory/gen-ai/)
...
See our [Use Cases](/edb-postgres-ai/latest/ai-factory/learn/use-cases/) and [Solutions](/edb-postgres-ai/latest/ai-factory/learn/solutions/) for detailed patterns.
...
-   Follow the [AI Factory 101 Learning Path](/edb-postgres-ai/latest/ai-factory/learn/paths/101/)
-   Explore the [Explained Concepts](/edb-postgres-ai/latest/ai-factory/learn/explained/) — Knowledge Bases, retrievers, Pipelines, and more
