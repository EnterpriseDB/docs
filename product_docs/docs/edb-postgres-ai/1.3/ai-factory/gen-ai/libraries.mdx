...
- [AI Factory Integration](/edb-postgres-ai/latest/ai-factory/learn/explained/ai-factory-concepts/): Ecosystem connectivity patterns
- [Hybrid Manager Deployment](/edb-postgres-ai/latest/hybrid-manager/ai-factory/gen-ai/builder/): Infrastructure integration procedures
