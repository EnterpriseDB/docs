...
For a deep dive, see: [Threads explained](/edb-postgres-ai/latest/ai-factory/learn/explained/threads-explained/).
...
See [View and manage Threads](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/view-threads/) for a full step-by-step guide.
