...
For a deep dive, see: [Rulesets explained](/edb-postgres-ai/latest/ai-factory/learn/explained/rulesets-explained/).
...
See [Create a Ruleset](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/create-ruleset/) for a full step-by-step guide.
