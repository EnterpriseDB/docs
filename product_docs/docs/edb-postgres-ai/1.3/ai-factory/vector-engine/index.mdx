...
deepToC: true
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/vector-engine
---
...
-   [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) can automatically populate vector columns using embedding models.
-   [Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/) and Knowledge Bases use PGvector-backed retrievals.
...
-   Retrieval in Knowledge Bases (via [Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/))
...
Use [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) to generate embeddings
...
AI Accelerator  [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) makes it easy to:

AI Factory [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) makes it easy to:
...
-   [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) uses PGvector-based retrieval when building Knowledge Bases:
