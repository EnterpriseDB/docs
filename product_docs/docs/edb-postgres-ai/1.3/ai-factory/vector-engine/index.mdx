...
-   [Pipelines](/edb-postgres-ai/1.3/ai-factory/pipeline/) can automatically populate vector columns using embedding models.
-   [Gen AI Builder](/edb-postgres-ai/1.3/ai-factory/gen-ai/) and Knowledge Bases use PGvector-backed retrievals.
...
-   Retrieval in Knowledge Bases (via [Gen AI Builder](/edb-postgres-ai/1.3/ai-factory/gen-ai/))
...
Use [Pipelines](/edb-postgres-ai/1.3/ai-factory/pipeline/) to generate embeddings
