...
For industry-specific solution examples, see: [Industry Solutions](/edb-postgres-ai/1.3/ai-factory/solutions).
...
-   Build [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/libraries/create-knowledge-base) from your Data Sources.
...
-   [Hybrid Knowledge Base Best Practices](/edb-postgres-ai/1.3/ai-factory/gen-ai/libraries/hybrid-kb-best-practices)
...
-   Store results in [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/libraries/create-knowledge-base) or **Vector Engine**.
...
-   Build [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants/create-assistant) in [Agent Studio](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/agent-studio/).
...
-   [Agent Studio in Hybrid Manager](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/agent-studio/)
-   [Sovereign AI Explained](/edb-postgres-ai/1.3/ai-factory/gen-ai/sovereign-ai)
...
-   Build [Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/libraries/create-knowledge-base).
...
-   Explore [Industry Solutions](/edb-postgres-ai/1.3/ai-factory/solutions)
-   Follow a [Learning Path](/edb-postgres-ai/1.3/ai-factory/learning-paths)
