...
-   Build [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-knowledge-base/) from your Data Sources.
-   Implement tuned [Retrievers](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-retriever/) for semantic search.
-   Power [Assistants](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-assistant/) and apps with RAG pipelines.

### Learn More

-   [Sovereign AI Explained](/edb-postgres-ai/current/hybrid-manager/ai-factory/sovereign-ai-on-hm/)
-   [Hybrid Knowledge Base Best Practices](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/hybrid-kb-best-practices/)
...
-   Store results in [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-knowledge-base/) or **Vector Engine**.
...
-   Defined and governed with [Rulesets](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-ruleset/).
...
-   Build [Assistants](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-assistant/) in Agent Studio.
-   Govern behavior with [Rulesets](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-ruleset/).
-   Add [Tools](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-tool/) to safely integrate internal systems.
...
-   Build [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-knowledge-base/).
-   Use [Retrievers](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-retriever/) to expose search to Assistants or apps.
...
-   [Knowledge Bases](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/)
-   [AI Factory 201](201/)
...
-   Use [Structures](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-structure/) and Pipelines to run:
-   AI categorization
...
-   Build [Structures](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-structure/).
-   Run as Tools in [Assistants](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-assistant/) or standalone Pipelines.
-   Monitor and govern pipeline execution via Hybrid Manager.

### Learn More

-   [Structures](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/structures/)
-   [AI Factory 301](301/)
...
-   Follow a [Learning Path](learning-paths/)
-   Get started with [How-To Guides](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/how-to/)

* * *

**AI Factory** gives you the foundation to build **trusted, governed, explainable Sovereign AI** — on your terms.

→ Start today with [AI Factory 101](101/), or deploy your first [Assistant](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-assistant/).
