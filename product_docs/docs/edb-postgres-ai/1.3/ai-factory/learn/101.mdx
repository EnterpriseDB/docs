...
**Prerequisites:** Completion of [AI Factory 101](/edb-postgres-ai/1.3/ai-factory/learn/101) or equivalent experience with basic AI Factory concepts.
...
### Modules:
1. **[Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants)** — Deep dive into assistant architecture, persona design, and memory management
2. **[Structures](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures)** — Master workflow orchestration with branching logic and validation patterns
3. **[Create an Assistant](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-assistant)** — Hands-on: Build a production assistant with integrated tools and knowledge bases
4. **[Create a Structure](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-structure)** — Hands-on: Implement complex workflows with conditional logic and error recovery
5. **[Create a Tool](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-tool)** — Hands-on: Wrap internal APIs as governed, secure AI tools
...
### Modules:
1. **[Hybrid Knowledge Base Best Practices](/edb-postgres-ai/1.3/ai-factory/gen-ai/hybrid-kb-best-practices)** — Proven patterns for balancing data freshness, coverage, and operational costs
2. **[Manage Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/manage-knowledge-base)** — Operational workflows: re-embedding strategies, source lifecycle management, and access controls
3. **[Create a Retriever](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-retriever)** — Hands-on: Fine-tune search behavior, implement advanced filtering, and optimize ranking algorithms
...
5. **[Verify Model Deployments](/edb-postgres-ai/1.3/ai-factory/model/verify-models)** — Validate endpoints and monitor GPU utilization through Hybrid Manager
...
3. **[Hybrid Manager Observability](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/observability)** — Leverage platform dashboards and automated alerting systems
...
Progress to **[AI Factory 301 Path](/edb-postgres-ai/1.3/ai-factory/learn/301)** to master:
...
- [AI Factory Architecture Overview](/edb-postgres-ai/1.3/ai-factory/concepts)
- [Hybrid Manager: Gen AI Builder Guide](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai)
- [Sovereign AI Implementation Guide](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/sovereign-ai-on-hm)
- [Model Serving Deep Dive](/edb-postgres-ai/1.3/ai-factory/model/model-serving-concepts/)
- [Advanced Structure Patterns](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures)
...
**Start your first module:** [Assistants →](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants)
