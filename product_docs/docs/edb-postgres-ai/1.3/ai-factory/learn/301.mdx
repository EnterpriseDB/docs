...
1.  [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants) — Architect assistants that reason, retrieve, and act across tools.
2.  [Tools](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/) — Design governed actions that call internal or external systems.
3.  [Create a Tool](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-tool) — Implement robust, reusable tool integrations for agent workflows.
4.  [Structures](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures) — Build multi-step pipelines and agent behaviors.
...
3.  [Advanced ServingRuntime Configuration](/edb-postgres-ai/1.3/ai-factory/model/how-to-deploy-ai-models) *(placeholder — expand with custom Transformers/Explainers patterns)*
...
3.  [Hybrid Manager Observability](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/observability)
