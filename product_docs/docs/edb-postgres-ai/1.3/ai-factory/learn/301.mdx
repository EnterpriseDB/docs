...
1.  [Assistants](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/assistants/) — Architect assistants that reason, retrieve, and act across tools.
2.  [Tools](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/tools/) — Design governed actions that call internal or external systems.
3.  [Create a Tool](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-tool/) — Implement robust, reusable tool integrations for agent workflows.
4.  [Structures](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/structures/) — Build multi-step pipelines and agent behaviors.
...
2.  [Configure ServingRuntime](/edb-postgres-ai/current/ai-factory/model/configure-servingruntime/) — Create custom runtimes for specialized models and settings.
3.  [Advanced ServingRuntime Configuration](/edb-postgres-ai/current/ai-factory/model/how-to-deploy-ai-models/) *(placeholder — expand with custom Transformers/Explainers patterns)*
...
1.  [Observability for Model Serving](/edb-postgres-ai/current/ai-factory/model/observability/) — Metrics, logs, and traces for serving and pipelines.
2.  [Monitor InferenceService](/edb-postgres-ai/current/ai-factory/model/monitor-inferenceservice/) — Health and performance of serving endpoints.
3.  [Hybrid Manager Observability](/edb-postgres-ai/current/hybrid-manager/ai-factory/observability/)
...
1.  [Hybrid Manager API Overview](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/interacting_programmatically/)
2.  [Using the Hybrid Manager API](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/interacting_programmatically/using_the_hm_api/)
