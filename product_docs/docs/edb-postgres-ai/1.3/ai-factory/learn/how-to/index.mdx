...
-   [Pipeline Getting Started](/edb-postgres-ai/latest/ai-factory/pipeline/gettingstarted/)
-   [Parse HTML and PDFs](/edb-postgres-ai/latest/ai-factory/pipeline/preparers/examples/)
-   [Use OCR and Summarization](/edb-postgres-ai/latest/ai-factory/pipeline/preparers/examples/)
-   [Supported Models for Pipelines](/edb-postgres-ai/latest/ai-factory/pipeline/models/supported-models/)
...
-   [Vector Engine Overview](/edb-postgres-ai/latest/ai-factory/vector-engine/)
-   [Build Retrieval-Augmented Generation Pipelines](./gen-ai/hybrid-kb-best-practices.mdx)

### Hybrid Manager Integration

-   [Setup GPU Resources](/edb-postgres-ai/latest/hybrid-manager/ai-factory/learn/how-to/setup-gpu/)
