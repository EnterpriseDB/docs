...
-   [Vector Engine](/edb-postgres-ai/latest/ai-factory/vector-engine/) — Vector search in your Postgres clusters.
-   [Pipelines](/edb-postgres-ai/latest/ai-factory/pipeline/) — Controlled creation of Knowledge Bases and embeddings.
-   [Model Serving](/edb-postgres-ai/latest/ai-factory/model/serving/) — Kubernetes-native, GPU-accelerated model inference.
-   [Agent Studio](/edb-postgres-ai/latest/ai-factory/gen-ai/agent-studio/) — Governed Assistant and Tool development.
...
-   [AI Factory Overview](/edb-postgres-ai/latest/ai-factory/)
-   [Vector Engine](/edb-postgres-ai/latest/ai-factory/vector-engine/)
-   [Pipelines](/edb-postgres-ai/latest/ai-factory/pipeline/)
-   [Model Serving](/edb-postgres-ai/latest/ai-factory/model/serving/)
-   [Agent Studio](/edb-postgres-ai/latest/ai-factory/gen-ai/agent-studio/)
