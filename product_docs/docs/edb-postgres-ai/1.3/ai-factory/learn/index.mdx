...
-   [Developer quickstart](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-assistant/) — Build a customer service assistant
...
-   [Create a Knowledge Base](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/create-knowledge-base/)
-   [Configure Data Lake](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/configure-datalake/)
...
**Tip:** If you're new to EDB PG AI, start with [AI Factory 101](101/).
