...
2.  [Tools Explained](/edb-postgres-ai/latest/ai-factory/learn/explained/tools-explained/)
3.  [Create a Tool](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/create-tool/)
4.  [Structures Explained](/edb-postgres-ai/latest/ai-factory/learn/explained/structures-explained/) — for multi-step pipelines and agent behaviors
...
3.  [Advanced ServingRuntime Configuration](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/faq/) *(placeholder — expand with custom Transformers/Explainers patterns)*
