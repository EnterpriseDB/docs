...
1.  [Assistants Explained](/edb-postgres-ai/latest/ai-factory/learn/explained/assistants-explained/)
2.  [Structures Explained](/edb-postgres-ai/latest/ai-factory/learn/explained/structures-explained/)
3.  [Create an Assistant](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/create-assistant/)
4.  [Create a Structure](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/create-structure/)
5.  [Create a Tool](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/create-tool/)
...
1.  [Hybrid Knowledge Base Best Practices](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/hybrid-kb-best-practices/)
2.  [Manage Knowledge Bases](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/manage-knowledge-base/)
...
1.  [Model Serving Concepts](/edb-postgres-ai/latest/ai-factory/learn/explained/model-serving-concepts/)
2.  [Configure ServingRuntime](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/configure-servingruntime/)
3.  [Deploy a NIM Container](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/deploy-nim-container/)
4.  [Update GPU Resources](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/update-gpu-resources/)
5.  [Verify Model Deployments](/edb-postgres-ai/latest/hybrid-manager/ai-factory/learn/how-to/verify-models/)
...
1.  [Observability for Model Serving](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/observability/)
2.  [Monitor InferenceService](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/monitor-inferenceservice/)
