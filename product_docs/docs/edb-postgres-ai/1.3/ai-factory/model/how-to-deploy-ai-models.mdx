...
→ For a full setup guide, see: [Setup GPU Resources for Model Serving](/edb-postgres-ai/1.3/ai-factory/model/setup-gpu)
...
-   [Setup GPU Resources for Model Serving](/edb-postgres-ai/1.3/ai-factory/model/setup-gpu)
-   [Deploy NVIDIA NIM Microservices - Advanced Guide](/edb-postgres-ai/1.3/ai-factory/model/deploy-nim-container)
