...
→ For a full setup guide, see: [Setup GPU Resources for Model Serving](/edb-postgres-ai/latest/hybrid-manager/ai-factory/model/how-to/setup-gpu/)
...
-   [Setup GPU Resources for Model Serving](/edb-postgres-ai/latest/hybrid-manager/ai-factory/model/how-to/setup-gpu/)
-   [Deploy NVIDIA NIM Microservices - Advanced Guide](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/deploy-nim-container/)
