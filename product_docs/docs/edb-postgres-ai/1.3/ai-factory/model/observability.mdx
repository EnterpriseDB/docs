...
See [Hybrid Manager Model Serving Observability](/edb-postgres-ai/latest/hybrid-manager/ai-factory/model/how-to/verify-models/) for additional guidance on using HCP observability tools with Model Serving.
