...
When running AI Factory in conjunction with Hybrid Manager (HM), you can integrate model serving observability into the broader HM observability stack.

See [Hybrid Manager Model Serving Observability](/edb-postgres-ai/latest/hybrid-manager/ai-factory/model/how-to/verify-models/) for additional guidance on using HM observability tools with Model Serving.
...
-   [KServe in AI Factory Concepts](/edb-postgres-ai/latest/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference)
-   [Hybrid Manager Model Serving Observability](/edb-postgres-ai/latest/hybrid-manager/ai-factory/model/how-to/verify-models/)
