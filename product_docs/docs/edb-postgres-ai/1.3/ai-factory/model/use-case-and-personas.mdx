...
- [Gen AI Builder Integration](/edb-postgres-ai/1.3/ai-factory/gen-ai/builder/)
...
**Stakeholders**: Platform Engineers, ML Engineers, Security Engineers, Compliance Teams
