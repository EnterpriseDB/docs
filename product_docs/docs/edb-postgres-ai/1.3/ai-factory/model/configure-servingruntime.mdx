---
title: How-To Configure a ClusterServingRuntime
...
For Hybrid Manager users, configuring runtimes is a core step toward enabling Model Serving — see [Model Serving in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/model/serving/).
...
-   [Model Serving Explained](/edb-postgres-ai/latest/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference)
-   [AI Factory Terminology](/edb-postgres-ai/latest/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference)
...
-   [Model Serving Explained](/edb-postgres-ai/latest/ai-factory/learn/explained/ai-factory-concepts/#model-serving-and-inference)
-   [AI Factory Terminology](/edb-postgres-ai/latest/ai-factory/learn/explained/model-serving-concepts/#servingruntime--clusterservingruntime)
