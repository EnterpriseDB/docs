...
For Hybrid Manager users, configuring runtimes is a core step toward enabling Model Serving — see [Model Serving in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/ai-factory/models).
