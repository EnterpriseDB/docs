---
title: How-To Create an InferenceService for NVIDIA NIM Container
...
Explore more in the [AI Factory learning guide](/edb-postgres-ai/current/ai-factory/learn/).
