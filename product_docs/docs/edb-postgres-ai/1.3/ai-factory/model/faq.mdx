...
AI Factory Model Serving (version 1.2) supports deploying models packaged as **NVIDIA NIM Microservices **
...
Refer to the [GPU setup guide](/edb-postgres-ai/1.3/ai-factory/model/update-gpu-resources) for supported configurations and node recommendations by cloud provider.
