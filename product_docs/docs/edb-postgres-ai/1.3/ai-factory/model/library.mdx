...
The Model Library provides the curated catalog for [Model Serving](serving/) deployments. Only models approved through the governance framework can be deployed to production inference endpoints, ensuring consistent security and compliance standards.
...
[Configure Private Registry Integration →](integrate-private-registry/)
...
[Manage Repository Metadata →](manage-repository-metadata/)
...
-   [Private Registry Integration Guide](integrate-private-registry/)
-   [Repository Rules Configuration](define-repository-rules/)
-   [Metadata Management Procedures](manage-repository-metadata/)
...
-   [Model Serving Architecture](architecture/)

**Integration Capabilities:**

-   [Model Serving Platform](serving/)
...
-   [Model Library Configuration](library)
-   [Repository Management Procedures](define-repository-rules/)
