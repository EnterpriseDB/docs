---
title: How-To Monitor deployed models with KServe
...
For AI Factory users, Hybrid Manager will provide additional value-add monitoring and observability features — see [Model Serving in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/model/serving/).
...
-   [AI Factory Terminology](/edb-postgres-ai/latest/ai-factory/learn/explained/terminology/#model-serving)
...
-   [Model Serving in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/model/serving/) *(Coming soon)*
