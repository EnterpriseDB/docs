...
prevNext: true
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/model
  - /edb-postgres-ai/innovation-release/ai-factory/model/*
navigation:
  - "#Getting started"
...
-   [AI Accelerator Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) - Pipeline model integration
-   [Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/knowledge-bases/) - Application development with served models
-   [Vector Engine](/edb-postgres-ai/current/ai-factory/vector-engine/) - Embedding model integration
