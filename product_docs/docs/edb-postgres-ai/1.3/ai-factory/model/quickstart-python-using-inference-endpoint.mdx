...
-   External access path and access key, or an internal cluster‑local path. See:
    -   [Access KServe endpoints](access-kserve-endpoints/)
...
-   Script: [hm_kserve_quickstart.py](samples/hm_kserve_quickstart.py/)
...
-   Build an app using the same headers and payloads; see the [Python client quickstart](quickstart-python-using-inference-endpoint).
...
-   Add observability and SLOs; see [Model observability](observability/) and [Update GPU resources](update-gpu-resources/).
