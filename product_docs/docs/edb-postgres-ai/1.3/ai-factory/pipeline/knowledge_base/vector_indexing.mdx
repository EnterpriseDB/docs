...
- VectorChordVchordq parameters: The `lists` and `spherical_centroids` can be set and will override the dynamic configuration. Guidance on these fields can be found in the [vectorchord docs](https://docs.vectorchord.ai/vectorchord/usage/indexing.html#tuning)
