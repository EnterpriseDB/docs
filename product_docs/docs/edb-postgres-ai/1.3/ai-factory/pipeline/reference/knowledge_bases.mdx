...
This reference documentation for Pipelines knowledge bases includes information on the functions and views available in the aidb extension related to [knowledge bases](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base/).
...
| index_type               | TEXT                                                               | 'vector'     | Vector index selection. See [Vector indexing](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base/vector_indexing/). |
...
> For details on index types, operator classes, and tuning, see [Vector indexing](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base/vector_indexing/).
...
| mode                     | [aidb.PipelineAutoProcessingMode](#aidbpipelineautoprocessingmode) |         | Desired auto-processing mode                                                                |
