...
For most use cases, we recommend that you use the aidb [preparers](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/usage) to perform bulk preprocessing preparation steps on your data.
...
!!! Tip
This operation transforms the shape of the data, automatically unnesting collections by introducing a `part_id` column. See the [unnesting concept](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/concepts#unnesting) for more details.
!!!
...
!!! Tip
This operation transforms the shape of the data, automatically unnesting collections by introducing a `part_id` column. See the [unnesting concept](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/concepts#unnesting) for more detail.
!!!
...
```
 ...
 - The `model` is the name of the created model to use for summarization. The model must support the `decode_text()` and `decode_text_batch()` [model primitives](/edb-postgres-ai/1.3/ai-factory/pipeline/models/primitives).
