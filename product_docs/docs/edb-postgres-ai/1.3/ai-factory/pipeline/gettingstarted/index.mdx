...
The best place to start is with the [Pipelines overview](/edb-postgres-ai/latest/ai-factory/pipeline/) to get an understanding of what Pipelines is and how it works.

## Installation

Pipelines is included with the EDB Postgres AI - AI Accelerator suite of tools. To install Pipelines, follow the instructions in the [AI Accelerator Installation Guide](/edb-postgres-ai/latest/ai-factory/pipeline/installing/).
