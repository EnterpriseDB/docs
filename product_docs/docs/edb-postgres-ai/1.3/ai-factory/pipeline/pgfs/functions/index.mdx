...
- [S3-compatible storage](/edb-postgres-ai/1.3/ai-factory/pipeline/pgfs/functions/s3)
- [Local file system](/edb-postgres-ai/1.3/ai-factory/pipeline/pgfs/functions/local)
...
To use a storage location with aidb, you need to create a volume from the storage location. To do that, see [Creating a volume](/edb-postgres-ai/1.3/ai-factory/pipeline/pgfs/volumes).
