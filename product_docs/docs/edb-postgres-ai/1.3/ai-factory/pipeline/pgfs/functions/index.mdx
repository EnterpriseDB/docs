...
To use a storage location with aidb, you need to create a volume from the storage location. To do that, see [Creating a volume](/edb-postgres-ai/1.3/ai-factory/pipeline/volumes).
