...
See [Installing](/edb-postgres-ai/1.3/ai-factory/pipeline/installing) to learn how to install the PGFS extension as part of the Pipelines installation.

## Using PGFS

See the [PGFS management functions](/edb-postgres-ai/1.3/ai-factory/pipeline/pgfs/functions) reference for details on the functions available in the PGFS extension.
