...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory
- /purl/ai-factory
...
-   **Conversational applications** for both internal users and external customers, built with [**Gen AI Builder**](gen-ai/knowledge-bases/)
...
-   Reference: [Gen AI reference](gen-ai/reference/), [Model Serving](model/serving/), [Vector Engine](vector-engine/), and [Pipelines](pipeline/)
...
-   Start building **knowledge bases** and **assistants** with [**Gen AI Builder**](gen-ai/knowledge-bases/) and [**Agent Studio**](gen-ai/assistants/)
...
-   [Agent Studio](gen-ai/assistants/) — Build assistants, tools, structures, and rulesets
-   [Gen AI Builder](gen-ai/knowledge-bases/) — Manage knowledge bases and data lakes
...
-   Build your first [**Gen AI Assistant**](gen-ai/assistants/) using Agent Studio
-   Deploy a [**Knowledge Base**](gen-ai/knowledge-bases/) with Gen AI Builder and integrate with RAG
