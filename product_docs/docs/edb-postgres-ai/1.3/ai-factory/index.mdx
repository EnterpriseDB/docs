...
-   Build and run [**Gen AI agents**](gen-ai/) and conversational experiences powered by your enterprise knowledge and sovereign Postgres data in [**Hybrid Manager**](/edb-postgres-ai/current/hybrid-manager/ai-factory/)
...
-   Outside Hybrid Manager (selected components): Run Postgres-focused capabilities on compatible platforms, such as the [Vector Engine](vector-engine/), [Pipelines](pipeline/), or the AI DB (AIDB) feature set where available.
...
-   **Conversational applications** for both internal users and external customers, built with [**Gen AI Builder**](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/)
-   **AI-powered data apps** exposing [**model-serving APIs**](model/serving/) for search, recommendations, NLP, and vision
...
See our [Use Cases](learn/use-cases/) and [Industry Solutions](learn/solutions/) for detailed examples and solution patterns.
...
-   Concepts and architecture: [AI Factory Concepts](concepts/)
-   How-to guides: [Gen AI how-to](learn/how-to/) and [Model serving how-to](model/how-to-deploy-ai-models/)
-   Tutorials and learning: [Learning Paths](learn/learning-paths/) — 101, 201, and 301
-   Reference: [Gen AI reference](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/), [Model Serving](model/serving/), [Vector Engine](vector-engine/), and [Pipelines](pipeline/)
...
-   **AI engineers** operationalizing models with [**Model Serving**](model/serving/) within governed Postgres-integrated environments
...
-   Explore our [Learning Paths](learn/learning-paths/) to build foundational skills
-   Start building **knowledge bases** and **assistants** with [**Gen AI Builder**](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/) and [**Agent Studio**](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/assistants/)
...
-   [Agent Studio](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/assistants/) — Build assistants, tools, structures, and rulesets
-   [Gen AI Builder](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/) — Manage knowledge bases and data lakes
...
-   [How-to Guides](learn/how-to/) — Practical guides for building EDB PG AI solutions
...
-   Build your first [**Gen AI Assistant**](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/assistants/) using Agent Studio
-   Deploy a [**Knowledge Base**](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/knowledge-bases/) with Gen AI Builder and integrate with RAG
...
Explore [Use Cases](learn/use-cases/) and [Industry Solutions](learn/solutions/) for end-to-end patterns and architecture guidance.
