...
- Build and run [**Gen AI agents**](./gen-ai/agent-studio) and conversational experiences powered by your enterprise knowledge and sovreign Postgres data in [**Hybrid Manager**](/edb-postgres-ai/hybrid-manager/ai-factory)
...
- Deploy scalable [**model serving**](/edb-postgres-ai/ai-factory/model/serving), using GPU acceleration and enterprise observability
...
- **ML/AI-powered data apps** exposing [**model-serving APIs**](/edb-postgres-ai/ai-factory/model/serving) for search, recommendations, NLP, and vision
...
- **AI/ML engineers** operationalizing models with [**Model Serving**](/edb-postgres-ai/ai-factory/model/serving) within governed Postgres-integrated environments
...
- Deploy your first [**model serving workload**](/edb-postgres-ai/ai-factory/model/serving) and integrate with Postgres queries
...
- [Asset Library](/edb-postgres-ai/ai-factory/model/library) — Manage and govern models and AI assets
- [Model Serving](/edb-postgres-ai/ai-factory/model/serving) — Deploy and scale model inference services
...
- Launch your first [**Model Serving InferenceService**](/edb-postgres-ai/ai-factory/model/serving)
