...
!!!note
Some of these issues have been resolved in a later Innovation release. Please refer to [Innovation Release Known Issues](/edb-postgres-ai/innovation-release/hybrid-manager/overview/known_issues) if you want to know the latest status of these issues or if you are using an Innovation release.
!!!
...
!!!tip
Resolved in an [Innovation Release](/edb-postgres-ai/innovation-release/hybrid-manager/overview/known_issues).
!!!
...
[UPM-73348, set to cancelled, checking with Kamlesh]: #

**Description**: You are currently unable to query Knowledge Bases for self-managed clusters. 
...
[UPM-67298, blocked, dependency on nvidia]:#
...
!!!tip
HM now uses LangFlow instead of Griptape for knowledge base management, so this issue is no longer applicable.
!!!

[GRIP-934, abandoned due to switch to LangFlow]: #
...
!!!tip 
Resolved in HM versions 1.3.6 and later.
!!!
