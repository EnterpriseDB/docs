...
!!!note
Some of these issues have been resolved in a later Innovation release. Please refer to [Innovation Release Known Issues](/edb-postgres-ai/preview/hybrid-manager/overview/known_issues) if you want to know the latest status of these issues or if you are using an Innovation release.
!!!
...
!!!tip
Resolved in an [Innovation Release](/edb-postgres-ai/preview/hybrid-manager/overview/known_issues).
!!!
