...
| **Analytics**                      | Offload cold data to [Delta Lake or Iceberg](/pgaa/1.3/), query with Postgres syntax, and enable hybrid transactional/analytical processing.                                                                                                                                  |
...
- [Analytics](/pgaa/1.3/) – Enable open-format analytics with Iceberg, Delta Lake, and tiered offloading.
