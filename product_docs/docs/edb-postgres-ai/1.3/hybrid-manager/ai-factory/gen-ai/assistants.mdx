...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/assistants
---
...
-   Model/driver selection appropriate to task (see SDK [drivers](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/drivers/))
...
-   [Create Assistant](/edb-postgres-ai/current/ai-factory/gen-ai/create-assistant): Step‑by‑step assistant configuration
-   [Knowledge Base Integration](/edb-postgres-ai/current/ai-factory/gen-ai/knowledge-bases): Comprehensive knowledge management
-   [Tool Development](/edb-postgres-ai/current/ai-factory/gen-ai/tools/): External system integration patterns
...
-   SDK overview: [Gen AI Builder SDK](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/)
