...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/structures
---
...
**Creation Procedures**
- [Create Structure Guide](/edb-postgres-ai/current/ai-factory/gen-ai/create-structure): Comprehensive structure development and deployment procedures
- [Structure Configuration](/edb-postgres-ai/current/ai-factory/gen-ai/reference/structures/structure-config): Detailed configuration options and best practices
- [Structure Execution](/edb-postgres-ai/current/ai-factory/gen-ai/reference/structures/run-structure): Testing and validation procedures for deployed structures

### Integration Resources

**Gen AI Builder Components**
- [Assistant Integration](/edb-postgres-ai/current/ai-factory/gen-ai/assistants): Structure utilization within conversational interfaces
- [Tool Development](/edb-postgres-ai/current/ai-factory/gen-ai/tools): Structure implementation as sophisticated tools
- [Data Source Integration](/edb-postgres-ai/current/ai-factory/gen-ai/libraries): Structure utilization in content processing workflows

**AI Factory Infrastructure**
- [Model Serving Integration](/edb-postgres-ai/current/ai-factory/model/): Language model connectivity for structure operations
- [Hybrid Manager Deployment](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai): Infrastructure integration and resource management

## SDK reference

- [Agents and Structures](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures)
- [Tasks](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures/tasks), [Pipelines](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures/pipelines), [Workflows](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures/workflows)
