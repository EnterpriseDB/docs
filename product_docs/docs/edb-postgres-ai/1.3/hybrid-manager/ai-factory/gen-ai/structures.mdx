...
1.  **API Integration**: Programmatic execution through RESTful API endpoints
1.  **Assistant Integration**: Structure invocation through assistant tool interfaces
1.  **Pipeline Integration**: Automated execution within data source processing workflows
1.  **Event-Driven Execution**: Triggered execution based on system events or schedules
...
-   [Structure Configuration](reference/structures/structure-config/): Detailed configuration options and best practices
-   [Structure Execution](reference/structures/run-structure/): Testing and validation procedures for deployed structures
...
-   [Tasks](reference/sdk/structures/tasks/), [Pipelines](reference/sdk/structures/pipelines/), [Workflows](reference/sdk/structures/workflows/)
