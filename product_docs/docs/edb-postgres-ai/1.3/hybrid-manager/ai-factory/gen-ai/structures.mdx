...
**Creation Procedures**
- [Create Structure Guide](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-structure): Comprehensive structure development and deployment procedures
- [Structure Configuration](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/structures/structure-config): Detailed configuration options and best practices
- [Structure Execution](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/structures/run-structure): Testing and validation procedures for deployed structures

### Integration Resources

**Gen AI Builder Components**
- [Assistant Integration](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants): Structure utilization within conversational interfaces
- [Tool Development](/edb-postgres-ai/1.3/ai-factory/gen-ai/tools): Structure implementation as sophisticated tools
- [Data Source Integration](/edb-postgres-ai/1.3/ai-factory/gen-ai/libraries): Structure utilization in content processing workflows
...
- [Tasks](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures/tasks), [Pipelines](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures/pipelines), [Workflows](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures/workflows)
