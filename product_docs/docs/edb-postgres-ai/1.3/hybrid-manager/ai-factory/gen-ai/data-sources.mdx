...
-   [Embeddings explained](/edb-postgres-ai/1.3/ai-factory/concepts/generic-concepts/#embeddings-and-vector-representations)
...
-   [Knowledge Bases overview](/edb-postgres-ai/1.3/ai-factory/pipeline/knowledge_base)
-   [Building Knowledge Bases with Gen AI Builder](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-knowledge-base)
...
-   [Configure a Web Page data source](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-source-webpage)
-   [Configure a Data Lake data source](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-source-data-lake)
-   [Configure an Amazon S3 data source](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-source-s3)
-   [Configure a Google Drive data source](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-source-google-drive)
-   [Configure an Atlassian Confluence data source](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-source-confluence)
-   [Configure a Custom data source](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-source-custom)
...
-   [Building AI Workflows with Gen AI Builder](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-knowledge-base)
-   [Structures](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures)
