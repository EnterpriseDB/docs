...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/data-sources
---
...
-   [Embeddings explained](/edb-postgres-ai/current/ai-factory/concepts/generic-concepts/#embeddings-and-vector-representations)
-   [Retrieval Augmented Generation (RAG)](/edb-postgres-ai/current/ai-factory/concepts/terminology/#retrieval-augmented-generation-rag)

For guidance on using this content in AI applications:

-   [Knowledge Bases overview](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base)
-   [Building Knowledge Bases with Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/create-knowledge-base)
...
-   [Configure a Web Page data source](/edb-postgres-ai/current/ai-factory/gen-ai/data-source-webpage)
-   [Configure a Data Lake data source](/edb-postgres-ai/current/ai-factory/gen-ai/data-source-data-lake)
-   [Configure an Amazon S3 data source](/edb-postgres-ai/current/ai-factory/gen-ai/data-source-s3)
-   [Configure a Google Drive data source](/edb-postgres-ai/current/ai-factory/gen-ai/data-source-google-drive)
-   [Configure an Atlassian Confluence data source](/edb-postgres-ai/current/ai-factory/gen-ai/data-source-confluence)
-   [Configure a Custom data source](/edb-postgres-ai/current/ai-factory/gen-ai/data-source-custom)
...
-   [Building AI Workflows with Gen AI Builder](/edb-postgres-ai/current/ai-factory/gen-ai/create-knowledge-base)
-   [Structures](/edb-postgres-ai/current/ai-factory/gen-ai/structures)

## SDK reference

-   [Data Loaders](reference/sdk/data/loaders.mdx)
-   [File Manager Drivers](reference/sdk/drivers/file-manager-drivers.mdx)
-   [Web Scraper Drivers](reference/sdk/drivers/web-scraper-drivers.mdx)
