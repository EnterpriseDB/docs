...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/quickstart-customer-service-agent-ui
---
...
- [Knowledge Base Creation Guide](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-knowledge-base)
...
**Tool Integration**: Connect external systems for account lookups, ticket creation, and workflow automation using [Tools Development](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/).
