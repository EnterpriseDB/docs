...
- A Knowledge Base (or data sources) you plan to use. See /edb-postgres-ai/1.3/ai-factory/pipeline/knowledge_base/.
- A model endpoint available via /edb-postgres-ai/1.3/ai-factory/model/serving/, or an approved external provider per your policy.
