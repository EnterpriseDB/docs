...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/create-tool
---

> Prerequisite: Access to the Hybrid Manager UI with AI Factory enabled. See [AI Factory in Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/ai-factory/).
...
-   [Tools](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/tools)
-   [Agents and Structures](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures)
...
- [Tool Configuration Reference](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/tool-config): Detailed configuration options
- [Tool Execution Testing](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/run-tool): Testing procedures and validation methods

**Integration Guides**
- [Tools Overview](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/): Comprehensive tool architecture and capabilities
- [Assistant Integration](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-assistant): Tool assignment procedures
- [Structure Workflows](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures): Tool integration in automated processes
