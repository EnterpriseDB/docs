...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/manage-knowledge-base
---
...
1.  The Knowledge Bases list view displays:
...
1.  The detail view typically shows:
...
1.  Locate `Company Policy KB`.
1.  Click **View Details** → confirm recent Libraries were updated.
1.  Click **Refresh** → re-sync the Knowledge Base.
1.  Monitor status until **Succeeded**.
