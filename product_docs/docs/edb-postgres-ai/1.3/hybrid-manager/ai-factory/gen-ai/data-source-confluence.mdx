...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/data-source-confluence
---
...
1.  Choose **Confluence** from the available data source types.
...
For more about how content is indexed and retrieved, see [Embeddings explained](/edb-postgres-ai/current/ai-factory/concepts/generic-concepts/#embeddings-and-vector-representations).
