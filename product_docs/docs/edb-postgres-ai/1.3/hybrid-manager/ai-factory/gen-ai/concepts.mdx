...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/concepts
---
...
- Runs with a model endpoint configured by your platform (see [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/)).

Learn more: [Assistants](/edb-postgres-ai/current/ai-factory/gen-ai/assistants)
...
Learn more: [Rulesets](/edb-postgres-ai/current/ai-factory/gen-ai/rulesets/)
...
Learn more: [Tools](/edb-postgres-ai/current/ai-factory/gen-ai/tools/)
...
Learn more: [Structures](/edb-postgres-ai/current/ai-factory/gen-ai/structures/)
...
Learn more: [Threads](/edb-postgres-ai/current/ai-factory/gen-ai/threads)

## Models and endpoints (generation)

Assistants use model endpoints for generation:

- Use [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/) for private inference.
...
Learn more: [Access KServe endpoints](/edb-postgres-ai/current/ai-factory/model/access-kserve-endpoints)
...
- [Developer quickstart](/edb-postgres-ai/current/ai-factory/gen-ai/quickstart-customer-service-agent-ui)
- [Getting started](/edb-postgres-ai/current/ai-factory/gen-ai/getting-started)
