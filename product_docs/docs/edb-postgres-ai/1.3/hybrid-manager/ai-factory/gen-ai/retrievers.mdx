...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/retrievers
---
...
**Retriever Setup**
- [Create Retriever Guide](/edb-postgres-ai/current/ai-factory/gen-ai/create-retriever): Comprehensive retriever configuration and deployment procedures
- [Performance Optimization](/edb-postgres-ai/current/ai-factory/gen-ai/retrievers): Advanced configuration techniques for optimal search effectiveness

### System Integration

**Component Connectivity**
- [Assistant Integration](/edb-postgres-ai/current/ai-factory/gen-ai/assistants): Retriever utilization within conversational systems
- [Knowledge Base Integration](/edb-postgres-ai/current/ai-factory/gen-ai/libraries): Content source configuration and optimization
- [Structure Integration](/edb-postgres-ai/current/ai-factory/gen-ai/structures): Advanced retrieval workflow development

**Infrastructure Integration**
- [Vector Engine Integration](/edb-postgres-ai/current/ai-factory/vector-engine/): High-performance semantic search capabilities
- [Hybrid Manager Deployment](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai): Infrastructure management and resource optimization

## SDK reference

- [RAG Engines](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/engines)
- [Embedding Drivers](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/drivers/embedding-drivers)
- [Rerank Drivers](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/drivers/rerank-drivers)
- [Vector Store Drivers](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/drivers/vector-store-drivers)
