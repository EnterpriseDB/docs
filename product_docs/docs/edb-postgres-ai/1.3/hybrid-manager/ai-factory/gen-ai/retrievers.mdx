...
-   [RAG Engines](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/engines)
-   [Embedding Drivers](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/drivers/embedding-drivers)
-   [Rerank Drivers](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/drivers/rerank-drivers)
-   [Vector Store Drivers](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/drivers/vector-store-drivers)
