...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/retrievers
---
...
1.  **Search Strategy Selection**: Optimal approach determination based on query characteristics
1.  **Knowledge Base Targeting**: Appropriate content source identification and prioritization
1.  **Semantic Matching**: Vector similarity computation and relevance scoring
1.  **Result Assembly**: Content selection and context window optimization
...
-   [Create Retriever Guide](create-retriever/): Comprehensive retriever configuration and deployment procedures
-   [Performance Optimization](retrievers): Advanced configuration techniques for optimal search effectiveness

### System Integration

**Component Connectivity**

-   [Assistant Integration](assistants/): Retriever utilization within conversational systems
-   [Knowledge Base Integration](libraries/): Content source configuration and optimization
-   [Structure Integration](structures/): Advanced retrieval workflow development
...
-   [Embedding Drivers](reference/sdk/drivers/embedding-drivers/)
-   [Rerank Drivers](reference/sdk/drivers/rerank-drivers/)
-   [Vector Store Drivers](reference/sdk/drivers/vector-store-drivers/)
