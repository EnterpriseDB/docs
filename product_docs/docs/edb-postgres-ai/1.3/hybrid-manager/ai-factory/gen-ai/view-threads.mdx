...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/view-threads
---
...
- [Threads Architecture](/edb-postgres-ai/current/ai-factory/gen-ai/threads): Comprehensive thread system overview
- [Assistant Performance Evaluation](/edb-postgres-ai/current/ai-factory/gen-ai/assistants): Assistant optimization procedures
- [Compliance Monitoring](/edb-postgres-ai/current/ai-factory/gen-ai/rulesets): Behavioral compliance assessment methods

**System Integration**
- [Gen AI Builder Overview](../): Platform architecture and component relationships
- [Hybrid Manager Integration](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai): Infrastructure management procedures
