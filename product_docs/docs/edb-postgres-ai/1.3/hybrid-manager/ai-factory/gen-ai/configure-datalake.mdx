...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/configure-datalake
---
...
-   [Data Artifacts](reference/sdk/data/artifacts.mdx) — pass data between components
-   [File Manager Drivers](reference/sdk/drivers/file-manager-drivers.mdx) — object storage access patterns
...
-   [Data Lake](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-lake)
-   [AI Factory Concepts](/edb-postgres-ai/1.3/ai-factory/concepts)
-   [Configure Data Sources](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-sources)
-   [Configure Knowledge Bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/knowledge-bases)
-   [Hybrid Manager: Using Gen AI Builder](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai)
