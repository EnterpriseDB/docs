...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/create-knowledge-base
---
...
-   In Gen AI Builder console, go to **Knowledge Bases**.
...
-   Useful when you want full control over your vector store (ex: HM-managed Postgres + AIDB).
...
-   [Embedding Drivers](reference/sdk/drivers/embedding-drivers.mdx) — generate vector embeddings
-   [Vector Store Drivers](reference/sdk/drivers/vector-store-drivers.mdx) — store/query embeddings
-   [RAG Engines](reference/sdk/engines) — assemble retrieval and response stages
