...
For more about how content is indexed and retrieved from these files, see [Embeddings explained](/edb-postgres-ai/1.3/ai-factory/concepts/generic-concepts/#embeddings-and-vector-representations).
