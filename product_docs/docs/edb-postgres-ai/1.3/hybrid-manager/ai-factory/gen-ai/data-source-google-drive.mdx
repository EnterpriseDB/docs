...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/data-source-google-drive
---
...
1.  Choose **Google Drive** from the available data source types.
...
For more about how content is indexed and retrieved from these files, see [Embeddings explained](/edb-postgres-ai/current/ai-factory/concepts/generic-concepts/#embeddings-and-vector-representations).
...
-   [Building Knowledge Bases with Gen AI Builder](create-knowledge-base/)
-   [Hybrid Manager: Using Gen AI Builder](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai)
