...
redirects:
  ...
  - /edb-postgres-ai/innovation-release/hybrid-manager/ai-factory/gen-ai
  - /purl/ai-factory/gen-ai/agent-studio
  - /edb_postgres-ai/innovation-release/ai-factory/gen-ai
navigation:
  - "#Getting started"
  - getting-started
  - concepts
...
Applications expose functionality through standardized APIs that support diverse client applications while maintaining consistent security and operational characteristics (see [SDK reference](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/)).
