...
Applications expose functionality through standardized APIs that support diverse client applications while maintaining consistent security and operational characteristics (see [SDK reference](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/)).
