...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/architecture
---
...
- [Gen AI quickstart (UI)](/edb-postgres-ai/current/ai-factory/gen-ai/quickstart-customer-service-agent-ui)
- [Getting started](/edb-postgres-ai/current/ai-factory/gen-ai/getting-started)
- [Hybrid KB best practices](/edb-postgres-ai/current/ai-factory/gen-ai/hybrid-kb-best-practices)
