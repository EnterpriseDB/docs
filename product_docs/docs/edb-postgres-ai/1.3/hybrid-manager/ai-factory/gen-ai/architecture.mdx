...
- Client patterns: OpenAI‑compatible or raw HTTP; see [access guide](/edb-postgres-ai/1.3/ai-factory/model/access-kserve-endpoints) and [Python client quickstart](/edb-postgres-ai/1.3/ai-factory/model/quickstart-python-using-inference-endpoint).
