...
See also: [AI Factory Models](/edb-postgres-ai/1.3/ai-factory/model/) and [deploy NIM containers](/edb-postgres-ai/1.3/ai-factory/model/deploy-nim-container).
...
-   Create: [Create a Retriever](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-retriever)
...
See: [Configure Data Lake](/edb-postgres-ai/1.3/ai-factory/gen-ai/configure-datalake), [Vector Engine](/edb-postgres-ai/1.3/ai-factory/vector-engine/).
...
See SDK: [Engines](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/engines) and Drivers. See Models: [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/).
...
Docs: [Threads](/edb-postgres-ai/1.3/ai-factory/gen-ai/threads), SDK [Structures/observability](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures/observability).
...
Explore: [Hybrid KB best practices](/edb-postgres-ai/1.3/ai-factory/gen-ai/hybrid-kb-best-practices), [Quickstart UI](/edb-postgres-ai/1.3/ai-factory/gen-ai/quickstart-customer-service-agent-ui).

### Where to find SDK references and examples?

-   SDK overview: [Gen AI Builder SDK](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/)
...
See also the product guides: [assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants), [knowledge bases](/edb-postgres-ai/1.3/ai-factory/gen-ai/knowledge-bases), [retrievers](/edb-postgres-ai/1.3/ai-factory/gen-ai/retrievers), [rulesets](/edb-postgres-ai/1.3/ai-factory/gen-ai/rulesets), [structures](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures), [tools](/edb-postgres-ai/1.3/ai-factory/gen-ai/tools), [threads](/edb-postgres-ai/1.3/ai-factory/gen-ai/threads).
