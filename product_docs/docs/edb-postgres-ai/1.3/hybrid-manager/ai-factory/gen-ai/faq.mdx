...
prevNext: true
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/faq
---
...
-   [When to use RAG vs. fine‑tuning?](#when-to-use-rag-vs-finetuning)
...
-   NVIDIA NIM: deploy as private endpoints via [Model Serving](/edb-postgres-ai/current/ai-factory/model/)

See also: [AI Factory Models](/edb-postgres-ai/current/ai-factory/model/) and [deploy NIM containers](../model/deploy-nim-container).
...
-   Create: [Create a Retriever](/edb-postgres-ai/current/ai-factory/gen-ai/create-retriever)
...
See: [Configure Data Lake](/edb-postgres-ai/current/ai-factory/gen-ai/configure-datalake), [Vector Engine](/edb-postgres-ai/current/ai-factory/vector-engine/).
...
See SDK: [Engines](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/engines) and Drivers. See Models: [Model Serving](/edb-postgres-ai/current/ai-factory/model/).
...
Docs: [Threads](/edb-postgres-ai/current/ai-factory/gen-ai/threads), SDK [Structures/observability](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures/observability).
...
Explore: [Hybrid KB best practices](/edb-postgres-ai/current/ai-factory/gen-ai/hybrid-kb-best-practices), [Quickstart UI](/edb-postgres-ai/current/ai-factory/gen-ai/quickstart-customer-service-agent-ui).
...
-   Drivers: [Prompt/Assistant](reference/sdk/drivers/), [Embedding](reference/sdk/drivers/embedding-drivers.mdx), [Vector Stores](reference/sdk/drivers/vector-store-drivers.mdx)
...
See also the product guides: [assistants](/edb-postgres-ai/current/ai-factory/gen-ai/assistants), [knowledge bases](/edb-postgres-ai/current/ai-factory/gen-ai/knowledge-bases), [retrievers](/edb-postgres-ai/current/ai-factory/gen-ai/retrievers), [rulesets](/edb-postgres-ai/current/ai-factory/gen-ai/rulesets), [structures](/edb-postgres-ai/current/ai-factory/gen-ai/structures), [tools](/edb-postgres-ai/current/ai-factory/gen-ai/tools), [threads](/edb-postgres-ai/current/ai-factory/gen-ai/threads).
