...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/data-source-webpage
---
...
-   [Hybrid Manager Gen AI Builder overview](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai)
...
1.  Choose **Web Page** from the available data source types.
