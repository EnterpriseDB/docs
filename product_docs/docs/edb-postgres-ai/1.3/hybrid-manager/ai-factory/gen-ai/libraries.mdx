...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/libraries
---
...
- [Data Source Configuration](/edb-postgres-ai/current/ai-factory/gen-ai/data-sources): Comprehensive source integration procedures
- [Knowledge Base Setup](/edb-postgres-ai/current/ai-factory/gen-ai/knowledge-bases): Search optimization and performance tuning
- [Retriever Configuration](/edb-postgres-ai/current/ai-factory/gen-ai/retrievers): Search strategy definition and parameter optimization
