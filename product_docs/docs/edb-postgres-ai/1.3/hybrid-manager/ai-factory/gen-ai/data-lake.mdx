...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/data-lake
---
...
**Setup Procedures**
- [Configure Data Lake](/edb-postgres-ai/current/ai-factory/gen-ai/configure-datalake): Comprehensive setup procedures for object storage integration
- [Data Source Configuration](/edb-postgres-ai/current/ai-factory/gen-ai/data-sources): Data Lake integration with content ingestion workflows

**Integration Documentation**
- [Libraries Integration](/edb-postgres-ai/current/ai-factory/gen-ai/libraries): Content management workflow integration
- [Component Deployment](/edb-postgres-ai/current/ai-factory/gen-ai/structures): Structure and Tool deployment procedures
