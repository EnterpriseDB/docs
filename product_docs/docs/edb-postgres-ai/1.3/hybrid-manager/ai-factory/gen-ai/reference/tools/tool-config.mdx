...
originalFilePath: >-
  https://github.com/EnterpriseDB/pgai-ai-builder/blob/main/docs/griptape-cloud/tools/tool-config.md
editTarget: originalFilePath

redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/reference/tools/tool-config
---

## Overview

Tool repositories require a configuration file which informs Gen AI Builder of your Tool's dependencies and how it needs to build and run.
...
-   **tool_file**: The file that contains the Gen AI Builder `BaseTool`-derived class. The default value is `tool.py`.
