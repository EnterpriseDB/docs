...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/reference/tools
---

You can host your [Gen AI Builder SDK Tools](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/tools) on Gen AI Builder. This allows you to run your Tools without needing to manage infrastructure.
