---
title: Refresh a Data Source
navTitle: Refreshing Your Data
originalFilePath: >-
  https://github.com/EnterpriseDB/pgai-ai-builder/blob/main/docs/griptape-cloud/data-sources/refresh-data.md
editTarget: originalFilePath

redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/reference/data-sources/refresh-data
---
...
If you wish to manually refresh a Data Source you can do so either via the `Refresh` button in the cloud console or by API using the `Data Source ID` on the `Config` tab and a Gen AI Builder API Key.
