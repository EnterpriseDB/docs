...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/reference/structures/create-structure
---

You can host your Gen AI Builder SDK [Agents](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures/), [Pipelines](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures/pipelines/), and [Workflows](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/sdk/structures/workflows/) on Gen AI Builder. This allows you to run your Structures without needing to manage infrastructure.
...
1.  Install the [Gen AI Builder GitHub app to your GitHub account or organization](https://github.com/apps/griptape-cloud/installations/new/)
...
1.  Navigate to the Create Structure page in the Gen AI Builder Console
1.  Select *Gen AI Builder Structure from GitHub Repo*
...
1.  Upload the created ZIP file to a [Data Lake Bucket](../data-lakes) and note the Asset Name
1.  Specify the `structure_config.yaml` for this deployment
1.  Optionally, Enable Webhook and/or add Environment Variables
1.  Click *Create* to create your Structure using the configuration details that you have entered
