...
You can host your Gen AI Builder SDK [Agents](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures), [Pipelines](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures/pipelines), and [Workflows](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/structures/workflows) on Gen AI Builder. This allows you to run your Structures without needing to manage infrastructure.
