...
You can specify a [Structure](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/structures/create-structure/) to run as a Data Source as long as your Structure returns a [`TextArtifact` or `ListArtifact` from the Gen AI Builder SDK](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/data/artifacts). You can use this as a way to build custom Data Sources.
