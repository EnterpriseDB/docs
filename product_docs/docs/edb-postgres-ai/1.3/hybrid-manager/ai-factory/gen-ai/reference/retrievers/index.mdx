...
Retrievers provide retrieval augmented generation capabilities within Gen AI Builder. They are a fully-managed implementation of the [RAG Engine](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/sdk/engines/) within the [Gen AI Builder SDK](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/).
