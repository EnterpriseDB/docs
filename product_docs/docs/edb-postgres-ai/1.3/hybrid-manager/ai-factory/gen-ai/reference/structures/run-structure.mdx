...
You can use [StructureRunDrivers](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/drivers/structure-run-drivers#gen-ai-builder) to run your Structure with Gen AI Builder.
