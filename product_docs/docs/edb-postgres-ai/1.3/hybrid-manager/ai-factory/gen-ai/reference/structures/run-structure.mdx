...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/reference/structures/run-structure
---
...
You can use [StructureRunDrivers](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/sdk/drivers/structure-run-drivers/#gen-ai-builder) to run your Structure with Gen AI Builder.
