...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/reference/structures/run-structure
---
...
You can use [StructureRunDrivers](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/drivers/structure-run-drivers#gen-ai-builder) to run your Structure with Gen AI Builder.
