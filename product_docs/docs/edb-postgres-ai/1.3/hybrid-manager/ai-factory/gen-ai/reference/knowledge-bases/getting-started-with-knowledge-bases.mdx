---
title: Getting Started with Vector Knowledge Bases
originalFilePath: >-
  https://github.com/EnterpriseDB/pgai-ai-builder/blob/main/docs/griptape-cloud/knowledge-bases/getting-started-with-knowledge-bases.md
editTarget: originalFilePath

redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/reference/knowledge-bases/getting-started-with-knowledge-bases
---

## How to create a Vector Knowledge Base

Follow these steps to create a Vector Knowledge Base. For this example, we will use the fully-managed Gen AI Builder vector store. If you are using EDB Postgres or another type of Postgres instance as your vector store, select the pgvector option.

1.  Navigate to the Knowledge Bases page in the Gen AI Builder Console.
2.  Click *Create Knowledge Base*.
3.  Select the Gen AI Builder Vector Knowledge Base type.
...
When your Vector Knowledge Base is ready, the data it contains becomes available for applications to retrieve via Gen AI Builder Assistants, or Structures such as Agents.
...
1.  Navigate to the Assistants page in the Gen AI Builder Console.
2.  Click *Create Assistant*.
3.  Give your Assistant a name and description (optional).
4.  Select your Vector Knowledge Base from the *Knowledge Bases* dropdown menu.
...
For more information about different Knowledge Base types, see [Knowledge Base Types](knowledge-base-types.mdx)
