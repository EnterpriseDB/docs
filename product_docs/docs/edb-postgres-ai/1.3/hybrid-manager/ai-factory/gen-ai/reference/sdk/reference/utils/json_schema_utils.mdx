---
title: json_schema_utils
navTitle: build_strict_schema(json_schema, schema_id)

---

<span id="griptape.utils.json_schema_utils.build_strict_schema"></span>
...
<span id="griptape.utils.json_schema_utils.resolve_refs"></span>
