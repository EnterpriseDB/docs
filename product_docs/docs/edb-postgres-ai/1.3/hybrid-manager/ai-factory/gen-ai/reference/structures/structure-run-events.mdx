...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/reference/structures/structure-run-events
---
...
[Gen AI Builder Event Listener Driver](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/drivers/event-listener-drivers#gen-ai-builder) in the Gen AI Builder SDK.
...
By using the Gen AI Builder Event Listener Driver and an [Event Bus](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/reference/sdk/misc) that emits that Event type in your Structure code, the Cloud will automatically populate your Structure Run's output.
