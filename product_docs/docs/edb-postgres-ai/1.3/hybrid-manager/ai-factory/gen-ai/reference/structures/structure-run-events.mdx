...
[Gen AI Builder Event Listener Driver](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/drivers/event-listener-drivers#gen-ai-builder) in the Gen AI Builder SDK.
...
By using the Gen AI Builder Event Listener Driver and an [Event Bus](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/misc) that emits that Event type in your Structure code, the Cloud will automatically populate your Structure Run's output.
