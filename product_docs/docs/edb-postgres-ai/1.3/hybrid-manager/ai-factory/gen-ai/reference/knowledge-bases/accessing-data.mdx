...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/reference/knowledge-bases/accessing-data
---
...
You can use the [GriptapeCloudVectorStoreDriver](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai/reference/sdk/drivers/vector-store-drivers/#gen-ai-builder-knowledge-base) to query your Knowledge Base with Gen AI Builder.
