...
- [Assistant Integration](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants): Tool utilization within conversational interfaces
- [Structure Workflows](/edb-postgres-ai/1.3/ai-factory/gen-ai/structures): Tool incorporation in automated processes
