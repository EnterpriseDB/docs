...
redirects:
  - /edb-postgres-ai/latest/ai-factory/gen-ai/tools
---
...
1.  **Parameter Extraction**: Relevant information extraction from user inputs and conversation history
1.  **Security Validation**: Permission verification and rate limit enforcement
1.  **Execution Phase**: Tool-specific logic execution with error handling and timeout management
1.  **Result Integration**: Output formatting and incorporation into conversation flow
1.  **Context Updates**: Memory system updates reflecting tool execution results
...
-   [Create a Tool](create-tool/): Step-by-step tool development using pgai-ai-builder SDK
-   [Tool Configuration](reference/tools/tool-config/): Configuration schema and deployment procedures
-   [Run Tool](reference/tools/run-tool/): Execution testing and validation procedures
...
-   [Tool API Reference](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/): Technical specification for tool interfaces
