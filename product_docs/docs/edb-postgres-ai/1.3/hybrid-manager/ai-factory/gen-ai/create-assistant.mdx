...
redirects:
  - /edb-postgres-ai/innovation-release/ai-factory/gen-ai/create-assistant
---
...
-   Claude 3 Sonnet
-   Gemini Pro
-   Custom models deployed via [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving)
...
-   [Assistant Drivers](reference/sdk/drivers/assistant-drivers.mdx)
