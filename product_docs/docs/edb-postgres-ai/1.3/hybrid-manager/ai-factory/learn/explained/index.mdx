...
-   [Gen AI in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/gen-ai/)
-   [Agent Studio in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/gen-ai/agent-studio/)
-   [Gen AI Builder in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/gen-ai/builder/)
-   [Model Serving in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/model/serving/)
-   [Model Library in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/model/library/)
-   [AI Accelerator Pipelines Knowledge Bases](/edb-postgres-ai/latest/ai-factory/pipeline/knowledge_base/)

* * *

## Learn more

For full conceptual explanations of each AI Factory capability, see the [AI Factory Hub](/edb-postgres-ai/latest/ai-factory/learn/explained/).

For feature-specific **How-To Guides** within Hybrid Manager:

-   [Gen AI How-To Guides](/edb-postgres-ai/latest/ai-factory/learn/how-to/gen-ai/)
