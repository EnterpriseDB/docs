...
-   [Gen AI in Hybrid Manager](gen-ai/) — Gen AI capabilities in Hybrid Manager
-   [Agent Studio & Builder (consolidated)](gen-ai/) — Create assistants, tools, structures, rulesets; manage Knowledge Bases
...
-   Deploy your first Gen AI assistant or model using [Gen AI in HM](gen-ai/) or [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/)
