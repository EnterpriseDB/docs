...
-   [Gen AI in Hybrid Manager](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai.mdx) — Gen AI capabilities in Hybrid Manager
-   [Agent Studio & Builder (consolidated)](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai.mdx) — Create assistants, tools, structures, rulesets; manage Knowledge Bases
...
-   [GPU resource management](/edb-postgres-ai/1.3/ai-factory/model/setup-gpu) — Configure and allocate GPU capacity for serving
...
-   Access to GPU resources where needed for serving. See [GPU resource management](/edb-postgres-ai/1.3/ai-factory/model/setup-gpu).
...
-   Follow the [AI Factory learning paths](/edb-postgres-ai/1.3/ai-factory/learn/learning-paths)
...
-   Read [How-To Guides](/edb-postgres-ai/1.3/ai-factory/gen-ai/how-to/)
-   Deploy your first Gen AI assistant or model using [Gen AI in HM](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai.mdx) or [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/)
