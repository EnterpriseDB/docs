...
You can create a Fernet key secret using the `edbctl` CLI if you have enabled the `ai` scenario for your installation (`ai` is enabled by default if not specified explicitly). 
