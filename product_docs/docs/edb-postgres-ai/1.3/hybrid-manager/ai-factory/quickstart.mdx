...
- [Create a Knowledge Base](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-knowledge-base.mdx)
...
- [Create an Assistant](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants/create-assistant/)
...
- [Quickstart (Python)](/edb-postgres-ai/1.3/ai-factory/model/quickstart-python-using-inference-endpoint.mdx)
...
- Learn progressively: [Learning paths](/edb-postgres-ai/1.3/ai-factory/learning-paths)
