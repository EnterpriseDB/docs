...
Hub quick links: [AI Factory Hub](/edb-postgres-ai/1.3/ai-factory) — [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/)
...
-   Follow the [How-To Guide: Setup GPU resources in HCP](/edb-postgres-ai/latest/hybrid-manager/ai-factory/learn/how-to/setup-gpu/).
