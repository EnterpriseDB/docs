...
-   OpenAI-compatible APIs enabling standard client libraries (see [OpenAI API compatibility](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/openai-api-compatibility/))
