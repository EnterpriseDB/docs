...
TODO: Confirm the list of default models and private registry locations for your environment.
...
TODO: Document the HM UI/API steps used in your organization to repoint default models.
...
TODO: Confirm where cached profiles should live in your environment and how HM automates distribution.
...
Before proceeding with AI Factory deployment:

- [ ] Kubernetes cluster meets version requirements
- [ ] GPU nodes configured with appropriate labels and taints
- [ ] Registry authentication configured (NGC or private)
- [ ] Model images available in accessible registry
- [ ] Profile cache prepared for air-gapped deployments
- [ ] Network policies support required communication patterns
- [ ] RBAC roles configured for operational teams
- [ ] Storage connectivity verified
- [ ] SSL certificates prepared for secure endpoints
...
- [Hybrid Manager Installation Guide](/edb-postgres-ai/1.3/hybrid-manager/installation)
