...
1.  [Model Library Configuration](/edb-postgres-ai/current/ai-factory/model/library/) for registry integration
1.  [Create First InferenceService](/edb-postgres-ai/current/ai-factory/model/create-inferenceservice/) to deploy initial model

For planning assistance, consult:

-   [AI Factory Architecture](gen-ai/architecture/)
