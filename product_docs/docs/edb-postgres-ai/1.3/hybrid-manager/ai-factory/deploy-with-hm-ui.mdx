...
See [Air-Gapped Configuration](prerequisites/#air-gapped-deployments) for detailed procedures.
...
3.  Process content to generate embeddings
...
See [Create Assistant Guide](gen-ai/create-assistant/) for detailed procedures.
...
For detailed diagnostics, see [Troubleshooting Guide](troubleshooting/).
