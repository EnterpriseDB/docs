...
Hub quick links: [AI Factory Hub](/edb-postgres-ai/1.3/ai-factory) — [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/) — [Gen AI (hub)](/edb-postgres-ai/1.3/ai-factory/gen-ai/)
...
-   [Deploying NVIDIA NIM Microservices in Hybrid Manager](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/deploy-nim-container/)
-   [Verify deployed models](/edb-postgres-ai/latest/hybrid-manager/ai-factory/learn/how-to/verify-models/)
-   [Model Serving Concepts Hub](/edb-postgres-ai/latest/ai-factory/learn/explained/model-serving-concepts/)
-   [Model Serving FAQ](/edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/faq/)
-   [AI Factory Concepts](/edb-postgres-ai/latest/ai-factory/learn/explained/ai-factory-concepts/)
-   [How to set up GPU resources](/edb-postgres-ai/latest/hybrid-manager/ai-factory/learn/how-to/setup-gpu/)
