...
-   **OpenAI API compatibility:** [Using models via OpenAI-compatible SQL calls](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/openai-api-compatibility/)
