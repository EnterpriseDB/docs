...
-   See: [View threads (hub)](gen-ai/view-threads/)
...
-   **Tracing.** OpenTelemetry drivers are included in Gen AI Builder for deeper tracing; see [Gen AI observability drivers (hub)](gen-ai/reference/sdk/drivers/observability-drivers/).
