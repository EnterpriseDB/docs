...
- **Tracing.** OpenTelemetry drivers are included in Gen AI Builder for deeper tracing; see [Gen AI observability drivers (hub)](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/sdk/drivers/observability/).
