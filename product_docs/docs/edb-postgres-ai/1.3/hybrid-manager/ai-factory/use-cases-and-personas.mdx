...
1. Review [Knowledge Base Concepts](/edb-postgres-ai/1.3/ai-factory/gen-ai/libraries/knowledge-bases-explained)
2. Follow [Data Source Integration](/edb-postgres-ai/1.3/ai-factory/gen-ai/data-sources)
3. Implement [Hybrid Search](/edb-postgres-ai/1.3/ai-factory/gen-ai/how-to/kb-hybrid-search)

### For Customer Service
1. Start with [Assistant Concepts](/edb-postgres-ai/1.3/ai-factory/gen-ai/assistants/assistants-explained)
...
2. Access endpoints following [Python Client Guide](/edb-postgres-ai/1.3/ai-factory/model/quickstart-python-client)
...
- [AI Factory Architecture](/edb-postgres-ai/1.3/ai-factory/architecture)
...
- [Analytics Personas](/edb-postgres-ai/1.3/analytics/personas)
