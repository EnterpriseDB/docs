...
2.  Configure retrievers using [Retriever Creation Guide](gen-ai/create-retriever/)
3.  Deploy assistants through [Assistant Configuration](gen-ai/create-assistant/)
...
2.  Implement conversation tracking using [Thread Management](gen-ai/threads/)
3.  Create custom tools following [Tool Development Guide](gen-ai/tools/)
...
2.  Follow [Data Source Integration](gen-ai/data-sources/)
3.  Implement [Hybrid Search](gen-ai/hybrid-kb-best-practices/)

### For Customer Service

1.  Start with [Assistant Concepts](gen-ai/assistants/)
2.  Configure [Rulesets](gen-ai/rulesets/) for behavior control
3.  Deploy using [Quickstart UI](gen-ai/quickstart-customer-service-agent-ui/)
