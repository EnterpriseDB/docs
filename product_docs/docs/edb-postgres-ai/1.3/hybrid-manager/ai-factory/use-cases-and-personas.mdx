...
See [Knowledge Base Creation](gen-ai/create-knowledge-base/) for implementation guidance.
...
See [Customer Service Agent Quickstart](gen-ai/quickstart-customer-service-agent-ui/) for a working example.
...
1.  Build knowledge bases following [Knowledge Base Management](gen-ai/manage-knowledge-base/)
1.  Configure retrievers using [Retriever Creation Guide](gen-ai/create-retriever/)
1.  Deploy assistants through [Assistant Configuration](gen-ai/create-assistant/)
...
1.  Implement conversation tracking using [Thread Management](gen-ai/threads/)
1.  Create custom tools following [Tool Development Guide](gen-ai/tools/)
...
1.  Connect data sources through configuration wizards
1.  Test interactions and refine behaviors iteratively
...
1.  Review [Knowledge Base Concepts](gen-ai/knowledge-bases/)
1.  Follow [Data Source Integration](gen-ai/data-sources/)
1.  Implement [Hybrid Search](gen-ai/hybrid-kb-best-practices/)

### For Customer Service

1.  Start with [Assistant Concepts](gen-ai/assistants/)
1.  Configure [Rulesets](gen-ai/rulesets/) for behavior control
1.  Deploy using [Quickstart UI](gen-ai/quickstart-customer-service-agent-ui/)

### For API Development

1.  Deploy models via [InferenceService Creation](/edb-postgres-ai/current/ai-factory/model/create-inferenceservice/)
1.  Access endpoints following [Python Client Guide](/edb-postgres-ai/current/ai-factory/model/quickstart-python-using-inference-endpoint/)
1.  Implement monitoring per [Observability Documentation](/edb-postgres-ai/current/ai-factory/model/monitor-inferenceservice/)

## Additional Resources

**Architecture References**

-   [Gen AI Architecture](gen-ai/architecture/)
