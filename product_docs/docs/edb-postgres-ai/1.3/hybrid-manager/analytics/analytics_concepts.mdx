...
This page introduces key concepts as they are applied in Hybrid Manager — with links to detailed explanations in the [Analytics Hub](/pgaa/1.3/) for background.
...
For a general introduction, see [What is a Postgres Lakehouse](/pgaa/1.3/lakehouse).
...
Learn more: [EDB Postgres Lakehouse: An Overview](/pgaa/1.3/lakehouse)
...
Conceptual overview: [Apache Iceberg® with EDB Solutions](/pgaa/1.3/iceberg)
...
Conceptual overview: [Understanding Delta Lake with EDB Solutions](/pgaa/1.3/delta_lake)
...
Conceptual overview: [Understanding Tiered Tables with EDB Postgres](/pgaa/1.3/tiered_tables)
