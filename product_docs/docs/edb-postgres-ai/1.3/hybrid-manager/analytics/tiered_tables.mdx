...
For a conceptual overview of Tiered Tables, see [Understanding Tiered Tables with EDB Postgres](/pgaa/1.3/tiered_tables).
...
For definitions of analytics terms used in Hybrid Manager—such as PGFS, PGAA, Analytics Offload, and Lakehouse—see [Analytics concepts (hub)](/pgaa/1.3/analytics-concepts).
...
2. Learn [Tiered Tables concepts](/pgaa/1.3/tiered_tables) and apply policies (AutoPartition, offload period) in PGD.
...
- [Tiered Tables concepts](/pgaa/1.3/tiered_tables)
