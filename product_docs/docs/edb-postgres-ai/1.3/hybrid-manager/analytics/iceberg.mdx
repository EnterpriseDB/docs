...
For a general overview of Iceberg, see [Apache Iceberg® with EDB Solutions](/pgaa/1.3/).
...
For definitions of analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse, Catalog, AutoPartition, and Analytics Offload—see [Analytics concepts (hub)](/pgaa/1.3/).
...
Related: [Analytics concepts (hub)](/pgaa/1.3/)
...
2. [Configure an Iceberg catalog connection](/pgaa/1.3/) (HM-managed or external).
3. Learn [Tiered Tables concepts](/pgaa/1.3/) if integrating with PGD.
4. [Read Iceberg/Delta with or without a catalog](/pgaa/1.3/).
