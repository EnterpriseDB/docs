...
For a general overview of Iceberg, see [Apache Iceberg® with EDB Solutions](/pgaa/1.3/iceberg).
...
For definitions of analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse, Catalog, AutoPartition, and Analytics Offload—see [Analytics concepts (hub)](/pgaa/1.3/analytics-concepts).
...
How-To: [Read Iceberg/Delta with or without a catalog](/pgaa/1.3/how-to-lakehouse-read-with-without-catalog)
...
How-To: [Configure an Iceberg catalog connection](/pgaa/1.3/how-to-iceberg-reads-writes-with-catalog)
...
Learn concepts for [Tiered Tables](/pgaa/1.3/tiered_tables)
...
Related: [Analytics concepts (hub)](/pgaa/1.3/analytics-concepts)

## Getting started with Iceberg in Hybrid Manager

To begin using Iceberg with Hybrid Manager:

1. [Provision a Lakehouse cluster](/pgaa/1.3/create-lakehouse-cluster.mdx).
2. [Configure an Iceberg catalog connection](/pgaa/1.3/how-to-iceberg-reads-writes-with-catalog) (HM-managed or external).
3. Learn [Tiered Tables concepts](/pgaa/1.3/tiered_tables) if integrating with PGD.
4. [Read Iceberg/Delta with or without a catalog](/pgaa/1.3/how-to-lakehouse-read-with-without-catalog).
5. Use standard Postgres clients to run analytical queries.

## Related How-Tos

- [Configure an Iceberg catalog connection](/pgaa/1.3/how-to-iceberg-reads-writes-with-catalog)
- [Read Iceberg/Delta with or without a catalog](/pgaa/1.3/how-to-lakehouse-read-with-without-catalog)
