...
Hub quick links: For the complete PGAA documentation, see the Analytics Hub: /edb-postgres-ai/1.3/analytics/ — Concepts: /edb-postgres-ai/1.3/analytics/analytics-concepts — How-Tos: /edb-postgres-ai/1.3/analytics#how-tos-runbook-aligned
...
For foundational concepts about EDB Postgres Lakehouse architecture, see [EDB Postgres Lakehouse: An Overview](/edb-postgres-ai/1.3/analytics/lakehouse).
...
For definitions of core analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse Cluster, and Analytics Offload—see [Analytics concepts (hub)](/edb-postgres-ai/1.3/analytics/analytics-concepts).
...
How-To: [Create a Lakehouse cluster](/edb-postgres-ai/1.3/analytics/create-lakehouse-cluster.mdx)
...
3. (Optional) [Configure an Iceberg catalog connection](/edb-postgres-ai/1.3/analytics/how-to-iceberg-reads-writes-with-catalog).
4. Learn [Tiered Tables concepts](/edb-postgres-ai/1.3/analytics/tiered_tables) if integrating with PGD.
