...
You must prepare the following for the `values.yaml` for Phase 3:
...
Proceed to **[Phase 3: Preparing the Environment](environment_prep)** to create your secrets and build the final configuration file.