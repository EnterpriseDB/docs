...
**Next Step:** [Deploying your Kubernetes cluster](./k8s_install)
...
> **Next Step:** You now have a complete inventory and deployment strategy, as well as some inputs to your HM Helm chart `values.yaml` used now if you are building your file as you go, or used to build the file at the end of [Preparing your environment](environment_prep) (Phase 4) 
