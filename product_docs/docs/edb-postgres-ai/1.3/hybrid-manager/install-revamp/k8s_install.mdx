...
Provision and configure your management workstation (Bastion or other) as planned in [Gathering your System requirements](./sys_reqs) the previous phase.
...
1. Confirm that your [management workstation](#set-up-your-management-workstation) can reach all relavent endpoints for configuration in the next phase: [Preparing your environment](./environment_prep).

1. Confirm that your deployed cluster matches the relevant specifications you defined in [Phase 2: Gathering your system Requirements](../requirements):

### Compute resources

**Source:** [System Requirements > Compute Sizing](./sys_reqs/#compute-node-requirements)

* **Node count:** Ensure your node pools match the High Availability profile (example: Production vs. Non-Production) you selected in Phase 2: [Gathering your system requirements](./sys_reqs).
...
**Source:** [System Requirements > Storage](./sys_reqs/#storage-requirements)

* **Storage class:** Ensure the cluster has the [**Storage Class** default](./sys_reqs/#storage-requirements) you identified in Phase 2 for the Control Plane (e.g., `gp2`).
...
Next you sync images to your local registry, stage your secrets, configure TLS, set up any relevant advanced features, and apply the HM configuration file: `values.yaml`.
