...
> **Outcome:** An Architectural Decision Record (ADR) defining the topology, locality, and redundancy model. (at minimum: architecture diagrams with notes)
...
Your architecture is defined and ideally recorded in an ADR.
