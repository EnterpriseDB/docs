...
> **Outcome:** An Architectural Decision Record (ADR) defining the topology, locality, and redundancy model.
> **Next Step:** [System Requirements](sys_reqs)
...
> **Recommendation:** Acquiring and reviewing diagrams of your current and target environment is the most efficient way to complete this phase.

---

### 1. Locality: Where will HM live?
...
### 3. Activeness (Active/Passive vs. Active/Active)
...
### A. HM distributed reference architecture
...
### B. Minimum Control Plane

The minimum install colocates the HM control plane on the Kubernetes control nodes. 
...
The EDB Hybrid Manager is composed of several core microservices running within the Kubernetes cluster. Understanding these components is helpful for planning resource allocation and security boundaries.
...
* **Local Network:** The fabric connecting the Control Plane to Data Plane. Latency here drives your Locality decisions.
...
### C. HM Data Plane (Postgres lifecycle orchestration)

Sitting alongside the HM Control Plane is the Data Plane. This is where your actual database workloads reside.
...
### E. Multi-Location (Hub and spoke)
...
## Mapping architecture to configuration
...
Here is how your decisions map to the final configuration file structure:
...
> Next step: With your architecture defined, proceed to System requirements to verify your infrastructure can match this design.