...
> **Outcome:** An Architectural Decision Record (ADR) defining the topology, locality, and redundancy model. (Architecture diagrams with notes)
...
> Next step: With your architecture defined, proceed to [Gathering system requirements] (Phase 2) to verify that your infrastructure can match this design.