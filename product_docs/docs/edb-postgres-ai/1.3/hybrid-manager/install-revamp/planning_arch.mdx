...
navTitle: Architecture planning
...
Your architecture is defined.

**Proceed to [Gathering system requirements] (Phase 2) to verify that your infrastructure can match your designs. →**