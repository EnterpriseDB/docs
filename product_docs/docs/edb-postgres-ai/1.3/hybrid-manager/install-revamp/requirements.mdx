...
### Enterprise considerations: prerequisites assumptions

Hybrid Manager (HM) requires a **dedicated Kubernetes cluster**:
...
* **Customer Ownership:** The customer is solely responsible for all **cluster lifecycle management** (upgrades, scaling, maintenance, etc.) following standard Kubernetes best practices.
