...
1.  **TLS & encryption:** 
    ...
    Implementing your chosen TLS strategy (Cert-Manager, Custom CA, Custom cert, vs self-signed) and enabling **KMS** for Transparent Data Encryption (TDE).
...
1.  **Advanced feature Prep:** 
    ...
    Defining **Multi-location** logic (SPIRE federation and object storage sync), constructing complex YAML configurations for **Identity Providers**, creating namespaces and secrets for **GenAI** (including CORS policies), and configuring secrets for **Catalogs**.
...
* [**SOP: Configuring IdPs**](idp_configuration.md)
