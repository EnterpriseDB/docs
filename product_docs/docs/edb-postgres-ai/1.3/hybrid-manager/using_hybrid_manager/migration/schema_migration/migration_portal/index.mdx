---
title: Using the Migration Portal to assess, convert and migrate Oracle schemas
navTitle: Migrating Oracle schemas
description: Learn about using the Migration Portal for schema migrations with Hybrid Manager.
navigation:
  - access_mp
  - hm_schema_migration
...
- The Migration Portal built into the Hybrid Manager is accessed directly within the product. 
  - Use [project-scoped access](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/hm_schema_migration/) to migrate schemas loaded by the Agent.
