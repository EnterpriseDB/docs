...
!!!note 
    Starting from HM version 1.3 and later, the [EDB Data Migration Service Agent](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/installing_agent/), packaged as `cdcagent`, replaces legacy DMS Reader and DMS Writer. 
