...
Starting from HM version 1.3 and later, the [EDB Data Migration Service Agent](getting_started/installing), packaged as `cdcagent`, replaces legacy DMS Reader and DMS Writer. 
