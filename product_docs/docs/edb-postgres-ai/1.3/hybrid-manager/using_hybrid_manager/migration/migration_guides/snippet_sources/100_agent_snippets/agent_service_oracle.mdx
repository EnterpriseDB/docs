...
For continuous metric streaming and to ensure your database remains visible in your **HM console** > estate, configure the agent to run as a service. Running as a service allows it to start on system startup and restart after any errors.
