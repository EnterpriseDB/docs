...
This is the user you will provide to the EDB DMS Writer [during configuration](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/writer_reference/) via the `DBCONFIG_DATABASES_0__USERNAME` and `DBCONFIG_DATABASES_0__PASSWORD` values.
