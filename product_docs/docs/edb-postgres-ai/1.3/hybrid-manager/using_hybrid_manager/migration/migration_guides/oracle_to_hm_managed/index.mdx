...
1.  [Configure the DMS Agent in reader mode for a data migration](configuring_reader). This agent handles data migration, not to be confused with the HM Agent previously used to assess and prepare your Oracle database for migration.
