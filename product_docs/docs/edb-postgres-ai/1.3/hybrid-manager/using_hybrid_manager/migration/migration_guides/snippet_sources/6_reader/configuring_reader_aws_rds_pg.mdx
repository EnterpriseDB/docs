...
2.  [Install the EDB DMS Reader](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/installing/).
...
Set the variables according to your environment and uncomment the edited lines. See [parameters](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/reader_reference/) for further guidance. The script is reproduced below.
