...
1.  Set the variables according to your environment and uncomment the edited lines. See [parameters](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/writer_reference/) for further guidance. The script is reproduced below.
