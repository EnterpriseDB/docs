...
2.  [Install the EDB DMS Writer](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/installing2/).

3.  Open the EDB DMS Writer located in `/opt/cdcwriter/run-cdcwriter.sh` and ensure you have write permissions.
