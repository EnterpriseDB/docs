...
Now that you have configured the source database, validate your Oracle configuration. For this, you need the configuration validation script packaged with the DMS Agent.
...
1.  Run the script with the necessary parameters. In this example:
    ...
    *** [Transporter] - Validate system user connectivity
    ...
    [Suggestion] Redo log size less than the requirements. Current: 0.10G, Suggested: 8G
    [Suggestion] Redo log with wrong status. Current: INACTIVE
