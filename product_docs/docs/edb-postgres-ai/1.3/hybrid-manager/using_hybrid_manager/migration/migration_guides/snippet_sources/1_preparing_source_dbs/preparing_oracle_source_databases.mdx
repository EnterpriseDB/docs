 ...
 *** [Transporter] - Validate if database supplemental logging is enable
[Pass] Supplemental logging check for database is passed.

 *** [Transporter] - Validate if table supplemental logging is enable
...
[Pass] This user has all sys privileges that migration need.
[Pass] This user has all role privileges that migration need.
[Pass] This user has all select privilege on specific tables that migration need.
[Pass] This user has all execute privilege on specific tables that migration need.
