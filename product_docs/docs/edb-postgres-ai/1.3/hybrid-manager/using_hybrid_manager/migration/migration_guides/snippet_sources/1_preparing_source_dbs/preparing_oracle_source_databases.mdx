...
!!! Note
    ...
    - For Oracle XE compatibility restrictions, see [limitations](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/limitations/#oracle-xe-compatibility-restrictions).


    - For Oracle XE compatibility restrictions, see [limitations](../../../limitations.mdx/#oracle-xe-compatibility-restrictions).
