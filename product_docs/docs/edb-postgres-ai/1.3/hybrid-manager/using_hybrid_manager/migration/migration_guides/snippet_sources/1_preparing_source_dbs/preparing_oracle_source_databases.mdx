...
!!!note 
If you previously created a dedicated Oracle user for schema extraction and assessment with the EDB Postgres AI agent, you can reuse the same user here. In that case, ensure it's configured in the same way and has the following permissions.
!!!
