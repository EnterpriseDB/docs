---
title: Preparing your Oracle database for the EDB Postgres AI agent
navTitle: Preparing Oracle database for EDB Postgres AI agent
description: Learn how to prepare your Oracle database for Hybrid Manager (HM) agent registration with HM.
---

Registering an Oracle database with the EDB Postgres AI agent provides migration assessment and schema extraction capabilities.
