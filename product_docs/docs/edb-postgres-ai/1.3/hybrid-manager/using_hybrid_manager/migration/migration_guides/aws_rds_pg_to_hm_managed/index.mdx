...
These are all the steps you need to perform a migration from an AWS RDS for PostgreSQL or Aurora PostgreSQL database to a database managed by Hybrid Manager (HM) managed.

## Prepare your source database

Prepare your source database for data migration involves creating a dedicated user for the migration and altering the database configuration to enable the replication features.
