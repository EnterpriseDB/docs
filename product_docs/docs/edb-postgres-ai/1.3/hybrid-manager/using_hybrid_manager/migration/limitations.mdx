...
!!!tip
Resolved in an [Innovation Release](/edb-postgres-ai/innovation-release/hybrid-manager/using_hybrid_manager/migration/limitations).
!!!
...
!!!tip
Partially resolved in an [Innovation Release](/edb-postgres-ai/innovation-release/hybrid-manager/using_hybrid_manager/migration/limitations).
!!!

[ET-4363, additional ticket for pending domain types will be provided]: #
...
-   DATE - Resolved in an Innovation Release.
-   TIME - Resolved in an Innovation Release.
-   TIMESTAMP - Resolved in an Innovation Release.
-   INTERVAL - Resolved in an Innovation Release.
-   UUID - Resolved in an Innovation Release.
-   ENUM
-   JSON - Resolved in an Innovation Release.
-   XML - Resolved in an Innovation Release.
-   POINT - Resolved in an Innovation Release.
-   LTREE
-   TSVECTOR
