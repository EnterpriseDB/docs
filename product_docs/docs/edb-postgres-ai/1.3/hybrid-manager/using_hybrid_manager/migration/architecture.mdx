...
![Migrations from Oracle databases](/edb-postgres-ai/1.3/hybrid-manager/images/hm_migrations_oracle_dmsagent.svg)
...
![Migrations from Postgres databases](/edb-postgres-ai/1.3/hybrid-manager/images/hm_migrations_pg_dmsagent.svg)
