...
The Hybrid Manager platform provides a broader set of APIs to support end-to-end database migration—including assessment, schema conversion, and data migration—even though only a subset is illustrated in the current [Examples](#examples) section.
