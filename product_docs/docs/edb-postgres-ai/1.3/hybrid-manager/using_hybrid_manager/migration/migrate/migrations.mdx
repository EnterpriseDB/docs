...
To create migrations, select **Create Migration**. See [Creating migration](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migration_guides/self_managed_pg_to_hm_managed/creating_migration/) for an example.
...
1.  In the HM console, select **Migrate > Migrations > Create Migration**. See [Creating migration](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migration_guides/self_managed_pg_to_hm_managed/creating_migration/) for more details.
