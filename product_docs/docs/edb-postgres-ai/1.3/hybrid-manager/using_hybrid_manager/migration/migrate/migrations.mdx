...
1.  Start a migration from **Migrate** > **Migrations** > **Create Migration** in the HM Console. See [Creating migration](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migration_guides/self_managed_pg_to_hm_managed/creating_migration/) for more details.
