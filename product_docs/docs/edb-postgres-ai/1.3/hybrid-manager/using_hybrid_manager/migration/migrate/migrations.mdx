...
**Overview** tab: The **Overview** tab contains additional information on the status of the migration, type of migration, source and destination database information, and error logs that can help you to troubleshoot.

**Tables**: The **Tables** tab displays a list of all tables migrated tables, including source and destination table names, schemas, migration status and number of columns.
