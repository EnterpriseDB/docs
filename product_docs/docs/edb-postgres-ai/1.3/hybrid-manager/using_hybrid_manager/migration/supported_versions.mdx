...
Both Reader and Writer run on Linux. For details, see [Installing EDB DMS Reader](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/migration/installing/) or [Installing EDB DMS Writer](/edb-postgres-ai/1.2/hybrid-manager/using_hybrid_manager/migration/installing2/).
