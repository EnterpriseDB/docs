...
-   **Dependencies:** Available for Oracle databases only. The name of the schema that the current schema depends on.
...
**Migrate Schema(s):** 
    ...
    - for Postgres databases, this option provides information on how to use external tooling like Migration Toolkit or pg_dump amont other tools to migrate Postgres schemas.
