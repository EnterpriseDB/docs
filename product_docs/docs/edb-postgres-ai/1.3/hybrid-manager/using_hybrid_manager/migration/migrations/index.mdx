...
**Engine:** Database server distribution. This column applies to Postgres databases only and indicates the distribution type, such as PostgreSQL, EDB Postgres Advanced Server, or EDB Postgres Extended Server.

**Complexity:** Level of complexity to migrate the database to the Hybrid Manager. This value is generated only for Oracle schemas. Possible values are Very Easy, Easy, Medium, Hard, and Very Hard.
