...
-   [**Migrations**](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migrations/)
-   [**Lakehouses**](lakehouse.mdx)
-   [**Catalogs**](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/configure-iceberg-catalog/)
-   **Model clusters**
...
-   View an [assessment of the databases](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migrations/#migrations-table) that you have connected to the Hybrid Manager to prepare them for migrations.

-   Select a specific database and view [an assessment of its schemas](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migrations/migration_database_details_view/#schemas).

-   Select a specific database and [perform a schema migration with Migration Portal integration](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/hm_schema_migration/#creating-a-migration-portal-project).

-   Create a destination cluster for a migration and perform a database migration.

In the **Lakehouse** tab of the estate, you can:

-   Monitor your [analytics clusters](/edb-postgres-ai/latest/hybrid-manager/analytics/#lakehouse-clusters), which are Hybrid Manager clusters specialized for analytics workloads.

In the **Catalog** tab of the estate, you can:

-   View all [Apache Iceberg](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/configure-iceberg-catalog/) tables attached to or created with the Hybrid Manager.
...
* [Grafana](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/monitoring/monitoring_grafana)
* Prometheus
* Thanos - Query
