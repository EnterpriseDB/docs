...
-   View an [assessment of the databases](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migrations/#migrations-table) that you connected to HM to prepare them for migrations.
...
-   Monitor your [analytics clusters](/edb-postgres-ai/latest/hybrid-manager/analytics/#lakehouse-clusters), which are HM clusters specialized for analytics workloads.

In the **Catalog** tab of the estate, you can:

-   View all [Apache Iceberg®](/edb-postgres-ai/latest/hybrid-manager/analytics/iceberg/) tables attached to or created with HM.
