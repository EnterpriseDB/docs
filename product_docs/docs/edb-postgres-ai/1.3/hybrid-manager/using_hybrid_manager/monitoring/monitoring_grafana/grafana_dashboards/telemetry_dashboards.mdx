...
**Description:** Provides metrics about the FluentBit instance, which is used to collect logs from the nodes, and ship them to Loki, which in turn informs Hybrid Manager.
