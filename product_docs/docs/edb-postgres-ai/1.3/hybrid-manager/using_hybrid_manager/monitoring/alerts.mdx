...
-   Column selector dropdown to select the columns to display in the table according to your preferences
...
!!!note
   ...
   -   All the alerts aren't available for external HM clusters due to the technical limitations of making them available.
