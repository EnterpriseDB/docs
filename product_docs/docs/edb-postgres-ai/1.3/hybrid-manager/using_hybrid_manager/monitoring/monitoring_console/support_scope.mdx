...
The availability of metrics you can see in the HM console depends on the metric and cluster type. This page provides an overview of the support scope and tells you where to find each grouping of metrics in the HM console. 
