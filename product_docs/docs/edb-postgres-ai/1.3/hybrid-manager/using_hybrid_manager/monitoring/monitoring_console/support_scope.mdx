...
!!!note Limitations
-   Self-managed multi-node instances aren't currently displayed as groups. Each data node instance and its metrics are displayed separately.
    Clustered views for multi-node instances will be added in a future release.

-   Currently, HM supports monitoring for EDB CloudNativePG clusters. Monitoring for open-source CloudNativePG clusters will be supported in a future release.
!!!
