...
For continuous metric streaming and to ensure your database remains visible in your Hybrid Manager (HM) estate, configure the agent to run as a service. This allows it to start automatically on system startup and restart after any errors.
