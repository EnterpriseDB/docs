...
-   [Use the agent to assess your Oracle database for migration](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migration_guides/oracle_to_hm_managed) ► Use the EDB Postgres AI agent to asses Oracle databases and extract schema for conversion with the Migration Portal. 
