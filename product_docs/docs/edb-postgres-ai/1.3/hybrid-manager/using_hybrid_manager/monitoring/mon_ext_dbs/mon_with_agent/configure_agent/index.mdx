...
| `agent.beacon_dispatcher_server`     | `<beacon_server>:9443` | The same as `agent.beacon_server`.                                                                                                                                                                                                                                                                                              |
| `general.metrics.push.push_endpoint` | `<beacon_server>:9443` | The same as `agent.beacon_server`.                                                                                                                                                                                                                                                                                              |
