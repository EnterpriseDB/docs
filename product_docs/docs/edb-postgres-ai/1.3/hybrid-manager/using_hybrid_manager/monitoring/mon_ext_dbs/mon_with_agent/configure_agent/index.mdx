...
-   Create a machine user and access key with the estate ingester role assigned to it. See [Creating a machine user](../create_machine_user.mdx).
-   Get the project ID for the project where you want to monitor the database. To get the ID, navigate to your project and fetch the ID from the URL displayed in the browser.
