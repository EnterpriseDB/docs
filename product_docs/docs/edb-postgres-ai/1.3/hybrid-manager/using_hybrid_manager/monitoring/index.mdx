...
With the Hybrid Manager (HM) you can collect a wide range of metrics (host metrics, Kubernetes metrics, postgres database data, query data, as well as logging data). You can visualize the collected data with the HM console or Grafana instance to analyze trends, configure alerting, improve the efficiency of databases, perform troubleshooting and much more.
...
![Monitoring infrastructure in the Hybrid Manager](../../images/hm_monitoring_ext.svg)
