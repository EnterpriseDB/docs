...
The Hybrid Manager (HM) features backup and recovery capabilities for its components using various technologies.
...
!!! Note
    Local storage is not supported for Snapshot backups at the moment.
...
Refer to [HA/DR](../hadr/hadr_recovery) to learn how to configure backups of the HM system.
