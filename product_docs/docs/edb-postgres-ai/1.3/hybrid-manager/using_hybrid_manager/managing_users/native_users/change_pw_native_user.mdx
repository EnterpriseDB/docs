...
1.  If you're installing Hybrid Manager (HM), continue performing the installation. If you're modifying the parameter in an already deployed installation, [apply the DEX configuration](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/managing_users/apply_dex_config/) to populate the changes.
