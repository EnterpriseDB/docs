...
- Then, select the **Data Groups** tab, find your old version “blue” data group, and select the **Duplicate** button. This brings up a new data group below the ones(s) you already have. 
...
Confirm the deletion, repeat the removal process for any other old version data groups you have or the Witness data group is no longer necessary, and the upgrade is complete.
