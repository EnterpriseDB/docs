...
1. (Optional) Discover the Secondary portal FQDN
    ...
    If you’ll also federate telemetry, capture the Secondary portal host as SECONDARY_PORTAL_URL.
...
You create the inital secret when setting up object storage during installation for the Primary.
