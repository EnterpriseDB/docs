...
-   [edbctl cluster switchover-primary](edbctl_cluster.mdx#edbctl-cluster-switchover-primary) — switchover a specified replica to primary.
...
```yaml
This example shows how to create single node cluster using sample YAML files:
