...
- [ ] **Networking & access:**
  ...
  - [ ] Ingress Controller (Load Balancer with external IP capacity or NodePort implemented)
...
These services should be available in your environment **before** deployment. 
