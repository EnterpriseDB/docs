...
If you have a [Sovereign System](/edb-postgres-ai/latest/hybrid-manager/system/), the EDB CX team executes the HM install. **Professional Services** and **Sales Engineering** can also be engaged for assistance, and **Support** has knowledge base articles available.
!!!
