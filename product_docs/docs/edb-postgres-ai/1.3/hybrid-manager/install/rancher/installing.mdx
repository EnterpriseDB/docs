...
If using your own IDP, you should have already set your `pgai:portal:authentication:staticPasswords` values during [preconfiguration](/product_docs/edb-postgres-ai/1.3/hybrid-manager/install/rancher/prerequisites/rke2cluster/#idp-setup).
If you did not, do so now.
