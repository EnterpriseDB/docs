...
- **Persistent storage driver (required):**  
  ...
  - **Cloud deployments (alternative):** Use the CSI driver provided by your CSP (e.g., AWS EBS, GCE PD, Azure Disk).  
...
```yaml
global:
  storage_class: <hm-cp-storage-class>      # for HM internal services
```
