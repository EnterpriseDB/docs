...
You can now use this key if you want to enable encryption when you create clusters. The added key will appear as an option when you [enable TDE during cluster creation](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/cluster_management/create-clusters/additional-settings/#security).
