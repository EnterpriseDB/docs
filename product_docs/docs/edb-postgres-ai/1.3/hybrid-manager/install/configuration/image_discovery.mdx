...
The EDB Postgres AI agent requires specific permissions to scan your registry. 
...
After applying these changes via `helm upgrade`, check the logs of the **EDB Postgres AI agent** pod. 
