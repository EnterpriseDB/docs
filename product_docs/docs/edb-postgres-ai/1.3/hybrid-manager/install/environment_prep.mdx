...
-  GenAI Builder secrets - Fernet key secret and NGC key secrets allows you to build AI agents.
-  Catalog secret - Is required to create encrypted storage credentials and manage Lakehouse data.
