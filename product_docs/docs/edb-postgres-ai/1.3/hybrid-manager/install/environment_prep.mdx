...
* *A Kubernetes cluster configured with necessary secrets (TLS, Auth, Storage)*

* *Synchronized container images*

* *Any chosen advanced features configured*
...
*  **Managing artifacts:** 
    ...
    * [Syncing container images to your local private registry](#sync-images-to-local-registry) 
    * [Configuring the agent for image discovery](#configure-image-discovery) if necessary.
...
*  **Enabling applications:** 
    ...
    * [Enabling **GenAI Builder**](#enabling-genai-builder) (requires Fernet secret)
    * [Enabling data catalogs](#enabling-catalogs) (requires Fernet secret)
...
**[Proceed to Phase 4: Installing Hybrid Manager →]**