...
* **Sizing:** Current recommendations require **Nvidia B200 GPUs** (or equivalent supported hardware). Required for default installations or when the `ai` installation module is enabled.
