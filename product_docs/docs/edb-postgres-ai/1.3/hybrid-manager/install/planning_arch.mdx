...
Use reference architectures A-D below as reference models to decide which topology matches your "[Target state](/edb-postgres-ai/current/hybrid-manager/install/planning_arch/#architectural-discovery)."
...
1.  The primary HM controls the Secondary.
1.  Connectivity is established using load-balanced endpoints—not a network mesh service, like Submariner for example.
