...
The architecture diagrams above reference several external components. While you verify the specific hardware/software requirements for these in **[Phase 2: Gathering your system requirements](./requirements)**, you must account for their connectivity in your architectural design.
...
**Proceed to [Phase 2: Gathering system requirements](./sys_reqs) to verify that your infrastructure can match your designs in your ADR. →**