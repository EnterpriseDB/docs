...
The architecture diagrams above reference several external components. While you will verify the specific hardware/software requirements for these in **[Phase 2: Gathering your system requirements](./requirements)**, you must account for their connectivity in your architectural design.
