...
**Description:** In the current iteration, project boundaries aren’t strictly applied and authorized users on one project may have visibility of the data and databases of other projects. This is why granular project access will be implemented in a future release.

**Workaround:** Currently, users can create dedicated object storage for new projects and project isolation in the Hybrid Manager Innovation Release.

**Workaround details:** Learn more about how to create [dedicated object storage](https://docs:rapeinvi@deploy-preview-472--edb-docs-editorial.netlify.app/docs/edb-postgres-ai/preview/hybrid-manager/using_hybrid_manager/projects/projected-object-storage/) for project isolation in the Hybrid Manager Innovation Release.
