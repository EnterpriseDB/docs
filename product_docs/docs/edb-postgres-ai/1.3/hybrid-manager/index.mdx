...
| **AI integration**                 | Run [sovereign GenAI pipelines](/edb-postgres-ai/hybrid-manager/ai-factory/), serve models with KServe, and build AI knowledge bases governed by your infrastructure.                                                                                                               |
| **Analytics**                      | Offload cold data to [Delta Lake or Iceberg](/edb-postgres-ai/hybrid-manager/analytics/), query with Postgres syntax, and enable hybrid transactional/analytical processing.                                                                                                        |
