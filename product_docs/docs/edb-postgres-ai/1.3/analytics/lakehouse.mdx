...
How-To guides
- [Create a Lakehouse cluster](/edb-postgres-ai/analytics/learn/how-to/create-lakehouse-cluster)
- [Query existing Apache Iceberg tables](/edb-postgres-ai/analytics/learn/how-to/query-iceberg-existing-tables)
- [Query Delta Lake tables](/edb-postgres-ai/analytics/learn/how-to/query-delta-lake-tables)
