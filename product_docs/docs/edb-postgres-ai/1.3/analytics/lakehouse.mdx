...
For implementation and management in Hybrid Manager (HM), see [Lakehouse clusters in EDB Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/lakehouse/).
...
Related concept: [Data lakehouse](learn/explained/generic-concepts#data-lakehouse)
...
Related concept: [Analytics Accelerator concepts](learn/explained/analytics-concepts#edb-postgres-lakehouse)
...
-   [Vectorized query engines](learn/explained/generic-concepts#vectorized-query-engines)
...
-   [Lakehouse clusters in EDB Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/lakehouse/)

How-To guides

-   [Create a Lakehouse cluster](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/create-lakehouse-cluster/)
-   [Query existing Apache Iceberg tables](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/query-iceberg-existing-tables/)
-   [Query Delta Lake tables](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/query-delta-lake-tables/)

Explore more in the [Analytics Accelerator learning guide](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/).
