...
This page is part of the Analytics Hub. For full navigation, visit: /edb-postgres-ai/1.3/analytics/ — Quick jumps: Concepts: /edb-postgres-ai/1.3/analytics/analytics-concepts — How-Tos: /edb-postgres-ai/1.3/analytics#how-tos-runbook-aligned

It builds on established industry patterns and technologies. If you're new to the space, start with:

-   [Analytics Terminology](/edb-postgres-ai/1.3/analytics/terminology) — learn the key terms used
-   [Generic Concepts](/edb-postgres-ai/1.3/analytics/generic-concepts) — understand common architectures and patterns
...
Related concept: [Data lakehouse](/edb-postgres-ai/1.3/analytics/generic-concepts#data-lakehouse)
...
-   [Columnar storage formats](/edb-postgres-ai/1.3/analytics/generic-concepts#columnar-storage-formats)
-   [Vectorized query engines](/edb-postgres-ai/1.3/analytics/generic-concepts#vectorized-query-engines)
-   [Separation of storage and compute](/edb-postgres-ai/1.3/analytics/generic-concepts#separation-of-storage-and-compute)
-   [Open table formats](/edb-postgres-ai/1.3/analytics/generic-concepts#open-table-formats)
...
Related concept: [Vectorized query engines](/edb-postgres-ai/1.3/analytics/generic-concepts#vectorized-query-engines)
...
-   [Data tiering](/edb-postgres-ai/1.3/analytics/generic-concepts#data-tiering)
-   [ETL / ELT](/edb-postgres-ai/1.3/analytics/generic-concepts#etl--elt)
...
Related concept: [OLAP / OLTP](/edb-postgres-ai/1.3/analytics/generic-concepts#olap--oltp)
...
-   [Semantic search](/edb-postgres-ai/1.3/analytics/generic-concepts#semantic-search)
-   [Vector embeddings](/edb-postgres-ai/1.3/analytics/generic-concepts#vector-embeddings)
-   [Retrieval augmented generation (RAG)](/edb-postgres-ai/1.3/analytics/generic-concepts#retrieval-augmented-generation-rag)
...
-   [Analytics Terminology](/edb-postgres-ai/1.3/analytics/terminology)
-   [Analytics Accelerator Generic Concepts](/edb-postgres-ai/1.3/analytics/generic-concepts)
-   [Analytics How-To Guides](/edb-postgres-ai/1.3/analytics#how-tos-runbook-aligned)
