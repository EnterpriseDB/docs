...
For details on how Delta Lake is used and managed within Hybrid Manager (HM), see [Working with Delta Lake in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/delta_lake/).
...
-   [Working with Delta Lake in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/delta_lake/)

**How-To guides**

-   [Query Delta Lake tables](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/query-delta-lake-tables/)
-   [Configure PGFS for Delta Lake](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/configure-delta-pgfs/)
-   [Performance tuning for Delta Lake queries](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/performance-delta-lake-queries/)
