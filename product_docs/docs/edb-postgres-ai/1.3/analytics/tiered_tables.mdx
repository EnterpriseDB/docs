...
How-To guides
[Configure PGFS storage for Tiered Tables](/edb-postgres-ai/analytics/learn/how-to/configure-tiered-pgfs)
[Configure PGD node group for analytics offload](/edb-postgres-ai/analytics/learn/how-to/configure-tiered-offload)
[Configure BDR AutoPartition with analytics offload](/edb-postgres-ai/analytics/learn/how-to/configure-tiered-autopartition)
[Query Tiered Tables from PGD and Lakehouse](/edb-postgres-ai/analytics/learn/how-to/query-tiered-tables)
