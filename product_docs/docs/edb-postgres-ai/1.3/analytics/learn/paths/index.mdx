...
**Start here:** [Analytics Accelerator generic concepts](../explained/generic-concepts)
...
**Continue your journey:** [Analytics Accelerator concepts](../explained/analytics-concepts) + [How-To Guides](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/)
...
**Advance your expertise:** [Advanced concepts and techniques](../explained/) *(expand this section over time)*
...
-   **Role-based guidance:** See [Analytics Accelerator for your role](../personas.mdx) for resources tailored to your job function.
-   **Solution-oriented examples:** Visit [Analytics Accelerator use cases and architectures](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/use-cases/) for real-world examples.

* * *

## Next steps

-   Build your foundation with [Analytics Accelerator generic concepts](../explained/generic-concepts)
-   Learn EDB’s approach in [Analytics Accelerator concepts](../explained/analytics-concepts)
-   Apply your knowledge with [How-To Guides](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/)
-   Explore industry applications in [Analytics Accelerator use cases](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/use-cases/)
