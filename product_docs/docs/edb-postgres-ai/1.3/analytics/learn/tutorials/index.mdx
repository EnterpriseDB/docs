...
For concise, goal-oriented instructions on specific tasks, see the [How-To guides](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/).
For tutorials specific to Hybrid Manager (HM), refer to the [HM analytics tutorials](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/).
...
**Related concepts:** [Analytics Accelerator concepts](../explained/analytics-concepts)
...
**Level:** Advanced
**Estimated time:** ~2-3 hrs
**Products used:** Postgres Lakehouse, PGAA, BI tools (Tableau, PowerBI)
...
For in-depth AI/ML concepts, see the [AI Factory concepts](/edb-postgres-ai/latest/ai-factory/learn/explained/ai-factory-concepts/).
...
**Related concepts:** [Analytics Accelerator concepts](../explained/analytics-concepts.mdx)
