...
For implementation in Hybrid Manager (HM), see [Working with Apache Iceberg in EDB HM](/edb-postgres-ai/latest/hybrid-manager/analytics/).
...
-   [How-To: Configure an Iceberg REST catalog connection in Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/analytics/learn/how-to/configure-iceberg-catalog/)
