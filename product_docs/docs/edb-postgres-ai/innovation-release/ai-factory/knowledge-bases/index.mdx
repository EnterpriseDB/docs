...
- **Returns**: A set of columns including:
  ...
  - **distance**: The similarity score (lower usually indicates a closer match).
  ...
  - **intermediate_steps**: A JSONB column containing data from steps occurring before the knowledge base (e.g., ChunkText).
