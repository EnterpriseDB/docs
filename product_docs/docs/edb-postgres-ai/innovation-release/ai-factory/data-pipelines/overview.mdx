...
- **Data source** — pipelines read from Postgres tables or from external cloud storage (S3, GCS, Azure) via [Postgres File System (PGFS)](/pg_extensions/pgfs/).
...
- [Data processing configuration](./data-processing) — how to configure table and volume data sources.
- [Pipeline steps](./pipeline-steps/pipeline-steps) — available step operations and their helper functions.
- [Orchestration](./orchestration/) — auto-processing modes, background workers, and monitoring.
