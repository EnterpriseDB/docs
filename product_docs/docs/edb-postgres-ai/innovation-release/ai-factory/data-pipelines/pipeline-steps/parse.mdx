...
- The `method` determines how the HTML is parsed:
  ...
  - `StructuredMarkdown` &mdash; Converts HTML into Markdown-like text. This retains important syntactical context (like headers and lists), which can help LLMs better understand the documents's orginal hierarchy.
