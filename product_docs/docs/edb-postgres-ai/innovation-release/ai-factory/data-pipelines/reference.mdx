...
navTitle: "Reference"
description: "Reference documentation for the EDB AI Accelerator Pipelines API — types, views, core functions, and configuration helpers."
deepToC: true
indexCards: none
---

This page covers the full public API for AI Accelerator Pipelines: the types and enums used across the API, the views for inspecting pipeline state, the core CRUD and execution functions, and the family of configuration helper functions for pipeline steps, vector indexes, and model providers.
