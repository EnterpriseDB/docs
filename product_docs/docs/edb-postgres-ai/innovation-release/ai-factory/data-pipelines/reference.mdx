...
Raises an exception if the pipeline does not exist. Returns an empty result set if the pipeline's error log table is missing (legacy pipelines created before 7.4.0 upgrade into the table automatically).
