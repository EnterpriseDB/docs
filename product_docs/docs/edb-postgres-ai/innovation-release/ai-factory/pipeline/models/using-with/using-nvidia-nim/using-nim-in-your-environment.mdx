...
SELECT aidb.create_model(
    ...
    aidb.completions_config(
        ...
        url => 'http://<ENDPOINT>:8000/v1/chat/completions'
    )
);
```
...
-   EDB AI Factory deployment examples: [Deploy NIM containers](/edb-postgres-ai/current/ai-factory/model/deploy-nim-container)
