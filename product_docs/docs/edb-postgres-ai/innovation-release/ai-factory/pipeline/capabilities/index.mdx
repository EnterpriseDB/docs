---
title: "Capabilities (deprecated)"
navTitle: "Capabilities (deprecated)"
...
Create a [model](../models) with AI Accelerator Pipelines. This model can be any AI model suitable for your tasks.
