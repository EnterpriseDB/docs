...
See [Installing](/pg_extensions/pgfs/installing.mdx) to learn how to install the PGFS extension as part of the Pipelines installation.

## Using PGFS

See the [PGFS management functions](/pg_extensions/pgfs/using/index.mdx) reference for details on the functions available in the PGFS extension.
