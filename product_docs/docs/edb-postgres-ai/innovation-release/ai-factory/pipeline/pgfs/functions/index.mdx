...
- [Google Cloud storage](/edb-postgres-ai/current/ai-factory/pipeline/pgfs/functions/gcs)
...
- [Azure Blob Storage](/edb-postgres-ai/current/ai-factory/pipeline/pgfs/functions/azure)
