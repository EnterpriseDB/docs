...
- [KServe concepts](/edb-postgres-ai/current/ai-factory/model/serving)

## Next steps

- [Deploy NIM containers](/edb-postgres-ai/current/ai-factory/model/deploy-nim-container)
- [Verify InferenceServices and GPU usage](/edb-postgres-ai/current/ai-factory/model/verify-models)
