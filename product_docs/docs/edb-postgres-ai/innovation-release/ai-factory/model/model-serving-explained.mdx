...
navTitle: Model Serving Explained In Depth
...
See: [Supported Models](/edb-postgres-ai/current/ai-factory/pipeline/models/supported-models/)
...
-   [Deploy your first InferenceService](/edb-postgres-ai/current/ai-factory/model/create-inferenceservice/)
-   [Verify deployed models](/edb-postgres-ai/current/ai-factory/model/verify-models)
