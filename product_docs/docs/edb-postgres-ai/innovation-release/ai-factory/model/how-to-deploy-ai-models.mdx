...
-   An active HM environment with **GPU worker nodes** configured.
	-   For a full setup guide, see: [Setup GPU Resources for Model Serving](/edb-postgres-ai/current/ai-factory/model/setup-gpu)
...
If you already store profiles in the object storage and images in your private registry, you don't need these two secrets. See: [How-To Use NVIDIA NIM Model Cache in Air‑Gapped Clusters in Hybrid Manager](/edb-postgres-ai/current/ai-factory/model/air-gapped-cache-hybrid-manager)
...
### 1. Create model in Asset Library
...
### 2. Browse and select model in Asset Library

-   Go to **Asset Library > Models**.
-   Browse models.
-   Select the model you want to deploy.

### 3. Configure and deploy model

-   Click "Create Local Inference Service".
-   Configure deployment parameters:
	...
	-   Model Profiles Path on Object Storage, the NIM profile path in the object storage. Ignore it when the model is not an NIM provider. See [How-To Use NVIDIA NIM Model Cache in Air‑Gapped Clusters in Hybrid Manager](/edb-postgres-ai/current/ai-factory/model/air-gapped-cache-hybrid-manager).
...
### 5. Connect model to AI Factory workloads
...
-   [Image and Model Library Explained](/edb-postgres-ai/current/ai-factory/model/model-library-explained/)
-   [Setup GPU Resources for Model Serving](/edb-postgres-ai/current/ai-factory/model/setup-gpu)
-   [Deploy NVIDIA NIM Microservices - Advanced Guide](/edb-postgres-ai/current/ai-factory/model/deploy-nim-container)
