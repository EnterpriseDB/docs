...
redirects:
- /purl/hm
- /edb-postgres-ai/preview/hybrid-manager/:splat
...
-   [Sovereign Data and Agent Factory](./system) → Sovereign Data and Agent Factory hardware
...
-   [Agent Factory](./ai-factory) → sovereign GenAI pipelines, model serving, and retrieval systems
