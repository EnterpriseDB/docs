...
| **Agent** | `beaconAgent.plaintext` | true |
| **Agent** | `beaconAgent.inCluster` | true |
...
Harbor and Artifactory have also been used in customer environments.
...
| **Bootstrap Tag** | `bootstrapImageTag` | HM/Platform version tag (for example, `"1.2.0"`). |
