...
!!! Note
The tables in this guide reference `values.yaml` parameter names. If you are using the **Operator method (recommended)**, see the [Configuration mapping reference](./install_hm_operator#configuration-mapping-reference) for how these map to `HybridControlPlane` CR fields.
!!!
...
For a complete field reference and mapping, see the [Configuration mapping reference](./install_hm_operator#configuration-mapping-reference).
