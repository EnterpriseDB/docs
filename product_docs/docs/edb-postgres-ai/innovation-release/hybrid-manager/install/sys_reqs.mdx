...
>>>>>>> ec912a7f10 (docs: address comments)
...
Here is the equivalent configuration as a `HybridControlPlane` Custom Resource for the Operator installation method. For a complete field reference and mapping, see the [Configuration mapping reference](./install_hm_operator#configuration-mapping-reference).
