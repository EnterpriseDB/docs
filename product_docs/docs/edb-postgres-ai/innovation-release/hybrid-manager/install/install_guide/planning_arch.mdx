...
-   **GenAI:** Provides the AI/ML capabilities. If enabled, this component dictates the need for GPU-enabled worker nodes in your **[system requirements](./sys_reqs)**.
    -   *See:* [GenAI in HM](/edb-postgres-ai/latest/hybrid-manager/ai-factory/gen-ai/)
...
3.  Connectivity is established using load-balanced endpoints—not a network mesh service, like Submariner for example.
