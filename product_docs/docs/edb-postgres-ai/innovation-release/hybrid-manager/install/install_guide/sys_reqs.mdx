...
For a complete field reference and mapping, see the [Configuration mapping reference](../configuration/migrate_bootstrap_to_operator#configuration-mapping-reference).
