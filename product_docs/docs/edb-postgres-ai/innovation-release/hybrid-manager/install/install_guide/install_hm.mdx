...
**`scenarios`**: Optional. Ensure you have listed the installation scenarios you need (options are `core`, `migration`, `ai`, and `analytics`). If this key is absent from your `values.yaml`, all scenarios are installed by default.
