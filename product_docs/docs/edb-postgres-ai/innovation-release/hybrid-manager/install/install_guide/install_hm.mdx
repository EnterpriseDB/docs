...
1. **`parameters.global.internal_backup_folder`**: A unique 12-character alphanumeric string for the backup folder (e.g., `a7462dbc7106`).
1. **`parameters.upm-beacon.beacon_location_id`**: The location identifier for this HM installation (e.g., `us-east-1`).
