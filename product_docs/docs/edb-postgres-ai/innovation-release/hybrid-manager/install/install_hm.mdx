...
The **Bootstrap installation method** will be deprecated in an upcoming release. New installations should use the **[Operator installation method](./install_hm_operator)** to ensure long-term support and access to the latest features.
...
This phase involves applying the Helm chart (`values.yaml`) to your cluster and monitoring the bootstrap operator as it deploys the platform services.
