...
HM supports two installation methods. 
The information you gather in Phases 1–2 is the same regardless of which method you choose — only the final configuration format differs:
...
The following YAML snippets show how your architectural decisions above map to the final configuration file structure. 
