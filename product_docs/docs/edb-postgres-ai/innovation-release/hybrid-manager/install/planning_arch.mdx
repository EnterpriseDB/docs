...
The following snippets show how your architectural decisions above map to the final configuration file structure. 
Examples are shown for both installation methods.
