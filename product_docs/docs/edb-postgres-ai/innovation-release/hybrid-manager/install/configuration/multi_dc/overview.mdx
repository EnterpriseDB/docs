...
- **HM-internal PGAI agent:** Instead of a UI, secondaries run the HM-internal PGAI agent. This agent heartbeats back to the primary, making local Kubernetes resources (nodes, storage) available to the central scheduler.
