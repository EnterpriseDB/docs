...
| [Google Artifact Registry (GAR)](https://docs.cloud.google.com/artifact-registry/docs)          | `<gcp-region-id>-docker.pkg.dev`                         | `us-east1-docker.pkg.dev`                      |
...
By default, `image_discovery_credentials_secret_name` is set to `edb-cred`.
