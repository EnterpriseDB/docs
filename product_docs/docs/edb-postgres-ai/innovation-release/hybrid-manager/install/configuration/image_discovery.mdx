...
This option specifies the container registry provider for the registry specified in `imagesetDiscoveryContainerRegistryURL`. It defaults to `oci`.
...
This value is the name of the Kubernetes secret containing the registry credentials of registry for image discovery.
