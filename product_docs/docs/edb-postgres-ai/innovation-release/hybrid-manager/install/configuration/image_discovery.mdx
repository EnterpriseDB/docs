...
**Image discovery** is a background process running within the **PGAI agent**. 
...
The PGAI agent requires specific permissions to scan your registry. 
...
After applying these changes via `helm upgrade`, check the logs of the **PGAI agent** pod. 
