...
For more options, see [edbctl image-pull-secret](/edbctl/latest/using/edbctl_image_pull_secret/).
...
For more options, see [edbctl setup](/edbctl/latest/using/edbctl_setup/).
...
[maybe here is where we back them up?]: #
