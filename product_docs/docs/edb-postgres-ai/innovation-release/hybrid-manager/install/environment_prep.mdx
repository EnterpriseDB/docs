 ...
 * [**SOP: Install with the Operator**](./install_hm_operator#example-hybridcontrolplane-manifest) guide for a complete HybridControlPlane manifest template and field mapping reference.
