...
* **Creating other necessary secrets**
  ...
  * [Creating **GenAI Builder** secret](#creating-genai-builder-secrets) (requires Fernet secret)
  * [Creating **Catalog** secret](#creating-catalog-secret) (requires Fernet secret)
  * [Customizing secrets for the **Migration Portal**](#creating-catalog-secret).
