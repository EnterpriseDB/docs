...
| **AI integration**                 | Run [sovereign GenAI pipelines](/edb-postgres-ai/1.3/ai-factory/), serve models with KServe, and build AI knowledge bases governed by your infrastructure.                                                                                                                                         |
...
-   [AI Factory](/edb-postgres-ai/1.3/ai-factory/) – Build and run GenAI workloads using private data.
