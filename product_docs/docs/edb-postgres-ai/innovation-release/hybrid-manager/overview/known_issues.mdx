...
**Workaround:** Click the **Hybrid Manager Project** dropdown on the component and select **Refresh list** to load the available projects. Once the project ID is populated, the error clears.
