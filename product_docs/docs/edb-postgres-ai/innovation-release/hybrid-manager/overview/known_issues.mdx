...
### No `kapp-controller` support in Hybrid Manager certified app to pull images

**Description:** The `kapp-controller` does not support Managed Identity/IAM Roles for pulling images.
