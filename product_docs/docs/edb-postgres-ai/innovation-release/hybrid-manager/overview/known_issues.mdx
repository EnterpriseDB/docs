...
**Description:** When creating a flow via the Langflow visual editor, the secret or credential field of any components must use a global variable. Pasting a password directly will cause errors when deploying the flow via HM Flow Hosting. This is a default behavior across all components from Langflow v0.19.

**Workaround:** Store the credential in a global variable and use it in the component.
