...
Logs and metrics from a deployed flow go to HM's observability stack and are surfaced through the standard HM Grafana dashboards. See [Observability](../observability) for Prometheus alert rules and Grafana dashboard setup for Langflow pods and model cluster performance.
