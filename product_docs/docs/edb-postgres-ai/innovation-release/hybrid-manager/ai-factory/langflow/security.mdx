---
title: Security considerations for Agent Studio
navTitle: Security
description: How Agent Studio on Hybrid Manager handles credentials across the flow builder, published bundles, and deployed flows, and how deployed flows reach models in air-gapped environments.
---
...
-   [Sovereign AI on Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/ai-factory/) — data residency and air-gapped architecture concepts.
-   [Flow deployment](./flow-deployment) — project-level isolation, scaling, and access control for deployed Agent Studio flows.
