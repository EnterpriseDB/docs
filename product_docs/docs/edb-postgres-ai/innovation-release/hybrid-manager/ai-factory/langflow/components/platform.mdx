...
-   The component must run inside an HM-deployed flow. The runtime injects the caller's identity headers. Outside that context the MCP proxy cannot authenticate the request.
