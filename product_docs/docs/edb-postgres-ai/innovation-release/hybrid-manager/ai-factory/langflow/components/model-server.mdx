...
-   An HM machine-user access key saved in Agent Studio as a [Global Variable](https://docs.langflow.org/configuration-global-variables) (default name `HM_API_KEY`).
