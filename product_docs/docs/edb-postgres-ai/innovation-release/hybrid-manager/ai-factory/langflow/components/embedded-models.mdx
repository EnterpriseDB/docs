...
-   The component uses `aidb.encode_text`, `aidb.encode_image`, and `aidb.decode_text` under the hood. See the [AIDB documentation](/aidb/latest/) for details on each function.
