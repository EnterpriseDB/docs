...
1.  Build knowledge base pipelines using [Pipeline Designer](pipeline-designer/getting-started)
1.  Configure retrieval in a Langflow flow: [EDB Knowledge Base component](langflow/components/knowledge-base)
1.  Deploy flows as services: [Flow deployment](langflow/flow-deployment/)
...
2.  Call models from Python: [Python Client Guide](/edb-postgres-ai/current/ai-factory/model/quickstart-python-using-inference-endpoint)
3.  Invoke deployed Langflow flows over HTTP or MCP: [Accessing deployed flows](langflow/flow-deployment/accessing-deployed-flows)
...
1.  Build flows using the Langflow visual editor: [Langflow quickstart](langflow/quickstart)
2.  Use pre-built templates as starting points: [Templates](langflow/templates/)
3.  Publish and deploy flows for others to use: [Flow deployment](langflow/flow-deployment/)
...
1.  Create a knowledge base pipeline: [Pipeline Designer getting started](pipeline-designer/getting-started)
1.  Query the knowledge base from a flow: [EDB Knowledge Base component](langflow/components/knowledge-base)
1.  Build a RAG flow end-to-end: [Langflow quickstart](langflow/quickstart)

### For Customer Service

1.  Build a conversational flow: [Langflow quickstart](langflow/quickstart)
1.  Try the Simple Migration Agent template as a reference for agentic flows: [Templates](langflow/templates/)
1.  Deploy the flow as a callable service: [Flow deployment](langflow/flow-deployment/)

### For API Development

1.  Deploy models via [Deploy with HM UI](deploy-with-hm-ui)
1.  Access endpoints: [Python Client Guide](/edb-postgres-ai/current/ai-factory/model/quickstart-python-using-inference-endpoint)
1.  Monitor performance: [Observability](observability)
...
-   [AI Factory architecture](architecture)
-   [Langflow](langflow/)
