...
See [Langflow quickstart](langflow/quickstart) for a working example.
...
1.  Configure model registries per [Model Library Documentation](/edb-postgres-ai/current/ai-factory/model/library)
1.  Monitor inference performance using [Observability Tools](/edb-postgres-ai/current/ai-factory/model/observability)
...
1.  Call models from Python: [Python Client Guide](/edb-postgres-ai/current/ai-factory/model/quickstart-python-using-inference-endpoint)
1.  Invoke deployed Langflow flows over HTTP or MCP: [Accessing deployed flows](langflow/flow-deployment/accessing-deployed-flows)
