...
See [Model Serving Guide](/edb-postgres-ai/latest/ai-factory/model/serving/) for deployment instructions.
...
1.  Provision GPU resources following [GPU Setup Guide](/edb-postgres-ai/latest/ai-factory/model/setup-gpu)
1.  Configure model registries per [Model Library Documentation](/edb-postgres-ai/latest/ai-factory/model/library)
1.  Monitor inference performance using [Observability Tools](/edb-postgres-ai/latest/ai-factory/model/observability)
...
1.  Access model endpoints via [KServe Integration](/edb-postgres-ai/latest/ai-factory/model/access-kserve-endpoints)
1.  Call models from Python: [Python Client Guide](/edb-postgres-ai/latest/ai-factory/model/quickstart-python-using-inference-endpoint)
...
1.  Access endpoints: [Python Client Guide](/edb-postgres-ai/latest/ai-factory/model/quickstart-python-using-inference-endpoint)
