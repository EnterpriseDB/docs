...
Gen AI Builder connects to models deployed through Hybrid Manager's [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/) infrastructure, providing seamless access to language models for text generation, embeddings, and reranking operations.
...
- OpenAI-compatible APIs enabling standard client libraries (see [OpenAI API compatibility](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/openai-api-compatibility.mdx))
...
Knowledge bases transform organizational data into searchable, AI-ready formats through embedding and indexing within PostgreSQL databases enhanced with [pgvector and Vector Engine concepts](/edb-postgres-ai/current/ai-factory/vector-engine/). See [Knowledge Bases](/edb-postgres-ai/current/ai-factory/gen-ai/knowledge-bases) and [Knowledge Base pipeline](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base/).

**Data Processing Pipeline**
1. **Ingestion**: Connect to [data sources](/edb-postgres-ai/current/ai-factory/gen-ai/data-sources/) including databases, documents, and APIs
...
Assistants orchestrate the interaction between users, knowledge bases, and external systems through configurable workflows that combine retrieval, reasoning, and action. See [Assistants](/edb-postgres-ai/current/ai-factory/gen-ai/assistants).

**Configuration Components**
- **Directive**: Define the assistant's purpose and behavior
- **Knowledge Integration**: Connect relevant [Knowledge Bases](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base/) for context
- **Tool Binding**: Enable external system interactions via [Tools](/edb-postgres-ai/current/ai-factory/gen-ai/reference/tools/)
...
RAG patterns ground LLM responses in organizational knowledge, reducing hallucination while maintaining conversational capabilities. See [Retrievers](/edb-postgres-ai/current/ai-factory/gen-ai/retrievers).
...
- Reranking to improve result relevance (see [Using NVIDIA NIM](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/index.mdx))
- Context window management for large documents

### Tool Integration

Tools extend assistant capabilities by enabling interactions with external systems and APIs while maintaining security boundaries. See [Tools](/edb-postgres-ai/current/ai-factory/gen-ai/reference/tools/).
...
Thread management provides comprehensive visibility into assistant interactions for debugging and compliance. See [Threads](/edb-postgres-ai/current/ai-factory/gen-ai/threads).
...
1. **Review Concepts**: Understand [core concepts](/edb-postgres-ai/current/ai-factory/gen-ai/concepts) and [architecture](/edb-postgres-ai/current/ai-factory/gen-ai/architecture)
2. **Create Knowledge Base**: Follow the [knowledge base guide](/edb-postgres-ai/current/ai-factory/gen-ai/create-knowledge-base)
3. **Build Assistant**: Use the [assistant creation guide](/edb-postgres-ai/current/ai-factory/gen-ai/create-assistant)
4. **Deploy Application**: Implement using the [quickstart UI](/edb-postgres-ai/current/ai-factory/gen-ai/quickstart-customer-service-agent-ui)

For detailed documentation:
- [Assistants](/edb-postgres-ai/current/ai-factory/gen-ai/assistants)
- [Knowledge Bases Manual](/edb-postgres-ai/current/ai-factory/gen-ai/manage-knowledge-base)
- [Tools Documentation](/edb-postgres-ai/current/ai-factory/gen-ai/reference/tools/)
- [SDK Reference](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/)
