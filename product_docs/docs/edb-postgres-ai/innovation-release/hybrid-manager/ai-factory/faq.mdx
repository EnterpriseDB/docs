...
-   [Concepts](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/concepts/) - Component overview
-   [Architecture](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/architecture/) - System design
...
Implementation guide: [Knowledge Base Creation](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/create-knowledge-base/).
