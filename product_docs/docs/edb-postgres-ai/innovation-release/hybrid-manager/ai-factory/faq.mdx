...
See [Prerequisites](prerequisites) for comprehensive specifications.
...
Check that the correct embedding model is in use, chunk sizes are appropriate for your content, and all documents have been indexed. For Langflow-specific guidance including AIDB knowledge base diagnostics, see [How do I improve retrieval quality in a RAG flow?](./langflow/faq#how-do-i-improve-retrieval-quality-in-a-rag-flow).
...
-   [Langflow](./langflow/)
-   [Knowledge bases](/aidb/7/knowledge-bases/) (AIDB)
-   [Data pipelines](/aidb/7/data-pipelines/) (AIDB)

**Troubleshooting Resources**

-   [Model Verification](/edb-postgres-ai/current/ai-factory/model/verify-models)

For issues not addressed here, contact EDB support or see [Troubleshooting](troubleshooting).
