...
| HuggingFace | `https://router.huggingface.co` | `OPENAI_V1` | `openai/gpt-oss-120b` | Only the HuggingFace router URL is supported (not `huggingface.co`). API key not validated at registration. |
