...
-   **Quickstart (Python):** [Quickstart using inference endpoint](/edb-postgres-ai/1.3/ai-factory/model/quickstart-python-using-inference-endpoint)
...
-   **OpenAI API compatibility:** [Using models via OpenAI-compatible SQL calls](/edb-postgres-ai/1.3/ai-factory/pipeline/models/using-with/openai-api-compatibility)
-   **NVIDIA NIM:** [Using NVIDIA NIM in AIDB](/edb-postgres-ai/1.3/ai-factory/pipeline/models/using-with/using-nvidia-nim/)
