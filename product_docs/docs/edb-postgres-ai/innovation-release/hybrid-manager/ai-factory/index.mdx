...
-   [Gen AI in Hybrid Manager](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/) — Gen AI capabilities in Hybrid Manager
-   [Agent Studio & Builder (consolidated)](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/) — Create assistants, tools, structures, rulesets; manage Knowledge Bases
...
-   [How-To Guides](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/how-to/)
...
-   Read [How-To Guides](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/how-to/)
-   Deploy your first Gen AI assistant or model using [Gen AI in HM](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/) or [Model Serving](/edb-postgres-ai/1.3/ai-factory/model/serving/)
