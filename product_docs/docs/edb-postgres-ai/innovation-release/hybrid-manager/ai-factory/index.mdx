...
-   [Model Library](/edb-postgres-ai/latest/ai-factory/model/library) — Manage and govern your model assets
-   [Model Serving](/edb-postgres-ai/latest/ai-factory/model/serving/) — Deploy and scale model inference services on Kubernetes
-   [GPU resource management](/edb-postgres-ai/latest/ai-factory/model/setup-gpu) — Configure and allocate GPU capacity for serving
...
-   Access to GPU resources where needed for serving. See [GPU resource management](/edb-postgres-ai/latest/ai-factory/model/setup-gpu).
