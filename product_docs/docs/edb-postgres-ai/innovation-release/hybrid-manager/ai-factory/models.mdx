...
Langflow flows consume model endpoints through the **EDB Model Server** and **EDB Embeddings** components. LLMs deployed through Model Serving provide text generation capabilities while embedding models support RAG pipelines and knowledge base indexing.

Applications and flows access models through cluster-local DNS:
