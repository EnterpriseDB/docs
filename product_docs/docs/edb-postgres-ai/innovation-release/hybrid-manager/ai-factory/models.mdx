...
-   [Using models via OpenAI-compatible SQL calls](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/openai-api-compatibility)
-   [Using NVIDIA NIM in AIDB](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/)
