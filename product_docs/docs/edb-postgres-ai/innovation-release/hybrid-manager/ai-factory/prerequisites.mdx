...
See [Creating other necessary secrets](/edb-postgres-ai/current/hybrid-manager/install/install_guide/environment_prep/#create-component-secrets) for an overview of the AI Factory-specific enablement steps.
