...
-   Private registries and image governance: [Model Library](/edb-postgres-ai/latest/ai-factory/model/library)
-   KServe manifests and deployment flow: [Using NVIDIA NIM in your environment](/edb-postgres-ai/latest/ai-factory/pipeline/models/using-with/using-nvidia-nim/using-nim-in-your-environment)
...
-   Hub usage patterns: [Using NVIDIA NIM in your environment](/edb-postgres-ai/latest/ai-factory/pipeline/models/using-with/using-nvidia-nim/using-nim-in-your-environment)
-   [Air-gapped cache](/edb-postgres-ai/latest/ai-factory/model/air-gapped-cache-hybrid-manager)
