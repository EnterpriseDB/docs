...
Before you can use AI Factory in Hybrid Manager, you need to enable it during the installation of HM.

See [Creating other necessary secrets](/edb-postgres-ai/current/hybrid-manager/install/install_guide/environment_prep/#create-component-secrets) for the AI Factory-specific enablement steps.
...
For architecture context, see [AI Factory architecture](architecture).
