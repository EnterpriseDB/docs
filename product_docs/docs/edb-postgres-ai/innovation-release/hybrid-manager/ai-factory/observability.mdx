...
**Hub quick links:**
[Model Serving observability](/edb-postgres-ai/current/ai-factory/model/monitor-inferenceservice/) — [Gen AI hub](/edb-postgres-ai/current/ai-factory/gen-ai/)
...
- See: [View threads (hub)](/edb-postgres-ai/current/ai-factory/gen-ai/view-threads/)
...
- **Tracing.** OpenTelemetry drivers are included in Gen AI Builder for deeper tracing; see [Gen AI observability drivers (hub)](/edb-postgres-ai/current/ai-factory/gen-ai/reference/sdk/drivers/observability-drivers/).
