...
1. Process content to generate embeddings

### Configure Assistant

1. Navigate to **AI Factory** → **Assistants**
1. Create new assistant with:
- Name and directive
...
See [Create Assistant Guide](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/gen-ai/create-assistant/) for detailed procedures.
