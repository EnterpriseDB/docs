...
The sections below cover intentional design boundaries of the current Pipeline Designer implementation and known issues with available workarounds. For release-specific details, see the [Hybrid Manager release notes](/edb-postgres-ai/innovation-release/hybrid-manager/release_notes/).
