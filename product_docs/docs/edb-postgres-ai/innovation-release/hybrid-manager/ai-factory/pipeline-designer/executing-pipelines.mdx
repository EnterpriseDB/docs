...
This page explains how execution works, how to trigger it, and how to run pipelines on different cluster types.
...
1.  Pipeline operations run under the [`visual_pipeline_user` (VPU)](vpu-and-permissions) role. 
    ...
    - For Background mode, AIDB's background worker connects to the database as the pipeline's owner role directly. 
