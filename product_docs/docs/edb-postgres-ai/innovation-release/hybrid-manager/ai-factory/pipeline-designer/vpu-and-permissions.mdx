...
!!! Note "Trigger function ownership"
    On PGD clusters, AIDB trigger handler functions may need their ownership adjusted for Live and Background processing to work correctly on replicated tables. See [Trigger function ownership on PGD clusters](limitations#trigger-function-ownership-on-pgd-clusters-aid-1076-aid-1136) for the current workaround.
!!!
