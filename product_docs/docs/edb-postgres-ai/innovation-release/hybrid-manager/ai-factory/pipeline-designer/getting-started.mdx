...
The knowledge base is now available for use by downstream applications such as [Langflow](/edb-postgres-ai/innovation-release/hybrid-manager/ai-factory/langflow) agents. See [Using knowledge bases with Langflow](knowledge-bases#using-knowledge-bases-with-langflow) for integration details.
