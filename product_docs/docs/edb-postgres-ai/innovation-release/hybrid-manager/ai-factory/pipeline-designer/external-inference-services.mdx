...
!!!Note "Model Serving interface not available in current release"
The management interface described in this section isn't available in the current Portal release. External models registered via AIDB-native registration are managed through SQL. See [AIDB-native model registration](#registering-aidb-native-models).
!!!
