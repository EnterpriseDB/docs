---
title: Sovereign Data and Agent Factory
...
Sovereign Data and Agent Factory is a fully integrated hardware and software platform co-designed by EDB and Supermicro®. It enables organizations to deploy production-grade Postgres® and AI workloads in their own data centers without external dependencies.
...
Cloud-first isn’t always an option. Sovereign Data and Agent Factory exists for environments where:
...
To learn more about lifecycle operations, see [Using Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/).
