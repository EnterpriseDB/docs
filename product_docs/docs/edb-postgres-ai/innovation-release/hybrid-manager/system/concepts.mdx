...
navTitle: Concepts
description: Key architecture concepts and components that make up the Sovereign Data and Agent Factory system.
---

Sovereign Data and Agent Factory combines physical infrastructure, orchestration software, and lifecycle automation into a single system, preassembled and installed in your data center.
...
As a prerequisite, see configuration details in [System specifications](./specs).
...
The administration node provides additional software packages, licensing, and support tooling for your Sovereign Data and Agent Factory. You need one administration node per installation.
...
These nodes aren't used for running data workloads.
...
The system runs a preinstalled Kubernetes cluster managed by Hybrid Manager. You don't directly access Kubernetes. Instead, Hybrid Manager provides a web-based interface to:
...
Sovereign Data and Agent Factory is suitable for:
