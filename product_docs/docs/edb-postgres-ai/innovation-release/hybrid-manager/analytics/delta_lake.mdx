...
How-To: [Configure PGFS](/aidb/7/external-data-sources)
...
2. [Configure PGFS](/aidb/7/external-data-sources) pointing to your Delta Lake object storage.
...
- [Configure PGFS](/aidb/7/external-data-sources)
