...
**Lakehouse Analytics - Single Node:** You can also create [Lakehouse Analytics](../analytics/) clusters with the Hybrid Manager. Lakehouse clusters provide an environment for querying and analyzing data stored in open lakehouse formats within object storage. 
### External clusters
