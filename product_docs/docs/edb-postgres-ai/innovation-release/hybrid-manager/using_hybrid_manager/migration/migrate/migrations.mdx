...
Select **Create Migration** to create migrations. See [Creating migration](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/self_managed_pg_to_hm_managed/migrating_data/#creating-a-migration) for an example.
