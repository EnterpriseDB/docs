...
Queries listed here won't run correctly as-is and require action before application cutover.

### Expand a query to see transformations and repair guidance

Use the **+** sign to select any row to expand it. The expanded panel shows:
