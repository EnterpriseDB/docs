...
If you plan to use the **Schema and data** migration scope, the agent must finish ingesting your source schema before a Migration Portal project is created for the database. Confirm the project exists at **Migrate > Migration Portal** in the HM console before [creating the migration](migrating_data#creating-a-migration). The **Schema and data** scope will fail without it.
!!!
