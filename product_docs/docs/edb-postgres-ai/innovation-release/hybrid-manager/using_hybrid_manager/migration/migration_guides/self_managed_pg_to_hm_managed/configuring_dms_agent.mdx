...
#   - migration_guides/aws_rds_pg_to_hm_managed/configuring_dms_agent.mdx
#   - migration_guides/self_managed_pg_to_self_managed_pg/configuring_dms_agent.mdx
redirects:
...
[Create a data migration](creating_migration)
