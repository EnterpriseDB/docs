...
The EDB DMS agent handles data migration from your Oracle source. It also handles schema migrations — if you're performing a **Schema Only** or **Schema and Data** migration. Before you can run it, you need to create migration credentials in HM and pass them to the agent alongside your Oracle connection details.
...
Run the agent by executing the configuration script you edited earlier:
