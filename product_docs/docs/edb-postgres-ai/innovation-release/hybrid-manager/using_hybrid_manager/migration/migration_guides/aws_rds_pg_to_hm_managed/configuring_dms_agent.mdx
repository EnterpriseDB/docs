...
redirects:
  - /edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/aws_rds_pg_to_hm_managed/creating_project_credentials/
  - /edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/aws_rds_pg_to_hm_managed/configuring_reader/
  - /edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/aws_rds_pg_to_hm_managed/viewing_source/
---
...
Run the agent by executing the configuration script you edited:
