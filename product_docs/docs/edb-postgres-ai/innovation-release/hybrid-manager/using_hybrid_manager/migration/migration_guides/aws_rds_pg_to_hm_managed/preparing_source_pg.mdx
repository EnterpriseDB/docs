...
If you plan to run both schema ingestion and data migration, complete all sections. If you only plan to do schema or data migration, each section will explain whether it's applicable for your use case.
