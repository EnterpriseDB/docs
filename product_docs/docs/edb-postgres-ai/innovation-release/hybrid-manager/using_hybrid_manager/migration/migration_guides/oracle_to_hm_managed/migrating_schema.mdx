...
See [Managing Migration Portal projects](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/hm_schema_migration/) for the steps to create — or delete — a project. Once the project is ready, a project link appears — select it to open Migration Portal and begin resolving incompatibilities using the AI Copilot or QuickHelp.
