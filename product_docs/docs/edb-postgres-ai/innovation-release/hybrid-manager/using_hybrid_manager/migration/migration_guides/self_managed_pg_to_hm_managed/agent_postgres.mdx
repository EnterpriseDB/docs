...
- **Machine user and access key**: Created in [Preparing your Postgres source database](preparing_source_pg#creating-a-machine-user-in-hm). Store the access key in an environment variable:
