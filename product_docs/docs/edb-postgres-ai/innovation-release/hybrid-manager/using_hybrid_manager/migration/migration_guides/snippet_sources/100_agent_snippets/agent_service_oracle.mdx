---
title: Running the PGAI agent as a service for Oracle databases
...
This example configures the PGAI agent to run on an RHEL 9 machine. Operating system aids help you to know when to replace the values.
