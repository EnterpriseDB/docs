...
No separate schema migration is required. HM handles schema import automatically when you select the **Schema and data** scope later. Proceed to [Creating project credentials for the data migration](creating_project_credentials).
