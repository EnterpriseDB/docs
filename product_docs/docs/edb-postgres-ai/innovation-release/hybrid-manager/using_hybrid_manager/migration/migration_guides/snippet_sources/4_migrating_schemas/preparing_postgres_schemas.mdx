...
!!!note
Apply the excluded foreign key, check, and exclusion constraints on the destination database after the migration completes successfully. Keep track of the excluded constraints so you can apply them when the time comes.
!!!
