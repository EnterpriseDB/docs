...
- **Machine user access key**: Store the access key generated in the HM console when you created a machine user in an environment variable, e.g. `export BEACON_AGENT_ACCESS_KEY="baak_your_key_here"`.
...
For production use, see [Running the agent as a service](#running-the-agent-as-a-service) below.
