...
1.  Monitor the ingestion process as the agent starts sending data to Hybrid Manager (HM). After a few minutes, your Oracle database appears in the HM console under **Estate > Migrations**, which lists your external databases along with summarized database and migration information. Selecting the database provides a detailed migration assessment and migration capabilities.
