...
-   The size of the ingested DDL exceeds the [limit customized by yourself](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/controlling_project_creation/#customizing-the-maximum-size-of-migration-portal-projects).
-   You [disabled the automatic creation of Migration Portal projects](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/controlling_project_creation/#disabling-the-automatic-creation-of-migration-portal-projects).

#### Manual project creation

1.  In the **Estate** page, select the **Migrations** tab.

2.  To open the database's detailed view, select the name of the database you want to migrate.

3.  In the detailed view of the database, select the **Schemas** tab. 

4.  Select **New MP Project** or the plus sign next to one of the schemas you want to migrate.
...
5.  Select **Next** and wait until the schemas are imported successfully.
...
2.  Select the **Offline migration** option.
...
6.  Connect to the destination database, and apply the modified DDL file.
