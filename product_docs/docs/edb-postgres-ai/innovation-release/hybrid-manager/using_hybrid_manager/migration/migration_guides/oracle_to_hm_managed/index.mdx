...
1.  [Create a machine user for registration with the EDB Postgres AI agent](agent_creating_machine_user).

1.  [Install the EDB Postgres AI agent](agent_installing).

1.  [Configure the EDB Postgres AI agent to register your Oracle database](agent_configuring_oracle).

1.  [Run the EDB Postgres AI agent](agent_running).

1.  [Run the EDB Postgres AI agent as a service](agent_service).

1.  [Verify the EDB Postgres AI agent has registered your Oracle database and view the migration assessment results](agent_verifying_assessment).
