...
1.  Grant all of the following privileges: 
    ...
    GRANT CONNECT TO <MIGRATION_USER> CONTAINER=ALL; 
    ...
    GRANT SELECT ON V_$VERSION TO <MIGRATION_USER> CONTAINER=ALL; 
    GRANT SELECT ON V_$INSTANCE TO <MIGRATION_USER> CONTAINER=ALL; 
    GRANT SELECT ON V_$LICENSE TO <MIGRATION_USER> CONTAINER=ALL;

    -- Grant access to tables
    GRANT CREATE TABLE TO <MIGRATION_USER> CONTAINER=ALL; 
    ALTER USER <MIGRATION_USER> QUOTA UNLIMITED ON LOGMINER_TBS CONTAINER=ALL;
    ```
...
1.  Change the default namespace:
    ...
    ALTER USER <C##_MIGRATION_USER> DEFAULT TABLESPACE MIGRATOR_TS;
    ...
    -- In the CDB ROOT
    ALTER SESSION SET CONTAINER = CDB$ROOT;
    ALTER USER <MIGRATION_USER> DEFAULT TABLESPACE MIGRATOR_TS;
    ```
