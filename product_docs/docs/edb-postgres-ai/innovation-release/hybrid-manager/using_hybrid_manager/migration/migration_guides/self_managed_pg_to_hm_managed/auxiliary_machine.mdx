...
Ensure network connectivity between the auxiliary machine and the source database host, and between the auxiliary machine and Hybrid Manager (HM). You'll verify the specific ports required later, when configuring the agents.
