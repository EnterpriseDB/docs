...
Select a link to access the applicable installation instructions. If you already have the agent installed and need to upgrade it, see [Upgrading the DMS agent](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/upgrading_agent/) instead.
