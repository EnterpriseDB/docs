...
!!!note
    ...
    (\*) The DMS agent supports migrating Oracle 21c databases. Starting in HM 2026.8, Migration Portal's schema assessment also recognizes several Oracle 21c syntax elements — multilevel indexes, `ANY_VALUE`, and `WINDOW` clause syntax. It flags blockchain tables and `SQL MACRO` as unsupported object types.
