...
1.  Select all the schemas you want to add to this Migration Portal project. You can select only schemas that the PGAI agent has ingested successfully and schemas that aren't already part of a different Migration Portal project.
