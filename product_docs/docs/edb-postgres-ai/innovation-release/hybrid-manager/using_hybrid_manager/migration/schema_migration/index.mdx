...
[Oracle schema migration](migration_portal/hm_schema_migration)
...
HM still creates a Migration Portal project for the schema in the background, mainly for visibility and as a recovery option — see [Assessing schemas for HM projects](migration_portal/hm_schema_migration) for details.
