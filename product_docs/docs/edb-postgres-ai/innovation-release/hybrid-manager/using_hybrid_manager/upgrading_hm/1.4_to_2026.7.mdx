...
- Required tools:
    ...
    - `kubectl`
    - [`edbctl`](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/edbctl/), the Hybrid Manager CLI, version `1.7.0` or later — see the [edbctl compatibility matrix](/edbctl/latest/compatibility_matrix/) for the supported version.
