...
- If your spec lists only `dbaas` and you use Distributed High Availability clusters, you must explicitly add `pgd` to your `spec.scenarios` list. Do this **before** upgrading to Innovation Release 2026.9 or later.
