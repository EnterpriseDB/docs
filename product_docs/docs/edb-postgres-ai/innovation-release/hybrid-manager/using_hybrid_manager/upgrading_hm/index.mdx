...
Hybrid Manager (HM) offers a [dual release strategy](/edb-postgres-ai/preview/hybrid-manager/release_notes/#hybrid-manager-dual-release-strategy): **LTS (Long-Term Support)** and **Innovation Releases (IR)**. Because these streams follow different versioning logic, the supported paths for moving among them depend on your current version and the target environment.
...
![IR sequential upgrade](images/LTS_major_simple.svg)
...
![IR sequential upgrade](images/cross-stream_light_final.svg)
