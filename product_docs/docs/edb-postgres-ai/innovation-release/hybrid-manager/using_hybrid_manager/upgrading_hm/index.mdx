...
- If your spec lists only `core` (without `ai`) and you use the OSS Library/marketplace apps, you must explicitly add `marketplace` to your `spec.scenarios` list. For where this step falls in the upgrade sequence, see the upgrade guide for your target version — for example, [Upgrading from 2026.7 to 2026.8](2026.7_to_2026.8).
