...
Two [installation scenario](/edb-postgres-ai/current/hybrid-manager/install/install_guide/planning_arch/#available-scenarios) changes in 2026.9. Check your `HybridControlPlane` manifest against both before you continue.
