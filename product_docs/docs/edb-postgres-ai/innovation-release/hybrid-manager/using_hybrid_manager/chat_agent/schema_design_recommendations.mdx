...
Chat Agent focuses on DDL-level improvements for both managed and self-managed clusters — changes to how your data is defined and stored, rather than to the queries that access it. The current scope covers three categories, in order of priority:
...
Chat Agent can reason about indexes as part of schema design recommendations. For curated, auto-applicable index recommendations, see [Recommendations and advisories](capabilities#recommendations-and-advisories).
