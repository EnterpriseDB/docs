...
To remove the sparkle icon entirely, disable the AI scenario at install time. See [HM installation scenarios](../../install/install_guide/install_hm/#example-hybridcontrolplane-manifest).
