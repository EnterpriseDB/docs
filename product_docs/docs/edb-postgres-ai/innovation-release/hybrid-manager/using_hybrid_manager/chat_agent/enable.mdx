...
In addition to the required `chatbot-gen-content` function, you can apply optional functions that change Chat Agent behavior for that model. Apply them the same way you applied `chatbot-gen-content`. For the procedure, see [Model Serving](../../../ai-factory/model/serving) in the AI Factory documentation.
