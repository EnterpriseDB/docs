...
5.  After the upgrade is applied, you can use the [PGD CLI](/pgd/latest/reference/cli/#check-the-health-of-the-cluster) to ensure the data group becomes healthy. The upgrade is successful when all checks have the Status `Ok`. 
