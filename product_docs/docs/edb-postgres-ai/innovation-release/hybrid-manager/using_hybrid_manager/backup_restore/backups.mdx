...
You can change the compression algorithm for each backup type independently in the [Backup and security settings](../create-clusters/additional-settings) tab when creating or editing a cluster.
