...
- [`edbctl`](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/edbctl/) (the Hybrid Manager CLI) version 1.1.8 or later.
...
!!!note
For the complete flag reference for `annotate-extensions`, `show-extensions`, `copy-version`, and `read-version`, see [edbctl operand](/edbctl/latest/using/edbctl_operand/).
!!!
