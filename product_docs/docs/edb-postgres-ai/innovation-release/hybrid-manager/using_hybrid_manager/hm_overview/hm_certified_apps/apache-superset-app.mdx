...
| `init.adminUser.username` | Default admin username for the Superset UI. | Yes |
| `init.adminUser.password` | Default admin password for the Superset UI. | Yes |
| `init.adminUser.email` | Email address for the admin account. | Yes |
