...
- Access the [Hybrid Manager certified apps](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/hm_overview/hm_certified_apps) to manage and monitor your customer data.
...
-   [Langflow](/edb-postgres-ai/current/ai-factory/langflow/)
-   Prometheus
-   Thanos - Query
