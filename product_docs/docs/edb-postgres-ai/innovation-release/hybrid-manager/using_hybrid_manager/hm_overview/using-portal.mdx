...
- Access the [Marketplace apps](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/hm_overview/marketplace_apps/) to manage and monitor your customer data.
