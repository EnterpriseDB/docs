...
Ensure the following tools are available on your workstation environment or [Bastion host](/edb-postgres-ai/current/hybrid-manager/install/sys_reqs/#1-management-workstation-bastion-host):
