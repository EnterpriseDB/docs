...
During installation, you configure an [S3-compatible storage](/edb-postgres-ai/current/hybrid-manager/install/sys_reqs/#7-object-storage) for your HM instance that stores:
