...
- For automated compliance: HM server transmits usage report to EDB for core-based licensing and entitlement tracking across all on-premises servers, eliminating manual audits.
...
-   [Enabling HM server monitoring](monitoring_hm_server.mdx)  ► Enable usage reporting in the HM server.
...
-   [Activity Log](activity_log.mdx) ► Audit platform events across your organization or project.
