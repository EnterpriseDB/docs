...
- For automated compliance: HM server transmits usage telemetry to EDB for core-based licensing and entitlement tracking across all on-premises servers, eliminating manual audits.
...
-   [Enabling HM server monitoring](monitoring_hm_server.mdx)  ► Enable usage report in the HM server.
