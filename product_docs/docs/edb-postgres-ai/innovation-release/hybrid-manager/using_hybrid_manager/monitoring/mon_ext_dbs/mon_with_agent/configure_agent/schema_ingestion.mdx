...
Start with the default `schema_export_max_workers: 10` when configuring initial schema ingestion. Then, monitor the auxiliary machine running the HM agent (CPU, memory, disk I/O, network).
