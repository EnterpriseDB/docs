...
| `clusters.manager`                        | `"other"`               | Collects statistics for cluster manager. Possible values are `"patroni"`, `"repmgr"`, `"efm"`, `"pgd"`, `"other"`. For self-managed instances, set to `"other"`.                                                                                                                                                                                                               |
...
-   [Monitoring PGD Cluster](pgd_cluster/) ► Learn how to use the same agent config file to monitor a PGD cluster.
