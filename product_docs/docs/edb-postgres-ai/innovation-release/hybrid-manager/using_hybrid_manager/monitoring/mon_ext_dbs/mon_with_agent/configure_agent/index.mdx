...
!!!info
You can also use the agent to [assess your Oracle database for migration](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/oracle_hm_new/).
!!!
...
-   [Use the agent to assess your Oracle database for migration](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migration_guides/oracle_hm_new/) ► Use the EDB Postgres AI agent to asses Oracle databases and extract schema for conversion with the Migration Portal. 
