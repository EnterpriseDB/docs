...
5.  Configure another object storage by following the same steps you used during the [installation](/edb-postgres-ai/current/hybrid-manager/install/environment_prep/#create-object-storage-secret):
