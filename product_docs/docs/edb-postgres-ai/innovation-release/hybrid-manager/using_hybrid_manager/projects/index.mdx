...
- [Access the Hybrid Manager certified apps](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/hm_overview/hm_certified_apps).
...
- Select **Credential Information to see the connection details for the cluster, including the connection URL, username, and the database name. You can use these details to connect to the cluster from a Postgres client. Passwords aren't shown, but you can reset the password if you need to. For more information, see [Credentials](../../using_hybrid_manager/migration/migrate/credentials.mdx).
