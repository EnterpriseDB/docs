...
For testing or demo environments, you can simplify operations by adding native users. For production deployments, we strongly recommend [configuring an external IdP](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/config_idp_hm).
