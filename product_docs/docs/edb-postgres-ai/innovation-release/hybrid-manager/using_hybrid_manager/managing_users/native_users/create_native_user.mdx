...
| `userID`   | Each new user with a static password must have a unique identifier (uuid). You can choose to generate this value with a UUID generator tool or assign a random sequence of characters manually.                                                                                                                                                                          |
