...
Changes to role mapping rules are recorded in the activity log. When you add or remove rules, HM logs an update action indicating the scope (organization or project) and the number of rules configured.
