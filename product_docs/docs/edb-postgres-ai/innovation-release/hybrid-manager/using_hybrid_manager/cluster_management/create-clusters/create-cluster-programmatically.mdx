...
Check the [API documentation](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/using_the_api/) for more details on the required fields, the naming convention, and JSON structure for cluster creation.
!!!
