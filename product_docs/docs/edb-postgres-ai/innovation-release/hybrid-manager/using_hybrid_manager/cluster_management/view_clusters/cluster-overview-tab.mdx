...
!!! Note
    ...
    The Cluster Activity Log isn't available for self-managed clusters. Schema change events for self-managed clusters appear as chart annotations on the [**Monitoring**](cluster-monitoring-tab) tab instead.
!!!
