...
Enable **Display Events** for each monitoring category (**Host**, **Connections**, **Transactions**, etc.) to overlay event markers on charts, including schema change events automatically detected by HM.
