...
For more information on how recommendations are generated, scored, and managed — including how the **applied** and **ignored** states interact with this automation — see [Cluster recommendations](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/cluster_management/view_clusters/cluster-recommendations-tab/).
