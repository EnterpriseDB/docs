...
For **DHA clusters**, you only need to configure it on one data group. The automation applies the index to the write leader, and PGD replicates the change to all other data groups automatically.
