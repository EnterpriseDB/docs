...
For information on what happens if an upgrade fails, including rollback behavior, see [Rollback considerations](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/upgrading/pg_minor/#rollback-considerations).
