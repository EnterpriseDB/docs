...
| Hybrid Manager operand images | `operandSet` | 1.2.0 (timestamp 2607061042) |
| [EDB Postgres AI agent](/tools/agent/) | `beacon-agent` | 1.396.12 |
| EDB Postgres AI agent - Helm chart | `beacon-agent` (Helm chart) | 1.368.0 |
| [DMS agent](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/cdcagent_compatibility/) | `cdcagent` | 2.0.14 |
| [Hybrid Manager CLI](/edbctl/1/) | `edbctl` | 1.8.0 |
