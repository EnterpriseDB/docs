...
| Hybrid Manager operand images | `operandSet` | 1.2.1 (timestamp 2608040800) |
| [EDB Postgres AI agent](/tools/agent/) | `beacon-agent` | 1.401.5 |
| EDB Postgres AI agent - Helm chart | `beacon-agent` (Helm chart) | 1.371.0 |
| [DMS agent](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/cdcagent_compatibility/) | `cdcagent` | 2.1.1 |
| [Hybrid Manager CLI](/edbctl/1/) | `edbctl` | 1.8.1 |
