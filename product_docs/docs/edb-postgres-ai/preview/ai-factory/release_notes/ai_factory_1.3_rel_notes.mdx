...
-   [Installing AI Factory](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/how-to-enable-ai-factory)
-   [Using AI Factory](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/)
-   [AI Factory Overview](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/)
-   [Analytics Lakehouse Architecture](/edb-postgres-ai/1.3/analytics/)
-   [Power & ESG Reporting](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/monitoring/monitoring_grafana/grafana_dashboards/other_dashboards/#power-consumption-power-usage--carbon-footprint)
