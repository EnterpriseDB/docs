...
- Script: [hm_kserve_quickstart.py](/edb-postgres-ai/current/ai-factory/model/samples/hm_kserve_quickstart.py)
...
- Build an app using the same headers and payloads; see the [Python client quickstart](/edb-postgres-ai/current/ai-factory/model/quickstart-python-using-inference-endpoint).
- Integrate with Gen AI Assistants and Knowledge Bases for RAG; see [Gen AI](/edb-postgres-ai/current/ai-factory/gen-ai) and [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline).
- Add observability and SLOs; see [Model observability](/edb-postgres-ai/current/ai-factory/model/observability) and [Update GPU resources](/edb-postgres-ai/current/ai-factory/model/update-gpu-resources/).
