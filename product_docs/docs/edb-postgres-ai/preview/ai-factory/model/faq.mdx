...
Refer to the [GPU setup guide](/edb-postgres-ai/current/ai-factory/model/update-gpu-resources) for supported configurations and node recommendations by cloud provider.
