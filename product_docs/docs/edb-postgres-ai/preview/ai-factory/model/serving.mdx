...
prevNext: true
redirects:
- /edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving
- /edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/model-selection
- /edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/software-tools-entitlement
- /edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/model-server-instance
- /edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/memory-allocation
- /edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/cpu-allocation
- /edb-postgres-ai/latest/ai-factory/learn/how-to/model-serving/gpu-configuration-and-tuning
---
...
> **Prerequisites:** Model Serving requires [Hybrid Manager installation](/edb-postgres-ai/current/hybrid-manager/) and [Asset Library configuration](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/image-management/asset-library/) for model image management. All inference services operate within your controlled Kubernetes environment.
...
[Verify Models and GPU Usage →](/edb-postgres-ai/current/ai-factory/model/verify-models)
...
- [InferenceService Creation Guide](/edb-postgres-ai/current/ai-factory/model/create-inferenceservice)
- [GPU Resource Setup](/edb-postgres-ai/current/ai-factory/model/setup-gpu)
...
- [Model Library Integration](/edb-postgres-ai/current/ai-factory/model/library)

**Implementation Guides:**
- [ServingRuntime Configuration](/edb-postgres-ai/current/ai-factory/model/configure-servingruntime)
- [InferenceService Management](/edb-postgres-ai/current/ai-factory/model/create-inferenceservice)
- [Observability Implementation](/edb-postgres-ai/current/ai-factory/model/observability)
