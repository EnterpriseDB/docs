...
| mode                     | [aidb.PipelineAutoProcessingMode](/edb-postgres-ai/current/ai-factory/pipeline/reference/knowledge_bases#aidbpipelineautoprocessingmode) |         | Desired auto-processing mode                                                                |
