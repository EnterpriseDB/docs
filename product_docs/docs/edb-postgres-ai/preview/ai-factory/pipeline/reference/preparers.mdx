...
This reference documentation for Pipelines preparers includes information on the functions and views available in the aidb extension related to [preparers](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/). See [Usage](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/usage) and [Examples](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/examples) for more details.
...
| options                 | JSONB                                                          | Configuration options for the data preparation operation. Uses the same API as the [data preparation primitives](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/primitives). |
...
| options                 | JSONB                                                          | '{}'::JSONB | Configuration options for the data preparation operation. Uses the same API as the [data preparation primitives](/edb-postgres-ai/1.3/ai-factory/pipeline/preparers/primitives). |
