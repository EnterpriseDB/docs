...
-   [Model Serving Concepts](/edb-postgres-ai/current/ai-factory/model/model-serving-explained/)
-   [Model Serving Terminology](/edb-postgres-ai/current/ai-factory/concepts/terminology)
...
-   [How-To Guides: Model Serving](/edb-postgres-ai/current/ai-factory/model/how-to-deploy-ai-models)
...
-   Read the [Model Serving Concepts](/edb-postgres-ai/current/ai-factory/model/model-serving-explained/)
-   Review key [Model Serving Terminology](/edb-postgres-ai/current/ai-factory/concepts/terminology)
-   Understand how KServe powers Model Serving in the [AI Factory Concepts](/edb-postgres-ai/current/ai-factory/concepts)
-   Understand [How Model Library relates to Model Serving](/edb-postgres-ai/current/ai-factory/model/library/) (coming soon)

[Follow Learning Path 101 for Model Serving](/edb-postgres-ai/current/ai-factory/learn/101)
...
-   Review the [Concepts](/edb-postgres-ai/current/ai-factory/concepts) and [Terminology](/edb-postgres-ai/current/ai-factory/concepts/terminology)
...
-   [Deploy NVIDIA NIM Container](/edb-postgres-ai/current/ai-factory/model/deploy-nim-container/)
-   [Configure ClusterServingRuntime](/edb-postgres-ai/current/ai-factory/model/configure-servingruntime/)
...
-   [List deployed InferenceServices](/edb-postgres-ai/current/ai-factory/model/monitor-inferenceservice/)
-   [Monitor KServe deployments](/edb-postgres-ai/current/ai-factory/model/monitor-inferenceservice/) (coming soon)


-   Understand traffic routing, canary rollouts, and scaling:


-   [Model serving scaling patterns](/edb-postgres-ai/current/ai-factory/concepts)
-   Future: Advanced How-Tos

[Follow Learning Path 201 for Model Serving](/edb-postgres-ai/current/ai-factory/learn/201)
...
[Follow Learning Path 301 for Model Serving](/edb-postgres-ai/current/ai-factory/learn/301)
...
-   [Model Serving Concepts](/edb-postgres-ai/current/ai-factory/model/model-serving-explained/)
-   [Model Serving How-To Guides](/edb-postgres-ai/current/ai-factory/model/how-to-deploy-ai-models)
