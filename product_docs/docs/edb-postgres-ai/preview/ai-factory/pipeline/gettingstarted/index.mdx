...
The best place to start is with the [Pipelines overview](/edb-postgres-ai/current/ai-factory/pipeline/) to get an understanding of what Pipelines is and how it works.

## Installation

Pipelines is included with the EDB Postgres AI - AI Accelerator suite of tools. To install Pipelines, follow the instructions in the [AI Accelerator Installation Guide](/edb-postgres-ai/current/ai-factory/pipeline/installing/).
...
This example uses simple, processed data. Pipelines can also handle multiple preprocessing steps via [preparers](/edb-postgres-ai/current/ai-factory/pipeline/preparers).
!!!
...
To keep the embeddings up to date, enable live [auto-processing](/edb-postgres-ai/current/ai-factory/pipeline/capabilities/auto-processing):
...
In [Models](/edb-postgres-ai/current/ai-factory/pipeline/models), you can learn how to create more models with Pipelines, including external models from OpenAI API-compatible services.

In [Preparers](/edb-postgres-ai/current/ai-factory/pipeline/preparers), you can learn more about how to create preparers to perform preprocessing steps on your data before embeddings are calculated.

In [Knowledge base](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base), you can learn more about how to use knowledge bases with external data sources, local files, or S3 storage and how to use the knowledge base functions to get the data you need.
