...
To retrieve correct and consistent data, embeddings must be in sync with the source data. Pipelines supports different [auto-processing](/edb-postgres-ai/1.3/ai-factory/pipeline/capabilities/auto-processing) modes achieve this:
