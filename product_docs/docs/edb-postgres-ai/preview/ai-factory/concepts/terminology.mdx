...
AIDB brings vector search, embedding pipelines, and other capabilities to HM-managed Postgres clusters. It is the foundation for AI Factory [Pipelines](/edb-postgres-ai/latest/ai-factory/pipeline/) and Knowledge Bases.
