...
-   [Vector Engine](/edb-postgres-ai/current/ai-factory/vector-engine/) — Vector search in your Postgres clusters.
-   [Pipelines](/edb-postgres-ai/current/ai-factory/pipeline/) — Controlled creation of Knowledge Bases and embeddings.
-   [Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/) — Kubernetes-native, GPU-accelerated model inference.
-   [Gen AI in Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai) — Governed Assistant and Tool development.
...
[See: Hybrid Manager Gen AI Workloads](/edb-postgres-ai/current/hybrid-manager/ai-factory/gen-ai)
...
-   [AI Factory Overview](/edb-postgres-ai/current/ai-factory/)
