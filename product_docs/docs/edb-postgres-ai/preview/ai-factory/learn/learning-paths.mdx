...
## [101 Path — Getting Started with AI Factory](/edb-postgres-ai/current/ai-factory/learn/101)
...
[Start the 101 Path →](/edb-postgres-ai/current/ai-factory/learn/101)

* * *

## [201 Path — Building Production-Ready AI Features](/edb-postgres-ai/current/ai-factory/learn/201)
...
[Start the 201 Path →](/edb-postgres-ai/current/ai-factory/learn/201)

* * *

## [301 Path — Advanced AI Factory Usage and Extensibility](/edb-postgres-ai/current/ai-factory/learn/301)
...
[Start the 301 Path →](/edb-postgres-ai/current/ai-factory/learn/301)
...
-   [Model Serving Quickstart](/edb-postgres-ai/current/ai-factory/model)
