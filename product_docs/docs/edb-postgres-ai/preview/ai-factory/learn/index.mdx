...
-   [Developer quickstart](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-assistant) — Build a customer service assistant
-   [Data Engineer quickstart](/edb-postgres-ai/1.3/ai-factory/pipeline/gettingstarted) — Stand up a RAG pipeline with Pipelines + Vector Engine
-   [Platform quickstart](/edb-postgres-ai/1.3/ai-factory/model/setup-gpu) — Serve a private model with KServe and GPUs
