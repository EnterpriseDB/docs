...
-   Implement tuned [Retrievers](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-retriever) for semantic search.
-   Power [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-assistant) and apps with RAG pipelines.
...
-   [Sovereign AI Concepts](/edb-postgres-ai/1.3/hybrid-manager/ai-factory/sovereign-ai-on-hm)
...
-   Defined and governed with [Rulesets](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-ruleset).
...
-   Build [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-assistant) in Agent Studio.
-   Govern behavior with [Rulesets](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-ruleset ).
-   Add [Tools](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-tool) to safely integrate internal systems.
...
-   Use [Retrievers](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-retriever) to expose search to Assistants or apps.
...
-   Use [Structures](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-structure) and Pipelines to run:
-   AI categorization
...
-   Build [Structures](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-structure).
-   Run as Tools in [Assistants](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-assistant) or standalone Pipelines.
...
→ Start today with [AI Factory 101](/edb-postgres-ai/1.3/ai-factory/learn/101), or deploy your first [Assistant](/edb-postgres-ai/1.3/ai-factory/gen-ai/create-assistant).
