...
1.  [Assistants](/edb-postgres-ai/current/ai-factory/gen-ai/assistants) — Architect assistants that reason, retrieve, and act across tools.
2.  [Tools](/edb-postgres-ai/current/ai-factory/gen-ai/reference/tools/) — Design governed actions that call internal or external systems.
3.  [Create a Tool](/edb-postgres-ai/current/ai-factory/gen-ai/create-tool) — Implement robust, reusable tool integrations for agent workflows.
4.  [Structures](/edb-postgres-ai/current/ai-factory/gen-ai/structures) — Build multi-step pipelines and agent behaviors.
