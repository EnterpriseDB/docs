...
- [Concepts](/edb-postgres-ai/current/ai-factory/gen-ai/concepts) - Component overview
- [Architecture](/edb-postgres-ai/current/ai-factory/gen-ai/architecture) - System design
...
Implementation guide: [Knowledge Base Creation](/edb-postgres-ai/current/ai-factory/gen-ai/create-knowledge-base).
...
- [Knowledge Base Management](/edb-postgres-ai/current/ai-factory/gen-ai/knowledge-bases)
