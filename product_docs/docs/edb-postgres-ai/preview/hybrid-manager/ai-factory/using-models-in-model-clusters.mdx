...
**Hub quick links:**
[Model Serving](/edb-postgres-ai/current/ai-factory/model/serving/) — [Access KServe endpoints](/edb-postgres-ai/current/ai-factory/model/access-kserve-endpoints/)
...
- **Quickstart (Python):** [Quickstart using inference endpoint](/edb-postgres-ai/current/ai-factory/model/quickstart-python-using-inference-endpoint)
...
- **OpenAI API compatibility:** [Using models via OpenAI-compatible SQL calls](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/openai-api-compatibility.mdx)
- **NVIDIA NIM:** [Using NVIDIA NIM in AIDB](/edb-postgres-ai/current/ai-factory/pipeline/models/using-with/using-nvidia-nim/index.mdx)
