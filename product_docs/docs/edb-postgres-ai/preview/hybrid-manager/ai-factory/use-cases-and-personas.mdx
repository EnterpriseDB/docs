...
See [Knowledge Base Creation](/edb-postgres-ai/current/ai-factory/gen-ai/create-knowledge-base) for implementation guidance.
...
See [Customer Service Agent Quickstart](/edb-postgres-ai/current/ai-factory/gen-ai/quickstart-customer-service-agent-ui) for a working example.
...
See [RAG Pipeline Documentation](/edb-postgres-ai/current/ai-factory/pipeline/knowledge_base/) for detailed architecture.
...
See [Model Serving Guide](/edb-postgres-ai/current/ai-factory/model/serving/) for deployment instructions.
...
**Key Workflows**
1. Provision GPU resources following [GPU Setup Guide](/edb-postgres-ai/current/ai-factory/model/setup-gpu)
2. Configure model registries per [Model Library Documentation](/edb-postgres-ai/current/ai-factory/model/library)
3. Monitor inference performance using [Observability Tools](/edb-postgres-ai/current/ai-factory/model/observability)
...
**Key Workflows**
1. Build knowledge bases following [Knowledge Base Management](/edb-postgres-ai/current/ai-factory/gen-ai/manage-knowledge-base)
2. Configure retrievers using [Retriever Creation Guide](/edb-postgres-ai/current/ai-factory/gen-ai/create-retriever)
3. Deploy assistants through [Assistant Configuration](/edb-postgres-ai/current/ai-factory/gen-ai/create-assistant)
...
**Key Workflows**
1. Access model endpoints via [KServe Integration](/edb-postgres-ai/current/ai-factory/model/access-kserve-endpoints)
2. Implement conversation tracking using [Thread Management](/edb-postgres-ai/current/ai-factory/gen-ai/threads)
3. Create custom tools following [Tool Development Guide](/edb-postgres-ai/current/ai-factory/gen-ai/tools)
...
1. Review [Knowledge Base Concepts](/edb-postgres-ai/current/ai-factory/gen-ai/knowledge-bases)
2. Follow [Data Source Integration](/edb-postgres-ai/current/ai-factory/gen-ai/data-sources)
3. Implement [Hybrid Search](/edb-postgres-ai/current/ai-factory/gen-ai/hybrid-kb-best-practices)

### For Customer Service
1. Start with [Assistant Concepts](/edb-postgres-ai/current/ai-factory/gen-ai/assistants)
2. Configure [Rulesets](/edb-postgres-ai/current/ai-factory/gen-ai/rulesets) for behavior control
3. Deploy using [Quickstart UI](/edb-postgres-ai/current/ai-factory/gen-ai/quickstart-customer-service-agent-ui)

### For API Development
1. Deploy models via [InferenceService Creation](/edb-postgres-ai/current/ai-factory/model/create-inferenceservice)
2. Access endpoints following [Python Client Guide](/edb-postgres-ai/current/ai-factory/model/quickstart-python-using-inference-endpoint)
3. Implement monitoring per [Observability Documentation](/edb-postgres-ai/current/ai-factory/model/monitor-inferenceservice)

## Additional Resources

**Architecture References**
- [Gen AI Architecture](/edb-postgres-ai/current/ai-factory/gen-ai/architecture)

**Implementation Guides**

**Related Documentation**
- [Hybrid Manager Overview](/edb-postgres-ai/current/hybrid-manager)
- [Analytics Personas](/edb-postgres-ai/current/analytics/personas)
