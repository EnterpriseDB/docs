...
- **Tool Binding**: Enable external system interactions via [Tools](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/)
...
Thread management provides comprehensive visibility into assistant interactions for debugging and compliance. See [Threads](/edb-postgres-ai/1.3/ai-factory/gen-ai/threads).
...
- [Knowledge Bases Manual](/edb-postgres-ai/1.3/ai-factory/gen-ai/manage-knowledge-base)
- [Tools Documentation](/edb-postgres-ai/1.3/ai-factory/gen-ai/reference/tools/)
