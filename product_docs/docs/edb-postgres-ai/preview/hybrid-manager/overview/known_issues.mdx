...
**Description:** In the current iteration, project boundaries aren’t strictly applied and authorized users on one project may have visibility of the data and databases of other projects. This is why granular project access is available for Hybrid Manager.

**Workaround:** Users have the option to create dedicated object storage for new projects and to enable project isolation. 

**Workaround details:** If you need to isolate project resources, you can configure [dedicated object storage](https://docs:rapeinvi@deploy-preview-472--edb-docs-editorial.netlify.app/docs/edb-postgres-ai/preview/hybrid-manager/using_hybrid_manager/projects/projected-object-storage/) for each project.
