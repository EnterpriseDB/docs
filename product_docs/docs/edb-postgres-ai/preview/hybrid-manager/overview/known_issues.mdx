...
[UPM-67934, Resolved in HM versions 1.3.1 and later.]: #
...
[UPM-67739, Resolved in HM versions 1.3.1 and later.]: #
...
[UPM-65193, tickets says ready for review]: #
...
[UPM-65193, tickets says blocked]: #
...
[UPM-67032, ticket says ready for review]: #
...
[UPM-71454, status says blocked, on hold]: #
...
[UPM-72526, ticket says in progress]: #
...
**Workaround:** Back up any custom dashboards externally by [exporting the dashboard as JSON](https://grafana.com/docs/grafana/latest/dashboards/share-dashboards-panels/#export-a-dashboard-as-json). After an upgrade, manually import them back into Grafana.
...
- `list_objects` & `get_object_details`: The Object Type field must not be empty.
