...
For a general overview of Iceberg, see [Apache Iceberg® with EDB Solutions](/pgaa/latest/).
...
For definitions of analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse, Catalog, AutoPartition, and Analytics Offload—see [Analytics concepts (hub)](/pgaa/latest/).
...
Related: [Analytics concepts (hub)](/pgaa/latest/)
...
2. [Configure an Iceberg catalog connection](/pgaa/latest/) (HM-managed or external).
3. Learn [Tiered Tables concepts](/pgaa/latest/) if integrating with PGD.
4. [Read Iceberg/Delta with or without a catalog](/pgaa/latest/).
