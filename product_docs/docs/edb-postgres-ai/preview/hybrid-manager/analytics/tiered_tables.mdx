...
- **No-catalog offload**: The metadata is stored alongside the data files and managed directly by the object storage file system. PGD uses the [PGFS extension](/edb-postgres-ai/latest/ai-factory/pipeline/pgfs) to connect directly to the object storage.
...
-   [Configure PGD data tiering](/edb-postgres-ai/latest/analytics/tiered_tables_howto) ► Learn how to configure your PGD cluster to manage your date lifecycle by moving Postgres data to object storage. 