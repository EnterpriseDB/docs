...
-   [Configure PGD data tiering](/edb-postgres-ai/current/analytics/tiered_tables_howto) ► Learn how to configure your PGD cluster to manage your date lifecycle by moving Postgres data to object storage. 