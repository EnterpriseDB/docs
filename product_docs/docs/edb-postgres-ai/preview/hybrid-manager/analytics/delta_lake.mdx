...
For a general overview of Delta Lake, see [Understanding Delta Lake with EDB Solutions](/edb-postgres-ai/current/analytics/delta_lake).
...
For definitions of analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse, and Analytics Offload—see [Analytics concepts (hub)](/edb-postgres-ai/current/analytics/analytics-concepts).
...
How-To: [Configure PGFS](/edb-postgres-ai/current/ai-factory/pipeline/pgfs/)
...
2. [Configure PGFS](/edb-postgres-ai/current/ai-factory/pipeline/pgfs/) pointing to your Delta Lake object storage.
...
- [Configure PGFS](/edb-postgres-ai/current/ai-factory/pipeline/pgfs/)
