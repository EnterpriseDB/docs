...
For a general overview of Delta Lake, see [Understanding Delta Lake with EDB Solutions](/pgaa/1.5/delta_lake).
...
For definitions of analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse, and Analytics Offload—see [Analytics concepts (hub)](/pgaa/1.5/analytics-concepts).
