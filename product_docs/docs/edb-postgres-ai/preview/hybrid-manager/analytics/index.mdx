...
Hub quick links: [Analytics Hub](/pgaa/latest/) — [Concepts](/pgaa/latest/analytics-concepts) — [How-Tos](/pgaa/latest#how-tos-runbook-aligned)
...
Next step: [Configure an Iceberg catalog connection](/pgaa/latest/how-to-iceberg-reads-writes-with-catalog)
...
Next step: [Read Iceberg/Delta with or without a catalog](/pgaa/latest/how-to-lakehouse-read-with-without-catalog)
...
Next step: [Tiered Tables concepts](/pgaa/latest/tiered_tables)
...
Next step: [Create a Lakehouse cluster](/pgaa/latest/create-lakehouse-cluster.mdx)
...
- [Analytics concepts (hub)](/pgaa/latest/analytics-concepts) — Understand core patterns and capabilities.
- [Create a Lakehouse cluster](/pgaa/latest/create-lakehouse-cluster.mdx) — Deploy Lakehouse Clusters to enable scalable querying on object storage.
- [Configure an Iceberg catalog connection](/pgaa/latest/how-to-iceberg-reads-writes-with-catalog) — Connect HM-managed or external catalogs to manage Iceberg tables.
- [Read with or without a catalog](/pgaa/latest/how-to-lakehouse-read-with-without-catalog) — Query Iceberg and Delta Lake tables from your Lakehouse Clusters.
- [Read/write without a catalog](/pgaa/latest/how-to-read-write-without-catalog) — Direct file-based access for development and testing.
- [Explore Persona-Based Guidance](/pgaa/latest/personas.mdx) — Tailored recommendations for DBAs, DevOps/SREs, Data Scientists, and Developers.
- [Explore architectures and examples](/pgaa/latest/analytics-concepts) — Concepts and patterns to solve common analytics problems.
- [Analytics How-To Index](/pgaa/latest#how-tos-runbook-aligned) — Step-by-step guides for configurations and operations.

## Explore Further

- [Analytics concepts (hub)](/pgaa/latest/analytics-concepts)
- [Working with Apache Iceberg® in Hybrid Manager](./iceberg)
- [Working with Delta Lake in Hybrid Manager](./delta_lake)
- [Implementing Tiered Tables in Hybrid Manager](./tiered_tables)
- [Lakehouse Clusters in Hybrid Manager](./lakehouse)
- [Persona-Based Guide](/pgaa/latest/personas.mdx)
- [Architectures and examples](/pgaa/latest/analytics-concepts)
- [Analytics How-To Index](/pgaa/latest#how-tos-runbook-aligned)
