...
For foundational concepts about EDB Postgres Lakehouse architecture, see [EDB Postgres Lakehouse: An Overview](/pgaa/latest/lakehouse).
...
For definitions of core analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse Cluster, and Analytics Offload—see [Analytics concepts (hub)](/pgaa/latest/analytics-concepts).
...
How-To: [Read Iceberg/Delta with or without a catalog](/pgaa/latest/how-to-lakehouse-read-with-without-catalog)
...
Learn concepts for [Tiered Tables](/pgaa/latest/tiered_tables)
...
How-To: [Configure an Iceberg catalog connection](/pgaa/latest/how-to-iceberg-reads-writes-with-catalog)
How-To: [Read Iceberg/Delta with or without a catalog](/pgaa/latest/how-to-lakehouse-read-with-without-catalog)
...
How-To: [Create a Lakehouse cluster](/pgaa/latest/create-lakehouse-cluster.mdx)

## Getting started with Lakehouse Clusters in Hybrid Manager

To begin using Lakehouse Clusters with Hybrid Manager:

1. [Provision a Lakehouse cluster](/pgaa/latest/create-lakehouse-cluster.mdx).
2. [Configure PGFS storage locations](/edb-postgres-ai/current/ai-factory/pipeline/pgfs/) pointing to object storage.
3. (Optional) [Configure an Iceberg catalog connection](/pgaa/latest/how-to-iceberg-reads-writes-with-catalog).
4. Learn [Tiered Tables concepts](/pgaa/latest/tiered_tables) if integrating with PGD.
5. Create Lakehouse tables or external readers for Iceberg/Delta data.
6. Query your data using Postgres clients.

## Related How-Tos

- [Create a Lakehouse cluster](/pgaa/latest/create-lakehouse-cluster.mdx)
- [Configure an Iceberg catalog connection](/pgaa/latest/how-to-iceberg-reads-writes-with-catalog)
- [Read Iceberg/Delta with or without a catalog](/pgaa/latest/how-to-lakehouse-read-with-without-catalog)
