...
For foundational concepts about EDB Postgres Lakehouse architecture, see [EDB Postgres Lakehouse: An Overview](/pgaa/latest/).
...
For definitions of core analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse Cluster, and Analytics Offload—see [Analytics concepts (hub)](/pgaa/latest/).
...
How-To: [Read Iceberg/Delta with or without a catalog](/pgaa/latest/)
...
Learn concepts for [Tiered Tables](/pgaa/latest/)
...
How-To: [Configure an Iceberg catalog connection](/pgaa/latest/)
How-To: [Read Iceberg/Delta with or without a catalog](/pgaa/latest/)
...
How-To: [Create a Lakehouse cluster](/pgaa/latest/)

## Getting started with Lakehouse Clusters in Hybrid Manager

To begin using Lakehouse Clusters with Hybrid Manager:

1. [Provision a Lakehouse cluster](/pgaa/latest/).
2. [Configure PGFS storage locations](/edb-postgres-ai/current/ai-factory/pipeline/pgfs/) pointing to object storage.
3. (Optional) [Configure an Iceberg catalog connection](/pgaa/latest/).
4. Learn [Tiered Tables concepts](/pgaa/latest/) if integrating with PGD.
5. Create Lakehouse tables or external readers for Iceberg/Delta data.
6. Query your data using Postgres clients.

## Related How-Tos

- [Create a Lakehouse cluster](/pgaa/latest/)
- [Configure an Iceberg catalog connection](/pgaa/latest/)
- [Read Iceberg/Delta with or without a catalog](/pgaa/latest/)
