...
This page introduces key concepts as they are applied in Hybrid Manager — with links to detailed explanations in the [Analytics Hub](/edb-postgres-ai/current/analytics) for background.
...
For a general introduction, see [What is a Postgres Lakehouse](/edb-postgres-ai/current/analytics/lakehouse).
...
Learn more: [EDB Postgres Lakehouse: An Overview](/edb-postgres-ai/current/analytics/lakehouse)
...
Conceptual overview: [Apache Iceberg® with EDB Solutions](/edb-postgres-ai/current/analytics/iceberg)
...
Conceptual overview: [Understanding Delta Lake with EDB Solutions](/edb-postgres-ai/current/analytics/delta_lake)
...
Conceptual overview: [Understanding Tiered Tables with EDB Postgres](/edb-postgres-ai/current/analytics/tiered_tables)
