...
* [**Guide: Gen AI Builder**](/edb-postgres-ai/current/ai-factory/gen-ai/) &mdash; Requires the `ai` installation module (enabled by default).
...
Requires the `migration` installation module (enabled by default).
