...
* **Consistency:** In multi-location deployments, the Object Storage configuration must be available equally across all locations. (See [multi-dc guidance](edb-postgres-ai/current/hybrid-manager/install/configuring/multi-dc/) for details.)
