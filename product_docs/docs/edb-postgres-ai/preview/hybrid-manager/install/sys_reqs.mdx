...
For a more detailed overview of HM compatibility per LTS/IR version, see [Hybrid Manager platform compatibility](https://www.enterprisedb.com/resources/platform-compatibility#hybrid management).
