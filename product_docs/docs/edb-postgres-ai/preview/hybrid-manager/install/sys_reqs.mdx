...
* **Consistency:** In multi-location deployments, the object storage configuration must be available equally across all locations. (See [multi-dc guidance](/edb-postgres-ai/preview/hybrid-manager/install/configuration/multi_dc/) for details.)
