...
* **SOP: [Set up a custom cert-manager issuer for the HM Portal](/edb-postgres-ai/current/hybrid-manager/install/customization/cert-man/#set-up-a-custom-cert-manager-issuer-for-the-hm-portal)**
...
* **SOP: [Set up a custom x.509 certificate for the Hybrid Manager Portal](/edb-postgres-ai/current/hybrid-manager/install/customization/cert-man/#set-up-a-custom-x509-certificate-for-the-hybrid-manager-portal)**
