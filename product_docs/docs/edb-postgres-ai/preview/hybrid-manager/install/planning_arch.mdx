...
To optimize resource usage and simplify the user interface, you can optionally use HM's modular installation approach. This allows you to deploy only the capabilities your organization requires, reducing the footprint of the installation and hiding UI elements for features you aren't using.
