...
The **core** scenario is mandatory, while the others are optional. If the `scenarios` parameter is omitted from your configuration, the system installs all scenarios by default to maintain backward compatibility.
