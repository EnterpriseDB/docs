...
* [Phase 5: Installing Hybrid Manager](../install_hm/#install-hybrid-manager) &mdash; You have run the installation command and the process seems stuck.
...
If the installation appears stuck after running the [installation Helm command](/edb-postgres-ai/current/hybrid-manager/install/install_hm/#install-hybrid-manager), inspect the preflight status:
