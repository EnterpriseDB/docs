...
For Rancher RKE2 deployments, this is typically a private Harbor registry or another enterprise container registry in your data center.
...
- `<LOCAL_REGISTRY_URI>`: Your destination registry URI (e.g., `harbor.example.com/edbhm`)
