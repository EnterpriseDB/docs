...
To [secure the data encryption key](/tde/current/secure_key/), you can either enter a passphrase of your choice, or bring your own key from a key management provider such as HashiCorp Vault or AWS Key Management Service.
