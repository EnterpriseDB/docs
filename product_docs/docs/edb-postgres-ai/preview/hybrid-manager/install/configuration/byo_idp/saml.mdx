...
redirects:
- /edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/managing_users/byo_idp/saml
---
...
After changing the authentication settings, you need to reconcile the Dex configuration and restart the Dex services for your changes to take effect. See [Applying Dex](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/managing_users/apply_dex_config/). 
