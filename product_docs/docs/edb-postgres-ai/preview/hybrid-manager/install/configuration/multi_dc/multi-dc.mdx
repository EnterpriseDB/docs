...
You must make sure this stanza is properly set in `primary.yaml`, and `secondary.yaml` files:
...
clusterGroups:
  ...
  - domainName: <secondary portal domain>
    # add an additional domainName entry here for additional locations
```
