...
**`spec.scenarios`**: Optional. Ensure you have listed the installation modules you require (options are `core`, `migration`. `ai`, and `analytics`). However, if you don't have this option in your `values.yaml`, all modules are installed by default.
