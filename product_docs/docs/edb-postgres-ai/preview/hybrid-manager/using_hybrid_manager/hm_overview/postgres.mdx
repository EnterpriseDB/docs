...
To see how often the data on the table is refreshed, refer to the values provided for **Estate page > Postgres table** in [Metrics latency](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/monitoring/monitoring_console/metrics_latency/).
