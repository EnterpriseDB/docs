...
-   Health Scores — Scorecards for the health of database indexes, statistics, configuration, and security. 
...
- Use the **Filter** control to display clusters that match the following properties. Each property has a submenu for choosing the specific type or values related to the property.
  ...
  -   Management
      ...
      -   External CNP Clusters - External clusters running CloudNativePG.
      -   Self Managed — External clusters running on a server, VM, etc.
  -   Postgres Version
  -   Project Name
  -   Status
