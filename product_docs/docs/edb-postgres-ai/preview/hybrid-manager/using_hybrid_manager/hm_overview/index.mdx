...
- [**Projects**](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/projects), where you create and manage projects, create and manage clusters, and perform a variety of tasks to manage your cluster and each project.
