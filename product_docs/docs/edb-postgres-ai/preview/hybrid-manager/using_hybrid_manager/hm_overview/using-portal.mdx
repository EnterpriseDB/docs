...
-   View an [assessment of the databases](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/migrations/#migrations-table) that you have connected to the Hybrid Manager to prepare them for migrations.
...
-   Monitor your [analytics clusters](/edb-postgres-ai/current/hybrid-manager/analytics/#lakehouse-clusters), which are Hybrid Manager clusters specialized for analytics workloads.

In the **Catalog** tab of the estate, you can:

-   View all [Apache Iceberg®](/edb-postgres-ai/current/hybrid-manager/analytics/iceberg/) tables attached to or created with the Hybrid Manager.
