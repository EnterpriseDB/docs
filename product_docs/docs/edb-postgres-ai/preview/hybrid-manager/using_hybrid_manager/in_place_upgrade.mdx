...
This release introduces new authentication secrets, updates the DMS configuration, and deprecates several Beacon parameters.
...
1. **Add DMS domain to `values.yaml`.**
   ...
   parameters:
   global:
       dms_domain_name: <your-dms-domain> 
   ```
