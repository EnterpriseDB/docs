...
!!! Note
The Helm upgrade will automatically scale the operator back up.
!!!
...
**2. Remove deprecated Beacon fields**
...
If the `trust_domain` you set in version 1.3.0 differs from your Portal Domain, SPIRE will break.
