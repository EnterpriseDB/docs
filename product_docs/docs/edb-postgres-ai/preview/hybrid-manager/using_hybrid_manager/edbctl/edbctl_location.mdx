...
This command helps managing the locations for Hybrid Manager (HM). With this command, you can create, list, and delete locations associated with the projects in HM.
