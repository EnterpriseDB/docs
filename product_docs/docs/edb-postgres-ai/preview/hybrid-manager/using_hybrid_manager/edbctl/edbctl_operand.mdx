...
```
      ...
      --version string                         <where do they get this version string> (required).
...
```
edbctl operand sync-to-local-registry --source-registry-username <username> --source-registry-password <password> --destination-registry-uri <registry> --destination-registry-username <username> --destination-registry-password <password> --version <version>
```