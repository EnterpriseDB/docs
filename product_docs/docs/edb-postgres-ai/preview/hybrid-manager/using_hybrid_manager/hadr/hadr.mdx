...
description: Learn about best practices for disaster recovery with Hybrid Manager.
---
...
Now that you have learned about best practices for DR with HM on this page, apply the appropriate backup strategies to meet your RTO and RPO requirements. See [Backup considerations](backup_considerations).
