...
To ensure all data is being synchronized as expected, you can use the PGD CLI to [view data group state](/pgd/latest/reference/cli/command_ref/group/show/) or perform [deeper monitoring](/pgd/latest/monitoring/sql/#monitoring-replication-peers) on the replication peers.
