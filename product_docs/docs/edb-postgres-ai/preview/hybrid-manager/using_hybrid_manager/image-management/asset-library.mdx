...
A model is an AI model that can be used in HM. You can utilize these models in conjunction with specific datasets to perform various tasks, including natural language processing, image recognition, and more. See [Knowledge bases](knowledge-bases.mdx) for more information on how to use this tab.
