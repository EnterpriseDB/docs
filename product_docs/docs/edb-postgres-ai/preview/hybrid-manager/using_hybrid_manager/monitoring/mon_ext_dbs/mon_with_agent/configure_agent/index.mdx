...
| `provider.onprem.check_databases_DSN` | N/A                        | When enabled, the HM agent verifies all DSN connections and reports any errors to the terminal by indicating the source of the error with the resource ID during runtime. The default is set to false.                                                                                                                          |
