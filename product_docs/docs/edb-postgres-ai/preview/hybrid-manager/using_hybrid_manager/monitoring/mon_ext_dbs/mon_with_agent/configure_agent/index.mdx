...
|---------------------------------------------|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `provider.onprem.schema_export_max_workers` | N/A                    | Maximum number of workers the HM agent starts in parallel to extract schema from the source database server(s). You can control CPU, memory and disk space usage by the HM agent witht this parameter. The default is set to 10. |
