...
Because AWS RDS databases are managed by a cloud service provider, you can't change their default configurations with psql. Instead, create a parameter group with replication enabled and associate it with your RDS instance.
