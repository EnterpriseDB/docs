...
If you registered an Oracle database with Hybrid Manager via the HM agent, a Migration Portal project is **created automatically** for all the database schemas and dependencies, unless the size of the ingested DDL exceeds the default limit of 300 GB, a [limit customized by yourself](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/controlling_project_creation/#customizing-the-maximum-size-of-projects) or if you [disabled Migration Portal project autocreation](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/controlling_project_creation/#disabling-automatic-migration-portal-project-creation). 
...
If the Migration Portal didn't create projects for your registered databases, create projects manually.
