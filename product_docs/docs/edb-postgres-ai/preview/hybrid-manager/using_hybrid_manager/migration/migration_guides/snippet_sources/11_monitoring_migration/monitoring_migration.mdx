...
On the migrations page, you can see a summary of all migrations in the project. **Migration progress** column on this page displays three metrics for each migration:
...
On the migration details page, you can monitor the progress of your migration using the following tabs:
