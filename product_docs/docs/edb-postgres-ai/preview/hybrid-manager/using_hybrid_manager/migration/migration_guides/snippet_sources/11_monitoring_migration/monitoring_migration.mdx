...
1.  Select the **Overview** tab to see the current state of your migration.
    ...
    If you selected the **Snapshot** option, you migration is finished when the status is **Completed**.
...
1.  Select the **Tables** tab to see more information about all the tables selected for the migration. 
    ...
    For each table, view the source and destination table names, schemas, the snapshot status, the count of columns and rows, as well as the migration rate (for ongoing migrations).
