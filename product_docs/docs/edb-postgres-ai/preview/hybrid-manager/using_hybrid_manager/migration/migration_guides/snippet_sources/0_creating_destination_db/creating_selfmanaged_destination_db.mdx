...
If you don't have a self-managed destination database yet, create one that the EDB DMS Agent can connect to for HM migrations. This example assumes you have installed the Postgres database distribution of your choice and initilized the server.
