...
-   A migration assessment, which provides a summarized view of database schema count, core count, migration complexity, and level of effort. It is available on the [**Migrations** tab](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migrate/migrations/) of the **Estate** page. 
