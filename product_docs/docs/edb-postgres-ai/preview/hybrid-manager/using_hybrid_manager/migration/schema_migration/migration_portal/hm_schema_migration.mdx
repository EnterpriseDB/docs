...
- The size of the ingested DDL exceeds the default limit of 300 GB.
...
- You [disabled the automatic creation of Migration Portal projects](controlling_project_creation/#disabling-the-automatic-creation-of-migration-portal-projects).
