...
The automatic creation of Migration Portal projects fails if the `resource_id` specified for the registered Oracle database contains characters that are invalid.
