...
- Resource ID reset: Modify the `resource_id` in your `beacon_agent.yaml` configuration file and restart the EDB Postgres AI agent, or create a new project and map the agent to that new project to trigger a fresh synchronization.
