...
1.  Remove existing migrations and Kafka clusters. If the command output lists a Kafka resource, you must first delete all migrations to create a clean state.
...
1.  You can start new data migrations that will use the increased broker capacity.