...
Upgrading HM affects the management plane and the HM-managed database clusters. All of the following upgrade paths trigger an automatic restart of the HM console and all of the Postgres clusters created with HM. This results in temporary downtime for your applications. Ensure you schedule these upgrades during a maintenance window to avoid unexpected service interruptions.
