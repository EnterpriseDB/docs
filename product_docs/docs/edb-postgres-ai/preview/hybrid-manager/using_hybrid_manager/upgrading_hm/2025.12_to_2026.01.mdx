...
!!!note Re-add the `scenarios` stanza (only for multi-DC environments)
If you removed the `scenarios:` stanza before the upgrade, you can now add it back to your primary (Hub) and secondaries (Spokes).
!!!