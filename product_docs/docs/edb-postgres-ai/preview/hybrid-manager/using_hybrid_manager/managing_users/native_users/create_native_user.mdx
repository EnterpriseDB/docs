...
For testing or demo environments, you can simplify operations by adding native users. For production deployments, we strongly recommend [configuring an external IdP](/edb-postgres-ai/current/hybrid-manager/install/customization/byo_idp/).
...
[Apply the DEX configuration](/edb-postgres-ai/current/hybrid-manager/using_hybrid_manager/managing_users/apply_dex_config/) to populate the changes.
