...
-   To perform a write leader switchover, from the ellispsis menu, select [**Switchover Write Leader**](cluster-overview-tab.mdx#switchover-write-leader). 
...
More details are available in [Switching the write leader](https://www.enterprisedb.com/docs/pgd/latest/routing/administering).
