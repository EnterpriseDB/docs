...
* Continue to [Read with or without a catalog](/edb-postgres-ai/current/analytics/how-to-lakehouse-read-with-without-catalog).
* Or, try [Read/write without a catalog](/edb-postgres-ai/current/analytics/how-to-read-write-without-catalog).
