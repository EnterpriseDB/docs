...
Manage the data lifecycle of your PGD cluster by moving Postgres data to object storage using three different available methods. Configure PGD data tiering either through the Hybrid Manager Console or manually from your PGD cluster command line.
