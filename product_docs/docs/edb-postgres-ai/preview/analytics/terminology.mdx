...
[Learn more](/edb-postgres-ai/current/analytics/iceberg)
...
[Learn more](/edb-postgres-ai/current/analytics/delta_lake)
...
[Learn more](/edb-postgres-ai/current/analytics/lakehouse)
...
[Learn more](/edb-postgres-ai/current/hybrid-manager/overview/database_types/distributed_highavailability/)
...
[Learn more](/edb-postgres-ai/current/analytics/tiered_tables)
...
[See how-tos](/edb-postgres-ai/current/analytics#how-tos-runbook-aligned)
...
- Supports AWS S3, Google Cloud Storage, Azure Blob Storage, and compatible services
...
[Learn more](/edb-postgres-ai/current/analytics/generic-concepts#open-table-formats)
...
Related concept: [Data Tiering](/edb-postgres-ai/current/analytics/generic-concepts#data-tiering)
...
Related concept: [Separation of Storage and Compute](/edb-postgres-ai/current/analytics/generic-concepts#separation-of-storage-and-compute)
...
- [Learn Analytics Concepts](/edb-postgres-ai/current/analytics/analytics-concepts)
- [Explore EDB Postgres Lakehouse](/edb-postgres-ai/current/analytics/lakehouse)
- [Implement Tiered Tables](/edb-postgres-ai/current/analytics/tiered_tables)
- [See How-To Guides](/edb-postgres-ai/current/analytics#how-tos-runbook-aligned)
