...
**Start here:** [Analytics Accelerator generic concepts](/edb-postgres-ai/current/analytics/generic-concepts)
...
**Continue your journey:** [Analytics Accelerator concepts](/edb-postgres-ai/current/analytics/analytics-concepts) + [How-To Guides](/edb-postgres-ai/current/analytics#how-tos-runbook-aligned)
...
**Advance your expertise:** See [Architecture](/edb-postgres-ai/current/analytics/architecture) and [Reference](/edb-postgres-ai/current/analytics/reference/index.mdx)
...
-   **Role-based guidance:** See [Analytics Accelerator for your role](/edb-postgres-ai/current/analytics/personas.mdx) for resources tailored to your job function.
-   **Solution-oriented examples:** Visit [Analytics in Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/analytics/) for real-world examples.

* * *

## Next steps

-   Build your foundation with [Analytics Accelerator generic concepts](/edb-postgres-ai/current/analytics/generic-concepts)
-   Learn EDB’s approach in [Analytics Accelerator concepts](/edb-postgres-ai/current/analytics/analytics-concepts)
-   Apply your knowledge with [How-To Guides](/edb-postgres-ai/current/analytics#how-tos-runbook-aligned)
-   Explore industry applications via [Analytics in Hybrid Manager](/edb-postgres-ai/current/hybrid-manager/analytics/)
