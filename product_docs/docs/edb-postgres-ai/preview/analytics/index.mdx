...
- [EDB analytics concepts](/edb-postgres-ai/current/analytics/analytics-concepts)
...
- [Lakehouse clusters (EDB Postgres Lakehouse overview)](/edb-postgres-ai/current/analytics/lakehouse)
Review the EDB Postgres® Lakehouse solution and its components for enabling analytics on object storage.

- [Apache Iceberg® with EDB solutions](/edb-postgres-ai/current/analytics/iceberg)
Understand how EDB solutions use Apache Iceberg® to manage large analytical datasets.

- [Delta Lake with EDB solutions](/edb-postgres-ai/current/analytics/delta_lake)
Learn how EDB Postgres® interacts with Delta tables to enable reliable data lakes.

- [Tiered tables with EDB Postgres](/edb-postgres-ai/current/analytics/tiered_tables)
...
- Lakehouse overview: [Lakehouse clusters](/edb-postgres-ai/current/analytics/lakehouse)
- Open formats: [Apache Iceberg®](/edb-postgres-ai/current/analytics/iceberg), [Delta Lake](/edb-postgres-ai/current/analytics/delta_lake)
- Storage locations: see [Reference](/edb-postgres-ai/current/analytics/reference/index.mdx) for functions and configuration
- Reference: [Functions](/edb-postgres-ai/current/analytics/reference/functions.mdx), [PGAA functions](/edb-postgres-ai/current/analytics/reference/pgaa_functions.mdx), [Direct scan](/edb-postgres-ai/current/analytics/reference/directscan.mdx), [Datasets](/edb-postgres-ai/current/analytics/reference/datasets.mdx)

## Use With PGD (Manual/Reference)

- Concepts: [Tiered Tables](/edb-postgres-ai/current/analytics/tiered_tables)

## Use In Hybrid Manager (Manual/Reference)

- Getting ready: [Getting setup](/edb-postgres-ai/current/analytics/getting-setup.mdx)
- Provision: [Create a Lakehouse cluster](/edb-postgres-ai/current/analytics/create-lakehouse-cluster.mdx)
- Catalogs: [Configure an Iceberg catalog connection](/edb-postgres-ai/current/analytics/how-to-iceberg-reads-writes-with-catalog)
- Interop: [Read with or without a catalog](/edb-postgres-ai/current/analytics/how-to-lakehouse-read-with-without-catalog)
...
— Core How-Tos
- How-to  [Read with/without a catalog](/edb-postgres-ai/current/analytics/how-to-lakehouse-read-with-without-catalog)
- How-to  [Read/write without a catalog](/edb-postgres-ai/current/analytics/how-to-read-write-without-catalog)
- How-to  [Reads/writes with a catalog](/edb-postgres-ai/current/analytics/how-to-iceberg-reads-writes-with-catalog)
- How-to  [Integrate a third-party catalog](/edb-postgres-ai/current/analytics/how-to-third-party-catalog)


## Where to start

- Start with [Generic analytics concepts](/edb-postgres-ai/current/analytics/generic-concepts) and [Lakehouse overview](/edb-postgres-ai/current/analytics/lakehouse) to understand core ideas.
