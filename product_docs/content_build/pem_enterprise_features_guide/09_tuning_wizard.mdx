...
<figure><img src="../images/tuning_wiz_welcome.png" class="align-center" alt="The Tuning Wizard Welcome dialog" /><figcaption aria-hidden="true"><em>The Tuning Wizard Welcome dialog</em></figcaption></figure>

Click `Next` to continue to the server selection dialog.

<figure><img src="../images/tuning_wiz_server_sel.png" class="align-center" alt="The Select Servers dialog" /><figcaption aria-hidden="true"><em>The Select Servers dialog</em></figcaption></figure>
...
<figure><img src="../images/tuning_wiz_configuration.png" class="align-center" alt="The Configuration dialog" /><figcaption aria-hidden="true"><em>The Configuration dialog</em></figcaption></figure>
...
<figure><img src="../images/tuning_wiz_changes_sum.png" class="align-center" alt="The Tuning Changes Summary dialog" /><figcaption aria-hidden="true"><em>The Tuning Changes Summary dialog</em></figcaption></figure>
...
<figure><img src="../images/tuning_wiz_apply_changes.png" class="align-center" alt="The Schedule or Run? dialog" /><figcaption aria-hidden="true"><em>The Schedule or Run? dialog</em></figcaption></figure>
...
<figure><img src="../images/tuning_wiz_generate_report.png" class="align-center" alt="The Schedule or Run? dialog" /><figcaption aria-hidden="true"><em>The Schedule or Run? dialog</em></figcaption></figure>
...
<figure><img src="../images/tuning_wiz_report.png" class="align-center" alt="The Tuning Wizard report" /><figcaption aria-hidden="true"><em>The Tuning Wizard report</em></figcaption></figure>
...
<figure><img src="../images/tuning_wiz_confirm_chg.png" class="align-center" alt="Confirming a change in the postgresql.conf file" /><figcaption aria-hidden="true"><em>Confirming a change in the postgresql.conf file</em></figcaption></figure>
