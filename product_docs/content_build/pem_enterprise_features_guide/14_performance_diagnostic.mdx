...
<figure><img src="../images/performance_diagnostic_chart_legends.png" class="align-center" alt="Performance Diagnostic dashboard - Show and hide a particular wait event type by click the respective chart legend" /><figcaption aria-hidden="true"><em>Performance Diagnostic dashboard - Show and hide a particular wait event type by click the respective chart legend</em></figcaption></figure>
...
<figure><img src="../images/performance_diagnostic_table_filter.png" class="align-center" alt="Performance Diagnostic - SQL table with filter applied" /><figcaption aria-hidden="true"><em>Performance Diagnostic - SQL table with filter applied</em></figcaption></figure>

<figure><img src="../images/performance_diagnostic_users_table.png" class="align-center" alt="Performance Diagnostic - Users table" /><figcaption aria-hidden="true"><em>Performance Diagnostic - Users table</em></figcaption></figure>

<figure><img src="../images/performance_diagnostic_wait_events.png" class="align-center" alt="Performance Diagnostic - Wait events table" /><figcaption aria-hidden="true"><em>Performance Diagnostic - Wait events table</em></figcaption></figure>
