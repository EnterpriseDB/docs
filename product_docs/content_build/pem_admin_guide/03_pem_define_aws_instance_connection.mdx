...
For detailed information on the `Create - Server` dialog and configuration details for each tab, see [Registering a Server](#registering_server).
...
<figure><img src="../images/create_server_pem_agent_tab_remote_monitoring.png" class="align-center" alt="Create Server dialog - PEM Agent tab" /><figcaption aria-hidden="true"><em>Create Server dialog - PEM Agent tab</em></figcaption></figure>
...
| Manage Probes                | Limited                         | Some of the PEM probes will not return information, and some of the functionalities may be affected. For details about probe functionality, see the [PEM Agent Guide](https://enterprisedb.com/edb-docs). |
