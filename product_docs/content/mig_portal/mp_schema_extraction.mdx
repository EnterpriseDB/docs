...
<figure><img src="images/mp_schema_extraction_paths.png" class="align-center" alt="Enter the path for Linux or Windows." /><figcaption aria-hidden="true"><em>Enter the path for Linux or Windows.</em></figcaption></figure>

1.  Enter a comma-separated list of schemas:

<figure><img src="images/mp_schema_extraction_list.png" class="align-center" alt="Provide a list of schemas." /><figcaption aria-hidden="true"><em>Provide a list of schemas.</em></figcaption></figure>

1.  Enter the file path for the output file:

<figure><img src="images/mp_schema_extraction_target.png" class="align-center" alt="Specify the output file path." /><figcaption aria-hidden="true"><em>Specify the output file path.</em></figcaption></figure>

1.  Enter (yes/no) to extract dependant objects:

<figure><img src="images/mp_schema_dependent_objects.png" class="align-center" alt="Extracting dependent objects." /><figcaption aria-hidden="true"><em>Extracting dependent objects.</em></figcaption></figure>
