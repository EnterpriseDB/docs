      ...
      <Container className="d-flex mw-100 pl-0 pr-0 bg-white ml-0">
        ...
        <MainContent>
          <ContentRow>
            ...
            <div className="card-deck mt-4 d-flex">
              <div className="card rounded shadow-sm  flex-row align-items-center">
                <div className="ml-3">
                  <Icon
            ...
            <ContentRow>
            <h2 className="mb-0 mt-4">EDB Products</h2>
            </ContentRow>
                ...
                <div className="card-title d-flex justify-content-start align-items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="card-text">
                      ...
                      urna mollis ornare vel eu leo. Aenean lacinia bibendum
