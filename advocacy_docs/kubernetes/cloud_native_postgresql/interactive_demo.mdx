...
INFO[0001] Pulling image 'docker.io/rancher/k3d-tools:5.3.0' 
...
INFO[0018] Pulling image 'docker.io/rancher/k3d-proxy:5.3.0' 
INFO[0028] Using the k3d-tools node to gather environment information 
INFO[0082] Starting Node 'k3d-k3s-default-tools'        
INFO[0083] HostIP: using network gateway 172.19.0.1 address 
INFO[0083] Starting cluster 'k3s-default'               
INFO[0083] Starting servers...                          
INFO[0083] Starting Node 'k3d-k3s-default-server-0'     
INFO[0091] All agents already running.                  
INFO[0091] Starting helpers...                          
INFO[0091] Starting Node 'k3d-k3s-default-serverlb'     
INFO[0098] Injecting records for hostAliases (incl. host.k3d.internal) and for 2 network members into CoreDNS configmap... 
INFO[0100] Cluster 'k3s-default' created successfully!  
INFO[0101] You can now use it like this:
...
k3d-k3s-default-server-0   Ready    control-plane,master   59s   v1.22.6+k3s1
```
...
```shell
kubectl apply -f https://get.enterprisedb.io/cnp/postgresql-operator-1.13.0.yaml
__OUTPUT__
...
metadata:
  ...
  creationTimestamp: "2022-02-17T18:40:51Z"
  generation: 1
  name: cluster-example
  namespace: default
  resourceVersion: "2004"
  uid: a069be02-7fe7-43db-8fb8-bdd888e7e413
spec:
  affinity:
...
status:
  certificates:
    ...
    expirations:
      cluster-example-ca: 2022-05-18 18:35:52 +0000 UTC
      cluster-example-replication: 2022-05-18 18:35:52 +0000 UTC
      cluster-example-server: 2022-05-18 18:35:52 +0000 UTC
  ...
  cloudNativePostgresqlCommitHash: b1f8f808
  cloudNativePostgresqlOperatorHash: c32c7516c519718e892658688ebdeeb2bf0b1859bdf3a3e95d28dbb2f6b16455
  configMapResourceVersion:
    metrics:
      postgresql-operator-default-monitoring: "987"
  currentPrimary: cluster-example-1
  currentPrimaryTimestamp: "2022-02-17T18:41:34Z"
  healthyPVC:
  - cluster-example-1
  - cluster-example-2
  - cluster-example-3
  ...
  licenseStatus:
    isImplicit: true
    isTrial: true
    licenseExpiration: "2022-03-19T18:40:51Z"
  ...
  secretsResourceVersion:
    applicationSecretVersion: "953"
    clientCaSecretVersion: "949"
    replicationSecretVersion: "951"
    serverCaSecretVersion: "949"
    serverSecretVersion: "950"
    superuserSecretVersion: "952"
  targetPrimary: cluster-example-1
  targetPrimaryTimestamp: "2022-02-17T18:40:52Z"
...
EnterpriseDB/kubectl-cnp info found version: 1.13.0 for v1.13.0/linux/x86_64
...
----------------             ---------------                --------------------------
cluster-example-ca           2022-05-18 18:35:52 +0000 UTC  89.99
cluster-example-replication  2022-05-18 18:35:52 +0000 UTC  89.99
cluster-example-server       2022-05-18 18:35:52 +0000 UTC  89.99
...
----               -------------  -----------  ----------------  ------  ---         ---------------
cluster-example-1  33 MB          0/5000060    Primary           OK      BestEffort  1.13.0
cluster-example-2  33 MB          0/5000060    Standby (async)   OK      BestEffort  1.13.0
cluster-example-3  33 MB          0/5000060    Standby (async)   OK      BestEffort  1.13.0
```
...
Instances:          3
Ready instances:    2
Current Write LSN:  0/6004CA0 (Timeline: 2 - WAL File: 000000020000000000000006)
...
Name               Sent LSN   Write LSN  Flush LSN  Replay LSN  Write Lag        Flush Lag        Replay Lag       State    Sync State  Sync Priority
----               --------   ---------  ---------  ----------  ---------        ---------        ----------       -----    ----------  -------------
cluster-example-1  0/60000A0  0/60000A0  0/60000A0  0/60000A0   00:00:00.007924  00:00:00.007924  00:00:00.007924  startup  async       0

Instances status
Name               Database Size  Current LSN  Replication role      Status  QoS         Manager Version
----               -------------  -----------  ----------------      ------  ---         ---------------
cluster-example-3  33 MB          0/60000A0    Standby (file based)  OK      BestEffort  1.13.0
cluster-example-2  33 MB          0/6004CA0    Primary               OK      BestEffort  1.13.0
cluster-example-1  33 MB          0/6004CA0    Unknown               OK      BestEffort  1.13.0
```
...
Name               Database Size  Current LSN  Replication role  Status  QoS         Manager Version
----               -------------  -----------  ----------------  ------  ---         ---------------
cluster-example-3  33 MB          0/6004CD8    Standby (async)   OK      BestEffort  1.13.0
cluster-example-2  33 MB          0/6004CD8    Primary           OK      BestEffort  1.13.0
cluster-example-1  33 MB          0/6004CD8    Standby (async)   OK      BestEffort  1.13.0
```
