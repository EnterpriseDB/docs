---
title: 'Installation'
originalFilePath: 'external_sources/cloud_native_operator/src/installation.md'
---
...
You can install the [latest operator manifest](samples/postgresql-operator-0.8.0.yaml)
as follows:

```sh
kubectl apply -f \
  https://docs.enterprisedb.io/cloud-native-postgresql/latest/samples/postgresql-operator-0.8.0.yaml
```
