...
In this guide we will look at how we manage user authentication. 
...
In this guide we looked at how we determine the user authentication mechanism used to authenticate different connection attempts, and how and why we might use some of the more popular authentication methods available in Postgres. There are a number of [other authentication methods](https://www.postgresql.org/docs/12/client-authentication.html) available, however these are typically less widely used and have more specialised applications.
