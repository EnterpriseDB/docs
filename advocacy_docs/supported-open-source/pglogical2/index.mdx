...
v18 will be the final release for which EDB supports pglogical2. This will allow customers time to transition before v19, where we recommend using the native logical replication capabilities.
