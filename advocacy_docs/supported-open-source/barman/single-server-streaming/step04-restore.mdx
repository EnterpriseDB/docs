...
katacodaPanel:
    ...
    initializeCommand: wget -q https://raw.githubusercontent.com/EnterpriseDB/barman-tutorial/main/step04-restore/docker-compose.yaml ; docker-compose up -d ; clear ; docker exec -it -u barman backup /bin/bash
