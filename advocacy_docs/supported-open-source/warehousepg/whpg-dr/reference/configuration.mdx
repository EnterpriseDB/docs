...
| `ssh_user` | No | OS user for SSH connections to segment hosts. Defaults to `gpadmin`. |
| `pg_user` | No | Postgres user for Barman's connections to segments. Defaults to `gpadmin`. |
...
| `ssh_user` | No | OS user for SSH connections to DR segment hosts. Defaults to `gpadmin`. |
| `pg_user` | No | Postgres user for Barman connections. Defaults to `gpadmin`. |
