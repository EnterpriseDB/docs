...
description: Install WHPG Exporter.
---
...
- `WHPG_OBS_DSN`: Your WHPG cluster connection details. The database must be a database with the WHPG Extension installed, and the user must hold the superuser role. This parameter must be the same as `WHPG_OBS_DSN` for the [WHPG Collector](collector_extension#Configure_the_WHPG_Collector).
