...
- Go to **Connections** > **Data Sources** > **Add new data source**.
- Select **Infinity**.
- Enter the Exporter details under **Base URL** (e.g., `http://</WHPG_EXPORTER_HOST:<9187>/api/v1/query`).
- Select **Save & Test**.
...
- Download [WarehousePG dashboard JSON files](https://github.com/warehouse-pg/warehouse-pg-grafana-dashboards/tree/be231d0260a48d04281ffd28a583cd6b47dc23ba/Grafana/provisioning/dashboards).
