...
description: Install WHPG Extension and WHPG Collector.
---

Install WHPG Extension and WHPG Collector on your WHPG cluster coordinator.
...
Where `%{whpg_major_version}` is your Warehouse version (6 or 7).
