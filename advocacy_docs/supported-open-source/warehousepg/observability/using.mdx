...
WarehousePG (WHPG) Observability uses Grafana to visualize your WHPG cluster. EDB maintains a [GitHub repository with seven pre-defined dashboards in JSON format](https://github.com/warehouse-pg/warehouse-pg-grafana-dashboards), along with instructions for easy setup.
