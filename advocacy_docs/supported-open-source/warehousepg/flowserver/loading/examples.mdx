...
In this example, you load Avro-format key and value data as JSON from a Kafka topic named `kafka_topic` into a WarehousePG (WHPG) table named `data_from_kafka`. 
