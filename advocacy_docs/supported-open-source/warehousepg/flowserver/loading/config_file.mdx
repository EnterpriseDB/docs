...
- `column`: Configuration for elements in the Kafka message.
    - `name`: Name of the data element in the Kafka message.
    - `type`: Type of the data element in the Kafka message. Valid values are `json`, and `jsonb`.
...
- `column`: Configuration for elements in the Kafka message.
    - `name`: Name of the data element in the Kafka message.
    - `type`: Name of the data element in the Kafka message. The value must be `json`.
...
- `option`: Additional options for the job.
    - `schedule`: Scheduling options for the job.
        ...
        - `auto_stop_restart_interval`: The interval after which the job will automatically stop and restart.
