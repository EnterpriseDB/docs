...
displayBanner: ''
redirects:
  - /warehousepg/6/ref_guide/modules/extensions/whpg_fdw
  - /warehousepg/7.3/ref_guide/modules/extensions/whpg_fdw
  - /warehousepg/7.4/ref_guide/modules/extensions/whpg_fdw
  - /warehousepg/7.5/ref_guide/modules/extensions/whpg_fdw
  - /warehousepg/7.6/ref_guide/modules/extensions/whpg_fdw
  - /warehousepg/latest/ref_guide/modules/extensions/whpg_fdw
  - /warehousepg/6/ref_guide/modules/edb_modules/whpg_fdw
  - /warehousepg/7.3/ref_guide/modules/edb_modules/whpg_fdw
  - /warehousepg/7.4/ref_guide/modules/edb_modules/whpg_fdw
  - /warehousepg/7.5/ref_guide/modules/edb_modules/whpg_fdw
  - /warehousepg/7.6/ref_guide/modules/edb_modules/whpg_fdw
  - /warehousepg/latest/ref_guide/modules/edb_modules/whpg_fdw
...
2.  [Create a user mapping](#creating-a-user-mapping) for the local WHPG database user that you want to allow to access each server.
3.  [Create a foreign table](#creating-a-foreign-table) for each remote WHPG table that you want to access, or import a foreign schema.
4.  [Import a foreign schema](#importing-a-foreign-schema) to import multiple foreign tables from the remote database at once.
5.  [Construct and run queries](#constructing-and-running-queries).
