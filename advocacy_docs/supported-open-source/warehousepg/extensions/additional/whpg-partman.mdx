---
title: whpg-partman
navTitle: whpg-partman
displayBanner: ''
redirects:
  - /warehousepg/7.3/ref_guide/modules/extensions/whpg-partman
  - /warehousepg/7.4/ref_guide/modules/extensions/whpg-partman
  - /warehousepg/7.5/ref_guide/modules/extensions/whpg-partman
  - /warehousepg/7.6/ref_guide/modules/extensions/whpg-partman
  - /warehousepg/latest/ref_guide/modules/extensions/whpg-partman
  - /warehousepg/7.3/ref_guide/modules/edb_modules/whpg-partman
  - /warehousepg/7.4/ref_guide/modules/edb_modules/whpg-partman
  - /warehousepg/7.5/ref_guide/modules/edb_modules/whpg-partman
  - /warehousepg/7.6/ref_guide/modules/edb_modules/whpg-partman
  - /warehousepg/latest/ref_guide/modules/edb_modules/whpg-partman
description: Learn how to automate time-based and serial ID partition management in WarehousePG using the whpg-partman extension.
---

!!!note Version availability

whpg-partman is available starting with WarehousePG 7.3.0.
!!!
...
The WarehousePG `whpg-partman` module is based on the [`pg_partman`](https://github.com/pgpartman/pg_partman) extension for PostgreSQL. See [Limitations](#limitations) before you use `whpg-partman` on WarehousePG.

## Downloading, installing, and loading the extension

Refer to [Downloading and installing an extension](/supported-open-source/warehousepg/extensions/additional/#downloading-and-installing-an-extension) for installation and setup instructions. The package name is `edb-whpg7-pg_partman`.
...
1.  Register the table with `whpg-partman`, specifying `native` as the partition type:
