...
displayBanner: ''
redirects:
  - /warehousepg/7.3/ref_guide/modules/extensions/whpg-q3c
  - /warehousepg/7.4/ref_guide/modules/extensions/whpg-q3c
  - /warehousepg/7.5/ref_guide/modules/extensions/whpg-q3c
  - /warehousepg/7.6/ref_guide/modules/extensions/whpg-q3c
  - /warehousepg/latest/ref_guide/modules/extensions/whpg-q3c
...
whpg-q3c is available starting with WarehousePG 7.3.0.
!!!
...
Refer to [Downloading and installing an extension](/supported-open-source/warehousepg/extensions/additional/#downloading-and-installing-an-extension) for installation and setup instructions. The package name is `edb-whpg7-q3c`.
