...
!!! Note
    ...
    whpg-utl-raw is only supported from WHPG 6 onwards.
...
Refer to [Downloading and installing an extension](/supported-open-source/warehousepg/extensions/additional/#downloading-and-installing-an-extension) for installation and setup instructions. The package name is `edb-whpg7-utl-raw`.
