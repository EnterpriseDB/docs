...
displayBanner: ''
redirects:
  - /warehousepg/6/ref_guide/modules/extensions/whpg_utl_raw
  - /warehousepg/7.3/ref_guide/modules/extensions/whpg_utl_raw
  - /warehousepg/7.4/ref_guide/modules/extensions/whpg_utl_raw
  - /warehousepg/7.5/ref_guide/modules/extensions/whpg_utl_raw
  - /warehousepg/7.6/ref_guide/modules/extensions/whpg_utl_raw
  - /warehousepg/latest/ref_guide/modules/extensions/whpg_utl_raw
  - /warehousepg/6/ref_guide/modules/edb_modules/whpg_utl_raw
  - /warehousepg/7.3/ref_guide/modules/edb_modules/whpg_utl_raw
  - /warehousepg/7.4/ref_guide/modules/edb_modules/whpg_utl_raw
  - /warehousepg/7.5/ref_guide/modules/edb_modules/whpg_utl_raw
  - /warehousepg/7.6/ref_guide/modules/edb_modules/whpg_utl_raw
  - /warehousepg/latest/ref_guide/modules/edb_modules/whpg_utl_raw
description: Learn about the whpg-utl-raw extension for WarehousePG.
deepToC: true
---

The `whpg-utl-raw` extension extends [orafce](/supported-open-source/warehousepg/extensions/bundled/orafce_ref/) with additional Oracle compatibility features for WarehousePG (WHPG). It implements the `UTL_RAW` package and the `RAW` data type.

## Downloading, installing, and loading the extension

Refer to [Downloading and installing an extension](/supported-open-source/warehousepg/extensions/additional/#downloading-and-installing-an-extension) for installation and setup instructions. The package name is `edb-whpg6-utl-raw` or `edb-whpg7-utl-raw`.
