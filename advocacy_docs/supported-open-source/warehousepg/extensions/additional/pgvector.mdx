...
displayBanner: ''
redirects:
  - /warehousepg/7.3/ref_guide/modules/extensions/pgvector
  - /warehousepg/7.4/ref_guide/modules/extensions/pgvector
  - /warehousepg/7.5/ref_guide/modules/extensions/pgvector
  - /warehousepg/7.6/ref_guide/modules/extensions/pgvector
  - /warehousepg/latest/ref_guide/modules/extensions/pgvector
  - /warehousepg/7.3/ref_guide/modules/edb_modules/pgvector
  - /warehousepg/7.4/ref_guide/modules/edb_modules/pgvector
  - /warehousepg/7.5/ref_guide/modules/edb_modules/pgvector
  - /warehousepg/7.6/ref_guide/modules/edb_modules/pgvector
  - /warehousepg/latest/ref_guide/modules/edb_modules/pgvector
...
pgvector is available starting with WarehousePG 7.3.0.
!!!
...
You can check index creation progress in WarehousePG as described in [CREATE INDEX Progress Reporting](/warehousepg/latest/admin_guide/managing/progress_reporting/#create_index_progress):
...
Use [partitioning](/warehousepg/latest/admin_guide/ddl/ddl-partition/) to perform an approximate search on many different values of the `WHERE` columns:
...
Use pgvector together with [full-text search](/warehousepg/latest/admin_guide/query/textsearch/) for a hybrid search:
