...
displayBanner: ''
redirects:
  - /warehousepg/6/ref_guide/modules/extensions/user_profile
  - /warehousepg/7.3/ref_guide/modules/extensions/user_profile
  - /warehousepg/7.4/ref_guide/modules/extensions/user_profile
  - /warehousepg/7.5/ref_guide/modules/extensions/user_profile
  - /warehousepg/7.6/ref_guide/modules/extensions/user_profile
  - /warehousepg/latest/ref_guide/modules/extensions/user_profile
  - /warehousepg/6/ref_guide/modules/edb_modules/user_profile
  - /warehousepg/7.3/ref_guide/modules/edb_modules/user_profile
  - /warehousepg/7.4/ref_guide/modules/edb_modules/user_profile
  - /warehousepg/7.5/ref_guide/modules/edb_modules/user_profile
  - /warehousepg/7.6/ref_guide/modules/edb_modules/user_profile
  - /warehousepg/latest/ref_guide/modules/edb_modules/user_profile
...
For `user_profile` versions earlier than 1.0.2, manually create the extension's SQLite database before you restart the database, avoiding connection failures for non-local, password-authenticated users:
...
2.  Use the output of the previous command to enable the new extension, along with any other shared libraries. Don't restart WHPG yet:
...
4.  Create the SQLite database for the extension:
