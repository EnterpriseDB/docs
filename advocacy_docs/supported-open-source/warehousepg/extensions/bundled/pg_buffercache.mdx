...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/extensions/bundled/pg_buffercache.md
redirects:
  - /warehousepg/7.5/ref_guide/modules/bundled/pg_buffercache
  - /warehousepg/7.4/ref_guide/modules/bundled/pg_buffercache
  - /warehousepg/7.3/ref_guide/modules/bundled/pg_buffercache
  - /warehousepg/7.5/ref_guide/modules/pg_buffercache
  - /warehousepg/7.4/ref_guide/modules/pg_buffercache
  - /warehousepg/7.3/ref_guide/modules/pg_buffercache
description: Provides access to views for obtaining cluster-wide shared buffer metrics.
