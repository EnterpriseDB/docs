...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/extensions/bundled/gp_check_functions.md
redirects:
  - /warehousepg/6/ref_guide/modules/bundled/gp_check_functions
description: >-
  Provides views to check for orphaned and missing relation files, and a
