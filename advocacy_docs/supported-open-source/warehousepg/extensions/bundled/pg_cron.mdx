...
title: pg_cron
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/extensions/bundled/pg_cron.md
redirects:
  - /warehousepg/6/ref_guide/modules/bundled/pg_cron
description: Cron-based job scheduler that runs inside the database.
