...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/extensions/bundled/tsm_system_time.md
redirects:
  - /warehousepg/7.5/ref_guide/modules/bundled/tsm_system_time
  - /warehousepg/7.4/ref_guide/modules/bundled/tsm_system_time
  - /warehousepg/7.3/ref_guide/modules/bundled/tsm_system_time
  - /warehousepg/7.5/ref_guide/modules/tsm_system_time
  - /warehousepg/7.4/ref_guide/modules/tsm_system_time
  - /warehousepg/7.3/ref_guide/modules/tsm_system_time
description: Implements the SYSTEM_TIME table sampling method for TABLESAMPLE.
...
The `tsm_system_time` module is installed when you install WarehousePG. Before you can use any of the functions defined in the module, you must register the `tsm_system_time` extension in each database where you want to use the functions. Refer to [Installing Extensions](/warehousepg/7.5/docs/7x/install_guide/additional_modules/) for more information.

<a id="topic_doc"></a>

## Using the tsm_system_time Module
