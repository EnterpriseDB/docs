...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/extensions/bundled/pg_stat_statements.md
redirects:
  - /warehousepg/7.6/ref_guide/modules/bundled/pg_stat_statements
  - /warehousepg/7.5/ref_guide/modules/bundled/pg_stat_statements
  - /warehousepg/7.4/ref_guide/modules/bundled/pg_stat_statements
  - /warehousepg/7.3/ref_guide/modules/bundled/pg_stat_statements
  - /warehousepg/7.6/ref_guide/modules/pg_stat_statements
  - /warehousepg/7.5/ref_guide/modules/pg_stat_statements
  - /warehousepg/7.4/ref_guide/modules/pg_stat_statements
  - /warehousepg/7.3/ref_guide/modules/pg_stat_statements
description: >-
  Tracks execution statistics of all SQL statements. Requires
