...
title: pageinspect
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/extensions/bundled/pageinspect.md
redirects:
  - /warehousepg/6/ref_guide/modules/bundled/pageinspect
  - /warehousepg/7.5/ref_guide/modules/bundled/pageinspect
  - /warehousepg/7.4/ref_guide/modules/bundled/pageinspect
  - /warehousepg/7.3/ref_guide/modules/bundled/pageinspect
  - /warehousepg/7.5/ref_guide/modules/pageinspect
  - /warehousepg/7.4/ref_guide/modules/pageinspect
  - /warehousepg/7.3/ref_guide/modules/pageinspect
description: >-
  Provides functions for low-level inspection of the contents of database pages,
