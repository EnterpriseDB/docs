...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/extensions/bundled/gp_legacy_string_agg.md
redirects:
  - /warehousepg/latest/ref_guide/modules/bundled/gp_legacy_string_agg
  - /warehousepg/6/ref_guide/modules/bundled/gp_legacy_string_agg
  - /warehousepg/7.5/ref_guide/modules/bundled/gp_legacy_string_agg
  - /warehousepg/7.4/ref_guide/modules/bundled/gp_legacy_string_agg
  - /warehousepg/7.3/ref_guide/modules/bundled/gp_legacy_string_agg
  - /warehousepg/7.5/ref_guide/modules/gp_legacy_string_agg
  - /warehousepg/7.4/ref_guide/modules/gp_legacy_string_agg
  - /warehousepg/7.3/ref_guide/modules/gp_legacy_string_agg
description: >-
  Implements the legacy, single-argument string_agg() aggregate function from
  WarehousePG 5.
...
The `gp_legacy_string_agg` module is installed when you install WarehousePG. Before you can use the function defined in the module, you must register the `gp_legacy_string_agg` extension in each database where you want to use the function. Refer to [Installing Extensions](/warehousepg/latest/install_guide/additional_modules/) for more information about registering the module.
