...
### <a id="topic_nby_j1b_dq"></a>Creating the session_level_memory_consumption View
...
### <a id="topic7"></a>The session_level_memory_consumption View
...
### <a id="topic30"></a>Searching the WarehousePG Server Log Files
...
## <a id="topic31"></a>Using gp_toolkit
