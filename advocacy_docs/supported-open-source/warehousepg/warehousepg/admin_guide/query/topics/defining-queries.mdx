...
originalFilePath: admin_guide/query/topics/defining-queries.md
...
**Parent topic:** [SQL: Querying Data](query.mdx)
...
For more information about SQL commands, see [SQL Command Reference](../../../ref_guide/sql_commands/sql_ref.mdx).
