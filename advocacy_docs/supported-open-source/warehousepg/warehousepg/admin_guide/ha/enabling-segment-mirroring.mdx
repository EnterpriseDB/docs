...
2.  Use [gpssh-exkeys](../../utility_guide/ref/gpssh-exkeys.mdx) to ensure that the segment hosts can SSH and remote sync to each other without a password prompt.
