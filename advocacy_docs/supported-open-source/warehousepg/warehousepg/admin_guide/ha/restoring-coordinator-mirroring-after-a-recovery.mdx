...
4.  After the initialization completes, check the status of standby coordinator, cdw. Run [gpstate](../../utility_guide/ref/gpstate.mdx) with the `-f` option to check the standby coordinator status:
