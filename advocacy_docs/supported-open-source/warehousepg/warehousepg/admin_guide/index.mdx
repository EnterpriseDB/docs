...
originalFilePath: admin_guide/index.md
...
-   **[SQL: Querying Data](query/topics/query.mdx)**  
    This topic provides information about using SQL in WarehousePGs.
-   **[External Data Sources](external/working-with-file-based-ext-tables.mdx)**  
...
-   **[Loading and Unloading Data](load/topics/g-loading-and-unloading-data.mdx)**  
