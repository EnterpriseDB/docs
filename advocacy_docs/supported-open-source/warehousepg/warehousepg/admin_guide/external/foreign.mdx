...
originalFilePath: admin_guide/external/foreign.md
...
The WarehousePG distribution includes the [greenplum_fdw](../../ref_guide/modules/greenplum_fdw.mdx) and [postgres_fdw](../../ref_guide/modules/postgres_fdw.mdx) foreign data wrappers.
