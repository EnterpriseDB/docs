...
See [Setting the WarehousePG Recommended OS Parameters](../install_guide/config_os.mdx#topic3__sysctl_file) and [Memory and Resource Management with Resource Queues](workloads.mdx).
...
See [System Monitoring and Maintenance](maintenance.mdx), [Query Profiling](../admin_guide/query/topics/query-profiling.mdx#in198649) and [Monitoring WarehousePG Log Files](logfiles.mdx).
