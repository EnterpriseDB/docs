...
<div className="note"><b>Note:</b> If you are migrating <code>gphdfs</code> from a WarehousePG 5 installation, you perform the migration in the order above in your WarehousePG 5 cluster before you migrate data to WarehousePG 6.</div>

<div className="note"><b>Note:</b> If you are migrating <code>gphdfs</code> from a WarehousePG 4 installation, you perform the migration in a similar order. However, since PXF is not available in WarehousePG 4, you must perform certain actions in the WarehousePG 6 installation before you migrate the data:
<ol>
...
</li><li>Migrate WarehousePG 4 data to WarehousePG 6.</li></ol></div>
