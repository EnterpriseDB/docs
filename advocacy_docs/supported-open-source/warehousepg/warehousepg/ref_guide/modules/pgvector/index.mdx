---
title: pgvector
originalFilePath: ref_guide/modules/pgvector/pgvector.md
redirects:
  - pgvector
...
You can use `pgvector` together with [full-text search](../../../admin_guide/textsearch/full-text-search.mdx) for a hybrid search:
