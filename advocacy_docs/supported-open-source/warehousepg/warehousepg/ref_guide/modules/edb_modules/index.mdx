...
## Downloading, installing, and loading an extension
...
1. Use the output of the previous command to enable the new extension, along any other shared libraries, and restart WHPG:
    ...
    ```bash
    gpconfig -c shared_preload_libraries -v '<other_libraries>,<extension>'
    gpstop -ar
    ```

    Where `<extension>` is the name of your new extension.
