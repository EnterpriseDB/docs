...
Refer to [Downloading, installing, and loading the extension](/supported-open-source/warehousepg/warehousepg/ref_guide/modules/edb_modules/#downloading-installing-and-loading-an-extension) for installation and setup instructions.
