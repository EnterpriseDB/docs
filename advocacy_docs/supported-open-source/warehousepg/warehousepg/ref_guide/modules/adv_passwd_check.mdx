...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/ref_guide/modules/adv_passwd_check.md
...
## <a id="topic_using"></a>Using the advanced_password_check Module
