...
The system catalog [pg_language](../system_catalogs/pg_language.mdx) records information about the currently installed languages. Also, the [psql](../../utility_guide/ref/psql.mdx) command `\dL` lists the installed languages.
