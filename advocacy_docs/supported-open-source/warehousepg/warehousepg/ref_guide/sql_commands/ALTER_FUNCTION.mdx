...
argname
The name of an argument. Note that [ALTER FUNCTION](ALTER_FUNCTION) does not actually pay any attention to argument names, since only the argument data types are needed to determine the function's identity.
