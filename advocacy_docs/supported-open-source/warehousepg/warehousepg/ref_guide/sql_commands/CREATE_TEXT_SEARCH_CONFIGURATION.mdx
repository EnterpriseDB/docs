...
originalFilePath: ref_guide/sql_commands/CREATE_TEXT_SEARCH_CONFIGURATION.md
...
Refer to [Using Full Text Search](../../admin_guide/textsearch/full-text-search.mdx#full-text-search) for further information.
