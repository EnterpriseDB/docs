...
See [Using Functions and Operators](../../admin_guide/query/topics/functions-operators.mdx#topic26/in151167) in the *WarehousePG Administrator Guide*.
...
[ALTER FUNCTION](ALTER_FUNCTION.mdx), [DROP FUNCTION](DROP_FUNCTION.mdx), [GRANT](GRANT.mdx), [LOAD](LOAD.mdx), [REVOKE](REVOKE.mdx), [createlang](../../utility_guide/ref/createdb.mdx)
