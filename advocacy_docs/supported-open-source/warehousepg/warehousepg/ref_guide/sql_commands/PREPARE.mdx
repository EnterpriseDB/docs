...
You can see all prepared statements available in the session by querying the [pg_prepared_statements](../system_catalogs/pg_prepared_statements.mdx) system view.
