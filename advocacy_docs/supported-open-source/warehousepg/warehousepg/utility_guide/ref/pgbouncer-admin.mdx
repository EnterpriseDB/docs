...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/utility_guide/ref/pgbouncer-admin.md
...
### <a id="SOCKETS"></a>SOCKETS, ACTIVE_SOCKETS
