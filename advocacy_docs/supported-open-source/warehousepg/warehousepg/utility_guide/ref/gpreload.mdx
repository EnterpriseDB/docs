...
title: gpreload
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/utility_guide/ref/gpreload.md
...
> **Note** The `gpreload` utility is deprecated and will be removed in the next major release of WarehousePG. Use [ALTER TABLE REPACK BY COLUMNS](../../ref_guide/sql_commands/ALTER_TABLE.mdx) to physically reorder a table based on one or more columns. 
