...
originalFilePath: >-
  https://github.com/warehouse-pg/whpg-docs/blob/main/docs/docs/7x/analytics/pl_perl.md
...
A PL/Perl procedure is similar to a PL/Perl function. Refer to [User-Defined Procedures](../admin_guide/query/topics/functions-operators.mdx#userproc) for more information on procedures in WarehousePG and how they differ from functions.
