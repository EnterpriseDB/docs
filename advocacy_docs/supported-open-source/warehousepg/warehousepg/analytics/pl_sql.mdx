...
For information about WarehousePG SQL conformance, see [Summary of WarehousePG Features](../ref_guide/feature_summary.mdx) in the *WarehousePG Reference Guide*.
...
A PL/pgSQL procedure is similar to a PL/pgSQL function. Refer to [User-Defined Procedures](../admin_guide/query/topics/functions-operators.mdx#userproc) for more information on procedures in WarehousePG and how they differ from functions.
