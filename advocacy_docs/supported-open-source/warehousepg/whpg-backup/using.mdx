...
Inspect and clean up the backups recorded in the [backup history database](#understanding-the-backup-history-database). See the [gpbackup reference](reference/gpbackup.mdx#subcommands) for the full subcommand syntax.
