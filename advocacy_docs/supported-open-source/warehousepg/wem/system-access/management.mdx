...
- Input your Prometheus, Loki, and Alertmanager URLs to enable real-time metric graphs, integrated log streaming, and real-time notifications. If these fields are left empty, the corresponding panels in the dashboard remain disabled.
