...
Expand the repository's row for its full path, bucket, and credential details, or use **Edit** and **Delete**, deleting is blocked while the primary or DR cluster still references it.
