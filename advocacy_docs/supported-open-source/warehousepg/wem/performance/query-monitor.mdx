...
!!! Note
    The AI Assistant is an optional feature. An administrator must configure an `ANTHROPIC_API_KEY` for the assistant to be active. The interface shows **AI Enabled** when it's configured. See [AI Assistant](../installing/wem#ai-assistant) in the WEM configuration for details.
