...
- If you have Admin or Operator privileges, use the **Cancel Query** action to gracefully stop a statement consuming excessive resources.
...
- Filter sessions by database, user, or resource group using the dropdowns above the table.
