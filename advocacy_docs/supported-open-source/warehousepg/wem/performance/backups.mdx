...
!!! Note
    This interface is for monitoring and auditing only; it can't be used to start, schedule, delete, or restore backups. For these operations, contact your system administrator to perform them using the server-side cluster tools such as `gpbackup` and `gprestore`.
