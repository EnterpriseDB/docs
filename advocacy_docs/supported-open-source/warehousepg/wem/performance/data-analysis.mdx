...
Control the [PXF](https://www.enterprisedb.com/docs/supported-open-source/warehousepg/warehousepg/admin_guide/external/pxf-overview/) service across your cluster using the **PXF** tab. The tab is always present and shows an empty state if PXF isn't installed on the current database.
