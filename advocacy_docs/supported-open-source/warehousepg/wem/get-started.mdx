...
| Management | [Performing administrative management](system-access/management/)
...
Review the **Recent WHPG Log Alerts** card for WarehousePG (WHPG) log events. Open the **Logs** panel for a full audit trail.
