...
- [Prometheus](https://prometheus.io/docs/prometheus/latest/installation/) 3.5.0 or later. You can deploy a dedicated instance for WEM or integrate with your existing enterprise monitoring stack.
