...
Once the Collector package are installed, edit the file `/var/lib/whpg-observability-collector/observability.conf` on the coordinator and configure the following parameters:
