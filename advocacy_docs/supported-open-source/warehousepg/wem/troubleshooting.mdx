...
This guide provides solutions for the most common issues encountered when using WarehousePG Enterprise Manager (WEM). If your issue persists after following these steps, contact your system administrator.
...
Any unsaved changes in forms or the query editor will be lost upon session expiration.
To prevent this issue, save your configuration changes frequently and avoid long periods of idle time with the browser tab open.
