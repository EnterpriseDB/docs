...
[PTT-981]: #
- **Configurable long-running query threshold:** The **Connection & Query Metrics** section in the **Database Metrics** tab on the **System Metrics** page has been improved, and the threshold for flagging long-running queries is now configurable.
