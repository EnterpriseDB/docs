...
[PTT-957]: #
[PTT-944]: #
- **Canary monitoring:** The **Monitoring** page is reorganized into **Current Status**, **Recent Results**, and **Trends** tabs, with additional admin controls. Canary check updates now use pointer-based partial updates, and system-defined checks are protected from modification.
