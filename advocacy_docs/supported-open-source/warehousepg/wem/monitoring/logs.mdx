...
- **Investigate technical error context:** Click the **Details** button in the actions column to view the full technical trace. Use the session ID, PID, and the specific source code file/line reference to pinpoint exactly where a query failed.
