...
The primary goal of the alerting system is to direct your response to system failures. Use the **Alerts**  panel on the left sidebar to identify, mute, and audit notifications throughout the incident lifecycle.
