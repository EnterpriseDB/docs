...
!!! Warning "Alertmanager required"
    You must set the `ALERTMANAGER_URL` in your system environment to enable the Alertmanager integration. See [Configuring WEM](../installing/wem#configuring-wem) for details.
