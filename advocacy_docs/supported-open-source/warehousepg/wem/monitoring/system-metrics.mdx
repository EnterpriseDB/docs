...
- Use the **Combined I/O Activity** graph to determine if spikes in network traffic coincide with disk writes. This pattern usually points to massive data redistributions or heavy background maintenance tasks that should be scheduled during off-peak hours.
