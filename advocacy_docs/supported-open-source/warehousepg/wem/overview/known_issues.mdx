...
[PTT-704]: #
- WEM doesn't support sending alert notifications directly via email. To receive email notifications, configure an email receiver in WEM's bundled Alertmanager configuration. See [Alertmanager notification configuration](https://prometheus.io/docs/alerting/latest/configuration/) for details.
