...
!!! Note 
    While WEM can function as a standalone tool, its capabilities will be limited to real-time cluster status and SQL execution data. Historical trends, host-level metrics, and log aggregation require Prometheus and Loki.
