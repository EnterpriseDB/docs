...
WEM ships two Prometheus alert rule files at `/usr/local/greenplum-db/wem/config/prometheus/alerts/` on the WEM host. For setup instructions, see [Installing the observability stack](../installing/observability-stack).
