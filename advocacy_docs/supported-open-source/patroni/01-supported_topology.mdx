...
EDB currently only supports using Patroni and Postgres _physical Streaming Replication_ with a primary server and two replicas (replicating directly from the primary).
