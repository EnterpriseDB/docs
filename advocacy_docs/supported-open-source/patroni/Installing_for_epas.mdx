---
title: 'Installing Patroni for EDB Postgres Advanced Server'
navTitle: 'Installing Patroni for Advanced Server'
...
Patroni requires Extra Packages for Enterprise Linux ([EPEL](https://fedoraproject.org/wiki/EPEL)). Configure the [PostgreSQL](https://yum.postgresql.org/) yum repository and then install Patroni and its dependencies for etcd:
