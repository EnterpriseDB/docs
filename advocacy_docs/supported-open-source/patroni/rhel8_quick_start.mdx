...
On both **pg-patroni1** and **pg-patroni2** hosts, install the Postgres flavour you'd like. More information about installing [EDB Postgres Advanced Server](/docs/epas/latest/installing/linux_x86_64/) or [EDB Postgres Extended Server](/docs/pge/latest/installing/linux_x86_64/) using the EDB repository can be found in [EDB docs](/docs/).
