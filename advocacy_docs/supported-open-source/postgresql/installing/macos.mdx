...
redirects:
  - /supported-open-source/postgresql/installer/02_installing_postgresql_with_the_graphical_installation_wizard/macos/
  - /postgresql_journey/02_installing/04_macos/
---
