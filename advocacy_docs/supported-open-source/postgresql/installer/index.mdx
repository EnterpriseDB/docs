...
You can use the EDB Language Pack installer with PostgreSQL installations and EDB Postgres Advanced Server installations. For details, see the [Language Pack documentation](/language_pack/).
