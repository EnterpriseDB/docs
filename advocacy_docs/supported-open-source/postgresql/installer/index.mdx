...
We created PostgreSQL installers designed to make it quick and simple to install PostgreSQL on your computer. The installer provides:

- A distribution-independent PostgreSQL installation.
- The popular open-source PostgreSQL administration tool, pgAdmin.
- The Stack Builder package manager (use to download and install drivers, tools, and applications to complement your PostgreSQL installation).

The sections that follow provide information about using the PostgreSQL installer. They also provide information about:
...
- Explanations of how to use Stack Builder to install modules that provide enhanced functionality for PostgreSQL
- Procedures for uninstalling PostgreSQL

## EDB Language Pack Installer

You can use the EDB Language Pack Installer with both PostgreSQL installations and EDB Postgres Advanced Server installations. [Details are in the documentation](/epas/latest/language_pack/).
