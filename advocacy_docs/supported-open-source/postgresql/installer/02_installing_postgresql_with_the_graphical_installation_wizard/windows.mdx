...
---
You can use the graphical installation wizard to install PostgreSQL on Windows. For information about preparing to use command-line tools after installation, see [Command-line tools](#command-line-tools).
