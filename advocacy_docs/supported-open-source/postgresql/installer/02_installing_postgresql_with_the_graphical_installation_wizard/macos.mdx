...
EDB provides MacOS installers for PostgreSQL at the [downloads page](https://www.enterprisedb.com/downloads/postgres-postgresql-downloads) of the EnterpriseDB website. These installers simplify the process of setting up a system.
...
This step is especially important if you plan to use scripts or other software (such as Python's `psycopg2`) that rely on PostgreSQL tools. You may instead [add this directory](https://apple.stackexchange.com/questions/106355/setting-the-system-wide-path-environment-variable-in-mavericks/106814#106814) to the system path.
