...
If you are operating in an air-gapped environment, you can create an usage report as a JSON file within the PGAI agent's configuration page and upload it to the Insights section of the Support Portal. 
