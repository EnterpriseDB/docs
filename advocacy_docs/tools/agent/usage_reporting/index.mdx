...
If you are operating in an air-gapped environment, you can create an usage report as a JSON file within the PGAI agent's configuration page and upload it through the option `PGAI Agent Reporting` under the `Tools` section in the left sidebar menu of the [EDB Customer Portal](https://techsupport.enterprisedb.com). 
