...
For a conceptual overview of this feature and a step-by-step workflow, see [Assessing multiple databases at once](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migrations/assessing_multiple_databases/) and [Enrolling multiple databases for assessment](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migrations/assessing_multiple_databases/enrolling_databases/).
