...
-   Perform a migration assessment for *Oracle and Postgres* databases through the Hybrid Manager, which provides: 
...
-   Perform automatic schema extraction for *Oracle and Postgres* databases through the Hybrid Manager. Refer to the [Oracle to Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migration_guides/oracle_to_hm_managed/) or [Postgres to Hybrid Manager](/edb-postgres-ai/latest/hybrid-manager/using_hybrid_manager/migration/migration_guides/self_managed_pg_to_hm_managed/) migration guides for more information on how to install and configure the agent to collect migration-related data and assessments.
