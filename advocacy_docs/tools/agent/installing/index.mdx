...
Install the agent (also called PGAI agent), your go-to tool for database monitoring, usage reporting, and migration assessment. Explore its full capabilities in [Agent](/tools/agent).
