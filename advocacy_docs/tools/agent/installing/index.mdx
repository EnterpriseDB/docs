...
!!!note 
To install the HM Agent, use a combined approach: Go to the EDB repository to obtain your authentication token, then proceed directly to the installation commands provided on this page, which are OS-specific.
!!!
