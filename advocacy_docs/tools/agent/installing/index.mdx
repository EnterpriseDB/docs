...
Install the PGAI agent (formerly called HM or beacon agent), your go-to tool for database monitoring, usage reporting, and migration assessment. Explore its full capabilities in [Agent](/tools/agent).

To install the PGAI agent, use a combined approach: 
...
Enable the system where you're planning on running the agent to download packages from the EDB repositories for EDB Postgres AI.
