...
1.  You can now [configure the agent to run as a service](/edb-postgres-ai/hybrid-manager/using_hybrid_manager/monitoring/mon_ext_dbs/mon_with_agent/run_as_service/). Reports are generated and sent every 12 hours while it's running. 
