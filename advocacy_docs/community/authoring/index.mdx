---
title: Detailed Repository Setup Guide
navTitle: Repo Setup
...
- Items preceded with $ indicate the Terminal command you should input; Terminal is a program that comes standard on MacOS.
