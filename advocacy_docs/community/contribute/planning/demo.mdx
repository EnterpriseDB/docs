...
## Have a tutorial / HOWTO / anything with a series of steps that you'd like to demonstrate live
...
1. Panel embeds pop up a console at the bottom of the page, and allow execution of commands embedded within the rest of the page. 
...
2. Multi-pane embeds put the entire Katacoda environment inline on the page. They can thus include the file browser, editor, etc. as-needed.
