...
1. Panel embeds ([example](/postgresql_journey/02_installing/05_docker)) pop up a console at the bottom of the page, and allow execution of commands embedded within the rest of the page. 
...
2. Multi-pane embeds ([example](/postgresql_journey/04_developing/connecting_to_postgres/java/02_JDBC)) put the entire Katacoda environment inline on the page. They can thus include the file browser, editor, etc. as-needed.
