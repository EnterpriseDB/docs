...
Unlike a [HOWTO](howto.mdx), the end result of completing a Tutorial need not be of any practical use beyond that of providing the reader familiarity with the system and its terminology. 
...
6. **Describe the steps:** Detail the work to be done before presenting the action. Avoid jargon that is not essential to describing the step, and take time to define new terminology upon first use. Link to additional reading (reference or [guide](guide.mdx)) for concepts, terms and actions that may not be familiar to the audience.
