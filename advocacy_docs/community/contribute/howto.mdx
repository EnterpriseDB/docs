...
### Preface: Usage
The distinction in these guides between [Guides](guide.mdx), HOWTOs and [Tutorials](tutorial.mdx) is drawn for the benefit of the authors and contributors; readers by and large will not care so long as they get the help they're looking for. Use your knowledge of your target audience to choose the format for your article, and title it according to the information it provides. 
...
The format of a HOWTO is similar to that of a [Tutorial](tutorial.mdx), but a tutorial need not produce any useful outcome beyond that of increasing the reader's familiarity with the subject matter.
...
4. **Describe the steps:** Be succinct, so as not to distract from the action itself. Link to additional reading (reference or [guide](guide.mdx)) for actions that may not be familiar to the audience.
...
See also: [Creating and Maintaining a Robust Article](robustness.mdx)
...
- [Planning an article](article_planning.mdx)
