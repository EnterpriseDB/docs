...
It's folks like you, working together, that make Postgres such a great community to be a part of. We appreciate everyone's effort and time to help us make this documentation project the best that it can be, for people new to PostgreSQL, EDB customers, the good people who support those customers, and anyone else who uses PostgreSQL in anger and with love.
...
1. Click the "Edit this page" link at the top-right of the page where you spotted the problem. This'll take you to GitHub (you may need to log in first).
