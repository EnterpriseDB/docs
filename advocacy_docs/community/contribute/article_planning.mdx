...
- ...Just getting started? [Write a Tutorial](tutorial)
...
Create a project that allows you to test each action described in your article, and use it (or recreate it) regularly as you write and test. For more on testing, see: [Creating and Maintaining a Robust Article](robustness).
...
- [Use of Code in Articles](code)
- [Use of Images in Articles](images)
- [HOWTO Guidelines](howto)
- [Guide Guidelines](guide)
- [Tutorial Guidelines](tutorial)
- [Live Demo Guidelines](demo)
