...
So, you'd like to contribute an article to this repository? That's awesome! Below are a few tips that you might find useful. These are all just guidelines - use what you can, ignore what you can't; you're here to share your knowledge, and we're here to help you do that!
...
- ...Just getting started? [Write a Tutorial](tutorial.mdx)
- ...Seeking to perform a specific task? [Write a HOWTO](howto.mdx)
- ...Wanting to better understand a tool, system or concept? [Write a Guide](guide.mdx)
...
Create a project that allows you to test each action described in your article, and use it (or recreate it) regularly as you write and test. For more on testing, see: [Creating and Maintaining a Robust Article](robustness.mdx).
...
- [Writing Style and Approach](style.mdx)
- [Creating and Maintaining a Robust Article](robustness.mdx)
- [Use of Code in Articles](code.mdx)
- [Use of Images in Articles](images.mdx)
- [HOWTO Guidelines](howto.mdx)
- [Guide Guidelines](guide.mdx)
- [Tutorial Guidelines](tutorial.mdx)
- [Live Demo Guidelines](demo.mdx)
