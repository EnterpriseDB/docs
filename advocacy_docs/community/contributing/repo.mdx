...
- <kbd>⌘</kbd>+<kbd>T</kbd> (press the command key and T key together) opens a new tab - use this to execute terminal commands while <code>npm run develop</code> is running
- <kbd>CTRL</kbd>+<kbd>C</kbd> closes a process - use this to return to the terminal prompt after you're done testing with <code>npm run develop</code>
