...
* **Diagrams** &mdash; Provide a visual of a complicated theory. Diagrams must be simple and easy to read.
...
House style to refer to refer to versions is to use "earlier" or "later." For example:
