...
![Query tool connection options](../images/new_connection_options.png)

-   Now select server, database, user, and role to connect and click OK.

![Query tool connection dialog](../images/new_connection_dialog.png)
...
![Query Tool Manage Macros clear the row](../images/query_tool_macros_clear_row.png)
...
![Query Tool Macros Clear All](../images/query_tool_macros_clear_all.png)

To execute a macro, simply select the appropriate shortcut keys, or select it from the *Macros* menu.

![Query Tool Macros Execution](../images/query_tool_macros_execution.png)
