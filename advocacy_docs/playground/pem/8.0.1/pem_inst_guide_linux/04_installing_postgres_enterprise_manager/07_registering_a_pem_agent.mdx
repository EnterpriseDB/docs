...
<div id="registering_a_pem_agent" class="registered_link"></div>
...
For information about using the `pemworker` utility to register a server, please see the [PEM Administrator's Guide](/pem/latest/pem_admin/)
