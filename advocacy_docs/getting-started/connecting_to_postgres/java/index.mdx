...
navTitle: Java
description: Guides to connecting to Postgres from various Java libraries & frameworks
---

In this section, we'll cover the basics of connecting to Postgres from Java. You'll find JDBC and Hibernate mentioned frequently: as these underpin most Java data access strategies, let's take a moment to talk about their history...
