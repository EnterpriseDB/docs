...
navTitle: Hibernate
description: Configuration options and walk-throughs for using Postgres from Hibernate
---
...
Internally, Hibernate connects using [JDBC](02_JDBC.mdx) and configures itself to generate queries based on information returned by the JDBC driver - but you can override this if necessary by specifying a Dialect:
