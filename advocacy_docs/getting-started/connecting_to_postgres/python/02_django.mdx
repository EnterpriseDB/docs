...
2. Create a new Django app and connect it to Postgres
3. Create data models and run a migration to set up the Postgres tables
...
<Katacoda account="shog9" scenario="django2" hideintro="true" clickToShow='Start tutorial' />
