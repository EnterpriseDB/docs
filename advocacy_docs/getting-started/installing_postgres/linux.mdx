...
If you're installing EDB's Postgres Advanced Server, [instructions for Linux & Unix systems can be found on this site](https://www.enterprisedb.com/edb-docs/d/edb-postgres-advanced-server/installation-getting-started/installation-guide-for-linux/12/toc.html), along with [a tool to generate installation scripts for each supported platform](https://repos.enterprisedb.com/).
