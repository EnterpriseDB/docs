...
For example, you might spend some time working on a Java app, backed by a Postgres database. It's built against a specific version of Java, which you don't want interfering with other projects on your machine - so, you put together a configuration like this:
