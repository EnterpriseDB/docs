...
OTEL is supported on the same platforms as the Postgres distribution you're using. Support for the OTEL extension starts with version 17 for PostgreSQL and EDB Postgres Advanced Server and version 12 for EDB Postgres Extended. See:
