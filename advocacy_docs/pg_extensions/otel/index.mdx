...
edb_otel-2.0 breaks compatibility with edb_otel-1.0 due to API changes essential for improvement
in support for metrics and tracing. You can [upgrade from 1.0 to 2.0](upgrading), as long as you then update any logic
that relies on the 1.0 API to [use the new 2.0 API](using). 
