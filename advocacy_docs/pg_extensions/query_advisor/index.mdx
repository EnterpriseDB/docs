...
EDB Query Advisor includes the [Query Advisor](#query-advisor) and the [Statistics Advisor](#statistics-advisor). 
...
See [Using EDB Query Advisor](using) for a description of the `query_advisor_statistics_recommendations` function you can use to generate the statistics recommendation.
