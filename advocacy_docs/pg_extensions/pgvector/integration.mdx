...
deepToC: true
description: How to use pgvector from application code, including Python drivers, JDBC, ODBC, AI application frameworks such as LangChain and LlamaIndex, and PgBouncer connection pooling.
---
