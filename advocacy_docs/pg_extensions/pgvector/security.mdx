...
navTitle: Securing
deepToC: true
description: Access control, encryption, auditing, and compliance considerations for pgvector, including row-level security, TDE, and audit logging on EDB Postgres distributions.
---
...
- Audit access to embedding tables using edb_audit in EDB Postgres Advanced Server or pgaudit in community PostgreSQL, see [Auditing](#auditing) below.
