---
title: Using EDB Failover Slots
navTitle: Using
---

During failover, the slots are not synchronized to the standby immediately because of consistency reasons. The standby can be too behind logical slots or too ahead of logical slots on primary when the edb_failover_slots extension is activated. The extension does verification and only synchronizes slots when it's actually safe.
