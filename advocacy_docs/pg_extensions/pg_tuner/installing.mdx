...
EDB Postgres Tuner is supported on the same platforms as the Postgres distribution you are using. Support for the extensions start with Postgres 11. For details, see:
