...
EDB Wait States is a tool for analyzing performance and tuning. The EDB Wait States contrib module contains two main components: the EDB Wait States Background Worker (BGW) and the EDB Wait States interface. 
