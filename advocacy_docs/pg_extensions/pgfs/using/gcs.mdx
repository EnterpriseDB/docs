...
PGFS supports Google Cloud Storage (GCS) with or without using environment variables. For more information on 

## Example: Private GCS bucket with credentials
...
## Example: Authentication in GKE with environment variables
