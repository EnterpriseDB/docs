...
Storage locations are used by [AIDB volumes](/edb-postgres-ai/latest/ai-factory/pipeline/volumes) or by [Analytics Accelerator](/pgaa/latest/storage_location).
