...
The functions created while creating `PGFS` extension are used to create and manage storage locations. 

These storage locations are used for AIDB volumes or as alias for your cloud buckets.
