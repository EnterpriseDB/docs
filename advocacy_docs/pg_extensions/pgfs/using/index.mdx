...
- s3
redirects:
 - /edb-postgres-ai/1.3/ai-factory/pipeline/pgfs
---

Create and manage storage locations using the PGFS extension.

Storage locations are used by [AIDB volumes](/aidb/latest/external-data-sources.mdx) or by [Analytics Accelerator](/pgaa/latest/read_no_catalog/).
