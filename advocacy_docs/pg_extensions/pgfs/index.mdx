...
deepToc: true
redirects:
- /edb-postgres-ai/ai-factory/1.3/pipelines/pgfs/
- /edb-postgres-ai/ai-factory/innovation-release/pipelines/pgfs/
- /edb-postgres-ai/ai-factory/latest/pipelines/pgfs/
---
...
The AI Database (AIDB) addresses external storage mapped through PGFS as storage locations and abstracts away the details of the underlying storage. To use a PGFS storage location with AIDB, a volume must be created in AIDB. For more information, see [creating AIDB volumes](/aidb/latest/external-data-sources/)
