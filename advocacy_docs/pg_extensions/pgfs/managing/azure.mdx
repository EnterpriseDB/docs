...
`PGFS` supports the following prefixes and formats to indicate an Azure Blob Storage or ADLS Gen2 bucket:
...
- `options` argument in JSON format settings

  | Option           | Description                                                              |
  |------------------|--------------------------------------------------------------------------|
  | `account_name`   | Unique, high-level identifier for your entire storage resource in Azure. |
  | `container_name` | The container name.                                                      |

- `credentials` argument in JSON format
