...
To keep your setup secure and lean, we recommend using IAM roles or Environment variables wherever possible. This avoids persisting sensitive secrets in your database.
...
The generic syntax and usage of static credentials:
