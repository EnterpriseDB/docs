...
- **Tables access statistics for a statement**: This feature allows edb_stat_monitor to easily identify all queries that accessed a given table. This set is at par with the information provided by the pg_stat_statements.
