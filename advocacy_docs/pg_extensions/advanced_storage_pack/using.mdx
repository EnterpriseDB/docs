...
These functions analyze a sample of the source table pages and simulate Bluefin’s compression algorithms to predict storage savings without performing the actual data movement.
