...
```shell
sudo <package-manager> -y install edb-<postgres><postgres_version>-advanced_storage_pack-<extension_version>
```
...
```
sudo dnf -y install edb-as14-advanced_storage_pack-1
```
