...
- Install [pg_cron] - I noticed that we repackage pg_cron but don't have any docs for it. Not sure if we need to. Anyway, install pg_cron should be a prerequisite.
