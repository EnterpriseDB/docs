...
You can control the levels of many warnings and hints. For instance, you can add `PRAGAMA` type markers to turn certain aspects off or on, allowing you to hide messages you're already aware of or keep ones you'd like to be reminded of. 

EDB SPL Check is supported on EDB Postgres Advanced Server versions 12 through 16. 

Some of the key features of EDB SPL Check include the following:
...
- Partially detects dead code, which is code after an unqualified `RETURN` command
