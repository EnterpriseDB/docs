...
The function `plpgsql_show_dependency_tb` shows all the functions, operators, and relations used inside a processed function. For example: 
...
Optional arguments for `plpgsql_show_dependency_tb` include:
