...
EDB SPL Check can't verify queries over temporary tables that are created in PL/pgSQL's function runtime. 

As a solution, do one of the following:
- create a fake temporary table
- disable `plpgsql_check` for this function
