---
title: Installing pg_anonymizer 
navTitle: Installing
---

pg_anonymizer is supported on the same platforms as the Postgres distribution you're using. Support for pg_anonymizer starts with Postgres 13. For details, see:
...
For example, to install pg_anonymizer for EDB Postgres Advanced Server 15 on a RHEL 8 platform:
