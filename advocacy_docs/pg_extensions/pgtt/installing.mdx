...
pgtt is supported on the same platforms as the Postgres distribution you're using. Support for pgtt starts with Postgres 14. For details, see:
...
sudo <package-manager> -y install edb-<postgres><postgres_version>-pgtt4

# For Debian and Ubuntu
sudo <package-manager> -y install edb-<postgres><postgres_version>-pgtt-4
```
...
```shell
sudo dnf -y install edb-as15-pgtt4
```
