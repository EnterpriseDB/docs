...
Prospective users must understand a few foundational details when comparing Oracle’s database with the EDB Postgres Advanced Server (EPAS) database. Having an understanding of these basic characteristics is especially valuable during discussions between Oracle experts and Postgres experts. 
