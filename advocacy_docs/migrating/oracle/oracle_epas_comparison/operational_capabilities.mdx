...
| Public cloud - managed service   | Yes <br/> Oracle Cloud on a proprietary stack including infrastructure and platform (middleware and database) | Yes <br/> EDB Postgres® AI Cloud Services (BigAnimal)                            |
