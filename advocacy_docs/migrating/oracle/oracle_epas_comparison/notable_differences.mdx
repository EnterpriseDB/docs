...
|------------------------------|------------------------------|
| MERGE                        | Yes <br/> Adds support for WHERE clauses to the UPDATE and INSERT of MERGE commands along with FORALL...MERGE commands for compatibility with Oracle beyond community PostgreSQL. | 
