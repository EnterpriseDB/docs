...
|------------------------------|------------------------------|
| MERGE                        | Yes <br/> EPAS 15 provides support for WHERE clause to the UPDATE and INSERT of MERGE command for Oracle compatibility. <br/> Additional Oracle compatible syntax planned for EPAS 16 | 
