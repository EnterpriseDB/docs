...
To assess the feasibility of your migration, look at the tables that follow to understand how the elements you need to migrate are handled in an Oracle to EDB Postgres Advanced Server migration.
