...
### Manual approach for transformig databases
...
See [Analyze feasibility](analyze_feasibility) for information on compatibility between Oracle and EDB Postgres Advanced Server and for information. 
