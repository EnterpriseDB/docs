...
- Don’t skip or skim over steps in the migration journey.
  - Do the planning. 
  - Identify and understand the functional and non-functional requirements.
  - Complete the solution design early to understand IT resource needs.
- Use development and test environments to help identify and resolve migration issues prior to migration to a production environment.
...
- When migrating the database shcema, defer loading indexes and constraints until after migrating the data.
- Engage the assistance of migration experts and PostgreSQL experts for more complex migrations.
