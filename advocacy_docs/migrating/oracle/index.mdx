...
Due to its rich set of features, quality, and strong development community, Postgres is often chosen as the target database for a migration off of Oracle. EDB provides a distribution of PostgreSQL, EDB Postgres Advanced Server, with built-in compatiblity for Oracle and a set of migration tools and services specifically geared toward helping organizations move off of Oracle more easily and with less impact to their business.
