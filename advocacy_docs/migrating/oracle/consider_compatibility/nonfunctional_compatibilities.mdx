...
| Advanced security              | Yes                                | Multiple options available; see [Data encryption options](#data_encryption_options) |
...
| Enterprise management          | Oracle Enterprise Manager | Postgres Enterprise Manager |
...
| Public cloud                     | Oracle Cloud on a proprietary stack including infrastructure and platform (middleware and database) | BigAnimal - EDB managed database service on AWS   |
