---
title: AI Accelerator - Pipelines 3.0.0 release notes
navTitle: Version 3.0.0
originalFilePath: advocacy_docs/edb-postgres-ai/ai-accelerator/rel_notes/src/rel_notes_3.0.0.yml
...
- Ubuntu 24 builds are now available

## Enhancements

<table class="table w-100"><thead><tr><th>Description</th><th width="10%">Addresses</th></tr></thead><tbody>
<tr><td><details><summary>Live auto processing for the Preparer Pipeline</summary><hr/><p>TODO</p>
</details></td><td></td></tr>
...
Complicated parseing of the flattened array was required to work with the return type.
