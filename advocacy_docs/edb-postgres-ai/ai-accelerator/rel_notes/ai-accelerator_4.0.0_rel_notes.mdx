...
In this release, we introduce a completely re-written processing back-end for the knowledge base pipeline.
TODO
we are renaming retrievers to knowledge bases and renaming preparer functions for consistency.
