---
title: EDB Postgres AI - AI Accelerator - Pipelines overview
navTitle: Pipelines overview
description: Where to start with EDB Postgres AI AI Accelerator and the aidb extension.
prevNext: True
---
...
Pipeline's delivers it's functionality through the aidb extension, embedded into the Postgres server. The extension provides a set of functions and views that allow you to interact with the AI data in your Postgres database.
...
You can make best use of the two options by bulk loading your exisiting data into your table with auto embedding disabled. Then you can running aidb.bulk_embedding() to create embeddings for that data. Following that you can enable auto embedding to create embeddings for any future data added to the table.
