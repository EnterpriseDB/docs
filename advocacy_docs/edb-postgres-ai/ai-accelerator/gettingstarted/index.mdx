...
> Note: This example uses simple, processed data. Pipelines can also handle multiple pre-processing steps via [Preparers](../preparers).
...
In the [Preparers](../preparers) section, you can learn more about how to create Preparers in order to perform pre-processing steps on your data before embeddings are calculated.
