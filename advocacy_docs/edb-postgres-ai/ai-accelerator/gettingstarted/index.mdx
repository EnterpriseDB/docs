...
__OUTPUT__
INFO:  bulk_embedding_text found 9 rows in knowledge_base products_knowledge_base
 bulk_embedding
----------------
...
As it stands, vectors were calculated for the data, but if you add data to the table, it isn't automatically embedded. The knowledge_base would go out of sync.
