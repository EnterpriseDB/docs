...
| `replace_credentials` | boolean | false       | If true, replace the credentials for the model provider. If false, the credentials will not be overwritten. |
...
| Column                    | Type  | Description                                              |
|---------------------------|-------|----------------------------------------------------------|
| `delete_model` | jsonb | The name, provider and options of the now deleted model. |
...
| Parameter    | Type             | Default | Description                       |
|--------------|------------------|---------|-----------------------------------|
| `model_name` | text             |         | Name of the model to rerank with. | `text`       | text             |         | Text to rerank.                   |
