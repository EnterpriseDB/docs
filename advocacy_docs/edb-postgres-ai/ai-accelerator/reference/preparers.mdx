...
### `aidb.set_preparer_auto_processing`
...
| mode                            | [aidb.PipelineProcessingMode](./retrievers#aidbpipelineprocessingmode)  |              | Desired processing mode  |

#### Example

```sql
SELECT aidb.set_preparer_auto_processing('test_preparer', 'Live');
SELECT aidb.set_preparer_auto_processing('test_preparer', 'Disabled');
```
