...
-------------------------+---------------------------------+-----------+----------+---------
knowledge base          | text                            |           |          |
auto processing         | aidb.pipelineautoprocessingmode |           |          |
table: unprocessed rows | bigint                          |           |          |
volume: scans completed | bigint                          |           |          |
count(source records)   | bigint                          |           |          |
count(embeddings)       | bigint                          |           |          |
