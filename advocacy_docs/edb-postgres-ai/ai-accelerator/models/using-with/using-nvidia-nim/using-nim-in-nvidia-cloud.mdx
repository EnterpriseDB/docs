...
To use a Nvidia NIM that is hosted in your own environment, you first need a instance of the model. For this tutorial, we will show how to configure an AWS hosted instance with the Nvidia NIM model. We will be using the Nvidia NIM model llama-3.3-70b-instruct.
