...
The [register_retriever_for_table](../reference/#aidbregister_retriever_for_table) function is used to create a retriever for a table data source. This is the function signature, you can see many of those are optional and have defaults
...
A view is available that lists all the retrievers. [aidb.retrievers](../reference/aidbretrievers) also includes some of the retrievers configuration:
