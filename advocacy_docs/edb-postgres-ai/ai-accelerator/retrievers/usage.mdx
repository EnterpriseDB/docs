...
-------------------------------------------------------------------------------
    ...
    source_table_data_column_type     aidb.RetrieverSourceDataFormat,
    source_table_key_column           TEXT DEFAULT 'id',
    vector_table_name                 TEXT DEFAULT NULL,
    vector_table_vector_column        TEXT DEFAULT 'embeddings',
    vector_table_key_column           TEXT DEFAULT 'id',
