...
Before you can create a retriever for a volume, you need to create a volume. The [aidb.create_volume](../reference/retrievers#aidbcreate_volume) function is used to create a volume. This is the function signature. You can see many of those are optional and have defaults.
