...
Before we can register a retriever for a volume, we need to create a volume. The [aidb.create_volume](../reference/volumes#aidbcreate_volume) function is used to create a volume. This is the function signature, you can see many of those are optional and have defaults.
