...
With data preparation, Pipelines can perform common pre-processing steps within the AI Accelerator directly from Postgres. Pipelines can even perform this pre-processing preparation automatically, keeping processed data up to date.
