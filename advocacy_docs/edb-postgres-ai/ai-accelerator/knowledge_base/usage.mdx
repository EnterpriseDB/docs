...
The [aidb.create_table_knowledge_base](../reference/knowledge_bases#aidbcreate_table_knowledge_base) function is used to create a knowledge base for a table data source. This is the function signature. You can see many of the functions parameters are optional and have defaults.
...
-------------------------------------------------------------------------------
    ...
    source_data_type                    aidb.PipelineDataFormat,
...
Before you can create a knowledge base for a volume, you need to create a volume. The [aidb.create_volume](../reference/knowledge_bases#aidbcreate_volume) function is used to create a volume. This is the function signature. You can see many of the function parameters are optional and have defaults.
...
The [aidb.create_volume_knowledge_base](../reference/knowledge_bases#aidbcreate_volume_knowledge_base) function is used to create a knowledge base for a volume data source. This is the function signature. You can see many of the function parameters are optional and have defaults.
