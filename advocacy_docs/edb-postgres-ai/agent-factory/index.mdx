---
title: Agent Factory
navTitle: Agent Factory
indexCards: simple
iconName: Agent Factory
description: Agent Factory is a platform for building and deploying AI agents that run directly in your Postgres database. It provides an agent UI, model serving, and managed orchestration for teams that want to build RAG applications without managing infrastructure.
deepToC: true
navigation:
  - /aidb/latest
