...
The EDB Data Migration Service (EDB DMS) stack requires the Oracle database to have archive log mode enabled and supplemental logging data enabled at the table and database level. For details, see [Preparing Oracle source databases](getting_started/preparing_db/preparing_oracle_source_databases).
