...
directoryDefaults:
  ...
  displayBanner: "Notice: Data Migration Service capabilities are only available as part of the EDB Postgres AI Hybrid Manager, which is currently in tech preview."
navigation:
  - "#Concepts"
  - terminology
  - "#Planning"
...
!!!note
   Data Migration Service capabilities are only available as part of the EDB Postgres AI Hybrid Manager (HM), which is currently in tech preview.
...
EDB DMS is currently a public preview capability that is available for users of EDB Postgres AI Hybrid Manager.
