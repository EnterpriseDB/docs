...
directoryDefaults:
  description: >-
    EDB Data Migration Service is a solution that enables secure,
    fault-tolerant, and performant migrations.
  product: data migration service
  iconName: EdbTransporter
  displayBanner: >-
    Notice: Data Migration Service capabilities are now only available as part
    of the EDB Postgres AI Hybrid Control Plane, which is currently in tech
    preview.
