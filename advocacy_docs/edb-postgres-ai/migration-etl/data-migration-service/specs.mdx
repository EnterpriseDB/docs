...
| Nr. of tables | Snapshot size (GB) | Total data size (GB) | Streaming enabled | Streaming TPS | Total streaming data size (GB) | EPAS resources (CPU/memory in GB) | Time to finish (minutes) | Average transfer speed (GB/min) | Max. target CPU/memory/IOPs usage |
|:--------------|:-------------------|:---------------------|:------------------|:--------------|:-------------------------------|:----------------------------------|:-------------------------|:--------------------------------|:----------------------------------|
...
| 1             | 100                | 100                  | True              | 500           | 1                              | 4/10                              | 53.09                    | 1.90                            | 92%/91%/1.82k IOPs                |
