...
Directory path to the `client-keystore.p12` keystore location file you downloaded from the Hybrid Manager.
...
Directory path to the `client-keystore.p12` keystore location file you downloaded from the Hybrid Manager (same path as `APICURIOREQUEST_CLIENT_KEYSTORE_LOCATION`).
...
Directory path to the `int.truststore.p12` location file you downloaded from the Hybrid Manager (same path as `APICURIOREQUEST_TRUSTSTORE_LOCATION`).
