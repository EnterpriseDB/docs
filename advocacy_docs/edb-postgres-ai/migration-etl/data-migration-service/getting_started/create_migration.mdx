...
After you you have configured the EDB DMS reader or writer to connect to the HCP, create a new migration in the HCP Portal. A migration establishes a sync between the source database and a target database with the help of EDB DMS.
