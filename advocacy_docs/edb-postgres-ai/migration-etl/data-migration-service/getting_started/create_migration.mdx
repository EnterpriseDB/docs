...
After you have configured the EDB DMS Reader (and Writer, for migrations into external databases) to establish connections to the Hybrid Manager (HM), create a new migration in the HM Console. A migration establishes a sync between the source database and a destination database with the help of EDB DMS.
