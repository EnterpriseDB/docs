...
After you have configured the EDB DMS Reader or Writer to connect to the HCP, create a new migration in the HCP Portal. A migration establishes a sync between the source database and a target database with the help of EDB DMS.
