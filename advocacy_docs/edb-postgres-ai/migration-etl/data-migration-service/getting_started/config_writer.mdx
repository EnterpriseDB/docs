...
Derive `RW_SERVICE_HOST` from the `TRANSPORTER_RW_SERVICE_DOMAIN_NAME` you assigned to your instance during installation via the `values.yaml` file and add `/transporter`.
