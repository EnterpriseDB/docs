...
Create migration credentials to enable the EDB DMS Writer on your [auxiliary machine](../terminology/#auxiliary-machine) to connect to the HCP for migrations. You need one set of credentials per destination [HCP project](../../../hybrid-manager/using_hybrid_manager/projects/).
