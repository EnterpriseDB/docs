...
1.  [Enable archive log mode](preparing_oracle_source_databases.mdx#enable-archive-log-mode).
2.  [Enable database supplemental logging](preparing_oracle_source_databases.mdx#enable-database-supplemental-logging).
3.  [Enable supplemental logging for table columns](preparing_oracle_source_databases.mdx#enable-supplemental-logging-for-table-columns).
4.  [Verify redo logs for adequate count and size](preparing_oracle_source_databases.mdx#verify-redo-logs-for-adequate-count-and-size).
5.  [Create a user with limited privileges for data migration](preparing_oracle_source_databases.mdx#create-a-user-with-limited-privileges-for-data-migration).
6.  [Grant `SELECT` on source tables](preparing_oracle_source_databases.mdx#grant-select-on-source-tables).
7.  [Validate configuration](preparing_oracle_source_databases.mdx#validate-configuration).
