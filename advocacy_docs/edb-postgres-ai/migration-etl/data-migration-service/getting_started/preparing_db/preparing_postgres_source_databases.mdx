...
!!! Note 
In the above example output, note that the `max_wal_size` check failed. Despite this, this migration was able to be run successfully without any issues. Therefore, although this check might fail, you may still have enough resources depending on the workload.
!!!
