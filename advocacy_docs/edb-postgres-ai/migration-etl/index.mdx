...
[EDB Data Migration Service](data-migration-service) is a cloud-based, Hybrid Manager service that helps you migrate your data, either with **Snapshot** or **Snapshot + Streaming** capabilities.
