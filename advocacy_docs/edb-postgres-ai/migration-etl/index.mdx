...
[EDB Data Migration Service](data-migration-service) is a cloud-based service that helps you migrate your data to the [Cloud Service](/edb-postgres-ai/cloud-service/).
...
- **Applicable migration scenarios:** From Oracle, PostgreSQL or EDB Postgres Advanced Server to [EDB Cloud Service](/edb-postgres-ai/cloud-service/) databases with PostgreSQL, EDB Postgres Advanced Server or EDB Postgres Extended Server
