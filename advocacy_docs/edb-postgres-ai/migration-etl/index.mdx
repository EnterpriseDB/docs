...
[EDB Data Migration Service](data-migration-service) is a cloud-based service that helps you migrate your data to the Hybrid Control Plane Portal (HCP Portal).

EDB DMS offers a secure and fault-tolerant way to migrate database data to the EDB Postgres AI platform using change data capture and event streaming technologies. This allows the migration to stream any changes in the source database to the HCP-managed database until you decide to cut over.

At the end of a data migration with EDB DMS, the data in your source database will have been copied to a Postgres database managed with EDB Postgres AI Hybrid Control Plane.
