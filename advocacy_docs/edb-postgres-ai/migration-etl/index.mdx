...
The [EDB Postgres Replication Server](/replication-server/latest/) is a tool that helps you keep your Postgres database up-to-date with changes from other databases.

## The EDB Postgres AI Migration Toolkit

The [EDB Postgres Migration Toolkit](/migration-toolkit/latest/) is a set of tools that help you migrate your data from other databases to Postgres.
