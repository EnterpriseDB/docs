...
[EDB Data Migration Service](/edb-postgres-ai/hybrid-manager/using_hybrid_manager/migration/) is a cloud-based, Hybrid Manager service that helps you migrate your data, either with **Snapshot** or **Snapshot + Streaming** capabilities.
