...
# EDB Postgres AI Hybrid Manager v1.2 Release Notes
...
For more, see the [README and implementation guide](https://github.com/EnterpriseDB/upm-prometheus/tree/main/config/k8s-components/patch-add-power-carbon-metrics) or view the [dashboard PR](https://github.com/EnterpriseDB/upm-cp-grafana/pull/137).
...
- [Power & ESG Reporting](../using_hybrid_manager/monitoring/esg)
