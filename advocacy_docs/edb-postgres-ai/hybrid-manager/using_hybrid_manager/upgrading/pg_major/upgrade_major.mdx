...
With Hybrid Manager (HM), users can manage major version upgrades at their discretion. Once a new major version has been validated and published, it becomes available in HM's image library, enabling controlled upgrades for existing clusters.
