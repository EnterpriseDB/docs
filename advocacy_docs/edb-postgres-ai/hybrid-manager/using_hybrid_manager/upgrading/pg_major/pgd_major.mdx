...
1.  After the first data group has been upgraded successfully and is healthy, proceed with the other data or witness groups, one after another, until all groups of the cluster are on the same version.
