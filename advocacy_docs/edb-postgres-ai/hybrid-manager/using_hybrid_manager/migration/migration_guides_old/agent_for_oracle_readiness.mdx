...
description: Learn about using the agent for an Oracle database migration with PG AI Hybrid Manager.
---
...
See [Prepare your Oracle instance](../../monitoring/mon_ext_dbs/mon_with_agent/prepare_postgres_database/) for instructions.
...
[Install the Agent](/tools/agent/installing/) on a machine that has access to the Oracle database.
