...
3.  [Create a destination database cluster managed by the Hybrid Manager](rds_pg_to_pg.mdx#create-a-destination-database-cluster-managed-by-the-hybrid-control-plane)
