---
title: "Configuring and running the EDB DMS Reader for AWS RDS PostgreSQL or Aurora (PostgreSQL compatible) sources"
navTitle: "Configuring Reader for AWS RDS PostgreSQL/Aurora"
deepToC: true
...
## Configuring the EDB DMS Reader for migrations from AWS RDS PostgreSQL or Aurora (PostgreSQL compatible)

Set the variables according to your environment and uncomment the edited lines. See [parameters](/edb-postgres-ai/hybrid-manager/using_hybrid_manager/migration/reader_reference/) for further guidance. The script is reproduced below.
