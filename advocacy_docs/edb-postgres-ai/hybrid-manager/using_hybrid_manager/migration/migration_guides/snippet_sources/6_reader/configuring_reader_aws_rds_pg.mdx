---
title: Configuring and running the EDB DMS Reader for AWS RDS Postgres sources
navTitle: Configuring Reader for AWS RDS Postgres
deepToC: true
...
## Configuring the EDB DMS Reader for migrations from AWS RDS Postgres
