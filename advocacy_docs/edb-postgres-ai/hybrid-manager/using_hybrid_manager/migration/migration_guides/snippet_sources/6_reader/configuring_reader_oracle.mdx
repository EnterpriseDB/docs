...
1.  Set the variables according to your environment and uncomment the edited lines. See [parameters](/edb-postgres-ai/migration-etl/data-migration-service/reader_reference/) for further guidance. The script is reproduced below.
