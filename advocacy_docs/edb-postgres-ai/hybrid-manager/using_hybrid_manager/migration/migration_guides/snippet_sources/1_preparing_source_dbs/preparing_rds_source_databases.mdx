---
title: "Preparing AWS RDS PostgreSQL or Aurora (PostgreSQL compatible) source databases"
navTitle: "Preparing AWS RDS PostgreSQL/Aurora source"

---

Before migrating data from an AWS RDS PostgreSQL or AWS RDS Aurora (PostgreSQL compatible) database using the EDB Data Migration Service, you must prepare the source database to allow the EDB DMS Reader to connect to the source and perfom replication.
