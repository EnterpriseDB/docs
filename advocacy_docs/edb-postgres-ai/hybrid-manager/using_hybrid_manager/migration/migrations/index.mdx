...
navTitle: "Migration assessments in the Console"
...
After you have registered an external database with the Agent (for example, [registered an Oracle database with the Agent](/edb-postgres-ai/hybrid-manager/using_hybrid_manager/migration/migration_guides/oracle_to_hm_managed/#agent-configuration)), the **Migrations** tab that is accesible through the **Estate** page displays a list of external databases you have registered among with a migration assessment that you can use for planning.
