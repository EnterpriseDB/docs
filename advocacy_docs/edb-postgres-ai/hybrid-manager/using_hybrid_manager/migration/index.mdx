...
-   Use the [Data Migration Service](../../../migration-etl/data-migration-service) to perform either a snapshot or streaming replication of a self-managed database, and migrate it to an HCP-managed database. 
