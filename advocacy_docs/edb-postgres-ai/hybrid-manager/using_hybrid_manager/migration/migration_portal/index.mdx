...
Migration Portal is a service that helps you assess, analyze, convert, and migrate Oracle database schemas to EDB Postgres Advanced Server. It is available as a web-based service or as an application in the Hybrid Manager. This documentation focusses on its usage as part of the Hybrid Manager.
