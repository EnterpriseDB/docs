...
1.  Select the **Schemas** tab. You will see a list of schemas and the Migration Portal projects assigned to them.
...
1.  Type **delete project** and select **Confirm Detele** to permanently delete the project. 
