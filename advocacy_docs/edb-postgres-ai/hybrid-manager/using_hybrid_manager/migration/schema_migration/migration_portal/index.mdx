...
- The Migration Portal built into the Hybrid Manager is accessed directly within the product. 
  - Use [project-scoped access](/edb-postgres-ai/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/hm_schema_migration/) to migrate schemas loaded by the Agent.
  - Use the [user's workspace access](/edb-postgres-ai/hybrid-manager/using_hybrid_manager/migration/schema_migration/migration_portal/external_schema_migration/) to migrate externally provided schemas. 
