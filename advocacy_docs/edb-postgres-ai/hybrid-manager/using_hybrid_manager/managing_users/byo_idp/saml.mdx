...
1.  Assign an app name and specify other general settings and select **Next**.    
...
| `idpConnectors`                     | Enter an array of data per IdP connector you want to use for authentication. See the [Dex SAML documentation](https://dexidp.io/docs/connectors/saml/#configuration) for more guidance.               |
...
After changing the authentication settings, you need to reconcile the Dex configuration and restart the Dex services for your changes to take effect. See [Applying Dex](../apply_dex_config/). 
