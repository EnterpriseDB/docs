...
1.  Replace the hash for the owner@mycompany.com user. You will have to replace this value either in your `values.yaml` file or `HybridControlPlane` custom resource, depending on the installation method you use.
