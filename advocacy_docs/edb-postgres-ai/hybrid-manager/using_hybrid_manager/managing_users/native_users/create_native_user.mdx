...
For testing or demo environments, you can simplify operations by adding native users. For production deployments, we strongly recommend [configuring an external IdP](../byo_idp/).
...
[Apply the DEX configuration](../apply_dex_config/) to populate the changes.
