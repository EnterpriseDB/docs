...
You can assign any of the default roles to both types of users, with the exception that only machine users can be estate ingesters.

There are two main categories of roles: organizational-level roles and project-level roles.

## Organization-level roles

You can assign these roles to either human or machine users through the **User Management** option of your user's avatar drop-down menu, located in the far right of the top navigation bar in the HM Console.
...
These roles can be assigned to either human or machine users (with the exception of estate ingester) by selecting **Users** in the left-side navigation menu when viewing a Project.
...
For users who only need to observe the data within a Project, the Project viewer role provides data read-only access.
