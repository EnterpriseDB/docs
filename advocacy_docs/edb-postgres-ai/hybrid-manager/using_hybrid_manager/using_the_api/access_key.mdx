...
| ------------ | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Machine user | 2                | Two access keys, created while the [creating a machine user](../../using_hybrid_manager/monitoring/mon_ext_dbs/mon_with_agent/create_machine_user.mdx). Optionally, can be individually added from **Access keys** tab on machine user's details page using **Create New Key** option. |
| Normal user  | 1                | One access key, [created](access_key.mdx) and managed by user from their home page.                                                                                                                                                                                                 |
