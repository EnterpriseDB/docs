...
**Advanced High Availability:** Also called AHA, this topology hosts at least two groups of a Postgres instance and its replicas across availability zones in a single region. See [Advances high availability cluster](../overview/database_types/advanced_highavailability.mdx) for more information.
