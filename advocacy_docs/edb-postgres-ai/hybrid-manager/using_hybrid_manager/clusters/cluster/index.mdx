...
-   [Health Status](cluster-health-status-tab.mdx) — Replication health status of the cluster (only on clusters with one or more replicas or distributed high-availability clusters).
