...
The user's role in the HCP determines the extent of their access to notification preferences. The notifications are categorized into the following preference sections:
