...
description: Learn how to customize the types of notifications and channels, such as email , webhook, pager duty, with Hybrid Manager.
---
...
The user's role in Hybrid Manager (HM) determines the extent of their access to notification preferences. The notifications are categorized into the following preference sections:
