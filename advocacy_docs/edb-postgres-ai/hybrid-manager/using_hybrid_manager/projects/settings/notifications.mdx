...
description: Learn how to customize the types of notifications and channels, such as email , webhook, pager duty, with PG AI Hybrid Manager.
---
...
The user's role in the Hybrid Manager (HM) determines the extent of their access to notification preferences. The notifications are categorized into the following preference sections:
...
1. Log in to the Hybrid Manager console.
1. From the menu under your name in the top-right panel, select Settings.
1. Select the Notifications tab. Options available are Webhook, Email, and Pager Duty.
1. Select Email and provide the details on the pop-up window:

      1. Email To - Optionally, for the system email notifications (Email group)
      1. Email From - for the email which is sending the email
      1. Host - URL of the email service
      1. Port - port of the email service
      1. Username - username of the email service
      1. Password - of the email service
      1. Select the Save button.
...
1. Log in to the Hybrid Manager console.
1. Select the Projects tab on the top.
1. Select any Project.
1. Go to the Project Overview page.
1. Select Settings on the left-side menu.
1. Select Notifications.
1. Follow the steps mentioned in the global notification setting for each system notification channel.
...
Each notification indicates the level and project the user belongs to with multiple roles assigned in Hybrid Manager.

Select the bell icon at the top of your HM console to view the in-app notifications. You can read a notification, mark it as unread, or archive it.
...
1. Scroll to the Account, Global or Project section to view the events you wish to manage.
