...
- [Kubernetes Concepts](./k8s_concepts) — clarify Kubernetes primitives used by HM.
...
- [Common Scenarios](./common_scenarios) — walk through guided workflows for typical usage patterns.
...
You can also explore [Explanations](../learn/explained/index.mdx) and [How-tos](../learn/how-to/index.mdx) for deeper understanding and task-specific steps.
