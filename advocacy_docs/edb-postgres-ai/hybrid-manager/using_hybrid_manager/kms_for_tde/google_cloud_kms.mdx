...
You can now use this key if you want to enable encryption when you create clusters. The added key will appear as an option when you [enable TDE during cluster creation](../cluster-management/create-clusters/additional-settings.mdx#security).
