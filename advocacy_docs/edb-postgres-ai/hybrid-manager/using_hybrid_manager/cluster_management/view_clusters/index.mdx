...
description: Learn how to use the Cluster view to see the configuration, health, monitoring, query diagnostics, backups, logs, and other properties of a PG AI Hybrid Manager cluster.
navigation:
