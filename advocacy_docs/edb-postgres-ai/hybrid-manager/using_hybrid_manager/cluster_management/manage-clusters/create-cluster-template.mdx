...
description: Learn about creating database cluster templates to use for deploying a PG AI Hybrid Manager cluster.
---
...
2.  Next to the template you want to delete, select the **Delete** icon button.
