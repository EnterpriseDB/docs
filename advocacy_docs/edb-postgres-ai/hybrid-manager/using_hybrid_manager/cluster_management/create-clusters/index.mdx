...
description: Learn about creating a PG AI Hybrid Manager cluster.
navigation:
  - cluster-info
  - cluster-settings
  - db-configuration
...
You can create a database cluster from a template (if you have one) or create the new cluster from scratch.
...
In both cases, the **Create Cluster** ["Choose your path"](#choose-your-path) page opens.
...
After you select **Create Cluster** with valid settings, the cluster begins provision, and you return to the list of clusters. A popup confirms the creation of the cluster, and the new cluster is added to the list of clusters. The cluster is created in the background. You can see the progress in the list of clusters. 
