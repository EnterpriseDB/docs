...
description: Learn how to monitor Kubernetes using dashboards with PG AI Hybrid Manager.
---

These dashboards provide insights into the health and performance of the underlying Kubernetes infrastructure that powers the PG AI Hybrid Manager. 
...
!!!note
    ...
    This dashboard only displays data for on-premise PG AI Hybrid Manager deployments, as Grafana requires node-level access to the API server.
