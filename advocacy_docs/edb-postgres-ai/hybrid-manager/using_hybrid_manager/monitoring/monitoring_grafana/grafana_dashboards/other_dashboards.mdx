...
**Description:** Monitors the energy consumption and estimated carbon footprint of the Hybrid Manager infrastructure. Use this for tracking and potentially optimizing environmental impact.
...
**Description:** Monitors the health and performance of [cert-manager](https://cert-manager.io/docs/), a Kubernetes add-on to automate the management and issuance of TLS certificates. Use this to ensure the proper functioning of certificate management within the Hybrid Manager.
...
**Usage:** Helps ensure that TLS certificates within the Hybrid Manager are being managed correctly and that applications relying on them have valid and up-to-date certificates. Identify potential issues with certificate issuance or renewal before they cause outages.
...
**Usage:** Provides visibility into the backup and restore operations within the Hybrid Manager. Allows you to verify the success of backups, monitor restore processes, and identify any issues with your disaster recovery strategy.
