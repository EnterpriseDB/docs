...
navTitle: Configure the Agent
description: Learn how to configure the agent for monitoring with PG AI Hybrid Manager.
---
...
This will cause log content to appear in the console, but log entries containing line breaks will appear as multiple log entries in the console.
!!!
