...
description: Learn how to create a machine user for monitoring with PG AI Hybrid Manager.
---

In the EDB Postgres® AI Hybrid Control Plane Console, create a machine user that Beacon Agent can use to ingest data into your Estate.
...
Your new machine user is ready to ingest data from the Beacon Agent.
