...
4.  [Install the PG AI Agent](install_agent.mdx)
5.  [Configure the PG AI Agent](configure_agent.mdx)
6.  [Run the PG AI Agent](run_agent.mdx)
7.  [Configure the PG AI Agent to run as a service](run_as_service.mdx)
