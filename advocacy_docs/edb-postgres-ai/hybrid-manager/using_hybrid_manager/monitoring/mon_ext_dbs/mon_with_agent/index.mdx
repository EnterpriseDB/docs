...
To monitor self-managed external Postgres instances from the **Hybrid Manager** that are deployed on bare metal or virtual machines, you must first install the PG AI Agent. The agent provides monitoring and observability metrics to your Hybrid Manager.
