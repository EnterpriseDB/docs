...
The Agent starts sending data to the Hybrid Manager (HM). Follow the logs to monitor the data ingestion process. After a few minutes, you should see the data from the Agent in the HM Console: 
