...
## Setting up the Agent to monitor AWS RDS deployments on HCP

The process of setting up the Agent to monitor all your AWS RDS deployments on HCP involves the following steps.
