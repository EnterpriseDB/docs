...
After you have configured the EDB DMS Reader to establish connections to the Hybrid Manager (HM), create a new migration in the HM Console. A migration establishes a sync between the source database and a destination database with the help of EDB DMS.
...
7.  Under **Destination Type**, select an HM-managed destination cluster and database for the migration. Then, select **Next**.
