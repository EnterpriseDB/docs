...
The template creation workflow and custom build workflow for analytic clusters are the same as the regular cluster creation workflow. See [Creating clusters](../cluster_management/create-clusters/index.mdx).

To learn more about how to use the Analytics/Lakehouse feature of Hybrid Manager, see [Analytics/Lakehouse](../../analytics/index.mdx).
