...
```
edbctl credential import-access-key --name user1 --access-key baak_xyz --address http://localhost --port 8080
...
-   [edbctl config](edbctl_config.mdx)	— Manages configuration settings for edbctl tool
