...
-   [edbctl backup list](edbctl_backup.mdx#edbctl-backup-list) — Displays a list of all available backups.
-   [edbctl backup create](edbctl_backup.mdx#edbctl-backup-create) — Creates a backup of a specified cluster.
-   [edbctl backup delete](edbctl_backup.mdx#edbctl-backup-delete) — Deletes a backup of a specified cluster.
...
```
    ...
    --name string         Backup name (required). The name of the backup to create.
    --location string     Location ID (required).
    --group-id string     PGD cluster group ID to back up. Required for PGD clusters.
