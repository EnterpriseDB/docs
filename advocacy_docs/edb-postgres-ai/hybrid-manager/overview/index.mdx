...
| Area | Description |
|------|-------------|
| **Database provisioning** | Deploy highly available PostgreSQL or Distributed Postgres clusters using UI, templates, or declarative manifests. |
| **AI integration** | Run [sovereign GenAI pipelines](../../ai_factory/), serve models with KServe, and build AI knowledge bases governed by your infrastructure. |
...
Hybrid Manager runs on Kubernetes and supports common enterprise platforms:
...
Hybrid Manager unlocks core functionality across the EDB Postgres AI ecosystem:

- [**AI Factory**](../../ai_factory/) – Build and run GenAI workloads using private data
...
- [**Monitoring**](../../using_hybrid_manager/monitoring/) – Built-in observability stack with Kubernetes and database insights
- [**Cluster Lifecycle**](../../using_hybrid_manager/cluster_management/) – Templates, upgrades, HA settings, and restore workflows
...
- [Explore Learning Resources](../learn/)
