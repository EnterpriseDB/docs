...
description: Lists the different flavours of Postgres distributions supported in Hybrid Manager.
---
...
EDB Postgres Extended Server provides specific enhancements designed for enterprise requirements, particularly in data security &mdash; for example, through [transparent data encryption](/tde/latest) &mdash; and advanced replication with EDB's powerful high-availability and multi-master replication solution &mdash; [EDB Postgres Distributed](/pgd/latest).
...
- [EDB Postgres Extended Server documentation](/pge/latest/)
- [EDB Postgres Advanced Server documentation](/epas/latest/)
