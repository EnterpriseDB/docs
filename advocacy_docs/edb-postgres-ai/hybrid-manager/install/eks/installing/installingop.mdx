...
!!! note
    This script creates secrets for Lakekeeper and Griptape, which are required for the Hybrid Manager platform to function correctly. If you are using
    these features consult the Customization Guide for more information on these secrets and what you need to do with them.
