...
!!!note Recommendations for PORTAL_DOMAIN_NAME and TRANSPORTER_RW_SERVICE_DOMAIN_NAME
    ...
    For consistency and ease of management, derive your TRANSPORTER_RW_SERVICE_DOMAIN_NAME from your PORTAL_DOMAIN_NAME. The most common approach is to replace the portal subdomain with dms-service.
    ...
    |------------------------------------------|-----------------------------------------------|
    | portal.examplecompany.com                | dms-service.examplecompany.com                |
    | portal-dev.examplecompany.com            | dms-service-dev.examplecompany.com            |
    | portal.qa.examplecompany.com             | dms-service.qa.examplecompany.com             |
    | portal.hm001.examplecompany.com          | dms-service.hm001.examplecompany.com          |
    | portal-hm001.examplecompany.com          | dms-service-hm001.examplecompany.com          |
    | portal.hm-us-east-001.examplecompany.com | dms-service.hm-us-east-001.examplecompany.com |
    | portal-hm-us-east-001.examplecompany.com | dms-service-hm-us-east-001.examplecompany.com |
...
8.  Set `parameters.transporter-dp-agent.rw_service_url` to `https://` followed by $TRANSPORTER_RW_SERVICE_DOMAIN_NAME followed by `/transporter`. Following the first of the previously provided examples, this would be `dms-service.examplecompany.com`.
...
You now need to configure your DNS service or your `/etc/hosts` file to point the domains specified in `default-env.sh` to the IP address you obtained from the command above. Those domains are in `PORTAL_DOMAIN_NAME`, `TRANSPORTER_RW_SERVICE_DOMAIN_NAME`, and `BEACON_SERVICE_DOMAIN_NAME`. In the example above, they are set to `portal.examplecompany.com`, `dms-service.examplecompany.com`, and `beacon.examplecompany.com` respectively. 
...
```shell
echo "52.70.180.102 portal.examplecompany.com transporter.examplecompany.com beacon.examplecompany.com" | sudo tee -a /etc/hosts
```
