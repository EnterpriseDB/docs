...
<Tabs>
 ...
 <TabItem value="connected" label=>"Install the operator on RHOS in a network-connected environment">

 <div id="install-connected">
...
!!! Tip
 ...
 <TabItem value="airgapped" label="Install the operator on RHOS in an air-gapped environment">

 <div id="install-airgapped">
