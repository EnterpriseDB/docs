...
After you've configured the secret and created a dedicated bucket, continue with the [Hybrid Manager installation](/edb-postgres-ai/hybrid-manager/install/).
