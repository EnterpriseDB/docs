---
title: Planning Your Kubernetes Cluster for HCP Installation

---

When preparing to deploy HCP, make certain to first consider the following preliminary aspects of the design:
...
By addressing these considerations, you can ensure your Kubernetes cluster is properly configured to support HCP in any deployment scenario.
