...
- [Gen AI Overview in Hybrid Manager](/edb-postgres-ai/gen-ai/index.mdx) — Gen AI capabilities in Hybrid Manager
- [Agent Studio](/edb-postgres-ai/gen-ai/agent-studio.mdx) — Create and manage assistants, tools, structures, and rulesets
- [Gen AI Builder](/edb-postgres-ai/gen-ai/builder.mdx) — Manage Knowledge Bases and Data Lakes
