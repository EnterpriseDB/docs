...
-   Discover and manage NVIDIA NIM models.
...
-   [Integrate private registry — How-To](/edb-postgres-ai/hybrid-manager/learn/how-to/model-library/integrate-private-registry)

## Typical use cases

-   Deploy pre-integrated NVIDIA NIM models (LLMs, embeddings, OCR, rerankers).
...
-   [How to deploy AI models in Hybrid Manager](/edb-postgres-ai/hybrid-manager/learn/how-to/model-library/how-to-deploy-ai-models)
-   [Manage repository metadata](/edb-postgres-ai/hybrid-manager/learn/how-to/model-library/manage-repository-metadata)
-   Full reference on the underlying concepts: [Model Library Hub](/edb-postgres-ai/ai-factory/model/library)
