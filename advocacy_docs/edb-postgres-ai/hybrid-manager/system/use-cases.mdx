...
navTitle: Use Cases
description: Explore why organizations choose Sovereign Data and AI Factory over cloud-based platforms and what workloads it supports.
---

# Common workloads and use cases

EDB Postgres AI Sovereign Data and AI Factory is purpose-built for organizations that require strict control over data, infrastructure, and AI execution. It supports a wide range of workloads while remaining locally managed.
...
Many modern workloads can run in cloud environments—but not all organizations can or should rely on them. Sovereign Data and AI Factory exists to meet the needs of:
...
The following workloads are supported end-to-end on the Sovereign Data and AI Factory system:
