...
All configuration is handled before delivery. Once installed, use the Hybrid Manager web interface to begin deploying Postgres clusters, RAG pipelines, and agentic applications immediately.
...
To learn more about lifecycle operations, visit [Hybrid Manager](../using_hybrid_manager/index)..
