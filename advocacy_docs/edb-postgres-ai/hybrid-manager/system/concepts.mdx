...
The administration node provides additional software packages, licensing, and support tooling for your Sovereign AI and Data Factory. You need one administration node per installation.
