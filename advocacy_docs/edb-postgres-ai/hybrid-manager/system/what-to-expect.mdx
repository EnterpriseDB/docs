...
This page outlines the experience of receiving, setting up, and operating your EDB Postgres AI Sovereign Data and AI Factory system during the first 90 days—from delivery through active use and support.
...
You don’t need to access Kubernetes directly—everything is managed through the console.
