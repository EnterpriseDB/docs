...
Use this checklist to begin applying Hybrid Manager analytics features.

[Analytics Concepts in Hybrid Manager](./analytics_concepts)
Understand the key architectural patterns and capabilities.

[Provision your first Lakehouse Cluster](./learn/how-to/create-lakehouse-cluster)
Deploy Lakehouse Clusters to enable scalable querying on object storage.

[Configure an Iceberg Catalog](./learn/how-to/configure-iceberg-catalog)
Connect HM-managed or external catalogs to manage Iceberg tables.

[Query Iceberg tables](./learn/how-to/query-iceberg-existing-tables)
Learn how to query Iceberg tables from your Lakehouse Clusters.

[Query Delta Lake tables](./learn/how-to/query-delta-lake-tables)
Connect Lakehouse Clusters to existing Delta Lake tables.

[Implement Tiered Tables](./learn/how-to/configure-tiered-autopartition)
Enable PGD AutoPartition and offload cold partitions to Iceberg.

[Monitor Tiered Tables](./learn/how-to/monitor-tiered-tables)
Track the health and performance of your Tiered Table setup.

[Explore Persona-Based Guidance](./personas)
Tailored recommendations for DBAs, DevOps/SREs, Data Scientists, and Developers.

[Solve Business Problems](./solved)
Common analytics use cases and how Hybrid Manager solves them.

[Full How-To Index](./learn/how-to/index)
Step-by-step guides for advanced configurations and operations.
