...
For definitions of core analytics terms used in Hybrid Manager—such as PGFS, PGAA, Lakehouse Cluster, Catalog, AutoPartition, and Analytics Offload—see [Analytics Concepts in Hybrid Manager](./analytics_concepts#key-terms).
...
[How-To: Iceberg use cases in Hybrid Manager](./learn/how-to/iceberg-use-cases)
...
- [Create an Iceberg table in a catalog](./learn/how-to/create-iceberg-catalog-table)
