...
[How-To: Create an Iceberg table in a catalog](./learn/how-to/configure-iceberg-catalog.mdx)
...
- [Create an Iceberg table in a catalog](./learn/how-to/configure-iceberg-catalog.mdx)
