...
For foundational concepts about EDB Postgres Lakehouse architecture, see [EDB Postgres Lakehouse: An Overview](../../explained/lakehouse).
...
[How-To: Query Delta Lake tables](./learn/how-to/query-delta-lake-tables) (to be created)
...
[How-To: Query Tiered Tables in Lakehouse Cluster](./learn/how-to/query-tiered-tables-lakehouse) (to be created)
...
3. (Optional) Configure Iceberg catalog connections.
