...
For definitions of core analytics terms used in Hybrid Manager—such as PGFS, PGAA, Analytics Offload, and Lakehouse Cluster—see [Analytics Concepts in Hybrid Manager](./analytics_concepts#key-terms).
