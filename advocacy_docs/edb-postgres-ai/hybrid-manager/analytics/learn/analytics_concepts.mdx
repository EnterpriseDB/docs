...
This page introduces key concepts as they are applied in Hybrid Manager — with links to detailed explanations in the [Analytics Hub](../../explained/index) for background.
...
For a general introduction, see [What is a Postgres Lakehouse](../../explained/lakehouse).
...
Learn more: [EDB Postgres Lakehouse: An Overview](../../explained/lakehouse)
...
Conceptual overview: [Apache Iceberg with EDB Solutions](../../explained/iceberg)
...
Conceptual overview: [Understanding Delta Lake with EDB Solutions](../../explained/delta-lake)
...
Conceptual overview: [Understanding Tiered Tables with EDB Postgres](../../explained/tiered-tables)
