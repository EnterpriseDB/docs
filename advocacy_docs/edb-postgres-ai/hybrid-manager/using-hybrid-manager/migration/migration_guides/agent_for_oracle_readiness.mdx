...
-   A migration assessment, which provides a summarized view of database schema count, core count, migration complexity, and level of effort. It is available on the [**Migrations** tab](../../estate/migrations) of the **Estate** page. 

-   A migration database [detailed view](../../estate/migrations/migration_database_details_view.mdx), which provides an expanded analysis of **Schemas**, a global and more detailed **Assessment**, as well as a **Migrations** hub that provides direct connections to other tools in the Console that will help you perform migrations. These resources are available when you select a specific Oracle database from the **Estate** page > **Migrations** tab.
