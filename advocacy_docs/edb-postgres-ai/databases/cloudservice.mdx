...
The EDB Postgres AI Cloud Service, formerly known as BigAnimal is an evolution of the service to offer a holistic platform which offers hybrid data estate management, observability, and AI capabilities. 
