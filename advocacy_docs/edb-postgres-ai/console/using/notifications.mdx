...
- User notifications channels - where you can receive notifications on email or in-app inbox or both. These notifications alerts all users who have enabled them and are eligible to receive the notifications for that event.
