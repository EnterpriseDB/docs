---
title: Managing TDE keys for a Project
navTitle: Managing TDE keys
description: Add and delete TDE keys for your project
---

TDE (Transparent Data Encryption) uses keys which must be securely stored in the cloud. 

You can add and delete TDE keys for your project in the BigAnimal console.
