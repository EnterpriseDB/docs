---
title: "Machine users"
navTitle: "Machine users"
description: "Create machine users to safely drive automated access to EDB Postgres AI"
---
...
1. Select the **Expires in (1-365 Day/s)** value for the access key.
