...
navTitle: Schema Ingestion from Cloud Service
description: How to ingest schemas from the EDB Postgres AI Cloud Service.
---

By default, clusters on the EDB Postgres AI Console Cloud Service don't have schemas ingested, only metrics.
...
You can enable schemas ingest from the EDB Postgres AI Console Cloud Service by selecting the **Schema Ingestion** option when creating a cluster.
