...
21. Select the **Next: Regions and Services** button in the Cloud Hosted Databases UI.

### Selecting the scope of regions and services

22. The Cloud Hosted Databases UI should now show **Step 3 - Regions and Services**. 
