...
If you want your password not to be visible in the `beacon_agent.yaml` file, its best practice to create an environment variable for each database you want to monitor and set each to the a corresponding DSN.
