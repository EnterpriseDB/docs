...
Self-managed Postgres clusters installed both on-premises and in the cloud can be integrated into your EDB Estate view by using an agent. The agent will collect metrics from an associated cluster and feed it to the EDB Estate. It’s in this pane that that information is rendered.
