...
To access the Console, you need to have an account with the EDB Postgres AI Database Cloud Service. If you don't have an account, you can sign up for a free trial at [https://www.enterprisedb.com/edb-postgres-ai](https://www.enterprisedb.com/edb-postgres-ai).

Once you have an account, you can access the Console by navigating to [https://portal.biganimal.com](https://portal.biganimal.com) and logging in with your EDB Postgres AI Database Cloud Service credentials.
...
![Console Overview](./images/placeholder-overview.png)
...
You can directly access the full __Project__ and __Estate__ views by selecting the **Projects** or **Estate** buttons next to the EDB logo. Alson
...
Rather than being broken down into projects, the Estate overview is broken down into types of resources.
...
Self-managed Postgres clusters installed both on-premises and in the cloud can be integrated into the EDB Estate view by using an agent. The agent will collect metrics from an associated cluster and feed it to the EDB Estate. It’s in this pane that that information is rendered.
