...
The pgai extension is currently available as a tech preview. It will be continuously extended with new functions. Here is a description of the major functionality available to date.
