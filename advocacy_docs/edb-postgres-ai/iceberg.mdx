...
For implementation in Hybrid Manager (HM), see [Working with Apache Iceberg in EDB HM](../../hm_analytics_spoke_root_v2).
...
Related concepts: [Analytics Accelerator concepts - EDB Postgres Lakehouse](../../analytics-concepts#edb-postgres-lakehouse)
...
## Related topics
Generic concepts - data lakehouse

Analytics Accelerator concepts - EDB Postgres Lakehouse

How-To: Configure an Iceberg REST catalog connection

## Next steps
For Hybrid Manager implementation, see Working with Apache Iceberg in EDB HM

For detailed Lakehouse node capabilities, see Lakehouse detailed concepts

For configuring PGD offload to Iceberg, see How-To: Enable analytics offload
