...
1. [Hybrid Manager API Overview](/edb-postgres-ai/hybrid-manager/using_the_api)
2. [Using the Hybrid Manager API](/edb-postgres-ai/hybrid-manager/using_the_api/using_the_hm_api)
