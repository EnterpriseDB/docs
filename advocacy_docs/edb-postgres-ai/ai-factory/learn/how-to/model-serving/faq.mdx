...
Support for deploying additional model types and formats will be expanded in future releases. See the [Supported Models Index](../../models/supported-models) for the latest information.
...
-   [AI Factory Concepts](/edb-postgres-ai/ai-factory/learn/explained/ai-factory-concepts/#model-serving-kserve)
