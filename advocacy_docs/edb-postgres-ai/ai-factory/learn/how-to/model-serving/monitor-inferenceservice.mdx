...
For AI Factory users, Hybrid Manager will provide additional value-add monitoring and observability features — see [Model Serving in Hybrid Manager](/edb-postgres-ai/hybrid-manager/ai-factory/model-serving).
