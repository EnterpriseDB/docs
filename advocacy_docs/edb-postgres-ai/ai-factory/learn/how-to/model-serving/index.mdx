...
-   [Model Serving Quickstart](/edb-postgres-ai/ai-factory/pipeline/models/getting-started)
...
For broader architecture context, see [AI Factory Concepts](/edb-postgres-ai/ai-factory/learn/explained/ai-factory-concepts#model-serving-and-inference).
