...
- [Libraries](../../../builder/libraries/index)
...
- Explore other [AI Factory Explained pages](./index)
- Configure your first **Data Lake** → [How-to: Configure the Data Lake](../../../how-to/gen-ai/configure-datalake)
