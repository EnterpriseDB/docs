...
Vector databases store embeddings and enable fast similarity search. AI Factory provides this through the [Vector Engine](/edb-postgres-ai/ai-factory/vector-engine/), built on the open-source [pgvector](https://github.com/pgvector/pgvector) extension, integrated directly with Postgres.
...
Vector search allows you to query embeddings directly within Postgres. AI Factory uses [pgvector](https://github.com/pgvector/pgvector) to power this capability through the [Vector Engine](/edb-postgres-ai/ai-factory/vector-engine/), supporting Knowledge Bases and RAG.
...
Natural language interfaces enable users to query Postgres using natural language rather than SQL. AI Factory Assistants leverage this pattern through [Gen AI Builder](/edb-postgres-ai/hybrid-manager/ai-factory/gen-ai/builder/), combining LLMs with structured and unstructured retrieval.
...
It is deployed on [Hybrid Manager AI Factory](/edb-postgres-ai/hybrid-manager/ai-factory), enabling full-stack Sovereign AI.
...
See: [Hybrid Manager AI Factory](/edb-postgres-ai/hybrid-manager/ai-factory)
...
See: [Deploy NIM containers](/edb-postgres-ai/ai-factory/learn/how-to/model-serving/deploy-nim-container)
