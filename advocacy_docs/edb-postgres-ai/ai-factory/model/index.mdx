...
- Manage and govern model assets in your [Asset Library](/edb-postgres-ai/ai-factory/model/library)
- Deploy and scale inference services with [Model Serving](/edb-postgres-ai/ai-factory/model/serving)
...
- Manage model images and metadata in [Asset Library](/edb-postgres-ai/ai-factory/model/library)
- Deploy models for inference via KServe and [Model Serving](/edb-postgres-ai/ai-factory/model/serving)
...
- [Asset Library](/edb-postgres-ai/ai-factory/model/library) — Manage and govern AI models
...
- [AI Factory Pipelines](/edb-postgres-ai/ai-factory/pipeline) — Automate embedding pipelines powered by your models
- [Gen AI Builder](/edb-postgres-ai/ai-factory/gen-ai/builder) — Build Gen AI apps powered by Knowledge Bases and models
- [Vector Engine](/edb-postgres-ai/ai-factory/vector-engine) — Store and query vector embeddings
