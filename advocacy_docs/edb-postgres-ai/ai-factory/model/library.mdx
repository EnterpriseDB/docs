...
> **Important:** The Model Library is a capability of the [Hybrid Manager Asset Library](/edb-postgres-ai/hybrid-manager/asset-library).
...
- **Enable model serving** — Make models available for deployment via [Model Serving](/edb-postgres-ai/ai-factory/model/serving)
- **Support Pipelines and Knowledge Bases** — Use registered models for embedding pipelines and Gen AI Builder functionality

## How It Works

- Model images are registered in the [Hybrid Manager Asset Library](/edb-postgres-ai/hybrid-manager/asset-library)
