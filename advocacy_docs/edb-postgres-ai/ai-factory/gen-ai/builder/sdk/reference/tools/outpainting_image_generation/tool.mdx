---
title: tool
navTitle: OutpaintingImageGenerationTool

---

<span id="griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool"></span>
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| <a href="tool.mdx#griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.image_generation_driver" title="image_generation_driver = field(kw_only=True)           class-attribute       instance-attribute    (griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.image_generation_driver)"><code class="language-python">image_generation_driver</code></a> | <a href="../../drivers/image_generation#griptape.drivers.image_generation.BaseImageGenerationDriver" title="BaseImageGenerationDriver (griptape.drivers.image_generation.BaseImageGenerationDriver)"><code class="language-python">BaseImageGenerationDriver</code></a> | The image generation driver used to generate the image.<br/>                  |
| <a href="../../mixins/artifact_file_output_mixin.mdx#griptape.mixins.artifact_file_output_mixin.ArtifactFileOutputMixin.output_dir" title="output_dir = field(default=None, kw_only=True)           class-attribute       instance-attribute    (griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.output_dir)"><code class="language-python">output_dir</code></a>                 | `Optional[str]`                                                                                                                                                                                                                                                         | If provided, the generated image will be written to disk in output_dir.<br/>  |
| <a href="../../mixins/artifact_file_output_mixin.mdx#griptape.mixins.artifact_file_output_mixin.ArtifactFileOutputMixin.output_file" title="output_file = field(default=None, kw_only=True)           class-attribute       instance-attribute    (griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.output_file)"><code class="language-python">output_file</code></a>             | `Optional[str]`                                                                                                                                                                                                                                                         | If provided, the generated image will be written to disk as output_file.<br/> |
...
-   `image_generation_driver = field(kw_only=True)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.image_generation_driver"></span> 

-   `image_loader = field(default=ImageLoader(), kw_only=True)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.image_loader"></span> 

<span id="griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool._generate_outpainting"></span>
...
<span id="griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.image_outpainting_from_file"></span>
...
<span id="griptape.tools.outpainting_image_generation.tool.OutpaintingImageGenerationTool.image_outpainting_from_memory"></span>
