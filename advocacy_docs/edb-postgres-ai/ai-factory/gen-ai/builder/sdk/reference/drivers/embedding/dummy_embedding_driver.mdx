---
title: dummy_embedding_driver
navTitle: DummyEmbeddingDriver

---

<span id="griptape.drivers.embedding.dummy_embedding_driver.DummyEmbeddingDriver"></span>
...
-   `model = field(init=False, default=None, kw_only=True)` <small>class-attribute</small> <small>instance-attribute</small>  <span id="griptape.drivers.embedding.dummy_embedding_driver.DummyEmbeddingDriver.model"></span> 

<span id="griptape.drivers.embedding.dummy_embedding_driver.DummyEmbeddingDriver.try_embed_chunk"></span>
