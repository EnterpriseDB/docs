...
If you need to add or remove fields in the serialization process, you can pass [serialization_overrides](../reference/mixins/serializable_mixin.mdx#griptape.mixins.serializable_mixin.SerializableMixin.serialization_overrides) to any of the serialization methods.
...
This is something we're [actively working](https://github.com/griptape-ai/griptape/issues/1587) on fixing, but in the meantime, you can use the [types_overrides](../reference/mixins/serializable_mixin.mdx#griptape.mixins.serializable_mixin.SerializableMixin.types_overrides) parameter to pass in a dictionary of types that need to be overridden during serialization.
