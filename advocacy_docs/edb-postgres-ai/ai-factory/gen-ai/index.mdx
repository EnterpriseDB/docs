...
[Gen AI Workloads in Hybrid Manager](/hybrid-manager/ai-factory/gen-ai)
...
- Explore the [Explained Concepts](/edb-postgres-ai/ai-factory/learn/explained) — Knowledge Bases, retrievers, Pipelines, and more
- Build your first Assistant in [Agent Studio](/edb-postgres-ai/ai-factory/gen-ai/agent-studio)
- Deploy Knowledge Bases using [Gen AI Builder](/edb-postgres-ai/ai-factory/gen-ai/builder)
- Try a [Tutorial](/edb-postgres-ai/ai-factory/learn/tutorials) to implement common patterns
