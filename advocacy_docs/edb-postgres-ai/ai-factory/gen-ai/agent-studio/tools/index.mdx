...
For a deep dive, see: [Tools explained](edb-postgres-ai/ai-factory/learn/explained/tools-explained).
...
See [Create a Tool](edb-postgres-ai/ai-factory/learn/how-to/gen-ai/create-tool) for a full step-by-step guide.
