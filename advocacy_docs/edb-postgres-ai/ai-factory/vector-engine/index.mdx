...
- [Gen AI Builder](/edb-postgres-ai/ai-factory/gen-ai/builder/index.mdx) and Knowledge Bases use PGvector-backed retrievals.
...
- Retrieval in Knowledge Bases (via [Gen AI Builder](/edb-postgres-ai/ai-factory/gen-ai/builder/index.mdx))
...
```
2. Define vector columns in your tables:

```
ALTER TABLE documents ADD COLUMN embedding vector(768);
```

3. Index vector columns for fast similarity search:
```
CREATE INDEX ON documents USING ivfflat (embedding vector_l2_ops) WITH (lists = 100);
```
4. Populate embeddings:

Use [Pipelines](/edb-postgres-ai/ai-factory/pipeline/index.mdx) to generate embeddings
...
AI Accelerator  [Pipelines](/edb-postgres-ai/ai-factory/pipeline/index.mdx) makes it easy to:
...
[Pipelines](/edb-postgres-ai/ai-factory/gen-ai-builder/index.mdx) uses PGvector-based retrieval when building Knowledge Bases:
