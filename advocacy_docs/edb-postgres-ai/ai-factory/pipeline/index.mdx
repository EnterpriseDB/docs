...
- Perform **semantic and similarity search** using [Vector Engine](/edb-postgres-ai/ai-factory/vector-engine/index.mdx)
...
See [Preparer Concepts](/edb-postgres-ai/ai-factory/pipeline/preparers/index.mdx) to learn more.
...
See [Knowledge Base Concepts](/edb-postgres-ai/ai-factory/pipeline/knowledge_base/index.mdx).
...
- [Knowledge Base Concepts](/edb-postgres-ai/ai-factory/pipeline/knowledge_base/index.mdx)
- [Preparer Concepts](/edb-postgres-ai/ai-factory/pipeline/preparers/index.mdx)
- [Auto-Processing](/edb-postgres-ai/ai-factory/pipeline/capabilities/auto-processing.mdx)
- [Supported Embedding Models](/edb-postgres-ai/ai-factory/pipeline/models/supported-models/index.mdx)
