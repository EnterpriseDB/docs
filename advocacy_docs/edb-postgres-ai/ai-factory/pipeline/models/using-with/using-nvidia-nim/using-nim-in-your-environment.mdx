...
# Using NVIDIA NIM Microservices in Your Environment
...
- Text Embedding Runtime: [embed-runtime.yaml](files/embed-runtime.yaml)
- Text Embedding Service: [embed-service.yaml](files/embed-service.yaml)
...
```bash
kubectl get clusterservingruntime -n ai-models
kubectl get inferenceservice -n ai-models
```
