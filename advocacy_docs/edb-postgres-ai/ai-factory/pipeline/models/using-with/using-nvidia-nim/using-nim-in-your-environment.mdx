...
- Text Embedding Runtime: [embed-runtime.yaml](/edb-postgres-ai/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/embedding-runtime.yaml)
- Text Embedding Service: [embed-service.yaml](/edb-postgres-ai/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/embedding-service.yaml)
...
- Image OCR Service: [ocr-service.yaml](/edb-postgres-ai/ai-factory/pipeline/models/using-with/using-nvidia-nim/files/ocr-service.yaml)
