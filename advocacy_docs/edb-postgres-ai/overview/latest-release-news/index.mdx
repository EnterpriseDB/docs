...
To get the latest PEM and enjoy all these benefits, update today: [https://www.enterprisedb.com/docs/pem/latest/upgrading/upgrading\_pem\_installation/](https://www.enterprisedb.com/docs/pem/latest/upgrading/upgrading_pem_installation/)
...
[EDB Postgres for Kubernetes](/postgres_for_kubernetes) adds speed, efficiency, and protection for your k8s infrastructure modernization, with an enterprise-grade operator for Postgres. EDB Postgres for Kubernetes brings automation, security, and reliability to cloud-native data infrastructures.
