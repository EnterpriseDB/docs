...
You'll want to look at the [EDB Postgres® AI Machine Learning](/edb-postgres-ai/ai-accelerator/) documentation, which covers the technical preview of the aidb extension.
