...
* **[Lakehouse nodes](/edb-postgres-ai/analytics/lakehouse)**
  * At the heart of Analytics is a custom built ojjevt store your data. Built to bring structured and unstructured data together, Lakehouse nodes support numerous formats to bring cold data in and ready for analysis. 
