...
* All of EDB's database expertise can be found in EDB Postgres Advanced Server and EDB Postgres Extended Server. Oracle compatibility, transparent data encryption and more. They provide the data fabric on which EDB Postgres AI operates. 
...
* High availability with an active-active mesh of Postgres instances, EDB Postgres Distributed provides a dynamic, resiliant, and scalable environment for your data.
