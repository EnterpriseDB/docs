...
Not just databases, but driven by databases, [Cloud Service](/edb-postgres-ai/cloud-service/getting_started/planning/your_cloud_account/) provides a global platform for delivering new elements of EDB Postgres AI efficiently and effectively.

Bring your own cloud account to EDB and let the Cloud Service environment take care of deploying and managing your Postgres databases in your own cloud provider account.
...
## [EDB Postgres AI - AI Accelerator](/edb-postgres-ai/ai-accelerator/)

- Postgres has proven its capability as a flexible data environment. With vector data as the core of generative AI, it's already infused into EDB Postgres AI, providing a platform for a range of practical and effective AI/ML solutions.

## [EDB Postgres AI Platforms and tools](/edb-postgres-ai/platforms-and-tools)
