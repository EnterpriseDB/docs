...
* **[EDB Postgres AI Estate](/edb-postgres-ai/console/estate)**
  * EDB Postgres AI Cloud Service databases are automatically managed on the Console. The Estate can also monitor the health of AWS RDS and S3 resources and using the Agent, on-premise databases show in the same view.
