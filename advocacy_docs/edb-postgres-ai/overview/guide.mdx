...
You'll want to look at the [EDB Postgres AI Migration](/edb-postgres-ai/migration-and-ai) documentation, which covers the Migration Toolkit and Migration Portal.
