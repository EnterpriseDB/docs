...
You'll want to look at the [EDB Postgres AI Migration](/edb-postgres-ai/migration) documentation, which covers the Migration Toolkit and Migration Portal.
...
You'll want to look at the [EDB Postgres AI Platform Agent](/ebd-postgres-ai/console/agent) documentation, which covers the Estate management and on premises agent installation.
