...
2. Select the type of cloud account for your cluster. You can choose EDB Hosted Cloud Service or Your Cloud Account. For more information, see [Deployment options](../../planning/deployment_options).
...
3. Select the cloud provider and region for your cluster. If you're using your account and haven't connected it to EDB Postgres AI Console yet, see [Connecting to your cloud](/biganimal/latest/getting_started/02_connecting_to_your_cloud).
...
1.  In the **Database Type** section:
    ...
    1.  In the **Postgres Type** field, select the type of Postgres you want to use:
        ...
        -   **[EDB Postgres Advanced Server](/epas/latest/)** is EDB's Oracle-compatible database offering. View [a quick demonstration of Oracle compatibility on EDB Postgres AI](../../using_cluster/06_demonstration_oracle_compatibility). EDB Postgres Advanced Server is compatible with all three cluster types.
...
Enable **PgBouncer** to have it manage your connections to Postgres databases and help your workloads run more efficiently &mdash; all entirely managed by Cloud Service. Learn more about [EDB PgBouncer](/biganimal/latest/overview/poolers/).
