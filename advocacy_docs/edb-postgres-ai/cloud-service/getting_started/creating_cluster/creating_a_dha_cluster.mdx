...
1. Select the type of cloud account for your cluster. You can choose EDB Hosted Cloud Service or Your Cloud Account. For more information, see [Deployment options](../../planning/deployment_options).
...
6.  Select **Next: DB Configuration**

7.  In the **Parameters** section on the **DB Configuration** tab, you can update the value of the database configuration parameters for the data group as needed.
...
8.  Select **Create: Data Group**. The data group preview appears. 

9.  If you want to create a second data group, select **Add a Data Group**. To finish creating your cluster, select **Create Cluster**. 
...
- [PGD CLI on Cloud Service](/biganimal/latest/using_cluster/pgd_cli_ba/)
