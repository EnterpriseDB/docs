...
navTitle: "Overview"
description: High-level description of the tasks needed to get started with BigAnimal 
---
...
1. Create a cluster. When prompted for **Where to deploy**, select **BigAnimal**. See [Creating a cluster](../getting_started/creating_a_cluster/). 
...
1. Create a cluster. When prompted for **Where to deploy**, select **Your Cloud Account**. See [Creating a cluster](../getting_started/creating_a_cluster/). 
