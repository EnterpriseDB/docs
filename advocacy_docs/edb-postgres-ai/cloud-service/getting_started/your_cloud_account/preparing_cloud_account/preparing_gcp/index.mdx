...
## Check Google Cloud resource limits for running Cloud Service
...
2.  From Google Cloud Shell, run the following command:
    ...
    | &lt;region>     | Google Cloud region where your clusters are being deployed. See [Supported regions](/edb-postgres-ai/cloud-service/references/supported_regions/) for a list of possible regions. |
