...
Use these techniques to connect your cloud if you're using Your Cloud Account as your [deployment option](/biganimal/release/planning/deployment_options).
...
- Cloud Service CLI version 2.0 or later. For details, see [Installing the CLI](/biganimal/latest/reference/cli/#installing-the-cli).
...
1. If the cloud readiness checks pass, your cloud account is successfully set up. Connect your cloud account to Cloud Service:
