...
2.  Set up your own identity provider. For more information see [Setting up your identity provider](/edb-postgres-ai/cloud-service/console/using/organizations/identity_provider/).
...
10. Provide access to other users. See [Managing user access](/edb-postgres-ai/cloud-service/console/using/organizations/users/).
