...
Use the following high-level steps to connect EDB Postgres AI to your own cloud account and begin using your new database. 
...
1. Set up a CLI. See [Using the Cloud Service CLI](../reference/cli/). 
   Although we recommend using a CLI, it isn't required.

1. Prepare your cloud to work with EDB Postgres AI. You must do this every time you create a new cluster. The required steps vary by cloud provider. See:
