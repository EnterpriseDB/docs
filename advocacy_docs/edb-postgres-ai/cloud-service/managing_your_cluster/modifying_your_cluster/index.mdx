...
redirects:
  - /purl/upm/modify-cluster/
  - ../03_modify_and_scale_cluster
  - /biganimal/latest/using_cluster/03_modifying_your_cluster/ #generated for BigAnimal URL path removal branch
---
...
4.  You can modify the following settings on the corresponding tab of the Edit Cluster page.
    ...
    | PgBouncer                                            | **Additional Settings** | Enabling PgBouncer incurs additional infrastructure costs that depend on your cloud provider. See [PgBouncer costs](/edb-postgres-ai/cloud-service/references/pricing_and_billing/#pgbouncer-costs).                                                                                                                                                    |
