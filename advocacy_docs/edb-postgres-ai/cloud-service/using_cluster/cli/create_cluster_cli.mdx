...
We'll be using the [Cloud Service command line interface](/biganimal/latest/reference/cli/), which is a convenient wrapper to the [Cloud Service API](/biganimal/latest/reference/api/). To start, download [the latest binary](/biganimal/latest/reference/cli/) and move it to wherever your system finds executable files (somewhere on your PATH). 
...
[Cloud Service CLI reference](/biganimal/latest/reference/cli/) and 
