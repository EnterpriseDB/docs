...
redirects:
  ...
  - /biganimal/latest/using_cluster/02_connecting_your_cluster/01_connecting_from_azure/02_virtual_network_peering/ #generated for BigAnimal URL path removal branch
---
