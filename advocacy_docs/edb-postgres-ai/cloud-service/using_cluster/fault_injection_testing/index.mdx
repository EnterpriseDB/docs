...
-   You've connected your Cloud Service account with your Azure subscription. See [Setting up your Azure Marketplace account](/edb-postgres-ai/cloud-service/getting_started/your_cloud_account/azure_market_setup/) for more information.
