...
redirects:
  - /biganimal/latest/using_cluster/managing_replicas/ #generated for BigAnimal URL path removal branch
  - /purl/upm/manage-faraway-replicas #UPM (BA / Cloud Service) permalink
---
