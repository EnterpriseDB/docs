...
## Extensions available when using EDB Hosted Cloud Service

If you're using EDB Hosted Cloud Service account, you can install and use the following extensions. 
