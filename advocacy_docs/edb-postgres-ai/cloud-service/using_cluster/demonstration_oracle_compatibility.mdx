...
3.  Create a limited-privilege user for connecting to this database:
    ...
    See [Details on managing access in Cloud Service databases](/biganimal/latest/using_cluster/01_postgres_access/) for more information.
...
-   Learn about [migrating existing databases to Cloud Service](/biganimal/latest/migration/).
