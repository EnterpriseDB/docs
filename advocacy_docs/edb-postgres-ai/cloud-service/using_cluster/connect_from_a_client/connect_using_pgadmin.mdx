...
indexCards: none
redirects:
  - /biganimal/latest/free_trial/detail/connect_to_a_cluster/connect_using_pgadmin/ #generated for BigAnimal URL path removal branch
---
...
For more information, see [Connecting to your cluster](/edb-postgres-ai/cloud-service/using_cluster/connecting_your_cluster/).
