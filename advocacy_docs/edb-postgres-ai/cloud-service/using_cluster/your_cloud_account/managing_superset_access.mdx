...
redirects:
  - /biganimal/latest/administering_cluster/01a_superset_access/ #generated for BigAnimal URL path removal branch
---
...
To assign Cloud Service user roles, see [Users](/edb-postgres-ai/cloud-service/console/using/organizations/users/).
