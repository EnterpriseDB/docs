...
description: "Customize default AWS configuration settings to match Cloud Service's resource configurations"
redirects:
  - /biganimal/latest/administering_cluster/customizing_compliance/aws_config_rules/ #generated for BigAnimal URL path removal branch
---
