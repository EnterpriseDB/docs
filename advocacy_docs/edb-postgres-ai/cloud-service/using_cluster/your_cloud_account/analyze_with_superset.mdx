...
---
You can use Apache Superset to analyze, explore, and visualize data stored in your Postgres clusters when using your own cloud account. (Apache Superset isn't supported on EDB Hosted Cloud Service.) You can open Superset from the [EDB Postgres AI Console](https://portal.biganimal.com/) using the **Analyze** links. 

!!!note
   Contact [Cloud Service Support](../overview/support) to enable the Apache Superset feature. 
!!!
