...
deepToC: true
description: How to tag your AWS resources using EDB Postgres AI Cloud Service to enable better audit policy and cost control.
redirects: 
  - /purl/cloudservice/csp_tagging
  - /purl/upm/csp-tagging/
  - /biganimal/latest/using_cluster/managing_cloud_account/
  - /biganimal/latest/using_cluster/managing_cloud_account/csp_tagging/
---
