...
description: How to tag a resource in EDB Postgres AI Cloud Service.
redirects:
  - /biganimal/latest/using_cluster/tagging/ #generated for BigAnimal URL path removal branch
---
