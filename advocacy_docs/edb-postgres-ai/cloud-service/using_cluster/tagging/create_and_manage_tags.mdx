...
Create and assign a tag while [creating a project](/biganimal/release/administering_cluster/projects.mdx#creating-a-project) and [creating a cluster](/edb-postgres-ai/cloud-service/getting_started/creating_cluster/creating_a_cluster/#cluster-settings-tab).
