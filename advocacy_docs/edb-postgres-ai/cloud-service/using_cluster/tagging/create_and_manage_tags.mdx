...
redirects:
  - /biganimal/latest/using_cluster/tagging/create_and_manage_tags/ #generated for BigAnimal URL path removal branch
---
...
Create and assign a tag while [creating a project](/edb-postgres-ai/cloud-service/console/using/projects/managing_projects/#creating-a-new-project) and [creating a cluster](/edb-postgres-ai/cloud-service/getting_started/creating_cluster/creating_a_cluster/#cluster-settings-tab).
