...
redirects:
  - /purl/upm/aws-metrics-logs-doc/
  - /biganimal/latest/using_cluster/05_monitoring_and_logging/monitoring_from_aws/ #generated for BigAnimal URL path removal branch
---
