---
title: Cloud Service June 2024 release notes
navTitle: June 2024
---
...
| Enhancement | Added [read-only endpoints for shadow nodes on PGD](/edb-postgres-ai/cloud-service/references/supported_cluster_types/distributed_highavailability/#read-only-workloads) on Cloud Service. |
