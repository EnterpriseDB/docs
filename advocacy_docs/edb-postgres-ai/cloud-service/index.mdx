...
!!! info
We're currently updating the documentation to reflect the new EDB Postgres AI Cloud Service. Consult the [BigAnimal documentation](/biganimal/latest/) during the transition.
!!!

## Overview

The EDB Postgres AI Cloud Service itself is a fully managed cloud service that provides a high-performance, scalable, and secure database platform for analytics, AI, and machine learning workloads. It also allows provides the platform for [EDB Postgres AI Analytics](../analytics/) and [EDB Postgres AI Machine Learning](../ai-ml/) services.
...
The Console view isn't limited to managed or hosted database deployments. You can also deploy the databases yourself in your own cloud or on-premises, but still have them visible in your EDB Postgres AI Console as part of your [EDB Postgres AI Estate](../console/estate) using the [EDB Postgres AI Agent](../console/agent/).
