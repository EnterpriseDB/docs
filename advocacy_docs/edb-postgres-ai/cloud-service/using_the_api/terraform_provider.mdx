---
title: Cloud Service Terraform provider
---
...
!!!note
   We provide support for the EDB Cloud Service Terraform provider and not for the underlying environment. 
...
## Prerequisites
To use Terraform with EDB Cloud Service, you need: 

- A Cloud Service account with an organization set up. If you don't already have an account, see [Getting started with Cloud Service](/biganimal/latest/free_trial).
