...
If you can’t log in to your account or are having issues using the widget, send us an email at [cloudsupport@enterprisedb.com](mailto:techsupport@enterprisedb.com).
...
1.  Start a Support case using any one of these options:
    ...
    -   Go to the [Support portal](https://techsupport.enterprisedb.com/) and select **Submit a request** at the top-right of the page.
