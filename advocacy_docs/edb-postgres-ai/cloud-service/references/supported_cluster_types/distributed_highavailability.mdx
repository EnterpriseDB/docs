...
For instructions on creating a distributed high-availability cluster using the Console, see [Creating a distributed high-availability cluster](../../getting_started/creating_a_cluster/creating_a_dha_cluster/).

For instructions on creating, retrieving information from, and managing a distributed high-availability cluster using the Cloud Service CLI, see [Using the Cloud Service CLI](/biganimal/latest/reference/cli/managing_clusters/#managing-distributed-high-availability-clusters).
