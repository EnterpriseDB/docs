...
redirects:
  - /biganimal/latest/overview/05_database_version_policy/ #generated for BigAnimal URL path removal branch
  - /purl/upm/db-version-policy #UPM (BA / Cloud Service) permalink
  - /purl/upm/end-of-life #UPM (BA / Cloud Service) permalink
  - /purl/upm/db-version-key-dates #UPM (BA / Cloud Service) permalink
---
