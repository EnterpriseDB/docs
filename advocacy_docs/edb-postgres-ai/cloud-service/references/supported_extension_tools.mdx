...
- See [Postgres extensions](/biganimal/release/using_cluster/extensions) for the list of extensions supported when using EDB Hosted Cloud Service account and for more information on installing and working with extensions.
