...
description: Create a single node Cloud Service database cluster on EDB Postgres AI.
redirects:
  - ../../../../console/quickstart/creating_a_database_cluster/ #generated for docs/hm/release-1.2
---
...
Next, you need to choose the cloud provider to host the infrastructure yourself in your own cloud account, while retaining the benefits of EDB Postgres AI management and monitoring of the cluster. 

The next step is choosing the region in your cloud provider you want to use. You can choose from AWS, Azure, or GCP. Choose AWS for this quickstart and the whichever region you prefer.
...
Below that's the **Database Type** section with a selector for which kind of Postgres database your want; plain Postgres, EDB's Postgres Extended or EDB's Postgres Advanced (with optional Oracle compatibility). You're going to use plain Postgres for this quickstart, so select PostgreSQL.
