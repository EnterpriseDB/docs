---
title: Connecting to the database cluster with psql
navTitle: Connecting with psql
description: How to get the credentials and connect to the database cluster you just created in the EDB Postgres AI Console with psql.
redirects:
  - ../../../../console/quickstart/connecting_to_the_database_with_psql/ #generated for docs/hm/release-1.2
---
...
This is a complete command for connecting to the database, assuming that is, that you are using `psql` as your Postgres client as suggested in the [previous step](creating_a_database_cluster.mdx).
...
- [Exploring the database](exploring_the_database)
- [Connecting with pgAdmin](connecting_to_the_database_with_pgadmin)
- [Connecting with DBeaver](connecting_to_the_database_with_dbeaver)
