...
redirects:
  - ../../../../../../console/estate/integrating/integrate_aws/01_create_policy/ #generated for docs/hm/release-1.2
---
...
3. The **Cloud Hosted Databases** console shows **Step 1 - Create custom policy**.
...
10. Next, in the Cloud Hosted Databases console, select the **Next: Create a Role** button. The Cloud Hosted Databases console should now show [**Step 2 - Create a Role**](02_create_role).
