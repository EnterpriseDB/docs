...
redirects:
  - ../../../../../../console/estate/integrating/integrate_aws/03_set_regions/ #generated for docs/hm/release-1.2
---

The final step after setting up a policy and [creating a role](02_create_role) in AWS is to set the regions and services you want to monitor in your AWS account. In the Cloud Hosted Databases console, you should be seeing the **Step 3 - Regions and Services** page.
