...
redirects:
  - ../../../../../../console/estate/integrating/integrate_aws/02_create_role/ #generated for docs/hm/release-1.2
---
...
1. Go to the AWS console, and in the left-hand navigation pane, choose **Roles** and then select the **Create role** button.

2. Select **Custom trust policy** role type.

3. In the **Custom trust policy** section, paste the trust policy you obtained from **Step 2** in the Cloud Hosted Databases console. It looks similar to this:
  ...
  !!! Note
  The EDB Postgres AI Cloud Hosted Databases console shows a snippet like the one above but with the `<project-id>` already specified.
  !!!
...
10. Copy the role ARN from the Summary section of the Role page in AWS console and paste it into the form at the bottom of the Cloud Hosted Databases console labeled **Role ARN**.

11. Select the **Next: Regions and Services** button in the Cloud Hosted Databases console to move to [**Step-3: Regions and Services**](03_set_regions).
