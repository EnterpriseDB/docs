...
description: Learn how to create a machine user in EDB Postgres AI Console to enable the Agent.
redirects:
  - ../../../../../console/estate/agent/create-machine-user/ #generated for docs/hm/release-1.2
---


In the EDB Postgres® AI Console, using your avatar's user menu (top right on the display), select the **User Management** page.

This takes you to the User Management page. Here, you can create a machine user that the Agent can use to ingest data into your Estate.
...
Your new machine user is now ready to ingest data from the Agent.
