---
title: Introduction to the EDB Postgres AI Console
navTitle: Introduction
description: Getting started with the EDB Postgres AI Console.
deepToC: true
redirects:
  - ../../../../console/using/introduction/ #generated for docs/hm/release-1.2
---
...
## Exploring the Console Overview

In the body of the console overview page, you can see two summaries of the [__Project__](#projects) and [__Estate__](#estate) views. 
