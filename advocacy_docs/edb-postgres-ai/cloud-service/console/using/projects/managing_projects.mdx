...
deepToC: true
redirects:
  - ../../../../../console/using/projects/managing_projects/ #generated for docs/hm/release-1.2
---
...
Contact [EDB Postgres AI Support](/edb-postgres-ai/cloud-service/support_services/) if you want to delete the initial automatically created default project. You can't delete the default project through the console interface.
!!!
