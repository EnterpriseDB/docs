...
redirects:
  - ../../../../../console/using/projects/regions/ #generated for docs/hm/release-1.2
---

Displays all the regions available to the project in a table format. The regions view shows the region name, tags, current number of clusters in the region, the cloud service provider, the region, the region status, the provisioned storage and whether the region is active or not.
