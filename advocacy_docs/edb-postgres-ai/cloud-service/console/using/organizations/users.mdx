...
redirects:
  ...
  - ../../../../../console/using/organizations/users/ #generated for docs/hm/release-1.2
---
...
See [Adding a user to a project](/edb-postgres-ai/cloud-service/console/using/projects/users/#adding-a-user-to-a-project) for information on adding users to projects.
