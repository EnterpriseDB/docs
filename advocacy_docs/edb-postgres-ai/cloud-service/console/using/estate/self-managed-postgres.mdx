...
redirects:
  - ../../../../../console/using/estate/self-managed-postgres/ #generated for docs/hm/release-1.2
---
...
The **Configure Agent** button takes you through the steps needed to configure the Estate to receive data from an agent. See the [Agent](/tools/agent/) documentation for more details and in particular [Install Agent](/tools/agent/installing/) on how to install the agent on your platform.
