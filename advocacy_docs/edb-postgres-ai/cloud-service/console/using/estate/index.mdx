...
navigation:
  ...
  - storage-locations
redirects:
  - ../../../../console/using/estate/ #generated for docs/hm/release-1.2
---
...
* [Self Managed Postgres](self-managed-postgres): This is any Postgres deployment that you have installed and manage on your own infrastructure and monitor with the [Agent](/tools/agent/).
