...
Related concept: [Analytics Accelerator concepts](../../analytics-concepts#edb-postgres-distributed-pgd-and-tiered-tables)
...
- [OLAP / OLTP](../../explained/generic-concepts#olap-oltp)
