...
For implementation and management in Hybrid Manager (HM), see [Lakehouse clusters in EDB Hybrid Manager](/edb-postgres-ai/hybrid-manager/analytics/lakehouse).
...
- [Lakehouse clusters in EDB Hybrid Manager](/edb-postgres-ai/hybrid-manager/analytics/lakehouse)

How-To guides
- [Create a Lakehouse cluster](/edb-postgres-ai/hybrid-manager/analytics/learn/how-to/create-lakehouse-cluster)
- [Query existing Apache Iceberg tables](/edb-postgres-ai/hybrid-manager/analytics/learn/how-to/query-iceberg-existing-tables)
- [Query Delta Lake tables](/edb-postgres-ai/hybrid-manager/analytics/learn/how-to/query-delta-lake-tables)
