...
How-To guides
- [Create a Lakehouse cluster](../hybrid-manager/analytics/learn/how-to/create-lakehouse-cluster)
- [Query existing Apache Iceberg tables](../hybrid-manager/analytics/learn/how-to/query-iceberg-existing-tables)
- [Query Delta Lake tables](../hybrid-manager/analytics/learn/how-to/query-delta-lake-tables)
