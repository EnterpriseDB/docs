...
Analytics: "Analytics Accelerator for your role: a persona-based guide"
...
[HM backup and recovery for Lakehouse components](#).
...
Use HM control plane to provision Lakehouse clusters and related resources via the console, API, or CLI.
[Provisioning Lakehouse clusters on HM](#).
