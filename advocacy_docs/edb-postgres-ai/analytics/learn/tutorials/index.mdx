...
For concise, goal-oriented instructions on specific tasks, see the [How-To guides](../how-to).
For tutorials specific to Hybrid Manager (HM), refer to the [HM analytics tutorials](../../hm_analytics_spoke_root_v2).
...
**Related concepts:** [Generic concepts - data lakehouse](../../explained/generic-concepts#data-lakehouse), [Analytics Accelerator concepts](../../analytics-concepts#edb-postgres-lakehouse)
...
**Related concepts:** [Analytics Accelerator concepts](../../analytics-concepts#analytics-use-cases-and-architecture-patterns)
...
**Related concepts:** [Analytics Accelerator concepts](../../analytics-concepts#edb-postgres-lakehouse)
...
**Related concepts:** [Analytics Accelerator concepts](../../analytics-concepts#edb-postgres-distributed-pgd-and-tiered-tables)
...
**Related concepts:** [Analytics Accelerator concepts](../../analytics-concepts#analytics-and-aiml-workloads)
...
This index will grow as additional tutorials are added. For Hybrid Manager (HM)-specific tutorials, see the [HM analytics tutorials](../../hm_analytics_spoke_root_v2).
