...
navTitle: Analytics
description: Guidance for DBAs, DevOps engineers, data scientists, and developers to use EDB Analytics effectively.
---

# EDB Analytics for your role: a persona-based guide
...
### Key objectives and EDB Analytics solutions
