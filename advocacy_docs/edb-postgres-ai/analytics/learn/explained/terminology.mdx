...
[Learn more](../../hybrid-manager/database_types/distributed_highavailability)
...
[Example in use](./learn/how-to/query-iceberg-existing-tables)
...
[Example in use](./learn/how-to/configure-delta-pgfs)
...
[Example in use](./learn/how-to/configure-tiered-autopartition)
...
[Example in use](./learn/how-to/monitor-tiered-tables)
...
[Example in use](./learn/how-to/configure-iceberg-catalog)
...
[Learn more](./explained/generic-concepts#open-table-formats)
...
Related concept: [Data Tiering](./explained/generic-concepts#data-tiering)
...
Related concept: [Separation of Storage and Compute](./explained/generic-concepts#separation-of-storage-and-compute)
