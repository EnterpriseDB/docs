...
-   **Solution-oriented examples:** Visit [Analytics Accelerator use cases and architectures](../../../hybrid-manager/analytics/learn/use-cases.mdx) for real-world examples.
...
-   Explore industry applications in [Analytics Accelerator use cases](../../../hybrid-manager/analytics/learn/use-cases.mdx)
