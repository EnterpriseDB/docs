...
**Continue your journey:** [Analytics Accelerator concepts](../explained/analytics-concepts) + [How-To Guides](/edb-postgres-ai/hybrid-manager/analytics/learn/how-to/)
...
-   **Solution-oriented examples:** Visit [Analytics Accelerator use cases and architectures](/edb-postgres-ai/hybrid-manager/analytics/learn/use-cases.mdx) for real-world examples.
...
-   Apply your knowledge with [How-To Guides](/edb-postgres-ai/hybrid-manager/analytics/learn/how-to/)
-   Explore industry applications in [Analytics Accelerator use cases](/edb-postgres-ai/hybrid-manager/analytics/learn/use-cases.mdx)
