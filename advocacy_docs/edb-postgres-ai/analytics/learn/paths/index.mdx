...
**Continue your journey:** [Analytics Accelerator concepts](../analytics-concepts) + [How-To Guides](../how-to/index)
...
**Advance your expertise:** [Advanced concepts and techniques](../explained/index) *(expand this section over time)*
...
- **Role-based guidance:** See [Analytics Accelerator for your role](../analytics-for) for resources tailored to your job function.
- **Solution-oriented examples:** Visit [Analytics Accelerator use cases and architectures](../use-cases) for real-world examples.
...
- Learn EDB’s approach in [Analytics Accelerator concepts](../analytics-concepts)
- Apply your knowledge with [How-To Guides](../how-to/index)
- Explore industry applications in [Analytics Accelerator use cases](../use-cases)
