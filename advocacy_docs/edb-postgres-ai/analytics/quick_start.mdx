...
For more details, see [Concepts](concepts.mdx) and [Reference](reference),
...
Select **Custom Build**, and then select **Start from Scratch**. TThe **Create Analytical Cluster** page opens, where you can choose the cluster size and configuration:
