...
Postgres Lakehouse nodes run either EPAS or PGE as the Postgres engine, with
data for analytics stored as columnar tables in object storage using the
open source Delta Lake protocol.
