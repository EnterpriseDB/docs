...
For details on how Delta Lake is used and managed within Hybrid Manager (HM), see [Working with Delta Lake in EDB HM](../hybrid-manager/analytics/delta_lake).
...
- [Generic concepts - data lakehouse](./learn/explained/generic-concepts#data-lakehouse)
- [Generic concepts - columnar storage formats](./learn/explained/generic-concepts#columnar-storage-formats)
- [Analytics Accelerator concepts - EDB Postgres Lakehouse](./learn/explained/generic-concepts#edb-postgres-lakehouse)

## Next steps

- For Delta Lake usage and management in Hybrid Manager, see [Working with Delta Lake in EDB HM](../hybrid-manager/analytics/delta_lake)
- For a broader understanding of related concepts, see [Generic concepts](./learn/explained/generic-concepts)
