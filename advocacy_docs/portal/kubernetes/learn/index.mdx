...
This section is part of the [EDB Developer Portal](../index). To learn more about the Postgres technologies and distributions we support, see [PostgreSQL at EDB](../postgresql/index).
...
→ Learn more in [How Kubernetes powers Hybrid Manager](./learn/explained/k8-in-hybrid-manager)
...
- [Kubernetes explained](./learn/explained/kubernetes-explained)
- [How Kubernetes powers Hybrid Manager](./learn/explained/k8-in-hybrid-manager)
- [How-to guides](./learn/how-to)
- [Role-based guides](./learn/explained/for)

---

## Want to learn more about Postgres?

→ Head to the [PostgreSQL section](../postgresql) to explore:

- Postgres distributions (Community, Advanced, Distributed)
- Use of Postgres in AI, analytics, and hybrid cloud
- Migration and compatibility (including Oracle)
- Integrations, extensions, and performance tuning
