...
If you are new to Kubernetes, start with the [Kubernetes explained](/edb-postgres-ai/portal/kubernetes/learn/explained/kubernetes-explained) section to build foundational understanding.
...
How to observe and monitor Kubernetes workloads and infrastructure.---
title: Kubernetes How-to guides
navTitle: How-to
...
- [Monitor Kubernetes clusters](./monitor-kubernetes-cluster)
- [Troubleshooting Kubernetes](./troubleshooting-on-kubernetes)
...
- [Restore Kubernetes PersistentVolumes](./restore-kubernetes-pv)
...
- [Hybrid Manager How-to index](./hybrid-manager/index)

---

## Related topics

- [Kubernetes explained](/edb-postgres-ai/portal/kubernetes/learn/explained/index)
- [Kubernetes terminology](/edb-postgres-ai/portal/kubernetes/learn/explained/terminology)
- [Kubernetes in Hybrid Manager](/edb-postgres-ai/portal/kubernetes/learn/explained/hybrid-manager/k8-in-hybrid-manager)


- [Scaling Kubernetes clusters](./scale-kubernetes-cluster)
