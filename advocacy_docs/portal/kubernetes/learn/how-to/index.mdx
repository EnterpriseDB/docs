...
If you are new to Kubernetes, start with the [Kubernetes explained](/portal/kubernetes/learn/explained/kubernetes-explained) section to build foundational understanding.
...
- [Kubernetes explained](/portal/kubernetes/learn/explained/index)
- [Kubernetes terminology](/portal/kubernetes/learn/explained/terminology)
- [Kubernetes in Hybrid Manager](/portal/kubernetes/learn/explained/hybrid-manager/k8-in-hybrid-manager)
