...
If you are new to Kubernetes, start with the [Kubernetes explained](../explained/kubernetes-explained) section to build foundational understanding.
...
- [Kubernetes explained](../explained/index)
- [Kubernetes terminology](../explained/terminology)
