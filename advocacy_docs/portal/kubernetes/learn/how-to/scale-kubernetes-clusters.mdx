...
> This page focuses on generic concepts. For Hybrid Manager clusters, refer to [monitoring cluster resources](../hybrid-manager/monitor-hybrid-manager-cluster-state) and ensure your underlying infrastructure can handle resource scaling.
...
- [Monitor Hybrid Manager cluster state](../hybrid-manager/monitor-hybrid-manager-cluster-state)
