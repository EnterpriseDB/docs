...
> This page focuses on generic concepts. For Hybrid Manager clusters, refer to [monitoring cluster resources](/portal/kubernetes/learn/how-to/hybrid-manager/monitor-hybrid-manager-cluster-state) and ensure your underlying infrastructure can handle resource scaling.
...
- [Monitor Hybrid Manager cluster state](/portal/kubernetes/learn/how-to/hybrid-manager/monitor-hybrid-manager-cluster-state)
