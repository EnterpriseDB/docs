...
# Use the EDB observability stack (Hybrid Manager)
...
For architectural guidance, see [Monitoring Kubernetes best practices](/edb-postgres-ai/portal/kubernetes/learn/explained/hybrid-manager/monitoring-kubernetes-best-practices).
...
- [Monitoring Kubernetes best practices](/edb-postgres-ai/portal/kubernetes/learn/explained/hybrid-manager/monitoring-kubernetes-best-practices)
