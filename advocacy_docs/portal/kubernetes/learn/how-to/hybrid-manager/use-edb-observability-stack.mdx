...
For architectural guidance, see [Monitoring Kubernetes best practices](../explained/hybrid-manager/monitoring-kubernetes-best-practices).
...
- External log forwarding (Splunk, ELK, etc.) → customer-managed
...
- [Monitoring Kubernetes best practices](../explained/hybrid-manager/monitoring-kubernetes-best-practices)
