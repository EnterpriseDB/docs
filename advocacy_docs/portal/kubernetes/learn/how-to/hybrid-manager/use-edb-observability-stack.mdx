...
Prometheus is deployed in the `edb-observability` namespace (default).
...
Grafana is deployed in the `edb-observability` namespace (default).
...
Loki is deployed in the `edb-observability` namespace (default).
