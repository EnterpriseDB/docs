...
For Postgres backup guidance, see [Backup Kubernetes PersistentVolumes](/edb-postgres-ai/portal/kubernetes/learn/how-to/backup-kubernetes-pv) and your database operator documentation.
...
- [Backup Kubernetes PersistentVolumes](/edb-postgres-ai/portal/kubernetes/learn/how-to/ba)
