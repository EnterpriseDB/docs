...
For Postgres backup guidance, see [Backup Kubernetes PersistentVolumes](../../backup-kubernetes-pv) and your database operator documentation.
...
- [Backup Kubernetes PersistentVolumes](../../ba)
