...
See [Manage Kubernetes storage](/edb-postgres-ai/portal/kubernetes/learn/how-to/manage-kubernetes-storage) and [Manage Kubernetes networking](/edb-postgres-ai/portal/kubernetes/learn/how-to/manage-kubernetes-networking) for managing related infrastructure.
