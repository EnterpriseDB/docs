...
For general storage architecture recommendations, see [Kubernetes storage best practices](../explained/hybrid-manager/k8s-storage-best-practices).
...
- You understand platform-specific behaviors — consult [platform operator guides](../explained/aws-operator), (../explained/gcp-operator), (../explained/rhos-operator).
...
- [Kubernetes storage best practices](../explained/hybrid-manager/k8s-storage-best-practices)
- [Minimum and recommended Kubernetes specs](../explained/hybrid-manager/minimum-recommended-k8s-specs)
