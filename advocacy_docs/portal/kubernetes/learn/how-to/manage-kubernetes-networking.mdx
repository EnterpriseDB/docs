...
For background on recommended networking architecture, see [Kubernetes networking best practices](/edb-postgres-ai/portal/kubernetes/learn/explained/hybrid-manager/manage-kubernetes-networking).
...
- [Kubernetes networking best practices](/edb-postgres-ai/portal/kubernetes/learn/explained/hybrid-manager/manage-kubernetes-networking)
