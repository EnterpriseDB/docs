...
For general storage architecture recommendations, see [Kubernetes storage best practices](/portal/kubernetes/learn/explained/hybrid-manager/k8s-storage-best-practices).
...
See full recommendations in [Kubernetes storage best practices](/portal/kubernetes/learn/explained/hybrid-manager/k8s-storage-best-practices).
...
See [Troubleshooting Kubernetes](/portal/learn/how-to/troubleshooting-on-kubernetes) for general troubleshooting patterns.
...
- [Kubernetes storage best practices](/portal/kubernetes/learn/explained/hybrid-manager/k8s-storage-best-practices)
- [Expand Kubernetes storage](./expand-kubernetes-storage)
- [Minimum and recommended Kubernetes specs](/portal/kubernetes/learn/explained/hybrid-manager/minimum-recommended-k8s-specs)
- [Troubleshooting Kubernetes](/portal/learn/how-to/troubleshooting-on-kubernetes)
