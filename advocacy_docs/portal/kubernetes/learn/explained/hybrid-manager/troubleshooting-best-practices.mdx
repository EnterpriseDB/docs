...
It complements the actionable [How to troubleshoot Kubernetes](../../how-to/troubleshooting-on-kubernetes) guide, which provides specific commands and procedures.
...
-   [How to troubleshoot Kubernetes](../../how-to/troubleshooting-on-kubernetes)
