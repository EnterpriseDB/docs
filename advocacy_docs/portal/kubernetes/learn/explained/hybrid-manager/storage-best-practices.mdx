...
This page provides storage best practices for Kubernetes clusters that support Hybrid Manager and EDB Platform services. It complements the general [Minimum and recommended Kubernetes specs](/edb-postgres-ai/latest/hybrid-manager/install/kubernetes/recommended/) and focuses specifically on storage considerations.
