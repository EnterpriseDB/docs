...
This page provides storage best practices for Kubernetes clusters that support Hybrid Manager and EDB Platform services. It complements the general [Minimum and recommended Kubernetes specs](/portal/kubernetes/learn/explained/hybrid-manager/minimum-required-specs.mdx) and focuses specifically on storage considerations.
