...
This page provides **networking best practices** for Kubernetes clusters that support Hybrid Manager and EDB-managed Postgres services. It complements the general [Minimum and recommended Kubernetes specs](/edb-postgres-ai/latest/hybrid-manager/install/kubernetes/recommended/) and [Kubernetes storage best practices](storage-best-practices/).
...
-   [Minimum and recommended Kubernetes specs](/edb-postgres-ai/latest/hybrid-manager/install/kubernetes/recommended/)
