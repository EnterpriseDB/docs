...
> For background, see [Kubernetes in Hybrid Manager](/edb-postgres-ai/portal/kubernetes/learnexplained/k8-in-hybrid-manager).
...
- Consider **storage throughput and IOPS** when sizing nodes — see [Kubernetes storage best practices](./k8s-storage-best-practices).
...
See detailed guidance in [Kubernetes storage best practices](./k8s-storage-best-practices).
