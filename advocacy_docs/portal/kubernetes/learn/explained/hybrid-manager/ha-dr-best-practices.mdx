...
It complements the general [Minimum and recommended Kubernetes specs](/edb-postgres-ai/latest/hybrid-manager/install/kubernetes/recommended/), [Kubernetes storage best practices](./storage-best-practices), and [Kubernetes networking best practices](./manage-kubernetes-networking).
