...
It complements the general [Minimum and recommended Kubernetes specs](./minimum-recommended-k8s-specs), [Kubernetes storage best practices](./storage-best-practices), and [Kubernetes networking best practices](./manage-kubernetes-networking).
