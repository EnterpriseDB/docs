...
It complements the general [Minimum and recommended Kubernetes specs](/portal/kubernetes/learn/explained/hybrid-manager/minimum-required-specs.mdx), [Kubernetes storage best practices](./storage-best-practices), and [Kubernetes networking best practices](./manage-kubernetes-networking).
