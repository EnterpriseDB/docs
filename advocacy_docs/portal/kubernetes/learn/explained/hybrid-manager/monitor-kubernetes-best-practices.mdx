...
**To implement these best practices, see our detailed How-to guide: [How to monitor Kubernetes clusters](../../how-to/monitor-kubernetes-cluster).**
...
For step-by-step instructions on configuring and monitoring these areas, see [How to monitor Kubernetes clusters](../../how-to/monitor-kubernetes-cluster).
...
**For step-by-step guidance on configuring monitoring, see [How to monitor Kubernetes clusters](../../how-to/monitor-kubernetes-cluster).**
