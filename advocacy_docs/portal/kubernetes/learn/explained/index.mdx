...
| -------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------- |
| [Decision makers](/portal/kubernetes/learn/explained/for/decision-makers)                 | Evaluate Kubernetes as part of platform strategy, assess TCO, align adoption with business outcomes                   |
| [Platform engineers](/portal/kubernetes/learn/explained/for/platform-engineers)           | Design and manage Kubernetes clusters, automate CI/CD, integrate observability and security tools                     |
| [Software engineers](/portal/kubernetes/learn/explained/for/software-engineers)           | Deploy applications to Kubernetes, define application configurations, manage scaling and observability                |
| [DBAs](/portal/kubernetes/learn/explained/for/dbas)                                       | Manage database services on Kubernetes, monitor resource usage and storage, tune performance and backups              |
| [Site reliability engineers (SREs)](/portal/kubernetes/learn/explained/for/sres)          | Observe cluster and application health, manage availability and capacity, automate recovery processes                 |
| [Security engineers](/portal/kubernetes/learn/explained/for/security-engineers)           | Define access controls, enforce network and security policies, monitor security posture of Kubernetes workloads       |
| [Cloud architects](/portal/kubernetes/learn/explained/for/cloud-architects)               | Design scalable, portable architectures leveraging Kubernetes, align Kubernetes use with cloud and hybrid strategy    |
| [Operations and support teams](/portal/kubernetes/learn/explained/for/operations-support) | Monitor system state, respond to alerts, investigate issues using Kubernetes-native tools and observability pipelines |
...
-   [Decision makers](/portal/kubernetes/learn/explained/for/decision-makers)
-   [Platform engineers](/portal/kubernetes/learn/explained/for/platform-engineers)
-   [Software engineers](/portal/kubernetes/learn/explained/for/software-engineers)
-   [DBAs](/portal/kubernetes/learn/explained/for/dbas)
-   [Site reliability engineers](/portal/kubernetes/learn/explained/for/sres)
-   [Security engineers](/portal/kubernetes/learn/explained/for/security-engineers)
-   [Cloud architects](/portal/kubernetes/learn/explained/for/cloud-architects)
-   [Operations and support teams](/portal/kubernetes/learn/explained/for/operations-support)
