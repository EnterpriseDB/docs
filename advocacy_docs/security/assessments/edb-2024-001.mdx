---
title: EDB-2024-001 (CVE-2024-0985) - PostgreSQL non-owner REFRESH MATERIALIZED VIEW CONCURRENTLY executes arbitrary SQL
navTitle: EDB-2024-001 (CVE-2024-0985)
...
redirect:
- security/assessments/cve-2024-0985/
---
...
This is an assessment of the impact of CVE-2024-0895 on EDB products and services. It links to and details the CVE and supplements that information with EDB's own assessment.
...
| EPAS    | All versions prior to 13.14.20 | Update to latest supported version <br/> (at least [13.14.20](/epas/13/epas_rel_notes/epas13_14_20_rel_notes/)) and patch existing clusters. |
| EPAS    | All versions prior to 12.18.23 | Update to latest supported version <br/> (at least [12.18.23](/epas/12/epas_rel_notes/epas12_18_23_rel_notes/)) and patch existing clusters. |
