...
<tr><td>
<details><summary><h3 style="display:inline">CVE-2025-48715 </h3>
<span>
&nbsp;&nbsp;<a href="advisories/cve20258715">Read Advisory</a>
&nbsp;&nbsp;Published: </span><span>2025/08/14</span>
...
<br/>
<a href="advisories/cve202528715">Read More...</a>
</details></td></tr>

<tr><td>
<details><summary><h3 style="display:inline">CVE-2025-48714 </h3>
<span>
&nbsp;&nbsp;<a href="advisories/cve20258714">Read Advisory</a>
&nbsp;&nbsp;Published: </span><span>2025/08/14</span>
...
When pglogical attempts to replicate data, it does not verify it is using a replication connection, which means a user with CONNECT access to a database configured for replication can execute the pglogical command to obtain read access to replicated tables. When pglogical runs it should verify it is running on a replication connection but does not perform this check. This vulnerability was introduced in the pglogical 3.x codebase, which is proprietary to EDB. The same code base has been integrated into BDR/PGD 4 and 5.
<br/>
<a href="advisories/cve202528714">Read More...</a>
</details></td></tr>

<tr><td>
<details><summary><h3 style="display:inline">CVE-2025-8713 </h3>
<span>
&nbsp;&nbsp;<a href="advisories/cve20258713">Read Advisory</a>
&nbsp;&nbsp;Published: </span><span>2025/08/14</span>
...
When pglogical attempts to replicate data, it does not verify it is using a replication connection, which means a user with CONNECT access to a database configured for replication can execute the pglogical command to obtain read access to replicated tables. When pglogical runs it should verify it is running on a replication connection but does not perform this check. This vulnerability was introduced in the pglogical 3.x codebase, which is proprietary to EDB. The same code base has been integrated into BDR/PGD 4 and 5.
<br/>
<a href="advisories/cve20258713">Read More...</a>
</details></td></tr>
