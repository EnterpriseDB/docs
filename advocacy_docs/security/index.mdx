...
Versions of EDB Postgres Advanced Server (EPAS) are affected by a high severity vulnerability
<br/></summary>
<hr/>
...
EDB Postgres Advanced Server version 8.2 is affected by an unscored vulnerability<br/></summary>
<hr/>
