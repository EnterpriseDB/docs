...
CVSS Vector: CVSS:3.1/AV:N/AC:L/PR:L/UI:N/S:U/C
...
|---------|------|-----------------------|
| EPAS | All versions prior to 11.21.32 | Update to latest supported version <br/> (at least 11.21.32) and patch existing clusters. |
| EPAS | All versions prior to 12.16.20 | Update to latest supported version <br/> (at least 12.16.20) and patch existing clusters. |
| EPAS | All versions prior to 13.12.17 | Update to latest supported version <br/> (at least [13.12.17](https://media.githubusercontent.com/media/EnterpriseDB/docs-archive/main/docs/epas/13/epas_v13.23_documentation.pdf#page=34)) and patch existing clusters. |
...
* 31 Jan 2025: Remove links to EOL EPAS 11/12 release notes
