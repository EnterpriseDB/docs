...
<h4>PEM 9.8 Cross-site scripting </h4><br/>
<h5>All versions of PEM prior to 9.8.1</h5>
</summary>
<hr/>
<em>Summary:</em>&nbsp;
Postgres Enterprise Manager (PEM) <= 9.8 is affected by a security vulnerability with Cross-Site Scripting(XSS). If attackers execute arbitrary HTML/JavaScript in a user's browser via query result rendering, it runs in the browser.
<br/>
