...
|---------|------|-----------------------|
| EPAS | All versions <br/>up to 10.23.32 | Update to latest supported version <br/> (at least 10.23.33) |
| EPAS | 11.1.7 to <br/>11.18.28 | Update to latest supported version <br/> (at least 11.18.29) |
| EPAS | 12.1.2 to <br/>12.13.16 | Update to latest supported version <br/> (at least 12.13.17) |
| EPAS | 13.1.4 to <br/>13.9.12 | Update to latest supported version <br/> (at least [13.9.13](https://media.githubusercontent.com/media/EnterpriseDB/docs-archive/main/docs/epas/13/epas_v13.23_documentation.pdf#page=37)) |
| EPAS | 14.1.0 to <br/>14.5.0 | Update to latest supported version <br/> (at least [14.6.0](https://www.enterprisedb.com/docs/epas/14/epas_rel_notes/epas14_6_0_rel_notes/))|
