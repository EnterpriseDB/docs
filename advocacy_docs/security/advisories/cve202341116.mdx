...
| EPAS | All versions prior to 13.12.16 | Update to latest supported version <br/> (at least [13.12.17](/epas/13/epas_rel_notes/epas13_12_17_rel_notes/)) and patch existing clusters. |
