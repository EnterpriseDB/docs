...
| EPAS | All versions prior to 13.12.16 | Update to latest supported version <br/> (at least [13.12.17](https://media.githubusercontent.com/media/EnterpriseDB/docs-archive/main/docs/epas/13/epas_v13.23_documentation.pdf#page=34)) and patch existing clusters. |
