...
![Download EDB software](images/download_repos.png)

4. Select the repository you want to browse. On selection, s new tab or window opens displaying operating system and architecture options available.
...
By default, the view of the available files is paged. Select the up/down arrow toggle button next to the **Search** field to view all the results in a single page. Entering text in the search field will filter the results to include only package names that contain the search text.
