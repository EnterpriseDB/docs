...
See [Repositories by name](/repos/reference/repositories_by_name) for a list of repositories and the subscriptions that can access them. If you don't know what your subscription is, contact your EDB account manager or support representative.

1.  From your EDB account, [get your token](/repos/getting_started/get_your_token/).
