...
1. If you're not logged in, log in to your EDB account to access this page. After you log in, go to the Account Profile page. On the Account Profile page, select **Repo Access**.
