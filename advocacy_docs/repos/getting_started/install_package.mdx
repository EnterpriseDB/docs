...
6. Step 2 will show you the full installation command for the package. You can copy and paste this command into your terminal to install the package. If you just need the package name, that appears at the end of the command. 
