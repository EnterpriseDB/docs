---
title: Getting started using the Web Repos page
navTitle: with the Web Repos page
description: How to download and install the EDB package you need using the Web Repos page
navigation:
- get_your_token
- add_your_repository
- install_package
