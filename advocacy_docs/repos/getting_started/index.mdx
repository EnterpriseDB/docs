...
!!! Note
 If you have an Standard or Community360 subscription, or want to install packages for Postgres Distributed without using TPA, you must use the CLI. Refer to the [CLI getting started guide]
 (with_cli) for that.
!!!
