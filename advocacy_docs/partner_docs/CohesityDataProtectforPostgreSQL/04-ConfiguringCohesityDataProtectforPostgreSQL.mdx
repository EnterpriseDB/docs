...
7. Enable **Custom Options**. A form appears called Global Source Registration Arguments where you enter more information for registering an EDB Postgres Advanced Server database.

   ![Cohesity Global Source Registration](Images/CohesityGlobalSourceRegistration.png)

8. In the **Global Source Registration Arguments** field enter:
