...
- Click on a run, then click the name in the Objects list to view the logs from that specific run. <br />![Cohesity Protection Page Overview](Images/CohesityProtectionPageOverview.png) <br />![Cohesity Protection Details](Images/CohesityProtectionDetails.png)
