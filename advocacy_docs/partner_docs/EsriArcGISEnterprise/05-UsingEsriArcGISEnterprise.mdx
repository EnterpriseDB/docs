...
This guide shares a use case in which a map was shared from Esri ArcGIS Pro to an Esri ArcGIS Enterprise Environment.  The steps below discuss sharing maps that have been created in Esri ArcGIS Pro and how they can then be viewed in the Esri Portal that is a part of an Esri ArcGIS Enterprise Environment.
