...
Implementing Esri ArcGIS Enterprise with EDB Postgres Advanced Server requires the following components:
...
- Optionally, an Esri ArcGIS Pro Environment installed and running on your machine if you will be sharing data from Esri ArcGIS Pro to Esri ArcGIS Enterprise

## Configuring EDB Postgres Advanced Server and PostGIS
The below steps will guide you through configuring PostGIS on your EDB Postgres Advanced Server instance and setting up the appropriate users and extensions needed for PostGIS to work with Esri ArcGIS Enterprise.

## Prerequisites

These components are needed before integrating EDB Postgres Advanced Server with Esri ArcGIS Enterprise and additionally Esri ArcGIS Pro if sharing from Esri ArcGIS Pro:
...
## Configuring Esri ArcGIS Pro
To share maps and data from Esri ArcGIS Pro to an Esri ArcGIS Enterprise Environment you will need to have Esri ArcGIS Pro installed and active on your machine with some maps, data or Enterprise Geodatabases present to share.

This guide does not go over installing and configuring Esri ArcGIS Pro, but those steps can be found in the Esri ArcGIS Pro EDB Implementation guide.
...
Before you can share from your Esri ArcGIS Pro environment to an Enterprise Portal that you have created, you will need to add that Portal in your Esri ArcGIS Pro environment.  You will need to be signed in to your Esri ArcGIS Enterprise Portal to share maps and data to your Esri ArcGIS Enterprise Environment.
