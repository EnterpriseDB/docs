---
title: 'Using Imperva Data Security Fabric with EDB Postgres Advanced Server'
...
The following steps need to be taken in order to set-up the Imperva Data Security Fabric Agent to monitor the EDB Postgres Advanced Server traffic.
