---
title: 'Viewing the Integration Output'
...
This section provides the examples of applying database change using Liquibase changesets:
...
#### Updating Tables 
1. Create a changelog file. See the following changelog file example. For detailed information on changelogs, refer to the [changelog documentation](https://docs.liquibase.com/concepts/basic/xml-format.html) from Liquibase.
...
Roll back changes made to the table using the sample changelog file shown earlier: 
