...
This section provides examples of applying database change using Liquibase changesets:
...
#### Updating Tables 
1. Create a changelog file. Use one of the following options for creating a changelog file:
...
3. To register the changelog with the Liquibase Hub and provide the project name when prompted, execute this command: 
