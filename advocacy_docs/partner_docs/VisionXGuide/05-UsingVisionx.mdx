...
Switching from Oracle is a simple step in SIB Visions VisionX. In the migrated VisionX application, simply click on the SIB Visions VisionX Settings screen and choose the “Datasources” tab. Click on “Edit” to change the database connection from Oracle to EDB Postgres Advanced Server.
