...
HPE systems are easy to deploy, turn on and off, and install your EDB Postgres distribution products on, while ensuring speed and security.

To use HPE System Components:

1. Access your server, either via GUI or SSH depending on your system setup.

1. Install and deploy your EDB Postgres distribution products as needed:
