...
---
Once an instance of EDB Postgres Advanced Server or EDB Postgres Extended is connected to DBeaver, you can access the capabilities of the integration demonstrated in the next section. 


# Sample User Scenarios

!!! Note The user scenarios shown are provided as example use cases of DBeaver and EDB Postgres Advanced Server or EDB Postgres Extended.  They are not intended to show all functionality.
