...
---
Once DBeaver PRO is connected to an instance of EDB Postgres Advanced Server or EDB Postgres Extended, you can then access the capabilities of DBeaver PRO.


# Sample User Scenarios

!!! Note
    The user scenarios shown are provided as example use cases of DBeaver PRO and EDB Postgres Advanced Server or EDB Postgres Extended.  They are not intended to show all functionality.


## Working with the Connected Database

**Create:** Here we can see that a table has been created in DBeaver PRO with one column of the type VARCHAR and one of the type NUMERIC. A couple of rows were inserted on the EDB Postgres Advanced Server side using PSQL. The data was retrieved in DBeaver PRO using the `View Data` option. 
