...
- Configure Postgres Distribution as Target Instance in Connect CDC Director
  - Setup and configuration of EDB Postgres Advanced Server as target instance to Connect CDC Director.
