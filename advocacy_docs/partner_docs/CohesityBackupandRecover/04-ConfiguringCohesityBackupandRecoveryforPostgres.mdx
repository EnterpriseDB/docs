---
title: 'Configuring Cohesity for Postgres'
...
1. Log on to the Cohesity console at the IP address that was used to create your VMware Cohesity Backup Appliance with the format: ```bash https://ipaddress/login ```
