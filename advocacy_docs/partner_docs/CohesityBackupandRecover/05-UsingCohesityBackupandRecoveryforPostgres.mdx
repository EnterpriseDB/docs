---
title: 'Using Cohesity with EDB Postgres Advanced Server'
description: 'Walkthroughs of a Cohesity Backup and Recovery with the Cohesity Postgres Connector Agent scenario'
---
This section features use cases that show how backups are taken and restored from EDB Postgres Advanced Server using Cohesity.


## Setting a Protection Policy with Cohesity Postgres Connector Agent
