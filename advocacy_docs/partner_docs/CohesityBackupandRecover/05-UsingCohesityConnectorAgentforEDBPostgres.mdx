---
title: 'Using Cohesity Connector Agent for EDB PostgreSQL with EDB Postgres Advanced Server'
description: 'Walkthroughs of multiple Cohesity Connector Agent for EDB PostgreSQL scenarios'
---
