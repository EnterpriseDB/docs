...
2. Go to the `Database` drop down menu in the top left, and select `New Database Connection`. In the `All` tab, select `EDB` and click `Next`.    

<p align="center">
<img src="Images/EPASDatabaseConfiguration.png">
</p>
...
<p align="center">
<img src="Images/JDBCConnection.png">
</p>
...
<p align="center">
<img src="Images/EPASConnectionSettings.png">
</p>

4. Click `Test Connection`. The connection should be successful. 
<p align="center">
<img src="Images/EPASTestConnection.png">
</p>
...
4. Click `Test Connection`. The connection should be successful. 
<p align="center">
<img src="Images/ExtendedTestConnection.png">
</p>
