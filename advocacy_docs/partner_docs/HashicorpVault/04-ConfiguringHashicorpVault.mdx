...
6. Define the Scopes and Roles to determine what allowed operations a role can perform.
...
9. Define the role for that scope and what operations they are allowed to do.
