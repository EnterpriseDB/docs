...
Commvault PostgreSQL iDataAgent provides the flexibility to backup the PostgreSQL/EDB Postgres Advanced Server databases in different modes and restore them in minimal time. Whether you need to perform a full or log backup or restore of the entire PostgreSQL/EDB Postgres Advanced Server server or individual databases or archive logs at any point of time, you have full control.
