---
title: 'Using Commvault Express'
description: 'Walkthroughs of multiple Commvault Express usage scenarios'
---

This section shows how backups are taken and restored from EDB Postgres Advanced Server (EPAS) using Commvault Express.

## Backup and Restore using Commvault Express

Commvault provided the following method of taking the backup from EDB Postgres Advanced Server (EPAS) and restoring it.

1. DumpBasedBackupSet Backup and Restore : pg_dump Utility is used to take the backup.
2. FSBasedBackupSet Backup and Restore : Its File System Level Backup which copy the files that EDB Postgres Advanced Server (EPAS) uses to store the data in the database.
...
9. Once the Restore is completed successfully, login to the EDB Postgres Advanced Server (EPAS) Instance and check the restore operation recovered the data.
...
!!! Note
    For FSBasedBackupSet Backup WAL Arching must be enabled on EDB Postgres Advanced Server (EPAS). Visit the link for details https://www.postgresql.org/docs/13/continuous-archiving.html.

1. On PostgreSQL Instance Screen, enter Archive Log Directory path.

<p align="center">
  <img  alt="PostgreSQL Instance Screen" src="Images/Fsbackup1.png">
</p>

2. From the navigation pane, go to Protect > Databases.
3. Click the required instance.
4. In the Backup sets section, click on FSBasedBackupSet backup set.

<p align="center">
  <img  alt="Select Backup Set" src="Images/Fsbackup2.png">
</p>

5. In the Database groups section, click the database group that you want to back up. In this case its default.

<p align="center">
  <img  alt="Select Database Group" src="Images/Fsbackup3.png">
</p>

6. In the Backup section, click Back up.

<p align="center">
  <img  alt="Backup Section" src="Images/Fsbackup4.png">
</p>

7. Select Full in the Select Backup Level Screen.

<p align="center">
  <img  alt="Backup Level Screen" src="Images/Fsbackup5.png">
</p>

8. A Job will be created to take the backup.

<p align="center">
  <img  alt="Backup Job" src="Images/Fsbackup6.png">
</p>

9. Once the Backup Job is completed then its status will be changed to Completed.

<p align="center">
  <img  alt="Backup Job" src="Images/Fsbackup7.png">
</p>

#### Known Issues:
1. FSBaseBadkupSet Restore has an issue where after the restore is done, the permissions on the restored directory and wal directory are changed which does not allow EDB Postgres Advanced Server (EPAS) to start on the restored directory. We are working with Commvault to resolve the issue.
