---
title: 'Using Esri ArcGIS Pro with EDB Postgres Advanced Server'
description: 'Walkthroughs of multiple Esri ArcGIS Pro usage scenarios'
---
...
8. The `Use symbol types compatible with all clients` option is checked by default, you can uncheck if needed.
