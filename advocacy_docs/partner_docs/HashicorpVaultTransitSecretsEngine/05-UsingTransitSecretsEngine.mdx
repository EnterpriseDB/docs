...
After you have configured Hashicorp Vault Transit Secrets Engine as stated in the Configuring section, you will be able to then encrypt your EDB Postgres Advanced Server database.

!!! Note
    It is important to note that this doc is intended for versions 15.2 and above of EDB Postgres Advanced Server or versions 15 and above of EDB Postgres Extended Server as this version supports Transparent Data Encryption (TDE).
...
1. Login to your EDB Postgres Advanced Server system as the database superuser, for example `sudo su - enterprisedb`.
