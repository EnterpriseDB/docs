...
You will need the following certificates for your KMIP server and pykmip.conf file.
...
3. For your download change the name from Certificate.pem to ca.pem.  Keep track of where you downloaded your key as you will need it later.
...
- Give the token a name, in our example `newtokenname2`
...
11. This will save the private key and certificate.

You are now ready to use Thales and EDB with the 3 requires certs to enable TDE.