...
Implementing Thales CipherTrust Manager with EDB Postgres Advanced Server 15.2 and above or EDB Postgres Extended 15 and above requires the following components:
!!! Note
...
## Configure Thales CipherTrust Manager for your Postgres Distribution
...
A user needs to be created for future authentication when creating a key on Thales CipherTrust Manager with Postgres Distribution.  It verifies the username and password against the Thales CipherTrust Manager internal database.
...
You are now ready to use Thales CipherTrust Manager and your Postgres Distribution with TDE for key management.