...
1. On your system where you have your EDB Postgres Advanced Server instance, login as the superuser of the database to create the key on Thales CipherTrust Manager.
...
To ensure that your key that you created will be able to encrypt and decrypt data, run the following two commands as the superuser on your system where you have your EDB Postgres Advanced Server instance.
