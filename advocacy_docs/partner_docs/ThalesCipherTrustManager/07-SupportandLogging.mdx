...
Thales CipherTrust Manager collects and stores records for both the Server and the Client. If you login to your Thales CipherTrust Manager UI on the left menu bar click on `Records`.  From there you can choose to view either Server Records or Client Records.
    ![Hashicorp Records](Images/HashicorpRecords.png) 