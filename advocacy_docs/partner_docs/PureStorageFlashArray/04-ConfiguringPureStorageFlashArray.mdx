...
!!! Note
    The Enterprisedb Postgres Advanced Server, Enterprisedb Postgres Extended Server and PostgreSQL Server products will be referred to as Postgres Distribution.  The specific Distribution type will be up to the customer needs or preferences.
