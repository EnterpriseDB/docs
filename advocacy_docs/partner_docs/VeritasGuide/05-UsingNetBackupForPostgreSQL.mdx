...
This section shows common backup/restore operations for PostgreSQL databases using Veritas NetBackup for PostgreSQL, such as:
- Performing backup - takes backup of the database and stores it in a predetermined location
