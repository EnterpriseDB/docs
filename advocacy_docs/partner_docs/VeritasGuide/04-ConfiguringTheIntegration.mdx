...
2. Within the Admin Console, create a policy using the steps below:
...
- Click on **NetBackup Management > Policies**, select the NetBackup server, right mouse click and select **New Policy**:
...
- Enter the policy name in the **Add New Policy** dialog box and click OK:
...
- Select the **Clients** tab, click on **New**, enter the NetBackup client name in the **Add Client** dialog box, and click **OK**:
...
- Select the **Attributes** tab, select **DataStore** for **Policy type**, 
select **Policy storage** from available values, and click **OK**:
