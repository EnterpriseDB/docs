...
- NetBackup PostgreSQL Agent installed on the EPAS host


### Configuring Veritas NetBackup for PostgreSQL

The following steps show an example of how to configure NetBackup for PostgreSQL for EDB Postgres Advanced 13.
