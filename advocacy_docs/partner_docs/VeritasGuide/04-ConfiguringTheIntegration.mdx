...
2. Within the Admin Console, click **NetBackup Management > Policies** and create a policy of the type **DataStore** to be used with the NetBackup Agent for PostgreSQL:
