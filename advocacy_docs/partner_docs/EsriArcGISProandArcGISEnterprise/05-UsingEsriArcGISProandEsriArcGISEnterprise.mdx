...
4. Go to the PostGIS database in your EDB Postgres Advanced Server instance to see the tables with data that was moved from Esri ArcGIS Pro.
...
15. Go to 'Portal' and the 'Contents' area and the Map will be added to the Contents section.
