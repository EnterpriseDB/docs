...
7. Display the data in the EDB Postgres Advanced Server Table that was imported in the above steps on your Esri ArcGIS Pro Map and table, and confirm that it is correct in Esri ArcGIS Pro.
