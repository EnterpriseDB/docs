...
!!! Note If you hover your mouse over your Database Connection in the `Catalog` pane it will display the message "Enterprise Connection" to easily keep track of your Enterprise Geodatabases within your project.
...
11. Once the web map has been successfully shared, click the `Manage Web Map` link that appears at the bottom of the pane to manage the web map in your portal.
...
15. Go to your `Portal` and navigate to the `Contents` area to see the Map that was added to your Portal Contents.
