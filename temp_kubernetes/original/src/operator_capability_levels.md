...
enhancements, such as improvements in how users interact with the
...
product, the cluster identifiers (namespace and name), the number of
instances, the expiration date, and, if required, the credentials to be used
